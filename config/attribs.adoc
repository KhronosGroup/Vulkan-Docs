...
// Spec macros generate errors when given invalid link targets.
// The SC and modular spec builds have many of these, and they will be
// tedious to fix, so this attribute turns the errors into warnings.
ifdef::VKSC_VERSION_1_0[:spec_macro_target_warning:]
ifndef::VK_VERSION_1_0[:spec_macro_target_warning:]
...
// URL prefix for the SPIR-V spec
:spirvspec: https://registry.khronos.org/spir-v/specs/unified1/SPIRV.html
// URL prefix for the SPIR-V registry
:spirvregistry: https://github.khronos.org/SPIRV-Registry/
