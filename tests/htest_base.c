//% gcc -c -Wall -I. -I../include htest_base.c
...
// Enable each platform when vulkan_base.h is included
...
// (uncomment type below if a platform extension is enabled for 'vulkanbase')
