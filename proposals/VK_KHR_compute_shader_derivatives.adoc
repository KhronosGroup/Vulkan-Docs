...
xref:{refpages}VK_NV_compute_shader_derivatives.html[VK_NV_compute_shader_derivatives].
...
This extension adds Vulkan support for the https://github.khronos.org/SPIRV-Registry/extensions/KHR/SPV_KHR_compute_shader_derivatives.html[`SPV_KHR_compute_shader_derivatives`] SPIR-V extension.
...
=== Should we add support for derivatives in mesh and task shaders?
