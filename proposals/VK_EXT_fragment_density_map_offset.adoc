...
xref:{refpages}VK_EXT_fragment_density_map.html[VK_EXT_fragment_density_map] to
...
xref:{refpages}VK_QCOM_fragment_density_map_offset.html[VK_QCOM_fragment_density_map_offset],
with the addition of support for
xref:{refpages}VK_KHR_dynamic_rendering.html[dynamic rendering]. As that extension
...
Some use cases for
xref:{refpages}VK_EXT_fragment_density_map.html[VK_EXT_fragment_density_map], such
...
xref:{refpages}VkSubpassEndInfo.html[VkSubpassEndInfo] or
xref:{refpages}VkRenderingEndInfoEXT.html[VkRenderingEndInfoEXT]
