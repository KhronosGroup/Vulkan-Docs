...
| 6 | 4480 | <id> _Result Type_ | Result <id> | <id> _Texture Sampled Image_ | <id> _Coordinate_ | <id> _Weight Image_
|====
...
| 6 | 4481 | <id> _Result Type_ | Result <id> | <id> _Texture Sampled Image_ | <id> _Coordinate_ | <id> _Box Size_
|====
...
| 8 | 4483 | <id> _Result Type_ | Result <id> | <id> _Target Sampled Image_ | <id> _Target Coordinate_ | <id> _Reference Sampled Image_ | <id> _Reference Coordinate_ | <id> _Block Size_
|====
...
2+|Capability: +
*TextureBlockMatchQCOM*
| 8 | 4482 | <id> _Result Type_ | Result <id> | <id> _Target Sampled Image_ | <id> _Target Coordinate_ | <id> _Reference Sampled Image_ | <id> _Reference Coordinate_ | <id> _Block Size_
|====
...
xref:{refpages}VkPhysicalDeviceProperties2.html[VkPhysicalDeviceProperties2].
...
xref:{refpages}VkSamplerReductionMode.html[VkSamplerReductionModes].

The other
xref:{refpages}VkSamplerCreateInfo.html[VkSamplerCreateInfo] parameters
...
xref:{refpages}VkFormatProperties3.html[VkFormatProperties3]
...
xref:{refpages}VkImageViewCreateInfo.html[VkImageViewCreateInfo] structure
...
be matched and must be greater than 0 or _result_ will contain an _undefined value_.
...
===  Should this be one extension or 3 extensions?
...
===  How does this interact with descriptor indexing ?
...
===  How does this extension interact with EXT_robustness2 ?
...
===  How does this interact with push descriptors ?
