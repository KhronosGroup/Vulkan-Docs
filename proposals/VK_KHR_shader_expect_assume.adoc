...
introduced by the
https://github.khronos.org/SPIRV-Registry/extensions/KHR/SPV_KHR_expect_assume.html[SPV_KHR_expect_assume]
...
=== What shader stages should the instructions introduced by this extension be allowed in?
