...
=== Do we want to allow the application to specify separate reference lists for each slice?
...
=== Are prefix NAL units generated by the implementation when multiple temporal layers are used?
...
=== How is reference picture setup requested for H.264 encode operations?
