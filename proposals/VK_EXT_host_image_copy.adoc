...
The xref:{refpages}vkGetImageSubresourceLayout2EXT.html[vkGetImageSubresourceLayout2EXT] function can be used for this purpose:
...
=== Should other layouts be allowed in `VkHostImageLayoutTransitionInfoEXT`?
...
=== Should queue family ownership transfers be supported on the host as well?
