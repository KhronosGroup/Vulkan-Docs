...
This document describes a limitation with xref:{refpages}VK_KHR_dynamic_rendering.html[VK_KHR_dynamic_rendering] that limits what
...
The xref:{refpages}VK_KHR_dynamic_rendering.html[VK_KHR_dynamic_rendering] has several restrictions on what pipelines can be
...
Implementations may expose the xref:{refpages}VK_EXT_dynamic_rendering_unused_attachments.html[VK_EXT_dynamic_rendering_unused_attachments] extension
and the
xref:{refpages}VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT.html[VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT]::`dynamicRenderingUnusedAttachments`
