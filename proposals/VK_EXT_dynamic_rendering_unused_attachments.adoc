...
and the
link:{refpage}VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT.html[VkPhysicalDeviceDynamicRenderingUnusedAttachmentsFeaturesEXT]::`dynamicRenderingUnusedAttachments`
