...
xref:{refpages}VK_ARM_data_graph.html[VK_ARM_data_graph] to allow applications
...
This proposal builds on two existing extensions:
  ...
  * xref:{refpages}VK_ARM_tensors.html[VK_ARM_tensors] which defines tensor objects that can be used in the model's inputs and outputs
  * xref:{refpages}VK_ARM_data_graph.html[VK_ARM_data_graph]
...
xref:{refpages}vkGetPhysicalDeviceQueueFamilyProperties.html[vkGetPhysicalDeviceQueueFamilyProperties]
...
xref:{refpages}vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM.html[vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM]
...
xref:{refpages}vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM.html[vkGetPhysicalDeviceQueueFamilyDataGraphProcessingEnginePropertiesARM].
...
xref:{refpages}vkCreatePipelineCache.html[vkCreatePipelineCache] by specifying the blob in the
...
xref:{refpages}vkCreateDataGraphPipelinesARM.html[vkCreateDataGraphPipelinesARM] will
...
the xref:{refpages}vkCreateDataGraphPipelinesARM.html[vkCreateDataGraphPipelinesARM] call.

The appropriate engine type must be attached to the `VkDataGraphPipelineCreateInfoARM::pNext` with the
xref:{refpages}VkDataGraphProcessingEngineCreateInfoARM.html[VkDataGraphProcessingEngineCreateInfoARM]
...
xref:{refpages}VkDataGraphPipelineIdentifierCreateInfoARM.html[VkDataGraphPipelineIdentifierCreateInfoARM]
...
xref:{refpages}VkDataGraphPipelineCompilerControlCreateInfoARM.html[VkDataGraphPipelineCompilerControlCreateInfoARM].
...
xref:{refpages}VkExternalMemoryTensorCreateInfoARM.html[VkExternalMemoryTensorCreateInfoARM] and
...
See the xref:{docs}chapters/resources.html#resources-memory-aliasing[memory aliasing] section for rules about
...
xref:{refpages}vkCmdCopyTensorARM.html[vkCmdCopyTensorARM] to copy it to/from a tensor that is compatible with
the model.
...
xref:{refpages}vkGetImageSubresourceLayout.html[vkGetImageSubresourceLayout] to get
...
The
xref:{refpages}vkCmdDispatchDataGraphARM.html[vkCmdDispatchDataGraphARM] command
