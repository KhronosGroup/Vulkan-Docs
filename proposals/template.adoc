...
Example: xref:{refpages}VkGraphicsPipelineCreateInfo.html[VkGraphicsPipelineCreateInfo]
...
Example: xref:{docs}chapters/copies.html#copies[copies]

Example markup:

[source,asciidoc]
----
xref:{docs}chapters/copies.html#copies[copies]
----
