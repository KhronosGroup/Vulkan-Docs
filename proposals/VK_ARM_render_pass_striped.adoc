...
=== Naming. Do we use "stripe" or "slice"?
...
=== Could we use timeline semaphores for this?
...
=== How do stripes interact with multiview or layered rendering?
...
=== Is striped rendering supported for all renderable formats?
