...
Implementations may expose the xref:{refpages}VK_NV_ray_tracing_validation.html[VK_NV_ray_tracing_validation] extension
and the
xref:{refpages}VkPhysicalDeviceRayTracingValidationFeaturesNV.html[VkPhysicalDeviceRayTracingValidationFeaturesNV]::`rayTracingValidation`
