...
=== How should the `pipelineProtectedAccess` feature interact with `protectedMemory`?
...
=== Should the `pipelineProtectedAccess` feature allow pipelines to opt into protected access or out of it?
...
=== Should links between protected and unprotected pipeline libraries be allowed?
