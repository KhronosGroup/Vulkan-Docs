...
include::{generated}/api/structs/VkExportMetalObjectCreateInfoEXT.txt[]
...
include::{generated}/validity/structs/VkExportMetalObjectCreateInfoEXT.txt[]
--
...
include::{generated}/api/enums/VkExportMetalObjectTypeFlagBitsEXT.txt[]
...
--
include::{generated}/api/flags/VkExportMetalObjectTypeFlagsEXT.txt[]
...
include::{generated}/api/protos/vkExportMetalObjectsEXT.txt[]
...
include::{generated}/validity/protos/vkExportMetalObjectsEXT.txt[]
--
...
include::{generated}/api/structs/VkExportMetalObjectsInfoEXT.txt[]
...
****
  ...
  * [[VUID-VkExportMetalObjectsInfoEXT-pNext-06795]]
    If the pname:pNext chain includes a slink:VkExportMetalTextureInfoEXT
    structure, and its pname:image member is not dname:VK_NULL_HANDLE, the
  ...
  * [[VUID-VkExportMetalObjectsInfoEXT-pNext-06796]]
    If the pname:pNext chain includes a slink:VkExportMetalTextureInfoEXT
    structure, and its pname:imageView member is not dname:VK_NULL_HANDLE,
  ...
  * [[VUID-VkExportMetalObjectsInfoEXT-pNext-06797]]
    If the pname:pNext chain includes a slink:VkExportMetalTextureInfoEXT
    structure, and its pname:bufferView member is not dname:VK_NULL_HANDLE,
  ...
  * [[VUID-VkExportMetalObjectsInfoEXT-pNext-06806]]
    ...
    member is not dname:VK_NULL_HANDLE, the slink:VkEvent in its pname:event
...
include::{generated}/validity/structs/VkExportMetalObjectsInfoEXT.txt[]
--
...
include::{generated}/api/structs/VkExportMetalDeviceInfoEXT.txt[]
...
include::{generated}/validity/structs/VkExportMetalDeviceInfoEXT.txt[]
--
...
include::{generated}/api/basetypes/MTLDevice_id.txt[]
--
...
include::{generated}/api/structs/VkExportMetalCommandQueueInfoEXT.txt[]
...
include::{generated}/validity/structs/VkExportMetalCommandQueueInfoEXT.txt[]
--
...
include::{generated}/api/basetypes/MTLCommandQueue_id.txt[]
--
...
include::{generated}/api/structs/VkExportMetalBufferInfoEXT.txt[]
...
include::{generated}/validity/structs/VkExportMetalBufferInfoEXT.txt[]
--
...
include::{generated}/api/structs/VkImportMetalBufferInfoEXT.txt[]
...
include::{generated}/validity/structs/VkImportMetalBufferInfoEXT.txt[]
--
...
include::{generated}/api/basetypes/MTLBuffer_id.txt[]
--
...
include::{generated}/api/structs/VkExportMetalTextureInfoEXT.txt[]

  * pname:sType is the type of this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:image is dname:VK_NULL_HANDLE or a slink:VkImage.
  * pname:imageView is dname:VK_NULL_HANDLE or a slink:VkImageView.
  * pname:bufferView is dname:VK_NULL_HANDLE or a slink:VkBufferView.
...
include::{generated}/validity/structs/VkExportMetalTextureInfoEXT.txt[]
--
...
include::{generated}/api/structs/VkImportMetalTextureInfoEXT.txt[]
...
include::{generated}/validity/structs/VkImportMetalTextureInfoEXT.txt[]
--
...
include::{generated}/api/basetypes/MTLTexture_id.txt[]
--
...
include::{generated}/api/structs/VkExportMetalIOSurfaceInfoEXT.txt[]
...
include::{generated}/validity/structs/VkExportMetalIOSurfaceInfoEXT.txt[]
--
...
include::{generated}/api/structs/VkImportMetalIOSurfaceInfoEXT.txt[]

  * pname:sType is the type of this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:ioSurface is dname:VK_NULL_HANDLE or the Metal
    basetype:IOSurfaceRef object that is to underlie the slink:VkImage.

If pname:ioSurface is not dname:VK_NULL_HANDLE, it will be used to underlie
the slink:VkImage.
If pname:ioSurface is dname:VK_NULL_HANDLE, the implementation will create a
...
include::{generated}/validity/structs/VkImportMetalIOSurfaceInfoEXT.txt[]
--
...
include::{generated}/api/basetypes/IOSurfaceRef.txt[]
--
...
include::{generated}/api/structs/VkExportMetalSharedEventInfoEXT.txt[]

  * pname:sType is the type of this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:semaphore is dname:VK_NULL_HANDLE or a slink:VkSemaphore.
  * pname:event is dname:VK_NULL_HANDLE or a slink:VkEvent.
...
include::{generated}/validity/structs/VkExportMetalSharedEventInfoEXT.txt[]
--
...
--
To import a Metal basetype:MTLSharedEvent object to underlie a
slink:VkSemaphore or slink:VkEvent object, include a
...
include::{generated}/api/structs/VkImportMetalSharedEventInfoEXT.txt[]
...
imported basetype:MTLSharedEvent object will be set to pname:initialValue of
slink:VkSemaphoreTypeCreateInfo.
endif::VK_KHR_timeline_semaphore[]

include::{generated}/validity/structs/VkImportMetalSharedEventInfoEXT.txt[]
--
...
include::{generated}/api/basetypes/MTLSharedEvent_id.txt[]
--
