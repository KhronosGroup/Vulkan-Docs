...
ifdef::VK_ARM_tensors[]
| pname:maxTensorDimensionCount                            | - |      4 | min
| pname:maxTensorElements                                  | - |  65536 | min
| pname:maxPerDimensionTensorElements                      | - |  65536 | min
| pname:maxTensorStride                                    | - |  65536 | min
| pname:maxTensorSize                                      | - |  65536 | min
| pname:maxTensorShaderAccessArrayLength                   | - |      4 | min
| pname:maxTensorShaderAccessSize                          | - |      4 | min
| pname:maxDescriptorSetStorageTensors                     | - |     16 | min
| pname:maxPerStageDescriptorSetStorageTensors             | - |     16 | min
...
| pname:shaderTensorSupportedStages                        | - | ename:VK_SHADER_STAGE_COMPUTE_BIT | bitfield
endif::VK_ARM_tensors[]
ifdef::VK_EXT_ray_tracing_invocation_reorder[]
