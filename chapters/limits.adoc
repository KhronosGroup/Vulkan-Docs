...
ifdef::VK_KHR_workgroup_memory_explicit_layout[]
    ...
    Storage Buffer Layout>> rules, and with code:Boolean values considered
    as 32-bit integer values for the purpose of this calculation.
...
If the <<features-indirectCopy, indirect copies>> feature is supported,
...
ifdef::VK_VERSION_1_3,VK_KHR_synchronization2[]
  ...
  * [[limits-uniformTexelBufferDescriptorSize]]
    ...
    <<features-robustBufferAccess,robust buffer access>> feature is not
    enabled.
  * [[limits-robustUniformTexelBufferDescriptorSize]]
    ...
    <<features-robustBufferAccess,robust buffer access>> feature is enabled.
...
| pname:samplerDescriptorSize                       | - | 64 | max
| pname:combinedImageSamplerDescriptorSize          | - | 128 | max
| pname:sampledImageDescriptorSize                  | - | 64 | max
| pname:storageImageDescriptorSize                  | - | 128 | max
| pname:uniformTexelBufferDescriptorSize            | - | 64 | max
| pname:robustUniformTexelBufferDescriptorSize      | - | 64 | max
| pname:storageTexelBufferDescriptorSize            | - | 128 | max
| pname:robustStorageTexelBufferDescriptorSize      | - | 128 | max
| pname:uniformBufferDescriptorSize                 | - | 64 | max
| pname:robustUniformBufferDescriptorSize           | - | 64 | max
| pname:storageBufferDescriptorSize                 | - | 128 | max
| pname:robustStorageBufferDescriptorSize           | - | 128 | max
| pname:inputAttachmentDescriptorSize               | - | 64 | max
| pname:accelerationStructureDescriptorSize         | - | 64 | max
| pname:maxSamplerDescriptorBufferRange             | - | [eq]#2^11^ {times} pname:samplerDescriptorSize# | min
| pname:maxResourceDescriptorBufferRange            | - | [eq]#(2^20^ - 2^15^) {times} ptext:maxResourceDescriptorSize# ^11^ | min
...
ifdef::VK_EXT_fragment_density_map[]
| pname:combinedImageSamplerDensityMapDescriptorSize          | - | 192 | max
endif::VK_EXT_fragment_density_map[]
endif::VK_EXT_descriptor_buffer[]
ifdef::VK_HUAWEI_subpass_shading[]
