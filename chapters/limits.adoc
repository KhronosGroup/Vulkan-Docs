...
ifdef::VK_EXT_shader_64bit_indexing[]
    If the <<features-shader64BitIndexing, pname:shader64BitIndexing>>
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    <<limits-minSamplerHeapReservedRangeWithEmbedded,pname:minSamplerHeapReservedRangeWithEmbedded>>
    divided by <<limits-samplerDescriptorSize,pname:samplerDescriptorSize>>,
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    See <<descriptors-sampler>> and <<descriptors-combinedimagesampler>>.
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    member of the sname:VkDescriptorSetLayoutBinding structure has the bit
    for that shader stage set.
    See <<descriptors-uniformbuffer>> and
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    See <<descriptors-storagebuffer>> and
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    pname:stageFlags member of the sname:VkDescriptorSetLayoutBinding
    structure has the bit for that shader stage set.
    See <<descriptors-combinedimagesampler>>, <<descriptors-sampledimage>>,
    and <<descriptors-uniformtexelbuffer>>.
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    pname:stageFlags member of the sname:VkDescriptorSetLayoutBinding
    structure has the bit for that shader stage set.
    See <<descriptors-storageimage>>, and
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    See <<descriptors-inputattachment>>.
+
[NOTE]
====
pname:maxPerStageDescriptorInputAttachments was originally only intended to
...
slink:VkRenderingInputAttachmentIndexInfo for dynamic rendering, or
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    See <<descriptors-uniformbufferdynamic>>.
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
    ...
    See <<descriptors-storagebufferdynamic>>.
...
====
  ...
  * [[limits-minTexelBufferOffsetAlignment]]
    ...
    The value must: be a power of two.
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
    ...
    alignment and <<limits-uniformTexelBufferOffsetAlignmentBytes,
    pname:uniformTexelBufferOffsetAlignmentBytes>> or
    <<limits-storageTexelBufferOffsetAlignmentBytes,
    pname:storageTexelBufferOffsetAlignmentBytes>> depending on the
    descriptor type.
    ...
    format is pname:minTexelBufferOffsetAlignment.
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
ifndef::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
    The effective alignment requirement is
    pname:minTexelBufferOffsetAlignment, and
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
...
ifdef::VK_KHR_maintenance8[code:Offset or]
  ...
  * [[limits-minTexelGatherOffset]] pname:minTexelGatherOffset is the
    ...
    code:ConstOffsets image operands of any of the code:OpImage*Gather
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_create_renderpass2[]
  ...
  * [[limits-sampledImageColorSampleCounts]]
    ...
    all 2D images created with ename:VK_IMAGE_TILING_OPTIMAL, the
    ename:VK_IMAGE_USAGE_SAMPLED_BIT usage flag set, and a non-integer color
    format.
  * [[limits-sampledImageIntegerSampleCounts]]
    pname:sampledImageIntegerSampleCounts is a bitmask^1^ of
    elink:VkSampleCountFlagBits indicating the sample counts supported for
    all 2D images created with ename:VK_IMAGE_TILING_OPTIMAL, the
    ename:VK_IMAGE_USAGE_SAMPLED_BIT usage flag set, and an integer color
    format.
  * [[limits-sampledImageDepthSampleCounts]]
    pname:sampledImageDepthSampleCounts is a bitmask^1^ of
    elink:VkSampleCountFlagBits indicating the sample counts supported for
    all 2D images created with ename:VK_IMAGE_TILING_OPTIMAL, the
    ename:VK_IMAGE_USAGE_SAMPLED_BIT usage flag set, and a depth format.
  * [[limits-sampledImageStencilSampleCounts]]
    pname:sampledImageStencilSampleCounts is a bitmask^1^ of
    elink:VkSampleCountFlagBits indicating the sample counts supported for
    all 2D images created with ename:VK_IMAGE_TILING_OPTIMAL, the
    ename:VK_IMAGE_USAGE_SAMPLED_BIT usage flag set, and a stencil format.
  * [[limits-storageImageSampleCounts]] pname:storageImageSampleCounts is a
    ...
    and the ename:VK_IMAGE_USAGE_STORAGE_BIT usage flag set.
  ...
  * [[limits-timestampComputeAndGraphics]] pname:timestampComputeAndGraphics
    ...
    If this limit is ename:VK_TRUE, all queues that advertise the
...
ifndef::VK_BASE_VERSION_1_3,VK_KHR_copy_commands2[]
...
ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
    ...
    flink:vkCopyMemoryToImage and flink:vkCopyImageToMemory.
...
ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
    ...
    for flink:vkCopyMemoryToImage and flink:vkCopyImageToMemory.
endif::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
...
[open,refpage='VkPhysicalDevicePushDescriptorProperties',desc='Structure describing push descriptor limits that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDevicePushDescriptorProperties structure is defined as:

include::{generated}/api/structs/VkPhysicalDevicePushDescriptorProperties.adoc[]
...
// tag::VK_KHR_push_descriptor-properties[]
  * [[{anchor-prefix}limits-maxPushDescriptors]] pname:maxPushDescriptors is
...
// end::VK_KHR_push_descriptor-properties[]

:refpage: VkPhysicalDevicePushDescriptorProperties
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDevicePushDescriptorProperties.adoc[]
--
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float_controls[]
[open,refpage='VkPhysicalDeviceFloatControlsProperties',desc='Structure describing properties supported by VK_KHR_shader_float_controls',type='structs']
--
...
[open,refpage='VkShaderFloatControlsIndependence',desc='Bitmask specifying whether, and how, shader float controls can be set separately',type='enums']
--
...
--
endif::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float_controls[]
...
// tag::VK_KHR_subgroup-properties[]
  ...
  * [[{anchor-prefix}limits-subgroupSupportedStages]]
    ...
    describing the shader stages that <<shaders-group-operations, group
    operations>> with <<shaders-scope-subgroup, subgroup scope>> are
    supported in.
  ...
  * [[{anchor-prefix}limits-subgroupSupportedOperations]]
...
or the <<features-shaderSubgroupUniformControlFlow,
pname:shaderSubgroupUniformControlFlow>> feature is enabled,
...
greater than or equal to 2, and the <<features-shaderSubgroupRotate,
pname:shaderSubgroupRotate>> feature is supported,
ename:VK_SUBGROUP_FEATURE_ROTATE_BIT must: be returned in
...
pname:shaderSubgroupRotateClustered>> feature is supported,
ename:VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT must: be returned in
ifdef::VK_COMPUTE_VERSION_1_2[]
slink:VkPhysicalDeviceVulkan11Properties::pname:subgroupSupportedOperations
and
endif::VK_COMPUTE_VERSION_1_2[]
...
If Vulkan 1.4 is supported, ename:VK_SUBGROUP_FEATURE_ROTATE_BIT and
ename:VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT must: be returned in
slink:VkPhysicalDeviceSubgroupProperties::pname:supportedOperations and
slink:VkPhysicalDeviceVulkan11Properties::pname:subgroupSupportedOperations
...
[NOTE]
====
ename:VK_SUBGROUP_FEATURE_ROTATE_BIT and
ename:VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT were added in version 2 of
the apiext:VK_KHR_shader_subgroup_rotate extension, after the initial
...
If the <<features-shaderSubgroupPartitioned,
pname:shaderSubgroupPartitioned>> feature is supported,
pname:supportedOperations must: include <<features-subgroup-partitioned,
ename:VK_SUBGROUP_FEATURE_PARTITIONED_BIT_EXT>>.
...
ifdef::VK_EXT_shader_subgroup_partitioned,VK_NV_shader_subgroup_partitioned[]
  * [[features-subgroup-partitioned]]
    ename:VK_SUBGROUP_FEATURE_PARTITIONED_BIT_EXT specifies the device will
    accept SPIR-V shader modules containing the
    code:GroupNonUniformPartitionedEXT capability.
endif::VK_EXT_shader_subgroup_partitioned,VK_NV_shader_subgroup_partitioned[]
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_shader_subgroup_rotate[]
  * [[features-subgroup-rotate]] ename:VK_SUBGROUP_FEATURE_ROTATE_BIT
    specifies the device will accept SPIR-V shader modules containing the
    code:GroupNonUniformRotateKHR capability.
  * [[features-subgroup-rotate-clustered]]
    ename:VK_SUBGROUP_FEATURE_ROTATE_CLUSTERED_BIT specifies the device will
    accept SPIR-V shader modules that use the code:ClusterSize operand to
...
[open,refpage='VkPhysicalDeviceSubgroupSizeControlProperties',desc='Structure describing the control subgroup size properties of an implementation',type='structs']
--
...
// tag::VK_EXT_subgroup_size_control-properties[]
  * [[{anchor-prefix}limits-minSubgroupSize]] pname:minSubgroupSize is the
    ...
    pname:minSubgroupSize is less than or equal to <<limits-subgroupSize,
    pname:subgroupSize>>.
  * [[{anchor-prefix}limits-maxSubgroupSize]] pname:maxSubgroupSize is the
    ...
    pname:maxSubgroupSize is greater than or equal to <<limits-subgroupSize,
    pname:subgroupSize>>.
...
include::{generated}/api/structs/VkPhysicalDeviceBlendOperationAdvancedPropertiesEXT.adoc[]
  ...
  * [[limits-advancedBlendMaxColorAttachments]]
    ...
    a pipeline that uses an <<framebuffer-blend-advanced,advanced blend
    operation>>.
...
// VkPhysicalDeviceVertexAttributeDivisorProperties includes identical
// language for maxVertexAttribDivisor, but it is less work to just
// duplicate it here than try to transclude part of that structure here and
// all of it in the Vulkan 1.4 properties structure.

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[extension-limits-maxVertexAttribDivisor]] pname:maxVertexAttribDivisor
...
[open,refpage='VkPhysicalDeviceVertexAttributeDivisorProperties',desc='Structure describing max value of vertex attribute divisor that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceVertexAttributeDivisorProperties structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceVertexAttributeDivisorProperties.adoc[]
...
// tag::VK_KHR_vertex_attribute_divisor-properties[]
  ...
  * [[{anchor-prefix}limits-supportsNonZeroFirstInstance]]
    ...
    is supported when
    slink:VkVertexInputBindingDivisorDescription::pname:divisor is not `1`.
// end::VK_KHR_vertex_attribute_divisor-properties[]

:refpage: VkPhysicalDeviceVertexAttributeDivisorProperties
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceVertexAttributeDivisorProperties.adoc[]
--
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_vertex_attribute_divisor[]

ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_sampler_filter_minmax[]
[open,refpage='VkPhysicalDeviceSamplerFilterMinmaxProperties',desc='Structure describing sampler filter minmax limits that can be supported by an implementation',type='structs']
--
...
Only the pname:r component of the sampled image value is defined; reading
...
// Must have preceding whitespace
ifdef::VK_BASE_VERSION_1_1[:anchor-prefix: extension-]
ifndef::VK_BASE_VERSION_1_1[:anchor-prefix:]
...
// tag::VK_KHR_maintenance3-properties[]
  ...
  * [[{anchor-prefix}limits-maxMemoryAllocationSize]]
    ...
    If slink:VkMemoryAllocateInfo::pname:allocationSize is larger the error
    ename:VK_ERROR_OUT_OF_DEVICE_MEMORY may: be returned.
...
[open,refpage='VkPhysicalDeviceMaintenance4Properties',desc='Structure describing various implementation-defined properties introduced with VK_KHR_maintenance4',type='structs']
--
...
[open,refpage='VkPhysicalDeviceMaintenance5Properties',desc='Structure describing various implementation-defined properties introduced with VK_KHR_maintenance5',type='structs']
--
The sname:VkPhysicalDeviceMaintenance5Properties structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceMaintenance5Properties.adoc[]
...
// tag::VK_KHR_maintenance5-properties[]
...
// end::VK_KHR_maintenance5-properties[]

:refpage: VkPhysicalDeviceMaintenance5Properties
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceMaintenance5Properties.adoc[]
--
endif::VK_BASE_VERSION_1_4,VK_KHR_maintenance5[]

ifdef::VK_BASE_VERSION_1_4,VK_KHR_maintenance6[]
[open,refpage='VkPhysicalDeviceMaintenance6Properties',desc='Structure describing various implementation-defined properties introduced with VK_KHR_maintenance6',type='structs']
--
The sname:VkPhysicalDeviceMaintenance6Properties structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceMaintenance6Properties.adoc[]
...
ifdef::VK_BASE_VERSION_1_4[:anchor-prefix: extension-]
ifndef::VK_BASE_VERSION_1_4[:anchor-prefix:]
// tag::VK_KHR_maintenance6-properties[]
...
// end::VK_KHR_maintenance6-properties[]

:refpage: VkPhysicalDeviceMaintenance6Properties
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceMaintenance6Properties.adoc[]
--
endif::VK_BASE_VERSION_1_4,VK_KHR_maintenance6[]

ifdef::VK_KHR_maintenance7[]
[open,refpage='VkPhysicalDeviceMaintenance7PropertiesKHR',desc='Structure describing various implementation-defined properties introduced with VK_KHR_maintenance7',type='structs']
--
The sname:VkPhysicalDeviceMaintenance7PropertiesKHR structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceMaintenance7PropertiesKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-robustFragmentShadingRateAttachmentAccess]]
    pname:robustFragmentShadingRateAttachmentAccess indicates whether the
    scaled size of a fragment shading rate attachment can: be less than the
    size of the render area.
    If pname:robustFragmentShadingRateAttachmentAccess is ename:VK_FALSE,
    the size of the attachment multiplied by the texel size must: be greater
    than or equal to the size of the render area.
    If it is ename:VK_TRUE and the fragment shading rate attachment was
    created with slink:VkImageSubresourceRange::pname:baseMipLevel equal to
    0, the scaled size can: be smaller than the render area, with missing
    shading rates defined by <<shaders-execution-memory-access-bounds, out
    of bounds behavior>>.
  * [[limits-separateDepthStencilAttachmentAccess]]
    pname:separateDepthStencilAttachmentAccess indicates support for writing
    to one aspect of a depth/stencil attachment without performing
    read-modify-write operations on the other aspect.
    If this property is ename:VK_TRUE, writes to one aspect must: not result
    in read-modify-write operations on the other aspect.
    If ename:VK_FALSE, writes to one aspect may: result in writes to the
    other aspect as defined by <<renderpass-load-operations,render pass load
    operations>>, <<renderpass-store-operations,render pass store
    operations>> and <<renderpass-resolve-operations,render pass resolve
    operations>>.
  * [[limits-maxDescriptorSetTotalUniformBuffersDynamic]]
    pname:maxDescriptorSetTotalUniformBuffersDynamic is the maximum total
  ...
  * [[limits-maxDescriptorSetTotalStorageBuffersDynamic]]
    pname:maxDescriptorSetTotalStorageBuffersDynamic is the maximum total
  ...
  * [[limits-maxDescriptorSetTotalBuffersDynamic]]
    pname:maxDescriptorSetTotalBuffersDynamic is the maximum total count of
  ...
  * [[limits-maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic]]
    pname:maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic is
    similar to pname:maxDescriptorSetTotalUniformBuffersDynamic but counts
    ...
    ename:VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT, and can: include
    dynamic uniform buffer descriptors in descriptor set layouts created
    with ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT,
  ...
  * [[limits-maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic]]
    pname:maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic is
    similar to pname:maxDescriptorSetTotalStorageBuffersDynamic but counts
    descriptors from descriptor sets created with or without the
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT bit
    set.
  ...
  * [[limits-maxDescriptorSetUpdateAfterBindTotalBuffersDynamic]]
    pname:maxDescriptorSetUpdateAfterBindTotalBuffersDynamic is similar to
    pname:maxDescriptorSetTotalBuffersDynamic but counts descriptors from
    ...
    with ename:VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT, and can:
...
:refpage: VkPhysicalDeviceMaintenance7PropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceMaintenance7PropertiesKHR.adoc[]
--

[open,refpage='VkPhysicalDeviceLayeredApiPropertiesListKHR',desc='Structure describing layered implementations underneath the Vulkan physical device',type='structs']
--
The sname:VkPhysicalDeviceLayeredApiPropertiesListKHR structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceLayeredApiPropertiesListKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:layeredApiCount is an integer related to the number of layered
    implementations underneath the Vulkan physical device, as described
    below.
  * pname:pLayeredApis is a pointer to an array of
    slink:VkPhysicalDeviceLayeredApiPropertiesKHR in which information
    regarding the layered implementations underneath the Vulkan physical
    device are returned.

If pname:pLayeredApis is `NULL`, then the number of layered implementations
that are underneath the top-most Vulkan physical device (i.e. the one
returned by flink:vkGetPhysicalDeviceProperties2) is returned in
pname:layeredApiCount.
Otherwise, pname:layeredApiCount must: be set by the application to the
number of elements in the pname:pLayeredApis array, and on return is
overwritten with the number of values actually written to
pname:pLayeredApis.
If the value of pname:layeredApiCount is less than the number of layered
implementations underneath the Vulkan physical device, at most
pname:layeredApiCount values will be written to pname:pLayeredApis.
...
pname:pLayeredApis corresponds to an API implementation that is implemented
...
:refpage: VkPhysicalDeviceLayeredApiPropertiesListKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceLayeredApiPropertiesListKHR.adoc[]
--

[open,refpage='VkPhysicalDeviceLayeredApiPropertiesKHR',desc='Structure describing a single layered implementation underneath the Vulkan physical device',type='structs']
--
The sname:VkPhysicalDeviceLayeredApiPropertiesKHR structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceLayeredApiPropertiesKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:vendorID is a unique identifier for the vendor of the layered
    implementation.
  * pname:deviceID is a unique identifier for the layered implementation
    among devices available from the vendor.
  * pname:layeredAPI is a elink:VkPhysicalDeviceLayeredApiKHR specifying the
...
If pname:layeredAPI is ename:VK_PHYSICAL_DEVICE_LAYERED_API_VULKAN_KHR,
additional Vulkan-specific information can be queried by including the
slink:VkPhysicalDeviceLayeredApiVulkanPropertiesKHR structure in the
pname:pNext chain.
Otherwise if such a structure is included in the pname:pNext chain, it is
ignored.

include::{generated}/validity/structs/VkPhysicalDeviceLayeredApiPropertiesKHR.adoc[]
--

[open,refpage='VkPhysicalDeviceLayeredApiKHR',desc='API implemented by the layered implementation',type='enums']
--
The list of possible API implementations of a layered implementation
underneath the Vulkan physical device, as returned in
slink:VkPhysicalDeviceLayeredApiPropertiesKHR::pname:layeredAPI, are:

include::{generated}/api/enums/VkPhysicalDeviceLayeredApiKHR.adoc[]

  * ename:VK_PHYSICAL_DEVICE_LAYERED_API_VULKAN_KHR - the device implements
    the Vulkan API.
  * ename:VK_PHYSICAL_DEVICE_LAYERED_API_D3D12_KHR - the device implements
    the D3D12 API.
  * ename:VK_PHYSICAL_DEVICE_LAYERED_API_METAL_KHR - the device implements
    the Metal API.
  * ename:VK_PHYSICAL_DEVICE_LAYERED_API_OPENGL_KHR - the device implements
    the OpenGL API.
  * ename:VK_PHYSICAL_DEVICE_LAYERED_API_OPENGLES_KHR - the device
    implements the OpenGL ES API.
--

[open,refpage='VkPhysicalDeviceLayeredApiVulkanPropertiesKHR',desc='Structure describing physical device properties of a layered Vulkan implementation underneath the Vulkan physical device',type='structs']
--
The sname:VkPhysicalDeviceLayeredApiVulkanPropertiesKHR structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:properties is a slink:VkPhysicalDeviceProperties2 in which
    properties of the underlying layered Vulkan implementation are returned.

The implementation must: zero-fill the contents of
pname:properties.properties.limits and
pname:properties.properties.sparseProperties.

.Valid Usage
****
  * [[VUID-VkPhysicalDeviceLayeredApiVulkanPropertiesKHR-pNext-10011]]
    Only slink:VkPhysicalDeviceDriverProperties and
    slink:VkPhysicalDeviceIDProperties are allowed in the pname:pNext chain
    of pname:properties
****

include::{generated}/validity/structs/VkPhysicalDeviceLayeredApiVulkanPropertiesKHR.adoc[]
--
endif::VK_KHR_maintenance7[]

ifdef::VK_KHR_maintenance9[]
[open,refpage='VkPhysicalDeviceMaintenance9PropertiesKHR',desc='Structure describing various implementation-defined properties introduced with VK_KHR_maintenance9',type='structs']
--
The sname:VkPhysicalDeviceMaintenance9PropertiesKHR structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceMaintenance9PropertiesKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
ifdef::VK_EXT_image_2d_view_of_3d[]
  * [[limits-image2DViewOf3DSparse]] If the <<features-image2DViewOf3D,
    pname:image2DViewOf3D>> feature is enabled, pname:image2DViewOf3DSparse
  ...
  * [[limits-defaultVertexAttributeValue]] pname:defaultVertexAttributeValue
    is a elink:VkDefaultVertexAttributeValueKHR that indicates what value
    ...
    slink:VkVertexInputAttributeDescription::pname:location defined in the
    bound graphics pipeline
ifdef::VK_EXT_vertex_input_dynamic_state[]
    or no corresponding
    slink:VkVertexInputAttributeDescription2EXT::pname:location set by the
    most recent call to flink:vkCmdSetVertexInputEXT when the state is
    dynamic
endif::VK_EXT_vertex_input_dynamic_state[]
    .

:refpage: VkPhysicalDeviceMaintenance9PropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceMaintenance9PropertiesKHR.adoc[]
--

[open,refpage='VkDefaultVertexAttributeValueKHR',desc='Values returned for unbound vertex attributes',type='enums']
--
The possible values returned by the implementation when the vertex shader
reads an unbound vertex attribute are:

include::{generated}/api/enums/VkDefaultVertexAttributeValueKHR.adoc[]

  * ename:VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ZERO_KHR - the
    value read for an unbound vertex attribute is (0,0,0,0).
  * ename:VK_DEFAULT_VERTEX_ATTRIBUTE_VALUE_ZERO_ZERO_ZERO_ONE_KHR - the
    value read for an unbound vertex attribute is (0,0,0,1).
--
endif::VK_KHR_maintenance9[]

ifdef::VK_KHR_maintenance10[]
[open,refpage='VkPhysicalDeviceMaintenance10PropertiesKHR',desc='Structure describing various implementation-defined properties introduced with VK_KHR_maintenance10',type='structs']
--
The sname:VkPhysicalDeviceMaintenance10PropertiesKHR structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceMaintenance10PropertiesKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-rgba4OpaqueBlackSwizzled]] pname:rgba4OpaqueBlackSwizzled
    indicates whether correct swizzling is applied to the opaque black
    border color when using either the ename:VK_FORMAT_B4G4R4A4_UNORM_PACK16
    or ename:VK_FORMAT_R4G4B4A4_UNORM_PACK16 format.
    If it is ename:VK_TRUE, the implementation will correctly produce an
    opaque black border color with these formats.
    If it is ename:VK_FALSE, the implementation may: swap the first channel
    with the alpha channel for the border color when sampling.
  * [[limits-resolveSrgbFormatAppliesTransferFunction]]
    pname:resolveSrgbFormatAppliesTransferFunction indicates whether
    ...
    resolve commands.
    If ename:VK_TRUE, implementation always converts to linear before
    averaging unless overridden.
    If ename:VK_FALSE, implementation never converts to linear before
    averaging unless overridden.
  * [[limits-resolveSrgbFormatSupportsTransferFunctionControl]]
    pname:resolveSrgbFormatSupportsTransferFunctionControl indicates whether
    the implementation supports overriding the default behavior in
    pname:resolveSrgbFormatAppliesTransferFunction in
ifdef::VK_VERSION_1_3,VK_KHR_copy_commands2[]
    render passes and flink:vkCmdResolveImage2.
endif::VK_VERSION_1_3,VK_KHR_copy_commands2[]
ifndef::VK_VERSION_1_3,VK_KHR_copy_commands2[]
    render passes.
endif::VK_VERSION_1_3,VK_KHR_copy_commands2[]

Implementations supporting <<features-maintenance10,pname:maintenance10>>
should: set pname:resolveSrgbFormatAppliesTransferFunction to ename:VK_TRUE.

:refpage: VkPhysicalDeviceMaintenance10PropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceMaintenance10PropertiesKHR.adoc[]
--
...
describe the following implementation-dependent limits:
  ...
  * [[limits-maxTaskWorkGroupTotalCount]] pname:maxTaskWorkGroupTotalCount
    ...
    task shader by a <<drawing-mesh-shading,mesh tasks drawing command>>.
  * [[limits-maxTaskWorkGroupCount]] pname:maxTaskWorkGroupCount[3] is the
    ...
    shader in each dimension by a <<drawing-mesh-shading,mesh tasks drawing
    command>>.
    These three values represent the maximum number of local workgroups for
    the X, Y, and Z dimensions, respectively.
...
ifdef::VK_KHR_maintenance4[or code:LocalSizeId]
  ...
  * [[limits-maxMeshWorkGroupTotalCount]] pname:maxMeshWorkGroupTotalCount
    is the maximum number of local workgroups that can: be launched for a
    mesh shader, either directly by a <<drawing-mesh-shading,mesh tasks
    drawing command>>, or emitted by a single task shader workgroup.
  * [[limits-maxMeshWorkGroupCount]] pname:maxMeshWorkGroupCount[3] is the
    ...
    <<drawing-mesh-shading,mesh tasks drawing command>>, or emitted by a
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
[open,refpage='VkPhysicalDeviceDescriptorIndexingProperties',desc='Structure describing descriptor indexing properties that can be supported by an implementation',type='structs']
--
...
ifdef::VK_EXT_pipeline_robustness,VK_COMPUTE_VERSION_1_4[]
    Similarly, if this property is ename:VK_FALSE, robustness must: not be
    enabled through the slink:VkPipelineRobustnessCreateInfo mechanism.
endif::VK_EXT_pipeline_robustness,VK_COMPUTE_VERSION_1_4[]
  ...
  * [[{anchor-prefix}limits-maxDescriptorSetUpdateAfterBindInputAttachments]]
    ...
    pool created with ename:VK_DESCRIPTOR_POOL_CREATE_UPDATE_AFTER_BIND_BIT,
    ...
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT than in
    a pipeline layout not including any descriptor set layouts created with
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT and
    may: be zero to indicate that only the
    pname:maxDescriptorSetInputAttachments applies.
...
[open,refpage='VkPhysicalDeviceInlineUniformBlockProperties',desc='Structure describing inline uniform block properties that can be supported by an implementation',type='structs']
--
...
// tag::VK_EXT_inline_uniform_block-properties[]
  * [[{anchor-prefix}limits-maxInlineUniformBlockSize]]
    ...
    <<descriptors-inlineuniformblock, inline uniform block>> binding.
...
[open,refpage='VkPhysicalDeviceShaderSplitBarrierPropertiesEXT',desc='Structure describing split barrier properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceShaderSplitBarrierPropertiesEXT structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceShaderSplitBarrierPropertiesEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-splitBarrierReservedSharedMemory]]
    pname:splitBarrierReservedSharedMemory is the number of bytes of shared
    memory reserved for the implementation when the module executes
    code:OpControlBarrierArriveEXT or code:OpControlBarrierWaitEXT
    instructions

:refpage: VkPhysicalDeviceShaderSplitBarrierPropertiesEXT
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceShaderSplitBarrierPropertiesEXT.adoc[]
--
...
[open,refpage='VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT',desc='Structure describing fragment density map offset properties that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT.adoc[]
...
:refpage: VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceFragmentDensityMapOffsetPropertiesEXT.adoc[]
--
endif::VK_QCOM_fragment_density_map_offset,VK_EXT_fragment_density_map_offset[]

ifdef::VK_VALVE_fragment_density_map_layered[]
[open,refpage='VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE',desc='Structure describing fragment density map layered properties that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE structure
is defined as:

include::{generated}/api/structs/VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE.adoc[]
...
:refpage: VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceFragmentDensityMapLayeredPropertiesVALVE.adoc[]
--
endif::VK_VALVE_fragment_density_map_layered[]
endif::VK_EXT_fragment_density_map[]

ifdef::VK_QCOM_tile_memory_heap[]
[open,refpage='VkPhysicalDeviceTileMemoryHeapPropertiesQCOM',desc='Structure describing tile memory heap properties that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceTileMemoryHeapPropertiesQCOM structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceTileMemoryHeapPropertiesQCOM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-queueSubmitBoundary]] pname:queueSubmitBoundary is a boolean
  ...
  * [[limits-tileBufferTransfers]] pname:tileBufferTransfers is a boolean
    describing if buffers bound to tile memory support transfer operations.

:refpage: VkPhysicalDeviceTileMemoryHeapPropertiesQCOM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceTileMemoryHeapPropertiesQCOM.adoc[]
--
...
[open,refpage='VkPhysicalDeviceDepthStencilResolveProperties',desc='Structure describing depth/stencil resolve properties that can be supported by an implementation',type='structs']
--
...
[open,refpage='VkPhysicalDeviceMemoryDecompressionPropertiesEXT',desc='Structure describing supported memory decompression methods by an implementation',type='structs']
--
The sname:VkPhysicalDeviceMemoryDecompressionPropertiesEXT structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceMemoryDecompressionPropertiesEXT.adoc[]
...
include::{generated}/api/structs/VkPhysicalDeviceMemoryDecompressionPropertiesNV.adoc[]
  ...
  * pname:decompressionMethods is a bitmask of
    elink:VkMemoryDecompressionMethodFlagBitsEXT specifying memory
  ...
  * pname:maxDecompressionIndirectCount specifies the maximum supported
    ...
    flink:vkCmdDecompressMemoryIndirectCountEXT::pname:maxDecompressionCount
    or the value specified in
    flink:vkCmdDecompressMemoryIndirectCountEXT::pname:indirectCommandsCountAddress

If <<features-memoryDecompression, pname:memoryDecompression>> feature is
supported, pname:decompressionMethods must: have at least one bit set.

:refpage: VkPhysicalDeviceMemoryDecompressionPropertiesEXT
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceMemoryDecompressionPropertiesEXT.adoc[]
--
...
include::{generated}/api/structs/VkPhysicalDeviceTransformFeedbackPropertiesEXT.adoc[]
  ...
  * [[limits-maxTransformFeedbackStreams]] pname:maxTransformFeedbackStreams
    ...
    then pname:maxTransformFeedbackStreams must: be `1`.
...
[open,refpage='VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR',desc='Structure describing supported queues for indirect copy',type='structs']
--
The sname:VkPhysicalDeviceCopyMemoryIndirectPropertiesNV structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR.adoc[]
...
include::{generated}/api/structs/VkPhysicalDeviceCopyMemoryIndirectPropertiesNV.adoc[]
  ...
  * pname:supportedQueues is a bitmask of elink:VkQueueFlagBits indicating
    the types of queues on which <<indirect-copies, indirect copy commands>>
    are supported.
    If a queue family supports any of the bits set in pname:supportedQueues,
    then it must: support at least one <<indirect-copies, indirect copy
    command>>.

If the <<features-indirectMemoryCopy, pname:indirectMemoryCopy>> or
<<features-indirectMemoryToImageCopy, pname:indirectMemoryToImageCopy>>
feature is supported, pname:supportedQueues must: return at least one
supported queue type.

:refpage: VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceCopyMemoryIndirectPropertiesKHR.adoc[]
--
...
include::{generated}/api/structs/VkPhysicalDeviceRayTracingPipelinePropertiesKHR.adoc[]
  ...
  * [[limits-maxShaderGroupStride]] pname:maxShaderGroupStride is the
...
[open,refpage='VkPhysicalDeviceCooperativeMatrix2PropertiesNV',desc='Structure describing cooperative matrix properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceCooperativeMatrix2PropertiesNV structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceCooperativeMatrix2PropertiesNV.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-cooperativeMatrixWorkgroupScopeMaxWorkgroupSize]]
    pname:cooperativeMatrixWorkgroupScopeMaxWorkgroupSize is the maximum
    number of invocations in a workgroup when the module uses
    code:OpTypeCooperativeMatrixKHR with code:Scope equal to code:Workgroup.
  * [[limits-cooperativeMatrixFlexibleDimensionsMaxDimension]]
    pname:cooperativeMatrixFlexibleDimensionsMaxDimension is the maximum
    supported dimension for cooperative matrix types when the
    <<features-cooperativeMatrixFlexibleDimensions,pname:cooperativeMatrixFlexibleDimensions>>
    feature is enabled.
  * [[limits-cooperativeMatrixWorkgroupScopeReservedSharedMemory]]
    pname:cooperativeMatrixWorkgroupScopeReservedSharedMemory is the number
    of bytes of shared memory reserved for the implementation when the
    module uses code:OpTypeCooperativeMatrixKHR with code:Scope equal to
    code:Workgroup.

:refpage: VkPhysicalDeviceCooperativeMatrix2PropertiesNV
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceCooperativeMatrix2PropertiesNV.adoc[]
--
endif::VK_NV_cooperative_matrix2[]

ifdef::VK_NV_cooperative_vector[]
[open,refpage='VkPhysicalDeviceCooperativeVectorPropertiesNV',desc='Structure describing cooperative vector properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceCooperativeVectorPropertiesNV structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceCooperativeVectorPropertiesNV.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-cooperativeVectorSupportedStages]]
    pname:cooperativeVectorSupportedStages is a bitfield of
    elink:VkShaderStageFlagBits describing the shader stages that
    cooperative vector instructions are supported in.
    pname:cooperativeVectorSupportedStages will have the
    ename:VK_SHADER_STAGE_COMPUTE_BIT bit set if any of the physical
    device's queues support ename:VK_QUEUE_COMPUTE_BIT.
  * [[limits-cooperativeVectorTrainingFloat16Accumulation]]
    pname:cooperativeVectorTrainingFloat16Accumulation is ename:VK_TRUE if
  ...
  * [[limits-cooperativeVectorTrainingFloat32Accumulation]]
    pname:cooperativeVectorTrainingFloat32Accumulation is ename:VK_TRUE if
    the implementation supports cooperative vector training functions
    accumulating 32-bit floating-point results.
  * [[limits-maxCooperativeVectorComponents]]
    pname:maxCooperativeVectorComponents indicates the maximum number of
    components that can: be in a cooperative vector.

:refpage: VkPhysicalDeviceCooperativeVectorPropertiesNV
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceCooperativeVectorPropertiesNV.adoc[]
--
endif::VK_NV_cooperative_vector[]

ifdef::VK_EXT_shader_long_vector[]
[open,refpage='VkPhysicalDeviceShaderLongVectorPropertiesEXT',desc='Structure describing long vector properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceShaderLongVectorPropertiesEXT structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceShaderLongVectorPropertiesEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxVectorComponents]] pname:maxVectorComponents indicates the
    maximum number of components that can: be in a vector type.

:refpage: VkPhysicalDeviceShaderLongVectorPropertiesEXT
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceShaderLongVectorPropertiesEXT.adoc[]
--
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
[open,refpage='VkPhysicalDeviceTexelBufferAlignmentProperties',desc='Structure describing the texel buffer alignment requirements supported by an implementation',type='structs']
--
...
[open,refpage='VkPhysicalDeviceTimelineSemaphoreProperties',desc='Structure describing timeline semaphore properties that can be supported by an implementation',type='structs']
--
...
[open,refpage='VkPhysicalDeviceLineRasterizationProperties',desc='Structure describing line rasterization properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceLineRasterizationProperties structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceLineRasterizationProperties.adoc[]
...
ifdef::VK_GRAPHICS_VERSION_1_4[:anchor-prefix: extension-]
ifndef::VK_GRAPHICS_VERSION_1_4[:anchor-prefix:]
// tag::VK_KHR_line_rasterization-properties[]
  * [[{anchor-prefix}limits-lineSubPixelPrecisionBits]]
    pname:lineSubPixelPrecisionBits is the number of bits of subpixel
    precision in framebuffer coordinates [eq]#x~f~# and [eq]#y~f~# when
    rasterizing <<primsrast-lines,line segments>>.
// end::VK_KHR_line_rasterization-properties[]

:refpage: VkPhysicalDeviceLineRasterizationProperties
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceLineRasterizationProperties.adoc[]
--
...
[open,refpage='VkPhysicalDeviceRobustness2PropertiesKHR',desc='Structure describing robust buffer access properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceRobustness2PropertiesKHR structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceRobustness2PropertiesKHR.adoc[]
...
:refpage: VkPhysicalDeviceRobustness2PropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceRobustness2PropertiesKHR.adoc[]
--
...
[open,refpage='VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT',desc='Structure describing push descriptor limits that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxIndirectPipelineCount]] pname:maxIndirectPipelineCount is
    the maximum number of pipelines passed to
    flink:vkCreateIndirectExecutionSetEXT.
ifdef::VK_EXT_shader_object[]
  * [[limits-maxIndirectShaderObjectCount]]
    pname:maxIndirectShaderObjectCount is the maximum number of shader
    objects passed to flink:vkCreateIndirectExecutionSetEXT.
    If this value is zero, binding shader objects indirectly is not
    supported.
endif::VK_EXT_shader_object[]
  * [[limits-maxIndirectSequenceCount]] pname:maxIndirectSequenceCount is
    the maximum number of sequences in slink:VkGeneratedCommandsInfoEXT and
    in slink:VkGeneratedCommandsMemoryRequirementsInfoEXT.
  * [[limits-maxIndirectCommandsTokenCount]]
    pname:maxIndirectCommandsTokenCount is the maximum number of tokens in
    slink:VkIndirectCommandsLayoutCreateInfoEXT.
  * [[limits-maxIndirectCommandsTokenOffset]]
    pname:maxIndirectCommandsTokenOffset is the maximum offset in
    slink:VkIndirectCommandsLayoutTokenEXT.
  * [[limits-maxIndirectCommandsIndirectStride]]
    pname:maxIndirectCommandsIndirectStride is the maximum stream stride in
    slink:VkIndirectCommandsLayoutCreateInfoEXT.
  * [[limits-supportedIndirectCommandsInputModes]]
    pname:supportedIndirectCommandsInputModes indicates the supported input
    modes.
  * [[limits-supportedIndirectCommandsShaderStages]]
    pname:supportedIndirectCommandsShaderStages indicates the stages which
  ...
  * [[limits-supportedIndirectCommandsShaderStagesPipelineBinding]]
    pname:supportedIndirectCommandsShaderStagesPipelineBinding indicates the
...
ifdef::VK_EXT_shader_object[]
  * [[limits-supportedIndirectCommandsShaderStagesShaderBinding]]
    pname:supportedIndirectCommandsShaderStagesShaderBinding indicates the
    stages which can: be used within indirect execution sets for indirectly
    binding shader stages using shader objects.
endif::VK_EXT_shader_object[]
  * [[limits-deviceGeneratedCommandsTransformFeedback]]
    pname:deviceGeneratedCommandsTransformFeedback indicates whether the
    implementation supports interactions with
    `apiext:VK_EXT_transform_feedback` for pipelines not created with
    ename:VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_EXT.
  * [[limits-deviceGeneratedCommandsMultiDrawIndirectCount]]
    pname:deviceGeneratedCommandsMultiDrawIndirectCount indicates whether
    the implementation supports COUNT variants of multi-draw indirect
    tokens.

:refpage: VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceDeviceGeneratedCommandsPropertiesEXT.adoc[]
--
...
[open,refpage='VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV',desc='Structure describing properties supported by a partitioned acceleration structure implementation',type='structs']
--
The sname:VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV
structure is defined as:

include::{generated}/api/structs/VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxPartitionCount]] pname:maxPartitionCount indicates the
    maximum number of partitions allowed in a partitioned acceleration
    structure.

:refpage: VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDevicePartitionedAccelerationStructurePropertiesNV.adoc[]
--
endif::VK_NV_partitioned_acceleration_structure[]

ifdef::VK_NV_cluster_acceleration_structure[]
[open,refpage='VkPhysicalDeviceClusterAccelerationStructurePropertiesNV',desc='Structure describing properties supported by a cluster acceleration structure implementation',type='structs']
--
The sname:VkPhysicalDeviceClusterAccelerationStructurePropertiesNV structure
is defined as:

include::{generated}/api/structs/VkPhysicalDeviceClusterAccelerationStructurePropertiesNV.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxVerticesPerCluster]] pname:maxVerticesPerCluster indicates
    the maximum number of unique vertices that can: be specified in the
    index buffer for a cluster.
  * [[limits-maxTrianglesPerCluster]] pname:maxTrianglesPerCluster indicates
    the maximum number of triangles in a cluster.
  * [[limits-clusterScratchByteAlignment]] pname:clusterScratchByteAlignment
    indicates the alignment required for scratch memory used in building or
    moving cluster acceleration structures.
  * [[limits-clusterByteAlignment]] pname:clusterByteAlignment indicates the
    alignment of buffers when building cluster acceleration structures.
  * [[limits-clusterTemplateByteAlignment]]
    pname:clusterTemplateByteAlignment indicates the alignment of buffers
    when building cluster templates.
  * [[limits-clusterBottomLevelByteAlignment]]
    pname:clusterBottomLevelByteAlignment indicates the alignment of buffers
...
:refpage: VkPhysicalDeviceClusterAccelerationStructurePropertiesNV
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceClusterAccelerationStructurePropertiesNV.adoc[]
--
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_EXT_shader_viewport_index_layer[or]
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_multiview,VK_GRAPHICS_VERSION_1_2,VK_EXT_shader_viewport_index_layer[or]
    the <<features-geometryShader, pname:geometryShader>> feature is not
...
include::{generated}/api/structs/VkPhysicalDeviceDescriptorBufferPropertiesEXT.adoc[]
  ...
  * [[limits-combinedImageSamplerDescriptorSingleArray]]
    ...
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER descriptors to be
  ...
  * [[limits-bufferlessPushDescriptors]] pname:bufferlessPushDescriptors
    ...
    the ename:VK_BUFFER_USAGE_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT
...
ifdef::VK_BASE_VERSION_1_3,VK_KHR_synchronization2[]
  ...
  * [[limits-maxResourceDescriptorBufferBindings]]
    ...
    ename:VK_BUFFER_USAGE_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT that can: be
    used.
  * [[limits-maxSamplerDescriptorBufferBindings]]
    ...
    ename:VK_BUFFER_USAGE_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT that can: be
    used.
  ...
  * [[limits-samplerDescriptorSizeEXT]] pname:samplerDescriptorSize
    indicates the size in bytes of a ename:VK_DESCRIPTOR_TYPE_SAMPLER
    descriptor.
  ...
  * [[limits-samplerDescriptorBufferAddressSpaceSize]]
    ...
    with the ename:VK_BUFFER_USAGE_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT usage
    flag set.
  * [[limits-resourceDescriptorBufferAddressSpaceSize]]
    pname:resourceDescriptorBufferAddressSpaceSize indicates the total size
    in bytes of the address space available for descriptor buffers created
    with the ename:VK_BUFFER_USAGE_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT usage
    flag set.
  * [[limits-descriptorBufferAddressSpaceSize]]
    ...
    the ename:VK_BUFFER_USAGE_SAMPLER_DESCRIPTOR_BUFFER_BIT_EXT and
    ename:VK_BUFFER_USAGE_RESOURCE_DESCRIPTOR_BUFFER_BIT_EXT usage flags
    set.

ifdef::VK_EXT_mutable_descriptor_type,VK_VALVE_mutable_descriptor_type[]
A descriptor binding with type ename:VK_DESCRIPTOR_TYPE_MUTABLE_EXT has a
descriptor size which is implied by the descriptor types included in the
slink:VkMutableDescriptorTypeCreateInfoEXT::pname:pDescriptorTypes list.
...
<<features-robustBufferAccess, pname:robustBufferAccess>> feature is enabled
...
ifdef::VK_ARM_tensors[]
[open,refpage='VkPhysicalDeviceDescriptorBufferTensorPropertiesARM',desc='Structure describing descriptor buffer tensor properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceDescriptorBufferTensorPropertiesARM structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceDescriptorBufferTensorPropertiesARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:tensorCaptureReplayDescriptorDataSize indicates the maximum size
    in bytes of the opaque data used for capture and replay with tensors.
  * pname:tensorViewCaptureReplayDescriptorDataSize indicates the maximum
    size in bytes of the opaque data used for capture and replay with tensor
    views.
  * pname:tensorDescriptorSize indicates the size in bytes of a
    ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM descriptor.

:refpage: VkPhysicalDeviceDescriptorBufferTensorPropertiesARM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceDescriptorBufferTensorPropertiesARM.adoc[]
--
endif::VK_ARM_tensors[]
...
ifdef::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
[open,refpage='VkPhysicalDeviceHostImageCopyProperties',desc='Structure enumerating image layouts supported by an implementation for host memory copies',type='structs']
--
The sname:VkPhysicalDeviceHostImageCopyProperties structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceHostImageCopyProperties.adoc[]
...
ifdef::VK_BASE_VERSION_1_4[:anchor-prefix: extension-]
ifndef::VK_BASE_VERSION_1_4[:anchor-prefix:]
// tag::VK_EXT_host_image_copy-properties[]
  ...
  * pname:identicalMemoryTypeRequirements indicates that specifying the
    ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT flag in
    slink:VkImageCreateInfo::pname:usage does not affect the memory type
    requirements of the image.
// end::VK_EXT_host_image_copy-properties[]

:refpage: VkPhysicalDeviceHostImageCopyProperties
include::{chapters}/limits.adoc[tag=limits_desc]

If pname:pCopyDstLayouts is `NULL`, then the number of image layouts that
are supported in slink:VkCopyMemoryToImageInfo::pname:dstImageLayout and
slink:VkCopyImageToImageInfo::pname:dstImageLayout is returned in
pname:copyDstLayoutCount.
Otherwise, pname:copyDstLayoutCount must: be set by the application to the
number of elements in the pname:pCopyDstLayouts array, and on return is
overwritten with the number of values actually written to
...
are interchangeable with ename:VK_IMAGE_LAYOUT_GENERAL in
pname:pCopyDstLayouts.
endif::VK_KHR_unified_image_layouts[]

If pname:pCopySrcLayouts is `NULL`, then the number of image layouts that
are supported in slink:VkCopyImageToMemoryInfo::pname:srcImageLayout and
slink:VkCopyImageToImageInfo::pname:srcImageLayout is returned in
pname:copySrcLayoutCount.
Otherwise, pname:copySrcLayoutCount must: be set by the application to the
number of elements in the pname:pCopySrcLayouts array, and on return is
overwritten with the number of values actually written to
...
data layouts when using the ename:VK_HOST_IMAGE_COPY_MEMCPY_BIT flag in
flink:vkCopyMemoryToImage and flink:vkCopyImageToMemory.

include::{generated}/validity/structs/VkPhysicalDeviceHostImageCopyProperties.adoc[]
--
endif::VK_BASE_VERSION_1_4,VK_EXT_host_image_copy[]
...
ifdef::VK_KHR_fragment_shader_barycentric+VK_EXT_provoking_vertex[]
...
--
endif::VK_KHR_fragment_shader_barycentric+VK_EXT_provoking_vertex[]
...
ifdef::VK_COMPUTE_VERSION_1_4,VK_EXT_pipeline_robustness[]
[open,refpage='VkPhysicalDevicePipelineRobustnessProperties',desc='Structure describing the default robustness behavior of a physical device',type='structs']
--
The sname:VkPhysicalDevicePipelineRobustnessProperties structure is defined
as:

include::{generated}/api/structs/VkPhysicalDevicePipelineRobustnessProperties.adoc[]
...
ifdef::VK_COMPUTE_VERSION_1_4[:anchor-prefix: extension-]
ifndef::VK_COMPUTE_VERSION_1_4[:anchor-prefix:]
// tag::VK_EXT_pipeline_robustness-properties[]
...
// end::VK_EXT_pipeline_robustness-properties[]
...
:refpage: VkPhysicalDevicePipelineRobustnessProperties
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDevicePipelineRobustnessProperties.adoc[]
--
endif::VK_COMPUTE_VERSION_1_4,VK_EXT_pipeline_robustness[]
...
[open,refpage='VkPhysicalDeviceOpacityMicromapPropertiesKHR',desc='Structure describing the opacity micromap properties of a physical device',type='structs']
--
The sname:VkPhysicalDeviceOpacityMicromapPropertiesKHR structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceOpacityMicromapPropertiesKHR.adoc[]
  ...
  * [[limits-maxOpacity2StateSubdivisionLevel]]
    ...
    ename:VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR.
  * [[limits-maxOpacity4StateSubdivisionLevel]]
    pname:maxOpacity4StateSubdivisionLevel is the maximum allowed
    pname:subdivisionLevel when pname:format is
    ename:VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR and the micromap is not
    built with ename:VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR.
  * [[limits-maxOpacityLossy4StateSubdivisionLevel]]
    pname:maxOpacityLossy4StateSubdivisionLevel is the maximum allowed
    pname:subdivisionLevel when pname:format is
    ename:VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR and the micromap is built
    with ename:VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR.
  * [[limits-maxMicromapTriangles]] pname:maxMicromapTriangles limits the
    number of triangles allowed to be specified when building a micromap

:refpage: VkPhysicalDeviceOpacityMicromapPropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceOpacityMicromapPropertiesKHR.adoc[]
--
...
include::{generated}/api/structs/VkPhysicalDeviceOpacityMicromapPropertiesEXT.adoc[]
  ...
  * [[limits-maxOpacity4StateSubdivisionLevelEXT]]
    pname:maxOpacity4StateSubdivisionLevel is the maximum allowed
    pname:subdivisionLevel when pname:format is
    ename:VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR
...
ifdef::VK_NV_ray_tracing_invocation_reorder,VK_EXT_ray_tracing_invocation_reorder[]
[open,refpage='VkRayTracingInvocationReorderModeEXT',desc='Enum providing a hint on how the application may: reorder',type='enums']
--
Values which may: be returned in the
pname:rayTracingInvocationReorderReorderingHint field of
ifdef::VK_EXT_ray_tracing_invocation_reorder[sname:VkPhysicalDeviceRayTracingInvocationReorderPropertiesEXT]
ifdef::VK_NV_ray_tracing_invocation_reorder,VK_EXT_ray_tracing_invocation_reorder[or]
ifdef::VK_NV_ray_tracing_invocation_reorder[sname:VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV]
are:

include::{generated}/api/enums/VkRayTracingInvocationReorderModeEXT.adoc[]
...
include::{generated}/api/enums/VkRayTracingInvocationReorderModeNV.adoc[]
  ...
  * ename:VK_RAY_TRACING_INVOCATION_REORDER_MODE_NONE_EXT specifies that the
    implementation does not reorder at reorder calls.
  * ename:VK_RAY_TRACING_INVOCATION_REORDER_MODE_REORDER_EXT specifies that
    the implementation may: reorder at reorder calls.
--
endif::VK_NV_ray_tracing_invocation_reorder,VK_EXT_ray_tracing_invocation_reorder[]

ifdef::VK_EXT_ray_tracing_invocation_reorder[]
[open,refpage='VkPhysicalDeviceRayTracingInvocationReorderPropertiesEXT',desc='Structure describing shader module identifier properties of an implementation',type='structs']
--
The sname:VkPhysicalDeviceRayTracingInvocationReorderPropertiesEXT structure
is defined as:

include::{generated}/api/structs/VkPhysicalDeviceRayTracingInvocationReorderPropertiesEXT.adoc[]
  ...
  * pname:maxShaderBindingTableRecordIndex is the maximum shader binding
    table record index allowed to be passed in to
    code:OpHitObjectSetShaderBindingTableRecordIndexEXT

If pname:rayTracingInvocationReorderReorderingHint is
ename:VK_RAY_TRACING_INVOCATION_REORDER_MODE_REORDER_EXT there must: exist
...
reorder instruction.
The ordering of a set of invocations is determined by the code:SubgroupId of
an invocation's subgroup and the code:SubGroupInvocationId of an invocation
within that subgroup.

The reorder instructions are:

  * code:OpReorderThreadWithHintEXT
  * code:OpReorderThreadWithHitObjectEXT
  * code:OpHitObjectReorderExecuteShaderEXT
...
:refpage: VkPhysicalDeviceRayTracingInvocationReorderPropertiesEXT
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceRayTracingInvocationReorderPropertiesEXT.adoc[]
--
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_KHR_maintenance4[or code:LocalSizeId]
  ...
  * pname:indirectBufferOffsetAlignment indicates the alignment for cluster
    ...
    flink:vkCmdDrawClusterIndirectHUAWEI::pname:offset must: be a multiple
    of this value.
...
[open,refpage='VkPhysicalDevicePushConstantBankPropertiesNV',desc='Structure describing push constant bank properties',type='structs']
--
The sname:VkPhysicalDevicePushConstantBankPropertiesNV structure is defined
as:

include::{generated}/api/structs/VkPhysicalDevicePushConstantBankPropertiesNV.adoc[]
...
This structure describes the following implementation-dependent limits:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:maxGraphicsPushConstantBanks indicates the maximum number of push
    constant banks supported for graphics pipelines when used with
    non-descriptor heap scenarios.
  * pname:maxComputePushConstantBanks indicates the maximum number of push
    constant banks supported for compute pipelines when used with
    non-descriptor heap scenarios.
  * pname:maxGraphicsPushDataBanks indicates the maximum number of push data
    banks supported for graphics pipelines when using descriptor heaps.
  * pname:maxComputePushDataBanks indicates the maximum number of push data
    banks supported for compute pipelines when using descriptor heaps.

:refpage: VkPhysicalDevicePushConstantBankPropertiesNV
include::{chapters}/limits.adoc[tag=limits_desc]

[NOTE]
====
The number of banks available for descriptor heap usage
(pname:maxGraphicsPushDataBanks and pname:maxComputePushDataBanks) is equal
or greater than the number of banks available for non-descriptor heap usage
(pname:maxGraphicsPushConstantBanks and pname:maxComputePushConstantBanks).
...
include::{generated}/validity/structs/VkPhysicalDevicePushConstantBankPropertiesNV.adoc[]
--
...
[open,refpage='VkPhysicalDevicePipelineBinaryPropertiesKHR',desc='Structure describing properties about the pipeline binary implementation',type='structs']
--
The sname:VkPhysicalDevicePipelineBinaryPropertiesKHR structure is defined
as:

include::{generated}/api/structs/VkPhysicalDevicePipelineBinaryPropertiesKHR.adoc[]
  ...
  * [[limits-pipelineBinaryInternalCache]] pname:pipelineBinaryInternalCache
    ...
    the implementation.
    If this is ename:VK_TRUE, applications can: create pipeline binaries
  ...
  * [[limits-pipelineBinaryInternalCacheControl]]
    pname:pipelineBinaryInternalCacheControl specifies whether the driver's
    internal cache can: be disabled.
    If this property is ename:VK_TRUE
  ...
  * [[limits-pipelineBinaryPrefersInternalCache]]
    pname:pipelineBinaryPrefersInternalCache specifies that the
  ...
  * [[limits-pipelineBinaryPrecompiledInternalCache]]
    pname:pipelineBinaryPrecompiledInternalCache specifies that the
  ...
  * [[limits-pipelineBinaryCompressedData]]
    pname:pipelineBinaryCompressedData specifies that the binary data is
...
In particular, if the pname:pipelineBinaryPrefersInternalCache limit is
...
:refpage: VkPhysicalDevicePipelineBinaryPropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDevicePipelineBinaryPropertiesKHR.adoc[]
--
...
[open,refpage='VkPhysicalDeviceTileShadingPropertiesQCOM',desc='Structure describing properties supported by VK_QCOM_tile_shading',type='structs']
--
The sname:VkPhysicalDeviceTileShadingPropertiesQCOM structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceTileShadingPropertiesQCOM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxApronSize]] pname:maxApronSize is the maximum value
    supported which can be specified for
    slink:VkRenderPassTileShadingCreateInfoQCOM::pname:apronSize or
    pname:width and pname:height.
  * [[limits-preferNonCoherent]] pname:preferNonCoherent indicates that the
    implementation prefers tile attachments declared in shaders with the
    code:NonCoherentTileAttachmentReadQCOM decoration.
    Use of the decoration may: offer performance or power advantages.
  * [[limits-tileGranularity]] pname:tileGranularity provides a guarantee on
    the granularity of each tile.
    Each tile will have dimensions that are a multiple of this granularity
    in width and height.
  * [[limits-maxTileShadingRate]] pname:maxTileShadingRate is the maximum
    value of code:TileShadingRateQCOM and must: be a power of 2.

:refpage: VkPhysicalDeviceTileShadingPropertiesQCOM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceTileShadingPropertiesQCOM.adoc[]
--
endif::VK_QCOM_tile_shading[]

ifdef::VK_QCOM_shader_multiple_wait_queues[]
[open,refpage='VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM',desc='Structure describing shader multiple wait queues properties that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM structure
is defined as:

include::{generated}/api/structs/VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxShaderWaitQueues]] pname:maxShaderWaitQueues is the maximum
    number of wait queues that can: be set for a code:MultipleWaitQueuesQCOM
    loop control hint.

:refpage: VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM.adoc[]
--
endif::VK_QCOM_shader_multiple_wait_queues[]

ifdef::VK_KHR_device_fault[]
[open,refpage='VkPhysicalDeviceFaultPropertiesKHR',desc='Structure describing fault reporting properties for the physical device',type='structs']
--
The sname:VkPhysicalDeviceFaultPropertiesKHR structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceFaultPropertiesKHR.adoc[]

The members of the sname:VkPhysicalDeviceFaultPropertiesKHR structure
describe the following:

  * [[limits-maxDeviceFaultCount]] pname:maxDeviceFaultCount is the maximum
    number of instances of slink:VkDeviceFaultInfoKHR that will be retained
...
:refpage: VkPhysicalDeviceFaultPropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceFaultPropertiesKHR.adoc[]
--

endif::VK_KHR_device_fault[]

ifdef::VK_ARM_tensors[]
[open,refpage='VkPhysicalDeviceTensorPropertiesARM',desc='Structure describing the tensor properties of a physical device',type='structs']
--
The sname:VkPhysicalDeviceTensorPropertiesARM structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceTensorPropertiesARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxTensorDimensionCount]] pname:maxTensorDimensionCount is the
    maximum number of dimensions that can be specified in the
    pname:dimensionCount member of slink:VkTensorDescriptionARM.
  * [[limits-maxTensorElements]] pname:maxTensorElements is the maximum
    number of data elements in a created tensor as specified in the
    slink:VkTensorDescriptionARM of slink:VkTensorCreateInfoARM.
    The number of data elements in a tensor is computed as the product of
    [eq]#pname:pDimensions[i]# for all [eq]#0 {leq} i {leq}
    dimensionCount-1#.
  * [[limits-maxPerDimensionTensorElements]]
    pname:maxPerDimensionTensorElements is the maximum number of data
    elements alongside any dimension of a tensor.
  * [[limits-maxTensorStride]] pname:maxTensorStride is the maximum value
    for a tensor stride that can be used in
    slink:VkTensorDescriptionARM::pname:pStrides.
  * [[limits-maxTensorSize]] pname:maxTensorSize is the maximum size, in
    bytes, of a tensor.
  * [[limits-maxTensorShaderAccessArrayLength]]
    pname:maxTensorShaderAccessArrayLength is the maximum number of elements
    in an array returned by code:OpTensoReadARM or consumed by
    code:OpTensorWriteARM.
  * [[limits-maxTensorShaderAccessSize]] pname:maxTensorShaderAccessSize is
    the maximum size in bytes of the data that can be read from a tensor
    with code:OpTensorReadARM or written to a tensor with
    code:OpTensorWriteARM.
  * [[limits-maxDescriptorSetStorageTensors]]
    pname:maxDescriptorSetStorageTensors is the maximum number of tensors
    ...
    Descriptors with a type of ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM count
    against this limit.
  * [[limits-maxPerStageDescriptorSetStorageTensors]]
    pname:maxPerStageDescriptorSetStorageTensors is the maximum number of
    tensors that can: be accessible to a single shader stage in a pipeline
    layout.
    Descriptors with a type of ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM count
    against this limit.
    A descriptor is accessible to a pipeline shader stage when the
    pname:stageFlags member of the slink:VkDescriptorSetLayoutBinding
    structure has the bit for that shader stage set.
  * [[limits-maxDescriptorSetUpdateAfterBindStorageTensors]]
    pname:maxDescriptorSetUpdateAfterBindStorageTensors is similar to
    pname:maxDescriptorSetStorageTensors but counts descriptors from
    descriptor sets created with or without the
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT bit
    set.
  * [[limits-maxPerStageDescriptorUpdateAfterBindStorageTensors]]
    pname:maxPerStageDescriptorUpdateAfterBindStorageTensors is similar to
    pname:maxPerStageDescriptorSetStorageTensors but counts descriptors from
    descriptor sets created with or without the
    ename:VK_DESCRIPTOR_SET_LAYOUT_CREATE_UPDATE_AFTER_BIND_POOL_BIT bit
    set.
  * [[limits-shaderStorageTensorArrayNonUniformIndexingNative]]
    pname:shaderStorageTensorArrayNonUniformIndexingNative is a boolean
  ...
  * [[limits-shaderTensorSupportedStages]] pname:shaderTensorSupportedStages
    is a bitfield of elink:VkShaderStageFlagBits describing the shader
    stages that can: access tensor resources.
    pname:shaderTensorSupportedStages will have the
    ename:VK_SHADER_STAGE_COMPUTE_BIT bit set if any of the physical
    device's queues support ename:VK_QUEUE_COMPUTE_BIT.

:refpage: VkPhysicalDeviceTensorPropertiesARM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceTensorPropertiesARM.adoc[]
--
endif::VK_ARM_tensors[]

ifdef::VK_QCOM_queue_perf_hint[]
[open,refpage='VkPhysicalDeviceQueuePerfHintPropertiesQCOM',desc='Structure describing queue perf hint properties for a physical device',type='structs']
--
The sname:VkPhysicalDeviceQueuePerfHintPropertiesQCOM structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceQueuePerfHintPropertiesQCOM.adoc[]

The members of the sname:VkPhysicalDeviceQueuePerfHintPropertiesQCOM
structure describe the following:

  * pname:supportedQueues is a bitmask of elink:VkQueueFlagBits indicating
    the types of queues on which <<devsandqueues-perfhint, setting perf
    hints>> are supported.

If the <<features-queuePerfHint, pname:queuePerfHint>> feature is supported
by pname:physicalDevice, pname:supportedQueues must: return at least one
supported queue type.

:refpage: VkPhysicalDeviceQueuePerfHintPropertiesQCOM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceQueuePerfHintPropertiesQCOM.adoc[]
--
endif::VK_QCOM_queue_perf_hint[]

ifdef::VK_ARM_performance_counters_by_region[]
[open,refpage='VkPhysicalDevicePerformanceCountersByRegionPropertiesARM',desc='Structure describing per region performance counter properties for a physical device',type='structs']
--
The sname:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM structure
is defined as:

include::{generated}/api/structs/VkPhysicalDevicePerformanceCountersByRegionPropertiesARM.adoc[]

The members of the
sname:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM structure
describe the following:

  * pname:maxPerRegionPerformanceCounters is the maximum number of
    performance counters that can: be captured per region.
  * pname:performanceCounterRegionSize is the width and height of each
    region for which performance counters can: be captured.
  * pname:rowStrideAlignment indicates the minimum row alignment for by
    region counters.
  * pname:regionAlignment indicates the alignment between each region's
    counter values.
  * pname:identityTransformOrder is a boolean value indicating whether per
    region counters are output in framebuffer-space order.

:refpage: VkPhysicalDevicePerformanceCountersByRegionPropertiesARM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDevicePerformanceCountersByRegionPropertiesARM.adoc[]
--
endif::VK_ARM_performance_counters_by_region[]

ifdef::VK_EXT_descriptor_heap[]
[open,refpage='VkPhysicalDeviceDescriptorHeapPropertiesEXT',desc='Structure describing supported image alignments for a physical device',type='structs']
--
The sname:VkPhysicalDeviceDescriptorHeapPropertiesEXT structure is defined
as:

include::{generated}/api/structs/VkPhysicalDeviceDescriptorHeapPropertiesEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-samplerHeapAlignment]] pname:samplerHeapAlignment specifies the
    required alignment of the pname:heapRange->address member of
    slink:VkBindHeapInfoEXT for binding sampler heaps.
    It must be a power-of-two value.
  * [[limits-resourceHeapAlignment]] pname:resourceHeapAlignment specifies
    the required alignment of the pname:heapRange->address member of
    slink:VkBindHeapInfoEXT for binding resource heaps.
    It must be a power-of-two value.
  * [[limits-maxSamplerHeapSize]] pname:maxSamplerHeapSize describes maximum
    value of the pname:size member of slink:VkDeviceAddressRangeKHR for
    binding sampler heaps, including the reservation, when embedded samplers
    are used.
  * [[limits-maxResourceHeapSize]] pname:maxResourceHeapSize describes
    maximum value of the pname:size member of slink:VkDeviceAddressRangeKHR
  ...
  * [[limits-minSamplerHeapReservedRangeWithEmbedded]]
    pname:minSamplerHeapReservedRangeWithEmbedded specifies the minimum
  ...
  * [[limits-minResourceHeapReservedRange]]
    pname:minResourceHeapReservedRange specifies the minimum amount of data
    that the implementation needs to be reserved within the bound resource
    heap range.
  * [[limits-samplerDescriptorSize]] pname:samplerDescriptorSize specifies
    the size of sampler descriptors written by
    flink:vkWriteSamplerDescriptorsEXT.
    It must: be a power-of-two value.
  * [[limits-imageDescriptorSize]] pname:imageDescriptorSize specifies the
    maximum size of image and texel buffer descriptors written by
    flink:vkWriteResourceDescriptorsEXT.
    It must: be a power-of-two value.
  * [[limits-bufferDescriptorSize]] pname:bufferDescriptorSize specifies the
...
ifdef::VK_KHR_acceleration_structure,VK_NV_ray_tracing[]
    ...
    written by flink:vkWriteResourceDescriptorsEXT.
    It must: be a power-of-two value.
...
ifdef::VK_KHR_acceleration_structure,VK_NV_ray_tracing[]
    ...
    It must be a power-of-two value, and less than or equal to
    pname:bufferDescriptorSize.
  * [[limits-maxPushDataSize]] pname:maxPushDataSize specifies the maximum
    total size of all push data.
    It must be greater than or equal to <<limits-maxPushConstantsSize,
    maxPushConstantsSize>>
  * [[limits-imageCaptureReplayOpaqueDataSize]]
    pname:imageCaptureReplayOpaqueDataSize specifies the size of the opaque
    capture/replay data for an image.
  * [[limits-maxDescriptorHeapEmbeddedSamplers]]
    pname:maxDescriptorHeapEmbeddedSamplers specifies the maximum number of
    unique embedded samplers across all pipelines.
  * [[limits-samplerYcbcrConversionCount]] pname:samplerYcbcrConversionCount
    specifies the number of sampler descriptors required for any sampler
    using YC~B~C~R~ conversion.
  * [[limits-sparseDescriptorHeaps]] pname:sparseDescriptorHeaps specifies
    whether descriptor heaps can be backed by sparse memory or not.
    If this value is ename:VK_FALSE, buffers cannot be specified as both
...
:refpage: VkPhysicalDeviceDescriptorHeapPropertiesEXT
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceDescriptorHeapPropertiesEXT.adoc[]
--

ifdef::VK_ARM_tensors[]
[open,refpage='VkPhysicalDeviceDescriptorHeapTensorPropertiesARM',desc='Structure describing descriptor heap tensor properties supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceDescriptorHeapTensorPropertiesARM structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceDescriptorHeapTensorPropertiesARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-tensorDescriptorSize]] pname:tensorDescriptorSize specifies the
  ...
  * [[limits-tensorDescriptorAlignment]] pname:tensorDescriptorAlignment
    ...
    heap.
    It must be a power-of-two value, and less than or equal to
    pname:tensorDescriptorSize.
  * [[limits-tensorCaptureReplayOpaqueDataSize]]
    pname:tensorCaptureReplayOpaqueDataSize specifies the size of the opaque
    capture/replay data for an tensor.

:refpage: VkPhysicalDeviceDescriptorHeapTensorPropertiesARM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceDescriptorHeapTensorPropertiesARM.adoc[]
--
endif::VK_ARM_tensors[]
endif::VK_EXT_descriptor_heap[]

ifdef::VK_ARM_shader_instrumentation[]
[open,refpage='VkPhysicalDeviceShaderInstrumentationPropertiesARM',desc='Structure describing shader instrumentation properties for a physical device',type='structs']
--
The sname:VkPhysicalDeviceShaderInstrumentationPropertiesARM structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceShaderInstrumentationPropertiesARM.adoc[]

The members of the sname:VkPhysicalDeviceShaderInstrumentationPropertiesARM
structure describe the following:

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:numMetrics is the number of shader instrumentation metrics
    supported.
  * pname:perBasicBlockGranularity is a boolean value indicating whether
    shader instrumentation metrics are returned per basic block.
    If this is ename:VK_FALSE, then all metrics for the shader are reported
    as basic block index `0`.

:refpage: VkPhysicalDeviceShaderInstrumentationPropertiesARM
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceShaderInstrumentationPropertiesARM.adoc[]
--
endif::VK_ARM_shader_instrumentation[]

ifdef::VK_AMD_gpa_interface[]
[open,refpage='VkPhysicalDeviceGpaPropertiesAMD',desc='Structure describing GPU performance API properties for a physical device',type='structs']
--
The sname:VkPhysicalDeviceGpaPropertiesAMD structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceGpaPropertiesAMD.adoc[]

The members of the sname:VkPhysicalDeviceGpaPropertiesAMD structure describe
the following:
  ...
  * pname:maxSqttSeBufferSize is the SQTT buffer size per engine.
  * pname:shaderEngineCount is the number of shader engines.
  * pname:perfBlockCount is the number of entries in pname:pPerfBlocks.
  * pname:pPerfBlocks is a pointer to an array of
    slink:VkGpaPerfBlockPropertiesAMD structures containing the available
    performance blocks.

:refpage: VkPhysicalDeviceGpaPropertiesAMD
include::{chapters}/limits.adoc[tag=limits_desc]

Note that, as opposed to other physical device property structures,
sname:VkPhysicalDeviceGpaPropertiesAMD needs
flink:vkGetPhysicalDeviceProperties2 to be called twice to obtain the
pname:pPerfBlocks array, similar to an enumeration function.
If pname:pPerfBlocks is `NULL`, then the number of performance blocks is
returned in pname:perfBlockCount.
Otherwise, pname:perfBlockCount must: be set by the application to the
number of elements in the pname:pPerfBlocks array, and on return the
variable is overwritten with the number of elements actually written to
pname:pPerfBlocks.

include::{generated}/validity/structs/VkPhysicalDeviceGpaPropertiesAMD.adoc[]
--

[open,refpage='VkPhysicalDeviceGpaPropertiesFlagsAMD',desc='Reserved for future use',type='flags']
--
include::{generated}/api/flags/VkPhysicalDeviceGpaPropertiesFlagsAMD.adoc[]

tname:VkPhysicalDeviceGpaPropertiesFlagsAMD is a bitmask type for setting
physical device GPA property flags, but is currently reserved for future
use.
--

[open,refpage='VkGpaPerfBlockPropertiesAMD',desc='Structure describing GPU performance API block properties for a physical device',type='structs']
--
The sname:VkGpaPerfBlockPropertiesAMD structure is defined as:

include::{generated}/api/structs/VkGpaPerfBlockPropertiesAMD.adoc[]

The members of the sname:VkGpaPerfBlockPropertiesAMD structure describe the
following:

  * pname:blockType is a elink:VkGpaPerfBlockAMD specifying the performance
    block type.
  * pname:flags is reserved for future use.
  * pname:instanceCount is the number of instances of this block that are
    available in the device.
  * pname:maxEventID is the maximum event ID for this block.
  * pname:maxGlobalOnlyCounters is the number of counters available only for
    global counters.
  * pname:maxGlobalSharedCounters is the total counters available including
    state shared between global and streaming performance monitor counters.
  * pname:maxStreamingCounters is the maximum number of counters available
    for streaming only.

:refpage: VkGpaPerfBlockPropertiesAMD
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkGpaPerfBlockPropertiesAMD.adoc[]
--

[open,refpage='VkGpaPerfBlockPropertiesFlagsAMD',desc='Reserved for future use',type='flags']
--
include::{generated}/api/flags/VkGpaPerfBlockPropertiesFlagsAMD.adoc[]

tname:VkGpaPerfBlockPropertiesFlagsAMD is a bitmask type for setting GPA
performance block property flags, but is currently reserved for future use.
--

[open,refpage='VkPhysicalDeviceGpaProperties2AMD',desc='Structure describing additional GPU performance API properties for a physical device',type='structs']
--
The sname:VkPhysicalDeviceGpaProperties2AMD structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceGpaProperties2AMD.adoc[]

The members of the sname:VkPhysicalDeviceGpaProperties2AMD structure
describe the following:

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:revisionId is the GPU product identifier that may be used to
    classify its GPA behavior.

:refpage: VkPhysicalDeviceGpaProperties2AMD
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceGpaProperties2AMD.adoc[]
--
...
[open,refpage='VkPhysicalDeviceShaderAbortPropertiesKHR',desc='Structure describing the maximum size of a shader abort message',type='structs']
--
The sname:VkPhysicalDeviceShaderAbortPropertiesKHR structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceShaderAbortPropertiesKHR.adoc[]

The sname:VkPhysicalDeviceShaderAbortPropertiesKHR structure describes the
following:

  * [[limits-maxShaderAbortMessageSize]] pname:maxShaderAbortMessageSize
    indicates the maximum size of a shader abort message that the
    application can: specify.

:refpage: VkPhysicalDeviceShaderAbortPropertiesKHR
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceShaderAbortPropertiesKHR.adoc[]
--
endif::VK_KHR_shader_abort[]

ifdef::VK_VALVE_buffer_device_address_allocation_alignment[]
[open,refpage='VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentPropertiesVALVE',desc='Structure describing maximum alignment request on buffer device addresses',type='structs']
--
The
sname:VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentPropertiesVALVE
structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentPropertiesVALVE.adoc[]
...
This structure describes the following features:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-maxBufferDeviceAddressAllocationAlignment]]
    pname:maxBufferDeviceAddressAllocationAlignment indicates the maximum
...
:refpage: VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentPropertiesVALVE
include::{chapters}/limits.adoc[tag=limits_desc]

include::{generated}/validity/structs/VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentPropertiesVALVE.adoc[]
--
endif::VK_VALVE_buffer_device_address_allocation_alignment[]


[[limits-minmax]]
== Limit Requirements

[open,refpage='Required_Limits',desc='Vulkan required limit tables',type='freeform',anchor='limits-minmax']
--
...
ifdef::VK_COMPUTE_VERSION_1_2[`<<features-samplerFilterMinmax, pname:samplerFilterMinmax>>` ]
...
| code:uint32_t            | pname:maxVertexAttribDivisor               | Vulkan 1.4, apiext:VK_KHR_vertex_attribute_divisor, apiext:VK_EXT_vertex_attribute_divisor
...
ifdef::VK_EXT_shader_split_barrier[]
| code:uint32_t            | pname:splitBarrierReservedSharedMemory         | `<<features-shaderSplitBarrier, pname:shaderSplitBarrier>>`
endif::VK_EXT_shader_split_barrier[]
ifdef::VK_EXT_fragment_density_map[]
...
ifdef::VK_QCOM_fragment_density_map_offset[]
| slink:VkExtent2D         | pname:fragmentDensityOffsetGranularity    | `<<features-fragmentDensityMapOffset, pname:fragmentDensityMapOffset>>`
endif::VK_QCOM_fragment_density_map_offset[]
ifdef::VK_VALVE_fragment_density_map_layered[]
| code:uint32_t         | pname:maxFragmentDensityMapLayers    | `<<features-fragmentDensityMapLayered, pname:fragmentDensityMapLayered>>`
endif::VK_VALVE_fragment_density_map_layered[]
endif::VK_EXT_fragment_density_map[]
...
ifdef::VK_NV_cluster_acceleration_structure,VK_KHR_acceleration_structure[]
| code:uint32_t            | pname:maxVerticesPerCluster                        | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
| code:uint32_t            | pname:maxTrianglesPerCluster                       | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
| code:uint32_t            | pname:clusterScratchByteAlignment                  | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
| code:uint32_t            | pname:clusterByteAlignment                         | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
| code:uint32_t            | pname:clusterTemplateByteAlignment                 | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
| code:uint32_t            | pname:clusterBottomLevelByteAlignment              | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
| code:uint32_t            | pname:clusterTemplateBoundsByteAlignment           | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
| code:uint32_t            | pname:maxClusterGeometryIndex                      | `<<features-clusterAccelerationStructure, pname:clusterAccelerationStructure>>`
endif::VK_NV_cluster_acceleration_structure,VK_KHR_acceleration_structure[]
...
ifdef::VK_NV_partitioned_acceleration_structure,VK_KHR_acceleration_structure[]
| code:uint32_t            | pname:maxPartitionCount                        | `<<features-partitionedAccelerationStructure, pname:partitionedAccelerationStructure>>`
endif::VK_NV_partitioned_acceleration_structure,VK_KHR_acceleration_structure[]
ifdef::VK_BASE_VERSION_1_2,VK_KHR_timeline_semaphore[]
| code:uint64_t            | pname:maxTimelineSemaphoreValueDifference      | `<<features-timelineSemaphore, pname:timelineSemaphore>>`
endif::VK_BASE_VERSION_1_2,VK_KHR_timeline_semaphore[]
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
| code:uint32_t            | pname:lineSubPixelPrecisionBits                | Vulkan 1.4, apiext:VK_KHR_line_rasterization, apiext:VK_EXT_line_rasterization
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
ifdef::VK_EXT_custom_border_color[]
| code:uint32_t            | pname:maxCustomBorderColorSamplers             | `apiext:VK_EXT_custom_border_color`
endif::VK_EXT_custom_border_color[]
ifdef::VK_EXT_robustness2,VK_KHR_robustness2[]
| basetype:VkDeviceSize    | pname:robustStorageBufferAccessSizeAlignment   | `apiext:VK_EXT_robustness2`, `apiext:VK_KHR_robustness2`
| basetype:VkDeviceSize    | pname:robustUniformBufferAccessSizeAlignment   | `apiext:VK_EXT_robustness2`, `apiext:VK_KHR_robustness2`
endif::VK_EXT_robustness2,VK_KHR_robustness2[]
ifdef::VK_KHR_fragment_shading_rate[]
...
ifdef::VK_KHR_opacity_micromap[]
| code:uint32_t                 | slink:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxOpacity2StateSubdivisionLevel      | `<<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>`
| code:uint32_t                 | sname:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxOpacity4StateSubdivisionLevel      | `<<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>`
| code:uint32_t                 | sname:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxOpacityLossy4StateSubdivisionLevel | `<<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>`
| code:uint64_t                 | sname:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxMicromapTriangles                  | `<<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>`
endif::VK_KHR_opacity_micromap[]
ifdef::VK_EXT_opacity_micromap[]
| code:uint32_t                 | slink:VkPhysicalDeviceOpacityMicromapPropertiesEXT::pname:maxOpacity2StateSubdivisionLevel | `apiext:VK_EXT_opacity_micromap`
| code:uint32_t                 | sname:VkPhysicalDeviceOpacityMicromapPropertiesEXT::pname:maxOpacity4StateSubdivisionLevel | `apiext:VK_EXT_opacity_micromap`
endif::VK_EXT_opacity_micromap[]
ifdef::VK_NV_memory_decompression,VK_EXT_memory_decompression[]
| code:uint64_t                 | pname:maxDecompressionIndirectCount                       | `apiext:VK_NV_memory_decompression`, `apiext:VK_EXT_memory_decompression`
endif::VK_NV_memory_decompression,VK_EXT_memory_decompression[]
ifdef::VK_HUAWEI_cluster_culling_shader[]
...
| code:uint32_t                 | pname:maxExecutionGraphVertexBufferBindings               | `<<features-shaderEnqueue,pname:shaderEnqueue>>`
| 3 {times} code:uint32_t       | pname:maxExecutionGraphWorkgroupCount                     | `<<features-shaderEnqueue,pname:shaderEnqueue>>`
| code:uint32_t                 | pname:maxExecutionGraphWorkgroups                         | `<<features-shaderEnqueue,pname:shaderEnqueue>>`
endif::VK_AMDX_shader_enqueue[]
ifdef::VK_EXT_device_generated_commands[]
| code:uint32_t                 | pname:maxIndirectShaderObjectCount              | `<<features-shaderObject,pname:shaderObject>>`
endif::VK_EXT_device_generated_commands[]
ifdef::VK_NV_extended_sparse_address_space[]
...
ifdef::VK_KHR_maintenance7[]
| basetype:VkBool32             | pname:separateDepthStencilAttachmentAccess                        | <<features-maintenance7,pname:maintenance7>>
| code:uint32_t                 | pname:maxDescriptorSetTotalUniformBuffersDynamic                  | `<<features-maintenance7, pname:maintenance7>>`
| code:uint32_t                 | pname:maxDescriptorSetTotalStorageBuffersDynamic                  | `<<features-maintenance7, pname:maintenance7>>`
| code:uint32_t                 | pname:maxDescriptorSetTotalBuffersDynamic                         | `<<features-maintenance7, pname:maintenance7>>`
| code:uint32_t                 | pname:maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic   | `<<features-maintenance7, pname:maintenance7>>`
| code:uint32_t                 | pname:maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic   | `<<features-maintenance7, pname:maintenance7>>`
| code:uint32_t                 | pname:maxDescriptorSetUpdateAfterBindTotalBuffersDynamic          | `<<features-maintenance7, pname:maintenance7>>`
endif::VK_KHR_maintenance7[]
ifdef::VK_NV_cooperative_matrix2[]
| code:uint32_t                 | pname:cooperativeMatrixWorkgroupScopeMaxWorkgroupSize             | `<<features-cooperativeMatrixWorkgroupScope, pname:cooperativeMatrixWorkgroupScope>>`
| code:uint32_t                 | pname:cooperativeMatrixFlexibleDimensionsMaxDimension             | `<<features-cooperativeMatrixFlexibleDimensions, pname:cooperativeMatrixFlexibleDimensions>>`
| code:uint32_t                 | pname:cooperativeMatrixWorkgroupScopeReservedSharedMemory         | `<<features-cooperativeMatrixWorkgroupScope, pname:cooperativeMatrixWorkgroupScope>>`
endif::VK_NV_cooperative_matrix2[]
ifdef::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float_controls[]
| basetype:VkBool32             | pname:shaderSignedZeroInfNanPreserveFloat16                       | `<<features-shaderFloat16, pname:shaderFloat16>>`
endif::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float_controls[]
ifdef::VK_NV_cooperative_vector[]
| basetype:VkBool32             | pname:cooperativeVectorTrainingFloat16Accumulation                | -
| basetype:VkBool32             | pname:cooperativeVectorTrainingFloat32Accumulation                | -
endif::VK_NV_cooperative_vector[]
ifdef::VK_QCOM_queue_perf_hint[]
| tlink:VkQueueFlags            | slink:VkPhysicalDeviceQueuePerfHintPropertiesQCOM::pname:supportedQueues | `<<features-queuePerfHint,pname:queuePerfHint>>`
endif::VK_QCOM_queue_perf_hint[]
ifdef::VK_QCOM_tile_shading[]
| code:uint32_t                 | pname:maxApronSize                     | `<<features-tileShadingApron, pname:tileShadingApron>>`
| basetype:VkBool32             | pname:preferNonCoherent                | `<<features-tileShading, pname:tileShading>>`
| 2 {times} code:uint32_t       | pname:tileGranularity                  | `<<features-tileShading, pname:tileShading>>`
| 2 {times} code:uint32_t       | pname:maxTileShadingRate               | `<<features-tileShadingDispatchTile, pname:tileShadingDispatchTile>>`
endif::VK_QCOM_tile_shading[]
ifdef::VK_QCOM_shader_multiple_wait_queues[]
| code:uint32_t                 | pname:maxShaderWaitQueues              | `<<features-shaderMultipleWaitQueues, pname:shaderMultipleWaitQueues>>`
endif::VK_QCOM_shader_multiple_wait_queues[]
ifdef::VK_EXT_ray_tracing_invocation_reorder[]
| code:uint32_t                 | pname:maxShaderBindingTableRecordIndex                    | `apiext:VK_EXT_ray_tracing_invocation_reorder`
endif::VK_EXT_ray_tracing_invocation_reorder[]
ifdef::VK_KHR_maintenance10[]
| basetype:VkBool32             | pname:resolveSrgbFormatAppliesTransferFunction | `<<features-maintenance10,pname:maintenance10>>`
| basetype:VkBool32             | pname:resolveSrgbFormatSupportsTransferFunctionControl | `<<features-maintenance10,pname:maintenance10>>`
endif::VK_KHR_maintenance10[]
ifdef::VK_EXT_descriptor_heap[]
| basetype:VkDeviceSize         | pname:samplerHeapAlignment                 | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:resourceHeapAlignment                | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:maxSamplerHeapSize                   | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:maxResourceHeapSize                  | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:minSamplerHeapReservedRange             | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:minSamplerHeapReservedRangeWithEmbedded | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:minResourceHeapReservedRange            | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:samplerDescriptorSize                | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:imageDescriptorSize                  | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:bufferDescriptorSize                 | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:samplerDescriptorAlignment           | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:imageDescriptorAlignment             | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:bufferDescriptorAlignment            | <<features-descriptorHeap,pname:descriptorHeap>>
| basetype:VkDeviceSize         | pname:maxPushDataSize                      | <<features-descriptorHeap,pname:descriptorHeap>>
| code:size_t                   | pname:imageCaptureReplayOpaqueDataSize     | <<features-descriptorHeap,pname:descriptorHeap>>
| code:uint32_t                 | pname:maxDescriptorHeapEmbeddedSamplers    | <<features-descriptorHeap,pname:descriptorHeap>>
| code:uint32_t                 | pname:samplerYcbcrConversionCount          | <<features-descriptorHeap,pname:descriptorHeap>>
| code:uint32_t                 | pname:sparseDescriptorHeaps                | <<features-descriptorHeap,pname:descriptorHeap>>
| code:uint32_t                 | pname:protectedDescriptorHeaps             | <<features-descriptorHeap,pname:descriptorHeap>>
endif::VK_EXT_descriptor_heap[]
ifdef::VK_ARM_shader_instrumentation[]
| code:uint32_t                 | pname:numMetrics                 | <<features-shaderInstrumentation,pname:shaderInstrumentation>>
| basetype:VkBool32             | pname:perBasicBlockGranularity   | <<features-shaderInstrumentation,pname:shaderInstrumentation>>
endif::VK_ARM_shader_instrumentation[]
ifdef::VK_KHR_shader_abort[]
| code:uint64_t                 | pname:maxShaderAbortMessageSize   | <<features-shaderAbort,pname:shaderAbort>>
endif::VK_KHR_shader_abort[]
ifdef::VK_KHR_device_fault[]
| code:uint32_t                 | pname:maxDeviceFaultCount              | `<<VK_KHR_device_fault>>`
endif::VK_KHR_device_fault[]
ifdef::VK_ARM_tensors[]
| code:uint32_t                 | pname:maxTensorDimensionCount          | <<features-tensors,pname:tensors>>
| code:uint64_t                 | pname:maxTensorElements                | <<features-tensors,pname:tensors>>
| code:uint64_t                 | pname:maxPerDimensionTensorElements    | <<features-tensors,pname:tensors>>
| code:int64_t                  | pname:maxTensorStride                  | <<features-tensors,pname:tensors>>
| code:uint32_t                 | pname:maxTensorShaderAccessArrayLength | <<features-shaderTensorAccess,pname:shaderTensorAccess>>
| code:uint32_t                 | pname:maxTensorShaderAccessSize        | <<features-shaderTensorAccess,pname:shaderTensorAccess>>
| code:uint32_t                 | pname:maxDescriptorSetStorageTensors   | <<features-tensors,pname:tensors>>
| code:uint32_t                 | pname:maxPerStageDescriptorSetStorageTensors | <<features-shaderTensorAccess,pname:shaderTensorAccess>>
| code:uint32_t                 | pname:maxDescriptorSetUpdateAfterBindStorageTensors | <<features-descriptorBindingStorageTensorUpdateAfterBind,pname:descriptorBindingStorageTensorUpdateAfterBind>>
| code:uint32_t                 | pname:maxPerStageDescriptorUpdateAfterBindStorageTensors | <<features-descriptorBindingStorageTensorUpdateAfterBind,pname:descriptorBindingStorageTensorUpdateAfterBind>> and <<features-shaderTensorAccess,pname:shaderTensorAccess>>
| basetype:VkBool32             | pname:shaderStorageTensorArrayNonUniformIndexingNative | <<features-shaderStorageTensorArrayNonUniformIndexing,pname:shaderStorageTensorArrayNonUniformIndexing>>
| tlink:VkShaderStageFlags      | pname:shaderTensorSupportedStages      | <<features-shaderTensorAccess,pname:shaderTensorAccess>>
endif::VK_ARM_tensors[]
|====

// Attributes expanding to roadmap / version-specific limit tags in the limits-required table
:core: Vulkan Core
:limit2022: Vulkan Roadmap 2022
:limit2024: Vulkan Roadmap 2024
:limit2026: Vulkan Roadmap 2026
:limit1_4: Vulkan 1.4
...
| pname:maxImageDimension1D                  | - | 4096 ({core}) +
                                                   8192 ({limit2022}, {limit1_4})  | min
| pname:maxImageDimension2D                  | - | 4096 ({core}) +
                                                   8192 ({limit2022}, {limit1_4})  | min
| pname:maxImageDimension3D                  | - | 256 ({core}) +
                                                   512 ({limit1_4})                | min
| pname:maxImageDimensionCube                | - | 4096 ({core}) +
                                                   8192 ({limit2022}, {limit1_4})  | min
| pname:maxImageArrayLayers                  | - | 256 ({core}) +
                                                   2048 ({limit2022}, {limit1_4})  | min
| pname:maxTexelBufferElements               | - | 65536   | min
| pname:maxUniformBufferRange                | - | 16384 ({core}) +
                                                   65536 ({limit2022}, {limit1_4}) | min
| pname:maxStorageBufferRange                | - | 2^27^   | min
| pname:maxPushConstantsSize                 | - | 128 ({core}) +
                                                   256 ({limit1_4})                | min
| pname:maxMemoryAllocationCount             | - | 4096    | min
| pname:maxSamplerAllocationCount            | - | 4000    | min
| pname:bufferImageGranularity               | - | 131072 ({core}) +
                                                   4096 ({limit2022}, {limit1_4})  | max
| pname:sparseAddressSpaceSize               | 0 | 2^31^   | min
| pname:maxBoundDescriptorSets               | - | 4 ({core}) +
                                                   7 ({limit2024}, {limit1_4})     | min
| pname:maxPerStageDescriptorSamplers        | - | 16 ({core}) +
                                                   64 ({limit2022})                | min
| pname:maxPerStageDescriptorUniformBuffers  | - | 12 ({core}) +
                                                   15 ({limit2022}, {limit1_4}) +
                                                   200 ({limit2026})               | min
| pname:maxPerStageDescriptorStorageBuffers  | - | 4 ({core}) +
                                                   30 ({limit2022}) +
                                                   200 ({limit2026})               | min
| pname:maxPerStageDescriptorSampledImages   | - | 16 ({core}) +
                                                   200 ({limit2022})               | min
| pname:maxPerStageDescriptorStorageImages   | - | 4 ({core}) +
                                                   16 ({limit2022})                | min
| pname:maxPerStageDescriptorInputAttachments| - | 4 +
                                                   8 ({limit2026})                 | min
| pname:maxPerStageResources                 | - | 128 ^2^ ({core}) +
                                                   200 ({limit2022}, {limit1_4})   | min
| pname:maxDescriptorSetSamplers             | - | 96 ^8^ ({core}) +
                                                   576 ({limit2022})               | min, _n_ {times} PerStage
| pname:maxDescriptorSetUniformBuffers       | - | 72 ^8^ ({core}) +
                                                   90 ({limit2022}, {limit1_4}) +
                                                   1800 ({limit2026})              | min, _n_ {times} PerStage
| pname:maxDescriptorSetUniformBuffersDynamic| - | 8       | min
| pname:maxDescriptorSetStorageBuffers       | - | 24 ^8^ ({core}) +
                                                   96 ({limit2022}, {limit1_4}) +
                                                   1800 ({limit2026})              | min, _n_ {times} PerStage
| pname:maxDescriptorSetStorageBuffersDynamic| - | 4       | min
ifdef::VK_KHR_maintenance7[]
| pname:maxDescriptorSetTotalUniformBuffersDynamic | - | pname:maxDescriptorSetUniformBuffersDynamic | min
| pname:maxDescriptorSetTotalStorageBuffersDynamic | - | pname:maxDescriptorSetStorageBuffersDynamic | min
| pname:maxDescriptorSetTotalBuffersDynamic        | - | [eq]#pname:maxDescriptorSetUniformBuffersDynamic {plus} pname:maxDescriptorSetStorageBuffersDynamic#| min
endif::VK_KHR_maintenance7[]
| pname:maxDescriptorSetSampledImages        | - | 96 ^8^ ({core}) +
                                                   1800 ({limit2022})              | min, _n_ {times} PerStage
| pname:maxDescriptorSetStorageImages        | - | 24 ^8^ ({core}) +
                                                   144 ({limit2022}, {limit1_4})   | min, _n_ {times} PerStage
| pname:maxDescriptorSetInputAttachments     | - | 4 +
                                                   8 ({limit2026})                 | min
...
| pname:maxVertexOutputComponents            | - | 64 +
                                                   124 ({limit2026})            | min
| pname:maxTessellationGenerationLevel       | 0 | 64      | min
| pname:maxTessellationPatchSize             | 0 | 32      | min
| pname:maxTessellationControlPerVertexInputComponents  | 0 | 64 +
                                                              128 ({limit2026}) | min
| pname:maxTessellationControlPerVertexOutputComponents | 0 | 64 +
                                                              128 ({limit2026}) | min
| pname:maxTessellationControlPerPatchOutputComponents  | 0 | 120 | min
| pname:maxTessellationControlTotalOutputComponents     | 0 | 2048 +
                                                              4096 ({limit2026})  | min
| pname:maxTessellationEvaluationInputComponents        | 0 | 64 +
                                                              128 ({limit2026}) | min
| pname:maxTessellationEvaluationOutputComponents       | 0 | 64 +
                                                              128 ({limit2026}) | min
| pname:maxGeometryShaderInvocations         | 0 | 32      | min
| pname:maxGeometryInputComponents           | 0 | 64 | min
| pname:maxGeometryOutputComponents          | 0 | 64 +
                                                   128 ({limit2026}) | min
| pname:maxGeometryOutputVertices            | 0 | 256     | min
| pname:maxGeometryTotalOutputComponents     | 0 | 1024    | min
| pname:maxFragmentInputComponents           | - | 64 +
                                                   112 ({limit2026})       | min
| pname:maxFragmentOutputAttachments         | - | 4 +
                                                   8 ({limit2026}) | min
| pname:maxFragmentDualSrcAttachments        | 0 | 1       | min
| pname:maxFragmentCombinedOutputResources   | - | 4 ({core}) +
                                                   16 ({limit2022}, {limit1_4})            | min
| pname:maxComputeSharedMemorySize           | - | 16384 +
                                                   32768 ({limit2026}) | min
| pname:maxComputeWorkGroupCount             | - | (65535,65535,65535) | min
| pname:maxComputeWorkGroupInvocations       | - | 128 ({core}) +
                                                   256 ({limit2022}, {limit1_4})           | min
| pname:maxComputeWorkGroupSize              | - | (128,128,64) ({core}) +
                                                   (256,256,64) ({limit2022}, {limit1_4})  | min
ifdef::VK_COMPUTE_VERSION_1_1[]
| pname:subgroupSize                         | - | 1/4 ({core}) +
                                                   4 ({limit2022})                         | min
| pname:subgroupSupportedStages              | - | ename:VK_SHADER_STAGE_COMPUTE_BIT ({core}) +
                                                   ename:VK_SHADER_STAGE_COMPUTE_BIT \| +
                                                   ename:VK_SHADER_STAGE_FRAGMENT_BIT ({limit2022})
                                                           | bitfield
| pname:subgroupSupportedOperations          | - | ename:VK_SUBGROUP_FEATURE_BASIC_BIT ({core}) +
                                                   ...
                                                   ename:VK_SUBGROUP_FEATURE_QUAD_BIT ({limit2022})
                                                           | bitfield
endif::VK_COMPUTE_VERSION_1_1[]
ifdef::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float_controls[]
| pname:shaderSignedZeroInfNanPreserveFloat16 | - | - ({core}) +
                                                    ename:VK_TRUE ({limit2022}, {limit1_4}) | Boolean
| pname:shaderSignedZeroInfNanPreserveFloat32 | - | - ({core}) +
                                                    ename:VK_TRUE ({limit2022}, {limit1_4}) | Boolean
| pname:shaderRoundingModeRTEFloat16          | - | ename:VK_FALSE ({core}) +
                                                    ename:VK_TRUE ({limit2024}) | Boolean
| pname:shaderRoundingModeRTEFloat32          | - | ename:VK_FALSE ({core}) +
                                                    ename:VK_TRUE ({limit2024}) | Boolean
endif::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float_controls[]
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_subgroup_size_control[]
| pname:maxSubgroupSize                      | - | - ({core}) +
                                                   4 ({limit2022})              | min
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_subgroup_size_control[]
| pname:subPixelPrecisionBits                | - | 4 +
                                                   8 ({limit2026}) | min
| pname:subTexelPrecisionBits                | - | 4 ({core}) +
                                                   8 ({limit2022}, {limit1_4})  | min
| pname:mipmapPrecisionBits                  | - | 4 ({core}) +
                                                   6 ({limit2022}, {limit1_4})  | min
| pname:maxDrawIndexedIndexValue             | 2^24^-1 | 2^32^-1 | min
| pname:maxDrawIndirectCount                 | 1 | 2^16^-1 | min
| pname:maxSamplerLodBias                    | - | 2 ({core}) +
                                                   14 ({limit2022}, {limit1_4}) | min
| pname:maxSamplerAnisotropy                 | 1 | 16      | min
| pname:maxViewports                         | 1 | 16      | min
| pname:maxViewportDimensions ^3^            | - | (4096,4096) ({core}) +
                                                   (7680,7680) ({limit1_4}) +
                                                   (8192,8192) ({limit2026}) | min
| pname:viewportBoundsRange ^4^              | - | (-8192,8191) ({core}) +
                                                   (-15360,15359) ({limit1_4}) | (max,min)
...
| pname:maxFramebufferWidth                  | - | 4096 ({core}) +
                                                   7680 ({limit1_4}) +
                                                   8192 ({limit2026}) | min
| pname:maxFramebufferHeight                 | - | 4096 ({core}) +
                                                   7680 ({limit1_4}) +
                                                   8192 ({limit2026}) | min
...
| pname:maxColorAttachments                  | - | 4 ({core}) +
                                                   7 ({limit2022}) +
                                                   8 ({limit2024}, {limit1_4})                                  | min
...
| pname:timestampComputeAndGraphics          | - | - ({core}) +
                                                   ename:VK_TRUE ({limit2024}, {limit1_4}) | Boolean
...
| pname:pointSizeRange                       | (1.0,1.0) | (1.0,64.0 - ULP) ^6^ ({core}) +
                                                           (1.0,256.0 - pname:pointSizeGranularity) ({limit1_4}) | (max,min)
| pname:lineWidthRange                       | (1.0,1.0) | (1.0,8.0 - ULP) ^7^ | (max,min)
| pname:pointSizeGranularity                 |  0.0 | 1.0 ^6^ ({core}) +
                                                      0.125 ({limit2022}, {limit1_4}) | max, fixed point increment
| pname:lineWidthGranularity                 |  0.0 | 1.0 ^7^ ({core}) +
                                                      0.5 ({limit2022}, {limit1_4})   | max, fixed point increment
| pname:strictLines                          | - | -   | implementation-dependent
| pname:standardSampleLocations              | - | - ({core}) +
                                                   ename:VK_TRUE ({limit2022}, {limit1_4}) | Boolean
...
| pname:variableSampleLocations              | - | ename:VK_FALSE | implementation-dependent
endif::VK_EXT_sample_locations[]
ifdef::VK_EXT_legacy_vertex_attributes[]
| pname:nativeUnalignedPerformance           | - | ename:VK_FALSE | implementation-dependent
endif::VK_EXT_legacy_vertex_attributes[]
ifdef::VK_EXT_external_memory_host[]
...
| pname:advancedBlendIndependentBlend           | - | ename:VK_FALSE| implementation-dependent
| pname:advancedBlendNonPremultipliedSrcColor   | - | ename:VK_FALSE| implementation-dependent
| pname:advancedBlendNonPremultipliedDstColor   | - | ename:VK_FALSE| implementation-dependent
| pname:advancedBlendCorrelatedOverlap          | - | ename:VK_FALSE| implementation-dependent
| pname:advancedBlendAllOperations              | - | ename:VK_FALSE| implementation-dependent
endif::VK_EXT_blend_operation_advanced[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_maintenance3[]
| pname:maxPerSetDescriptors                                | - |1024 | min
| pname:maxMemoryAllocationSize                             | - | 2^30^ | min
endif::VK_BASE_VERSION_1_1,VK_KHR_maintenance3[]
ifdef::VK_BASE_VERSION_1_3,VK_KHR_maintenance4[]
...
| pname:primitiveUnderestimation                    | - | ename:VK_FALSE | implementation-dependent
| pname:conservativePointAndLineRasterization       | - | ename:VK_FALSE | implementation-dependent
| pname:degenerateTrianglesRasterized               | - | ename:VK_FALSE | implementation-dependent
| pname:degenerateLinesRasterized                   | - | ename:VK_FALSE | implementation-dependent
| pname:fullyCoveredFragmentShaderInputVariable     | - | ename:VK_FALSE | implementation-dependent
| pname:conservativeRasterizationPostDepthCoverage  | - | ename:VK_FALSE | implementation-dependent
endif::VK_EXT_conservative_rasterization[]
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
| pname:maxUpdateAfterBindDescriptorsInAllPools             | - |500000| min
| pname:shaderUniformBufferArrayNonUniformIndexingNative    | - | ename:VK_FALSE| implementation-dependent
| pname:shaderSampledImageArrayNonUniformIndexingNative     | - | ename:VK_FALSE| implementation-dependent
| pname:shaderStorageBufferArrayNonUniformIndexingNative    | - | ename:VK_FALSE| implementation-dependent
| pname:shaderStorageImageArrayNonUniformIndexingNative     | - | ename:VK_FALSE| implementation-dependent
| pname:shaderInputAttachmentArrayNonUniformIndexingNative  | - | ename:VK_FALSE| implementation-dependent
...
| pname:maxPerStageDescriptorUpdateAfterBindInputAttachments| - |4 ({core}) +
                                                                     7 ({limit2022}) ^14^ | min
| pname:maxPerStageUpdateAfterBindResources                 | - |500000 | min
...
| pname:maxDescriptorSetUpdateAfterBindUniformBuffersDynamic| - |8 ^13^ | min
| pname:maxDescriptorSetUpdateAfterBindStorageBuffers       | - |500000 ^9^ | min
| pname:maxDescriptorSetUpdateAfterBindStorageBuffersDynamic| - |4 ^13^ | min
ifdef::VK_KHR_maintenance7[]
| pname:maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic | - | pname:maxDescriptorSetUpdateAfterBindUniformBuffersDynamic ^13^ | min
| pname:maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic | - | pname:maxDescriptorSetUpdateAfterBindStorageBuffersDynamic ^13^ | min
| pname:maxDescriptorSetUpdateAfterBindTotalBuffersDynamic        | - | [eq]#pname:maxDescriptorSetUpdateAfterBindUniformBuffersDynamic {plus} pname:maxDescriptorSetUpdateAfterBindStorageBuffersDynamic# ^13^ | min
endif::VK_KHR_maintenance7[]
...
| pname:maxDescriptorSetUpdateAfterBindInputAttachments     | - |4 ^14^ | min
endif::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
| pname:maxInlineUniformBlockSize                               | - | 256   | min
| pname:maxPerStageDescriptorInlineUniformBlocks                | - | 4     | min
| pname:maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks | - | 4 ^9^ | min
| pname:maxDescriptorSetInlineUniformBlocks                     | - | 4     | min
| pname:maxDescriptorSetUpdateAfterBindInlineUniformBlocks      | - | 4 ^9^ | min
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
ifdef::VK_COMPUTE_VERSION_1_3[]
...
| pname:transformFeedbackQueries                            | - | ename:VK_FALSE     | implementation-dependent
| pname:transformFeedbackStreamsLinesTriangles              | - | ename:VK_FALSE     | implementation-dependent
| pname:transformFeedbackRasterizationStreamSelect          | - | ename:VK_FALSE     | implementation-dependent
| pname:transformFeedbackDraw                               | - | ename:VK_FALSE     | implementation-dependent
endif::VK_EXT_transform_feedback[]
ifdef::VK_EXT_shader_split_barrier[]
| pname:splitBarrierReservedSharedMemory |   -   | 8   | max
endif::VK_EXT_shader_split_barrier[]
ifdef::VK_EXT_fragment_density_map[]
...
ifdef::VK_EXT_fragment_density_map2[]
| pname:subsampledLoads                           | ename:VK_TRUE  | ename:VK_FALSE | implementation-dependent
| pname:subsampledCoarseReconstructionEarlyAccess | ename:VK_FALSE | ename:VK_FALSE | implementation-dependent
...
ifdef::VK_VALVE_fragment_density_map_layered[]
| pname:maxFragmentDensityMapLayers     | - | (2) | max
endif::VK_VALVE_fragment_density_map_layered[]
endif::VK_EXT_fragment_density_map[]
ifdef::VK_NV_ray_tracing,VK_KHR_ray_tracing_pipeline[]
ifdef::VK_NV_ray_tracing[]
...
ifdef::VK_NV_cluster_acceleration_structure[]
| pname:maxVerticesPerCluster                   | - | 256 | min
| pname:maxTrianglesPerCluster                  | - | 256 | min
| pname:clusterScratchByteAlignment             | - | 256  | max
| pname:clusterByteAlignment                    | - | 128  | max
| pname:clusterTemplateByteAlignment            | - | 32  | max
| pname:clusterBottomLevelByteAlignment         | - | 256  | max
| pname:clusterTemplateBoundsByteAlignment      | - | 32  | max
| pname:maxClusterGeometryIndex                 | - | 2^24^-1    | min
endif::VK_NV_cluster_acceleration_structure[]
...
ifdef::VK_NV_partitioned_acceleration_structure[]
| pname:maxPartitionCount                   | - | 2^24^-1 | min
endif::VK_NV_partitioned_acceleration_structure[]
ifdef::VK_BASE_VERSION_1_2,VK_KHR_timeline_semaphore[]
...
| pname:maxIndirectCommandsStreamCount +  (for NV extension)                              | - | 2^12^    | min
...
ifdef::VK_EXT_device_generated_commands[]
| pname:maxIndirectPipelineCount                  | - | 2^12^   | min
| pname:deviceGeneratedCommandsTransformFeedback  | - | false   | implementation-dependent
...
| pname:maxIndirectCommandsIndirectStride           | - | 2048   | min
| pname:supportedIndirectCommandsInputModes | - | ename:VK_INDIRECT_COMMANDS_INPUT_MODE_VULKAN_INDEX_BUFFER_EXT | min
| pname:supportedIndirectCommandsShaderStages     | - | (ename:VK_SHADER_STAGE_COMPUTE_BIT \| ename:VK_SHADER_STAGE_VERTEX_BIT \| ename:VK_SHADER_STAGE_FRAGMENT_BIT) | min
| pname:supportedIndirectCommandsShaderStagesPipelineBinding     | - | 0 | min
ifdef::VK_EXT_shader_object[]
| pname:supportedIndirectCommandsShaderStagesShaderBinding     | - | 0 | min
endif::VK_EXT_shader_object[]
endif::VK_EXT_device_generated_commands[]
ifdef::VK_EXT_custom_border_color[]
...
| pname:primitiveFragmentShadingRateWithMultipleViewports   | ename:VK_FALSE | ename:VK_FALSE   | implementation-dependent
| pname:layeredShadingRateAttachments                       | ename:VK_FALSE | ename:VK_FALSE   | implementation-dependent
| pname:fragmentShadingRateNonTrivialCombinerOps            |   -   | ename:VK_FALSE   | implementation-dependent
...
| pname:fragmentShadingRateWithShaderDepthStencilWrites     |   -   | ename:VK_FALSE   | implementation-dependent
| pname:fragmentShadingRateWithSampleMask                   |   -   | ename:VK_FALSE   | implementation-dependent
| pname:fragmentShadingRateWithShaderSampleMask             |   -   | ename:VK_FALSE   | implementation-dependent
| pname:fragmentShadingRateWithConservativeRasterization    |   -   | ename:VK_FALSE   | implementation-dependent
| pname:fragmentShadingRateWithFragmentShaderInterlock      |   -   | ename:VK_FALSE   | implementation-dependent
| pname:fragmentShadingRateWithCustomSampleLocations        |   -   | ename:VK_FALSE   | implementation-dependent
| pname:fragmentShadingRateStrictMultiplyCombiner           |   -   | ename:VK_FALSE   | implementation-dependent
endif::VK_KHR_fragment_shading_rate[]
ifdef::VK_NV_fragment_shading_rate_enums[]
| pname:maxFragmentShadingRateInvocationCount               | - | ename:VK_SAMPLE_COUNT_4_BIT | min
endif::VK_NV_fragment_shading_rate_enums[]
ifdef::VK_EXT_descriptor_buffer[]
| pname:combinedImageSamplerDescriptorSingleArray          | - | ename:VK_FALSE | implementation-dependent
| pname:bufferlessPushDescriptors            | - | ename:VK_FALSE | implementation-dependent
| pname:allowSamplerImageViewPostSubmitCreation     | - | ename:VK_FALSE | implementation-dependent
...
ifdef::VK_EXT_graphics_pipeline_library[]
| pname:graphicsPipelineLibraryFastLinking                  | - | ename:VK_FALSE | implementation-dependent
| pname:graphicsPipelineLibraryIndependentInterpolationDecoration | - | ename:VK_FALSE | implementation-dependent
endif::VK_EXT_graphics_pipeline_library[]
ifdef::VK_KHR_fragment_shader_barycentric[]
| pname:triStripVertexOrderIndependentOfProvokingVertex     |   -   | ename:VK_FALSE   | implementation-dependent
endif::VK_KHR_fragment_shader_barycentric[]
ifdef::VK_QCOM_image_processing[]
...
ifdef::VK_KHR_opacity_micromap[]
| slink:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxOpacity2StateSubdivisionLevel      | - | 3      | min
| sname:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxOpacity4StateSubdivisionLevel      | - | 3      | min
| sname:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxOpacityLossy4StateSubdivisionLevel | - | 3      | min
| sname:VkPhysicalDeviceOpacityMicromapPropertiesKHR::pname:maxMicromapTriangles                  | - | 2^27^  | min
endif::VK_KHR_opacity_micromap[]
ifdef::VK_EXT_opacity_micromap[]
| slink:VkPhysicalDeviceOpacityMicromapPropertiesEXT::pname:maxOpacity2StateSubdivisionLevel | - | 3      | min
| sname:VkPhysicalDeviceOpacityMicromapPropertiesEXT::pname:maxOpacity4StateSubdivisionLevel | - | 3      | min
endif::VK_EXT_opacity_micromap[]
ifdef::VK_NV_memory_decompression,VK_EXT_memory_decompression[]
...
| pname:maxExecutionGraphVertexBufferBindings               |   -   | 1024    | min
| pname:maxExecutionGraphWorkgroupCount                     |   -   | (65535,65535,65535) | min
| pname:maxExecutionGraphWorkgroups                         |   -   | 2^24^-1 | min
endif::VK_AMDX_shader_enqueue[]
ifdef::VK_NV_extended_sparse_address_space[]
...
ifdef::VK_KHR_maintenance7[]
| pname:separateDepthStencilAttachmentAccess | ename:VK_FALSE | - | implementation-dependent
endif::VK_KHR_maintenance7[]
ifdef::VK_NV_cooperative_matrix2[]
| pname:cooperativeMatrixWorkgroupScopeMaxWorkgroupSize                      |   -   | [eq]#subgroupSize {times} 2#                 | min
| pname:cooperativeMatrixFlexibleDimensionsMaxDimension                      |   -   | 256                                          | min
| pname:cooperativeMatrixWorkgroupScopeReservedSharedMemory                  |   -   | [eq]#pname:maxComputeSharedMemorySize / 2#   | max
endif::VK_NV_cooperative_matrix2[]
ifdef::VK_NV_cooperative_vector[]
| pname:maxCooperativeVectorComponents  | - | 128 | min
endif::VK_NV_cooperative_vector[]
ifdef::VK_EXT_shader_long_vector[]
| pname:maxVectorComponents  | - | 1024 | min
endif::VK_EXT_shader_long_vector[]
ifdef::VK_QCOM_queue_perf_hint[]
| slink:VkPhysicalDeviceQueuePerfHintPropertiesQCOM::pname:supportedQueues | - | ename:VK_QUEUE_GRAPHICS_BIT \| +
                                                                                 ename:VK_QUEUE_COMPUTE_BIT
                                                                                    | bitfield
endif::VK_QCOM_queue_perf_hint[]
ifdef::VK_QCOM_tile_shading[]
| pname:maxApronSize                     | - | 1        | min
| pname:preferNonCoherent                | - | -        | implementation-dependent
| pname:tileGranularity                  | - | (16,16)  | min
| pname:maxTileShadingRate               | - | (8,8)    | min
endif::VK_QCOM_tile_shading[]
ifdef::VK_QCOM_shader_multiple_wait_queues[]
| pname:maxShaderWaitQueues              | - | 2        | min
endif::VK_QCOM_shader_multiple_wait_queues[]
ifdef::VK_ARM_tensors[]
| pname:maxTensorDimensionCount                            | 0 |      4 | min
| pname:maxTensorElements                                  | 0 |  65536 | min
| pname:maxPerDimensionTensorElements                      | 0 |  65536 | min
| pname:maxTensorStride                                    | 0 |  65536 | min
| pname:maxTensorSize                                      | 0 |  65536 | min
| pname:maxTensorShaderAccessArrayLength                   | 0 |      4 | min
| pname:maxTensorShaderAccessSize                          | 0 |      4 | min
| pname:maxDescriptorSetStorageTensors                     | 0 |     16 | min
| pname:maxPerStageDescriptorSetStorageTensors             | 0 |     16 | min
| pname:maxDescriptorSetUpdateAfterBindStorageTensors      | 0 | 500000 ^9^ | min
| pname:maxPerStageDescriptorUpdateAfterBindStorageTensors | 0 | 500000 ^9^ | min
| pname:shaderTensorSupportedStages                        | 0 | ename:VK_SHADER_STAGE_COMPUTE_BIT | bitfield
endif::VK_ARM_tensors[]
ifdef::VK_EXT_ray_tracing_invocation_reorder[]
| pname:maxShaderBindingTableRecordIndex | - | 2^28^-1| min
endif::VK_EXT_ray_tracing_invocation_reorder[]
ifdef::VK_KHR_maintenance10[]
| pname:resolveSrgbFormatAppliesTransferFunction | - | - | implementation-dependent
| pname:resolveSrgbFormatSupportsTransferFunctionControl | ename:VK_FALSE | ename:VK_FALSE | min
endif::VK_KHR_maintenance10[]
ifdef::VK_EXT_descriptor_heap[]
| pname:samplerHeapAlignment                  | - | 65536                                                      | max
| pname:resourceHeapAlignment                 | - | 65536                                                      | max
| pname:maxSamplerHeapSize                    | - | [eq]#max( +
                                                    4000 × pname:samplerDescriptorSize
                                                    + pname:minSamplerHeapReservedRange, +
                                                    2048 × pname:samplerDescriptorSize
                                                    + pname:minSamplerHeapReservedRangeWithEmbedded)#          | min
| pname:maxResourceHeapSize                   | - | [eq]#(2^20^ - 2^15^) × max(pname:imageDescriptorSize,
                                                    pname:bufferDescriptorSize)
                                                    + pname:minResourceHeapReservedRange#                      | min
| pname:minSamplerHeapReservedRange              | - | [eq]#96 × pname:samplerDescriptorSize#                  | max
| pname:minSamplerHeapReservedRangeWithEmbedded  | - | [eq]#2048 × pname:samplerDescriptorSize#                | max
| pname:minResourceHeapReservedRange             | - | [eq]#2^15^ × max(pname:imageDescriptorSize,
                                                       pname:bufferDescriptorSize)#                            | max
...
| pname:imageCaptureReplayOpaqueDataSize      | - | -                                                          | implementation-dependent
endif::VK_EXT_descriptor_heap[]
ifdef::VK_ARM_shader_instrumentation[]
| pname:numMetrics                            | - | 1                                                          | min
| pname:perBasicBlockGranularity              | - | VK_FALSE                                                   | max
endif::VK_ARM_shader_instrumentation[]
ifdef::VK_KHR_shader_abort[]
| pname:maxShaderAbortMessageSize                           | 0 | 65536 | min
endif::VK_KHR_shader_abort[]
ifdef::VK_KHR_device_fault[]
| pname:maxDeviceFaultCount | 0 | 1 | min
endif::VK_KHR_device_fault[]
ifdef::VK_VALVE_buffer_device_address_allocation_alignment[]
| pname:maxBufferDeviceAddressAllocationAlignment | - | 65536 | min
endif::VK_VALVE_buffer_device_address_allocation_alignment[]
|====
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
9::
    This ptext:UpdateAfterBind descriptor limit must: be greater than or
    equal to the corresponding ptext:non-UpdateAfterBind limit if the
    corresponding ptext:UpdateAfterBind feature is supported.
...
ifdef::VKSC_VERSION_1_0[]
11::
    ptext:maxFramebufferAttachments must: be greater than or equal to two
    times pname:maxColorAttachments (for color and resolve attachments) plus
    one (for the depth/stencil attachment), or else must: be equal to
    2^32^-1.
endif::VKSC_VERSION_1_0[]
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
13::
    This ptext:UpdateAfterBind descriptor limit exists and is defined to
    have a non-zero supported limit for historical reasons.
    As ename:VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT must: not be used
    ...
    bindings created with ename:VK_DESCRIPTOR_BINDING_UPDATE_AFTER_BIND_BIT,
...
14::
    ...
    ptext:non-UpdateAfterBind limit applies.
endif::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
--
...
// This use of VK_VERSION_1_3 in this block is intentional
ifdef::VK_VERSION_1_3[]
[[milestone-limits]]
== Milestone Limits


[[milestone-limits-roadmap-2022]]
=== Roadmap 2022
...
// This use of VK_VERSION_1_4 in this block is intentional
ifdef::VK_VERSION_1_4[]
[[milestone-limits-roadmap-2026]]
=== Roadmap 2026

Implementations that claim support for the <<roadmap-2026, Roadmap 2026>>
milestone must: satisfy the following additional limit requirements:

[width="100%",cols="<35,<14,<11",options="header"]
|====
| Limit                                                 | Supported Limit  | Limit Type^1^
| pname:maxPerStageDescriptorUniformBuffers             | 200   | min
| pname:maxPerStageDescriptorStorageBuffers             | 200   | min
| pname:maxPerStageDescriptorInputAttachments           | 8     | min
| pname:maxDescriptorSetUniformBuffers                  | 1800  | min
| pname:maxDescriptorSetStorageBuffers                  | 1800  | min
| pname:maxDescriptorSetInputAttachments                | 8     | min
| pname:maxVertexOutputComponents                       | 124   | min
| pname:maxTessellationControlPerVertexInputComponents  | 128   | min
| pname:maxTessellationControlPerVertexOutputComponents | 128   | min
| pname:maxTessellationControlTotalOutputComponents     | 4096  | min
| pname:maxTessellationEvaluationInputComponents        | 128   | min
| pname:maxTessellationEvaluationOutputComponents       | 128   | min
| pname:maxGeometryOutputComponents                     | 128   | min
| pname:maxFragmentInputComponents                      | 112   | min
| pname:maxFragmentOutputAttachments                    | 8     | min
| pname:maxComputeSharedMemorySize                      | 32768 | min
| pname:subPixelPrecisionBits                           | 8     | min
| pname:maxViewportDimensions.width                     | 8192  | min
| pname:maxViewportDimensions.height                    | 8192  | min
| pname:maxFramebufferWidth                             | 8192  | min
| pname:maxFramebufferHeight                            | 8192  | min
|====
