...
include::{generated}/api/structs/VkPhysicalDeviceMemoryDecompressionPropertiesNV.adoc[]
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:decompressionMethods specifies the list of all the memory
    decompression methods supported by the implementation as a bitmask of
    ename:VkMemoryDecompressionMethodFlagBitsNV.
...
The members of the
sname:VkPhysicalDeviceRayTracingInvocationReorderPropertiesNV structure
