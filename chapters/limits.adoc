...
number of elements in the pname:pLayeredApis array, and on return the
...
number of elements in the pname:pCopyDstLayouts array, and on return the
variable is overwritten with the number of values actually written to
...
number of elements in the pname:pCopySrcLayouts array, and on return the
variable is overwritten with the number of values actually written to
