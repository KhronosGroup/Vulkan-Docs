...
| pname:maxImageDimension1D                  | - | 4096 +
                                                   8192 ({limit2022}, {limit1_4})  | min
| pname:maxImageDimension2D                  | - | 4096 +
                                                   8192 ({limit2022}, {limit1_4})  | min
| pname:maxImageDimension3D                  | - | 256 +
                                                   512 ({limit1_4})                | min
| pname:maxImageDimensionCube                | - | 4096 +
                                                   8192 ({limit2022}, {limit1_4})  | min
| pname:maxImageArrayLayers                  | - | 256 +
                                                   2048 ({limit2022}, {limit1_4})  | min
| pname:maxTexelBufferElements               | - | 65536   | min
| pname:maxUniformBufferRange                | - | 16384 +
                                                   65536 ({limit2022}, {limit1_4}) | min
| pname:maxStorageBufferRange                | - | 2^27^   | min
| pname:maxPushConstantsSize                 | - | 128 +
                                                   256 ({limit1_4})                | min
| pname:maxMemoryAllocationCount             | - | 4096    | min
| pname:maxSamplerAllocationCount            | - | 4000    | min
| pname:bufferImageGranularity               | - | 131072 +
                                                   4096 ({limit2022}, {limit1_4})  | max
| pname:sparseAddressSpaceSize               | 0 | 2^31^   | min
| pname:maxBoundDescriptorSets               | - | 4 +
                                                   7 ({limit2024}, {limit1_4})     | min
| pname:maxPerStageDescriptorSamplers        | - | 16      | min
| pname:maxPerStageDescriptorUniformBuffers  | - | 12 +
                                                   15 ({limit2022}, {limit1_4})    | min
| pname:maxPerStageDescriptorStorageBuffers  | - | 4 +
                                                   30 ({limit2022})                | min
| pname:maxPerStageDescriptorSampledImages   | - | 16 +
                                                   200 ({limit2022})               | min
| pname:maxPerStageDescriptorStorageImages   | - | 4 +
                                                   144 ({limit2022})               | min
| pname:maxPerStageDescriptorInputAttachments| - | 4       | min
| pname:maxPerStageResources                 | - | 128 ^2^ +
                                                   200 ({limit2022}, {limit1_4})   | min
| pname:maxDescriptorSetSamplers             | - | 96 ^8^ +
                                                   576 ({limit2022})               | min, _n_ {times} PerStage
| pname:maxDescriptorSetUniformBuffers       | - | 72 ^8^ +
                                                   90 ({limit2022}, {limit1_4})    | min, _n_ {times} PerStage
| pname:maxDescriptorSetUniformBuffersDynamic| - | 8       | min
| pname:maxDescriptorSetStorageBuffers       | - | 24 ^8^ +
...
| pname:maxDescriptorSetSampledImages        | - | 96 ^8^ +
                                                   1800 ({limit2022})              | min, _n_ {times} PerStage
| pname:maxDescriptorSetStorageImages        | - | 24 ^8^ +
...
ifdef::VK_VERSION_1_2,VK_KHR_shader_float_controls[]
| pname:shaderSignedZeroInfNanPreserveFloat16 | - | ename:VK_TRUE ({limit2022}, {limit1_4}) | Boolean
| pname:shaderSignedZeroInfNanPreserveFloat32 | - | ename:VK_TRUE ({limit2022}, {limit1_4}) | Boolean
| pname:shaderRoundingModeRTEFloat16          | - | ename:VK_TRUE ({limit2024}) | Boolean
| pname:shaderRoundingModeRTEFloat32          | - | ename:VK_TRUE ({limit2024}) | Boolean
endif::VK_VERSION_1_2,VK_KHR_shader_float_controls[]
ifdef::VK_VERSION_1_3,VK_EXT_subgroup_size_control[]
| pname:maxSubgroupSize                      | - | 4 ({limit2022})              | min
endif::VK_VERSION_1_3,VK_EXT_subgroup_size_control[]
| pname:subPixelPrecisionBits                | - | 4       | min
| pname:subTexelPrecisionBits                | - | 4 +
                                                   8 ({limit2022}, {limit1_4})  | min
| pname:mipmapPrecisionBits                  | - | 4 +
                                                   6 ({limit2022}, {limit1_4})  | min
| pname:maxDrawIndexedIndexValue             | 2^24^-1 | 2^32^-1 | min
| pname:maxDrawIndirectCount                 | 1 | 2^16^-1 | min
| pname:maxSamplerLodBias                    | - | 2 +
...
| pname:maxPerStageDescriptorUpdateAfterBindInputAttachments| 0 ^9^ |4 ^9^ +
                                                                     7 ({limit2022}) | min
