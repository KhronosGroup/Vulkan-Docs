...
ifdef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-vkCmdSetColorBlendAdvancedEXT-None-08592]]
    Either the <<features-extendedDynamicState3ColorBlendAdvanced,
    pname:extendedDynamicState3ColorBlendAdvanced>> feature or the
    <<features-shaderObject, pname:shaderObject>> feature or both must: be
    enabled
endif::VK_EXT_extended_dynamic_state3[]
ifndef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-vkCmdSetColorBlendAdvancedEXT-None-08593]]
...
ifndef::VK_EXT_shader_object[]
  * [[VUID-vkCmdSetColorBlendAdvancedEXT-extendedDynamicState3ColorBlendAdvanced-07504]]
    The <<features-extendedDynamicState3ColorBlendAdvanced,
    pname:extendedDynamicState3ColorBlendAdvanced>> feature must: be enabled
endif::VK_EXT_shader_object[]
****
