...
ifdef::VK_EXT_descriptor_heap,VK_KHR_copy_memory_indirect[]
=== Device Address Ranges

ifdef::VK_EXT_descriptor_heap[]
[open,refpage='VkDeviceAddressRangeEXT',desc='Structure specifying a device address range',type='structs']
--
:refpage: VkDeviceAddressRangeEXT
...
include::{generated}/validity/structs/VkDeviceAddressRangeEXT.adoc[]
--
endif::VK_EXT_descriptor_heap[]
...
endif::VK_EXT_descriptor_heap,VK_KHR_copy_memory_indirect[]
