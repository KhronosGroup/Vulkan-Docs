...
ifdef::VK_EXT_device_generated_commands[]
  * sname:VkIndirectCommandsLayoutEXT
  * sname:VkIndirectExecutionSetEXT
...
ifdef::VK_EXT_device_generated_commands[]
use of a <<device-generated-indirect-execution-sets,referenced object>> for
additional shader-related states in a set,
endif::VK_EXT_device_generated_commands[]
ifdef::VK_KHR_acceleration_structure[]
