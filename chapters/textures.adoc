...
ifdef::VK_VERSION_1_3,VK_EXT_image_robustness,VK_EXT_robustness2,VK_KHR_robustness2[]
...
endif::VK_VERSION_1_3,VK_EXT_image_robustness,VK_EXT_robustness2,VK_KHR_robustness2[]
...
<<textures-implict-reconstruction,Implicit Reconstruction>> section.
...
conversion if the <<features-ycbcrDegamma,pname:ycbcrDegamma>> feature is
enabled.
endif::VK_QCOM_ycbcr_degamma[]
