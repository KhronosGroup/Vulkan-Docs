...
ifdef::VK_EXT_shader_object[]
    ...
    enabled, and the <<dynamic-state-current-value, current value>> of
    pname:rasterizerDiscardEnable is ename:VK_FALSE, and the
    <<dynamic-state-current-value, current value>> of pname:polygonMode is
    ename:VK_POLYGON_MODE_LINE, then flink:vkCmdSetLineRasterizationModeEXT
    must: have been called and not subsequently <<dynamic-state-lifetime,
    invalidated>> in the current command buffer prior to this drawing
    command
  * [[VUID-{refpage}-None-08667]]
    ...
    pname:stippledSmoothLines>> features are enabled, and
ifdef::VK_EXT_shader_object[]
    a shader object is bound or
endif::VK_EXT_shader_object[]
    a graphics pipeline is bound which was created with the
    ename:VK_DYNAMIC_STATE_LINE_RASTERIZATION_MODE_EXT dynamic state
    enabled, and a ename:VK_SHADER_STAGE_VERTEX_BIT stage is bound, the
    <<dynamic-state-current-value, current value>> of
    pname:rasterizerDiscardEnable is ename:VK_FALSE, and the
    <<dynamic-state-current-value, current value>> of
    pname:primitiveTopology is any line topology, then
...
ifdef::VK_EXT_shader_object[]
    ...
    a graphics pipeline is bound which was created with the
    ename:VK_DYNAMIC_STATE_LINE_RASTERIZATION_MODE_EXT dynamic state
    enabled, either a ename:VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT or
    ename:VK_SHADER_STAGE_GEOMETRY_BIT stage is bound, and the
    <<dynamic-state-current-value, current value>> of
    pname:rasterizerDiscardEnable is ename:VK_FALSE, then
    flink:vkCmdSetLineRasterizationModeEXT must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
...
ifdef::VK_EXT_shader_object[]
    ...
    pname:rasterizerDiscardEnable is ename:VK_FALSE, and the
    <<dynamic-state-current-value, current value>> of pname:polygonMode is
    ename:VK_POLYGON_MODE_LINE, then flink:vkCmdSetLineStippleEnableEXT
    must: have been called and not subsequently <<dynamic-state-lifetime,
    invalidated>> in the current command buffer prior to this drawing
    command
...
ifdef::VK_EXT_shader_object[]
    ...
    a graphics pipeline is bound which was created with the
    ename:VK_DYNAMIC_STATE_LINE_STIPPLE_ENABLE_EXT dynamic state enabled, a
    ename:VK_SHADER_STAGE_VERTEX_BIT stage is bound, the
    <<dynamic-state-current-value, current value>> of
    pname:rasterizerDiscardEnable is ename:VK_FALSE, and the
    <<dynamic-state-current-value, current value>> of
    pname:primitiveTopology is any line topology, then
...
ifdef::VK_EXT_shader_object[]
    ...
    a graphics pipeline is bound which was created with the
    ename:VK_DYNAMIC_STATE_LINE_STIPPLE_ENABLE_EXT dynamic state enabled,
    either a ename:VK_SHADER_STAGE_TESSELLATION_EVALUATION_BIT or
    ename:VK_SHADER_STAGE_GEOMETRY_BIT stage is bound, the
    <<dynamic-state-current-value, current value>> of
    pname:rasterizerDiscardEnable is ename:VK_FALSE, then
    flink:vkCmdSetLineStippleEnableEXT must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
...
ifdef::VK_EXT_shader_object[]
    ...
    a graphics pipeline is bound which was created with the
    ename:VK_DYNAMIC_STATE_LINE_RASTERIZATION_MODE_EXT dynamic state
    enabled, and the current pname:lineRasterizationMode is
