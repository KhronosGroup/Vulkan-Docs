...
include::{chapters}/commonvalidity/draw_dispatch_common.adoc[]
  ...
  * [[VUID-{refpage}-None-07469]]
    ...
    same elink:VkFormat as the corresponding subpass definition be created
    with a slink:VkImageView that is an attachment in the currently bound
    slink:VkFramebuffer at an index that corresponds to a valid input
