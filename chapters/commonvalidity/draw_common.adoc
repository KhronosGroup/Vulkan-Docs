...
ifdef::VK_EXT_shader_object[]
  ...
  * [[VUID-{refpage}-None-07845]]
    ...
    flink:vkCmdSetDepthCompareOp must: have been called and not subsequently
    <<dynamic-state-lifetime, invalidated>> in the current command buffer
    prior to this drawing command
ifdef::VK_EXT_shader_object[]
  ...
  * [[VUID-{refpage}-None-07846]]
    ...
    then flink:vkCmdSetDepthBoundsTestEnable must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-None-08632]]
    ...
    the flink:vkCmdSetDepthBoundsTestEnable must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_shader_object[]
...
ifdef::VK_EXT_shader_object[]
  ...
  * [[VUID-{refpage}-None-07848]]
    ...
    flink:vkCmdSetStencilOp must: have been called and not subsequently
    <<dynamic-state-lifetime, invalidated>> in the current command buffer
    prior to this drawing command
ifdef::VK_EXT_shader_object[]
...
ifdef::VK_NV_scissor_exclusive[]
  ...
  * [[VUID-{refpage}-None-07878]]
    ...
    then flink:vkCmdSetExclusiveScissorEnableNV must: have been called and
  ...
  * [[VUID-{refpage}-None-07879]]
    ...
    flink:vkCmdSetExclusiveScissorNV must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-exclusiveScissor-09235]]
    ...
    flink:vkCmdSetExclusiveScissorEnableNV must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
...
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-None-08639]]
    ...
    flink:vkCmdSetRasterizerDiscardEnable must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_shader_object[]
...
ifdef::VK_EXT_extended_dynamic_state2[]
  * [[VUID-{refpage}-logicOp-04878]]
    ...
    flink:vkCmdSetLogicOpEXT must: have been called and not subsequently
    <<dynamic-state-lifetime, invalidated>> in the current command buffer
    prior to this drawing command
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-None-08641]]
    ...
    then flink:vkCmdSetLogicOpEXT must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_shader_object[]
...
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-None-09237]]
    ...
    flink:vkCmdSetTessellationDomainOriginEXT must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
...
ifdef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-{refpage}-None-07622]]
    If the bound graphics pipeline state was created with the
    ename:VK_DYNAMIC_STATE_RASTERIZATION_SAMPLES_EXT dynamic state enabled
    then flink:vkCmdSetRasterizationSamplesEXT must: have been called and
    not subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_extended_dynamic_state3[]
ifdef::VK_EXT_shader_object[]
...
ifdef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-{refpage}-None-07625]]
    ...
    then flink:vkCmdSetAlphaToOneEnableEXT must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_extended_dynamic_state3[]
ifdef::VK_EXT_shader_object[]
...
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-None-08660]]
    ...
    flink:vkCmdSetRasterizationStreamEXT must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_shader_object[]
endif::VK_EXT_transform_feedback[]
...
ifdef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-{refpage}-None-07636]]
    ...
    then flink:vkCmdSetProvokingVertexModeEXT must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_extended_dynamic_state3[]
ifdef::VK_EXT_shader_object[]
...
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-None-08673]]
    ...
    enabled, and a shader object is bound to any graphics stage, then
    flink:vkCmdSetDepthClipNegativeOneToOneEXT must: have been called and
    not subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_shader_object[]
...
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-None-08674]]
    ...
    flink:vkCmdSetViewportWScalingEnableNV must: have been called and not
    subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_shader_object[]
endif::VK_NV_clip_space_w_scaling[]
...
ifdef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-{refpage}-None-07642]]
    ...
    then flink:vkCmdSetCoverageToColorEnableNV must: have been called and
    not subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_extended_dynamic_state3[]
ifdef::VK_EXT_shader_object[]
...
ifdef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-{refpage}-None-07644]]
    ...
    then flink:vkCmdSetCoverageModulationModeNV must: have been called and
    not subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command buffer prior to this drawing command
endif::VK_EXT_extended_dynamic_state3[]
ifdef::VK_EXT_shader_object[]
...
ifdef::VK_EXT_extended_dynamic_state3[]
  * [[VUID-{refpage}-None-07649]]
    ...
    then flink:vkCmdSetCoverageReductionModeNV must: have been called and
    not subsequently <<dynamic-state-lifetime, invalidated>> in the current
    command sbuffer prior to this drawing command
endif::VK_EXT_extended_dynamic_state3[]
ifdef::VK_EXT_shader_object[]
