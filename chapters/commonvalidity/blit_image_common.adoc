...
ifdef::VK_KHR_shared_presentable_image[]
  ...
  * [[VUID-{refpage}-srcImage-09459]]
    If pname:srcImage and pname:dstImage are the same, and an element of
...
ifdef::VK_KHR_shared_presentable_image[]
  ...
  * [[VUID-{refpage}-srcImage-00230]]
    ...
    unsigned integer color elink:VkFormat, the other must: also have been
    created with an unsigned integer color elink:VkFormat
...
ifdef::VK_KHR_maintenance8[the <<features-maintenance8,pname:maintenance8>> feature is not enabled and]
  ...
  * [[VUID-{refpage}-dstImage-00252]]
    ...
    `1`
  * [[VUID-{refpage}-dstOffsets-12518]]
    pname:dstOffsets[0].x must: not be equal to pname:dstOffsets[1].x
  * [[VUID-{refpage}-dstOffsets-12519]]
    pname:dstOffsets[0].y must: not be equal to pname:dstOffsets[1].y
  * [[VUID-{refpage}-dstOffsets-12520]]
    pname:dstOffsets[0].z must: not be equal to pname:dstOffsets[1].z
// Common Valid Usage
