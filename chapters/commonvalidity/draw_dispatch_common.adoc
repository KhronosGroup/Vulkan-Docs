...
ifdef::VK_QCOM_filter_cubic_clamp[]
  * [[VUID-{refpage}-cubicRangeClamp-09212]]
    ...
    not enabled, then any slink:VkImageView being sampled as a result of
...
ifdef::VK_KHR_ray_query[]
  * [[VUID-{refpage}-micromap-11636]]
    ...
    through an code:OpRayQueryProceedKHR operation
...
ifdef::VK_KHR_maintenance5,VK_BASE_VERSION_1_4[]
  * [[VUID-{refpage}-micromap-11638]]
    ...
    pname:indexBuffer containing both elink:VkOpacityMicromapSpecialIndexKHR
    ...
    must: not have been created with pname:flags that includes
...
ifdef::VK_EXT_shader_object[]
  * [[VUID-{refpage}-micromap-11639]]
    ...
    pname:indexBuffer containing both elink:VkOpacityMicromapSpecialIndexKHR
    values and indices into an associated micromap array, any
    slink:VkShaderEXT that accessed the descriptor must: not have been
    created with pname:flags that includes
