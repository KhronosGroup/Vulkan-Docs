...
ifdef::VK_KHR_ray_tracing_pipeline,VK_NV_ray_tracing[]
  ...
  * [[VUID-{refpage}-pNext-11316]]
    ...
    <<limits-maxPushDataSize,pname:maxPushDataSize>> minus the
    pname:pushDataOffset used in the mapping
ifdef::VK_KHR_ray_tracing_pipeline,VK_NV_ray_tracing[]
  * [[VUID-{refpage}-pNext-12454]]
    If the pname:pNext chain specifies a <<descriptorheaps-bindings,
    descriptor mapping>> using
    ...
    ename:VK_DESCRIPTOR_MAPPING_SOURCE_SHADER_RECORD_ADDRESS_EXT, and there
    is a variable in the shader that matches the mapping, the pname:stage
...
ifdef::VK_KHR_ray_tracing_pipeline,VK_NV_ray_tracing[]
    ...
    ename:VK_DESCRIPTOR_MAPPING_SOURCE_PUSH_ADDRESS_EXT, or
    ename:VK_DESCRIPTOR_MAPPING_SOURCE_INDIRECT_ADDRESS_EXT the mapped
...
ifdef::VK_KHR_ray_tracing_pipeline,VK_NV_ray_tracing[]
    ...
    code:OpArrayLength
ifdef::VK_KHR_shader_untyped_pointers[or code:OpUntypedArrayLengthKHR]
