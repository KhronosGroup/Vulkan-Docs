...
ifdef::VK_NV_dedicated_allocation_image_aliasing[]
  ...
  * [[VUID-{refpage}-memory-10926]]
    ...
    its pname:pNext chain, slink:VkMemoryDedicatedAllocateInfo::pname:buffer
...
ifdef::VK_EXT_descriptor_heap,VK_EXT_descriptor_buffer[]
  * [[VUID-{refpage}-image-08113]]
    If the pname:image was created with the
    ename:VK_IMAGE_CREATE_DESCRIPTOR_HEAP_CAPTURE_REPLAY_BIT_EXT bit set,
...
endif::VK_EXT_descriptor_heap,VK_EXT_descriptor_buffer[]
// Common Valid Usage
