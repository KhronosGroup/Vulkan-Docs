...
// Common to vkCmdPipelineBarrier* commands
  * [[VUID-{refpage}-None-07889]]
    ...
    ename:VK_DEPENDENCY_BY_REGION_BIT if this command does not,
ifdef::VK_KHR_multiview,VK_GRAPHICS_VERSION_1_1[]
    does not include ename:VK_DEPENDENCY_VIEW_LOCAL_BIT if this command does
    not,
endif::VK_KHR_multiview,VK_GRAPHICS_VERSION_1_1[]
    and has <<synchronization-dependencies-scopes, synchronization scopes>>
    and <<synchronization-dependencies-access-scopes, access scopes>> that
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_dynamic_rendering_local_read,VK_EXT_shader_tile_image[]
...
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_dynamic_rendering_local_read,VK_EXT_shader_tile_image[]
