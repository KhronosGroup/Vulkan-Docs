...
ifdef::VK_EXT_shader_tile_image[]
  * [[VUID-{refpage}-shaderTileImageColorReadAccess-08718]]
    If fname:{refpage} is called within a render pass instance and none of
    the <<features-shaderTileImageColorReadAccess,
    ...
    pname:shaderTileImageStencilReadAccess>> features are enabled, the
    render pass must: not have been started with flink:vkCmdBeginRendering
