...
ifdef::VK_KHR_copy_memory_indirect[]
    ename:VK_PIPELINE_STAGE_2_COPY_INDIRECT_BIT_KHR,
...
ifdef::VK_KHR_ray_query[]
    and the <<features-rayQuery, pname:rayQuery>> feature is enabled,
...
ifdef::VK_KHR_ray_query[]
    one of the etext:VK_PIPELINE_STAGE_*_SHADER_BIT stages,
endif::VK_KHR_ray_query[]
    ename:VK_PIPELINE_STAGE_2_ACCELERATION_STRUCTURE_BUILD_BIT_KHR,
...
ifdef::VK_KHR_ray_query[]
  * [[VUID-{refpage}-{accessMaskName}-06256]]
    If pname:{accessMaskName} includes
    ename:VK_ACCESS_2_ACCELERATION_STRUCTURE_READ_BIT_KHR, and the
    <<features-rayQuery, pname:rayQuery>> feature is not enabled,
    pname:{stageMaskName} must: include
ifdef::VK_NV_ray_tracing,VK_KHR_ray_tracing_pipeline[]
    ename:VK_PIPELINE_STAGE_2_RAY_TRACING_SHADER_BIT_KHR,
endif::VK_NV_ray_tracing,VK_KHR_ray_tracing_pipeline[]
...
ifdef::VK_EXT_memory_decompression[]
  * [[VUID-{refpage}-{accessMaskName}-11771]]
    If pname:{accessMaskName} includes
    ename:VK_ACCESS_2_MEMORY_DECOMPRESSION_READ_BIT_EXT,
    pname:{stageMaskName} must: include
    ename:VK_PIPELINE_STAGE_2_MEMORY_DECOMPRESSION_BIT_EXT
  * [[VUID-{refpage}-{accessMaskName}-11772]]
    If pname:{accessMaskName} includes
...
ifdef::VK_EXT_descriptor_heap[]
  * [[VUID-{refpage}-{accessMaskName}-11294]]
    If pname:{accessMaskName} includes
    ename:VK_ACCESS_2_SAMPLER_HEAP_READ_BIT_EXT or
    ename:VK_ACCESS_2_RESOURCE_HEAP_READ_BIT_EXT, pname:{stageMaskName}
    must: include ename:VK_PIPELINE_STAGE_2_ALL_GRAPHICS_BIT,
    ename:VK_PIPELINE_STAGE_2_ALL_COMMANDS_BIT, or one of
    etext:VK_PIPELINE_STAGE_*_SHADER_BIT stages
