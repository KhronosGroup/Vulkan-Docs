...
ifdef::VK_EXT_primitive_topology_list_restart[]
  * [[VUID-VkPipelineInputAssemblyStateCreateInfo-topology-06252]]
    ...
    <<features-primitiveTopologyListRestart,
    pname:primitiveTopologyListRestart>> feature must: be enabled
  * [[VUID-VkPipelineInputAssemblyStateCreateInfo-topology-06253]]
    ...
    pname:primitiveTopologyPatchListRestart>> feature must: be enabled
endif::VK_EXT_primitive_topology_list_restart[]
...
ifdef::VK_EXT_extended_dynamic_state2[]
  * [[VUID-vkCmdSetPrimitiveRestartEnable-None-08500]]
...
ifndef::VK_EXT_extended_dynamic_state2[]
  * [[VUID-vkCmdSetPrimitiveRestartEnable-None-08501]]
...
ifdef::VK_EXT_extended_dynamic_state[]
  * [[VUID-vkCmdSetPrimitiveTopology-None-08502]]
...
ifndef::VK_EXT_extended_dynamic_state[]
  * [[VUID-vkCmdSetPrimitiveTopology-None-08503]]
    The <<features-shaderObject, pname:shaderObject>> feature must: be
    enabled
endif::VK_EXT_extended_dynamic_state[]
endif::VK_EXT_shader_object[]
...
ifdef::VK_HUAWEI_cluster_culling_shader[]
  ** For draws using cluster culling shaders, the order is provided by
     <<primitive-ordering,cluster culling shading>>.
