...
of the following:
  ...
  * Remove micromaps or elink:VkOpacityMicromapSpecialIndexKHR values from a
    geometry which previously had them, or vice versa.
  * Change between use of elink:VkOpacityMicromapSpecialIndexKHR values and
...
flink:vkCmdCopyMemoryToAccelerationStructureKHR and originally built with
the
ename:VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_OPACITY_MICROMAP_DATA_UPDATE_BIT_EXT
...
micromap
ifdef::VK_EXT_opacity_micromap[]
unless slink:VkMicromapBuildSizesInfoEXT::pname:discardable is ename:VK_TRUE
endif::VK_EXT_opacity_micromap[]
.
...
ifdef::VK_KHR_opacity_micromap,VK_AMDX_dense_geometry_format[]
[NOTE]
====
...
and must: be NULL:
ifdef::VK_AMDX_dense_geometry_format[  ** ename:VK_GEOMETRY_TYPE_DENSE_GEOMETRY_FORMAT_TRIANGLES_AMDX]
ifdef::VK_KHR_opacity_micromap[  ** ename:VK_GEOMETRY_TYPE_MICROMAP_KHR]
====
endif::VK_KHR_opacity_micromap,VK_AMDX_dense_geometry_format[]
...
ifdef::VK_KHR_opacity_micromap[]
slink:VkAccelerationStructureGeometryMicromapDataKHR::pname:data,
slink:VkAccelerationStructureGeometryMicromapDataKHR::pname:triangleArray,
endif::VK_KHR_opacity_micromap[]
...
ifdef::VK_KHR_opacity_micromap,VK_AMDX_dense_geometry_format[]
    if the pname:pInfos[i].type is not one of:
ifdef::VK_AMDX_dense_geometry_format[  ** ename:VK_GEOMETRY_TYPE_DENSE_GEOMETRY_FORMAT_TRIANGLES_AMDX]
ifdef::VK_KHR_opacity_micromap[  ** ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR]
endif::VK_KHR_opacity_micromap,VK_AMDX_dense_geometry_format[]
ifdef::VK_AMDX_dense_geometry_format[]
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-pInfos-10906]]
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-ppBuildRangeInfos-11544]]
    For each element of pname:pInfos[i] whose pname:pGeometries or
    pname:ppGeometries members have a pname:geometryType of
    ename:VK_GEOMETRY_TYPE_MICROMAP_KHR, pname:ppBuildRangeInfos[i] must: be
    `NULL`
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-mode-11545]]
    For each element of pname:pInfos, if its pname:type member is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR, its
    pname:mode must: equal
    ename:VK_BUILD_ACCELERATION_STRUCTURE_MODE_BUILD_KHR
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-srcAccelerationStructure-11546]]
    For each element of pname:pInfos, if its pname:type member is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR, its
    pname:srcAccelerationStructure must: be dlink:VK_NULL_HANDLE
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-dstAccelerationStructure-11547]]
    ...
    either ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR or
  ...
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-dstAccelerationStructure-11548]]
    ...
    slink:VkAccelerationStructureTrianglesOpacityMicromapKHR::pname:micromap
    member included in the pname:pNext chain of any pname:geometry.triangles
    member of any element of pname:pGeometries or pname:ppGeometries in any
    other element of pname:pInfos
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-dstAccelerationStructure-11549]]
    ...
    member included in the pname:pNext chain of any pname:geometry.triangles
    member of any element of pname:pGeometries or pname:ppGeometries in any
    other element of pname:pInfos, which is accessed by this command
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-micromap-11550]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, its pname:data and pname:triangleArray members must:
    be a valid basetype:VkDeviceAddress
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-micromap-11551]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, the buffers from which the buffer device addresses
    for its pname:data and pname:triangleArray members are queried must:
  ...
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-micromap-11553]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, each element of its pname:triangleArray member must:
    specify an access within the range of the slink:VkBuffer that pname:data
    was retrieved from, given by [eq]#[pname:dataOffset, pname:dataOffset +
    triangleSize]# where triangleSize is calculated using its pname:format
    and pname:subdivisionLevel members rounded up to the nearest byte
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-micromap-11554]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, the range of [eq]#[pname:triangleArray,
    pname:triangleArray + (pname:triangleArrayStride * numTriangles)]# must:
    be within the range of the slink:VkBuffer from which the
    pname:triangleArray member was retrieved from, where _numTriangles_ is
    the sum of pname:count of all elements of pname:pUsageCounts or
    pname:ppUsageCounts
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-micromap-11555]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, each element of its pname:geometry.triangleArray
    member must: have a pname:format with a valid value from
    ename:VkOpacityMicromapFormatKHR
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-micromap-11556]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, for each element of its pname:triangleArray member
    with a pname:format equal to
    ename:VK_OPACITY_MICROMAP_FORMAT_2_STATE_KHR, pname:subdivisionLevel
    must: be less than or equal to
    <<limits-maxOpacity2StateSubdivisionLevel,
    pname:maxOpacity2StateSubdivisionLevel>>
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-indexBuffer-11575]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries with a pname:geometryType equal to
    ename:VK_GEOMETRY_TYPE_TRIANGLES_KHR, if its pname:geometry.triangles
    member includes a
    slink:VkAccelerationStructureTrianglesOpacityMicromapKHR structure in
    its pname:pNext chain, the micromap's pname:indexType member is not
    ename:VK_INDEX_TYPE_NONE_KHR, and pname:micromap is not
    dlink:VK_NULL_HANDLE, for each _index_ in pname:indexBuffer[_j_] greater
    than zero where _j_ is within the range [eq]#[0, numTrianglesInGeometry -
    1]# where _numTrianglesInGeometry_ is equal to
    pname:ppBuildRangeInfos[i]->primitiveCount, _index_ plus
    pname:baseTriangle must: be less than or equal to _numTriangles_, where
    _numTriangles_ is given by the sum of all pname:count parameters in the
    pname:pUsageCounts or pname:ppUsageCounts provided to the micromap's
    build command
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-indexBuffer-11577]]
    ...
    member includes a
    slink:VkAccelerationStructureTrianglesOpacityMicromapKHR structure in
    its pname:pNext chain, and the micromap's pname:indexType member is not
    ename:VK_INDEX_TYPE_NONE_KHR, [eq]#pname:indexBuffer +
    (pname:indexStride * numTrianglesInGeometry)# must: be within the range
    of the slink:VkBuffer from which the pname:indexBuffer device address
    was obtained from where _numTrianglesInGeometry_ is equal to
    pname:ppBuildRangeInfos[i]->primitiveCount
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-indexBuffer-11578]]
    For each element of pname:pInfos[i].pname:pGeometries or
    pname:pInfos[i].pname:ppGeometries with a pname:geometryType equal to
    ename:VK_GEOMETRY_TYPE_TRIANGLES_KHR, if its pname:geometry.triangles
    member includes a
    slink:VkAccelerationStructureTrianglesOpacityMicromapKHR structure in
    its pname:pNext chain, the micromap's pname:indexType member is not
    ename:VK_INDEX_TYPE_NONE_KHR, and pname:micromap is
    dlink:VK_NULL_HANDLE, for each _index_ in pname:indexBuffer[_j_] where
    _j_ is within the range from [eq]#[0, numTrianglesInGeometry - 1]#,
    _index_ must: be a valid ename:VkOpacityMicromapSpecialIndexKHR value
    where _numTrianglesInGeometry_ is equal to
    pname:ppBuildRangeInfos[i]->primitiveCount
endif::VK_KHR_opacity_micromap[]
...
ifdef::VK_NV_ray_tracing_motion_blur[]
  * [[VUID-vkCmdBuildAccelerationStructuresKHR-pInfos-11845]]
    ...
    pname:vertexData.deviceAddress must: be a valid basetype:VkDeviceAddress
endif::VK_NV_ray_tracing_motion_blur[]
****
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-vkCmdBuildAccelerationStructuresIndirectKHR-type-11557]]
    For any element of pname:pInfos, its pname:type member must: not be
...
pname:pGeometries or pname:ppGeometries members of
slink:VkAccelerationStructureBuildGeometryInfoKHR is used as the _geometry
index_ during ray traversal.
...
ifdef::VK_KHR_opacity_micromap[]
  ...
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryType-11561]]
    ...
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR, the
    pname:geometryType member of elements of either pname:pGeometries or
    pname:ppGeometries must: be ename:VK_GEOMETRY_TYPE_MICROMAP_KHR
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-geometryType-11707]]
    If pname:type is not
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR, the
    pname:geometryType member of elements of either pname:pGeometries or
    pname:ppGeometries must: not be ename:VK_GEOMETRY_TYPE_MICROMAP_KHR
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-flags-11562]]
    If pname:type is
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR, pname:flags
  ...
  ** ename:VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-type-11563]]
    If pname:flags includes
    ename:VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR, pname:type
    must: be ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-format-11712]]
    If pname:flags includes
    ename:VK_BUILD_ACCELERATION_STRUCTURE_MICROMAP_LOSSY_BIT_KHR, for each
    element of pname:pGeometries or pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, each element of its pname:pUsageCounts or
    pname:ppUsageCounts members must: have its pname:format member equal to
  ...
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11564]]
    ...
    element of pname:pGeometries or pname:ppGeometries, if it includes a
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, for each element of its pname:pUsageCounts or
    pname:ppUsageCounts members, if its pname:format member is
    ename:VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR, its pname:subdivisionLevel
  ...
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11565]]
    ...
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, for each element of its pname:pUsageCounts or
    pname:ppUsageCounts members, its pname:subdivisionLevel member must: be
    less than or equal to <<limits-maxOpacity4StateSubdivisionLevel,
    pname:maxOpacityLossy4StateSubdivisionLevel>>
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-format-11713]]
    ...
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, each element of its pname:triangleArray member must:
    have its pname:format member equal to
    ename:VK_OPACITY_MICROMAP_FORMAT_4_STATE_KHR
  ...
  * [[VUID-VkAccelerationStructureBuildGeometryInfoKHR-subdivisionLevel-11567]]
    ...
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure in its
    pname:pNext chain, for each element of its pname:triangleArray member,
    its pname:subdivisionLevel member must: be less than or equal to
    <<limits-maxOpacity4StateSubdivisionLevel,
    pname:maxOpacityLossy4StateSubdivisionLevel>>
endif::VK_KHR_opacity_micromap[]
****
...
.Valid Usage
****
  * [[VUID-VkAccelerationStructureGeometryKHR-micromap-11568]]
    If pname:geometryType is ename:VK_GEOMETRY_TYPE_MICROMAP_KHR,
    pname:pNext chain must: include a single
    slink:VkAccelerationStructureGeometryMicromapDataKHR structure
  * [[VUID-VkAccelerationStructureGeometryKHR-flags-11569]]
    If pname:geometryType is ename:VK_GEOMETRY_TYPE_MICROMAP_KHR,
...
ifdef::VK_KHR_opacity_micromap[]
[open,refpage='VkAccelerationStructureTrianglesOpacityMicromapKHR',desc='Structure specifying an opacity micromap in a bottom-level acceleration structure',type='structs']
--
:refpage: VkAccelerationStructureTrianglesOpacityMicromapKHR

The sname:VkAccelerationStructureTrianglesOpacityMicromapKHR structure is
defined as:

include::{generated}/api/structs/VkAccelerationStructureTrianglesOpacityMicromapKHR.adoc[]
...
If sname:VkAccelerationStructureTrianglesOpacityMicromapKHR is included in
the pname:pNext chain of a
ifdef::VK_AMDX_dense_geometry_format[]
...
if present.
If pname:indexType is ename:VK_INDEX_TYPE_NONE_KHR, then the index used is
the index of the triangle in the geometry.

If that value is the unsigned cast of one of the values from
elink:VkOpacityMicromapSpecialIndexKHR then that triangle behaves as
...
****
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-indexType-11570]]
    pname:indexType must: be
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_index_type_uint8,VK_EXT_index_type_uint8[]
    ename:VK_INDEX_TYPE_UINT8,
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_index_type_uint8,VK_EXT_index_type_uint8[]
    ename:VK_INDEX_TYPE_UINT16, ename:VK_INDEX_TYPE_UINT32, or
    ename:VK_INDEX_TYPE_NONE_KHR
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-indexBuffer-11571]]
    If pname:indexType is ename:VK_INDEX_TYPE_NONE_KHR, pname:indexBuffer
    must: be 0
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-indexBuffer-11572]]
    If pname:indexType is not ename:VK_INDEX_TYPE_NONE_KHR,
    pname:indexBuffer must: be a valid basetype:VkDeviceAddress
  ...
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-geometry-11576]]
    If pname:indexType is ename:VK_INDEX_TYPE_NONE_KHR, for each triangle
    index in the geometry, index plus pname:baseTriangle must: be less than
    or equal to _numTriangles_, where _numTriangles_ is given by the sum of
    all pname:count parameters in the pname:pUsageCounts or
    pname:ppUsageCounts provided to the micromap's build command
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapKHR-micromap-11579]]
    If pname:indexType is ename:VK_INDEX_TYPE_NONE_KHR, pname:micromap must:
    not be dlink:VK_NULL_HANDLE
****

include::{generated}/validity/structs/VkAccelerationStructureTrianglesOpacityMicromapKHR.adoc[]
--
endif::VK_KHR_opacity_micromap[]
...
elink:VkOpacityMicromapSpecialIndexEXT.
...
****
  ...
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-format-11679]]
    If pname:micromap is not dlink:VK_NULL_HANDLE, the pname:type used to
    construct pname:micromap is ename:VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT,
    the pname:format member of each element of pname:pUsageCounts or
    pname:ppUsageCounts must: be a valid value from
    ename:VkOpacityMicromapFormatEXT
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11680]]
    If pname:micromap is not dlink:VK_NULL_HANDLE, the pname:type used to
    build pname:micromap is ename:VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT, for
    each member of pname:pUsageCounts or pname:ppUsageCounts with
    pname:format equal to ename:VK_OPACITY_MICROMAP_FORMAT_2_STATE_EXT,
  ...
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11681]]
    ...
    build pname:micromap is ename:VK_MICROMAP_TYPE_OPACITY_MICROMAP_EXT, for
    each member of pname:pUsageCounts or pname:ppUsageCounts with
    pname:format equal to ename:VK_OPACITY_MICROMAP_FORMAT_4_STATE_EXT,
    pname:subdivisionLevel must: be less than or equal to
...
ifdef::VK_NV_displacement_micromap[]
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-format-11682]]
    If pname:micromap is not dlink:VK_NULL_HANDLE, the pname:type used to
    construct pname:micromap is
    ename:VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV, the pname:format member
    of each element of pname:pUsageCounts or pname:ppUsageCounts must: be a
    valid value from ename:VkDisplacementMicromapFormatNV
  * [[VUID-VkAccelerationStructureTrianglesOpacityMicromapEXT-subdivisionLevel-11683]]
    If pname:micromap is not dlink:VK_NULL_HANDLE, the pname:type used to
    construct pname:micromap is
    ename:VK_MICROMAP_TYPE_DISPLACEMENT_MICROMAP_NV, for each member of
    pname:pUsageCounts or pname:ppUsageCounts pname:subdivisionLevel must:
...
ifdef::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
[open,refpage='VkOpacityMicromapSpecialIndexKHR',desc='Enum for special indices in the opacity micromap',type='enums',alias="VkOpacityMicromapSpecialIndexEXT"]
--
:refpage: VkOpacityMicromapSpecialIndexKHR

The ename:VkOpacityMicromapSpecialIndexKHR enumeration is defined as:

include::{generated}/api/enums/VkOpacityMicromapSpecialIndexKHR.adoc[]

ifdef::VK_EXT_opacity_micromap[]
include::{generated}/api/enums/VkOpacityMicromapSpecialIndexEXT.adoc[]
endif::VK_EXT_opacity_micromap[]

  * ename:VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_TRANSPARENT_KHR specifies
    that the entire triangle is fully transparent.
  * ename:VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_OPAQUE_KHR specifies that
    the entire triangle is fully opaque.
  * ename:VK_OPACITY_MICROMAP_SPECIAL_INDEX_FULLY_UNKNOWN_TRANSPARENT_KHR
...
ifdef::VK_KHR_opacity_micromap[]
[open,refpage='VkAccelerationStructureSerializedBlockTypeKHR',desc='Enum for block types in a serialized acceleration structure',type='enums']
--
:refpage: VkAccelerationStructureSerializedBlockTypeKHR

The ename:VkAccelerationStructureSerializedBlockTypeKHR enumeration is
defined as:

include::{generated}/api/enums/VkAccelerationStructureSerializedBlockTypeKHR.adoc[]

  * ename:VK_ACCELERATION_STRUCTURE_SERIALIZED_BLOCK_TYPE_OPACITY_MICROMAP_KHR
...
****
ifdef::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
  * [[VUID-VkAccelerationStructureInstanceKHR-micromap-11580]]
    If pname:flags includes
    ename:VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_KHR or
    ename:VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR, the
    <<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>
ifdef::VK_EXT_opacity_micromap[]
    or
    <<features-micromapEXT,sname:VkPhysicalDeviceOpacityMicromapFeaturesEXT::pname:micromap>>
  ...
  * [[VUID-VkAccelerationStructureInstanceKHR-flags-11581]]
    If pname:flags includes
    ename:VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR, the
    pname:flags used to build the acceleration structure referenced by
    pname:accelerationStructureReference must: have included
    ename:VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DISABLE_OPACITY_MICROMAPS_BIT_KHR
endif::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
****
...
ifdef::VK_EXT_opacity_micromap,VK_KHR_opacity_micromap[]
  * ename:VK_GEOMETRY_INSTANCE_FORCE_OPACITY_MICROMAP_2_STATE_BIT_KHR forces
    the micromap format to 2 state mode as described in
    <<ray-opacity-micromap,traversal>>.
  * ename:VK_GEOMETRY_INSTANCE_DISABLE_OPACITY_MICROMAPS_BIT_KHR disables
    any opacity micromaps referenced by acceleration structures referenced
    by this instance as described in <<ray-opacity-micromap,traversal>>.
endif::VK_EXT_opacity_micromap,VK_KHR_opacity_micromap[]
...
****
  ...
  * [[VUID-VkAccelerationStructureBuildRangeInfoKHR-None-10775]]
    ...
    slink:VkAccelerationStructureGeometryTrianglesDataKHR::pname:maxVertex
    must: be greater than or equal to [eq]#firstVertex + primitiveCount x 3 -
    1#
...
ifdef::VK_KHR_ray_tracing_maintenance1[]
  * If pname:queryType is
    ename:VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SIZE_KHR, then the value
...
****
  ...
  * [[VUID-vkCmdCopyAccelerationStructureKHR-src-11633]]
    The source acceleration structure pname:pInfo->src must: have been
    constructed prior to the execution of this command on the device
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-vkCmdCopyAccelerationStructureKHR-src-11634]]
    If the source acceleration structure pname:pInfo->src was constructed
...
ifdef::VK_KHR_ray_tracing_maintenance1[]
    with the exception of pname:size, which must: at least as large as the
    queried ename:VK_QUERY_TYPE_ACCELERATION_STRUCTURE_SIZE_KHR size
endif::VK_KHR_ray_tracing_maintenance1[]
    .
...
header consists of:
  ...
  ** A 32-bit unsigned integer indicating the block type corresponding to
     values in the elink:VkAccelerationStructureSerializedBlockTypeKHR
     enumeration
...
and match the values returned by flink:vkGetBufferDeviceAddressKHR for the
...
that was serialized.
They must: be created before deserializing with identical pname:type and
pname:createFlags except for the
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-vkCmdCopyAccelerationStructureToMemoryKHR-pInfo-11699]]
    If pname:pInfo->src was built with a pname:type of
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR,
    pname:pInfo->dst.deviceAddress must: be aligned to `128` bytes
endif::VK_KHR_opacity_micromap[]
****
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-VkCopyAccelerationStructureToMemoryInfoKHR-src-11582]]
    If the source acceleration structure pname:src was constructed through
...
<<serialized-as-header,fname:vkCmdCopyAccelerationStructureToMemoryKHR>>.
endif::VK_KHR_opacity_micromap[]
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-vkCmdCopyAccelerationStructureToMemoryKHR-pInfo-11700]]
    If the serialized acceleration structure in pname:pInfo->src was
    originally built with a pname:type of
    ename:VK_ACCELERATION_STRUCTURE_TYPE_OPACITY_MICROMAP_KHR,
    pname:pInfo->src.deviceAddress must: be aligned to `128` bytes
endif::VK_KHR_opacity_micromap[]
****
...
If the serialized data in pname:src represents a top-level acceleration
structure, pname:dst must: have been created with a value of
slink:VkAccelerationStructureCreateInfoKHR::pname:type equal to either
ename:VK_ACCELERATION_STRUCTURE_TYPE_TOP_LEVEL_KHR or
ename:VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR.

If the serialized data in pname:src represents a bottom-level acceleration
structure, pname:dst must: have been created with a value of
slink:VkAccelerationStructureCreateInfoKHR::pname:type equal to either
ename:VK_ACCELERATION_STRUCTURE_TYPE_BOTTOM_LEVEL_KHR or
ename:VK_ACCELERATION_STRUCTURE_TYPE_GENERIC_KHR.
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-VkCopyMemoryToAccelerationStructureInfoKHR-src-11583]]
    If the serialized acceleration structure in pname:src is bottom-level,
    each block in the header must: have a type that corresponds to a valid
    value in elink:VkAccelerationStructureSerializedBlockTypeKHR
  ...
  * [[VUID-VkCopyMemoryToAccelerationStructureInfoKHR-dst-11585]]
    ...
    ename:VK_ACCELERATION_STRUCTURE_SERIALIZED_BLOCK_TYPE_OPACITY_MICROMAP_KHR
    must: point to a valid basetype:VkDeviceAddress that was retrieved by
    flink:vkGetBufferDeviceAddressKHR for the underlying buffer objects of
    <<serialized-as-header,compatible micromaps>> constructed on the
    slink:VkDevice when the command is executed
endif::VK_KHR_opacity_micromap[]
****
...
****
  ...
  * [[VUID-vkCmdBuildClusterAccelerationStructureIndirectNV-dstAddressesArray-12302]]
    ...
    pname:pCommandInfos->scratchData, or the memory indirectly referenced in
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:scratchData
    when
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:addressResolutionFlags
    contains
  ...
  * [[VUID-vkCmdBuildClusterAccelerationStructureIndirectNV-pCommandInfos-12304]]
    pname:pCommandInfos->scratchData, or the address indirectly referenced
    in slink:VkClusterAccelerationStructureCommandsInfoNV::pname:scratchData
    when
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:addressResolutionFlags
    contains
    ename:VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_SCRATCH_DATA_BIT_NV,
  ...
  * [[VUID-vkCmdBuildClusterAccelerationStructureIndirectNV-pCommandInfos-12305]]
    pname:pCommandInfos->srcInfosArray, or the address indirectly referenced
    in
  ...
  * [[VUID-vkCmdBuildClusterAccelerationStructureIndirectNV-pCommandInfos-12306]]
    pname:pCommandInfos->srcInfosCount, or the address indirectly referenced
    in
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:srcInfosCount
    when
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:addressResolutionFlags
  ...
  * [[VUID-vkCmdBuildClusterAccelerationStructureIndirectNV-pCommandInfos-12381]]
    pname:pCommandInfos->dstAddressesArray, or the address indirectly
    referenced in
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:dstAddressesArray
    when
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:addressResolutionFlags
    ...
    ename:VK_CLUSTER_ACCELERATION_STRUCTURE_ADDRESS_RESOLUTION_INDIRECTED_DST_ADDRESS_ARRAY_BIT_NV,
    must: be a device address range allocated to the application from a
    buffer created with the ename:VK_BUFFER_USAGE_STORAGE_BUFFER_BIT usage
    flag set
  * [[VUID-vkCmdBuildClusterAccelerationStructureIndirectNV-pCommandInfos-12382]]
    All destination addresses contained in
    pname:pCommandInfos->dstAddressesArray, or in the memory indirectly
    referenced in
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:dstAddressesArray
    when
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:addressResolutionFlags
  ...
  * [[VUID-vkCmdBuildClusterAccelerationStructureIndirectNV-pCommandInfos-12308]]
    pname:pCommandInfos->dstImplicitData, or the address indirectly
    referenced in
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:dstImplicitData
    when
    slink:VkClusterAccelerationStructureCommandsInfoNV::pname:addressResolutionFlags
...
include::{generated}/api/structs/VkPartitionedAccelerationStructureInstancesInputNV.adoc[]
  ...
  * pname:maxInstanceInGlobalPartitionCount is the maximum number of
    instances in the <<ptlas-global-partition, global partition>>.
...
****
  * [[VUID-VkBuildPartitionedAccelerationStructureInfoNV-scratchData-10558]]
    ...
    `0`, then pname:scratchData must: be a valid basetype:VkDeviceAddress
...
slink:VkAccelerationStructureCreateInfo2KHR command as they are backed by a
basetype:VkDeviceAddress and therefore are not valid to be used with host
commands.
...
include::{chapters}/commonvalidity/deferred_operations_common.adoc[]
  ...
  * [[VUID-vkBuildAccelerationStructuresKHR-pInfos-11703]]
    For each element of pname:pInfos, its pname:dstAccelerationStructure
  ...
  * [[VUID-vkBuildAccelerationStructuresKHR-pInfos-11706]]
    ...
    pname:srcAccelerationStructure member must: have been created with
    flink:vkCreateAccelerationStructureKHR
  ...
  * [[VUID-vkBuildAccelerationStructuresKHR-pInfos-11704]]
    For each element of pname:pInfos, the acceleration structure referenced
    by the pname:geometry.instances.data member of any element of
    pname:pGeometries or pname:ppGeometries with a pname:geometryType of
    ename:VK_GEOMETRY_TYPE_INSTANCES_KHR must: have been created with
    flink:vkCreateAccelerationStructureKHR
  * [[VUID-vkBuildAccelerationStructuresKHR-pInfos-03724]]
    For each element of pname:pInfos, each acceleration structure referenced
    by the pname:geometry.instances.data member of any element of
    pname:pGeometries or pname:ppGeometries with a pname:geometryType of
    ename:VK_GEOMETRY_TYPE_INSTANCES_KHR must: be bound to host-visible
    device memory
...
ifdef::VK_KHR_device_group,VK_BASE_VERSION_1_1[]
  ...
  * [[VUID-vkBuildAccelerationStructuresKHR-pInfos-03777]]
    ...
    by the pname:geometry.instances.data member of any element of
    pname:pGeometries or pname:ppGeometries with a pname:geometryType of
    ename:VK_GEOMETRY_TYPE_INSTANCES_KHR must: be bound to memory that was
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-vkBuildAccelerationStructuresKHR-pInfos-11705]]
    ...
    pname:geometry.triangles.pNext chain its pname:micromap member must: be
    dlink:VK_NULL_HANDLE
endif::VK_KHR_opacity_micromap[]
ifdef::VK_NV_ray_tracing_linear_swept_spheres[]
...
include::{chapters}/commonvalidity/deferred_operations_common.adoc[]
  * [[VUID-vkCopyAccelerationStructureKHR-buffer-03727]]
    pname:pInfo->src must: be bound to host-visible device memory
  * [[VUID-vkCopyAccelerationStructureKHR-buffer-03728]]
    pname:pInfo->dst must: be bound to host-visible device memory
ifdef::VK_KHR_device_group,VK_BASE_VERSION_1_1[]
  * [[VUID-vkCopyAccelerationStructureKHR-buffer-03780]]
    pname:pInfo->src must: be bound to memory that was not allocated with
    multiple instances
  * [[VUID-vkCopyAccelerationStructureKHR-buffer-03781]]
    pname:pInfo->dst must: be bound to memory that was not allocated with
    multiple instances
endif::VK_KHR_device_group,VK_BASE_VERSION_1_1[]
...
ifdef::VK_KHR_opacity_micromap[]
  ...
  * [[VUID-vkCopyAccelerationStructureKHR-src-11588]]
    pname:pInfo->src must: have been created with
    flink:vkCreateAccelerationStructureKHR
  * [[VUID-vkCopyAccelerationStructureKHR-dst-11589]]
    pname:pInfo->dst must: have been created with
    flink:vkCreateAccelerationStructureKHR
****
...
ifdef::VK_KHR_device_group,VK_BASE_VERSION_1_1[]
  * [[VUID-vkCopyAccelerationStructureToMemoryKHR-buffer-03783]]
    pname:pInfo->src must: not be bound to memory that was allocated with
    multiple instances
endif::VK_KHR_device_group,VK_BASE_VERSION_1_1[]
  * [[VUID-vkCopyAccelerationStructureToMemoryKHR-src-11678]]
    pname:pInfo->src must: have been created with
    flink:vkCreateAccelerationStructureKHR
****
...
ifdef::VK_KHR_ray_tracing_maintenance1[]
  ...
  * [[VUID-vkWriteAccelerationStructuresPropertiesKHR-buffer-03733]]
    Each element of pname:pAccelerationStructures must: be bound to
  ...
  * [[VUID-vkWriteAccelerationStructuresPropertiesKHR-pAccelerationStructures-11592]]
    ...
    been created with flink:vkCreateAccelerationStructureKHR
ifdef::VK_KHR_device_group,VK_BASE_VERSION_1_1[]
  * [[VUID-vkWriteAccelerationStructuresPropertiesKHR-buffer-03784]]
    Each element of pname:pAccelerationStructures must: be bound to memory
