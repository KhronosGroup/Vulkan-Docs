...
[open,refpage='VkDispatchIndirect2InfoKHR',desc='Dispatch indirect info',type='structs']
--
:refpage: VkDispatchIndirect2InfoKHR

sname:VkDispatchIndirect2InfoKHR is defined as:

include::{generated}/api/structs/VkDispatchIndirect2InfoKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:addressRange is the slink:VkDeviceAddressRangeKHR containing
    dispatch parameters.
...
include::{generated}/validity/structs/VkDispatchIndirect2InfoKHR.adoc[]
--

[open,refpage='vkCmdDispatchIndirect2KHR',desc='Dispatch compute work items with indirect parameters through an address range',type='protos']
--
:refpage: vkCmdDispatchIndirect2KHR

To record an indirect dispatching command, call:

include::{generated}/api/protos/vkCmdDispatchIndirect2KHR.adoc[]

  * pname:commandBuffer is the command buffer into which the command is
    recorded.
  * pname:pInfo is a pointer to a slink:VkDispatchIndirect2InfoKHR structure
    defining parameters of this command.

fname:vkCmdDispatchIndirect2KHR behaves similarly to
flink:vkCmdDispatchIndirect except that the parameters, encoded in a
slink:VkDispatchIndirectCommand structure, are read by the device from an
...
include::{chapters}/commonvalidity/draw_dispatch_common.adoc[]
  ...
  * [[VUID-vkCmdDispatchIndirect2KHR-pInfo-13050]]
    ...
    code:sizeof(VkDispatchIndirectCommand)
****

include::{generated}/validity/protos/vkCmdDispatchIndirect2KHR.adoc[]
--
...
include::{chapters}/commonvalidity/draw_dispatch_nonindirect_common.adoc[]
  ...
  * [[VUID-vkCmdDispatchTileQCOM-None-10669]]
    The <<features-tileShadingDispatchTile,tileShadingDispatchTile>> feature
    must: be enabled
****
...
documentation.
For more information, please refer to the CUDA toolkit documentation at
...
The apiext:VK_NV_compute_occupancy_priority extension provides applications
...
[open,refpage='vkCmdSetComputeOccupancyPriorityNV',desc='Set the compute occupancy priority for subsequent compute dispatches',type='protos']
--
To set the compute occupancy priority for subsequent compute dispatches,
call:

include::{generated}/api/protos/vkCmdSetComputeOccupancyPriorityNV.adoc[]

  * pname:commandBuffer is the command buffer into which the command will be
    recorded.
  * pname:pParameters is a pointer to a
    slink:VkComputeOccupancyPriorityParametersNV structure specifying the
...
flink:vkCmdSetComputeOccupancyPriorityNV call will be executed with the
...
equal to the ename:VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV value.
...
include::{generated}/validity/protos/vkCmdSetComputeOccupancyPriorityNV.adoc[]
--

[open,refpage='VkComputeOccupancyPriorityParametersNV',desc='Structure specifying compute occupancy priority parameters',type='structs']
--
The sname:VkComputeOccupancyPriorityParametersNV structure is defined as:

include::{generated}/api/structs/VkComputeOccupancyPriorityParametersNV.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:occupancyPriority is a value specifying the occupancy priority for
  ...
  * pname:occupancyThrottling is a value specifying the level of occupancy
...
****
  * [[VUID-VkComputeOccupancyPriorityParametersNV-occupancyPriority-12298]]
    pname:occupancyPriority must: be between `0` and `1`, inclusive
  * [[VUID-VkComputeOccupancyPriorityParametersNV-occupancyThrottling-12299]]
    pname:occupancyThrottling must: be between `0` and `1`, inclusive
****

include::{generated}/validity/structs/VkComputeOccupancyPriorityParametersNV.adoc[]
--

[open,refpage='VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV',desc='Low occupancy priority constant',type='consts']
--
ename:VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV is a constant value that can be
used for
slink:VkComputeOccupancyPriorityParametersNV::pname:occupancyPriority to
specify a low priority level.

include::{generated}/api/enums/VK_COMPUTE_OCCUPANCY_PRIORITY_LOW_NV.adoc[]
--

[open,refpage='VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV',desc='Normal occupancy priority constant',type='consts']
--
ename:VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV is a constant value that can
be used for
slink:VkComputeOccupancyPriorityParametersNV::pname:occupancyPriority to
specify a normal priority level.
This represents the default priority level.

include::{generated}/api/enums/VK_COMPUTE_OCCUPANCY_PRIORITY_NORMAL_NV.adoc[]
--

[open,refpage='VK_COMPUTE_OCCUPANCY_PRIORITY_HIGH_NV',desc='High occupancy priority constant',type='consts']
--
ename:VK_COMPUTE_OCCUPANCY_PRIORITY_HIGH_NV is a constant value that can be
used for
slink:VkComputeOccupancyPriorityParametersNV::pname:occupancyPriority to
specify a high priority level.

include::{generated}/api/enums/VK_COMPUTE_OCCUPANCY_PRIORITY_HIGH_NV.adoc[]
--
endif::VK_NV_compute_occupancy_priority[]

ifdef::VK_ARM_scheduling_controls[]
[open,refpage='vkCmdSetDispatchParametersARM',desc='Set parameters that affect dispatch commands',type='protos']
--
:refpage: vkCmdSetDispatchParametersARM

To set parameters that affect dispatch commands, call:

include::{generated}/api/protos/vkCmdSetDispatchParametersARM.adoc[]

  * pname:commandBuffer is the command buffer into which the command will be
    recorded.
  * pname:pDispatchParameters is a pointer to a
    slink:VkDispatchParametersARM structure specifying the dispatch
    parameters to be set.

Parameters set using fname:vkCmdSetDispatchParametersARM affect the
...
include::{generated}/validity/protos/vkCmdSetDispatchParametersARM.adoc[]
--

[open,refpage='VkDispatchParametersARM',desc='Structure specifying parameters that affect dispatch commands',type='structs',xrefs='vkCmdSetDispatchParametersARM']
--
The sname:VkDispatchParametersARM structure is defined as:

include::{generated}/api/structs/VkDispatchParametersARM.adoc[]

  * pname:workGroupBatchSize, if it is not 0, is the number of workgroups in
    each batch distributed to shader cores.
    Otherwise, the implementation selects the number of workgroups in each
    batch.
  * pname:maxQueuedWorkGroupBatches, if it is not 0, is the maximum number
  ...
  * pname:maxWarpsPerShaderCore, if it is not 0, is the maximum number of
...
****
  * [[VUID-VkDispatchParametersARM-maxWarpsPerShaderCore-12392]]
    pname:maxWarpsPerShaderCore must: be less than or equal to
    slink:VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM::pname:schedulingControlsMaxWarpCount
  * [[VUID-VkDispatchParametersARM-maxQueuedWorkGroupBatches-12393]]
    pname:maxQueuedWorkGroupBatches must: be less than or equal to
    slink:VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM::pname:schedulingControlsMaxQueuedBatchesCount
  * [[VUID-VkDispatchParametersARM-workGroupBatchSize-12394]]
    pname:workGroupBatchSize must: be less than or equal to
    slink:VkPhysicalDeviceSchedulingControlsPropertiesARM::pname:schedulingControlsMaxWorkGroupBatchSize
****

include::{generated}/validity/structs/VkDispatchParametersARM.adoc[]
--
