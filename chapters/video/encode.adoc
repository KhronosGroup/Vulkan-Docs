...
ifdef::VK_KHR_unified_image_layouts[]
    ...
    pname:unifiedImageLayoutsVideo>> feature is ename:VK_TRUE, in which case
    it may: be in the ename:VK_IMAGE_LAYOUT_GENERAL layout
...
ifndef::VK_KHR_video_encode_quantization_map[]
