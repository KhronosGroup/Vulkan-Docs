...
[open,refpage='VK_MAX_VIDEO_VP9_REFERENCES_PER_FRAME_KHR',desc='Length of an array of supported queue priorities',type='consts']
--
ename:VK_MAX_VIDEO_VP9_REFERENCES_PER_FRAME_KHR is the length of the array
of DPB slot or VP9 reference names passed in
slink:VkVideoDecodeVP9PictureInfoKHR::pname:referenceNameSlotIndices.

include::{generated}/api/enums/VK_MAX_VIDEO_VP9_REFERENCES_PER_FRAME_KHR.adoc[]
--
...
[[vp9_decode-required-video-std-header-versions-table]]
...
[[vp9_decode-required-video-capabilities-table]]
