...
[open,refpage='VK_MAX_VIDEO_AV1_REFERENCES_PER_FRAME_KHR',desc='Length of an array of supported queue priorities',type='consts']
--
ename:VK_MAX_VIDEO_AV1_REFERENCES_PER_FRAME_KHR is the length of the array
of DPB slot or AV1 reference names passed in
slink:VkVideoDecodeAV1PictureInfoKHR::pname:referenceNameSlotIndices.

include::{generated}/api/enums/VK_MAX_VIDEO_AV1_REFERENCES_PER_FRAME_KHR.adoc[]
--
...
[[av1_decode-required-video-std-header-versions-table]]
...
[[av1_decode-required-video-capabilities-table]]
