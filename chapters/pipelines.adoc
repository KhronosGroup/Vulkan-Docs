...
ifndef::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library,VK_EXT_shader_module_identifier[]
...
ifdef::VK_NV_cooperative_matrix2[]
  * [[VUID-VkPipelineShaderStageCreateInfo-module-10169]]
    ...
    in the X dimension of the pipeline must: be a multiple of
    <<limits-subgroupSize,pname:subgroupSize>> and the total local workgroup
    size must: be a power of two multiple of
    <<limits-subgroupSize,pname:subgroupSize>> and must: be less than or
    equal to
...
ifdef::VK_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineRobustnessCreateInfo-storageBuffers-10636]]
    ...
    either <<features-descriptorBindingStorageBufferUpdateAfterBind,
    pname:descriptorBindingStorageBufferUpdateAfterBind>> or
    <<features-descriptorBindingStorageTexelBufferUpdateAfterBind,
    pname:descriptorBindingStorageTexelBufferUpdateAfterBind>> is enabled on
    the device, <<limits-robustBufferAccessUpdateAfterBind,
...
ifdef::VK_EXT_inline_uniform_block,VK_VERSION_1_3[]
    ...
    pname:descriptorBindingUniformBufferUpdateAfterBind>> or
    <<features-descriptorBindingUniformTexelBufferUpdateAfterBind,
    pname:descriptorBindingUniformTexelBufferUpdateAfterBind>> is enabled on
    the device, <<limits-robustBufferAccessUpdateAfterBind,
    pname:robustBufferAccessUpdateAfterBind>> must: be ename:VK_TRUE
  * [[VUID-VkPipelineRobustnessCreateInfo-images-10638]]
    ...
    either <<features-descriptorBindingStorageImageUpdateAfterBind,
    pname:descriptorBindingStorageImageUpdateAfterBind>> or
    <<features-descriptorBindingSampledImageUpdateAfterBind,
    pname:descriptorBindingSampledImageUpdateAfterBind>> is enabled on the
    device, <<limits-robustBufferAccessUpdateAfterBind,
    pname:robustBufferAccessUpdateAfterBind>> must: be ename:VK_TRUE
...
ifdef::VK_ARM_pipeline_opacity_micromap[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-10392]]
    pname:flags must: not include both
    ename:VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_EXT and
