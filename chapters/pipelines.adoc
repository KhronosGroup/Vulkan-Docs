...
ifdef::VK_VERSION_1_1,VK_KHR_multiview[]
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-06047]]
    ...
    with <<pipelines-graphics-subsets-pre-rasterization, pre-rasterization
...
ifdef::VK_EXT_extended_dynamic_state3[]
  ...
  * ename:VK_DYNAMIC_STATE_DEPTH_CLIP_ENABLE_EXT specifies that the
    ...
    slink:VkPhysicalDeviceDepthClipEnableFeaturesEXT will be ignored and
    must: be set dynamically with flink:vkCmdSetDepthClipEnableEXT before
    any draw call.
