...
ifdef::VK_GRAPHICS_VERSION_1_0,VK_NV_ray_tracing,VK_KHR_ray_tracing_pipeline[or]
a _compute pipeline_.
...
The <<pipelines-compute,compute pipeline>>
ifdef::VK_GRAPHICS_VERSION_1_0[]
...
ifdef::VK_GRAPHICS_VERSION_1_0,VK_NV_ray_tracing,VK_KHR_ray_tracing_pipeline[and]
ifdef::VK_GRAPHICS_VERSION_1_0[]
graphics
endif::VK_GRAPHICS_VERSION_1_0[]
pipelines are each represented by sname:VkPipeline handles:
...
ifdef::VK_GRAPHICS_VERSION_1_0[  * flink:vkCreateGraphicsPipelines,]
  * flink:vkCreateComputePipelines.
...
by chaining the slink:VkPipelineCreateFlags2CreateInfo structure to the
pipeline creation structure with a bitmask of
elink:VkPipelineCreateFlagBits2, or
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
by setting the pname:flags member of the pipeline creation structure to a
bitmask of elink:VkPipelineCreateFlagBits.

ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_KHR_extended_flags[]
[[pipelines-create-flags-2]]
[open,refpage='VkPipelineCreateFlags2CreateInfo',desc='Extended pipeline create flags',type='structs']
--
...
[open,refpage='VkPipelineCreateFlagBits2',desc='Bitmask controlling how a pipeline is created',type='enums']
--
...
// are mirrored between VkPipelineCreateFlagBits2/VkPipelineCreateFlagBits
...
ifdef::VK_EXT_descriptor_buffer[]
  * ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_BUFFER_BIT_EXT specifies that a
    ...
    rather than <<descriptors,descriptor sets>>.
...
ifdef::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
  * ename:VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR
...
ifdef::VK_KHR_opacity_micromap[]
  * ename:VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR
...
ifdef::VK_EXT_shader_64bit_indexing[]
  * ename:VK_PIPELINE_CREATE_2_64_BIT_INDEXING_BIT_EXT specifies that the
    pipeline enables <<spirvenv-64bindexing, 64-bit indexing>>.
endif::VK_EXT_shader_64bit_indexing[]
ifdef::VK_EXT_descriptor_heap[]
  * ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT specifies that the
...
ifdef::VK_ARM_shader_instrumentation[]
  * ename:VK_PIPELINE_CREATE_2_INSTRUMENT_SHADERS_BIT_ARM specifies that the
...
ifdef::VK_EXT_graphics_pipeline_library[]
When an implementation is looking up a pipeline in a <<pipelines-cache,
pipeline cache>>, if that pipeline is being created using linked libraries,
...
[open,refpage='VkPipelineCreateFlags2',desc='Bitmask of VkPipelineCreateFlagBits2',type='flags']
--
...
ifdef::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
  * ename:VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR specifies
...
ifdef::VK_COMPUTE_VERSION_1_3+VK_KHR_maintenance4[or]
ifdef::VK_KHR_maintenance4[]
    apiext:VK_KHR_maintenance4 is enabled
endif::VK_KHR_maintenance4[]
    pname:layout must: not be accessed by the implementation outside of the
...
include::{chapters}/commonvalidity/compute_graph_pipeline_create_info_common.adoc[]
  ...
  * [[VUID-VkComputePipelineCreateInfo-layout-01687]]
    If pname:layout is not dlink:VK_NULL_HANDLE, the number of resources in
    pname:layout accessible to the compute shader stage must: be less than
    or equal to sname:VkPhysicalDeviceLimits::pname:maxPerStageResources
ifdef::VK_KHR_pipeline_library[]
...
ifdef::VK_KHR_opacity_micromap[]
ifdef::VK_KHR_maintenance5,VK_BASE_VERSION_1_4[]
  * [[VUID-VkComputePipelineCreateInfo-flags-11593]]
    If the
    ...
    ename:VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR
endif::VK_KHR_maintenance5,VK_BASE_VERSION_1_4[]
endif::VK_KHR_opacity_micromap[]
ifdef::VK_NV_displacement_micromap[]
...
ifdef::VK_EXT_graphics_pipeline_library[]
  * [[VUID-VkComputePipelineCreateInfo-layout-12396]]
    If pname:layout is not dlink:VK_NULL_HANDLE, it must: not have been
    created with ename:VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT
endif::VK_EXT_graphics_pipeline_library[]
  * [[VUID-VkComputePipelineCreateInfo-None-11367]]
    {empty}
ifdef::VK_EXT_descriptor_heap[]
    If slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags does not
    include ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT,
endif::VK_EXT_descriptor_heap[]
...
--
:refpage: VkPipelineShaderStageCreateInfo
...
include::{generated}/api/structs/VkPipelineShaderStageCreateInfo.adoc[]
  ...
  * pname:stage is a elink:VkShaderStageFlagBits value specifying a single
    pipeline stage.
  * pname:module is
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library,VK_EXT_shader_module_identifier[]
    optionally
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library,VK_EXT_shader_module_identifier[]
...
ifndef::VKSC_VERSION_1_0[]
ifdef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library[]
...
endif::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library[]
ifndef::VK_COMPUTE_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_graphics_pipeline_library[]
...
.Valid Usage
****
include::{chapters}/commonvalidity/shader_descriptor_heap_common.adoc[]
...
<<shaders-required-subgroup-size, required subgroup size>> is specified,
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_subgroup_size_control[]
[open,refpage='VkPipelineShaderStageRequiredSubgroupSizeCreateInfo',desc='Structure specifying the required subgroup size of a newly created pipeline shader stage',type='structs']
--
...
include::{generated}/api/structs/VkShaderRequiredSubgroupSizeCreateInfoEXT.adoc[]
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:requiredSubgroupSize is an unsigned integer value specifying the
...
[open,refpage='VkPipelineRobustnessCreateInfo',desc='Structure controlling the robustness of a newly created pipeline shader stage',type='structs']
--
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  ...
  * [[VUID-VkPipelineRobustnessCreateInfo-uniformBuffers-10637]]
    ...
    ename:VK_PIPELINE_ROBUSTNESS_BUFFER_BEHAVIOR_ROBUST_BUFFER_ACCESS_2, and
    either
ifdef::VK_EXT_inline_uniform_block,VK_COMPUTE_VERSION_1_3[]
...
endif::VK_EXT_inline_uniform_block,VK_COMPUTE_VERSION_1_3[]
...
[open,refpage='VkPipelineRobustnessBufferBehavior',desc='Enum controlling the robustness of buffer accesses in a pipeline stage',type='enums']
--
...
[open,refpage='VkPipelineRobustnessImageBehavior',desc='Enum controlling the robustness of image accesses in a pipeline stage',type='enums']
--
...
****
  ...
  * [[VUID-VkComputePipelineIndirectBufferInfoNV-deviceAddress-09012]]
    ...
    created with both the ename:VK_BUFFER_USAGE_TRANSFER_DST_BIT and
    ename:VK_BUFFER_USAGE_INDIRECT_BUFFER_BIT usage flags set
...
ifdef::VK_EXT_custom_resolve[]
  * The pname:customResolve parameter of slink:VkCustomResolveCreateInfoEXT.
    Formats are ignored, and not including the structure behaves identically
    to setting pname:customResolve to ename:VK_FALSE, unlike in
...
Fragment output state is defined by:
  ...
  * slink:VkPipelineMultisampleStateCreateInfo
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
  * The format parameters of slink:VkPipelineRenderingCreateInfo
    (pname:viewMask is ignored)
...
slink:VkPipelineLayout that is <<descriptors-compatibility,compatible>> with
...
<<descriptors-compatibility,compatible>> with this union.
endif::VK_EXT_graphics_pipeline_library[]
...
ifdef::VK_EXT_depth_range_unrestricted[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-pDynamicStates-10913]]
    If the pipeline requires <<pipelines-graphics-subsets-fragment-shader,
    fragment shader state>>, no element of the pname:pDynamicStates member
    of pname:pDynamicState is ename:VK_DYNAMIC_STATE_DEPTH_BOUNDS, and
ifdef::VK_EXT_extended_dynamic_state,VK_GRAPHICS_VERSION_1_3[]
    pname:pDynamicStates includes
    ename:VK_DYNAMIC_STATE_DEPTH_BOUNDS_TEST_ENABLE or
endif::VK_EXT_extended_dynamic_state,VK_GRAPHICS_VERSION_1_3[]
    the pname:depthBoundsTestEnable member of pname:pDepthStencilState is
    ename:VK_TRUE, pname:minDepthBounds must: be less than or equal to
...
ifdef::VK_EXT_multisampled_render_to_single_sampled[]
    ...
    the `apiext:VK_AMD_mixed_attachment_samples` extension is not enabled,
    the `apiext:VK_NV_framebuffer_mixed_samples` extension is not enabled,
    pname:rasterizationSamples is not dynamic, and pname:subpass uses color
...
ifdef::VK_EXT_multisampled_render_to_single_sampled[]
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-06854]]
    ...
    pname:multisampledRenderToSingleSampled>> feature is not enabled,
    pname:rasterizationSamples is not dynamic, and pname:subpass has a
...
ifdef::VK_EXT_mesh_shader[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-12325]]
    If pname:renderPass is not dlink:VK_NULL_HANDLE, the pipeline is being
    created with <<pipelines-graphics-subsets-pre-rasterization,
    pre-rasterization shader state>>, pname:pStages include a mesh shader,
    and pname:subpass viewMask is not `0`, then the index of the most
    significant bit in pname:viewMask must: be less than
    <<limits-maxMeshMultiviewViewCount, pname:maxMeshMultiviewViewCount>>
endif::VK_EXT_mesh_shader[]
endif::VK_GRAPHICS_VERSION_1_1,VK_KHR_multiview[]
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance2,VK_KHR_create_renderpass2[]
  * [[VUID-VkGraphicsPipelineCreateInfo-pStages-01565]]
    ...
    attachment
endif::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance2,VK_KHR_create_renderpass2[]
...
ifdef::VK_GRAPHICS_VERSION_1_3+VK_EXT_extended_dynamic_state[and]
...
ifdef::VK_GRAPHICS_VERSION_1_3+VK_EXT_extended_dynamic_state2[and]
ifdef::VK_GRAPHICS_VERSION_1_3[]
    the minimum value of slink:VkApplicationInfo::pname:apiVersion used to
    create the slink:VkInstance and pname:apiVersion supported by the
    physical device is less than Version 1.3
...
ifdef::VK_QCOM_render_pass_shader_resolve[]
    the `apiext:VK_QCOM_render_pass_shader_resolve` extension
endif::VK_QCOM_render_pass_shader_resolve[]
ifdef::VK_QCOM_render_pass_shader_resolve+VK_EXT_custom_resolve[or]
ifdef::VK_EXT_custom_resolve[]
    the <<features-customResolve, pname:customResolve>> feature
endif::VK_EXT_custom_resolve[]
    is enabled, pname:rasterizationSamples is not dynamic, and if subpass
    has any input attachments, and if the subpass description contains
    ename:VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_EXT, then the sample
...
ifdef::VK_EXT_custom_resolve[]
    ...
    ename:VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_EXT, then
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-pNext-12427]]
    If slink:VkPipelineRenderingCreateInfo is included in the pname:pNext
    chain, then pname:renderPass must: be dlink:VK_NULL_HANDLE
  * [[VUID-VkGraphicsPipelineCreateInfo-multiview-06577]]
    ...
    pre-rasterization shader state>> or
    <<pipelines-graphics-subsets-fragment-shader, fragment shader state>>,
    and pname:renderPass is dlink:VK_NULL_HANDLE,
    slink:VkPipelineRenderingCreateInfo::pname:viewMask must: be `0`
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-06578]]
    If the pipeline requires <<pipelines-graphics-subsets-pre-rasterization,
    pre-rasterization shader state>> or
    <<pipelines-graphics-subsets-fragment-shader, fragment shader state>>,
    and pname:renderPass is dlink:VK_NULL_HANDLE, the index of the most
    significant bit in slink:VkPipelineRenderingCreateInfo::pname:viewMask
    must: be less than <<limits-maxMultiviewViewCount,
...
ifdef::VK_EXT_extended_dynamic_state3[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-06055]]
    If pname:renderPass is dlink:VK_NULL_HANDLE, the pname:attachmentCount
    member of pname:pColorBlendState is not ignored, and the pipeline is
    being created with <<pipelines-graphics-subsets-fragment-output,
    fragment output interface state>>,
    pname:pColorBlendState->attachmentCount must: be equal to
    slink:VkPipelineRenderingCreateInfo::pname:colorAttachmentCount
ifdef::VK_EXT_custom_resolve[]
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-11504]]
    If pname:renderPass is dlink:VK_NULL_HANDLE, a
    slink:VkCustomResolveCreateInfoEXT is in the pNext chain, and the
    pipeline is being created with
    <<pipelines-graphics-subsets-fragment-output, fragment output interface
    state>>, slink:VkPipelineRenderingCreateInfo::pname:colorAttachmentCount
    must: be equal to
    slink:VkCustomResolveCreateInfoEXT::pname:colorAttachmentCount
endif::VK_EXT_custom_resolve[]
...
ifdef::VK_EXT_mesh_shader[]
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-07720]]
    ...
    pname:multiviewMeshShader is not enabled, then pname:pStages must: not
    include a mesh shader
  * [[VUID-VkGraphicsPipelineCreateInfo-renderPass-12326]]
    If pname:renderPass is dlink:VK_NULL_HANDLE, the pipeline is being
    created with <<pipelines-graphics-subsets-pre-rasterization,
    pre-rasterization shader state>>, pname:pStages include a mesh shader,
    and slink:VkPipelineRenderingCreateInfo::pname:viewMask is not `0`, then
    the index of the most significant bit in pname:viewMask must: be less
    than <<limits-maxMeshMultiviewViewCount,
    pname:maxMeshMultiviewViewCount>>
endif::VK_EXT_mesh_shader[]
...
ifdef::VK_EXT_graphics_pipeline_library[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-layout-06602]]
    ...
    state>>,
ifdef::VK_EXT_descriptor_heap[]
    and slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags does not
    include ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT,
endif::VK_EXT_descriptor_heap[]
...
ifndef::VK_AMDX_shader_enqueue[If]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-06612]]
    If
ifdef::VK_EXT_descriptor_heap[]
    slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags does not include
    ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT,
endif::VK_EXT_descriptor_heap[]
    slink:VkGraphicsPipelineLibraryCreateInfoEXT::pname:flags includes only
    one of
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT, and an
    element of slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    one element of slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries
    includes
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT and
    another element includes
...
ifdef::VK_EXT_descriptor_heap[]
    slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags does not include
    ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT, and
endif::VK_EXT_descriptor_heap[]
    one element of slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries
    includes
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT and
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT, an element
    of slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries includes the
    other subset, ename:VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT
    was not used, and any element of the pname:pSetLayouts array when
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    ename:VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT was not used,
    and any element of the pname:pSetLayouts array used to create each
    library's pname:layout was dlink:VK_NULL_HANDLE, then the corresponding
    element of the pname:pSetLayouts array used to create the other
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    slink:VkGraphicsPipelineLibraryCreateInfoEXT::pname:flags includes both
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT and
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    slink:VkGraphicsPipelineLibraryCreateInfoEXT::pname:flags includes
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT,
    and pname:pRasterizationState->rasterizerDiscardEnable is ename:VK_TRUE,
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-06626]]
    ...
    slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries, and
    pname:renderPass is dlink:VK_NULL_HANDLE, the value of
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-pLibraries-06627]]
    If ename:VK_GRAPHICS_PIPELINE_LIBRARY_PRE_RASTERIZATION_SHADERS_BIT_EXT
    and ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT are
    included in two elements of
    slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries, and
    pname:renderPass was dlink:VK_NULL_HANDLE for both libraries, the value
    of slink:VkPipelineRenderingCreateInfo::pname:viewMask set by each
...
ifdef::VK_EXT_extended_dynamic_state3[]
    ...
    slink:VkPipelineMultisampleStateCreateInfo structure
ifdef::VK_EXT_custom_resolve[]
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-11856]]
    If slink:VkGraphicsPipelineLibraryCreateInfoEXT::pname:flags includes
    either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT,
    slink:VkCustomResolveCreateInfoEXT is included and
    slink:VkCustomResolveCreateInfoEXT::pname:customResolve is
    ename:VK_TRUE, and an element of
    slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries also includes
    either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT, the library
    must: also include slink:VkCustomResolveCreateInfoEXT and the
    slink:VkCustomResolveCreateInfoEXT::pname:customResolve specified by the
    library must: be ename:VK_TRUE
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-11857]]
    If slink:VkGraphicsPipelineLibraryCreateInfoEXT::pname:flags includes
    either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT,
    slink:VkCustomResolveCreateInfoEXT is not included or
    slink:VkCustomResolveCreateInfoEXT::pname:customResolve is
    ename:VK_FALSE, and an element of
    slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries also includes
    either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT, either the
    library must: not include slink:VkCustomResolveCreateInfoEXT or the
    slink:VkCustomResolveCreateInfoEXT::pname:customResolve specified by the
    library must: be ename:VK_FALSE
  * [[VUID-VkGraphicsPipelineCreateInfo-customResolve-11858]]
    If one element of slink:VkPipelineLibraryCreateInfoKHR includes either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT,
    slink:VkCustomResolveCreateInfoEXT is included and
    slink:VkCustomResolveCreateInfoEXT::pname:customResolve is
    ename:VK_TRUE, and another element of
    slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries also includes
    either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT, the other
    library must: also include slink:VkCustomResolveCreateInfoEXT and the
    slink:VkCustomResolveCreateInfoEXT::pname:customResolve specified by the
    library must: be ename:VK_TRUE
  * [[VUID-VkGraphicsPipelineCreateInfo-customResolve-11859]]
    If one element of slink:VkPipelineLibraryCreateInfoKHR includes either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT,
    slink:VkCustomResolveCreateInfoEXT is not included or
    slink:VkCustomResolveCreateInfoEXT::pname:customResolve is
    ename:VK_FALSE, and another element of
    slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries also includes
    either
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_OUTPUT_INTERFACE_BIT_EXT or
    ename:VK_GRAPHICS_PIPELINE_LIBRARY_FRAGMENT_SHADER_BIT_EXT, either the
    other library must: not include slink:VkCustomResolveCreateInfoEXT or
    the slink:VkCustomResolveCreateInfoEXT::pname:customResolve specified by
    the library must: be ename:VK_FALSE
endif::VK_EXT_custom_resolve[]
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    the pipeline includes a <<pipelines-graphics-subsets-complete, complete
    set of state>>, and there are no libraries included in
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    the pipeline includes a <<pipelines-graphics-subsets-complete, complete
    set of state>> specified entirely by libraries, and each library was
    created with a slink:VkPipelineLayout created without
    ename:VK_PIPELINE_LAYOUT_CREATE_INDEPENDENT_SETS_BIT_EXT, then
    pname:layout must: be <<descriptors-compatibility,compatible>> with the
...
ifdef::VK_EXT_conservative_rasterization[]
  * [[VUID-VkGraphicsPipelineCreateInfo-conservativePointAndLineRasterization-08892]]
    ...
    topology>> is in line or point topology class, then
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-VkGraphicsPipelineCreateInfo-pLibraries-11594]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR,
    each element of slink:VkPipelineLibraryCreateInfoKHR::pname:pLibraries
    must: have been created with the
    ename:VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR
    bit set
ifdef::VK_KHR_maintenance5,VK_BASE_VERSION_1_4[]
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-11595]]
    If the
    <<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>
    feature is not enabled, pname:flags must: not include
    ename:VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR
...
ifdef::VK_QCOM_multiview_per_view_viewports[]
  * [[VUID-VkGraphicsPipelineCreateInfo-pDynamicStates-07730]]
    ...
    pname:multiviewPerViewViewports>> feature is enabled, pname:renderpass
    is not dlink:VK_NULL_HANDLE, the pipeline requires
    <<pipelines-graphics-subsets-pre-rasterization, pre-rasterization shader
    state>>, and no element of the pname:pDynamicStates member of
    pname:pDynamicState is ename:VK_DYNAMIC_STATE_VIEWPORT_WITH_COUNT, then
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-pDynamicStates-07731]]
    ...
    <<pipelines-graphics-subsets-pre-rasterization, pre-rasterization shader
    state>>, and no element of the pname:pDynamicStates member of
    pname:pDynamicState is ename:VK_DYNAMIC_STATE_SCISSOR_WITH_COUNT, then
    the index of the most significant bit in each element of
    slink:VkRenderPassMultiviewCreateInfo::pname:pViewMasks must: be less
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-multiviewPerViewViewports-12250]]
    ...
    the index of the most significant bit in
    slink:VkPipelineRenderingCreateInfo::pname:viewMask must: be less than
    pname:pViewportState->scissorCount
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
...
ifndef::VK_EXT_graphics_pipeline_library[]
  ...
  * [[VUID-VkGraphicsPipelineCreateInfo-pDynamicState-08896]]
    If
ifdef::VK_EXT_extended_dynamic_state2,VK_GRAPHICS_VERSION_1_3[]
    pname:pDynamicState->pDynamicStates includes
    ename:VK_DYNAMIC_STATE_RASTERIZER_DISCARD_ENABLE, or if it does not and
endif::VK_EXT_extended_dynamic_state2,VK_GRAPHICS_VERSION_1_3[]
...
ifdef::VK_EXT_descriptor_heap+VK_EXT_graphics_pipeline_library[]
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-11273]]
    If slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags includes
    ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT, all libraries linked
    to this pipeline must: also have that flag set
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-11274]]
    If slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags does not
    include ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT, all
    libraries linked to this pipeline must: also not have that flag set
endif::VK_EXT_descriptor_heap+VK_EXT_graphics_pipeline_library[]
ifdef::VK_EXT_descriptor_buffer+VK_EXT_graphics_pipeline_library[]
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-12355]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT, all libraries linked
    to this pipeline must: also have that flag set
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-12356]]
    If pname:flags does not include
    ename:VK_PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT, all libraries linked
    to this pipeline must: also not have that flag set
endif::VK_EXT_descriptor_buffer+VK_EXT_graphics_pipeline_library[]
ifdef::VK_COMPUTE_VERSION_1_4,VK_EXT_pipeline_protected_access+VK_EXT_graphics_pipeline_library[]
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-12357]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT, all libraries linked
    to this pipeline must: also have that flag set
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-12358]]
    If pname:flags does not include
    ename:VK_PIPELINE_CREATE_NO_PROTECTED_ACCESS_BIT, all libraries linked
    to this pipeline must: also not have that flag set
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-12359]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT, all libraries linked
    to this pipeline must: also have that flag set
  * [[VUID-VkGraphicsPipelineCreateInfo-flags-12360]]
    If pname:flags does not include
    ename:VK_PIPELINE_CREATE_PROTECTED_ACCESS_ONLY_BIT, all libraries linked
    to this pipeline must: also not have that flag set
endif::VK_COMPUTE_VERSION_1_4,VK_EXT_pipeline_protected_access+VK_EXT_graphics_pipeline_library[]
****
ifdef::VKSC_VERSION_1_0[]
ifdef::hidden[]
// tag::scdeviation[]
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
[open,refpage='VkPipelineRenderingCreateInfo',desc='Structure specifying attachment formats',type='structs']
--
...
include::{generated}/api/structs/VkPipelineRenderingCreateInfoKHR.adoc[]
  ...
  * pname:viewMask is a bitfield of view indices describing which views are
    ...
    It must: match slink:VkRenderingInfo::pname:viewMask when rendering.
...
ifdef::VK_EXT_custom_resolve[]
[open,refpage='VkCustomResolveCreateInfoEXT',desc='Structure specifying format info for custom resolves',type='structs']
--
The sname:VkCustomResolveCreateInfoEXT structure is defined as:

include::{generated}/api/structs/VkCustomResolveCreateInfoEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:customResolve indicates whether this pipeline will be used for a
    resolve operation.
  * pname:colorAttachmentCount is the number of entries in
    pname:pColorAttachmentFormats.
  * pname:pColorAttachmentFormats is a pointer to an array of elink:VkFormat
...
If the pname:pNext chain includes this structure for one of:

  * a slink:VkGraphicsPipelineCreateInfo for a pipeline created without a
    slink:VkRenderPass
  * a slink:VkCommandBufferInheritanceInfo for a secondary command buffer
    within a render pass instance begun with flink:vkCmdBeginRendering.
...
ifdef::VK_EXT_shader_object[]
If the pname:pNext chain includes this structure for a
slink:VkShaderCreateInfoEXT for a fragment shader object, it only specifies
...
If pname:customResolve is ename:VK_FALSE, the pipeline can: only be used
outside the custom resolve section.
If pname:customResolve is ename:VK_TRUE, the pipeline can: only be used
...
pname:dynamicRenderingUnusedAttachments>> feature is enabled, then when this
structure is not included in the pname:pNext chain for
slink:VkGraphicsPipelineCreateInfo, pname:customResolve is ename:VK_FALSE,
pname:colorAttachmentCount is `0`, and pname:depthAttachmentFormat and
pname:stencilAttachmentFormat are ename:VK_FORMAT_UNDEFINED.
endif::VK_EXT_dynamic_rendering_unused_attachments[]
...
ifdef::VK_EXT_fragment_density_map[]
ifdef::VK_EXT_shader_object[]
When passed as a pname:pNext member to a slink:VkShaderCreateInfoEXT struct
for use with fragment density maps, the pname:colorAttachmentCount,
pname:pColorAttachmentFormats, pname:depthAttachmentFormat, and
pname:stencilAttachmentFormat members of this struct are ignored.
When not passed as a pname:pNext member, pname:customResolve is
ename:VK_FALSE.
endif::VK_EXT_shader_object[]
endif::VK_EXT_fragment_density_map[]
...
include::{generated}/validity/structs/VkCustomResolveCreateInfoEXT.adoc[]
--
endif::VK_EXT_custom_resolve[]
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
...
slink:VkShaderModuleCreateInfo structures declared in
slink:VkPipelineShaderStageCreateInfo instances, are ignored.
ifdef::VK_EXT_descriptor_heap[]
Any slink:VkShaderDescriptorSetAndBindingMappingInfoEXT in the pname:pNext
chains of slink:VkPipelineShaderStageCreateInfo instances are ignored.
endif::VK_EXT_descriptor_heap[]
...
****
  * [[VUID-VkPipelineBinaryInfoKHR-binaryCount-09603]]
    ...
    sname:VkShaderModuleCreateInfo structures, for the same
...
=== Ray Tracing Pipeline Enums and Types

[open,refpage='VK_SHADER_UNUSED_KHR',desc='Sentinel for an unused shader index',type='consts']
--
...
[open,refpage='VkRayTracingShaderGroupTypeKHR',desc='Shader group types',type='enums']
--
...
ifdef::VK_KHR_pipeline_library[]
  ...
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-pLibraryInfo-03592]]
    If pname:pLibraryInfo is not `NULL` and pname:layout is not
    dlink:VK_NULL_HANDLE, each element of pname:pLibraryInfo->pLibraries
    must: have been created with a pname:layout that is compatible with the
  ...
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-03470]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_RAY_TRACING_NO_NULL_ANY_HIT_SHADERS_BIT_KHR,
    for each element of pname:pGroups with a pname:type of
...
ifdef::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-11597]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR, at least
    one of the following features must: be enabled
ifdef::VK_KHR_opacity_micromap[]
  ** <<features-micromap,
     sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>
endif::VK_KHR_opacity_micromap[]
ifdef::VK_EXT_opacity_micromap[]
  ** <<features-micromapEXT,
     sname:VkPhysicalDeviceOpacityMicromapFeaturesEXT::pname:micromap>>
endif::VK_EXT_opacity_micromap[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-pLibraries-11598]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR, each
    element of pname:pLibraryInfo->pLibraries must: have been created with
    the ename:VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR bit
    set
endif::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
ifdef::VK_KHR_opacity_micromap[]
ifdef::VK_KHR_maintenance5,VK_BASE_VERSION_1_4[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-11599]]
    If the
    <<features-micromap,sname:VkPhysicalDeviceOpacityMicromapFeaturesKHR::pname:micromap>>
    feature is not enabled or pname:flags does not include
    ename:VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR,
    pname:flags must: not include
    ename:VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR
endif::VK_KHR_maintenance5,VK_BASE_VERSION_1_4[]
...
ifdef::VK_ARM_pipeline_opacity_micromap[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-10392]]
    ...
    include both
    ename:VK_PIPELINE_CREATE_2_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR and
    ename:VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM
endif::VK_ARM_pipeline_opacity_micromap[]
ifdef::VK_EXT_descriptor_heap+VK_KHR_pipeline_library[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-11275]]
    If slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags includes
    ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT, all libraries linked
    to this pipeline must: also have that flag set
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-11276]]
    If slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags does not
    include ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT, all
    libraries linked to this pipeline must: also not have that flag set
endif::VK_EXT_descriptor_heap+VK_KHR_pipeline_library[]
ifdef::VK_EXT_descriptor_buffer+VK_KHR_pipeline_library[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-12361]]
    If pname:flags includes
    ename:VK_PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT, all libraries linked
    to this pipeline must: also have that flag set
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-flags-12362]]
    If pname:flags does not include
    ename:VK_PIPELINE_CREATE_DESCRIPTOR_BUFFER_BIT_EXT, all libraries linked
    to this pipeline must: also not have that flag set
endif::VK_EXT_descriptor_buffer+VK_KHR_pipeline_library[]
  * [[VUID-VkRayTracingPipelineCreateInfoKHR-None-11369]]
    {empty}
ifdef::VK_EXT_descriptor_heap[]
    If slink:VkPipelineCreateFlags2CreateInfoKHR::pname:flags does not
    include ename:VK_PIPELINE_CREATE_2_DESCRIPTOR_HEAP_BIT_EXT,
...
ifdef::VK_EXT_pipeline_library_group_handles,VK_KHR_pipeline_library_group_handles[]
...
endif::VK_EXT_pipeline_library_group_handles,VK_KHR_pipeline_library_group_handles[]
...
****
  * [[VUID-VkRayTracingShaderGroupCreateInfoKHR-type-03474]]
    ...
    pname:generalShader must: be a valid index into the list of shaders,
    formed by shaders in
    slink:VkRayTracingPipelineCreateInfoKHR::pname:pStages and the shaders
  ...
  * [[VUID-VkRayTracingShaderGroupCreateInfoKHR-type-03476]]
    ...
    pname:intersectionShader must: be a valid index into the list of
...
any block (in bytes) declared in the code:HitAttributeKHR
ifdef::VK_EXT_ray_tracing_invocation_reorder[]
or code:HitObjectAttributeEXT
...
ifdef::VK_EXT_pipeline_creation_feedback,VK_COMPUTE_VERSION_1_3[]
  ...
  * [[VUID-VkRayTracingPipelineCreateInfoNV-stage-06898]]
    ...
    ename:VK_SHADER_STAGE_CALLABLE_BIT_KHR
ifdef::VK_KHR_opacity_micromap,VK_EXT_opacity_micromap[]
  * [[VUID-VkRayTracingPipelineCreateInfoNV-flags-11596]]
    pname:flags must: not include any of the following bits
  ** ename:VK_PIPELINE_CREATE_RAY_TRACING_OPACITY_MICROMAP_BIT_KHR
ifdef::VK_KHR_opacity_micromap[]
ifdef::VK_KHR_maintenance5,VK_BASE_VERSION_1_4[]
  ** ename:VK_PIPELINE_CREATE_2_OPACITY_MICROMAP_DISALLOW_MIXED_SPECIAL_INDEX_BIT_KHR
...
=== Ray Tracing Pipeline Queries and Commands

[open,refpage='vkGetRayTracingShaderGroupHandlesKHR',desc='Query ray tracing pipeline shader group handles',type='protos']
--
...
pname:firstGroup, with subsequent handles corresponding to consecutive
...
pname:firstGroup, with subsequent handles corresponding to consecutive
shader groups in the order they appear in the
slink:VkRayTracingPipelineCreateInfoKHR::pname:pGroups array.
...
include::{generated}/api/structs/VkPipelineCacheCreateInfo.adoc[]
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_pipeline_creation_cache_control,VKSC_VERSION_1_0[]
  * pname:flags is a bitmask of elink:VkPipelineCacheCreateFlagBits
    specifying the behavior of the pipeline cache.
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_pipeline_creation_cache_control,VKSC_VERSION_1_0[]
ifndef::VK_COMPUTE_VERSION_1_3,VK_EXT_pipeline_creation_cache_control,VKSC_VERSION_1_0[]
  * pname:flags is reserved for future use.
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_pipeline_creation_cache_control,VKSC_VERSION_1_0[]
...
memory pointed to by pname:pInitialData can: be modified or released by the
application only after any pipeline cache objects created using it have been
destroyed.
====
...
ifdef::VK_QCOM_data_graph_model[]
  * [[VUID-vkMergePipelineCaches-dstCache-11832]]
    pname:dstCache must: not have been created with the pname:headerVersion
    member of slink:VkPipelineCacheCreateInfo::pname:pInitialData equal to
    ename:VK_PIPELINE_CACHE_HEADER_VERSION_DATA_GRAPH_QCOM
  * [[VUID-vkMergePipelineCaches-headerVersion-11833]]
    Each member of pSrcCaches must: not have been created with the
    pname:headerVersion member of
    slink:VkPipelineCacheCreateInfo::pname:pInitialData equal to
    ename:VK_PIPELINE_CACHE_HEADER_VERSION_DATA_GRAPH_QCOM
...
****
  * [[VUID-vkGetPipelineCacheData-pipelineCache-11834]]
    pname:pipelineCache must: not have been created with the
    pname:headerVersion member of
    slink:VkPipelineCacheCreateInfo::pname:pInitialData equal to
    ename:VK_PIPELINE_CACHE_HEADER_VERSION_DATA_GRAPH_QCOM
****
...
ifdef::VK_QCOM_data_graph_model[]
  * ename:VK_PIPELINE_CACHE_HEADER_VERSION_DATA_GRAPH_QCOM specifies a
    pipeline cache for offline built data graph models, described by
    slink:VkPipelineCacheHeaderVersionDataGraphQCOM.
endif::VK_QCOM_data_graph_model[]
--
...
ifdef::VK_QCOM_data_graph_model[]
[open,refpage='VkPipelineCacheHeaderVersionDataGraphQCOM',desc='Structure describing the layout of the pipeline cache header for data graphs',type='structs']
--
The data graph pipeline cache header is defined as:

include::{generated}/api/structs/VkPipelineCacheHeaderVersionDataGraphQCOM.adoc[]
  ...
  * pname:headerVersion is a elink:VkPipelineCacheHeaderVersion value
    ...
    interpret the remainder of the cache header.
    pname:headerVersion must: be written as exactly 4 bytes.
  * pname:cacheType is the elink:VkDataGraphModelCacheTypeQCOM type of data
    graph cache encoded in the data.
  * pname:cacheVersion is the version of the encoding of the data graph
    cache.
  * pname:toolchainVersion is a null-terminated UTF-8 string specifying the
...
slink:VkDataGraphProcessingEngineCreateInfoARM passed during pipeline
creation.
Implementations may: return ename:VK_PIPELINE_COMPILE_REQUIRED_EXT from
flink:vkCreateDataGraphPipelinesARM if the cache is not compatible.
...
include::{generated}/validity/structs/VkPipelineCacheHeaderVersionDataGraphQCOM.adoc[]
--

[open,refpage='VkDataGraphModelCacheTypeQCOM',desc='Encode pipeline data graph cache type',type='enums']
--
The elink:VkDataGraphModelCacheTypeQCOM enumeration determines the contents
of the pipeline data graph cache.

Possible values are:

include::{generated}/api/enums/VkDataGraphModelCacheTypeQCOM.adoc[]

  * ename:VK_DATA_GRAPH_MODEL_CACHE_TYPE_GENERIC_BINARY_QCOM specifies a
    general binary layout type.
--

[open,refpage='VK_DATA_GRAPH_MODEL_TOOLCHAIN_VERSION_LENGTH_QCOM',desc='Length of a data graph toolchain version string',type='consts']
--
ename:VK_DATA_GRAPH_MODEL_TOOLCHAIN_VERSION_LENGTH_QCOM is the length in
code:char values of an array containing the version of the compiler that
built a data graph cache, as returned in
slink:VkPipelineCacheHeaderVersionDataGraphQCOM::pname:toolchainVersion.

include::{generated}/api/enums/VK_DATA_GRAPH_MODEL_TOOLCHAIN_VERSION_LENGTH_QCOM.adoc[]
--
endif::VK_QCOM_data_graph_model[]
...
ifdef::VK_EXT_sample_locations[]
  * [[VUID-vkCmdBindPipeline-variableSampleLocations-01525]]
    ...
    with a pname:renderPass that is not dlink:VK_NULL_HANDLE and with a
    slink:VkPipelineSampleLocationsStateCreateInfoEXT structure having its
    pname:sampleLocationsEnable member set to ename:VK_TRUE but without
    ename:VK_DYNAMIC_STATE_SAMPLE_LOCATIONS_EXT enabled then the current
...
The following list all the dynamic state with their logical state name.

Some dynamic state is tied to a single shader stage and can be ignored if
that stage is not being used.

ifdef::VK_EXT_graphics_pipeline_library[]
Some dynamic state is tied to certain graphics pipeline state.
The dynamic state in
slink:VkPipelineDynamicStateCreateInfo::pname:pDynamicStates is ignored if
the pipeline is being created without the corresponding pipeline state.
endif::VK_EXT_graphics_pipeline_library[]

Some dynamic state is ignored if there is no <<primsrast,rasterization
stage>>.
The pname:rasterizerDiscardEnable state is used to control if the
rasterization stage occurs.

Some dynamic state is ignored if other dynamic state is not enabled.
Some conditions involve special conditions to be met.

Each dynamic state has at least one command that can be set while recording
the command buffer.
If using a pipeline, there is a elink:VkDynamicState associated for each of
these commands.

ifdef::VK_EXT_shader_object[]
When using flink:vkCreateShadersEXT to create a shader object, all dynamic
state is dynamic, with no static equivalent.
endif::VK_EXT_shader_object[]

include::{generated}/dynamicstate/dynamic_state_table.adoc[]
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_pipeline_creation_feedback[]
...
--
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_pipeline_creation_feedback[]
