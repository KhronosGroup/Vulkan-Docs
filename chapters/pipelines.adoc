...
ifdef::VKSC_VERSION_1_0[]
    If pname:pipelineCache was not created with
    ename:VK_PIPELINE_CACHE_CREATE_USE_APPLICATION_STORAGE_BIT then the
endif::VKSC_VERSION_1_0[]
ifndef::VKSC_VERSION_1_0[The]
...
ifdef::VKSC_VERSION_1_0[]
  * pname:pInitialData is a pointer to pipeline cache data that has been
    ...
    pname:flags, pname:pInitialData may: be accessed at any time the
    resulting slink:VkPipelineCache is accessed.
ifdef::hidden[]
// tag::scdeviation[]
