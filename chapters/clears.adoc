...
ifdef::VK_VERSION_1_3,VK_KHR_dynamic_rendering[]
  * [[VUID-vkCmdClearAttachments-aspectMask-07882]]
    If the current render pass instance uses dynamic rendering, the
    pname:aspectMask member of any element of pname:pAttachments contains
    ename:VK_IMAGE_ASPECT_DEPTH_BIT,
    slink:VkRenderingInfo::pname:pDepthAttachment is not code:NULL, and
    pname:pDepthAttachment->imageView is not dlink:VK_NULL_HANDLE, the
    render pass pname:format must: contain a depth aspect
  * [[VUID-vkCmdClearAttachments-aspectMask-07883]]
    If the current render pass instance uses dynamic rendering, the
    pname:aspectMask member of any element of pname:pAttachments contains
    ename:VK_IMAGE_ASPECT_STENCIL_BIT,
    slink:VkRenderingInfo::pname:pStencilAttachment is not code:NULL, and
    pname:pStencilAttachment->imageView is not dlink:VK_NULL_HANDLE, the
    render pass pname:format must: contain a stencil aspect
  * [[VUID-vkCmdClearAttachments-aspectMask-07884]]
    If the current render pass instance does not use dynamic rendering, and
    ...
    the attachment pname:format must: contain a depth aspect
