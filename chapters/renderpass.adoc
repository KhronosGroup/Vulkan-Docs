...
ifdef::VK_EXT_attachment_feedback_loop_layout[]
  ...
  * [[VUID-VkRenderingAttachmentInfo-resolveImageView-10781]]
    If <<renderpass-feedbackloop,feedback loop is enabled>> for the
    attachment identified by pname:resolveImageView, then
    pname:resolveImageView must: have been created with a pname:usage value
    including ename:VK_IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT, either
    ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT or
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, and either
    ename:VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT or
    ename:VK_IMAGE_USAGE_SAMPLED_BIT
...
[open,refpage='VkAttachmentFeedbackLoopInfoEXT',desc='Structure specifying whether feedback loop is enabled for an attachment or its resolve attachment',type='structs']
--
...
#ifdef::VK_QCOM_tile_shading[] The pname:tileSize is guaranteed to be a
multiple of <<limits-tileGranularity,pname:tileGranularity>>.
#endif::VK_QCOM_tile_shading[]
