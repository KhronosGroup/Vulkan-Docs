...
ifdef::VK_VERSION_1_4+VK_KHR_maintenance5[or the equivalent command]
...
ifdef::VK_VERSION_1_4,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
This does not apply when using ename:VK_ATTACHMENT_LOAD_OP_NONE.
endif::VK_VERSION_1_4,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
====
