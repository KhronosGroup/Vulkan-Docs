...
[open,refpage='vkCmdBeginRendering',desc='Begin a dynamic render pass instance',type='protos']
--
...
If there is an instance of slink:VkTileMemorySizeInfoQCOM included in the
pname:pNext chain of slink:VkRenderingInfo, the structure is ignored.
...
ifdef::VK_EXT_nested_command_buffer[]
  ...
  * [[VUID-vkCmdBeginRendering-commandBuffer-10914]]
    If pname:commandBuffer is a secondary command buffer,
    ename:VK_COMMAND_BUFFER_USAGE_RENDER_PASS_CONTINUE_BIT must: not have
    been set in slink:VkCommandBufferBeginInfo::pname:flags when
    pname:commandBuffer began
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09588]]
    ...
    dlink:VK_NULL_HANDLE, when
    pname:pRenderingInfo->pDepthAttachment->imageView is accessed it must:
  ...
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09589]]
    ...
    pname:pRenderingInfo->pDepthAttachment->resolveMode is not
  ...
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09590]]
    ...
    dlink:VK_NULL_HANDLE, when
    pname:pRenderingInfo->pStencilAttachment->imageView is accessed it must:
    be in the layout specified by
  ...
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09591]]
    ...
    pname:pRenderingInfo->pStencilAttachment->imageView is not
    dlink:VK_NULL_HANDLE,
    pname:pRenderingInfo->pStencilAttachment->resolveMode is not
    ename:VK_RESOLVE_MODE_NONE, and
  ...
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09592]]
    For each element of pname:pRenderingInfo->pColorAttachments, if
    pname:imageView is not dlink:VK_NULL_HANDLE, when that image view is
    accessed it must: be in the layout specified by the pname:imageLayout
    member of that same element of pname:pRenderingInfo->pColorAttachments
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-09593]]
    For each element of pname:pRenderingInfo->pColorAttachments, if
ifdef::VK_ANDROID_external_format_resolve[]
    either pname:resolveMode is
    ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID, or
...
ifdef::VK_QCOM_tile_shading[]
  * [[VUID-vkCmdBeginRendering-flags-10641]]
    If ename:VK_TILE_SHADING_RENDER_PASS_ENABLE_BIT_QCOM is included in
    slink:VkRenderPassTileShadingCreateInfoQCOM::pname:flags,
  ...
  * [[VUID-vkCmdBeginRendering-flags-10642]]
    slink:VkRenderPassTileShadingCreateInfoQCOM::pname:flags must: not
    include ename:VK_TILE_SHADING_RENDER_PASS_PER_TILE_EXECUTION_BIT_QCOM
endif::VK_QCOM_tile_shading[]
ifdef::VK_KHR_maintenance10[]
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-11750]]
    If pname:pRenderingInfo->flags contains
    ename:VK_RENDERING_LOCAL_READ_CONCURRENT_ACCESS_CONTROL_BIT_KHR,
    <<features-maintenance10,pname:maintenance10>> must: be enabled
  * [[VUID-vkCmdBeginRendering-pRenderingInfo-11751]]
    If pname:pRenderingInfo->flags does not contain
    ename:VK_RENDERING_LOCAL_READ_CONCURRENT_ACCESS_CONTROL_BIT_KHR,
...
ifdef::VK_EXT_fragment_density_map[]
  * [[VUID-vkCmdBeginRendering-imageView-12276]]
    If slink:VkRenderingFragmentDensityMapAttachmentInfoEXT::pname:imageView
    is not equal to dlink:VK_NULL_HANDLE, when pname:imageView is accessed
    it must: be in the layout specified by
    slink:VkRenderingFragmentDensityMapAttachmentInfoEXT::pname:imageLayout
...
ifdef::VK_KHR_fragment_shading_rate[]
  * [[VUID-vkCmdBeginRendering-imageView-12277]]
    ...
    is not equal to dlink:VK_NULL_HANDLE, when pname:imageView is accessed
    it must: be in the layout specified by
    slink:VkRenderingFragmentShadingRateAttachmentInfoKHR::pname:imageLayout
...
[open,refpage='VkRenderingInfo',desc='Structure specifying render pass instance begin info',type='structs']
--
...
include::{generated}/api/structs/VkRenderingInfoKHR.adoc[]
  ...
  * pname:viewMask is a bitfield of view indices describing which views are
...
ifdef::VK_KHR_multiview,VK_GRAPHICS_VERSION_1_1[]
If pname:viewMask is not `0`, multiview is enabled.
endif::VK_KHR_multiview,VK_GRAPHICS_VERSION_1_1[]

ifdef::VK_KHR_device_group,VK_GRAPHICS_VERSION_1_1[]
...
endif::VK_KHR_device_group,VK_GRAPHICS_VERSION_1_1[]

ifdef::VK_QCOM_multiview_per_view_render_areas[]
If multiview is enabled, and the <<features-multiviewPerViewRenderAreas,
...
In this case, pname:renderArea must: be an area at least as large as the
...
ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID,
endif::VK_ANDROID_external_format_resolve[]
writes to the corresponding location by a fragment are discarded.

The pname:aspectMask of any image view specified for pname:pDepthAttachment
or pname:pStencilAttachment is ignored.
Instead, depth attachments are automatically treated as if
ename:VK_IMAGE_ASPECT_DEPTH_BIT was specified for their aspect masks, and
stencil attachments are automatically treated as if
ename:VK_IMAGE_ASPECT_STENCIL_BIT was specified for their aspect masks.
...
+
pname:imageView members of pname:pDepthAttachment, pname:pStencilAttachment,
and elements of pname:pColorAttachments that are not dlink:VK_NULL_HANDLE
must: have been created with the same pname:sampleCount
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_device_group[]
    If slink:VkDeviceGroupRenderPassBeginInfo::pname:deviceRenderAreaCount
    is 0,
endif::VK_GRAPHICS_VERSION_1_1,VK_KHR_device_group[]
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_device_group[]
    ...
    the width of the pname:imageView member of each element of
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_device_group[]
    ...
    the height of the pname:imageView member of each element of
    pname:pColorAttachments, pname:pDepthAttachment, or
    pname:pStencilAttachment that is not dlink:VK_NULL_HANDLE must: be
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_device_group[]
  ...
  * [[VUID-VkRenderingInfo-colorAttachmentCount-06087]]
    ...
    ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT usage flag set
...
ifdef::VK_ANDROID_external_format_resolve[]
    ...
    its pname:imageView member not dlink:VK_NULL_HANDLE, its
    pname:resolveMode member not set to ename:VK_RESOLVE_MODE_NONE, and
    pname:resolveImageView is not dlink:VK_NULL_HANDLE, then the
  ...
  * [[VUID-VkRenderingInfo-pDepthAttachment-09477]]
    ...
    and pname:pDepthAttachment->resolveImageView is not
    dlink:VK_NULL_HANDLE, then pname:pDepthAttachment->resolveImageView
    must: have been created with the
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT usage flag set
  ...
  * [[VUID-VkRenderingInfo-pStencilAttachment-09478]]
    ...
    and pname:pStencilAttachment->resolveImageView is not
    dlink:VK_NULL_HANDLE, then pname:pStencilAttachment->resolveImageView
    must: have been created with the
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT usage flag set
...
ifdef::VK_EXT_custom_resolve[]
  * [[VUID-VkRenderingInfo-flags-11514]]
    If pname:flags contains ename:VK_RENDERING_CUSTOM_RESOLVE_BIT_EXT or
    ename:VK_RENDERING_FRAGMENT_REGION_BIT_EXT, then the
    <<features-customResolve, pname:customResolve>> feature must: be enabled
  * [[VUID-VkRenderingInfo-pColorAttachments-11515]]
    For any element of pname:pColorAttachments, pname:pDepthAttachment, or
    pname:pStencilAttachment, if pname:resolveMode contains
    ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT, then pname:flags must: contain
    ename:VK_RENDERING_CUSTOM_RESOLVE_BIT_EXT
  * [[VUID-VkRenderingInfo-flags-11516]]
    If pname:flags contains ename:VK_RENDERING_CUSTOM_RESOLVE_BIT_EXT, then
    for any element of pname:pColorAttachments, pname:pDepthAttachment, or
    pname:pStencilAttachment, pname:resolveMode must: be
    ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT or ename:VK_RESOLVE_MODE_NONE
  ...
  * [[VUID-VkRenderingInfo-viewMask-10859]]
    If pname:viewMask is `0`, each pname:pColorAttachment->imageView and
    pname:pColorAttachment->resolveImageView that is not
    dlink:VK_NULL_HANDLE must: have a pname:layerCount that is greater than
    or equal to sname:VkRenderingInfo::pname:layerCount
  * [[VUID-VkRenderingInfo-viewMask-10860]]
    If pname:viewMask is `0`, each pname:pDepthAttachment->imageView and
    pname:pDepthAttachment->resolveImageView that is not
    dlink:VK_NULL_HANDLE must: have a pname:layerCount that is greater than
    or equal to sname:VkRenderingInfo::pname:layerCount
  * [[VUID-VkRenderingInfo-viewMask-10861]]
    If pname:viewMask is `0`, each pname:pStencilAttachment->imageView and
    pname:pStencilAttachment->resolveImageView that is not
    dlink:VK_NULL_HANDLE must: have a pname:layerCount that is greater than
    or equal to sname:VkRenderingInfo::pname:layerCount
  * [[VUID-VkRenderingInfo-viewMask-12403]]
    If pname:viewMask is not `0`, each pname:pColorAttachment->imageView and
    pname:pColorAttachment->resolveImageView that is not
    dlink:VK_NULL_HANDLE must: have a pname:layerCount that is greater than
    the index of the most significant bit in pname:viewMask
  * [[VUID-VkRenderingInfo-viewMask-12404]]
    If pname:viewMask is not `0`, each pname:pDepthAttachment->imageView and
    pname:pDepthAttachment->resolveImageView that is not
    dlink:VK_NULL_HANDLE must: have a pname:layerCount that is greater than
    the index of the most significant bit in pname:viewMask
  * [[VUID-VkRenderingInfo-viewMask-12405]]
    If pname:viewMask is not `0`, each pname:pStencilAttachment->imageView
    and pname:pStencilAttachment->resolveImageView that is not
    dlink:VK_NULL_HANDLE must: have a pname:layerCount that is greater than
    the index of the most significant bit in pname:viewMask
ifdef::VK_KHR_maintenance2,VK_GRAPHICS_VERSION_1_1[]
  ...
  * [[VUID-VkRenderingInfo-pStencilAttachment-06099]]
    ...
    pname:pStencilAttachment->resolveImageLayout must: not be
    ename:VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_STENCIL_READ_ONLY_OPTIMAL
endif::VK_KHR_maintenance2,VK_GRAPHICS_VERSION_1_1[]
ifdef::VK_KHR_separate_depth_stencil_layouts,VK_GRAPHICS_VERSION_1_2[]
  ...
  * [[VUID-VkRenderingInfo-pStencilAttachment-07735]]
    ...
    ename:VK_IMAGE_LAYOUT_DEPTH_ATTACHMENT_OPTIMAL or
    ename:VK_IMAGE_LAYOUT_DEPTH_READ_ONLY_OPTIMAL
endif::VK_KHR_separate_depth_stencil_layouts,VK_GRAPHICS_VERSION_1_2[]
...
ifdef::VK_VALVE_fragment_density_map_layered[]
  * [[VUID-VkRenderingInfo-flags-10826]]
    ...
    ename:VK_RENDERING_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE, then
    pname:layerCount must: be less than or equal to
    <<limits-maxFragmentDensityMapLayers,
    pname:maxFragmentDensityMapLayers>>
  * [[VUID-VkRenderingInfo-fragmentDensityMapLayered-10827]]
    If the <<features-fragmentDensityMapLayered,
    pname:fragmentDensityMapLayered>> feature is not enabled, pname:flags
    must: not contain
    ename:VK_RENDERING_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE
...
ifdef::VK_KHR_maintenance7[]
    the <<features-maintenance7,pname:maintenance7>> feature is not enabled
    or the <<limits-robustFragmentShadingRateAttachmentAccess,
    pname:robustFragmentShadingRateAttachmentAccess>> limit is
    ename:VK_FALSE or the pname:imageView member of a
    slink:VkRenderingFragmentShadingRateAttachmentInfoKHR structure was
    created with slink:VkImageSubresourceRange::pname:baseMipLevel greater
    than 0,
...
ifdef::VK_KHR_maintenance7[]
    ...
    the pname:pNext chain contains a slink:VkDeviceGroupRenderPassBeginInfo
    structure, its pname:deviceRenderAreaCount member is not 0, and the
    pname:imageView member of a
    slink:VkRenderingFragmentShadingRateAttachmentInfoKHR structure included
    in the pname:pNext chain is not dlink:VK_NULL_HANDLE, pname:imageView
    must: have a width greater than or equal to
...
ifdef::VK_KHR_maintenance7[]
  ...
  * [[VUID-VkRenderingInfo-imageView-06123]]
    ...
    sname:VkRenderingInfo::pname:layerCount
  * [[VUID-VkRenderingInfo-imageView-06124]]
    If the pname:imageView member of a
    slink:VkRenderingFragmentShadingRateAttachmentInfoKHR structure included
    in the pname:pNext chain is not dlink:VK_NULL_HANDLE, and pname:viewMask
    is not `0`, pname:imageView must: have a pname:layerCount that is either
...
ifdef::VK_QCOM_multiview_per_view_render_areas[]
  ...
  * [[VUID-VkRenderingInfo-None-09044]]
    ...
    by this structure
ifdef::VK_EXT_nested_command_buffer,VK_KHR_maintenance7[]
  * [[VUID-VkRenderingInfo-flags-10012]]
    If pname:flags includes ename:VK_RENDERING_CONTENTS_INLINE_BIT_KHR then
    at least one of the following features must: be enabled
ifdef::VK_KHR_maintenance7[]
  ** <<features-maintenance7, pname:maintenance7>>
endif::VK_KHR_maintenance7[]
ifdef::VK_EXT_nested_command_buffer[]
  ** <<features-nestedCommandBuffer, pname:nestedCommandBuffer>>
endif::VK_EXT_nested_command_buffer[]
endif::VK_EXT_nested_command_buffer,VK_KHR_maintenance7[]
ifdef::VK_ANDROID_external_format_resolve[]
...
ifdef::VK_ARM_render_pass_striped[]
  * [[VUID-VkRenderingInfo-pNext-09535]]
    ...
    slink:VkRenderPassStripeBeginInfoARM::pname:pStripeInfos must: cover the
    pname:renderArea
...
ifdef::VK_ANDROID_external_format_resolve[]
    ...
    its pname:imageView member not set to dlink:VK_NULL_HANDLE, its
    pname:resolveMode member not set to ename:VK_RESOLVE_MODE_NONE, and
    pname:resolveImageView is not dlink:VK_NULL_HANDLE, then the
    pname:resolveImageView member of that element of pname:pColorAttachments
    must: have been created with the
  ...
  * [[VUID-VkRenderingInfo-pDepthAttachment-09482]]
    ...
    pname:pDepthAttachment->resolveMode is not ename:VK_RESOLVE_MODE_NONE,
    and pname:pDepthAttachment->resolveImageView is not
    dlink:VK_NULL_HANDLE, pname:pDepthAttachment->resolveImageView must:
  ...
  * [[VUID-VkRenderingInfo-pStencilAttachment-09484]]
    ...
    pname:pStencilAttachment->resolveMode is not ename:VK_RESOLVE_MODE_NONE,
    and pname:pStencilAttachment->resolveImageView is not
    dlink:VK_NULL_HANDLE, pname:pStencilAttachment->resolveImageView must:
    have been created with the
    <<resources-image-views-identity-mappings,identity swizzle>>
ifdef::VK_KHR_fragment_shading_rate[]
...
ifdef::VK_EXT_fragment_density_map[]
  * [[VUID-VkRenderingInfo-imageView-10643]]
    If the pname:imageView member of a
    slink:VkRenderingFragmentDensityMapAttachmentInfoEXT structure included
    in the pname:pNext chain is not dlink:VK_NULL_HANDLE,
    ename:VK_TILE_SHADING_RENDER_PASS_ENABLE_BIT_QCOM must: not be included
    in slink:VkRenderPassTileShadingCreateInfoQCOM::pname:flags
endif::VK_EXT_fragment_density_map[]
ifdef::VK_ANDROID_external_format_resolve[]
...
[open,refpage='VkRenderingFlagBits',desc='Bitmask specifying additional properties of a dynamic render pass instance',type='enums']
--
...
include::{generated}/api/enums/VkRenderingFlagBitsKHR.adoc[]
  ...
  * ename:VK_RENDERING_CONTENTS_SECONDARY_COMMAND_BUFFERS_BIT specifies that
    ...
    command buffers, and flink:vkCmdExecuteCommands is the only valid
    command in the command buffer until
ifdef::VK_KHR_maintenance10[]
    flink:vkCmdEndRendering2KHR or
endif::VK_KHR_maintenance10[]
...
ifdef::VK_EXT_nested_command_buffer,VK_KHR_maintenance7[]
  * ename:VK_RENDERING_CONTENTS_INLINE_BIT_KHR specifies that contents for
...
ifdef::VK_VALVE_fragment_density_map_layered[]
  * ename:VK_RENDERING_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE specifies that
    the render pass can: be used with layered fragment density maps.
endif::VK_VALVE_fragment_density_map_layered[]
ifdef::VK_KHR_maintenance10,VK_KHR_dynamic_rendering_local_read[]
  * ename:VK_RENDERING_LOCAL_READ_CONCURRENT_ACCESS_CONTROL_BIT_KHR
    specifies that
    ename:VK_RENDERING_ATTACHMENT_INPUT_ATTACHMENT_FEEDBACK_BIT_KHR will
    always be specified for any attachment which invokes the behavior
    described by <<rendering-attachment-input-attachment-feedback,that
    flag>>.
endif::VK_KHR_maintenance10,VK_KHR_dynamic_rendering_local_read[]
ifdef::VK_EXT_custom_resolve[]
  * ename:VK_RENDERING_FRAGMENT_REGION_BIT_EXT specifies that the render
    pass can: access samples which are not covered in its code:SampleMask.
  * ename:VK_RENDERING_CUSTOM_RESOLVE_BIT_EXT specifies that the render pass
    contains a custom resolve.
    When this bit is set, flink:vkCmdBeginCustomResolveEXT can: be called.
endif::VK_EXT_custom_resolve[]
...
[open,refpage='VkRenderingFlags',desc='Bitmask of VkRenderingFlagBits',type='flags']
--
...
[open,refpage='VkRenderingAttachmentInfo',desc='Structure specifying attachment information',type='structs']
--
...
If pname:resolveMode is not ename:VK_RESOLVE_MODE_NONE,
ifdef::VK_EXT_multisampled_render_to_single_sampled[]
<<multisampled-render-to-single-sampled,multisampled rendering to
single-sampled attachments>> is enabled, and pname:imageView has a sample
count of ename:VK_SAMPLE_COUNT_1_BIT, pname:resolveImageView must: be
dlink:VK_NULL_HANDLE.
Otherwise,
endif::VK_EXT_multisampled_render_to_single_sampled[]
pname:resolveImageView must: not be dlink:VK_NULL_HANDLE.

If pname:resolveMode is not ename:VK_RESOLVE_MODE_NONE, a
...
ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID, and the
...
undefined: at the time flink:vkCmdBeginCustomResolveEXT is called if all of
the following conditions are true:

  * ename:VK_RENDERING_CUSTOM_RESOLVE_BIT_EXT is set.
  * The attachment sets pname:resolveMode to
    ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT.

This affects color, depth, and stencil attachments.
In addition, there is an implicit <<renderpass-store-operations,store
operation>> of ename:VK_ATTACHMENT_STORE_OP_STORE for these attachments.
endif::VK_EXT_custom_resolve[]
...
flag.
ifdef::VK_EXT_custom_resolve[]
If the ename:VK_RENDERING_CUSTOM_RESOLVE_BIT_EXT is specified and an
attachment uses the ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT resolve mode, the
resolve attachment will only be written by draws recorded following a call
to flink:vkCmdBeginCustomResolveEXT.
endif::VK_EXT_custom_resolve[]
...
ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID, values in the
...
ifdef::VK_EXT_custom_resolve[ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT or]
ifdef::VK_ANDROID_external_format_resolve[ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID or]
...
+
pname:imageView must: not have a sample count of ename:VK_SAMPLE_COUNT_1_BIT
...
ifdef::VK_EXT_multisampled_render_to_single_sampled[]
  ...
  * [[VUID-VkRenderingAttachmentInfo-None-12256]]
    If all of the following are true:
  ** pname:imageView is not dlink:VK_NULL_HANDLE
  ** pname:imageView has a sample count of ename:VK_SAMPLE_COUNT_1_BIT
  ** the pname:pNext chain of slink:VkRenderingInfo includes a
     slink:VkMultisampledRenderToSingleSampledInfoEXT structure with the
     pname:multisampledRenderToSingleSampledEnable field equal to
     ename:VK_TRUE
  ** pname:storeOp is ename:VK_ATTACHMENT_STORE_OP_STORE

+
then pname:resolveMode must: not be ename:VK_RESOLVE_MODE_NONE
endif::VK_EXT_multisampled_render_to_single_sampled[]
  ...
  * [[VUID-VkRenderingAttachmentInfo-imageView-06865]]
    If all of the following are true:
  ** pname:imageView is not dlink:VK_NULL_HANDLE
  ** pname:resolveImageView is not dlink:VK_NULL_HANDLE
  ** pname:resolveMode is not ename:VK_RESOLVE_MODE_NONE
ifdef::VK_EXT_custom_resolve[]
  ** pname:resolveMode is not ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT
endif::VK_EXT_custom_resolve[]
ifdef::VK_ANDROID_external_format_resolve[]
  ** pname:resolveMode is not
     ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID
...
+
pname:imageView and pname:resolveImageView must: have the same
elink:VkFormat
...
ifdef::VK_EXT_zero_initialize_device_memory[ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT,]
  ...
  * [[VUID-VkRenderingAttachmentInfo-imageView-06136]]
    If pname:resolveImageView is not dlink:VK_NULL_HANDLE,
    pname:resolveImageLayout must: not be ename:VK_IMAGE_LAYOUT_UNDEFINED,
    ename:VK_IMAGE_LAYOUT_DEPTH_STENCIL_READ_ONLY_OPTIMAL,
    ename:VK_IMAGE_LAYOUT_SHADER_READ_ONLY_OPTIMAL,
    ename:VK_IMAGE_LAYOUT_TRANSFER_SRC_OPTIMAL,
ifdef::VK_EXT_zero_initialize_device_memory[ename:VK_IMAGE_LAYOUT_ZERO_INITIALIZED_EXT,]
...
ifdef::VK_KHR_separate_depth_stencil_layouts,VK_GRAPHICS_VERSION_1_2[]
  * [[VUID-VkRenderingAttachmentInfo-imageView-06137]]
    If pname:resolveImageView is not dlink:VK_NULL_HANDLE,
    pname:resolveImageLayout must: not be
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_synchronization2[]
  * [[VUID-VkRenderingAttachmentInfo-imageView-06142]]
    If pname:resolveImageView is not dlink:VK_NULL_HANDLE,
    pname:resolveImageLayout must: not be
    ename:VK_IMAGE_LAYOUT_READ_ONLY_OPTIMAL_KHR
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_synchronization2[]
ifdef::VK_KHR_fragment_shading_rate[]
...
ifdef::VK_EXT_attachment_feedback_loop_layout[]
  * [[VUID-VkRenderingAttachmentInfo-imageView-10780]]
    If <<renderpass-feedbackloop,feedback loop is enabled>> for the
    attachment identified by pname:imageView, then pname:imageView must:
    have been created with a pname:usage value including
    ename:VK_IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT, either
    ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT or
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT, and either
...
ifdef::VK_ANDROID_external_format_resolve[]
  * [[VUID-VkRenderingAttachmentInfo-externalFormatResolve-09323]]
    ...
    feature is not enabled, pname:resolveMode must: not be
    ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID
  ...
  * [[VUID-VkRenderingAttachmentInfo-resolveMode-09328]]
    If pname:resolveMode is
    ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID and
    <<limits-nullColorAttachmentWithExternalFormatResolve,
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkRenderingAttachmentInfo-resolveImageView-10728]]
    If pname:resolveImageView is not dlink:VK_NULL_HANDLE, the underlying
    resource must not be bound to a sname:VkDeviceMemory object allocated
    from a sname:VkMemoryHeap with the
...
ifdef::VK_KHR_maintenance10[]
  * [[VUID-VkRenderingAttachmentInfo-pNext-11752]]
    ...
    slink:VkRenderingAttachmentFlagsInfoKHR structure, and pname:flags
    includes
    ename:VK_RENDERING_ATTACHMENT_RESOLVE_SKIP_TRANSFER_FUNCTION_BIT_KHR or
    ename:VK_RENDERING_ATTACHMENT_RESOLVE_ENABLE_TRANSFER_FUNCTION_BIT_KHR,
    pname:imageView must: have a format using sRGB encoding
...
ifdef::VK_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  * [[VUID-VkRenderingAttachmentInfo-pNext-11754]]
    ...
    includes
    ename:VK_RENDERING_ATTACHMENT_INPUT_ATTACHMENT_FEEDBACK_BIT_KHR,
    pname:imageView must: have an image that was created with the
    ename:VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT usage flag set
endif::VK_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
endif::VK_KHR_maintenance10[]
  * [[VUID-VkRenderingAttachmentInfo-imageView-12470]]
    If pname:imageView is not dlink:VK_NULL_HANDLE, it must: have been
    created with a slink:VkImageViewCreateInfo::pname:viewType not equal to
    ename:VK_IMAGE_VIEW_TYPE_3D
  * [[VUID-VkRenderingAttachmentInfo-resolveImageView-12471]]
    If pname:resolveImageView is not dlink:VK_NULL_HANDLE, it must: have
    been created with a slink:VkImageViewCreateInfo::pname:viewType not
    equal to ename:VK_IMAGE_VIEW_TYPE_3D
  * [[VUID-VkRenderingAttachmentInfo-imageView-12486]]
    If pname:imageView is not dlink:VK_NULL_HANDLE it must: only specify a
    single mip level
  * [[VUID-VkRenderingAttachmentInfo-resolveImageView-12487]]
    If pname:resolveImageView is not dlink:VK_NULL_HANDLE it must: only
...
ifdef::VK_KHR_maintenance10[]
[open,refpage='VkRenderingAttachmentFlagsInfoKHR',desc='Structure specifying flags extending a rendering attachment',type='structs']
--
To specify an attachment as an _input attachment_ or to specify resolve
operation flags, the sname:VkRenderingAttachmentFlagsInfoKHR structure can:
be added to the pname:pNext chain of slink:VkRenderingAttachmentInfo.

The sname:VkRenderingAttachmentFlagsInfoKHR structure is defined as:

include::{generated}/api/structs/VkRenderingAttachmentFlagsInfoKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:flags is a bitmask of tlink:VkRenderingAttachmentFlagsKHR
...
ifdef::VK_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  ...
  * [[VUID-VkRenderingAttachmentFlagsInfoKHR-flags-11756]]
    ...
    ename:VK_RENDERING_ATTACHMENT_RESOLVE_SKIP_TRANSFER_FUNCTION_BIT_KHR,
    pname:flags must: not include
    ename:VK_RENDERING_ATTACHMENT_RESOLVE_ENABLE_TRANSFER_FUNCTION_BIT_KHR
...
include::{generated}/validity/structs/VkRenderingAttachmentFlagsInfoKHR.adoc[]
--

[open,refpage='VkRenderingAttachmentFlagBitsKHR',desc='Bitmask specifying additional properties of a rendering attachment',type='enums']
--
Bits which can: be set in
slink:VkRenderingAttachmentFlagsInfoKHR::pname:flags, describing additional
properties of a rendering attachment, are:

include::{generated}/api/enums/VkRenderingAttachmentFlagBitsKHR.adoc[]

[[rendering-attachment-input-attachment-feedback]]
  * ename:VK_RENDERING_ATTACHMENT_INPUT_ATTACHMENT_FEEDBACK_BIT_KHR
    ...
    ename:VK_DEPENDENCY_BY_REGION_BIT barrier separating the write
    attachment and input attachment usage.
    Using this flag does not remove the general requirement to use a
    ename:VK_DEPENDENCY_BY_REGION_BIT barrier to resolve hazards when two
    ...
    If ename:VK_RENDERING_LOCAL_READ_CONCURRENT_ACCESS_CONTROL_BIT_KHR is
...
[NOTE]
====
ename:VK_RENDERING_ATTACHMENT_INPUT_ATTACHMENT_FEEDBACK_BIT_KHR is intended
...
ename:VK_RENDERING_LOCAL_READ_CONCURRENT_ACCESS_CONTROL_BIT_KHR if
<<features-maintenance10,pname:maintenance10>> is available and they use
feedback loops with apiext:VK_KHR_dynamic_rendering_local_read.
...
[open,refpage='VkRenderingAttachmentFlagsKHR',desc='Bitmask of VkRenderingAttachmentFlagBitsKHR',type='flags']
--
include::{generated}/api/flags/VkRenderingAttachmentFlagsKHR.adoc[]

tname:VkRenderingAttachmentFlagsKHR is a bitmask type for setting a mask of
zero or more elink:VkRenderingAttachmentFlagBitsKHR.
--

endif::VK_KHR_maintenance10[]

ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]
ifdef::VK_KHR_unified_image_layouts+VK_EXT_attachment_feedback_loop_layout[]
[open,refpage='VkAttachmentFeedbackLoopInfoEXT',desc='Structure specifying whether feedback loop is enabled for an attachment',type='structs']
--
To <<renderpass-feedbackloop,enable feedback loop>> for an attachment, the
sname:VkAttachmentFeedbackLoopInfoEXT structure can: be added to the
pname:pNext chain of slink:VkRenderingAttachmentInfo.

The sname:VkAttachmentFeedbackLoopInfoEXT structure is defined as:

include::{generated}/api/structs/VkAttachmentFeedbackLoopInfoEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:feedbackLoopEnable specifies that
    <<renderpass-feedbackloop,feedback loop is enabled>> for the attachment
    identified by slink:VkRenderingAttachmentInfo::pname:imageView.
...
****
  * [[VUID-VkAttachmentFeedbackLoopInfoEXT-unifiedImageLayouts-10782]]
    ...
    feature is not enabled, pname:feedbackLoopEnable must: be ename:VK_FALSE
****

include::{generated}/validity/structs/VkAttachmentFeedbackLoopInfoEXT.adoc[]
--
endif::VK_KHR_unified_image_layouts+VK_EXT_attachment_feedback_loop_layout[]
...
****
  ...
  * [[VUID-VkRenderingFragmentDensityMapAttachmentInfoEXT-imageView-06158]]
    If pname:imageView is not dlink:VK_NULL_HANDLE, it must: have been
    created with the ename:VK_IMAGE_USAGE_FRAGMENT_DENSITY_MAP_BIT_EXT usage
    flag set
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
[open,refpage='vkGetRenderingAreaGranularity',desc='Returns the granularity for dynamic rendering optimal render area',type='protos']
--
To query the render area granularity for a render pass instance, call:

ifdef::VK_GRAPHICS_VERSION_1_4[]
include::{generated}/api/protos/vkGetRenderingAreaGranularity.adoc[]
...
include::{generated}/api/protos/vkGetRenderingAreaGranularityKHR.adoc[]
  ...
  * pname:pRenderingAreaInfo is a pointer to a slink:VkRenderingAreaInfo
...
include::{generated}/validity/protos/vkGetRenderingAreaGranularity.adoc[]
--

[open,refpage='VkRenderingAreaInfo',desc='Structure describing rendering area granularity query info',type='structs']
--
The sname:VkRenderingAreaInfo structure is defined as:

include::{generated}/api/structs/VkRenderingAreaInfo.adoc[]
...
include::{generated}/validity/structs/VkRenderingAreaInfo.adoc[]
--
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
...
[open,refpage='VkRenderPassPerformanceCountersByRegionBeginInfoARM',desc='Structure specifying per region performance counters',type='structs']
--
The sname:VkRenderPassPerformanceCountersByRegionBeginInfoARM structure is
defined as:

include::{generated}/api/structs/VkRenderPassPerformanceCountersByRegionBeginInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:counterAddressCount is the number of entries in the
    pname:pCounterAddresses array.
  * pname:pCounterAddresses is a pointer to an array of
    basetype:VkDeviceAddress where performance counter data will be written.
  * pname:serializeRegions controls whether the implementation serializes
    the execution of each region.
  * pname:counterIndexCount is the number of entries in the
    pname:pCounterIndices array.
  * pname:pCounterIndices is a pointer to an array of
    slink:VkPerformanceCounterARM::pname:counterID values, as enumerated by
    flink:vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM,
    to enable in this render pass instance.

Performance counters values are written to each element of
pname:pCounterAddresses in an implementation-dependent manner.
...
where pname:s is the physical subpass index, pname:L is the maximum number
of
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_multiview[views or]
layers in the current render pass instance, and pname:l is the index of the
current
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_multiview[view or]
layer.
...
[NOTE]
====
The `apiext:VK_EXT_subpass_merge_feedback` extension can be used to
...
in slink:VkRenderPassSubpassFeedbackInfoEXT.
====
endif::VK_EXT_subpass_merge_feedback[]

Within each element of pname:pCounterAddresses, counter values are written
in framebuffer-space order if
slink:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM::pname:identityTransformOrder
is ename:VK_TRUE.
...
****
  * [[VUID-VkRenderPassPerformanceCountersByRegionBeginInfoARM-counterAddressCount-11815]]
    pname:counterAddressCount must: be equal to [eq]#S {times} L#, where S
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_multiview[]
  ...
  * [[VUID-VkRenderPassPerformanceCountersByRegionBeginInfoARM-pCounterAddresses-11816]]
    For each element of pname:pCounterAddresses that is not `0`, if the
  ...
  * [[VUID-VkRenderPassPerformanceCountersByRegionBeginInfoARM-pCounterAddresses-11817]]
    For each element of pname:pCounterAddresses[i], all device addresses
    between pname:pCounterAddresses[i] and pname:pCounterAddresses[i] plus N -
    1, must: be in the buffer device address range of the same buffer, where
    N is given by latexmath:[N = \mathbin{align}\left(\left\lceil w/rsw
    \right\rceil \times \mathbin{align}\left(c \times sizeof(uint32\_t),
    ra\right), rsa\right) \times \left\lceil h/rsh \right\rceil], where
    pname:w is the value of
    slink:VkRenderingInfo::pname:renderArea.extent.width, pname:h is the
    value of slink:VkRenderingInfo::pname:renderArea.extent.height,
    pname:rsw is the value of
    slink:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM::pname:performanceCounterRegionSize.width,
    pname:rsh is the value of
    slink:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM::pname:performanceCounterRegionSize.height,
    pname:c is the value of pname:counterIndexCount, pname:ra is the value
    of
    slink:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM::pname:regionAlignment,
    and pname:rsa is the value of
    slink:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM::pname:rowStrideAlignment
  * [[VUID-VkRenderPassPerformanceCountersByRegionBeginInfoARM-counterIndexCount-11818]]
    pname:counterIndexCount must: be less than or equal to
    slink:VkPhysicalDevicePerformanceCountersByRegionPropertiesARM::pname:maxPerRegionPerformanceCounters
****


include::{generated}/validity/structs/VkRenderPassPerformanceCountersByRegionBeginInfoARM.adoc[]
--
endif::VK_ARM_performance_counters_by_region[]

ifdef::VK_EXT_custom_resolve[]
[open,refpage='vkCmdBeginCustomResolveEXT',desc='Begins a shader resolve operation',type='protos']
--
To begin resolving attachments using render pass draws, call:

include::{generated}/api/protos/vkCmdBeginCustomResolveEXT.adoc[]

  * pname:commandBuffer is the command buffer in which to record the
    command.
  * pname:pBeginCustomResolveInfo is an optional struct with which to extend
    functionality.

Following this call, any pname:resolveImageView with pname:resolveMode set
to ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT will be written by outputs which
would otherwise have written to the pname:imageView image until the end of
the current render pass instance.

ifdef::VK_EXT_fragment_density_map[]
Following this call, the fragment area may: be reduced to [eq]#(1,1)# if a
...
same (x, y, layer,
ifdef::VK_KHR_multiview,VK_GRAPHICS_VERSION_1_1[view,]
...
****
  ...
  * [[VUID-vkCmdBeginCustomResolveEXT-None-11518]]
    flink:vkCmdBeginCustomResolveEXT must: not have already been recorded in
    the current render pass instance
  ...
  * [[VUID-vkCmdBeginCustomResolveEXT-None-11520]]
    ...
    ename:VK_RENDERING_SUSPENDING_BIT
****

include::{generated}/validity/protos/vkCmdBeginCustomResolveEXT.adoc[]
--

[open,refpage='VkBeginCustomResolveInfoEXT',desc='Structure specifying shader resolve information',type='structs']
--
The sname:VkBeginCustomResolveInfoEXT structure is defined as:

include::{generated}/api/structs/VkBeginCustomResolveInfoEXT.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.

include::{generated}/validity/structs/VkBeginCustomResolveInfoEXT.adoc[]
--
endif::VK_EXT_custom_resolve[]

[open,refpage='vkCmdEndRendering',desc='End a dynamic render pass instance',type='protos']
--
...
[[renderpass-multipassordering]]
// tag::multipassorderingnote[]
[NOTE]
====
...
<<primsrast-order,rasterization order>> between multiple render passes with
...
ifdef::VK_EXT_fragment_density_map_offset,VK_KHR_maintenance10[]
[open,refpage='vkCmdEndRendering2KHR',desc='End a dynamic render pass instance',type='protos']
--
To end a render pass instance, call:

ifdef::VK_KHR_maintenance10[]
include::{generated}/api/protos/vkCmdEndRendering2KHR.adoc[]
endif::VK_KHR_maintenance10[]

ifdef::VK_EXT_fragment_density_map_offset[]
include::{generated}/api/protos/vkCmdEndRendering2EXT.adoc[]
endif::VK_EXT_fragment_density_map_offset[]

  * pname:commandBuffer is the command buffer in which to record the
    command.
  * pname:pRenderingEndInfo is `NULL` or a pointer to a
    slink:VkRenderingEndInfoKHR structure containing information about how
...
include::{chapters}/renderpass.adoc[tag=multipassorderingnote]
...
include::{generated}/validity/protos/vkCmdEndRendering2KHR.adoc[]
--

[open,refpage='VkRenderingEndInfoKHR',desc='Structure specifying render pass end information',type='structs']
--
The sname:VkRenderingEndInfoKHR structure is defined as:

include::{generated}/api/structs/VkRenderingEndInfoKHR.adoc[]

ifdef::VK_EXT_fragment_density_map_offset[]
include::{generated}/api/structs/VkRenderingEndInfoEXT.adoc[]
endif::VK_EXT_fragment_density_map_offset[]
...
include::{generated}/validity/structs/VkRenderingEndInfoKHR.adoc[]
--
endif::VK_EXT_fragment_density_map_offset,VK_KHR_maintenance10[]
...
include::{generated}/api/structs/VkTilePropertiesQCOM.adoc[]
  ...
  * pname:apronSize is the dimension of the
    <<renderpass-tile-shading-aprons,apron>>.
...
ifdef::VK_QCOM_tile_shading[]
The pname:tileSize is guaranteed to be a multiple of
<<limits-tileGranularity,pname:tileGranularity>>.
endif::VK_QCOM_tile_shading[]
...
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
perform _shader resolve operations_ to _color_attachments_ or
_depth/stencil_attachments_,
endif::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
...
include::{generated}/api/structs/VkRenderPassCreateInfo.adoc[]
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
ifndef::VK_QCOM_render_pass_transform,VK_VALVE_fragment_density_map_layered[]
  * pname:flags is reserved for future use.
endif::VK_QCOM_render_pass_transform,VK_VALVE_fragment_density_map_layered[]
ifdef::VK_QCOM_render_pass_transform,VK_VALVE_fragment_density_map_layered[]
...
ifdef::VK_VALVE_fragment_density_map_layered[]
  * [[VUID-VkRenderPassCreateInfo-fragmentDensityMapLayered-10828]]
    ...
    pname:fragmentDensityMapLayered>> feature is not enabled, pname:flags
    must: not contain
    ename:VK_RENDER_PASS_CREATE_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE
endif::VK_VALVE_fragment_density_map_layered[]
endif::VK_EXT_fragment_density_map[]
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_multiview[]
  ...
  * [[VUID-VkRenderPassCreateInfo-pNext-02512]]
    If the pname:pNext chain includes a
    slink:VkRenderPassMultiviewCreateInfo structure, for each element of
  ...
  * [[VUID-VkRenderPassCreateInfo-pDependencies-00837]]
    For each element of pname:pDependencies, if the pname:srcSubpass is not
    ename:VK_SUBPASS_EXTERNAL, all stage flags included in the
    pname:srcStageMask member of that dependency must: be
    ename:VK_PIPELINE_STAGE_ALL_COMMANDS_BIT or a pipeline stage supported
    by the <<synchronization-pipeline-stages-types, pipeline>> identified by
    the pname:pipelineBindPoint member of the source subpass
  * [[VUID-VkRenderPassCreateInfo-pDependencies-00838]]
    For each element of pname:pDependencies, if the pname:dstSubpass is not
    ename:VK_SUBPASS_EXTERNAL, all stage flags included in the
    pname:dstStageMask member of that dependency must: be
    ename:VK_PIPELINE_STAGE_ALL_COMMANDS_BIT or a pipeline stage supported
    by the <<synchronization-pipeline-stages-types, pipeline>> identified by
    the pname:pipelineBindPoint member of the destination subpass
  * [[VUID-VkRenderPassCreateInfo-pDependencies-06866]]
    For each element of pname:pDependencies, if its pname:srcSubpass is not
    ename:VK_SUBPASS_EXTERNAL, it must: be less than pname:subpassCount
  * [[VUID-VkRenderPassCreateInfo-pDependencies-06867]]
    For each element of pname:pDependencies, if its pname:dstSubpass is not
    ename:VK_SUBPASS_EXTERNAL, it must: be less than pname:subpassCount
...
ifdef::VK_EXT_mesh_shader[<<features-multiviewMeshShader, mesh shaders>>,]
...
respectively.
If the `apiext:VK_NV_viewport_array2` extension is not supported and
enabled, code:ViewportMaskPerViewNV must: not be used.
...
an input attachment at the fragment's [eq]#(x~f~,y~f~)# framebuffer
...
ename:VK_SUBPASS_DESCRIPTION_CUSTOM_RESOLVE_BIT_EXT, and if
endif::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
...
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
pname:flags does not include
ename:VK_SUBPASS_DESCRIPTION_CUSTOM_RESOLVE_BIT_EXT, and
endif::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
slink:VkSubpassDescriptionDepthStencilResolve::pname:pDepthStencilResolveAttachment
...
ifdef::VK_EXT_fragment_density_map+VK_EXT_custom_resolve[]
Following this call, if the <<features-customResolve, pname:customResolve>>
feature is enabled the fragment area may: be reduced to [eq]#(1,1)# if a
...
fragment area.
endif::VK_EXT_fragment_density_map+VK_EXT_custom_resolve[]
...
are true:
  ...
  * ename:VK_SUBPASS_DESCRIPTION_CUSTOM_RESOLVE_BIT_EXT is set.
...
ename:VK_PIPELINE_STAGE_COLOR_ATTACHMENT_OUTPUT_BIT pipeline stage, with any
image accesses performed via ename:VK_ACCESS_INPUT_ATTACHMENT_READ_BIT,
...
the ename:VK_PIPELINE_STAGE_EARLY_FRAGMENT_TESTS_BIT or
ename:VK_PIPELINE_STAGE_LATE_FRAGMENT_TESTS_BIT pipeline stage, with any
image accesses performed via ename:VK_ACCESS_INPUT_ATTACHMENT_READ_BIT,
...
starting with subpass *S~1~* if all subpasses in each chain use or preserve
the attachment.
...
+
all attachments in pname:pDepthStencilAttachment and pname:pColorAttachments
...
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
  ...
  * [[VUID-VkSubpassDescription-flags-03343]]
    If pname:flags includes
    ename:VK_SUBPASS_DESCRIPTION_CUSTOM_RESOLVE_BIT_EXT, then the subpass
...
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
  * ename:VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_EXT specifies that the
    ...
    shader invocation.
  * ename:VK_SUBPASS_DESCRIPTION_CUSTOM_RESOLVE_BIT_EXT specifies that the
...
ifdef::VK_QCOM_tile_shading[]
  * ename:VK_SUBPASS_DESCRIPTION_TILE_SHADING_APRON_BIT_QCOM specifies that
    <<renderpass-tile-shading-aprons,apron regions>> can: be read within
    this subpass when <<renderpass-tile-shading,tile shading is enabled>>.
endif::VK_QCOM_tile_shading[]

ifndef::VK_NVX_multiview_per_view_attributes,VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
[NOTE]
====
All bits for this type are defined by extensions, and none of those
extensions are enabled in this build of the specification.
====
endif::VK_NVX_multiview_per_view_attributes,VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
...
or
ename:VK_SUBPASS_DESCRIPTION_RASTERIZATION_ORDER_ATTACHMENT_STENCIL_ACCESS_BIT_EXT
for render pass instances begun with flink:vkCmdBeginRendering.
...
include::{generated}/api/structs/VkSubpassDependency.adoc[]
  ...
  * pname:srcStageMask is a bitmask of elink:VkPipelineStageFlagBits
    ...
    mask>>.
    If set to ename:VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, it is equivalent to
    setting it to ename:VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT.
  * pname:dstStageMask is a bitmask of elink:VkPipelineStageFlagBits
    ...
    stage mask>> If set to ename:VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, it is
    equivalent to setting it to ename:VK_PIPELINE_STAGE_ALL_GRAPHICS_BIT.
...
ifdef::VK_KHR_maintenance8[]
  * [[VUID-VkSubpassDependency-dependencyFlags-10203]]
    pname:dependencyFlags must: not include
...
ifndef::VK_BASE_VERSION_1_3,VK_KHR_synchronization2[]
...
the <<features-maintenance9, pname:maintenance9>> feature is not enabled,
and
...
<<features-maintenance9, pname:maintenance9>> feature is enabled, layout
...
[open,refpage='vkCreateRenderPass2',desc='Create a new render pass object',type='protos']
--
...
[open,refpage='VkRenderPassCreateInfo2',desc='Structure specifying parameters of a newly created render pass',type='structs']
--
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
  ...
  * [[VUID-VkRenderPassCreateInfo2-pDependencies-03060]]
    For each element of pname:pDependencies where its pname:srcSubpass
    member equals its pname:dstSubpass member, if the pname:viewMask member
    of the corresponding element of pname:pSubpasses includes more than one
    bit, its pname:dependencyFlags member must: include
    ename:VK_DEPENDENCY_VIEW_LOCAL_BIT
...
[open,refpage='VkAttachmentDescription2',desc='Structure specifying an attachment description',type='structs']
--
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_separate_depth_stencil_layouts[]
[open,refpage='VkAttachmentDescriptionStencilLayout',desc='Structure specifying an attachment description',type='structs']
--
...
[open,refpage='VkSubpassDescription2',desc='Structure specifying a subpass description',type='structs']
--
...
ifdef::VK_ANDROID_external_format_resolve[]
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09335]]
    If the <<features-externalFormatResolve,pname:externalFormatResolve>>
    feature is not enabled and pname:pResolveAttachments is not `NULL`, for
    each resolve attachment that does not have the value
    ename:VK_ATTACHMENT_UNUSED, the corresponding color attachment must: not
    have the value ename:VK_ATTACHMENT_UNUSED
  ...
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09338]]
    If the <<features-externalFormatResolve,pname:externalFormatResolve>>
    feature is not enabled and pname:pResolveAttachments is not `NULL`, for
    each resolve attachment that is not ename:VK_ATTACHMENT_UNUSED, the
    corresponding color attachment must: not have a sample count of
    ename:VK_SAMPLE_COUNT_1_BIT
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09339]]
    If the <<features-externalFormatResolve,pname:externalFormatResolve>>
    feature is not enabled, each element of pname:pResolveAttachments must:
    have the same elink:VkFormat as its corresponding color attachment
endif::VK_ANDROID_external_format_resolve[]
ifdef::VK_EXT_multisampled_render_to_single_sampled[]
...
features>> contain at least ename:VK_FORMAT_FEATURE_COLOR_ATTACHMENT_BIT or
ename:VK_FORMAT_FEATURE_DEPTH_STENCIL_ATTACHMENT_BIT
...
ifdef::VK_ANDROID_external_format_resolve[]
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09344]]
    If the <<features-externalFormatResolve,pname:externalFormatResolve>>
    feature is enabled, pname:pResolveAttachments is not `NULL`, and
    pname:colorAttachmentCount is not `1`, any element of
    pname:pResolveAttachments that is not ename:VK_ATTACHMENT_UNUSED, must:
    not have a format of ename:VK_FORMAT_UNDEFINED
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09345]]
    If the <<features-externalFormatResolve,pname:externalFormatResolve>>
    feature is enabled, pname:pResolveAttachments is not `NULL`, any element
    of pname:pResolveAttachments is not ename:VK_ATTACHMENT_UNUSED and has a
  ...
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09346]]
    If the <<features-externalFormatResolve,pname:externalFormatResolve>>
    feature is enabled, pname:pResolveAttachments is not `NULL`, and any
    element of pname:pResolveAttachments is not ename:VK_ATTACHMENT_UNUSED
    and has a format of ename:VK_FORMAT_UNDEFINED, pname:viewMask must: be
    `0`
ifdef::VK_KHR_fragment_shading_rate[]
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09347]]
    ...
    feature is enabled, pname:pResolveAttachments is not `NULL`, and any
    element of pname:pResolveAttachments is not ename:VK_ATTACHMENT_UNUSED
    and has a format of ename:VK_FORMAT_UNDEFINED,
  ...
  * [[VUID-VkSubpassDescription2-externalFormatResolve-09348]]
    ...
    feature is enabled, pname:pResolveAttachments is not `NULL`, and any
    element of pname:pResolveAttachments is not ename:VK_ATTACHMENT_UNUSED
    and has a format of ename:VK_FORMAT_UNDEFINED, elements of
    pname:pInputAttachments referencing either a color attachment or resolve
    attachment used in this subpass must: not include
    `VK_IMAGE_ASPECT_PLANE__{ibit}__BIT` for any index _i_ in its
    pname:aspectMask
endif::VK_ANDROID_external_format_resolve[]
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
  * [[VUID-VkSubpassDescription2-flags-04907]]
    ...
    pname:pResolveAttachments is not `NULL`, then each resolve attachment
    must: be ename:VK_ATTACHMENT_UNUSED
  * [[VUID-VkSubpassDescription2-flags-04908]]
    If pname:flags includes
    ename:VK_SUBPASS_DESCRIPTION_CUSTOM_RESOLVE_BIT_EXT, and if
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
[open,refpage='VkSubpassDescriptionDepthStencilResolve',desc='Structure specifying depth/stencil resolve operations for a subpass',type='structs']
--
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[or slink:VkRenderingInfo]
...
[open,refpage='VkAttachmentReference2',desc='Structure specifying an attachment reference',type='structs']
--
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_separate_depth_stencil_layouts[]
[open,refpage='VkAttachmentReferenceStencilLayout',desc='Structure specifying an attachment description',type='structs']
--
...
[open,refpage='VkSubpassDependency2',desc='Structure specifying a subpass dependency',type='structs']
--
...
If either pname:srcStageMask or pname:dstStageMask are set to
ename:VK_PIPELINE_STAGE_ALL_COMMANDS_BIT, it is equivalent to setting
...
sample count, or are both ename:VK_ATTACHMENT_UNUSED.
...
reference is treated as ename:VK_ATTACHMENT_UNUSED.
...
slink:VkRenderPassAttachmentBeginInfoKHR::pname:pAttachments,
endif::VK_KHR_imageless_framebuffer[]
the pname:aspectMask is ignored.
...
ifdef::VK_VALVE_fragment_density_map_layered[]
  * [[VUID-VkFramebufferCreateInfo-renderPass-10830]]
    ...
    ename:VK_RENDER_PASS_CREATE_PER_LAYER_FRAGMENT_DENSITY_BIT_VALVE, then
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkFramebufferCreateInfo-pAttachments-12327]]
    ...
    element of pname:pAttachments that is used as a resolve attachment by
    pname:renderPass must: not be bound to a sname:VkDeviceMemory object
...
ifdef::VK_KHR_maintenance7[]
    ...
    an element of pname:pAttachments that is used as a
    <<primsrast-fragment-shading-rate-attachment, fragment shading rate
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance1[]
...
endif::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance1[]
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_imageless_framebuffer[]
...
ifdef::VK_KHR_maintenance7[]
  ...
  * [[VUID-VkFramebufferCreateInfo-flags-04587]]
    ...
    pname:renderPass was specified with non-zero view masks, the
    pname:layerCount member of any element of the
    pname:pAttachmentImageInfos member of a
    slink:VkFramebufferAttachmentsCreateInfo structure in the pname:pNext
    chain that is used as a <<primsrast-fragment-shading-rate-attachment,
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_imageless_framebuffer[]
[open,refpage='VkFramebufferAttachmentsCreateInfo',desc='Structure specifying parameters of images that will be used with a framebuffer',type='structs']
--
...
[open,refpage='VkFramebufferAttachmentImageInfo',desc='Structure specifying parameters of an image that will be used with a framebuffer',type='structs']
--
...
[[renderpass-effective-attachment-image-create]]
...
[[renderpass-effective-attachment-image-usage]]
...
by slink:VkImageUsageFlags2CreateInfoKHR::pname:flags.
endif::VK_KHR_extended_flags[]
...
ifndef::VK_GRAPHICS_VERSION_1_2,VK_KHR_imageless_framebuffer[]
[NOTE]
====
All bits for this type are defined by extensions, and none of those
extensions are enabled in this build of the specification.
...
In a render pass object with multiple <<renderpass-subpass,subpasses>>, load
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
This does not apply when using ename:VK_ATTACHMENT_LOAD_OP_NONE.
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
====
...
ifdef::VK_KHR_maintenance7[]
if the <<features-maintenance7,maintenance7>> feature is not enabled or
<<limits-separateDepthStencilAttachmentAccess,pname:separateDepthStencilAttachmentAccess>>
is ename:VK_FALSE,
endif::VK_KHR_maintenance7[]
...
<<renderpass-feedbackloop,feedback loop enabled>>, implementations must: not
...
include::{generated}/api/enums/VkAttachmentLoadOp.adoc[]
  ...
  * ename:VK_ATTACHMENT_LOAD_OP_DONT_CARE specifies that the previous
    ...
    ename:VK_ACCESS_COLOR_ATTACHMENT_WRITE_BIT.
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none[]
  * ename:VK_ATTACHMENT_LOAD_OP_NONE specifies that the previous contents of
...
In a render pass object with multiple <<renderpass-subpass,subpasses>>,
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_KHR_dynamic_rendering,VK_QCOM_render_pass_store_ops[]
This does not apply when using ename:VK_ATTACHMENT_STORE_OP_NONE.
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_KHR_dynamic_rendering,VK_QCOM_render_pass_store_ops[]
====
...
[NOTE]
====
Because ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT specifies that the attachment
will be resolved by shaders in the render pass instead of fixed-function
operations, resolve operations with ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT do
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
[open,refpage='VkResolveModeFlagBits',desc='Bitmask indicating supported depth and stencil resolve modes',type='enums']
--
...
include::{generated}/api/enums/VkResolveModeFlagBitsKHR.adoc[]
  ...
  * ename:VK_RESOLVE_MODE_NONE specifies that no resolve operation is done.
  * ename:VK_RESOLVE_MODE_SAMPLE_ZERO_BIT specifies that result of the
    resolve operation is equal to the value of sample 0.
  * ename:VK_RESOLVE_MODE_AVERAGE_BIT specifies that result of the resolve
    operation is the average of the sample values.
  * ename:VK_RESOLVE_MODE_MIN_BIT specifies that result of the resolve
    operation is the minimum of the sample values.
  * ename:VK_RESOLVE_MODE_MAX_BIT specifies that result of the resolve
    operation is the maximum of the sample values.
ifdef::VK_ANDROID_external_format_resolve[]
  * ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID specifies
    that rather than a multisample resolve, a single sampled color
    attachment will be downsampled into a {YCbCr} format image specified by
    ...
    according to
    slink:VkPhysicalDeviceExternalFormatResolvePropertiesANDROID::pname:externalFormatResolveChromaOffsetX,
    slink:VkPhysicalDeviceExternalFormatResolvePropertiesANDROID::pname:externalFormatResolveChromaOffsetY,
    and the chroma sample rate of the resolved image.
endif::VK_ANDROID_external_format_resolve[]
ifdef::VK_EXT_custom_resolve[]
  * ename:VK_RESOLVE_MODE_CUSTOM_BIT_EXT specifies that the attachment will
...
If ename:VK_RESOLVE_MODE_AVERAGE_BIT is used, and the source format is a
...
If the <<formats-numericformat, numeric format>> of the resolve attachment
...
EOTF`" section of the <<data-format,Khronos Data Format Specification>>.
...
etext:VK_*_RESOLVE_{SKIP,ENABLE}_TRANSFER_FUNCTION_BIT_KHR flag usage.
endif::VK_KHR_maintenance10[]
...
ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID; applications
...
[open,refpage='VkResolveModeFlags',desc='Bitmask of VkResolveModeFlagBits',type='flags']
--
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance2[]
    ...
    created with the ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT usage
    flag set
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_maintenance2[]
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_separate_depth_stencil_layouts[]
  ...
  * [[VUID-vkCmdBeginRenderPass-initialLayout-00897]]
    ...
    then the corresponding attachment image view of the framebuffer
    specified in the pname:framebuffer member of pname:pRenderPassBegin
    must: have been created with the ename:VK_IMAGE_USAGE_SAMPLED_BIT or
  ...
  * [[VUID-vkCmdBeginRenderPass-initialLayout-00898]]
    ...
    then the corresponding attachment image view of the framebuffer
    specified in the pname:framebuffer member of pname:pRenderPassBegin
    must: have been created with the ename:VK_IMAGE_USAGE_TRANSFER_SRC_BIT
    usage flag set
  * [[VUID-vkCmdBeginRenderPass-initialLayout-00899]]
    ...
    then the corresponding attachment image view of the framebuffer
    specified in the pname:framebuffer member of pname:pRenderPassBegin
    must: have been created with the ename:VK_IMAGE_USAGE_TRANSFER_DST_BIT
    usage flag set
...
ifdef::VK_EXT_attachment_feedback_loop_layout[]
  * [[VUID-vkCmdBeginRenderPass-initialLayout-07000]]
    ...
    corresponding attachment image view of the framebuffer specified in the
    pname:framebuffer member of pname:pRenderPassBegin must: have been
    created with either the ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT or
  ...
  * [[VUID-vkCmdBeginRenderPass-initialLayout-07001]]
    ...
    corresponding attachment image view of the framebuffer specified in the
    pname:framebuffer member of pname:pRenderPassBegin must: have been
    created with the ename:VK_IMAGE_USAGE_ATTACHMENT_FEEDBACK_LOOP_BIT_EXT
    usage flag set
endif::VK_EXT_attachment_feedback_loop_layout[]
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  * [[VUID-vkCmdBeginRenderPass-initialLayout-09537]]
    ...
    the sname:VkAttachmentReference structures specified when creating the
    render pass specified in the pname:renderPass member of
    pname:pRenderPassBegin is ename:VK_IMAGE_LAYOUT_RENDERING_LOCAL_READ
    then the corresponding attachment image view of the framebuffer
    specified in the pname:framebuffer member of pname:pRenderPassBegin
    must: have been created with either the ename:VK_IMAGE_USAGE_STORAGE_BIT
    usage flag set, or both the ename:VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT
    and either of ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT or
...
ifdef::VK_EXT_nested_command_buffer,VK_KHR_maintenance7[]
  * [[VUID-vkCmdBeginRenderPass-contents-09640]]
    ...
    ename:VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_KHR, then
    at least one of the following features must: be enabled:
ifdef::VK_KHR_maintenance7[]
  ** <<features-maintenance7, pname:maintenance7>>
endif::VK_KHR_maintenance7[]
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_create_renderpass2[]
[open,refpage='vkCmdBeginRenderPass2',desc='Begin a new render pass',type='protos']
--
...
include::{generated}/api/protos/vkCmdBeginRenderPass2KHR.adoc[]
  ...
  * pname:pRenderPassBegin is a pointer to a slink:VkRenderPassBeginInfo
    ...
    accessed at any point that pname:commandBuffer is in the recording or
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  * [[VUID-vkCmdBeginRenderPass2-initialLayout-09538]]
    ...
    must: have been created with either the ename:VK_IMAGE_USAGE_STORAGE_BIT
    usage flag set, or both the ename:VK_IMAGE_USAGE_INPUT_ATTACHMENT_BIT
    and either of the ename:VK_IMAGE_USAGE_COLOR_ATTACHMENT_BIT or
    ename:VK_IMAGE_USAGE_DEPTH_STENCIL_ATTACHMENT_BIT usage flags set
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
ifdef::VK_QCOM_tile_shading[]
  * [[VUID-vkCmdBeginRenderPass2-flags-10652]]
    If ename:VK_TILE_SHADING_RENDER_PASS_ENABLE_BIT_QCOM was included in the
    slink:VkRenderPassTileShadingCreateInfoQCOM::pname:flags used to create
    the pname:renderPass, pname:commandBuffer must: not have been recorded
...
<<features-multiviewPerViewRenderAreas, pname:multiviewPerViewRenderAreas>>
feature is enabled, and there is an instance of
slink:VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM included in the
pname:pNext chain with pname:perViewRenderAreaCount not equal to `0`, then
the elements of
slink:VkMultiviewPerViewRenderAreasRenderPassBeginInfoQCOM::pname:pPerViewRenderAreas
override pname:renderArea and define a render area for each view.
In this case, pname:renderArea must: be an area at least as large as the
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_imageless_framebuffer[]
  ...
  * [[VUID-VkRenderPassBeginInfo-framebuffer-03209]]
    ...
    used to create pname:framebuffer
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkRenderPassBeginInfo-framebuffer-12328]]
    If pname:framebuffer was created with a
    slink:VkFramebufferCreateInfo::pname:flags value that included
    ename:VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT, each pname:pAttachments
    member of slink:VkRenderPassAttachmentBeginInfo that is used as a
    resolve attachment by pname:renderPass must: not be bound to a
    sname:VkDeviceMemory object allocated from a sname:VkMemoryHeap with the
    ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM property
endif::VK_QCOM_tile_memory_heap[]
...
ifdef::VK_QCOM_tile_memory_heap[]
ifdef::VK_QCOM_tile_properties[]
[open,refpage='VkTileMemorySizeInfoQCOM',desc='Structure describing tile memory size in use in a render pass instance',type='structs']
--
The tile properties queried using apiext:VK_QCOM_tile_properties depend on
the size of the reserved tile memory by the application.
This size can: be specified by the following structure to
slink:VkRenderPassCreateInfo, slink:VkRenderPassCreateInfo2
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[, or slink:VkRenderingInfo]
...
pname:pNext member of slink:VkRenderingInfo passed to
flink:vkGetDynamicRenderingTilePropertiesQCOM.
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[]

The sname:VkTileMemorySizeInfoQCOM structure is defined as:

include::{generated}/api/structs/VkTileMemorySizeInfoQCOM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:size is the size in bytes of tile memory used by the render pass
    or preserved for later use.

The returned tile properties are invalid if the pname:size is not equal to
the <<memory-bind-tile-memory, bound tile memory's>> allocation size when
the render pass is executed.

If this structure is not provided, the pname:size of the reserved region
defaults to `0`.
...
****
  * [[VUID-VkTileMemorySizeInfoQCOM-size-10729]]
    pname:size must be less than or equal to the largest size memory heap
    with the ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM property
****

include::{generated}/validity/structs/VkTileMemorySizeInfoQCOM.adoc[]
--
endif::VK_QCOM_tile_properties[]
endif::VK_QCOM_tile_memory_heap[]

ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_create_renderpass2[]
[open,refpage='VkSubpassBeginInfo',desc='Structure specifying subpass begin information',type='structs']
--
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_imageless_framebuffer[]
[open,refpage='VkRenderPassAttachmentBeginInfo',desc='Structure specifying images to be used as framebuffer attachments',type='structs']
--
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[or slink:VkRenderingInfo::pname:renderArea]
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_dynamic_rendering[or slink:VkRenderingInfo::pname:viewMask]
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_create_renderpass2[]
[open,refpage='vkCmdNextSubpass2',desc='Transition to the next subpass of a render pass',type='protos']
--
To transition to the next subpass in the render pass instance after
recording the commands for a subpass, call:
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_create_renderpass2[]
[open,refpage='vkCmdEndRenderPass2',desc='End the current render pass',type='protos']
--
To record a command to end a render pass instance after recording the
commands for the last subpass, call:
...
[open,refpage='VkSubpassEndInfo',desc='Structure specifying subpass end information',type='structs']
--
...
[open,refpage='VkRenderPassFragmentDensityMapOffsetEndInfoEXT',desc='Structure specifying fragment density map offset subpass end information',type='structs']
--
[[renderpass-fragmentdensitymapoffsets]]
If the slink:VkSubpassEndInfo::pname:pNext chain
ifdef::VK_EXT_fragment_density_map_offset[]
or slink:VkRenderingEndInfoEXT::pname:pNext chain
endif::VK_EXT_fragment_density_map_offset[]
includes a sname:VkRenderPassFragmentDensityMapOffsetEndInfoEXT structure,
then that structure includes an array of fragment density map offsets per
layer for the render pass.

The sname:VkRenderPassFragmentDensityMapOffsetEndInfoEXT structure is
defined as:

include::{generated}/api/structs/VkRenderPassFragmentDensityMapOffsetEndInfoEXT.adoc[]
...
ifdef::VK_EXT_fragment_density_map_offset[]
If neither the slink:VkSubpassEndInfo::pname:pNext chain for the last
subpass of a render pass nor the slink:VkRenderingEndInfoEXT::pname:pNext
...
sname:VkRenderPassFragmentDensityMapOffsetEndInfoEXT, or if
...
****
  * [[VUID-VkRenderPassFragmentDensityMapOffsetEndInfoEXT-fragmentDensityMapOffsets-06503]]
    ...
    pname:fragmentDensityMapOffset>> feature is not enabled or fragment
  ...
  * [[VUID-VkRenderPassFragmentDensityMapOffsetEndInfoEXT-fragmentDensityMapAttachment-06504]]
    ...
    ename:VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT,
    pname:fragmentDensityOffsetCount must: equal `0`
  ...
  * [[VUID-VkRenderPassFragmentDensityMapOffsetEndInfoEXT-pResolveAttachments-06508]]
    ...
    with ename:VK_IMAGE_CREATE_FRAGMENT_DENSITY_MAP_OFFSET_BIT_EXT,
    pname:fragmentDensityOffsetCount must: equal `0`
  ...
  * [[VUID-VkRenderPassFragmentDensityMapOffsetEndInfoEXT-pFragmentDensityOffsets-10730]]
    Each element of pname:pFragmentDensityOffsets must: be identical for
    every flink:vkCmdEndRendering2KHR call made in a render pass
****

include::{generated}/validity/structs/VkRenderPassFragmentDensityMapOffsetEndInfoEXT.adoc[]
--
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_QCOM_render_pass_store_ops,VK_KHR_dynamic_rendering[]
...
endif::VK_GRAPHICS_VERSION_1_3,VK_KHR_load_store_op_none,VK_EXT_load_store_op_none,VK_QCOM_render_pass_store_ops,VK_KHR_dynamic_rendering[]
...
ifdef::VK_KHR_unified_image_layouts[]
  * For the attachment identified by
    slink:VkRenderingAttachmentInfo::pname:imageView,
    slink:VkAttachmentFeedbackLoopInfoEXT::pname:feedbackLoopEnable is
    ename:VK_TRUE
...
ifndef::VK_EXT_shader_object[]
    The bound pipeline was created with
endif::VK_EXT_shader_object[]
    ename:VK_DYNAMIC_STATE_ATTACHMENT_FEEDBACK_LOOP_ENABLE_EXT and the
    pname:aspectMask state in flink:vkCmdSetAttachmentFeedbackLoopEnableEXT
    has been set and not subsequently <<dynamic-state-lifetime,
    invalidated>> in the current command buffer, and pname:aspectMask
...
=== Access Via Different Image Resources Types
...
For example, a write to a <<descriptors-storageimage, storage image>> may:
not be visible to a subsequent read from a <<descriptors-sampledimage,
sampled image>>.
...
<<renderpass-feedbackloop,feedback loops>>.
endif::VK_EXT_attachment_feedback_loop_layout[]
...
slink:VkPhysicalDeviceTileShadingPropertiesQCOM::pname:maxApronSize.
...
code:OpImageWrite or with atomic operations using
ifdef::VK_KHR_shader_untyped_pointer+VK_EXT_descriptor_heap[]
code:OpUntypedImageTexelPointerEXT or
...
code:OpImage*Gather,
ifdef::VK_QCOM_image_processing3[code:OpImageGatherQCOM,]
or code:OpImageSparse*Gather, and with an code:Image operand from storage
class code:TileAttachmentQCOM, the code:Coordinate operand must: not result
in a any texels accessed that are outside the pname:renderArea or outside
