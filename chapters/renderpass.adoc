...
ifdef::VK_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  * [[VUID-VkRenderingAttachmentInfo-pNext-11754]]
    ...
    includes
    ename:VK_RENDERING_ATTACHMENT_INPUT_ATTACHMENT_FEEDBACK_BIT_KHR,
    pname:imageView must: have an image that was created with
...
ifdef::VK_GRAPHICS_VERSION_1_1,VK_KHR_multiview[]
  ...
  * [[VUID-VkRenderPassPerformanceCountersByRegionBeginInfoARM-pCounterAddresses-11816]]
    For any element of pname:pCounterAddresses that is not `0`, if the
  ...
  * [[VUID-VkRenderPassPerformanceCountersByRegionBeginInfoARM-pCounterAddresses-11817]]
    For any element of pname:pCounterAddresses[i], all device addresses
...
ifdef::VK_EXT_custom_resolve[]
[open,refpage='vkCmdBeginCustomResolveEXT',desc='Begins a shader resolve operation',type='protos',alias='vkCmdBeginCustomResolveEXT']
--
