...
[open,refpage='vkCmdEndRendering2EXT',desc='End a dynamic render pass instance',type='protos']
--
...
include::{generated}/api/protos/vkCmdEndRendering2EXT.adoc[]
  ...
  * pname:pRenderingEndInfo is `NULL` or a pointer to a
    slink:VkRenderingEndInfoEXT structure containing information about how
...
include::{generated}/validity/protos/vkCmdEndRendering2EXT.adoc[]
--

[open,refpage='VkRenderingEndInfoEXT',desc='Structure specifying render pass end information',type='structs']
--
The sname:VkRenderingEndInfoEXT structure is defined as:
...
include::{generated}/validity/structs/VkRenderingEndInfoEXT.adoc[]
--
...
ifdef::VK_GRAPHICS_VERSION_1_2,VK_KHR_depth_stencil_resolve[]
  ...
  * [[VUID-VkFramebufferCreateInfo-flags-10917]]
    If pname:flags does not include
    ename:VK_FRAMEBUFFER_CREATE_IMAGELESS_BIT, each element of
    pname:pAttachments that is used as a color attachment or resolve
    attachment by pname:renderPass must: have been created with a
    slink:VkImageSubresourceRange::pname:aspectMask including
ifdef::VK_BASE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
    ename:VK_IMAGE_ASPECT_PLANE_0_BIT, ename:VK_IMAGE_ASPECT_PLANE_1_BIT,
    ename:VK_IMAGE_ASPECT_PLANE_2_BIT, or
...
****
  ...
  * [[VUID-VkRenderPassFragmentDensityMapOffsetEndInfoEXT-pFragmentDensityOffsets-10730]]
    ...
    every flink:vkCmdEndRendering2EXT call made in a render pass
****
