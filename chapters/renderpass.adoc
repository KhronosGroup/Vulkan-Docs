...
ifdef::VK_EXT_fragment_density_map_offset[]
If the render pass instance was begun with
ename:VK_RENDERING_SUSPENDING_BIT, then any
sname:VkRenderPassFragmentDensityMapOffsetEndInfoEXT structure is ignored.
If the render pass instance was begun with ename:VK_RENDERING_RESUMING_BIT
but not ename:VK_RENDERING_SUSPENDING_BIT, then the offsets in
sname:VkRenderPassFragmentDensityMapOffsetEndInfoEXT apply to all of the
