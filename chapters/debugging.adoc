...
include::{generated}/api/structs/VkDeviceFaultInfoKHR.adoc[]
  ...
  * pname:faultAddressInfo a slink:VkDeviceFaultAddressInfoKHR structure
    providing details of the memory access which caused a fault.
  * pname:instructionAddressInfo a slink:VkDeviceFaultAddressInfoKHR
    structure providing details of the GPU instruction which cause a fault.
  * pname:vendorInfo a slink:VkDeviceFaultVendorInfoKHR structure providing
