...
ifdef::VK_EXT_pipeline_protected_access[]
  ...
  * [[VUID-VkDataGraphPipelineCreateInfoARM-module-09769]]
    If a <<interfaces-resources,resource variable>> is declared in
    slink:VkDataGraphPipelineShaderModuleCreateInfoARM::pname:module, a
    descriptor slot in pname:layout must: match the descriptor type
  ...
  * [[VUID-VkDataGraphPipelineCreateInfoARM-pNext-09876]]
    If a slink:VkDataGraphPipelineIdentifierCreateInfoARM structure is
    included in the pname:pNext chain, then a
  ...
  * [[VUID-VkDataGraphPipelineCreateInfoARM-module-09934]]
    If a <<interfaces-resources,resource variable>> is declared in
    pname:module as an array, a descriptor slot in pname:layout must: match
...
ifdef::VK_EXT_mutable_descriptor_type[]
  ...
  * [[VUID-VkDataGraphPipelineCreateInfoARM-pResourceInfos-09771]]
    For each of the structures in pname:pResourceInfos,
    slink:VkDataGraphPipelineResourceInfoARM::pname:descriptorSet and
    slink:VkDataGraphPipelineResourceInfoARM::pname:binding must: correspond
    to a <<interfaces-resources,resource variable>> declared in pname:module
ifdef::VK_EXT_pipeline_protected_access[]
...
include::{generated}/api/structs/VkDataGraphPipelineIdentifierCreateInfoARM.adoc[]
  ...
  * pname:pIdentifer is a pointer to pname:identifierSize bytes of data that
    describe the pipeline being created.

.Valid Usage
****
  * [[VUID-VkDataGraphPipelineIdentifierCreateInfoARM-pIdentifer-09877]]
    The data provided via pname:pIdentifer must: have been obtained by
    calling flink:vkGetDataGraphPipelinePropertiesARM to query the value of
    the ename:VK_DATA_GRAPH_PIPELINE_PROPERTY_IDENTIFIER_ARM property
****
...
ifdef::VK_EXT_descriptor_buffer[]
  ...
  * [[VUID-vkCmdDispatchDataGraphARM-commandBuffer-09940]]
    If pname:commandBuffer was allocated from a pool that was created with a
    ...
    member, then all ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM descriptors
    accessed as a result of this command must: be tied to slink:VkTensorARM
...
****
  * [[VUID-vkGetDataGraphPipelineAvailablePropertiesARM-dataGraphPipeline-09887]]
    ...
    been returned by a call to flink:vkCreateDataGraphPipelinesARM
