...
.Valid Usage
****
  * [[VUID-VkDataGraphPipelineCreateInfoARM-pNext-09977]]
...
ifdef::VK_ARM_data_graph_optical_flow[]
  ** slink:VkDataGraphPipelineSingleNodeCreateInfoARM
...
ifdef::VK_EXT_pipeline_protected_access[]
  * [[VUID-VkDataGraphPipelineCreateInfoARM-flags-09848]]
    If pname:flags contains
    ename:VK_PIPELINE_CREATE_2_PROTECTED_ACCESS_ONLY_BIT_EXT then a
    slink:VkDataGraphPipelineNeuralStatisticsCreateInfoARM structure must:
    not be included in the pname:pNext chain.
endif::VK_EXT_pipeline_protected_access[]
...
ifdef::VK_QCOM_data_graph_model[or a slink:VkDataGraphPipelineBuiltinModelCreateInfoQCOM]
...
ifdef::VK_QCOM_data_graph_model[or a slink:VkDataGraphPipelineBuiltinModelCreateInfoQCOM]
    ...
    pname:resourceInfoCount must: be 0
  * [[VUID-VkDataGraphPipelineCreateInfoARM-resourceInfoCount-12364]]
    If pname:resourceInfoCount is equal to 0, then pname:pResourceInfos
    must: equal `NULL`
  * [[VUID-VkDataGraphPipelineCreateInfoARM-None-12365]]
    If
ifdef::VK_QCOM_data_graph_model[neither]
    a slink:VkDataGraphPipelineIdentifierCreateInfoARM
ifdef::VK_QCOM_data_graph_model[nor a slink:VkDataGraphPipelineBuiltinModelCreateInfoQCOM]
    structure
ifdef::VK_QCOM_data_graph_model[are]
ifndef::VK_QCOM_data_graph_model[is not]
...
ifdef::VK_ARM_data_graph_optical_flow[]
  * [[VUID-VkDataGraphPipelineResourceInfoARM-descriptorSet-09962]]
    If pname:descriptorSet and pname:binding identify an image resource or
    an array of image resources, then a
    slink:VkDataGraphPipelineResourceInfoImageLayoutARM structure must: be
    included in the pname:pNext chain
ifdef::VK_KHR_unified_image_layouts[]
    , unless the <<features-unifiedImageLayouts, pname:unifiedImageLayouts>>
    feature is enabled
...
ifdef::VK_ARM_data_graph_optical_flow[]
[open,refpage='VkDataGraphPipelineResourceInfoImageLayoutARM',desc='Structure specifying parameters of a graph pipeline image resource',type='structs']
--
:refpage: VkDataGraphPipelineResourceInfoImageLayoutARM

The sname:VkDataGraphPipelineResourceInfoImageLayoutARM structure is defined
as:

include::{generated}/api/structs/VkDataGraphPipelineResourceInfoImageLayoutARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:layout specifies the layout that the image subresource accessible
...
include::{generated}/validity/structs/VkDataGraphPipelineResourceInfoImageLayoutARM.adoc[]
--

[open,refpage='VkDataGraphPipelineSingleNodeCreateInfoARM',desc='Structure specifying parameters of a newly-created single fixed-function node graph pipeline',type='structs']
--
:refpage: VkDataGraphPipelineSingleNodeCreateInfoARM

The sname:VkDataGraphPipelineSingleNodeCreateInfoARM structure is defined
as:

include::{generated}/api/structs/VkDataGraphPipelineSingleNodeCreateInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:nodeType is a elink:VkDataGraphPipelineNodeTypeARM describing the
    type of this node.
  * pname:connectionCount is the length of the pname:pConnections array.
  * pname:pConnections is a pointer to an array of pname:connectionCount
    slink:VkDataGraphPipelineSingleNodeConnectionARM structures.

.Valid Usage
****
  * [[VUID-VkDataGraphPipelineSingleNodeCreateInfoARM-nodeType-09963]]
    If pname:nodeType is
    ename:VK_DATA_GRAPH_PIPELINE_NODE_TYPE_OPTICAL_FLOW_ARM, then a
    slink:VkDataGraphPipelineOpticalFlowCreateInfoARM structure must: be
    included in the pname:pNext chain of this structure
  * [[VUID-VkDataGraphPipelineSingleNodeCreateInfoARM-nodeType-09978]]
    If pname:nodeType is
    ename:VK_DATA_GRAPH_PIPELINE_NODE_TYPE_OPTICAL_FLOW_ARM, then one and
    only slink:VkDataGraphPipelineSingleNodeConnectionARM structure must: be
    present in the pname:pConnections array for each of the following values
    of its pname:connection member:
  ** ename:VK_DATA_GRAPH_PIPELINE_NODE_CONNECTION_TYPE_OPTICAL_FLOW_INPUT_ARM
  ** ename:VK_DATA_GRAPH_PIPELINE_NODE_CONNECTION_TYPE_OPTICAL_FLOW_REFERENCE_ARM
  ** ename:VK_DATA_GRAPH_PIPELINE_NODE_CONNECTION_TYPE_OPTICAL_FLOW_FLOW_VECTOR_ARM
  * [[VUID-VkDataGraphPipelineSingleNodeCreateInfoARM-nodeType-09979]]
    If pname:nodeType is
    ename:VK_DATA_GRAPH_PIPELINE_NODE_TYPE_OPTICAL_FLOW_ARM and
    slink:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:hintGridSize is
    not 0, then one and only
    slink:VkDataGraphPipelineSingleNodeConnectionARM structure whose
    pname:connection member is
    ename:VK_DATA_GRAPH_PIPELINE_NODE_CONNECTION_TYPE_OPTICAL_FLOW_HINT_ARM
    must: be present in the pname:pConnections array
****

include::{generated}/validity/structs/VkDataGraphPipelineSingleNodeCreateInfoARM.adoc[]
--

[open,refpage='VkDataGraphPipelineNodeTypeARM',desc='Enumeration describing the type of a data graph pipeline node',type='enums']
--
:refpage: VkDataGraphPipelineNodeTypeARM

Possible values of ename:VkDataGraphPipelineNodeTypeARM, specifying the type
of a data graph pipeline node, are:

include::{generated}/api/enums/VkDataGraphPipelineNodeTypeARM.adoc[]

  * ename:VK_DATA_GRAPH_PIPELINE_NODE_TYPE_OPTICAL_FLOW_ARM corresponds to
    an <<graphs-operations-opticalflow,optical flow node>>.
--

[open,refpage='VkDataGraphPipelineSingleNodeConnectionARM',desc='Structure describing a single connection between a data graph node and the pipeline layout of a graph pipeline',type='structs']
--
The sname:VkDataGraphPipelineSingleNodeConnectionARM structure is defined
as:

include::{generated}/api/structs/VkDataGraphPipelineSingleNodeConnectionARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:set is the descriptor set number of the graph pipeline layout
    resource to be connected to this connection point.
  * pname:binding is the binding number of the graph pipeline layout
    resource to be connected to this connection point.
  * pname:connection is a elink:VkDataGraphPipelineNodeConnectionTypeARM
    specifying the connection point to link to a graph pipeline layout
    resource.

include::{generated}/validity/structs/VkDataGraphPipelineSingleNodeConnectionARM.adoc[]
--

[[graphs-node-connection-points]]
[open,refpage='VkDataGraphPipelineNodeConnectionTypeARM',desc='Connection points for a fixed-function data graph node',type='enums']
--
Possible values of ename:VkDataGraphPipelineNodeConnectionTypeARM,
specifying the connection points of a data graph pipeline node, are:

include::{generated}/api/enums/VkDataGraphPipelineNodeConnectionTypeARM.adoc[]
  ...
  * ename:VK_DATA_GRAPH_PIPELINE_NODE_CONNECTION_TYPE_OPTICAL_FLOW_FLOW_VECTOR_ARM
    ...
    optical flow node.
  * ename:VK_DATA_GRAPH_PIPELINE_NODE_CONNECTION_TYPE_OPTICAL_FLOW_COST_ARM
...
[open,refpage='VkDataGraphPipelineNeuralStatisticsCreateInfoARM',desc='Structure specifying neural statistics parameters of a newly created graph pipeline',type='structs']
--
:refpage: VkDataGraphPipelineNeuralStatisticsCreateInfoARM

The sname:VkDataGraphPipelineNeuralStatisticsCreateInfoARM structure is
defined as:

include::{generated}/api/structs/VkDataGraphPipelineNeuralStatisticsCreateInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:allowNeuralStatistics specifies whether sessions for the newly
    created pipeline may: enable neural statistics reporting.

include::{generated}/validity/structs/VkDataGraphPipelineNeuralStatisticsCreateInfoARM.adoc[]
--
...
ifdef::VK_ARM_data_graph_neural_accelerator_statistics[]
  * [[VUID-VkDataGraphPipelineSessionCreateInfoARM-pNext-09852]]
    A slink:VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM
    structure may: only be included in the pname:pNext chain if and only if
    a slink:VkDataGraphPipelineNeuralStatisticsCreateInfoARM structure whose
    pname:allowNeuralStatistics member was ename:VK_TRUE was included in the
    pname:pNext chain of the slink:VkDataGraphPipelineCreateInfoARM
    structure used to create pname:dataGraphPipeline
  * [[VUID-VkDataGraphPipelineSessionCreateInfoARM-flags-09853]]
    If pname:flags contains
    ename:VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_PROTECTED_BIT_ARM then a
    slink:VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM structure
    must: not be included in the pname:pNext chain
endif::VK_ARM_data_graph_neural_accelerator_statistics[]
****
...
ifdef::VK_ARM_data_graph_optical_flow[]
  * ename:VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_OPTICAL_FLOW_CACHE_BIT_ARM
...
ifdef::VK_ARM_data_graph_neural_accelerator_statistics[]
[open,refpage='VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM',desc='Structure specifying neural statistics parameters of a newly created data graph pipeline session',type='structs']
--
:refpage: VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM

include::{generated}/api/structs/VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:mode is a elink:VkNeuralAcceleratorStatisticsModeARM specifying
    the neural statistics mode for the session being created.

include::{generated}/validity/structs/VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM.adoc[]
--

[open,refpage='VkNeuralAcceleratorStatisticsModeARM',desc='Enum specifying the mode of operation for neural accelerator statistics',type='enums']
--
The available values for ename:VkNeuralAcceleratorStatisticsModeARM are:

include::{generated}/api/enums/VkNeuralAcceleratorStatisticsModeARM.adoc[]

  * ename:VK_NEURAL_ACCELERATOR_STATISTICS_MODE_DISABLED_ARM specifies that
    neural accelerator statistics are disabled.
  * ename:VK_NEURAL_ACCELERATOR_STATISTICS_MODE_STATISTICS0_ARM specifies
    the `statistics0` mode of operation.
  * ename:VK_NEURAL_ACCELERATOR_STATISTICS_MODE_STATISTICS1_ARM specifies
...
ifdef::VK_ARM_data_graph_neural_accelerator_statistics[]
* ename:VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_NEURAL_ACCELERATOR_STATISTICS_ARM
endif::VK_ARM_data_graph_neural_accelerator_statistics[]
...
include::{generated}/api/enums/VkDataGraphPipelineSessionBindPointARM.adoc[]
  ...
  * ename:VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_TRANSIENT_ARM
    ...
    completes execution.
ifdef::VK_ARM_data_graph_optical_flow[]
  * ename:VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_OPTICAL_FLOW_CACHE_ARM
    corresponds to the cache for <<graphs-operations-opticalflow,optical
    flow operations>>.
endif::VK_ARM_data_graph_optical_flow[]
ifdef::VK_ARM_data_graph_neural_accelerator_statistics[]
  * ename:VK_DATA_GRAPH_PIPELINE_SESSION_BIND_POINT_NEURAL_ACCELERATOR_STATISTICS_ARM
...
****
  ...
  * [[VUID-vkCmdDispatchDataGraphARM-dataGraphPipeline-09951]]
    ...
    pname:session
include::{chapters}/commonvalidity/draw_dispatch_data_graph_common.adoc[]
ifndef::VK_EXT_descriptor_buffer[]
  ...
  * [[VUID-vkCmdDispatchDataGraphARM-commandBuffer-09941]]
    ...
    flink:vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM
ifdef::VK_ARM_data_graph_optical_flow[]
  * [[VUID-vkCmdDispatchDataGraphARM-pInfo-09964]]
    If pname:pInfo is not `NULL` and its pname:pNext chain includes a
    slink:VkDataGraphPipelineOpticalFlowDispatchInfoARM structure, then the
    pname:flags member of that latter structure must: not contain
    ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_INPUT_UNCHANGED_BIT_ARM,
    ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_REFERENCE_UNCHANGED_BIT_ARM,
    ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_INPUT_IS_PREVIOUS_REFERENCE_BIT_ARM,
    or
    ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_REFERENCE_IS_PREVIOUS_INPUT_BIT_ARM
    if pname:session was not created with
    ename:VK_DATA_GRAPH_PIPELINE_SESSION_CREATE_OPTICAL_FLOW_CACHE_BIT_ARM
  * [[VUID-vkCmdDispatchDataGraphARM-nodeType-09980]]
    If the slink:VkPipeline bound to the
    ename:VK_PIPELINE_BIND_POINT_DATA_GRAPH_ARM pipeline bind point was not
    created with a slink:VkDataGraphPipelineSingleNodeCreateInfoARM
    structure whose pname:nodeType member is
    ename:VK_DATA_GRAPH_PIPELINE_NODE_TYPE_OPTICAL_FLOW_ARM included in the
    pname:pNext chain of slink:VkDataGraphPipelineCreateInfoARM, then a
    slink:VkDataGraphPipelineOpticalFlowDispatchInfoARM structure must: not
    be included in the pname:pNext chain of pname:pInfo
  * [[VUID-vkCmdDispatchDataGraphARM-nodeType-09981]]
    If the slink:VkPipeline bound to the
    ename:VK_PIPELINE_BIND_POINT_DATA_GRAPH_ARM pipeline bind point was
    created with a slink:VkDataGraphPipelineSingleNodeCreateInfoARM
    structure whose pname:nodeType member is
    ename:VK_DATA_GRAPH_PIPELINE_NODE_TYPE_OPTICAL_FLOW_ARM included in the
    pname:pNext chain of slink:VkDataGraphPipelineCreateInfoARM, then all
    image subresources that are accessed via a connection point in
    slink:VkDataGraphPipelineSingleNodeCreateInfoARM::pname:pConnections
    must: be in the layout specified by the pname:layout member of the
    slink:VkDataGraphPipelineResourceInfoImageLayoutARM that extends the
    slink:VkDataGraphPipelineResourceInfoARM structure whose
    pname:descriptorSet and pname:binding members match the pname:set and
    pname:binding members of the
    slink:VkDataGraphPipelineSingleNodeConnectionARM structure for the
    connection point
ifdef::VK_KHR_unified_image_layouts[]
    , unless the <<features-unifiedImageLayouts, pname:unifiedImageLayouts>>
...
ifdef::VK_ARM_data_graph_neural_accelerator_statistics[]
  * [[VUID-vkGetDataGraphPipelinePropertiesARM-pProperties-09856]]
    If pname:pProperties includes a
    slink:VkDataGraphPipelinePropertyQueryResultARM whose pname:property
    member is
    ename:VK_DATA_GRAPH_PIPELINE_PROPERTY_NEURAL_ACCELERATOR_STATISTICS_INFO_ARM
    then pname:dataGraphPipeline must: have been created with a
    slink:VkDataGraphPipelineNeuralStatisticsCreateInfoARM whose
    pname:allowNeuralStatistics member was ename:VK_TRUE included in the
    pname:pNext chain of slink:VkDataGraphPipelineCreateInfoARM.
endif::VK_ARM_data_graph_neural_accelerator_statistics[]
****
...
ifdef::VK_ARM_data_graph_neural_accelerator_statistics[]
  * ename:VK_DATA_GRAPH_PIPELINE_PROPERTY_NEURAL_ACCELERATOR_DEBUG_DATABASE_ARM
  ...
  * ename:VK_DATA_GRAPH_PIPELINE_PROPERTY_NEURAL_ACCELERATOR_STATISTICS_INFO_ARM
    ...
    slink:VkDataGraphPipelineSessionNeuralStatisticsCreateInfoARM structure
    whose pname:allowNeuralStatistics was ename:VK_TRUE included in the
    pname:pNext chain of slink:VkDataGraphPipelineCreateInfoARM.
endif::VK_ARM_data_graph_neural_accelerator_statistics[]
--
...
ifdef::VK_ARM_data_graph_optical_flow[]
  * ename:VK_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_TYPE_OPTICAL_FLOW_ARM
    corresponds to fixed-function optical flow as defined by
    `apiext:VK_ARM_data_graph_optical_flow`.
endif::VK_ARM_data_graph_optical_flow[]
--

ifdef::VK_ARM_data_graph_instruction_set_tosa[]
[open,refpage='vkGetPhysicalDeviceQueueFamilyDataGraphEngineOperationPropertiesARM',desc='Query the properties of a data graph processing engine and operation set combination for a specific queue family of a physical device',type='protos']
--
:refpage: vkGetPhysicalDeviceQueueFamilyDataGraphEngineOperationPropertiesARM
...
include::{generated}/api/protos/vkGetPhysicalDeviceQueueFamilyDataGraphEngineOperationPropertiesARM.adoc[]

  * pname:physicalDevice is the physical device to query.
  * pname:queueFamilyIndex is the index of the queue family being queried.
  * pname:pQueueFamilyDataGraphProperties is a pointer to a
    slink:VkQueueFamilyDataGraphPropertiesARM structure that selects the
    processing engine and operation set for which the properties are
    queried.
  * pname:pProperties is a pointer to a structure in which the properties
    are returned.

[[graphs-valid-engine-operation-queries]]
...
ifdef::VK_ARM_data_graph_instruction_set_tosa[]
| Any | Any | `TOSA.XXXXXX.X` where `X` is a digit between 0 and 9 | Any | slink:VkQueueFamilyDataGraphTOSAPropertiesARM
endif::VK_ARM_data_graph_instruction_set_tosa[]
ifdef::VK_ARM_data_graph_optical_flow[]
| Any | Any | `OpticalFlow` | Any | slink:VkQueueFamilyDataGraphOpticalFlowPropertiesARM
endif::VK_ARM_data_graph_optical_flow[]
|====
****
...
****
  * [[VUID-vkGetPhysicalDeviceQueueFamilyDataGraphEngineOperationPropertiesARM-pQueueFamilyDataGraphProperties-09957]]
    The slink:VkQueueFamilyDataGraphPropertiesARM structure pointed to by
    pname:pQueueFamilyDataGraphProperties must: have been obtained by a
    prior call to flink:vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM
    with the same pname:physicalDevice and pname:queueFamilyIndex
  * [[VUID-vkGetPhysicalDeviceQueueFamilyDataGraphEngineOperationPropertiesARM-pProperties-09958]]
    pname:pProperties must: be a valid structure of the appropriate type as
    defined in <<graphs-valid-engine-operation-queries>>
****

include::{generated}/validity/protos/vkGetPhysicalDeviceQueueFamilyDataGraphEngineOperationPropertiesARM.adoc[]
--
endif::VK_ARM_data_graph_instruction_set_tosa[]

=== Data Graph Operations Requirements

Physical devices that support the <<features-dataGraphShaderModule,
pname:dataGraphShaderModule>> feature must: support an operation whose
slink:VkPhysicalDeviceDataGraphOperationSupportARM::pname:operationType is
ename:VK_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_TYPE_SPIRV_EXTENDED_INSTRUCTION_SET_ARM
and code:name and code:version are as described in the following table for
...
ifdef::VK_ARM_data_graph_instruction_set_tosa[]
| apiext:VK_ARM_data_graph_instruction_set_tosa | 1 | `TOSA.001000.1` | 0
endif::VK_ARM_data_graph_instruction_set_tosa[]
|====

ifdef::VK_ARM_data_graph_optical_flow[]
Physical devices that support apiext:VK_ARM_data_graph_optical_flow must:
support the following slink:VkPhysicalDeviceDataGraphOperationSupportARM for
at least one processing engine in at least one queue family:

* code:operationType:
  ename:VK_PHYSICAL_DEVICE_DATA_GRAPH_OPERATION_TYPE_OPTICAL_FLOW_ARM
* code:name: `OpticalFlow`
* code:version: `1`
endif::VK_ARM_data_graph_optical_flow[]

ifdef::VK_ARM_data_graph_instruction_set_tosa[]
[[graphs-operations-tosa]]
=== TOSA

[open,refpage='VkQueueFamilyDataGraphTOSAPropertiesARM',desc='Structure describing the TOSA properties of a processing engine and operation set for a specific queue family of a physical device',type='structs']
--
The sname:VkQueueFamilyDataGraphTOSAPropertiesARM structure is defined as:

include::{generated}/api/structs/VkQueueFamilyDataGraphTOSAPropertiesARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:profileCount is the length of the pname:pProfiles array.
  * pname:pProfiles is a pointer to an array of
    slink:VkDataGraphTOSANameQualityARM structures describing the TOSA
    profiles supported.
  * pname:extensionCount is the length of the pname:pExtensions array.
  * pname:pExtensions is a pointer to an array of
    slink:VkDataGraphTOSANameQualityARM structures describing the TOSA
    extensions supported.
  * pname:level is a elink:VkDataGraphTOSALevelARM describing the TOSA level
    supported.

include::{generated}/validity/structs/VkQueueFamilyDataGraphTOSAPropertiesARM.adoc[]
--

[open,refpage='VkDataGraphTOSANameQualityARM',desc='Structure describing the name and quality level of a TOSA profile or extension',type='structs']
--
The sname:VkDataGraphTOSANameQualityARM structure is defined as:

include::{generated}/api/structs/VkDataGraphTOSANameQualityARM.adoc[]

  * pname:name is a pointer to a null-terminated UTF-8 string specifying the
    name of the TOSA profile or extension.
  * pname:qualityLevel is a tlink:VkDataGraphTOSAQualityFlagsARM describing
    the quality of the support for the TOSA profile or extension.

include::{generated}/validity/structs/VkDataGraphTOSANameQualityARM.adoc[]
--

[open,refpage='VK_MAX_DATA_GRAPH_TOSA_NAME_SIZE_ARM',desc='Length of a data graph TOSA profile or extension name string',type='consts']
--
ename:VK_MAX_DATA_GRAPH_TOSA_NAME_SIZE_ARM is the length in code:char values
of an array containing the name of a data graph TOSA profile or extension,
as returned in slink:VkDataGraphTOSANameQualityARM::pname:name.

include::{generated}/api/enums/VK_MAX_DATA_GRAPH_TOSA_NAME_SIZE_ARM.adoc[]
--

[open,refpage='VkDataGraphTOSAQualityFlagBitsARM',desc='Bits specifying quality properties for a TOSA profile or extension',type='enums']
--
Bits which can: be set in
slink:VkDataGraphTOSANameQualityARM::pname:qualityLevel, describing the
quality of a TOSA profile or extension, are:

include::{generated}/api/enums/VkDataGraphTOSAQualityFlagBitsARM.adoc[]

  * ename:VK_DATA_GRAPH_TOSA_QUALITY_ACCELERATED_ARM specifies that the
    implementation of the TOSA profile or extension is accelerated.
  * ename:VK_DATA_GRAPH_TOSA_QUALITY_CONFORMANT_ARM specifies that the
    implementation of the TOSA profile or extension is conformant.
  * ename:VK_DATA_GRAPH_TOSA_QUALITY_EXPERIMENTAL_ARM specifies that the
    TOSA profile or extension is experimental.
  * ename:VK_DATA_GRAPH_TOSA_QUALITY_DEPRECATED_ARM specifies that the TOSA
    profile or extension is deprecated.
--

[open,refpage='VkDataGraphTOSAQualityFlagsARM',desc='Bitmask of VkDataGraphTOSAQualityFlagBitsARM',type='flags']
--
include::{generated}/api/flags/VkDataGraphTOSAQualityFlagsARM.adoc[]

tname:VkDataGraphTOSAQualityFlagsARM is a bitmask type for setting a mask of
zero or more elink:VkDataGraphTOSAQualityFlagBitsARM.
--

[open,refpage='VkDataGraphTOSALevelARM',desc='Enumeration describing a data graph TOSA level',type='enums']
--
:refpage: VkDataGraphTOSALevelARM

The defined data graph TOSA levels are:

include::{generated}/api/enums/VkDataGraphTOSALevelARM.adoc[]

  * ename:VK_DATA_GRAPH_TOSA_LEVEL_NONE_ARM corresponds to the none TOSA
    level, as described in the TOSA specification.
  * ename:VK_DATA_GRAPH_TOSA_LEVEL_8K_ARM corresponds to the 8K TOSA level,
    as described in the TOSA specification.
--
endif::VK_ARM_data_graph_instruction_set_tosa[]

ifdef::VK_ARM_data_graph_optical_flow[]
[[graphs-operations-opticalflow]]
=== Optical flow
...
<<graphs-node-connection-points, graph node connection points>>:
...
[open,refpage='VkQueueFamilyDataGraphOpticalFlowPropertiesARM',desc='Structure describing optical flow properties of a processing engine and operation set for a specific queue family of a physical device',type='structs']
--
:refpage: VkQueueFamilyDataGraphOpticalFlowPropertiesARM

The sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM structure is
defined as:

include::{generated}/api/structs/VkQueueFamilyDataGraphOpticalFlowPropertiesARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[limits-supportedOutputGridSizesARM]] pname:supportedOutputGridSizes
    are the supported tlink:VkDataGraphOpticalFlowGridSizeFlagsARM which
    can: be specified in
    sname:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:outputGridSize.
  * [[limits-supportedHintGridSizesARM]] pname:supportedHintGridSizes are
    the supported tlink:VkDataGraphOpticalFlowGridSizeFlagsARM which can: be
    specified in
    sname:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:hintGridSize.
  * [[limits-hintSupportedARM]] pname:hintSupported is a boolean describing
    whether using hint flow vector map is supported in an optical flow graph
    pipeline.
  * [[limits-costSupportedARM]] pname:costSupported is a boolean describing
    whether cost map generation is supported in an optical flow graph
    pipeline.
  * [[limits-minWidthARM]] pname:minWidth is the minimum width in pixels for
    images used in an optical flow graph pipeline.
  * [[limits-minHeightARM]] pname:minHeight is the minimum height in pixels
    for images used in an optical flow graph pipeline.
  * [[limits-maxWidthARM]] pname:maxWidth is the maximum width in pixels for
    images used in an optical flow graph pipeline.
  * [[limits-maxHeightARM]] pname:maxHeight is the maximum height in pixels
    for images used in an optical flow graph pipeline.

include::{generated}/validity/structs/VkQueueFamilyDataGraphOpticalFlowPropertiesARM.adoc[]
--

==== Image formats

[open,refpage='vkGetPhysicalDeviceQueueFamilyDataGraphOpticalFlowImageFormatsARM',desc='Query image formats for data graph optical flow',type='protos']
--
To enumerate the supported image formats for a specific data graph optical
flow usage, call:

include::{generated}/api/protos/vkGetPhysicalDeviceQueueFamilyDataGraphOpticalFlowImageFormatsARM.adoc[]
  ...
  * pname:pOpticalFlowImageFormatInfo is a pointer to a
    slink:VkDataGraphOpticalFlowImageFormatInfoARM structure specifying the
    optical flow usage for which information is returned.
  * pname:pFormatCount is a pointer to an integer related to the number of
    optical flow properties available or queried, as described below.
  * pname:pImageFormatProperties is a pointer to an array of
    slink:VkDataGraphOpticalFlowImageFormatPropertiesARM structures in which
...
formats and adding slink:VkDataGraphOpticalFlowImageFormatInfoARM to the
...
flow operations, the
slink:VkDataGraphOpticalFlowImageFormatInfoARM::pname:usage field should
contain one or more of the bits defined in
elink:VkDataGraphOpticalFlowImageUsageFlagBitsARM.

.Valid Usage
****
  * [[VUID-vkGetPhysicalDeviceQueueFamilyDataGraphOpticalFlowImageFormatsARM-pQueueFamilyDataGraphProperties-09965]]
    pname:pQueueFamilyDataGraphProperties must: point to a structure whose
    pname:operation member has its pname:name member equal to `OpticalFlow`
****

include::{generated}/validity/protos/vkGetPhysicalDeviceQueueFamilyDataGraphOpticalFlowImageFormatsARM.adoc[]

[NOTE]
====
ename:VK_FORMAT_B8G8R8A8_UNORM, ename:VK_FORMAT_R8G8B8A8_UNORM,
ename:VK_FORMAT_R8G8B8_UNORM, ename:VK_FORMAT_B8G8R8_UNORM,
ename:VK_FORMAT_R8_UNORM, and ename:VK_FORMAT_B10G11R11_UFLOAT_PACK32 are
initially supported for images with <<opticalflow-usageARM,optical flow
usage>> ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_INPUT_BIT_ARM.

ename:VK_FORMAT_R16G16_SFLOAT is initially supported for images with
<<opticalflow-usageARM,optical flow usage>>
ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_OUTPUT_BIT_ARM and
ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_HINT_BIT_ARM.

ename:VK_FORMAT_R16_UINT is initially supported for images with
<<opticalflow-usageARM,optical flow usage>>
ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_COST_BIT_ARM.
====
--

[open,refpage='VkDataGraphOpticalFlowImageFormatInfoARM',desc='Structure describing data graph optical flow image format info',type='structs']
--
The slink:VkDataGraphOpticalFlowImageFormatInfoARM structure is defined as:

include::{generated}/api/structs/VkDataGraphOpticalFlowImageFormatInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[opticalflow-usageARM]] pname:usage is a bitmask of
    elink:VkDataGraphOpticalFlowImageUsageFlagBitsARM describing the
    intended optical flow usage of the image.

include::{generated}/validity/structs/VkDataGraphOpticalFlowImageFormatInfoARM.adoc[]
--

[open,refpage='VkDataGraphOpticalFlowImageUsageFlagBitsARM',desc='Bits specifying image usage for optical flow operations',type='enums']
--
Bits which can: be set in
slink:VkDataGraphOpticalFlowImageFormatInfoARM::pname:usage, controlling
optical flow usage, are:

include::{generated}/api/enums/VkDataGraphOpticalFlowImageUsageFlagBitsARM.adoc[]

  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_INPUT_BIT_ARM specifies
    that the image can: be used as input or reference image for an optical
    flow operation.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_OUTPUT_BIT_ARM specifies
    that the image can: be used as output flow vector map for an optical
    flow operation.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_HINT_BIT_ARM specifies that
    the image can: be used as hint flow vector map for an optical flow
    operation.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_COST_BIT_ARM specifies that
    the image can: be used as output cost map for an optical flow operation.
--

[open,refpage='VkDataGraphOpticalFlowImageUsageFlagsARM',desc='Bitmask of VkDataGraphOpticalFlowImageUsageFlagBitsARM',type='flags']
--
include::{generated}/api/flags/VkDataGraphOpticalFlowImageUsageFlagsARM.adoc[]

tname:VkDataGraphOpticalFlowImageUsageFlagsARM is a bitmask type for setting
a mask of zero or more elink:VkDataGraphOpticalFlowImageUsageFlagBitsARM.
--

[open,refpage='VkDataGraphOpticalFlowImageFormatPropertiesARM',desc='Structure describing properties of an optical flow image format',type='structs']
--
The slink:VkDataGraphOpticalFlowImageFormatPropertiesARM structure is
defined as:

include::{generated}/api/structs/VkDataGraphOpticalFlowImageFormatPropertiesARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[opticalflow-formatARM]] pname:format is a elink:VkFormat that
    specifies the format that can: be used with the specified optical flow
    image usages.

include::{generated}/validity/structs/VkDataGraphOpticalFlowImageFormatPropertiesARM.adoc[]
--

==== Pipeline creation

[open,refpage='VkDataGraphPipelineOpticalFlowCreateInfoARM',desc='Structure specifying the parameters of a newly-created optical flow graph pipeline',type='structs']
--
The sname:VkDataGraphPipelineOpticalFlowCreateInfoARM structure is defined
as:

include::{generated}/api/structs/VkDataGraphPipelineOpticalFlowCreateInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:width is the width in pixels of the input or reference image to be
    bound to this optical flow pipeline.
  * pname:height is the height in pixels of the input or reference image to
    be bound to this optical flow pipeline.
  * pname:imageFormat is the elink:VkFormat of the input and reference image
  ...
  * pname:outputGridSize is exactly one bit of
    tlink:VkDataGraphOpticalFlowGridSizeFlagsARM specifying the grid size of
    ...
    image dimensions and pname:outputGridSize and is calculated as follows: +
    [eq]#OutputWidth = {lceil} pname:width / OutputGridWidth {rceil}# +
    [eq]#OutputHeight = {lceil} pname:height / OutputGridHeight {rceil}# +
    where OutputGridWidth and OutputGridHeight are determined by
    pname:outputGridSize.
  * pname:hintGridSize is one exactly bit of
    ...
    and pname:hintGridSize and is calculated as follows: +
    [eq]#HintWidth = {lceil} pname:width / HintGridWidth {rceil}# +
    [eq]#HintHeight = {lceil} pname:height / HintGridHeight {rceil}# +
    where HintGridWidth and HintGridHeight are determined by
    pname:hintGridSize.
  * pname:performanceLevel is the
    elink:VkDataGraphOpticalFlowPerformanceLevelARM used for this optical
    flow pipeline.
  * pname:flags are the tlink:VkDataGraphOpticalFlowCreateFlagsARM used for
    this optical flow pipeline.
...
****
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-width-09966]]
    ...
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:minWidth and
    less than or equal to
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:maxWidth
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-height-09967]]
    pname:height must: be greater than or equal to
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:minHeight
    and less than or equal to
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:maxHeight
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-imageFormat-09968]]
    ...
    flink:vkGetPhysicalDeviceQueueFamilyDataGraphOpticalFlowImageFormatsARM
    for ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_INPUT_BIT_ARM
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-flowVectorFormat-09969]]
    ...
    flink:vkGetPhysicalDeviceQueueFamilyDataGraphOpticalFlowImageFormatsARM
    for ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_OUTPUT_BIT_ARM
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-costFormat-09970]]
    pname:costFormat must: be one of the formats returned by
    flink:vkGetPhysicalDeviceQueueFamilyDataGraphOpticalFlowImageFormatsARM
    for ename:VK_DATA_GRAPH_OPTICAL_FLOW_IMAGE_USAGE_COST_BIT_ARM if
    ename:VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_COST_BIT_ARM is set in
    pname:flags
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-outputGridSize-09971]]
    ...
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:supportedOutputGridSizes
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-hintGridSize-09972]]
    pname:hintGridSize must: be 0 or exactly one of the bits reported in
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:supportedHintGridSizes
    if ename:VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_HINT_BIT_ARM is set in
    pname:flags
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-hintGridSize-09973]]
    pname:hintGridSize must: be the same as pname:outputGridSize if
    pname:hintGridSize is not 0
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-flags-09974]]
    ename:VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_HINT_BIT_ARM must: not be
    set in pname:flags if
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:hintSupported
    is ename:VK_FALSE
  * [[VUID-VkDataGraphPipelineOpticalFlowCreateInfoARM-flags-09975]]
    ename:VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_COST_BIT_ARM must: not be
    set in pname:flags if
    sname:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:costSupported
    is ename:VK_FALSE
****

include::{generated}/validity/structs/VkDataGraphPipelineOpticalFlowCreateInfoARM.adoc[]
--

[open,refpage='VkDataGraphOpticalFlowGridSizeFlagBitsARM',desc='Bits specifying grid sizes for optical flow operations',type='enums']
--
Optical flow vectors are generated block-wise, one vector for each block of
NxN pixels (referred to as grid).
Bits which can: be set in
slink:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:outputGridSize and
slink:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:hintGridSize, or
which are returned in
slink:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:supportedOutputGridSizes
and
slink:VkQueueFamilyDataGraphOpticalFlowPropertiesARM::pname:supportedHintGridSizes
controlling optical flow grid sizes, are:

include::{generated}/api/enums/VkDataGraphOpticalFlowGridSizeFlagBitsARM.adoc[]

  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_1X1_BIT_ARM specifies that
    grid is 1x1 pixel.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_2X2_BIT_ARM specifies that
    grid is 2x2 pixel.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_4X4_BIT_ARM specifies that
    grid is 4x4 pixel.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_GRID_SIZE_8X8_BIT_ARM specifies that
    grid is 8x8 pixel.
--

[open,refpage='VkDataGraphOpticalFlowGridSizeFlagsARM',desc='Bitmask of VkDataGraphOpticalFlowGridSizeFlagBitsARM',type='flags']
--
include::{generated}/api/flags/VkDataGraphOpticalFlowGridSizeFlagsARM.adoc[]

tname:VkDataGraphOpticalFlowGridSizeFlagsARM is a bitmask type for setting a
mask of zero or more elink:VkDataGraphOpticalFlowGridSizeFlagBitsARM.
--

[open,refpage='VkDataGraphOpticalFlowPerformanceLevelARM',desc='Optical flow performance level types',type='enums']
--
...
include::{generated}/api/enums/VkDataGraphOpticalFlowPerformanceLevelARM.adoc[]

  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_PERFORMANCE_LEVEL_SLOW_ARM is a level
    with slower performance but higher quality.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_PERFORMANCE_LEVEL_MEDIUM_ARM is a level
    with medium performance and medium quality.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_PERFORMANCE_LEVEL_FAST_ARM is a preset
    with higher performance but lower quality.
--

[open,refpage='VkDataGraphOpticalFlowCreateFlagBitsARM',desc='Bits specifying flags for newly created optical flow data graph node',type='enums']
--
Bits which can: be set in
slink:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:flags, controlling
optical flow pipeline operations, are:

include::{generated}/api/enums/VkDataGraphOpticalFlowCreateFlagBitsARM.adoc[]

  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_HINT_BIT_ARM specifies
    that a slink:VkImageView with external flow vector map will be used as
    hints in performing the motion search and must: be connected to
    ename:VK_DATA_GRAPH_PIPELINE_NODE_CONNECTION_TYPE_OPTICAL_FLOW_HINT_ARM.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_CREATE_ENABLE_COST_BIT_ARM specifies
    that the cost for the forward flow is generated in a slink:VkImageView
...
[open,refpage='VkDataGraphOpticalFlowCreateFlagsARM',desc='Bitmask of VkDataGraphOpticalFlowCreateFlagBitsARM',type='flags']
--
tname:VkDataGraphOpticalFlowCreateFlagsARM is a bitmask type for setting a
mask of zero or more elink:VkDataGraphOpticalFlowCreateFlagBitsARM.
include::{generated}/api/flags/VkDataGraphOpticalFlowCreateFlagsARM.adoc[]
--


==== Pipeline dispatch

[open,refpage='VkDataGraphPipelineOpticalFlowDispatchInfoARM',desc='Structure specifying parameters of a optical flow vector calculation',type='structs']
--
The slink:VkDataGraphPipelineOpticalFlowDispatchInfoARM structure is defined
as:

include::{generated}/api/structs/VkDataGraphPipelineOpticalFlowDispatchInfoARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:flags are the tlink:VkDataGraphOpticalFlowExecuteFlagsARM used for
    this command.
  * pname:meanFlowL1NormHint is an integer used to hint to the
...
****
  * [[VUID-VkDataGraphPipelineOpticalFlowDispatchInfoARM-meanFlowL1NormHint-09976]]
    pname:meanFlowL1NormHint, when different from 0, must: be less than or
    equal to the maximum of the width or height of the input image provided
    at pipeline creation time via
    slink:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:width or
    slink:VkDataGraphPipelineOpticalFlowCreateInfoARM::pname:height,
    respectively
****
include::{generated}/validity/structs/VkDataGraphPipelineOpticalFlowDispatchInfoARM.adoc[]
--

[open,refpage='VkDataGraphOpticalFlowExecuteFlagBitsARM',desc='Bits specifying flags for a optical flow vector calculation',type='enums']
--
Bits which can: be set in
slink:VkDataGraphPipelineOpticalFlowDispatchInfoARM::pname:flags,
controlling optical flow execution, are:

include::{generated}/api/enums/VkDataGraphOpticalFlowExecuteFlagBitsARM.adoc[]

  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_DISABLE_TEMPORAL_HINTS_BIT_ARM
    ...
    flink:vkCmdDispatchDataGraphARM calls in the same graph pipeline session
    may: be automatically used as hints for the current
    flink:vkCmdDispatchDataGraphARM call, to take advantage of temporal
  ...
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_INPUT_UNCHANGED_BIT_ARM
    ...
    previously executed flink:vkCmdDispatchDataGraphARM call in the same
    graph pipeline session.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_REFERENCE_UNCHANGED_BIT_ARM
    specifies that the contents of the reference image are the same as in
    the previously executed flink:vkCmdDispatchDataGraphARM call in the same
    graph pipeline session.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_INPUT_IS_PREVIOUS_REFERENCE_BIT_ARM
    ...
    flink:vkCmdDispatchDataGraphARM call in the same graph pipeline session.
  * ename:VK_DATA_GRAPH_OPTICAL_FLOW_EXECUTE_REFERENCE_IS_PREVIOUS_INPUT_BIT_ARM
...
[open,refpage='VkDataGraphOpticalFlowExecuteFlagsARM',desc='Bitmask of VkDataGraphOpticalFlowExecuteFlagBitsARM',type='flags']
--
tname:VkDataGraphOpticalFlowExecuteFlagsARM is a bitmask type for setting a
mask of zero or more elink:VkDataGraphOpticalFlowExecuteFlagBitsARM.

include::{generated}/api/flags/VkDataGraphOpticalFlowExecuteFlagsARM.adoc[]
--
