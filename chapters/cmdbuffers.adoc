...
****
  ...
  * [[VUID-vkCmdExecuteCommands-contents-09680]]
    ...
    must: have been ename:VK_SUBPASS_CONTENTS_SECONDARY_COMMAND_BUFFERS
ifdef::VK_EXT_nested_command_buffer[, or ename:VK_SUBPASS_CONTENTS_INLINE_AND_SECONDARY_COMMAND_BUFFERS_EXT]
  * [[VUID-vkCmdExecuteCommands-None-09681]]
    ...
    flink:vkCmdNextSubpass must: have been
...
ifdef::VK_ANDROID_external_format_resolve[]
  * [[VUID-vkCmdExecuteCommands-pNext-09299]]
    ...
    ename:VK_RESOLVE_MODE_EXTERNAL_FORMAT_DOWNSAMPLE_BIT_ANDROID, the
...
ifdef::VK_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[]
  * [[VUID-vkCmdExecuteCommands-pCommandBuffers-09504]]
    ...
    mapping state specified by slink:VkRenderingAttachmentLocationInfo in
  ...
  * [[VUID-vkCmdExecuteCommands-pCommandBuffers-09505]]
    ...
    mapping state specified by slink:VkRenderingInputAttachmentIndexInfo in
    the inheritance info of each element of pname:pCommandBuffers and in the
    current state of pname:commandBuffer must: match
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-vkCmdExecuteCommands-memory-10724]]
    If fname:vkCmdExecuteCommands is being called within a render pass
    instance, the size of pname:memory member of the
    slink:VkTileMemoryBindInfoQCOM structure included in the pname:pNext
    ...
    the active bound <<memory-bind-tile-memory, bound tile memory object>>
    in pname:commandBuffer
