...
ifdef::VKSC_VERSION_1_0[]
    ...
    slink:VkCommandPool objects, destroying or freeing any object or memory
    ...
    command buffer to the _invalid state_.
    The command buffer must: not be in the _pending state_ when this
    happens.
