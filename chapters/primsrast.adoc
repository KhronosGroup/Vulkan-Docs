...
ifdef::VK_EXT_depth_clip_enable[]
    ...
    planes of the frustum as described in <<vertexpostproc-clipping,
    Primitive Clipping>>.
...
ifdef::VK_EXT_extended_dynamic_state3[]
  ...
  * pname:minSampleShading specifies a minimum fraction of sample shading if
    pname:sampleShadingEnable is ename:VK_TRUE.
...
ifdef::VK_NV_coverage_reduction_mode[]
    ...
    feature is not enabled, or the pname:pNext chain does not contain
    sname:VkPipelineCoverageReductionStateCreateInfoNV, or
    sname:VkPipelineCoverageReductionStateCreateInfoNV::pname:coverageReductionMode
    is not set to ename:VK_COVERAGE_REDUCTION_MODE_TRUNCATE_NV,
    ...
    then <<primsrast-sampleshading,sample shading>> must: not be enabled
...
[open,refpage='vkCmdSetRasterizerDiscardEnable',desc='Control whether primitives are discarded before the rasterization stage dynamically for a command buffer',type='protos']
--
...
[[primsrast-pixel-indices-1-wide-table]]
...
[[primsrast-pixel-indices-2-wide-table]]
...
[[primsrast-pixel-indices-4-wide-table]]
...
****
  * [[VUID-VkSampleLocationsInfoEXT-sampleLocationsPerPixel-01526]]
    pname:sampleLocationsPerPixel must: be a valid
...
the application to the number of elements in the pname:pFragmentShadingRates
array, and on return the variable is overwritten with the number of
structures actually written to pname:pFragmentShadingRates.
...
shading rate attachment texel is selected using [eq]#layer =
<<interfaces-builtin-variables-layer,code:Layer>>#.
Otherwise, [eq]#layer = 0#.

The texel is <<images-reads, read from the fragment shading rate attachment
image>> using image coordinates equal to [eq]#(x',y',0,layer,0,0)#.
...
where [eq]#texel# is the value in the first component of the returned value,
and [eq]#size~w~# and [eq]#size~h~# are the width and height of the fragment
...
If any of the following conditions are met, [eq]#C~xy~'# is set to
[eq]#{1,1}# by the implementation:
...
[eq]#A~xy~# and [eq]#B~xy~#, and must:
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance6[]
do so if
sname:VkPhysicalDeviceMaintenance6Properties::pname:fragmentShadingRateClampCombinerInputs
is ename:VK_TRUE.
...
--
If the <<features-fragmentShadingRateEnums, pname:fragmentShadingRateEnums>>
feature is enabled, fragment shading rates may be specified using the
elink:VkFragmentShadingRateNV enumerated type defined as:
...
****
  ...
  * [[VUID-vkCmdSetFragmentShadingRateEnumNV-supersampleFragmentShadingRates-04577]]
    If the <<features-supersampleFragmentShadingRates,
  ...
  * [[VUID-vkCmdSetFragmentShadingRateEnumNV-noInvocationFragmentShadingRates-04578]]
    If the <<features-noInvocationFragmentShadingRates,
...
include::{generated}/api/protos/vkCmdBindShadingRateImageNV.adoc[]
  ...
  * pname:imageView is an image view handle specifying the shading rate
    image.
    pname:imageView may: be dlink:VK_NULL_HANDLE, which is equivalent to
...
****
  ...
  * [[VUID-vkCmdBindShadingRateImageNV-imageView-02061]]
    ...
    created with the ename:VK_IMAGE_USAGE_SHADING_RATE_IMAGE_BIT_NV usage
    flag set
...
ename:VK_TRUE, sample shading is enabled.
...
When the <<features-fragmentShaderBarycentric,
pname:fragmentShaderBarycentric>> feature is enabled, the code:PerVertexKHR
<<shaders-interpolation-decorations, interpolation decoration>> can: be used
...
a value is not written to code:PointSize, the point size takes a default
value of 1.0.
...
advertised by the <<features-largePoints, pname:largePoints>> feature and
the <<limits-pointSizeRange, pname:pointSizeRange>> and
<<limits-pointSizeGranularity, pname:pointSizeGranularity>> limits indicate
...
[open,refpage='VkPipelineRasterizationLineStateCreateInfo',desc='Structure specifying parameters of a newly created pipeline line rasterization state',type='structs']
--
Line segment rasterization options are controlled by the
slink:VkPipelineRasterizationLineStateCreateInfo structure.

The sname:VkPipelineRasterizationLineStateCreateInfo structure is defined
as:

include::{generated}/api/structs/VkPipelineRasterizationLineStateCreateInfo.adoc[]

ifdef::VK_KHR_line_rasterization[]
include::{generated}/api/structs/VkPipelineRasterizationLineStateCreateInfoKHR.adoc[]
...
include::{generated}/api/structs/VkPipelineRasterizationLineStateCreateInfoEXT.adoc[]
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:lineRasterizationMode is a elink:VkLineRasterizationMode value
...
****
  ...
  * [[VUID-VkPipelineRasterizationLineStateCreateInfo-stippledLineEnable-02774]]
    If pname:stippledLineEnable is ename:VK_TRUE and
    pname:lineRasterizationMode is ename:VK_LINE_RASTERIZATION_MODE_DEFAULT,
    then the <<features-stippledRectangularLines,
    pname:stippledRectangularLines>> feature must: be enabled and
    slink:VkPhysicalDeviceLimits::pname:strictLines must: be ename:VK_TRUE
****

include::{generated}/validity/structs/VkPipelineRasterizationLineStateCreateInfo.adoc[]
--

[open,refpage='VkLineRasterizationMode',desc='Line rasterization modes',type='enums']
--
Possible values of
slink:VkPipelineRasterizationLineStateCreateInfo::pname:lineRasterizationMode,
specifying the line rasterization mode, are:

include::{generated}/api/enums/VkLineRasterizationMode.adoc[]

ifdef::VK_KHR_line_rasterization[]
include::{generated}/api/enums/VkLineRasterizationModeKHR.adoc[]
endif::VK_KHR_line_rasterization[]
...
include::{generated}/api/enums/VkLineRasterizationModeEXT.adoc[]
  ...
  * ename:VK_LINE_RASTERIZATION_MODE_DEFAULT is equivalent to
    ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR if
  ...
  * ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR specifies lines drawn as if
    they were rectangles extruded from the line
  * ename:VK_LINE_RASTERIZATION_MODE_BRESENHAM specifies lines drawn by
    ...
    Rasterization>>.
  * ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH specifies lines
...
Otherwise, this state is specified by the
slink:VkPipelineRasterizationLineStateCreateInfo::pname:stippledLineEnable
value used to create the currently active pipeline.
...
slink:VkPipelineRasterizationLineStateCreateInfo is
ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR, rasterized
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
ifndef::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
Rasterized
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
pname:lineRasterizationMode is ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR.
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
ifndef::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
...
ename:VK_LINE_RASTERIZATION_MODE_DEFAULT,
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
If
sname:VkPhysicalDeviceMaintenance5Properties::pname:nonStrictSinglePixelWideLinesUseParallelogram
is ename:VK_TRUE,
ifdef::VK_EXT_line_rasterization[]
...
If
sname:VkPhysicalDeviceMaintenance5Properties::pname:nonStrictWideLinesUseParallelogram
is ename:VK_TRUE,
ifdef::VK_EXT_line_rasterization[]
the pname:lineRasterizationMode is
ename:VK_LINE_RASTERIZATION_MODE_DEFAULT_EXT,
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
If pname:lineRasterizationMode is
ename:VK_LINE_RASTERIZATION_MODE_BRESENHAM, then the following rules replace
the line rasterization rules defined in <<primsrast-lines-basic, Basic Line
Segment Rasterization>>.
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
...
slink:VkPipelineRasterizationLineStateCreateInfo is ename:VK_TRUE, then
...
For ename:VK_LINE_RASTERIZATION_MODE_BRESENHAM lines, _s_ is incremented
...
point).
For ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR and
ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH lines, the rectangular
...
[open,refpage='vkCmdSetLineStipple',desc='Set line stipple dynamically for a command buffer',type='protos']
--
To <<pipelines-dynamic-state, dynamically set>> the line stipple state,
call:

ifdef::VK_GRAPHICS_VERSION_1_4[]
include::{generated}/api/protos/vkCmdSetLineStipple.adoc[]
endif::VK_GRAPHICS_VERSION_1_4[]

ifdef::VK_KHR_line_rasterization[]
include::{generated}/api/protos/vkCmdSetLineStippleKHR.adoc[]
endif::VK_KHR_line_rasterization[]
...
ifdef::VK_EXT_shader_object[when drawing using <<shaders-objects, shader objects>>, or]
when the graphics pipeline is created with
ename:VK_DYNAMIC_STATE_LINE_STIPPLE set in
slink:VkPipelineDynamicStateCreateInfo::pname:pDynamicStates.
Otherwise, this state is specified by the
slink:VkPipelineRasterizationLineStateCreateInfo::pname:lineStippleFactor
and
slink:VkPipelineRasterizationLineStateCreateInfo::pname:lineStipplePattern
values used to create the currently active pipeline.
...
include::{generated}/validity/protos/vkCmdSetLineStipple.adoc[]
--
...
If the pname:lineRasterizationMode member of
slink:VkPipelineRasterizationLineStateCreateInfo is
ename:VK_LINE_RASTERIZATION_MODE_RECTANGULAR_SMOOTH, then lines are
...
[open,refpage='vkCmdSetFrontFace',desc='Set front face orientation dynamically for a command buffer',type='protos']
--
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_EXT_extended_dynamic_state,VK_EXT_shader_object[]
[open,refpage='vkCmdSetCullMode',desc='Set cull mode dynamically for a command buffer',type='protos']
--
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
If sname:VkPhysicalDeviceMaintenance5Properties::pname:polygonModePointSize
is ename:VK_TRUE, the point size of the final rasterization of polygons is
taken from code:PointSize when <<primsrast-polygonmode, polygon mode>> is
ename:VK_POLYGON_MODE_POINT.

Otherwise, if
sname:VkPhysicalDeviceMaintenance5Properties::pname:polygonModePointSize is
ename:VK_FALSE, the point size of the final rasterization of polygons is 1.0
when <<primsrast-polygonmode, polygon mode>> is ename:VK_POLYGON_MODE_POINT.
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
--
...
ifdef::VK_GRAPHICS_VERSION_1_3,VK_EXT_extended_dynamic_state2,VK_EXT_shader_object[]
[open,refpage='vkCmdSetDepthBiasEnable',desc='Control whether to bias fragment depth values dynamically for a command buffer',type='protos']
--
...
is the smallest difference in a sample's depth [eq]#z~f~# values that is
...
otherwise identical vertices, but [eq]#z~f~# values that differ by [eq]#r#,
...
****
  ...
  * [[VUID-VkDepthBiasRepresentationInfoEXT-floatRepresentation-08948]]
    ...
    ename:VK_DEPTH_BIAS_REPRESENTATION_FLOAT_EXT
  * [[VUID-VkDepthBiasRepresentationInfoEXT-depthBiasExact-08949]]
    ...
    enabled, pname:depthBiasExact must: be ename:VK_FALSE
****
