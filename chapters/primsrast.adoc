...
ifndef::VK_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
Rasterized
endif::VK_VERSION_1_4,VK_KHR_line_rasterization,VK_EXT_line_rasterization[]
...
ifdef::VK_KHR_line_rasterization,VK_EXT_line_rasterization[or the equivalent command]
endif::VK_VERSION_1_4[]

ifdef::VK_KHR_line_rasterization[]
include::{generated}/api/protos/vkCmdSetLineStippleKHR.adoc[]

ifdef::VK_EXT_line_rasterization[or the equivalent command]
endif::VK_KHR_line_rasterization[]
