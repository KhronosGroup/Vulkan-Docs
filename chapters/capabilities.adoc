...
pname:usage includes ename:VK_IMAGE_USAGE_SAMPLED_BIT, and pname:flags does
not include either of ename:VK_IMAGE_CREATE_SPARSE_BINDING_BIT,
...
except for the inclusion of ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT in
