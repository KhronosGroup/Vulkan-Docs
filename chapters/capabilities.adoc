...
****
ifdef::VK_EXT_host_image_copy[]
  * [[VUID-VkImageFormatProperties2-pNext-09005]]
    If sname:VkHostImageCopyDevicePerformanceQueryEXT is included in a
    pname:pNext chain, the <<features-hostImageCopy, pname:hostImageCopy>>
