...
If the `apiext:VK_EXT_host_image_copy` extension is supported, pname:usage
includes ename:VK_IMAGE_USAGE_SAMPLED_BIT, and pname:flags does not include
either of ename:VK_IMAGE_CREATE_SPARSE_BINDING_BIT,
