...
ifdef::VK_VERSION_1_4,VK_EXT_host_image_copy,VK_ANDROID_external_memory_android_hardware_buffer[]
.Valid Usage
****
...
****
endif::VK_VERSION_1_4,VK_EXT_host_image_copy,VK_ANDROID_external_memory_android_hardware_buffer[]
