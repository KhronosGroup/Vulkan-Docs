...
ifndef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve,VK_EXT_rasterization_order_attachment_access,VK_ARM_rasterization_order_attachment_access[]
A _framebuffer region_ is a set of sample (x, y, layer, sample) coordinates
that is a subset of the entire framebuffer.
endif::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve,VK_EXT_rasterization_order_attachment_access,VK_ARM_rasterization_order_attachment_access[]
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve,VK_EXT_rasterization_order_attachment_access,VK_ARM_rasterization_order_attachment_access[]
...
scope.
ifndef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
...
sname:VkRenderingInfo::pname:flags does not specify the
ename:VK_RENDERING_FRAGMENT_REGION_BIT_EXT flag or the
endif::VK_EXT_custom_resolve[]
sname:VkSubpassDescription::pname:flags does not specify the
ename:VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_EXT flag,
endif::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
...
<<renderpass-tile-shading,tile shading>>, the framebuffer region is a tile
region and it is a tile granularity dependency.
endif::VK_QCOM_tile_shading[]

[NOTE]
====
ifndef::VK_QCOM_tile_shading[Since]
ifdef::VK_QCOM_tile_shading[]
For commands recorded within a render pass instance that enables
<<renderpass-tile-shading,tile shading>>, the fragment shader invocations
...
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
ifdef::VK_EXT_custom_resolve[]
the ename:VK_RENDERING_FRAGMENT_REGION_BIT_EXT flag, or
endif::VK_EXT_custom_resolve[]
the ename:VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_EXT flag, or
endif::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
a framebuffer-global dependency is required.

ifdef::VK_QCOM_tile_shading[]
For a tile granularity dependency, a fragment shader can: use
<<renderpass-tile-shading-attachment-access,tile attachment variables>> to
access any pixel or sample within the _active tile_ for color, depth/stencil
