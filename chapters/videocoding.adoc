...
indicate specific causes of the failure of the query operation:
  ...
  * ename:VK_ERROR_VIDEO_PICTURE_LAYOUT_NOT_SUPPORTED_KHR specifies that the
...
ifdef::VK_KHR_video_decode_h264[]
    ...
    is not supported.
  * ename:VK_ERROR_VIDEO_PROFILE_OPERATION_NOT_SUPPORTED_KHR specifies that
    a video profile operation specified by pname:videoCodecOperation is not
    supported.
  * ename:VK_ERROR_VIDEO_PROFILE_FORMAT_NOT_SUPPORTED_KHR specifies that
    video format parameters specified by pname:chromaSubsampling,
    pname:lumaBitDepth, or pname:chromaBitDepth are not supported.
  * ename:VK_ERROR_VIDEO_PROFILE_CODEC_NOT_SUPPORTED_KHR specifies that the
...
ifdef::VK_KHR_video_decode_vp9[]
  * [[VUID-VkVideoProfileInfoKHR-videoCodecOperation-10791]]
    If pname:videoCodecOperation is
    ename:VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR, then the pname:pNext
    chain must: include a slink:VkVideoDecodeVP9ProfileInfoKHR structure
...
ifdef::VK_KHR_video_encode_av1[]
  * [[VUID-VkVideoProfileInfoKHR-videoCodecOperation-10262]]
    ...
    chain must: include a slink:VkVideoEncodeAV1ProfileInfoKHR structure
...
include::{generated}/api/enums/VkVideoCodecOperationFlagBitsKHR.adoc[]
  ...
  * ename:VK_VIDEO_CODEC_OPERATION_NONE_KHR specifies that no video codec
...
ifdef::VK_KHR_video_decode_vp9[]
  * ename:VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR specifies support for
    <<decode-vp9,VP9 decode operations>>.
endif::VK_KHR_video_decode_vp9[]
ifdef::VK_KHR_video_decode_av1[]
...
ifdef::VK_KHR_video_encode_av1[]
  * ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR specifies support for
    <<encode-av1,AV1 encode operations>>.
endif::VK_KHR_video_encode_av1[]
--
...
ifdef::VK_KHR_video_decode_vp9[]
  * [[VUID-vkGetPhysicalDeviceVideoCapabilitiesKHR-pVideoProfile-10792]]
    ...
    ename:VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR, then the pname:pNext
    chain of pname:pCapabilities must: include a
    slink:VkVideoDecodeVP9CapabilitiesKHR structure
endif::VK_KHR_video_decode_vp9[]
ifdef::VK_KHR_video_decode_av1[]
...
ifdef::VK_KHR_video_encode_av1[]
  * [[VUID-vkGetPhysicalDeviceVideoCapabilitiesKHR-pVideoProfile-10263]]
    ...
    ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR, then the pname:pNext
    chain of pname:pCapabilities must: include a
    slink:VkVideoEncodeAV1CapabilitiesKHR structure
endif::VK_KHR_video_encode_av1[]
ifdef::VK_VALVE_video_encode_rgb_conversion[]
  * [[VUID-vkGetPhysicalDeviceVideoCapabilitiesKHR-pNext-10921]]
    If the pname:pNext chain of pname:pVideoProfile includes a
...
pname:pVideoFormatProperties array, and on return the variable is
overwritten with the number of values actually written to
pname:pVideoFormatProperties.
...
ename:VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_COINCIDE_BIT_KHR, then
...
ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR in
slink:VkPhysicalDeviceVideoFormatInfoKHR::pname:imageUsage.
However, even in this case, querying video format properties with
slink:VkPhysicalDeviceVideoFormatInfoKHR::pname:imageUsage including only
ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR or
ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR will also return formats
supporting both.

[NOTE]
====
This enables application to be able to query all formats supporting
ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR and/or
ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR by just including one of the
...
ename:VK_VIDEO_DECODE_CAPABILITY_DPB_AND_OUTPUT_DISTINCT_BIT_KHR, or both.
...
structure, pname:usage from that structure specifies the expected video
usage flags instead of
slink:VkPhysicalDeviceVideoFormatInfoKHR::pname:imageUsage.
endif::VK_KHR_extended_flags[]

If the implementation supports using images of a particular format in
operations other than video decode/encode then the pname:imageUsageFlags
member of the corresponding slink:VkVideoFormatPropertiesKHR structure
...
If slink:VkPhysicalDeviceVideoFormatInfoKHR::pname:imageUsage includes
ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR or
ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR, multiple
sname:VkVideoFormatPropertiesKHR entries may: be returned with the same
pname:format, pname:componentMapping, pname:imageType, and pname:imageTiling
member values, but different pname:quantizationMapTexelSize returned in the
slink:VkVideoFormatQuantizationMapPropertiesKHR structure, if one is
included in the slink:VkVideoFormatPropertiesKHR::pname:pNext chain, when
the queried <<encode-quantization-map,quantization map type>> supports
multiple distinct <<encode-quantization-map-texel-size,quantization map
texel sizes>>.
...
****
  * [[VUID-vkGetPhysicalDeviceVideoFormatPropertiesKHR-pNext-06812]]
    ...
    greater than `0`
ifdef::VK_VALVE_video_encode_rgb_conversion[]
  * [[VUID-vkGetPhysicalDeviceVideoFormatPropertiesKHR-pNext-10922]]
    If the pname:pNext chain of pname:pVideoFormatInfo includes a
    slink:VkVideoEncodeProfileRgbConversionInfoVALVE structure, then the
    <<features-videoEncodeRgbConversion, pname:videoEncodeRgbConversion>>
    feature must: be supported
endif::VK_VALVE_video_encode_rgb_conversion[]
...
[[supported-video-format-properties]]
The _list of supported video format properties_ for a set of image usage
flags with respect to a <<video-profiles,video profile>> is defined as the
list of slink:VkVideoFormatPropertiesKHR structures and any structures
included in its pname:pNext chain, obtained by calling
...
tlink:VkImageUsageFlags in question and the
...
containing a single array element specifying the slink:VkVideoProfileInfoKHR
...
ifdef::VK_KHR_video_maintenance2+VK_KHR_video_decode_queue[]
  * [[VUID-VkVideoSessionCreateInfoKHR-flags-10398]]
    If pname:flags includes
    ename:VK_VIDEO_SESSION_CREATE_INLINE_SESSION_PARAMETERS_BIT_KHR, then
    <<features-videoMaintenance2,pname:videoMaintenance2>> must: be enabled
  * [[VUID-VkVideoSessionCreateInfoKHR-flags-10399]]
    If pname:flags includes
    ename:VK_VIDEO_SESSION_CREATE_INLINE_SESSION_PARAMETERS_BIT_KHR, then
    pname:pVideoProfile->videoCodecOperation must: specify a decode
    operation
endif::VK_KHR_video_maintenance2+VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_quantization_map[]
  * [[VUID-VkVideoSessionCreateInfoKHR-flags-10264]]
    If pname:flags includes
    ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR
    or ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR, then
    the <<features-videoEncodeQuantizationMap,
  ...
  * [[VUID-VkVideoSessionCreateInfoKHR-flags-10267]]
    If slink:VkVideoEncodeCapabilitiesKHR::pname:flags does not include
    ...
    profile specified by pname:pVideoProfile, then pname:flags must: not
    include
    ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR
  ...
  * [[VUID-VkVideoSessionCreateInfoKHR-pVideoProfile-11759]]
    pname:pVideoProfile->videoCodecOperation must: be supported by the queue
    family index specified in pname:queueFamilyIndex, as reported in
...
ifdef::VK_KHR_video_encode_intra_refresh[]
  * [[VUID-VkVideoSessionCreateInfoKHR-pVideoProfile-10835]]
    If pname:pVideoProfile->videoCodecOperation specifies an encode
    operation, the pname:pNext chain of this structure includes a
    slink:VkVideoEncodeSessionIntraRefreshCreateInfoKHR structure, and its
    pname:intraRefreshMode member is not
    ename:VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_NONE_KHR, then the
  ...
  * [[VUID-VkVideoSessionCreateInfoKHR-pVideoProfile-10836]]
    ...
    slink:VkVideoEncodeSessionIntraRefreshCreateInfoKHR structure, and its
    pname:intraRefreshMode member is not
    ename:VK_VIDEO_ENCODE_INTRA_REFRESH_MODE_NONE_KHR, then
    pname:intraRefreshMode must: specify one of the bits included in
    slink:VkVideoEncodeIntraRefreshCapabilitiesKHR::pname:intraRefreshModes,
    as returned by flink:vkGetPhysicalDeviceVideoCapabilitiesKHR for the
    video profile specified by pname:pVideoProfile
...
ifdef::VK_KHR_video_encode_av1[]
  ...
  * [[VUID-VkVideoSessionCreateInfoKHR-pVideoProfile-10270]]
    If pname:pVideoProfile->videoCodecOperation is
    ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR and the pname:pNext
    chain of this structure includes a
    slink:VkVideoEncodeAV1SessionCreateInfoKHR structure, then its
    pname:maxLevel member must: be less than or equal to
    slink:VkVideoEncodeAV1CapabilitiesKHR::pname:maxLevel, as returned by
    flink:vkGetPhysicalDeviceVideoCapabilitiesKHR for the video profile
    specified in pname:pVideoProfile
endif::VK_KHR_video_encode_av1[]
ifdef::VK_VALVE_video_encode_rgb_conversion[]
  * [[VUID-VkVideoSessionCreateInfoKHR-pVideoProfile-10923]]
    If the pname:pVideoProfile->pNext chain includes a
    slink:VkVideoEncodeProfileRgbConversionInfoVALVE structure, then the
    <<features-videoEncodeRgbConversion, pname:videoEncodeRgbConversion>>
    feature must: be enabled
  * [[VUID-VkVideoSessionCreateInfoKHR-pNext-10924]]
    If a slink:VkVideoEncodeProfileRgbConversionInfoVALVE structure is
    included in the pname:pNext chain of pname:pVideoProfile and
    sname:VkVideoEncodeProfileRgbConversionInfoVALVE::pname:performEncodeRgbConversion
    is enabled, a slink:VkVideoEncodeSessionRgbConversionCreateInfoVALVE
    structure must: be included in the pname:pNext chain of
...
ifdef::VK_KHR_video_maintenance2+VK_KHR_video_decode_queue[]
  * ename:VK_VIDEO_SESSION_CREATE_INLINE_SESSION_PARAMETERS_BIT_KHR
...
the application to the number of elements in the pname:pMemoryRequirements
array, and on return the variable is overwritten with the number of memory
binding requirements actually written to pname:pMemoryRequirements.
...
image was created with:
  ...
  ** slink:VkImageCreateInfo::pname:flags only contains
     ename:VK_IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR and/or bits
     also set in slink:VkVideoFormatPropertiesKHR::pname:imageCreateFlags.
+
[NOTE]
====
Specifying ename:VK_IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR when
creating
ifdef::VK_KHR_video_decode_queue[]
<<decode-output-picture,decode output pictures>>
endif::VK_KHR_video_decode_queue[]
...
<<features-videoMaintenance1,videoMaintenance1>> feature is enabled,
regardless of the supported tlink:VkImageCreateFlags reported in
slink:VkVideoFormatPropertiesKHR::pname:imageCreateFlags.
Accordingly, implementations should: not report
ename:VK_IMAGE_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR in
slink:VkVideoFormatPropertiesKHR::pname:imageCreateFlags for any video
format.
====
...
ifdef::VK_KHR_video_decode_vp9[]
  * For ename:VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR there are no
...
ifdef::VK_KHR_video_encode_av1[]
  * For ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR these are defined
    in the <<encode-av1-parameter-sets,AV1 Encode Parameter Sets>> section.
endif::VK_KHR_video_encode_av1[]
...
<<encode-quantization-map,quantization maps>> if they are created with
pname:pCreateInfo->flags including
...
ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR or
ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR are created
with a specific compatible <<encode-quantization-map-texel-size,quantization
map texel size>> specified in the pname:quantizationMapTexelSize member of
the slink:VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR
structure included in the pname:pNext chain of pname:pCreateInfo.
...
the <<encode-overrides,parameter overrides>> the implementation has to
...
pname:pCreateInfo->videoSessionParametersTemplate must: also have been
created with
ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR
and the same compatible <<encode-quantization-map-texel-size,quantization
map texel size>> specified in
slink:VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR::pname:quantizationMapTexelSize.
...
applied <<encode-overrides,parameter overrides>>) may: no longer be
...
ifdef::VK_KHR_video_encode_av1[]
If pname:pCreateInfo->videoSession was created with the video codec
operation ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR, then the
created video session parameters object will contain a single
<<encode-av1-sequence-header,AV1 sequence header>> specified through the
members of the slink:VkVideoEncodeAV1SessionParametersCreateInfoKHR
structure provided in the pname:pCreateInfo->pNext chain.
As such video session parameters objects can: only contain a single
<<encode-av1-sequence-header,AV1 sequence header>>, it is not possible to
use a previously created object as a template or subsequently update the
created video session parameters object.
endif::VK_KHR_video_encode_av1[]
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * pname:flags is a bitmask of
    elink:VkVideoSessionParametersCreateFlagBitsKHR specifying create flags.
endif::VK_KHR_video_encode_quantization_map[]
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-flags-10271]]
    If pname:flags includes
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR,
    then pname:videoSession must: have been created with
    ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR
    or ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-flags-10272]]
    If pname:flags includes
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR,
    then the pname:pNext chain must: include a
    slink:VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR
    structure
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-flags-10273]]
    If pname:flags includes
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR
    and pname:videoSession was created with
    ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR,
    then the <<supported-video-format-properties,list of video format
    properties>> supported for the image usage flag
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_QUANTIZATION_DELTA_MAP_BIT_KHR must:
    have an element for which
    slink:VkVideoFormatQuantizationMapPropertiesKHR::pname:quantizationMapTexelSize
    equals the pname:quantizationMapTexelSize member of the
    slink:VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR
  ...
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-flags-10274]]
    ...
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR
    and pname:videoSession was created with
    ename:VK_VIDEO_SESSION_CREATE_ALLOW_ENCODE_EMPHASIS_MAP_BIT_KHR, then
    the <<supported-video-format-properties,list of video format
    properties>> supported for the image usage flag
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR must: have an
    element for which
    slink:VkVideoFormatQuantizationMapPropertiesKHR::pname:quantizationMapTexelSize
    equals the pname:quantizationMapTexelSize member of the
    slink:VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR
  ...
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-videoSessionParametersTemplate-10275]]
    ...
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR,
    then pname:videoSessionParametersTemplate must: have been created with
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-videoSessionParametersTemplate-10276]]
    ...
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR,
    then pname:videoSessionParametersTemplate must: have been created with
    the same <<encode-quantization-map-texel-size,quantization map texel
    size>> as the one specified in the pname:quantizationMapTexelSize member
    of the slink:VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR
    structure included in the pname:pNext chain
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-videoSessionParametersTemplate-10277]]
    If pname:videoSessionParametersTemplate is not dname:VK_NULL_HANDLE and
    pname:flags does not include
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR,
    then pname:videoSessionParametersTemplate must: have been created
    without
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR
endif::VK_KHR_video_encode_quantization_map[]
ifdef::VK_KHR_video_decode_h264[]
...
ifdef::VK_KHR_video_decode_vp9[]
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-videoSession-10794]]
    pname:videoSession must: not have been created with the codec operation
    ename:VK_VIDEO_CODEC_OPERATION_DECODE_VP9_BIT_KHR
endif::VK_KHR_video_decode_vp9[]
ifdef::VK_KHR_video_decode_av1[]
...
ifdef::VK_KHR_video_encode_av1[]
  ...
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-videoSession-10279]]
    ...
    ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR, then the pname:pNext
    chain must: include a
    slink:VkVideoEncodeAV1SessionParametersCreateInfoKHR structure
  * [[VUID-VkVideoSessionParametersCreateInfoKHR-videoSession-10280]]
    If pname:videoSession was created with the video codec operation
    ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR, then the
    pname:stdOperatingPointCount member of the
    slink:VkVideoEncodeAV1SessionParametersCreateInfoKHR structure included
    in the pname:pNext chain must: be less than or equal to
    slink:VkVideoEncodeAV1CapabilitiesKHR::pname:maxOperatingPoints, as
    returned by flink:vkGetPhysicalDeviceVideoCapabilitiesKHR for the video
    profile pname:videoSession was created with
endif::VK_KHR_video_encode_av1[]
****
...
ifdef::VK_KHR_video_encode_quantization_map[]
[open,refpage='VkVideoSessionParametersCreateFlagBitsKHR',desc='Video session parameters creation flags',type='enums']
--
Bits which can: be set in
slink:VkVideoSessionParametersCreateInfoKHR::pname:flags are:

include::{generated}/api/enums/VkVideoSessionParametersCreateFlagBitsKHR.adoc[]

  * ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR
    specifies that the created video session parameters object can: be used
    with <<encode-quantization-map,quantization maps>>.
--
endif::VK_KHR_video_encode_quantization_map[]

[open,refpage='VkVideoSessionParametersCreateFlagsKHR',desc='Bitmask of VkVideoSessionParametersCreateFlagBitsKHR',type='flags']
--
...
ifdef::VK_KHR_video_encode_quantization_map[]
tname:VkVideoSessionParametersCreateFlagsKHR is a bitmask type for setting a
mask of zero or more elink:VkVideoSessionParametersCreateFlagBitsKHR.
endif::VK_KHR_video_encode_quantization_map[]
--

ifdef::VK_KHR_video_encode_quantization_map[]
[open,refpage='VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR',desc='Structure specifying quantization map texel size for video session parameters',type='structs']
--
The sname:VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR
structure is defined as:

include::{generated}/api/structs/VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:quantizationMapTexelSize specifies the
    <<encode-quantization-map-texel-size,quantization map texel size>> a
    video session parameters object created with
    ename:VK_VIDEO_SESSION_PARAMETERS_CREATE_QUANTIZATION_MAP_COMPATIBLE_BIT_KHR
    is compatible with.

include::{generated}/validity/structs/VkVideoEncodeQuantizationMapSessionParametersCreateInfoKHR.adoc[]
--
endif::VK_KHR_video_encode_quantization_map[]
...
ifdef::VK_KHR_video_encode_av1[]
  * [[VUID-vkUpdateVideoSessionParametersKHR-videoSessionParameters-10281]]
    pname:videoSessionParameters must: not have been created with the video
    codec operation ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR
endif::VK_KHR_video_encode_av1[]
****
...
.Valid Usage
****
  * [[VUID-vkCmdBeginVideoCodingKHR-commandBuffer-11760]]
    ...
    pname:pBeginInfo->videoSession was created with
...
ifdef::VK_KHR_video_encode_av1[]
  * [[VUID-vkCmdBeginVideoCodingKHR-pBeginInfo-10282]]
    If pname:pBeginInfo->videoSession was created with the video codec
    operation ename:VK_VIDEO_CODEC_OPERATION_ENCODE_AV1_BIT_KHR, the current
    ...
    pname:pBeginInfo->videoSession was created with, then the pname:pNext
    chain of pname:pBeginInfo must: include an instance of the
    slink:VkVideoEncodeAV1GopRemainingFrameInfoKHR with its
    pname:useGopRemainingFrames member set to ename:VK_TRUE
endif::VK_KHR_video_encode_av1[]
****
...
ifdef::VK_KHR_video_maintenance2[]
    , unless the <<features-videoMaintenance2,pname:videoMaintenance2>>
    feature is enabled
...
include::{generated}/api/enums/VkVideoCodingControlFlagBitsKHR.adoc[]
  ...
  * ename:VK_VIDEO_CODING_CONTROL_RESET_BIT_KHR specifies a request for the
    bound video session to be reset before other coding control parameters
    are applied.
ifdef::VK_KHR_video_encode_queue[]
  * ename:VK_VIDEO_CODING_CONTROL_ENCODE_RATE_CONTROL_BIT_KHR specifies that
    the coding control parameters include video encode rate control
    parameters (see slink:VkVideoEncodeRateControlInfoKHR).
  * ename:VK_VIDEO_CODING_CONTROL_ENCODE_QUALITY_LEVEL_BIT_KHR specifies
...
ifdef::VK_KHR_video_decode_vp9[]
include::{chapters}/video/vp9_decode.adoc[]
endif::VK_KHR_video_decode_vp9[]
...
ifdef::VK_KHR_video_encode_av1[]
include::{chapters}/video/av1_encode.adoc[]
endif::VK_KHR_video_encode_av1[]
