...
include::{chapters}/VK_OHOS_surface/platformCreateSurface_OHOS.adoc[]
...
ifdef::VK_OHOS_surface[]
include::{chapters}/VK_OHOS_surface/platformQuerySupport_OHOS.adoc[]
endif::VK_OHOS_surface[]
...
through the use of slink:VkSwapchainPresentScalingCreateInfoEXT.
...
mode, add a slink:VkSurfacePresentModeEXT structure in the pname:pNext chain
...
through the use of slink:VkSwapchainPresentModesCreateInfoEXT.
endif::VK_EXT_swapchain_maintenance1[]
...
ifdef::VK_KHR_present_wait2[]
include::{chapters}/VK_KHR_present_wait2/present_wait2.adoc[]
endif::VK_KHR_present_wait2[]
