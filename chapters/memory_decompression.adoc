...
include::{chapters}/commonvalidity/decompress_memory_region_common.adoc[]
  * [[VUID-VkDecompressMemoryRegionEXT-srcAddress-11764]]
    ...
    ename:VK_BUFFER_USAGE_2_MEMORY_DECOMPRESSION_BIT_EXT usage flag set
  * [[VUID-VkDecompressMemoryRegionEXT-dstAddress-11765]]
    pname:dstAddress must: be a device address allocated to the application
    from a buffer created with the
    ename:VK_BUFFER_USAGE_2_MEMORY_DECOMPRESSION_BIT_EXT usage flag set
****
...
ifdef::VK_NV_memory_decompression[]
[open,refpage='vkCmdDecompressMemoryNV',desc='Decompress memory containing compressed data',type='protos']
--
...
include::{generated}/api/protos/vkCmdDecompressMemoryIndirectCountEXT.adoc[]
  ...
  * pname:maxDecompressionCount is the maximum number of decompressions that
    will be executed.
