...
ifdef::VK_EXT_robustness2[]
  ...
  * [[VUID-VkDescriptorAddressInfoEXT-nullDescriptor-08938]]
    If the <<features-nullDescriptor, pname:nullDescriptor>> feature is
    enabled, and pname:address is zero, pname:range must: be
    ename:VK_WHOLE_SIZE
  * [[VUID-VkDescriptorAddressInfoEXT-nullDescriptor-08939]]
    If the <<features-nullDescriptor, pname:nullDescriptor>> feature is
    enabled and pname:address is not zero, pname:range must: not be
    ename:VK_WHOLE_SIZE
endif::VK_EXT_robustness2[]
