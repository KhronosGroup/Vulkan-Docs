...
ifdef::VK_NV_per_stage_descriptor_set[]
  * [[VUID-VkDescriptorSetLayoutBinding-flags-09466]]
    ...
    pname:descriptorCount is not `0`, then pname:stageFlags must: be 0 or a
    valid combination of ename:VK_SHADER_STAGE_VERTEX_BIT,
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03022]]
    ...
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER accessible to any given
    shader stage across all elements of pname:pSetLayouts must: be less than
    or equal to the maximum of <<limits-maxPerStageDescriptorSamplers,
    sname:VkPhysicalDeviceLimits::pname:maxPerStageDescriptorSamplers>> and
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03023]]
    ...
    shader stage across all elements of pname:pSetLayouts must: be less than
    or equal to the maximum of <<limits-maxPerStageDescriptorUniformBuffers,
    sname:VkPhysicalDeviceLimits::pname:maxPerStageDescriptorUniformBuffers>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindUniformBuffers,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03024]]
    ...
    shader stage across all elements of pname:pSetLayouts must: be less than
    or equal to the maximum of <<limits-maxPerStageDescriptorStorageBuffers,
    sname:VkPhysicalDeviceLimits::pname:maxPerStageDescriptorStorageBuffers>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindStorageBuffers,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03025]]
    ...
    shader stage across all elements of pname:pSetLayouts must: be less than
    or equal to the maximum of <<limits-maxPerStageDescriptorSampledImages,
    sname:VkPhysicalDeviceLimits::pname:maxPerStageDescriptorSampledImages>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindSampledImages,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03026]]
    ...
    shader stage across all elements of pname:pSetLayouts must: be less than
    or equal to the maximum of <<limits-maxPerStageDescriptorStorageImages,
    sname:VkPhysicalDeviceLimits::pname:maxPerStageDescriptorStorageImages>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindStorageImages,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03027]]
    ...
    equal to the maximum of <<limits-maxPerStageDescriptorInputAttachments,
    sname:VkPhysicalDeviceLimits::pname:maxPerStageDescriptorInputAttachments>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindInputAttachments,
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-02215]]
    ...
    sname:VkPhysicalDeviceInlineUniformBlockProperties::pname:maxPerStageDescriptorInlineUniformBlocks>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindInlineUniformBlocks,
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-10006]]
    ...
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetTotalBuffersDynamic>>
    and <<limits-maxDescriptorSetUpdateAfterBindTotalBuffersDynamic,
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03036]]
    ...
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to the maximum of <<limits-maxDescriptorSetSamplers,
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetSamplers>> and
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03037]]
    ...
    or equal to the maximum of <<limits-maxDescriptorSetUniformBuffers,
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetUniformBuffers>> and
...
ifndef::VK_KHR_maintenance7[The]
    ...
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetUniformBuffersDynamic>>
    and <<limits-maxDescriptorSetUpdateAfterBindUniformBuffersDynamic,
...
ifdef::VK_KHR_maintenance7[]
  * [[VUID-VkPipelineLayoutCreateInfo-maintenance7-10007]]
    ...
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetTotalUniformBuffersDynamic>>
    and <<limits-maxDescriptorSetUpdateAfterBindTotalUniformBuffersDynamic,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03039]]
    ...
    stages and across all elements of pname:pSetLayouts must: be less than
    or equal to the maximum of <<limits-maxDescriptorSetStorageBuffers,
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetStorageBuffers>> and
...
ifdef::VK_KHR_maintenance7[]
  * [[VUID-VkPipelineLayoutCreateInfo-maintenance7-10008]]
    ...
    sname:VkPhysicalDeviceMaintenance7PropertiesKHR::pname:maxDescriptorSetTotalStorageBuffersDynamic>>
    and <<limits-maxDescriptorSetUpdateAfterBindTotalStorageBuffersDynamic,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03041]]
    ...
    ename:VK_DESCRIPTOR_TYPE_UNIFORM_TEXEL_BUFFER accessible across all
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to the maximum of <<limits-maxDescriptorSetSampledImages,
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetSampledImages>> and
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03042]]
    ...
    shader stages and across all elements of pname:pSetLayouts must: be less
    than or equal to the maximum of <<limits-maxDescriptorSetStorageImages,
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetStorageImages>> and
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-03043]]
    ...
    stages and across all elements of pname:pSetLayouts must: be less than
    or equal to the maximum of <<limits-maxDescriptorSetInputAttachments,
    sname:VkPhysicalDeviceLimits::pname:maxDescriptorSetInputAttachments>>
    and <<limits-maxDescriptorSetUpdateAfterBindInputAttachments,
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_inline_uniform_block[]
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-02217]]
    ...
    sname:VkPhysicalDeviceInlineUniformBlockProperties::pname:maxDescriptorSetInlineUniformBlocks>>
    and <<limits-maxDescriptorSetUpdateAfterBindInlineUniformBlocks,
...
ifdef::VK_KHR_acceleration_structure[]
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03572]]
    ...
    <<limits-maxPerStageDescriptorAccelerationStructures,
    slink:VkPhysicalDeviceAccelerationStructurePropertiesKHR::pname:maxPerStageDescriptorAccelerationStructures>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindAccelerationStructures,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03573]]
    ...
    less than or equal to <<limits-maxDescriptorSetAccelerationStructures,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-03574]]
    ...
    slink:VkPhysicalDeviceAccelerationStructurePropertiesKHR::pname:maxDescriptorSetAccelerationStructures>>
    and <<limits-maxDescriptorSetUpdateAfterBindAccelerationStructures,
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-pSetLayouts-09878]]
    ...
    to the maximum of <<limits-maxDescriptorSetStorageTensors,
    slink:VkPhysicalDeviceTensorPropertiesARM::pname:maxDescriptorSetStorageTensors>>
    and <<limits-maxDescriptorSetUpdateAfterBindStorageTensors,
  ...
  * [[VUID-VkPipelineLayoutCreateInfo-descriptorType-09879]]
    ...
    the maximum of <<limits-maxPerStageDescriptorSetStorageTensors,
    sname:VkPhysicalDeviceTensorPropertiesARM::pname:maxPerStageDescriptorSetStorageTensors>>
    and <<limits-maxPerStageDescriptorUpdateAfterBindStorageTensors,
...
image samplers with <<samplers-YCbCr-conversion,{YCbCr} conversion>>, an
...
property to conservatively size the pname:descriptorCount value instead of
querying pname:combinedImageSamplerDescriptorCount for each format.

ifdef::VK_ANDROID_external_memory_android_hardware_buffer[]
Applications must: use pname:maxCombinedImageSamplerDescriptorCount to size
the pname:descriptorCount value for image samplers with an
<<memory-external-android-hardware-buffer-external-formats,Android external
format>> as it is not possible to query
pname:combinedImageSamplerDescriptorCount for those formats.
