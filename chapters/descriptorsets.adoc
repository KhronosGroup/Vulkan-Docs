...
ifndef::VK_VERSION_1_4,VK_KHR_push_descriptor[]
[NOTE]
====
...
format.
In conjunction with
ifdef::VK_VERSION_1_4,VK_KHR_push_descriptor[flink:vkCmdPushDescriptorSetWithTemplate or]
flink:vkUpdateDescriptorSetWithTemplate, this can: be more efficient
compared to calling
ifdef::VK_VERSION_1_4,VK_KHR_push_descriptor[flink:vkCmdPushDescriptorSet or]
flink:vkUpdateDescriptorSets.
...
ifdef::VK_VERSION_1_4+VK_KHR_maintenance6[or the equivalent command]
...
ifdef::VK_VERSION_1_4+VK_KHR_push_descriptor[or the equivalent command]
