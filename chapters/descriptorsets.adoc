...
[NOTE]
====
When available, applications can use <<descriptorheaps, descriptor heaps>>
...
ifdef::VK_ARM_data_graph[]
  * [[VUID-vkCmdBindDescriptorBuffersEXT-pBindingInfos-09947]]
    ...
    slink:VkDataGraphProcessingEngineCreateInfoARM::pProcessingEngines with
    pname:isForeign set to ename:VK_TRUE
endif::VK_ARM_data_graph[]
****
