...
ifdef::VK_VULKAN_1_1,VK_KHR_sampler_ycbcr_conversion[]
    If pname:descriptorType is not
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER or pname:pImageInfo has
    a pname:imageView member that was not created with a
    sname:VkSamplerYcbcrConversionInfo structure in its pname:pNext chain,
endif::VK_VULKAN_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_VULKAN_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-vkGetDescriptorEXT-descriptorType-09469]]
    If pname:descriptorType is
    ename:VK_DESCRIPTOR_TYPE_COMBINED_IMAGE_SAMPLER and pname:pImageInfo has
    a pname:imageView member that was created with a
    sname:VkSamplerYcbcrConversionInfo structure in its pname:pNext chain,
    pname:dataSize must: equal the size of
...
The sname::VkBindDescriptorBufferEmbeddedSamplersInfoEXT structure is
defined as:
