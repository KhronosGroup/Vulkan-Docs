...
ifdef::VK_ARM_tensors[]
or if pname:descriptorType is ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM, in which
case the source data for the descriptor writes is taken from the instance of
slink:VkWriteDescriptorSetTensorARM in the pname:pNext chain of
...
ifdef::VK_ARM_tensors[]
  * ename:VK_DESCRIPTOR_TYPE_TENSOR_ARM specifies a
    <<descriptorsets-storagetensor, storage tensor descriptor>>.
endif::VK_ARM_tensors[]
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
    the <<features-texelBufferAlignment, pname:texelBufferAlignment>>
    feature is not enabled,
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
    and pname:pUniformTexelBuffer is not `NULL`,
    pname:pUniformTexelBuffer->address must: be aligned to
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
    ...
    and pname:pStorageTexelBuffer is not `NULL`,
    pname:pStorageTexelBuffer->address must: be aligned to
    sname:VkPhysicalDeviceLimits::pname:minTexelBufferOffsetAlignment
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
  * [[VUID-VkDescriptorGetInfoEXT-type-12269]]
    ...
    enabled, and pname:pUniformTexelBuffer is not `NULL`,
    pname:pUniformTexelBuffer->address must: be a multiple of the lesser of
    ...
    is ename:VK_TRUE, the size of a texel of the requested
    pname:pUniformTexelBuffer->format.
  ...
  * [[VUID-VkDescriptorGetInfoEXT-type-12270]]
    ...
    <<features-texelBufferAlignment, pname:texelBufferAlignment>> feature is
    enabled, and pname:pStorageTexelBuffer is not `NULL`,
    pname:pStorageTexelBuffer->address must: be a multiple of the lesser of
    ...
    is ename:VK_TRUE, the size of a texel of the requested
    pname:pStorageTexelBuffer->format.
    If the size of a texel is a multiple of three bytes, then the size of a
    single component of pname:format is used instead
endif::VK_COMPUTE_VERSION_1_3,VK_EXT_texel_buffer_alignment[]
****
