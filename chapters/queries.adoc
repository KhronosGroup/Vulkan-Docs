...
ifdef::VK_KHR_video_queue[]
  ...
  * [[VUID-vkGetQueryPoolResults-queryType-06900]]
    If the pname:queryType used to create pname:queryPool was
    ename:VK_QUERY_TYPE_PERFORMANCE_QUERY_KHR, pname:flags must: not contain
    ename:VK_QUERY_RESULT_WITH_STATUS_BIT_KHR
endif::VK_KHR_video_queue[]
...
ifdef::VK_KHR_video_queue[]
  ...
  * [[VUID-vkCmdCopyQueryPoolResults-flags-06902]]
    If pname:flags includes ename:VK_QUERY_RESULT_WITH_STATUS_BIT_KHR, it
    must: not include ename:VK_QUERY_RESULT_WITH_AVAILABILITY_BIT
  * [[VUID-vkCmdCopyQueryPoolResults-queryType-06903]]
    If the pname:queryType used to create pname:queryPool was
    ename:VK_QUERY_TYPE_PERFORMANCE_QUERY_KHR, pname:flags must: not contain
    ename:VK_QUERY_RESULT_WITH_STATUS_BIT_KHR
endif::VK_KHR_video_queue[]
...
In order to determine if a queue family supports result status queries and
use of ename:VK_QUERY_RESULT_WITH_STATUS_BIT_KHR flag, add a
slink:VkQueueFamilyQueryResultStatusPropertiesKHR structure to the
pname:pNext chain of slink:VkQueueFamilyProperties2 when calling
