...
ifdef::VK_EXT_present_timing[]
  * If none of the <<features-presentTiming, pname:presentTiming>>,
    ...
    <<features-presentAtRelativeTime, pname:presentAtRelativeTime>>
    features are enabled, pname:flags must: not contain
...
ifdef::VK_KHR_swapchain_maintenance1,VK_EXT_swapchain_maintenance1[]
include::{chapters}/VK_KHR_swapchain_maintenance1/SwapchainPresentModesCreateInfo.adoc[]
include::{chapters}/VK_KHR_swapchain_maintenance1/SwapchainPresentScalingCreateInfo.adoc[]
endif::VK_KHR_swapchain_maintenance1,VK_EXT_swapchain_maintenance1[]
...
ifdef::VK_KHR_present_id2[]
include::{chapters}/VK_KHR_swapchain/PresentId2.adoc[]
endif::VK_KHR_present_id2[]
...
ifdef::VK_KHR_swapchain_maintenance1,VK_EXT_swapchain_maintenance1[]
include::{chapters}/VK_KHR_swapchain_maintenance1/SwapchainPresentModeInfo.adoc[]
include::{chapters}/VK_KHR_swapchain_maintenance1/SwapchainPresentFenceInfo.adoc[]
endif::VK_KHR_swapchain_maintenance1,VK_EXT_swapchain_maintenance1[]
