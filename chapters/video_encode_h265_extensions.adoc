...
include::{generated}/api/enums/VkVideoEncodeH265CapabilityFlagBitsEXT.adoc[]
  ...
  * ename:VK_VIDEO_ENCODE_H265_CAPABILITY_DIFFERENT_REFERENCE_FINAL_LISTS_BIT_EXT
    reports that the implementation allows encoding each slice segment with
    a different code:StdVideoEncodeH265ReferenceListsInfo.
    If not supported, all slice segments of the frame must: be encoded with
    the same code:StdVideoEncodeH265ReferenceListsInfo.
--
...
include::{generated}/api/structs/VkVideoEncodeH265VclFrameInfoEXT.adoc[]
  ...
  * pname:pStdReferenceFinalLists is `NULL` or a pointer to a
    code:StdVideoEncodeH265ReferenceListsInfo structure specifying the
...
include::{generated}/api/structs/VkVideoEncodeH265NaluSliceSegmentInfoEXT.adoc[]
  ...
  * pname:pStdReferenceFinalLists is `NULL` or a pointer to a
    ...
    slink:VkVideoEncodeH265VclFrameInfoEXT::pname:pStdReferenceFinalLists.
