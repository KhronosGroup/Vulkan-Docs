...
ifdef::VK_KHR_device_address_commands+VK_KHR_acceleration_structure[]
  * [[VUID-VkDeviceCreateInfo-deviceAddressCommands-13048]]
    If the <<features-deviceAddressCommands, pname:deviceAddressCommands>>
    feature is enabled, the <<features-accelerationStructureHostCommands,
    pname:accelerationStructureHostCommands>> feature must: not be enabled
