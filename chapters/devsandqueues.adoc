...
destroyed with the slink:VkInstance that they were retrieved from.
...
application to the number of elements in the pname:pPhysicalDevices array,
and on return the variable is overwritten with the number of handles
actually written to pname:pPhysicalDevices.
...
//The use of VK_VERSION_1_3 in this block is intended.
...
// @TODO The subgroup language should be transcluded from
// VkPhysicalDeviceSubgroupProperties like the others, but there is a
// different member name involved for subgroupSupportedOperations.
// This could be worked around with an attribute, like commonvalidity VUs.
...
[NOTE]
====
The pname:subgroupSupportedStages, pname:subgroupSupportedOperations, and
pname:subgroupQuadOperationsInAllStages members of this structure correspond
respectively to the
slink:VkPhysicalDeviceSubgroupProperties::pname:supportedStages,
slink:VkPhysicalDeviceSubgroupProperties::pname:supportedOperations, and
slink:VkPhysicalDeviceSubgroupProperties::pname:quadOperationsInAllStages
...
[open,refpage='VkPhysicalDeviceVulkan14Properties',desc='Structure specifying physical device properties for functionality promoted to Vulkan 1.4',type='structs']
--
The sname:VkPhysicalDeviceVulkan14Properties structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceVulkan14Properties.adoc[]
...
:anchor-prefix:
include::{chapters}/limits.adoc[tag=VK_KHR_line_rasterization-properties]
include::{chapters}/limits.adoc[tag=VK_KHR_vertex_attribute_divisor-properties]
include::{chapters}/limits.adoc[tag=VK_KHR_push_descriptor-properties]
  * [[{anchor-prefix}limits-dynamicRenderingLocalReadDepthStencilAttachments]]
    pname:dynamicRenderingLocalReadDepthStencilAttachments is ename:VK_TRUE
    if the implementation supports local reads of depth/stencil attachments,
    ename:VK_FALSE otherwise.
  * [[{anchor-prefix}limits-dynamicRenderingLocalReadMultisampledAttachments]]
    pname:dynamicRenderingLocalReadMultisampledAttachments is ename:VK_TRUE
    if the implementation supports local reads of multisampled attachments,
    ename:VK_FALSE otherwise.
include::{chapters}/limits.adoc[tag=VK_KHR_maintenance5-properties]
include::{chapters}/limits.adoc[tag=VK_KHR_maintenance6-properties]
include::{chapters}/limits.adoc[tag=VK_EXT_pipeline_robustness-properties]
include::{chapters}/limits.adoc[tag=VK_EXT_host_image_copy-properties]

:refpage: VkPhysicalDeviceVulkan14Properties
include::{chapters}/limits.adoc[tag=limits_desc]

These properties correspond to Vulkan 1.4 functionality.

// @TODO is this true for any of these property structures?
// The members of sname:VkPhysicalDeviceVulkan14Properties must: have the same
// values as the corresponding members of
// slink:VkPhysicalDevice*Properties.

include::{generated}/validity/structs/VkPhysicalDeviceVulkan14Properties.adoc[]
--
endif::VK_BASE_VERSION_1_4[]

ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_memory_capabilities,VK_KHR_external_semaphore_capabilities,VK_KHR_external_fence_capabilities[]
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_memory_capabilities[]
  * <<external-memory-handle-types-compatibility, External memory handle
    types compatibility>>
endif::VK_BASE_VERSION_1_1,VK_KHR_external_memory_capabilities[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_semaphore_capabilities[]
  * <<external-semaphore-handle-types-compatibility, External semaphore
    handle types compatibility>>
endif::VK_BASE_VERSION_1_1,VK_KHR_external_semaphore_capabilities[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_external_fence_capabilities[]
  * <<external-fence-handle-types-compatibility, External fence handle types
    compatibility>>
endif::VK_BASE_VERSION_1_1,VK_KHR_external_fence_capabilities[]
...
slink:VkPhysicalDeviceProperties2::pname:properties.pipelineCacheUUID.
...
--
endif::VK_BASE_VERSION_1_1,VK_KHR_external_memory_capabilities,VK_KHR_external_semaphore_capabilities,VK_KHR_external_fence_capabilities[]

ifdef::VK_BASE_VERSION_1_2,VK_KHR_driver_properties[]
[open,refpage='VkPhysicalDeviceDriverProperties',desc='Structure containing driver identification information',type='structs']
--
...
[open,refpage='VkDriverId',desc='Khronos driver IDs',type='enums']
--
...
[open,refpage='VkConformanceVersion',desc='Structure containing the conformance test suite version the implementation is compliant with',type='structs']
--
...
--
endif::VK_BASE_VERSION_1_2,VK_KHR_driver_properties[]
...
[open,refpage='VkPhysicalDeviceInfoPropertiesINTEL',desc='Structure containing the IP version of a physical device',type='structs']
--
The sname:VkPhysicalDeviceInfoPropertiesINTEL structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceInfoPropertiesINTEL.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:deviceIpVersionArch is the major architecture generation of the
    intellectual property (IP) block implemented by the physical device.
  * pname:deviceIpVersionRelease is the release of that architecture
    generation implemented by the physical device.
  * pname:deviceIpVersionRevision is the revision, or stepping, of that
...
pname:deviceIpVersionRelease is only meaningful relative to a given
pname:deviceIpVersionArch, and pname:deviceIpVersionRevision is only
meaningful relative to a given pname:deviceIpVersionRelease.
...
:refpage: VkPhysicalDeviceInfoPropertiesINTEL
include::{chapters}/limits.adoc[tag=limits_desc]

These are properties of the IP version of a physical device.

include::{generated}/validity/structs/VkPhysicalDeviceInfoPropertiesINTEL.adoc[]
--
endif::VK_INTEL_device_info[]
...
[open,refpage='VkPhysicalDeviceShaderIntegerDotProductProperties',desc='Structure containing information about integer dot product support for a physical device',type='structs']
--
...
include::{generated}/api/enums/VkPhysicalDeviceSchedulingControlsFlagBitsARM.adoc[]
  ...
  * ename:VK_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_SHADER_CORE_COUNT_ARM
    specifies that a slink:VkDeviceQueueShaderCoreControlCreateInfoARM
  ...
  * ename:VK_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_ARM
    specifies that a flink:vkCmdSetDispatchParametersARM command may: be
...
[open,refpage='VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM',desc='Structure containing scheduling control dispatch parameters properties of a physical device',type='structs']
--
The sname:VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM
structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM.adoc[]

  * [[limits-schedulingControlsMaxWarpsCount]]pname:schedulingControlsMaxWarpsCount
    specifies the maximum number of warps that a shader core can: run
    concurrently.
  * [[limits-schedulingControlsMaxQueuedWorkgroupBatchesCount]]pname:schedulingControlsMaxQueuedWorkgroupBatchesCount
    specifies the maximum number of workgroup batches that a shader core
    can: queue.
  * [[limits-schedulingControlsMaxWorkGroupBatchSize]]pname:schedulingControlsMaxWorkGroupBatchSize
    specifies the maximum size of workgroup batches that can: be requested
    using slink:VkDispatchParametersARM::pname:workGroupBatchSize.

:refpage: VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM
include::{chapters}/limits.adoc[tag=limits_desc]

If
slink:VkPhysicalDeviceSchedulingControlsPropertiesARM::pname:schedulingControlsFlags
does not contain
ename:VK_PHYSICAL_DEVICE_SCHEDULING_CONTROLS_DISPATCH_PARAMETERS_ARM then
pname:schedulingControlsMaxWarpCount and
pname:schedulingControlsMaxQueuedBatchesCount are undefined:.

include::{generated}/validity/structs/VkPhysicalDeviceSchedulingControlsDispatchParametersPropertiesARM.adoc[]
--
...
pname:pQueueFamilyProperties array, and on return the variable is
...
and/or, if the <<features-maintenance11,pname:maintenance11>> feature is
supported, transfer
endif::VK_KHR_maintenance11[]
operations, must: report [eq]#(1,1,1)# in pname:minImageTransferGranularity,
...
ifdef::VK_KHR_maintenance11[]
If the <<features-maintenance11,pname:maintenance11>> feature is supported,
slink:VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR::pname:optimalImageTransferGranularity
...
ifdef::VK_ARM_data_graph[]
  * ename:VK_QUEUE_DATA_GRAPH_BIT_ARM specifies that queues in this queue
    family support <<graphs-operations,data graph operations>>.
endif::VK_ARM_data_graph[]
ifdef::VK_BASE_VERSION_1_1[]
  * ename:VK_QUEUE_PROTECTED_BIT specifies that queues in this queue family
    support the ename:VK_DEVICE_QUEUE_CREATE_PROTECTED_BIT bit (see
    <<memory-protected-memory,Protected Memory>>).
...
[open,refpage='VkQueueFamilyGlobalPriorityProperties',desc='Return structure for queue family global priority information query',type='structs']
--
The slink:VkQueueFamilyGlobalPriorityProperties structure is defined as:

include::{generated}/api/structs/VkQueueFamilyGlobalPriorityProperties.adoc[]
...
include::{generated}/api/structs/VkQueueFamilyGlobalPriorityPropertiesEXT.adoc[]
  ...
  * pname:priorities is an array of ename:VK_MAX_GLOBAL_PRIORITY_SIZE
    elink:VkQueueGlobalPriority enums representing all supported global
    queue priorities in this queue family.
    The first pname:priorityCount elements of the array will be valid.

If the sname:VkQueueFamilyGlobalPriorityProperties structure is included in
the pname:pNext chain of the slink:VkQueueFamilyProperties2 structure passed
to flink:vkGetPhysicalDeviceQueueFamilyProperties2, it is filled in with the
...
elink:VkQueueGlobalPriority enums in ascending order.

[NOTE]
====
For example, returning pname:priorityCount as 3 with supported
pname:priorities as ename:VK_QUEUE_GLOBAL_PRIORITY_LOW,
ename:VK_QUEUE_GLOBAL_PRIORITY_MEDIUM and
ename:VK_QUEUE_GLOBAL_PRIORITY_REALTIME is not allowed.
====

include::{generated}/validity/structs/VkQueueFamilyGlobalPriorityProperties.adoc[]
--

[open,refpage='VK_MAX_GLOBAL_PRIORITY_SIZE',desc='Length of an array of global queue priorities',type='consts']
--
ename:VK_MAX_GLOBAL_PRIORITY_SIZE is the length of an array of
elink:VkQueueGlobalPriority enumerants representing supported queue
priorities, as returned in
slink:VkQueueFamilyGlobalPriorityProperties::pname:priorities.

include::{generated}/api/enums/VK_MAX_GLOBAL_PRIORITY_SIZE.adoc[]
...
[open,refpage='VkQueueFamilyOwnershipTransferPropertiesKHR',desc='Structure describing queue family ownership transfer properties',type='structs']
--
The slink:VkQueueFamilyOwnershipTransferPropertiesKHR structure is defined
as:

include::{generated}/api/structs/VkQueueFamilyOwnershipTransferPropertiesKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:optimalImageTransferToQueueFamilies is a bitmask of queue family
...
include::{generated}/validity/structs/VkQueueFamilyOwnershipTransferPropertiesKHR.adoc[]
--
endif::VK_KHR_maintenance9[]

ifdef::VK_KHR_maintenance11[]
[open,refpage='VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR',desc='Structure specifying the optimal image transfer granularity for a queue family',type='structs']
--
The slink:VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR
structure is defined as:

include::{generated}/api/structs/VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:optimalImageTransferGranularity is the optimal granularity for
...
The value returned in pname:optimalImageTransferGranularity has a unit of
compressed texel blocks for images having a block-compressed format, and a
unit of texels otherwise.

Possible values of pname:optimalImageTransferGranularity are:

  * [eq]#(0,0,0)# specifies that an image copy operation is optimal only
    when copying whole mip levels, i.e. all of the following conditions are
    met:
  ** The pname:x, pname:y, and pname:z members of a slink:VkOffset3D are
     zero.
  ** The pname:width, pname:height, and pname:depth members of a
     slink:VkExtent3D parameter match the width, height, and depth of the
  ...
  * [eq]#(A~x~, A~y~, A~z~)# where [eq]#A~x~#, [eq]#A~y~#, and [eq]#A~z~#
    ...
    are met:
  ** pname:width of a slink:VkExtent3D parameter is an integer multiple of
     [eq]#A~x~#, or else [eq]#pname:x {plus} pname:width# equals the width
     of the image subresource corresponding to the parameter.
  ** pname:height of a slink:VkExtent3D parameter is an integer multiple of
     [eq]#A~y~#, or else [eq]#pname:y {plus} pname:height# equals the height
     of the image subresource corresponding to the parameter.
  ** pname:depth of a slink:VkExtent3D parameter is an integer multiple of
     [eq]#A~z~#, or else [eq]#pname:z {plus} pname:depth# equals the depth
     of the image subresource corresponding to the parameter.
  ** If the format of the image corresponding to the parameters is one of
     the block-compressed formats then for the purposes of the above
     calculations the granularity must: be scaled up by the compressed texel
...
cost for copies not aligned to pname:optimalImageTransferGranularity.
====

include::{generated}/validity/structs/VkQueueFamilyOptimalImageTransferGranularityPropertiesKHR.adoc[]
--
endif::VK_KHR_maintenance11[]

ifdef::VK_ARM_performance_counters_by_region[]
[open,refpage='vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM',desc='Reports properties of the by region performance counters available on a queue family of a device',type='protos']
--
:refpage: vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM

To enumerate the by region performance counters available on a queue family
of a physical device, call:

include::{generated}/api/protos/vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM.adoc[]
  ...
  * pname:pCounterCount is a pointer to an integer related to the number of
    counters available or queried, as described below.
  * pname:pCounters is either `NULL` or a pointer to an array of
    slink:VkPerformanceCounterARM structures.
  * pname:pCounterDescriptions is either `NULL` or a pointer to an array of
    slink:VkPerformanceCounterDescriptionARM structures.
...
include::{generated}/validity/protos/vkEnumeratePhysicalDeviceQueueFamilyPerformanceCountersByRegionARM.adoc[]
--

[open,refpage='VkPerformanceCounterARM',desc='Structure providing information about a counter',type='structs']
--
The sname:VkPerformanceCounterARM structure is defined as:

include::{generated}/api/structs/VkPerformanceCounterARM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:counterID is an identifier for the counter of the physical device.

include::{generated}/validity/structs/VkPerformanceCounterARM.adoc[]
--

[open,refpage='VkPerformanceCounterDescriptionARM',desc='Structure providing more detailed information about a counter',type='structs']
--
The sname:VkPerformanceCounterDescriptionARM structure is defined as:

include::{generated}/api/structs/VkPerformanceCounterDescriptionARM.adoc[]
...
include::{generated}/validity/structs/VkPerformanceCounterDescriptionARM.adoc[]
--

[open,refpage='VkPerformanceCounterDescriptionFlagsARM',desc='Reserved for future use',type='flags']
--
include::{generated}/api/flags/VkPerformanceCounterDescriptionFlagsARM.adoc[]

tname:VkPerformanceCounterDescriptionFlagsARM is a bitmask type for setting
...
ifdef::VK_BASE_VERSION_1_1,VK_KHR_device_group_creation[]
...
--
endif::VK_BASE_VERSION_1_1,VK_KHR_device_group_creation[]
...
include::{generated}/api/structs/VkDeviceCreateInfo.adoc[]
  ...
  * pname:pQueueCreateInfos is a pointer to an array of
    ...
    Refer to the <<devsandqueues-queue-creation,Queue Creation>> section
    below for further details.
  * pname:enabledLayerCount is legacy and not used.
    Implementations must: not access this parameter.
    It must: be 0.
    See <<legacy-devicelayers>>.
  * pname:ppEnabledLayerNames is legacy and not used.
    Implementations must: not access this parameter.
    It must: be `NULL`.
    See <<legacy-devicelayers>>.
...
****
  * [[VUID-VkDeviceCreateInfo-queueFamilyIndex-02802]]
    The combination of the values in the pname:queueFamilyIndex and
    pname:flags members of each element of pname:pQueueCreateInfos must: be
    unique within pname:pQueueCreateInfos
ifdef::VK_BASE_VERSION_1_1[]
...
ifdef::VK_BASE_VERSION_1_4,VK_KHR_global_priority,VK_EXT_global_priority[]
  * [[VUID-VkDeviceCreateInfo-pQueueCreateInfos-06654]]
    ...
    including a slink:VkDeviceQueueGlobalPriorityCreateInfo structure in the
    pname:pNext chain, or by the implicit default value
endif::VK_BASE_VERSION_1_4,VK_KHR_global_priority,VK_EXT_global_priority[]
endif::VK_BASE_VERSION_1_1[]
ifdef::VK_BASE_VERSION_1_1,VK_KHR_get_physical_device_properties2[]
...
ifdef::VK_BASE_VERSION_1_4[]
  * [[VUID-VkDeviceCreateInfo-pNext-10360]]
    If the pname:pNext chain includes a
    slink:VkPhysicalDeviceVulkan14Features structure, then it must: not
    include a slink:VkPhysicalDeviceGlobalPriorityQueryFeatures,
    slink:VkPhysicalDeviceShaderSubgroupRotateFeatures,
    slink:VkPhysicalDeviceShaderFloatControls2Features,
    slink:VkPhysicalDeviceShaderExpectAssumeFeatures,
    slink:VkPhysicalDeviceLineRasterizationFeatures,
    slink:VkPhysicalDeviceVertexAttributeDivisorFeatures,
    slink:VkPhysicalDeviceIndexTypeUint8Features,
    slink:VkPhysicalDeviceDynamicRenderingLocalReadFeatures,
    slink:VkPhysicalDeviceMaintenance5Features,
    slink:VkPhysicalDeviceMaintenance6Features,
    slink:VkPhysicalDevicePipelineProtectedAccessFeatures,
    slink:VkPhysicalDevicePipelineRobustnessFeatures, or
    slink:VkPhysicalDeviceHostImageCopyFeatures structure
ifdef::VK_KHR_push_descriptor[]
  * [[VUID-VkDeviceCreateInfo-ppEnabledExtensionNames-10858]]
    If pname:ppEnabledExtensionNames contains `"VK_KHR_push_descriptor"` and
    the pname:pNext chain includes a slink:VkPhysicalDeviceVulkan14Features
    structure, then
    sname:VkPhysicalDeviceVulkan14Features::pname:pushDescriptor must: be
    ename:VK_TRUE
...
ifdef::VK_EXT_shader_image_atomic_int64[]
  * [[VUID-VkDeviceCreateInfo-None-04896]]
    ...
    pname:sparseImageInt64Atomics>> feature is enabled,
...
ifdef::VK_EXT_shader_atomic_float[]
  * [[VUID-VkDeviceCreateInfo-None-04897]]
    ...
    pname:sparseImageFloat32Atomics>> feature is enabled,
    <<features-shaderImageFloat32Atomics, pname:shaderImageFloat32Atomics>>
    must: be enabled
  * [[VUID-VkDeviceCreateInfo-None-04898]]
    If the <<features-sparseImageFloat32AtomicAdd,
    pname:sparseImageFloat32AtomicAdd>> feature is enabled,
...
ifdef::VK_EXT_shader_atomic_float2[]
  * [[VUID-VkDeviceCreateInfo-sparseImageFloat32AtomicMinMax-04975]]
    If the <<features-sparseImageFloat32AtomicMinMax,
    pname:sparseImageFloat32AtomicMinMax>> feature is enabled,
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_descriptor_indexing[]
  * [[VUID-VkDeviceCreateInfo-robustBufferAccess-10247]]
    ...
    is enabled, and <<limits-robustBufferAccessUpdateAfterBind,
    pname:robustBufferAccessUpdateAfterBind>> is ename:VK_FALSE, then
    ...
    pname:descriptorBindingUniformTexelBufferUpdateAfterBind>>, and
    <<features-descriptorBindingStorageTexelBufferUpdateAfterBind,
    pname:descriptorBindingStorageTexelBufferUpdateAfterBind>> must: not be
    enabled
...
ifdef::VK_AMD_shader_fragment_mask[]
  * [[VUID-VkDeviceCreateInfo-None-08095]]
    ...
    enabled, pname:ppEnabledExtensionNames must: not contain
...
ifdef::VK_ARM_scheduling_controls[]
  ...
  * [[VUID-VkDeviceCreateInfo-None-10778]]
    {empty}
ifdef::VK_KHR_maintenance9[]
    If the <<features-maintenance9,maintenance9>> feature is not supported,
endif::VK_KHR_maintenance9[]
...
ifdef::VK_QCOM_data_graph_model[]
  * [[VUID-VkDeviceCreateInfo-queueFamilyIndex-11831]]
    If any element of pQueueCreateInfos specifies a pname:queueFamilyIndex
    that supports ename:VK_QUEUE_DATA_GRAPH_BIT_ARM and that
    pname:queueFamilyIndex enumerates an engine through
    flink:vkGetPhysicalDeviceQueueFamilyDataGraphPropertiesARM with
    pname:type
    ...
    a slink:VkPhysicalDeviceDataGraphModelFeaturesQCOM structure must: be
    included in pname:pNext with <<features-dataGraphModelQCOM,
    dataGraphModel>> set to ename:VK_TRUE
endif::VK_QCOM_data_graph_model[]
  * [[VUID-VkDeviceCreateInfo-enabledLayerCount-12384]]
    pname:enabledLayerCount must: be 0
  * [[VUID-VkDeviceCreateInfo-ppEnabledLayerNames-12385]]
    pname:ppEnabledLayerNames must: be `NULL`
****
...
include::{generated}/api/funcpointers/PFN_vkDeviceMemoryReportCallbackEXT.adoc[]
  ...
  * pname:pUserData is the application-defined user data pointer, equal to
    the value of
    slink:VkDeviceDeviceMemoryReportCreateInfoEXT::pname:pUserData specified
    when the slink:VkDevice object was created.
...
pname:memoryObjectId must: be unique system wide.
...
[open,refpage='VkDevicePrivateDataCreateInfo',desc='Reserve private data slots',type='structs']
--
...
[open,refpage='VkDevicePipelineBinaryInternalCacheControlKHR',desc='Structure specifying parameter to disable the internal pipeline cache',type='structs']
--
To disable the implementation's internal pipeline cache, add a
slink:VkDevicePipelineBinaryInternalCacheControlKHR structure to the
pname:pNext chain of the slink:VkDeviceCreateInfo structure.

include::{generated}/api/structs/VkDevicePipelineBinaryInternalCacheControlKHR.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:disableInternalCache specifies whether or not to disable the
    implementation's internal pipeline cache.

If the sname:VkDeviceCreateInfo::pname:pNext chain does not include this
structure, then pname:disableInternalCache defaults to ename:VK_FALSE.

.Valid Usage
****
  * [[VUID-VkDevicePipelineBinaryInternalCacheControlKHR-disableInternalCache-09602]]
    If
    slink:VkPhysicalDevicePipelineBinaryPropertiesKHR::pname:pipelineBinaryInternalCacheControl
    is ename:VK_FALSE, pname:disableInternalCache must: be ename:VK_FALSE
****

include::{generated}/validity/structs/VkDevicePipelineBinaryInternalCacheControlKHR.adoc[]
--
...
include::{generated}/api/structs/VkDeviceObjectReservationCreateInfo.adoc[]
  ...
  * pname:samplerYcbcrConversionRequestCount is the requested maximum number
    ...
    time.
  * pname:surfaceRequestCount is legacy and implementations must: ignore it.
  ...
  * pname:displayModeRequestCount is legacy and implementations must: ignore
    it.
...
references on where to find more information:
  ...
  * Creation, destruction, and management of graphics state.
    See <<pipelines,Pipelines>> and <<descriptors,Resource Descriptors>>,
...
ftext:vkFree* commands that were created using that device as the first
parameter of the corresponding ftext:vkCreate* or ftext:vkAllocate* command.
...
****
  * [[VUID-vkDestroyDevice-device-05137]]
    All child objects created on pname:device that can be destroyed or freed
    must: have been destroyed or freed prior to destroying pname:device
ifndef::VKSC_VERSION_1_0[]
...
the slink:VkDevice that they were created from.
...
slink:VkQueueFamilyProperties::pname:queueFlags member.
Applications may: create such queues and submit <<devsandqueues-submission,
queue submission commands>> to them without enabling the corresponding
feature or extension, but must: not utilize the specific functionality that
they did not enable.

For example, <<sparsememory, sparse memory management operations>> can: be
performed on queues from queue families exposing the
ename:VK_QUEUE_SPARSE_BINDING_BIT bit, provided the
<<features-sparseBinding, sparseBinding>> feature is enabled.
If a queue family supports both the ename:VK_QUEUE_SPARSE_BINDING_BIT and
ename:VK_QUEUE_TRANSFER_BIT bits, applications may: create a queue from this
family and issue transfer operations without enabling the
<<features-sparseBinding, sparseBinding>> feature.
...
ifdef::VK_KHR_internally_synchronized_queues[]
  * [[VUID-VkDeviceQueueCreateInfo-internallySynchronizedQueues-12348]]
    If the <<features-internallySynchronizedQueues,
    pname:internallySynchronizedQueues>> feature is not enabled, pname:flags
    must: not include
...
ifdef::VK_KHR_internally_synchronized_queues[]
  * ename:VK_DEVICE_QUEUE_CREATE_INTERNALLY_SYNCHRONIZED_BIT_KHR specifies
...
ifdef::VK_BASE_VERSION_1_4,VK_KHR_global_priority,VK_EXT_global_priority[]
[open,refpage='VkDeviceQueueGlobalPriorityCreateInfo',desc='Specify a system wide priority',type='structs']
--
Queues can: be created with a system-wide priority by adding a
sname:VkDeviceQueueGlobalPriorityCreateInfo structure to the pname:pNext
chain of slink:VkDeviceQueueCreateInfo.

The sname:VkDeviceQueueGlobalPriorityCreateInfo structure is defined as:

include::{generated}/api/structs/VkDeviceQueueGlobalPriorityCreateInfo.adoc[]
...
include::{generated}/api/structs/VkDeviceQueueGlobalPriorityCreateInfoEXT.adoc[]
  ...
  * pname:globalPriority is the system-wide priority associated to these
    queues as specified by elink:VkQueueGlobalPriority

Queues created without specifying
sname:VkDeviceQueueGlobalPriorityCreateInfo will default to
ename:VK_QUEUE_GLOBAL_PRIORITY_MEDIUM.

include::{generated}/validity/structs/VkDeviceQueueGlobalPriorityCreateInfo.adoc[]
--

[open,refpage='VkQueueGlobalPriority',desc='Values specifying a system-wide queue priority',type='enums']
--
Possible values of
slink:VkDeviceQueueGlobalPriorityCreateInfo::pname:globalPriority,
specifying a system-wide priority level are:

include::{generated}/api/enums/VkQueueGlobalPriority.adoc[]
...
In this scenario ename:VK_ERROR_NOT_PERMITTED is returned.
...
slink:VkQueueFamilyGlobalPriorityProperties, the driver implementation must:
...
****
  ...
  * [[VUID-vkGetDeviceQueue-flags-01841]]
    slink:VkDeviceQueueCreateInfo::pname:flags must: have been zero when
    pname:device was created
****
...
[[devsandqueues-perfhint]]
==== Queue Performance Hints

Each queue has performance hint state, which defaults to
ename:VK_PERF_HINT_TYPE_DEFAULT_QCOM when creating them with device.
...
[open,refpage='vkQueueSetPerfHintQCOM',desc='Set a performance hint on a queue',type='protos']
--
To set a performance hint on a slink:VkQueue object, call:

include::{generated}/api/protos/vkQueueSetPerfHintQCOM.adoc[]

  * pname:queue is the queue to set the performance hint on.
  * pname:pPerfHintInfo is a pointer to a slink:VkPerfHintInfoQCOM
    structure, describing the performance hint to set.

.Valid Usage
****
  * [[VUID-vkQueueSetPerfHintQCOM-queuePerfHint-12387]]
    The <<features-queuePerfHint,pname:queuePerfHint>> feature must: be
    enabled
  * [[VUID-vkQueueSetPerfHintQCOM-queue-12388]]
    pname:queue must: support at least one of the queue types specified in
    slink:VkPhysicalDeviceQueuePerfHintPropertiesQCOM::pname:supportedQueues
****

include::{generated}/validity/protos/vkQueueSetPerfHintQCOM.adoc[]
--

[open,refpage='VkPerfHintInfoQCOM',desc='Structure specifying the parameters used for setting a performance hint on a queue',type='structs']
--
The sname:VkPerfHintInfoQCOM structure is defined as:

include::{generated}/api/structs/VkPerfHintInfoQCOM.adoc[]

  * pname:sType is a elink:VkStructureType value identifying this structure.
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * pname:type is a elink:VkPerfHintTypeQCOM value indicating the type of
    performance hint to apply.
  * pname:scale is a normalized fixed-point scale factor.

The device has two global frequency constraints, `f~min~` and `f~max~`, that
can be influenced by the ename:VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM,
ename:VK_PERF_HINT_TYPE_FREQUENCY_MAX_QCOM, and
ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM performance hints.
These constraints determine the range of clock frequencies that the platform
performance algorithms may: select from.
If no constraints are set, `f~min~` and `f~max~` are set to the minimum and
maximum frequencies the device can support, `F~min~` and `F~max~`
respectively.

The `f~min~` constraint applied by
ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM is calculated with the
following:

  {empty}:: latexmath:[f_{min} = \lfloor\frac{scale}{100} \times
            F_{max}\rfloor]

The implementation rounds `f~min~` down to the next available lower
frequency the device supports, clamped to `F~min~`.
...
These are listed in order of highest rank to lowest:
  ...
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_MAX_QCOM
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM and pname:scale equal to
    `100`
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM and pname:scale equal to
    `99`
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM and pname:scale equal to
  ...
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM and pname:scale equal to
    `0`
  * ename:VK_PERF_HINT_TYPE_DEFAULT_QCOM
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM

[NOTE]
====
This means that ename:VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM only takes effect
if all of the device's other active queues running on the host also have the
ename:VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM hint applied.

If any queue is active that never had a performance hint applied and
therefore is in the ename:VK_PERF_HINT_TYPE_DEFAULT_QCOM state, it will
...
****
  * [[VUID-VkPerfHintInfoQCOM-type-12389]]
    If pname:type is not ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM,
    pname:scale must: equal `0`
  * [[VUID-VkPerfHintInfoQCOM-scale-12390]]
    pname:scale must: be less than or equal to `100`
****

include::{generated}/validity/structs/VkPerfHintInfoQCOM.adoc[]
--

[open,refpage='VkPerfHintTypeQCOM',desc='Specifies the performance hint type',type='enums']
--
Possible values of slink:VkPerfHintInfoQCOM::pname:type, specifying the type
of performance hint to apply, are:

include::{generated}/api/enums/VkPerfHintTypeQCOM.adoc[]

  * ename:VK_PERF_HINT_TYPE_DEFAULT_QCOM resets the performance hint state
    back to default for the queue.
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_MIN_QCOM specifies the queue should:
    prioritize power and sets the frequency constraints `f~min~` and
    `f~max~` to `F~min~`.
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_MAX_QCOM specifies the queue should:
    prioritize performance and sets the frequency constraints `f~min~` and
    `f~max~` to `F~max~`.
  * ename:VK_PERF_HINT_TYPE_FREQUENCY_SCALED_QCOM specifies the queue
    should: be balanced between performance and power and sets the frequency
    constraint `f~min~` by applying a scale factor to `F~max~`.
    No constraint is applied to `f~max~`.
--
