...
members of slink:VkImageSubresource2EXT::pname:imageSubresource will have
...
ifdef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  ...
  * [[VUID-VkImageViewCreateInfo-subresourceRange-07818]]
    If pname:subresourceRange.aspectMask contains any of
    ename:VK_IMAGE_ASPECT_PLANE_0_BIT, ename:VK_IMAGE_ASPECT_PLANE_1_BIT, or
    ename:VK_IMAGE_ASPECT_PLANE_2_BIT, then it must: only have a single bit
    set
endif::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
ifndef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
If this image view is not accessed through a
ename:VK_DESCRIPTOR_TYPE_STORAGE_IMAGE, sname:VkImageViewSlicedCreateInfoEXT
is ignored.
pname:sliceOffset is considered to be equal to 0, and pname:sliceCount is
considered to be equal to ename:VK_REMAINING_3D_SLICES_EXT.
