...
Once memory has been bound to that buffer, it is populated by commands such
as flink:vkCmdBuildAccelerationStructuresKHR,
...
Once memory has been bound to that buffer, it is populated by commands such
as flink:vkCmdBuildMicromapsEXT, flink:vkBuildMicromapsEXT,
flink:vkCmdCopyMicromapEXT, and flink:vkCopyMicromapEXT.
