...
ifdef::VK_EXT_buffer_device_address[]
    ...
    feature
ifdef::VK_VERSION_1_2,VK_KHR_buffer_device_address[or the]
endif::VK_EXT_buffer_device_address[]
ifdef::VK_VERSION_1_2,VK_KHR_buffer_device_address[]
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkBufferCreateInfo-tileMemoryHeap-10731]]
    If the <<features-tileMemoryHeap, pname:tileMemoryHeap>> feature is not
    enabled, pname:usage must: not include
    ename:VK_BUFFER_USAGE_TILE_MEMORY_QCOM
  * [[VUID-VkBufferCreateInfo-usage-10732]]
    If pname:usage includes ename:VK_BUFFER_USAGE_TILE_MEMORY_QCOM, then
  pname:flags must: not contain any of the following bits
  ** ename:VK_BUFFER_CREATE_SPARSE_BINDING_BIT
  ** ename:VK_BUFFER_CREATE_SPARSE_RESIDENCY_BIT
  ** ename:VK_BUFFER_CREATE_SPARSE_ALIASED_BIT
  ** ename:VK_BUFFER_CREATE_PROTECTED_BIT
ifdef::VK_VERSION_1_2[** ename:VK_BUFFER_CREATE_DEVICE_ADDRESS_CAPTURE_REPLAY_BIT]
...
ifdef::VK_KHR_video_maintenance1[** ename:VK_BUFFER_CREATE_VIDEO_PROFILE_INDEPENDENT_BIT_KHR]
  * [[VUID-VkBufferCreateInfo-usage-10733]]
    If pname:usage includes ename:VK_BUFFER_USAGE_TILE_MEMORY_QCOM, then
...
ifdef::VK_VERSION_1_2[** ename:VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT]
  ** and if
...
ifdef::VK_VERSION_1_4,VK_KHR_maintenance5[]
[open,refpage='VkBufferUsageFlags2CreateInfo',desc='Extended buffer usage flags',type='structs',alias='VkBufferUsageFlags2CreateInfoKHR']
--
...
[open,refpage='VkBufferUsageFlagBits2',desc='Bitmask controlling how a pipeline is created',type='enums',alias='VkBufferUsageFlagBits2KHR']
--
...
// are mirrored in VkBufferUsageFlagBits2/VkBufferUsageFlagBits
...
ifdef::VK_QCOM_tile_memory_heap[]
  * ename:VK_BUFFER_USAGE_2_TILE_MEMORY_QCOM specifies that the buffer can:
...
[open,refpage='VkBufferUsageFlags2',desc='Bitmask of VkBufferUsageFlagBits2',type='flags',alias='VkBufferUsageFlags2KHR']
--
...
ifdef::VK_QCOM_tile_memory_heap[]
  * ename:VK_BUFFER_USAGE_TILE_MEMORY_QCOM specifies that the buffer can: be
    bound to sname:VkDeviceMemory allocated from a slink:VkMemoryHeap with
...
ifdef::VK_QCOM_tile_memory_heap[]
Images created with usage including ename:VK_IMAGE_USAGE_TILE_MEMORY_QCOM
have further restrictions on their limits and capabilities compared to
images created without this bit.
Creation of images with usage including
ename:VK_IMAGE_USAGE_TILE_MEMORY_QCOM may: not be supported unless
...
* pname:usage includes ename:VK_IMAGE_USAGE_TILE_MEMORY_QCOM and any valid
  combination of the following ename:VK_IMAGE_USAGE_SAMPLED_BIT,
...
ifdef::VK_EXT_image_2d_view_of_3d[]
  ...
  * [[VUID-VkImageCreateInfo-imageType-10197]]
    If pname:flags contains
    ename:VK_IMAGE_CREATE_2D_VIEW_COMPATIBLE_BIT_EXT, pname:flags must: not
    include ename:VK_IMAGE_CREATE_SPARSE_ALIASED_BIT,
    ename:VK_IMAGE_CREATE_SPARSE_BINDING_BIT, or
    ename:VK_IMAGE_CREATE_SPARSE_RESIDENCY_BIT
...
ifdef::VK_VERSION_1_4,VK_EXT_host_image_copy[]
  ...
  * [[VUID-VkImageCreateInfo-usage-10245]]
    If pname:usage includes ename:VK_IMAGE_USAGE_HOST_TRANSFER_BIT_EXT, then
    the <<features-hostImageCopy, pname:hostImageCopy>> feature must: be
    enabled
endif::VK_VERSION_1_4,VK_EXT_host_image_copy[]
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkImageCreateInfo-tileMemoryHeap-10734]]
    If the <<features-tileMemoryHeap, pname:tileMemoryHeap>> feature is not
    enabled, pname:usage must: not include
    ename:VK_IMAGE_USAGE_TILE_MEMORY_QCOM
endif::VK_QCOM_tile_memory_heap[]
...
ifdef::VK_VERSION_1_4,VK_KHR_maintenance5[flink:vkGetImageSubresourceLayout2 or]
...
ifdef::VK_QCOM_tile_memory_heap[]
  * ename:VK_IMAGE_USAGE_TILE_MEMORY_QCOM specifies that the image can: be
    bound to sname:VkDeviceMemory allocated from a slink:VkMemoryHeap with
    the ename:VK_MEMORY_HEAP_TILE_MEMORY_BIT_QCOM property.
endif::VK_QCOM_tile_memory_heap[]
ifdef::VK_VERSION_1_4,VK_EXT_host_image_copy[]
...
ifdef::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_host_image_copy,VK_EXT_image_compression_control[]
[open,refpage='vkGetImageSubresourceLayout2',desc='Retrieve information about an image subresource',type='protos',alias='vkGetImageSubresourceLayout2KHR vkGetImageSubresourceLayout2EXT']
--
...
ifdef::VK_KHR_maintenance5,VK_EXT_host_image_copy,VK_EXT_image_compression_control[or the equivalent command]
endif::VK_VERSION_1_4[]

ifdef::VK_KHR_maintenance5[]
include::{generated}/api/protos/vkGetImageSubresourceLayout2KHR.adoc[]

ifdef::VK_EXT_host_image_copy,VK_EXT_image_compression_control[or the equivalent command]
endif::VK_KHR_maintenance5[]
...
[open,refpage='VkImageSubresource2',desc='Structure specifying an image subresource',type='structs',alias='VkImageSubresource2KHR VkImageSubresource2EXT']
--
...
[open,refpage='VkSubresourceLayout2',desc='Structure specifying subresource layout',type='structs',alias='VkSubresourceLayout2KHR VkSubresourceLayout2EXT']
--
Information about the layout of the image subresource is returned in a
...
ifdef::VK_VERSION_1_4,VK_EXT_host_image_copy[]
[open,refpage='VkSubresourceHostMemcpySize',desc='Memory size needed to copy to or from an image on the host with VK_HOST_IMAGE_COPY_MEMCPY',type='structs',alias='VkSubresourceHostMemcpySizeEXT']
--
...
ename:VK_HOST_IMAGE_COPY_MEMCPY flag is specified, add a
...
endif::VK_VERSION_1_4,VK_KHR_maintenance5,VK_EXT_host_image_copy,VK_EXT_image_compression_control[]

ifdef::VK_VERSION_1_4,VK_KHR_maintenance5[]
[open,refpage='vkGetDeviceImageSubresourceLayout',desc='Retrieve information about an image subresource without an image object',type='protos',alias='vkGetDeviceImageSubresourceLayoutKHR']
--
...
[open,refpage='VkDeviceImageSubresourceInfo',desc='Image creation information for querying subresource layout',type='structs',alias='VkDeviceImageSubresourceInfoKHR']
--
...
ifdef::VK_KHR_video_encode_quantization_map[]
  * ename:VK_IMAGE_LAYOUT_VIDEO_ENCODE_QUANTIZATION_MAP_KHR must: only be
    ...
    ename:VK_IMAGE_USAGE_VIDEO_ENCODE_EMPHASIS_MAP_BIT_KHR usage bit
    enabled.
endif::VK_KHR_video_encode_quantization_map[]
...
ename:VK_IMAGE_LAYOUT_ATTACHMENT_FEEDBACK_LOOP_OPTIMAL_EXT adds extra
guarantees which ename:VK_IMAGE_LAYOUT_GENERAL does not.
endif::VK_EXT_attachment_feedback_loop_layout[]
====
--
...
flag,
ifdef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
and if the pname:format of the image is not <<formats-multiplanar,
multi-planar>>
endif::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
flink:vkCreateImageView, an <<glossary-identically-defined,identically
defined>> slink:VkSamplerYcbcrConversion object must: be used when sampling
the image.
...
If pname:image was created with the ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT
and the image has a <<formats-multiplanar, multi-planar format>>, and if
pname:subresourceRange.aspectMask is ename:VK_IMAGE_ASPECT_PLANE_0_BIT,
ename:VK_IMAGE_ASPECT_PLANE_1_BIT, or ename:VK_IMAGE_ASPECT_PLANE_2_BIT,
pname:format must: be <<formats-compatible-planes,compatible>> with the
corresponding plane of the image, and the sampler to be used with the image
view must: not enable <<samplers-YCbCr-conversion,sampler {YCbCr}
conversion>>.
...
ifdef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-VkImageViewCreateInfo-image-01762]]
    ...
    ename:VK_IMAGE_CREATE_MUTABLE_FORMAT_BIT flag,
// ifdef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
    or if the pname:format of the pname:image is a <<formats-multiplanar,
    multi-planar format>> and if pname:subresourceRange.aspectMask is
    ename:VK_IMAGE_ASPECT_COLOR_BIT,
// endif::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
...
ifdef::VK_QNX_external_memory_screen_buffer[]
  ...
  ** ename:VK_FORMAT_FEATURE_2_STORAGE_READ_WITHOUT_FORMAT_BIT if the format
     is one of the <<formats-without-shader-storage-format,extended storage
     formats>> and the <<features-shaderStorageImageReadWithoutFormat,
     pname:shaderStorageImageReadWithoutFormat>> is enabled.
  ** ename:VK_FORMAT_FEATURE_2_STORAGE_WRITE_WITHOUT_FORMAT_BIT if the
     format is one of the <<formats-without-shader-storage-format,extended
     storage formats>> and the
     <<features-shaderStorageImageWriteWithoutFormat,
     pname:shaderStorageImageWriteWithoutFormat>> is enabled.
endif::VK_VERSION_1_3,VK_KHR_format_feature_flags2[]
ifdef::VK_ANDROID_external_memory_android_hardware_buffer[]
...
extension` are represented by sname:VkAccelerationStructureKHR handles:
...
****
  ...
  * [[VUID-VkAccelerationStructureCreateInfoKHR-deviceAddress-10393]]
    If pname:deviceAddress is not zero, it must: be a valid device address
    obtained from flink:vkGetAccelerationStructureDeviceAddressKHR
...
ifdef::VK_KHR_ray_tracing_position_fetch[]
  * ename:VK_BUILD_ACCELERATION_STRUCTURE_ALLOW_DATA_ACCESS_KHR specifies
...
include::{generated}/api/protos/vkCreateMicromapEXT.adoc[]
  ...
  * pname:device is the logical device that creates the micromap object.
...
ifdef::VK_VERSION_1_4,VK_KHR_maintenance6[]
[open,refpage='VkBindMemoryStatus',desc='Structure specifying where to return memory binding status',type='structs',alias='VkBindMemoryStatusKHR']
--
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-vkBindImageMemory-memory-10736]]
    ...
    a call to fname:vkGetImageMemoryRequirements with pname:image
endif::VK_QCOM_tile_memory_heap[]
...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-vkBindImageMemory-memory-10738]]
    ...
    member of the sname:VkTileMemoryRequirementsQCOM structure returned from
    a call to fname:vkGetImageMemoryRequirements with pname:image must: be
