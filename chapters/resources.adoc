...
ifdef::VK_EXT_descriptor_buffer[]
  ...
  * [[VUID-VkBufferCreateInfo-usage-08101]]
    ...
    <<features-descriptorBufferPushDescriptors,descriptorBufferPushDescriptors>>
    feature must: be enabled
  * [[VUID-VkBufferCreateInfo-usage-08102]]
    If pname:usage includes
    ename:VK_BUFFER_USAGE_PUSH_DESCRIPTORS_DESCRIPTOR_BUFFER_BIT_EXT
    <<limits-bufferlessPushDescriptors,sname:VkPhysicalDeviceDescriptorBufferPropertiesEXT::pname:bufferlessPushDescriptors>>
