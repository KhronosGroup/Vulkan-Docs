...
ifdef::VK_KHR_video_decode_queue[]
  * [[VUID-VkBufferCreateInfo-usage-04813]]
    ...
    chain must: include a valid slink:VkVideoProfileListInfoKHR structure
    with pname:profileCount greater than `0` and pname:pProfiles including
    at least one slink:VkVideoProfileInfoKHR::pname:videoCodecOperation
...
ifdef::VK_KHR_video_queue[]
  * [[VUID-VkImageCreateInfo-pNext-06811]]
    ...
    structure then pname:supportedVideoFormat must: be ename:VK_TRUE
endif::VK_KHR_video_queue[]
ifdef::VK_FUCHSIA_buffer_collection[]
...
ifdef::VK_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  ...
  * [[VUID-VkImageCreateInfo-pNext-06744]]
    If the pname:pNext chain includes a slink:VkImageCompressionControlEXT
    structure, pname:format is a not
    <<formats-requiring-sampler-ycbcr-conversion,multi-planar>> format, and
    slink:VkImageCompressionControlEXT::pname:flags includes
    ename:VK_IMAGE_COMPRESSION_FIXED_RATE_EXPLICIT_EXT, then
    slink:VkImageCompressionControlEXT::pname:compressionControlPlaneCount
...
include::{generated}/api/structs/VkImageCompressionControlEXT.txt[]
...
include::{generated}/validity/structs/VkImageCompressionControlEXT.txt[]
...
include::{generated}/api/enums/VkImageCompressionFlagBitsEXT.txt[]
...
--
include::{generated}/api/flags/VkImageCompressionFixedRateFlagsEXT.txt[]
...
include::{generated}/api/enums/VkImageCompressionFixedRateFlagBitsEXT.txt[]
...
slink:VkImageCompressionControlEXT::pFixedRateFlags for a plane,
...
include::{generated}/api/structs/VkImageCompressionPropertiesEXT.txt[]
...
include::{generated}/validity/structs/VkImageCompressionPropertiesEXT.txt[]
--
endif::VK_EXT_image_compression_control[]
...
ifdef::VK_KHR_video_decode_queue[]
  ...
  * ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR specifies that
    ...
    output, indicating this by returning ename:VK_ERROR_FORMAT_NOT_SUPPORTED
    to any flink:vkGetPhysicalDeviceVideoFormatPropertiesKHR call with both
    ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR and
    ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR usage bits, then
    ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR must: not be combined with
    any other etext:VK_IMAGE_USAGE_* flags.
    Otherwise, ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR must: be
    combined with ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR, if the DPB
    ...
    resources can: be used as <<reference-picture,reference pictures>> only
    ...
    and
    slink:VkVideoDecodeInfoKHR::pname:dstPictureResource.imageViewBinding.
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
  * ename:VK_IMAGE_USAGE_VIDEO_ENCODE_SRC_BIT_KHR specifies that the image
    can: be used as an <<encode-input-picture, input picture>> for
  ...
  * ename:VK_IMAGE_USAGE_VIDEO_ENCODE_DPB_BIT_KHR specifies that
    ...
    as an output to hold a <<reconstructed-picture,reconstructed picture>>
    that can: subsequently act as an input <<reference-picture,reference
    picture>>.
endif::VK_KHR_video_encode_queue[]
...
.Valid Usage
****
include::{chapters}/commonvalidity/get_image_subresource_layout_common.txt[]
****
...
include::{generated}/api/protos/vkGetImageSubresourceLayout2EXT.txt[]
...
include::{generated}/validity/protos/vkGetImageSubresourceLayout2EXT.txt[]
--
...
include::{generated}/api/structs/VkImageSubresource2EXT.txt[]
...
include::{generated}/validity/structs/VkImageSubresource2EXT.txt[]
--
...
include::{generated}/api/structs/VkSubresourceLayout2EXT.txt[]
...
include::{generated}/validity/structs/VkSubresourceLayout2EXT.txt[]
--
endif::VK_EXT_image_compression_control[]
...
ifdef::VK_KHR_video_queue[]
    and it was created with pname:usage value containing flags other than
ifdef::VK_KHR_video_decode_queue[]
    ename:VK_IMAGE_USAGE_VIDEO_DECODE_DST_BIT_KHR,
    ename:VK_IMAGE_USAGE_VIDEO_DECODE_DPB_BIT_KHR
endif::VK_KHR_video_decode_queue[]
...
<<samplers-YCbCr-conversion,sampler {YCbCr} conversion>> object, associated
with the image view.
endif::VK_KHR_video_decode_queue[]
ifdef::VK_KHR_video_encode_queue[]
If the image has a
...
ifdef::VK_NV_linear_color_attachment[]
  * [[VUID-VkImageViewCreateInfo-usage-06516]]
    ...
    ename:VK_FORMAT_FEATURE_2_LINEAR_COLOR_ATTACHMENT_BIT_NV, if the image
    is created with ename:VK_IMAGE_TILING_LINEAR and the
...
include::{generated}/api/structs/VkImageViewSampleWeightCreateInfoQCOM.txt[]
...
include::{generated}/validity/structs/VkImageViewSampleWeightCreateInfoQCOM.txt[]
--
endif::VK_QCOM_image_processing[]
...
ifdef::VK_VERSION_1_3,VK_KHR_format_feature_flags2[]
  * If Vulkan 1.3 is supported or the `apiext:VK_KHR_format_feature_flags2`
    extension is enabled, and slink:VkImageViewCreateInfo::pname:image was
  ...
  * If Vulkan 1.3 is not supported and the
    `apiext:VK_KHR_format_feature_flags2` extension is not enabled, and
...
Level(s) Selection>> and <<textures-integer-coordinate-operations,Integer
Texel Coordinate Operations>>.

The sname:VkImageViewMinLodCreateInfoEXT structure is defined as:

include::{generated}/api/structs/VkImageViewMinLodCreateInfoEXT.txt[]
...
include::{generated}/validity/structs/VkImageViewMinLodCreateInfoEXT.txt[]
--
...
include::{generated}/api/protos/vkGetDeviceBufferMemoryRequirements.txt[]
...
include::{generated}/validity/protos/vkGetDeviceBufferMemoryRequirements.txt[]
--
endif::VK_VERSION_1_3,VK_KHR_maintenance4[]
...
include::{generated}/api/structs/VkDeviceBufferMemoryRequirements.txt[]
...
include::{generated}/validity/structs/VkDeviceBufferMemoryRequirements.txt[]
--
endif::VK_VERSION_1_3,VK_KHR_maintenance4[]
...
ifdef::VK_VERSION_1_3[]
include::{generated}/api/protos/vkGetDeviceImageMemoryRequirements.txt[]
endif::VK_VERSION_1_3[]
...
include::{generated}/validity/protos/vkGetDeviceImageMemoryRequirements.txt[]
--
endif::VK_VERSION_1_3,VK_KHR_maintenance4[]
...
include::{generated}/api/structs/VkDeviceImageMemoryRequirements.txt[]
...
include::{generated}/validity/structs/VkDeviceImageMemoryRequirements.txt[]
--
endif::VK_VERSION_1_3,VK_KHR_maintenance4[]
