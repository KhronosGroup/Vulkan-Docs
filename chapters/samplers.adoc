...
.Note
====
If pname:format is a combined depth stencil format, the aspect is determined
by the value of slink:VkSamplerCreateInfo::pname:pname:borderColor.
If slink:VkSamplerCreateInfo::pname:pname:borderColor is
...
****
  * [[VUID-VkSamplerCustomBorderColorCreateInfoEXT-format-07605]]
    ...
    a combined depth stencil format then the
