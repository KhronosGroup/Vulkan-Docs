...
include::{chapters}/commonvalidity/dynamic_state3_feature_common.adoc[]
  * [[VUID-vkCmdSetColorBlendEnableEXT-firstAttachment-12525]]
    The sum of pname:firstAttachment and pname:attachmentCount must: be less
    than or equal to
...
****
include::{chapters}/commonvalidity/dynamic_state3_feature_common.adoc[]
  * [[VUID-vkCmdSetColorBlendEquationEXT-firstAttachment-12526]]
    The sum of pname:firstAttachment and pname:attachmentCount must: be less
    than or equal to
    <<limits-maxColorAttachments,pname:maxColorAttachments>>
****
...
****
include::{chapters}/commonvalidity/dynamic_state3_feature_common.adoc[]
  * [[VUID-vkCmdSetColorWriteMaskEXT-firstAttachment-12527]]
    The sum of pname:firstAttachment and pname:attachmentCount must: be less
    than or equal to
    <<limits-maxColorAttachments,pname:maxColorAttachments>>
****
...
[[framebuffer-blend-factors-table]]
.Blend Factors
...
[[framebuffer-basic-blend-operations-table]]
...
attachment is not sRGB encoded, then the resulting [eq]#c~s~# values for R,
...
****
include::{chapters}/commonvalidity/dynamic_state3_feature_common.adoc[]
  * [[VUID-vkCmdSetColorBlendAdvancedEXT-firstAttachment-12528]]
    The sum of pname:firstAttachment and pname:attachmentCount must: be less
    than or equal to
    <<limits-maxColorAttachments,pname:maxColorAttachments>>
****
...
[[framebuffer-logical-operations-table]]
.Logical Operations
