...
child structure slink:VkBufferCopy2 is a variant of slink:VkBufferCopy which
includes pname:sType and pname:pNext parameters, allowing it to be extended.
...
ifdef::VK_QCOM_rotated_copy_commands[]
include::{chapters}/VK_QCOM_rotated_copies/rotated_addressing_copies.adoc[]
endif::VK_QCOM_rotated_copy_commands[]
