...
****
  * [[VUID-VkCopyDeviceMemoryImageInfoKHR-addressRange-13026]]
    The range of memory backing the address range defined by the
    pname:addressRange member of any element of pname:pRegions must: not
    overlap the memory backing the address range defined by the
    pname:addressRange of any other element of pname:pRegions
  * [[VUID-VkCopyDeviceMemoryImageInfoKHR-addressRange-13027]]
    The range of memory backing the address range defined by the
    pname:addressRange member of any element of pname:pRegions must: not
    overlap the memory backing any texels in pname:image defined by the
    pname:imageSubresource, pname:imageOffset, and pname:imageExtent members
    of any element of pname:pRegions
