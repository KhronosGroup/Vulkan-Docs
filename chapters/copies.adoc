...
****
  ...
  * [[VUID-VkCopyTensorInfoARM-pSrcOffset-09687]]
    pRegions must point to a slink:VkTensorCopyARM structure whose
    pname:pSrcOffset is `NULL` or whose elements are all `0`
  * [[VUID-VkCopyTensorInfoARM-pDstOffset-09688]]
    pRegions must point to a slink:VkTensorCopyARM structure whose
    pname:pDstOffset, is `NULL` or whose elements are all `0`
  * [[VUID-VkCopyTensorInfoARM-pExtent-09689]]
    pRegions must point to a slink:VkTensorCopyARM structure whose
    pname:pExtent is `NULL` or equal to the
