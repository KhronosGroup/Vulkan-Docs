...
****
  * [[VUID-VkIndirectExecutionSetCreateInfoEXT-maxIndirectShaderObjectCount-11014]]
    ...
    is zero
ifdef::VK_EXT_shader_object[]
    or <<features-shaderObject, pname:shaderObject>> is not enabled
endif::VK_EXT_shader_object[]
...
****
  ...
  * [[VUID-VkWriteIndirectExecutionSetPipelineEXT-pipeline-11027]]
    ...
    ename:VK_PIPELINE_CREATE_2_INDIRECT_BINDABLE_BIT_EXT
  * [[VUID-VkWriteIndirectExecutionSetPipelineEXT-pipeline-11028]]
    The descriptor layout info used to create pname:pipeline must: be
    <<descriptorsets-compatibility,compatible>> with the descriptor layout
...
ifdef::VK_EXT_transform_feedback[]
  ...
  * [[VUID-vkCmdExecuteGeneratedCommandsEXT-supportedIndirectCommandsShaderStages-11060]]
    The currently bound shader stages must: be supported by
