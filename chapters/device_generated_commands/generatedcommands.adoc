...
ifndef::VK_EXT_descriptor_heap[]
    ...
    <<descriptors-compatibility,compatible>> with the pname:initialPipeline
...
ifndef::VK_EXT_descriptor_heap[]
    ...
    <<descriptors-compatibility,compatible>> with the initial layout info
    used to create the Indirect Execution Set
...
ifdef::VK_EXT_transform_feedback[]
  ...
  * [[VUID-vkCmdExecuteGeneratedCommandsEXT-None-11062]]
    ...
    `0` or pname:indirectExecutionSet must: be dlink:VK_NULL_HANDLE
...
****
  ...
  * [[VUID-VkGeneratedCommandsInfoEXT-indirectCommandsLayout-11144]]
    ...
    <<descriptors-compatibility,compatible>> with the descriptor and push
...
ifdef::VK_EXT_shader_object[]
  ...
  * [[VUID-VkGeneratedCommandsInfoEXT-indirectAddress-12407]]
    The underlying buffer for pname:indirectAddress must: have the
    ename:VK_BUFFER_USAGE_2_INDIRECT_BUFFER_BIT_KHR bit set in its usage
    flag
