...
--
:refpage: vkCmdDecompressMemoryNV
...
include::{generated}/api/protos/vkCmdDecompressMemoryNV.adoc[]
  ...
  * pname:commandBuffer is the command buffer into which the command will be
    recorded.
  * pname:decompressRegionCount is the number of decompressions to execute.
  * pname:pDecompressMemoryRegions is a pointer to an array of size
    pname:decompressRegionCount of slink:VkDecompressMemoryRegionNV
    structures used to specify the decompression parameters.
...
****
  * [[VUID-vkCmdDecompressMemoryNV-None-07684]]
    <<features-memoryDecompression,memoryDecompression>> must: be enabled
****
...
include::{generated}/api/structs/VkDecompressMemoryRegionNV.adoc[]
  ...
  * pname:decompressionMethod is a single bit value from
    ename:VkMemoryDecompressionMethodFlagBitsNV which specifies the
