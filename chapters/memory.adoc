...
dlink:VK_NULL_HANDLE is equivalent to binding no tile memory to the command
buffer.
...
ifdef::VK_BASE_VERSION_1_2,VK_KHR_buffer_device_address[]
  * ename:VK_MEMORY_ALLOCATE_DEVICE_ADDRESS_BIT specifies that the memory
    ...
    ename:VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT usage flag set, and that
...
****
  * [[VUID-VkMemoryMapPlacedInfoEXT-flags-09576]]
    If sname:VkMemoryMapInfo::pname:flags contains
