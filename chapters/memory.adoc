...
ifdef::VK_QCOM_tile_memory_heap[]
  * [[VUID-VkTileMemoryBindInfoQCOM-memoryTypeIndex]]
...
ifdef::VK_VERSION_1_4+VK_KHR_map_memory2[or the equivalent command]
