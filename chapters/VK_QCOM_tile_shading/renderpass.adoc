...
ifdef::VK_EXT_transform_feedback[]
  * Transform feedback commands such as
   flink:vkCmdBeginTransformFeedbackEXT, flink:vkCmdEndTransformFeedbackEXT,
   flink:vkCmdBeginQueryIndexedEXT, and flink:vkCmdEndQueryIndexedEXT,must:
   not be recorded.
