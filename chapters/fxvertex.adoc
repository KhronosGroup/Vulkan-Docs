...
<<features-vertexAttributeRobustness, pname:vertexAttributeRobustness>> is
enabled and there is no
sname:VkVertexInputAttributeDescription::pname:location specified for the
shader vertex attribute code:Location being read, the value (0,0,0,0) or
