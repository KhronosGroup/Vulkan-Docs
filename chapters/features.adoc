...
ifdef::VK_NV_cooperative_matrix[]
  *** If the <<features-cooperativeMatrixRobustBufferAccessNV,
...
ifdef::VK_NV_cooperative_vector[]
  *** Accesses using code:OpCooperativeVector* are not bounds-checked.
...
ifdef::VK_EXT_robustness2,VK_KHR_robustness2[]
      the <<features-robustBufferAccess2, pname:robustBufferAccess2>>
...
ifdef::VK_EXT_robustness2,VK_KHR_robustness2[]
  *** If the access is to a uniform buffer and the
      <<features-robustBufferAccess2, pname:robustBufferAccess2>> feature is
...
This structure describes the following features:
  ...
  * [[features-tileShadingAnisotropicApron]]
    ...
    set to a value where pname:apronSize::pname:width differs from
    pname:apronSize::pname:height.
...
This structure describes the following features:
  ...
  * [[features-shaderFloat8CooperativeMatrix]] pname:shaderFloat8 indicates
    whether the implementation supports shaders with the
    code:Float8CooperativeMatrixEXT capability.
