...
ifdef::VK_EXT_ray_tracing_invocation_reorder,VK_NV_ray_tracing_invocation_reorder[]
...
ifdef::VK_EXT_ray_tracing_invocation_reorder+VK_NV_ray_tracing_invocation_reorder[or]
ifdef::VK_NV_ray_tracing_invocation_reorder[]
...
--
endif::VK_EXT_ray_tracing_invocation_reorder,VK_NV_ray_tracing_invocation_reorder[]
