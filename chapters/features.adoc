...
ifdef::VK_KHR_shader_relaxed_extended_instruction[]
  * <<features-shaderRelaxedExtendedInstruction, pname:shaderRelaxedExtendedInstruction>>
    if the `apiext:VK_KHR_shader_relaxed_extended_instruction` extension is supported.
endif::VK_KHR_shader_relaxed_extended_instruction[]
