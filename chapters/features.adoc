...
include::{generated}/validity/structs/VkPhysicalDeviceMutableDescriptorTypeFeaturesVALVE.adoc[]
--
...
This structure describes the following feature:
  ...
  * [[features-graphicsPipelineLibrary]] pname:graphicsPipelineLibrary
    indicates that the implementation supports <<pipeline-library, graphics
    pipeline libraries>>.
