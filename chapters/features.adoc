...
[open,refpage='VkPhysicalDevicePrivateDataBaseHandleFeaturesNV',desc='Structure describing private data base handle features that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDevicePrivateDataBaseHandleFeaturesNV structure is
defined as:

include::{generated}/api/structs/VkPhysicalDevicePrivateDataBaseHandleFeaturesNV.adoc[]
...
This structure describes the following feature:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[features-privateDataBaseHandle]] pname:privateDataBaseHandle indicates
    that the implementation supports querying its base handle for any
    device-level object by creating a slink:VkPrivateDataSlot with
    ename:VK_PRIVATE_DATA_SLOT_CREATE_BASE_OBJECT_HANDLE_BIT_NV and calling
    fname:vkGetPrivateData.

:refpage: VkPhysicalDevicePrivateDataBaseHandleFeaturesNV
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDevicePrivateDataBaseHandleFeaturesNV.adoc[]
--
...
// tag::VK_KHR_maintenance6-features[]
  ...
  ** slink:VkPhysicalDeviceMaintenance6Properties::pname:maxCombinedImageSamplerDescriptorCount
     ...
     sampled images with <<samplers-YCbCr-conversion,{YCbCr} conversion>>.
  ** A
...
[open,refpage='VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR',desc='Structure describing whether querying shader group handles from a pipeline library is supported by the implementation',type='structs']
--
The sname:VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR structure
is defined as:

include::{generated}/api/structs/VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR.adoc[]
...
:refpage: VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDevicePipelineLibraryGroupHandlesFeaturesKHR.adoc[]
--
...
[open,refpage='VkPhysicalDeviceShaderBfloat16FeaturesKHR',desc='Structure describing bfloat16 features that can be supported by an implementation',type='structs']
--
...
[open,refpage='VkPhysicalDeviceShaderFloat8FeaturesEXT',desc='Structure describing float8 features that can be supported by an implementation',type='structs']
--
...
[open,refpage='VkPhysicalDeviceShaderOCPMicroscalingTypesFeaturesEXT',desc='Structure describing OCP microscaling types features that can be supported by an implementation',type='structs']
--
...
[open,refpage='VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE',desc='Structure describing support for alignment request on buffer device addresses',type='structs']
--
The
sname:VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE
structure is defined as:

include::{generated}/api/structs/VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE.adoc[]
...
This structure describes the following features:
  ...
  * pname:pNext is `NULL` or a pointer to a structure extending this
    structure.
  * [[features-bufferDeviceAddressAllocationAlignment]]
    pname:bufferDeviceAddressAllocationAlignment indicates whether the
...
:refpage: VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDeviceBufferDeviceAddressAllocationAlignmentFeaturesVALVE.adoc[]
--
