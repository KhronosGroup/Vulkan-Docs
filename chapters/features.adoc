...
[open,refpage='VkPhysicalDeviceDeviceGeneratedComputeFeaturesNV',desc='Structure describing the device-generated compute features that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceDeviceGeneratedComputeFeaturesNV structure is
defined as:
include::{generated}/api/structs/VkPhysicalDeviceDeviceGeneratedComputeFeaturesNV.adoc[]
This structure describes the following feature:
  ...
  * [[features-deviceGeneratedCompute]] pname:deviceGeneratedCompute
    indicates whether the implementation supports functionality to bind compute
    pipelines and generate dispatch commands on the device.
    See <<device-generated-commands,Device-Generated Commands>>.
  * pname:deviceGeneratedComputePushConstants indicates whether the implementation
    supports generating push constants for the compute pipeline on the device.

:refpage: VkPhysicalDeviceDeviceGeneratedComputeFeaturesNV
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDeviceDeviceGeneratedComputeFeaturesNV.adoc[]
--
