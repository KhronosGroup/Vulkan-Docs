...
ifdef::VK_MESA_fragment_coverage_mask[]
[open,refpage='VkPhysicalDeviceFragmentCoverageMaskFeaturesMESA',desc='Structure describing the fragment coverage mask feature that can be supported by an implementation',type='structs']
--
The sname:VkPhysicalDeviceFragmentCoverageMaskFeaturesMESA structure is
defined as:

include::{generated}/api/structs/VkPhysicalDeviceFragmentCoverageMaskFeaturesMESA.adoc[]
...
This structure describes the following feature:
  ...
  * [[features-fragmentCoverageMask]]
    ...
    the code:FragmentCoverageMESA SPIR-V capability.

:refpage: VkPhysicalDeviceFragmentCoverageMaskFeaturesMESA
include::{chapters}/features.adoc[tag=features]

include::{generated}/validity/structs/VkPhysicalDeviceFragmentCoverageMaskFeaturesMESA.adoc[]
--
endif::VK_MESA_fragment_coverage_mask[]
...
This structure describes the following feature:
  ...
  ** The depth clipping state of the pipeline is well defined when the
     ...
     ename:VK_DYNAMIC_STATE_DEPTH_CLIP_ENABLE_EXT being set and the
     slink:VkPipelineRasterizationDepthClipStateCreateInfoEXT structure is
     not present
...
[[milestone-features-roadmap-2022]]
=== Roadmap 2022
...
[[milestone-features-roadmap-2024]]
=== Roadmap 2024
...
// intentionally using VK_VERSION_1_4 for this block
ifdef::VK_VERSION_1_4[]
[[milestone-features-roadmap-2026]]
=== Roadmap 2026
