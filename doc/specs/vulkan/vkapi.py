...
mapDict['VkAccessFlags'] =  {'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkSubpassDependency': None, 'VkAccessFlagBits': None}
mapDict['VkAllocationCallbacks'] =  {'vkDestroyPipelineLayout': None, 'vkCreateBufferView': None, 'vkDestroyPipeline': None, 'vkDestroyImageView': None, 'PFN_vkInternalAllocationNotification': None, 'vkDestroySemaphore': None, 'vkDestroyQueryPool': None, 'vkAllocateMemory': None, 'vkDestroyBuffer': None, 'vkCreateShaderModule': None, 'vkCreateRenderPass': None, 'vkDestroyPipelineCache': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyFence': None, 'vkCreateBuffer': None, 'vkFreeMemory': None, 'vkCreatePipelineLayout': None, 'PFN_vkInternalFreeNotification': None, 'vkCreateImageView': None, 'vkCreateComputePipelines': None, 'vkDestroyDevice': None, 'PFN_vkAllocationFunction': None, 'vkDestroyDescriptorPool': None, 'PFN_vkFreeFunction': None, 'vkDestroyInstance': None, 'vkCreateInstance': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateDescriptorPool': None, 'vkCreatePipelineCache': None, 'PFN_vkReallocationFunction': None, 'vkDestroyCommandPool': None, 'vkDestroyImage': None, 'vkCreateQueryPool': None, 'vkCreateFence': None, 'vkCreateSharedSwapchainsKHR': None, 'vkCreateSemaphore': None, 'vkCreateSampler': None, 'vkDestroyBufferView': None, 'vkDestroyShaderModule': None, 'vkCreateImage': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateFramebuffer': None, 'vkCreateCommandPool': None, 'vkCreateDevice': None, 'vkDestroyFramebuffer': None, 'vkDestroySampler': None, 'vkDestroyRenderPass': None, 'vkCreateEvent': None, 'vkDestroyEvent': None}
mapDict['VkApplicationInfo'] =  {'VkInstanceCreateInfo': None, 'VkStructureType': None}
mapDict['VkAttachmentDescription'] =  {'VkSampleCountFlagBits': None, 'VkRenderPassCreateInfo': None, 'VkAttachmentDescriptionFlags': None, 'VkFormat': None, 'VkAttachmentLoadOp': None, 'VkImageLayout': None, 'VkAttachmentStoreOp': None}
...
mapDict['VkBindSparseInfo'] =  {'vkQueueBindSparse': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSemaphore': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'VkStructureType': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineInputAssemblyStateCreateInfo': None, 'VkDisplayPresentInfoKHR': None, 'vkWaitForFences': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPhysicalDeviceLimits': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdCopyBuffer': None, 'VkBufferMemoryBarrier': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkBindBufferMemory': None, 'vkCmdFillBuffer': None, 'vkCmdDispatchIndirect': None, 'vkCmdDrawIndirect': None, 'vkCmdBindVertexBuffers': None, 'vkCmdCopyBufferToImage': None, 'vkCmdDrawIndexedIndirect': None, 'VkBufferViewCreateInfo': None, 'vkDestroyBuffer': None, 'vkCmdUpdateBuffer': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCreateBuffer': None, 'VkDescriptorBufferInfo': None, 'vkGetBufferMemoryRequirements': None, 'vkCmdCopyQueryPoolResults': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkSharingMode': None, 'VkDeviceSize': None, 'VkBufferCreateFlags': None, 'vkCreateBuffer': None, 'VkStructureType': None, 'VkBufferUsageFlags': None}
mapDict['VkBufferImageCopy'] =  {'VkDeviceSize': None, 'VkImageSubresourceLayers': None, 'VkExtent3D': None, 'VkOffset3D': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkAccessFlags': None, 'VkDeviceSize': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkBuffer': None, 'VkStructureType': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkDeviceSize': None, 'VkBufferViewCreateFlags': None, 'vkCreateBufferView': None, 'VkFormat': None, 'VkBuffer': None, 'VkStructureType': None}
...
mapDict['VkClearValue'] =  {'VkClearColorValue': None, 'VkClearAttachment': None, 'VkRenderPassBeginInfo': None, 'VkClearDepthStencilValue': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdClearColorImage': None, 'vkCmdClearAttachments': None, 'vkCmdWriteTimestamp': None, 'vkCmdWaitEvents': None, 'vkCmdSetLineWidth': None, 'vkCmdDrawIndirect': None, 'vkCmdExecuteCommands': None, 'vkCmdDispatch': None, 'vkCmdBeginRenderPass': None, 'vkCmdPushConstants': None, 'VkSubmitInfo': None, 'vkCmdSetScissor': None, 'vkResetCommandBuffer': None, 'vkCmdDrawIndexed': None, 'vkCmdSetEvent': None, 'vkCmdResetEvent': None, 'vkFreeCommandBuffers': None, 'vkCmdSetDepthBounds': None, 'vkCmdNextSubpass': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdPipelineBarrier': None, 'vkCmdUpdateBuffer': None, 'vkCmdCopyImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyBuffer': None, 'vkCmdBeginQuery': None, 'vkCmdSetViewport': None, 'vkCmdBindIndexBuffer': None, 'vkCmdResetQueryPool': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdSetStencilWriteMask': None, 'vkBeginCommandBuffer': None, 'vkCmdSetBlendConstants': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdSetStencilReference': None, 'vkCmdBlitImage': None, 'vkCmdBindDescriptorSets': None, 'vkEndCommandBuffer': None, 'vkCmdBindPipeline': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdSetDepthBias': None, 'vkCmdResolveImage': None, 'vkCmdEndQuery': None, 'vkCmdDispatchIndirect': None, 'vkCmdBindVertexBuffers': None, 'vkAllocateCommandBuffers': None, 'vkCmdDraw': None, 'vkCmdEndRenderPass': None, 'vkCmdFillBuffer': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'vkAllocateCommandBuffers': None, 'VkCommandPool': None, 'VkCommandBufferLevel': None, 'VkStructureType': None}
mapDict['VkCommandBufferBeginInfo'] =  {'VkCommandBufferUsageFlags': None, 'vkBeginCommandBuffer': None, 'VkStructureType': None, 'VkCommandBufferInheritanceInfo': None}
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkRenderPass': None, 'VkFramebuffer': None, 'VkBool32': None, 'VkQueryPipelineStatisticFlags': None, 'VkCommandBufferBeginInfo': None, 'VkQueryControlFlags': None, 'VkStructureType': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipelineCreateFlags': None, 'VkPipeline': None, 'VkStructureType': None, 'vkCreateComputePipelines': None, 'VkPipelineLayout': None, 'VkPipelineShaderStageCreateInfo': None}
...
mapDict['VkDescriptorImageInfo'] =  {'VkImageView': None, 'VkWriteDescriptorSet': None, 'VkImageLayout': None, 'VkSampler': None}
mapDict['VkDescriptorPool'] =  {'vkCreateDescriptorPool': None, 'vkResetDescriptorPool': None, 'vkDestroyDescriptorPool': None, 'VkDescriptorSetAllocateInfo': None, 'vkFreeDescriptorSets': None}
...
mapDict['VkDescriptorPoolCreateInfo'] =  {'vkCreateDescriptorPool': None, 'VkDescriptorPoolCreateFlags': None, 'VkDescriptorPoolSize': None, 'VkStructureType': None}
...
mapDict['VkDescriptorSet'] =  {'vkFreeDescriptorSets': None, 'VkWriteDescriptorSet': None, 'vkAllocateDescriptorSets': None, 'vkCmdBindDescriptorSets': None, 'VkCopyDescriptorSet': None}
mapDict['VkDescriptorSetAllocateInfo'] =  {'VkDescriptorPool': None, 'vkAllocateDescriptorSets': None, 'VkStructureType': None, 'VkDescriptorSetLayout': None}
...
mapDict['VkDescriptorSetLayoutBinding'] =  {'VkDescriptorType': None, 'VkSampler': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkShaderStageFlags': None}
mapDict['VkDescriptorSetLayoutCreateFlags'] =  {'VkDescriptorSetLayoutCreateInfo': None}
mapDict['VkDescriptorSetLayoutCreateInfo'] =  {'VkDescriptorSetLayoutCreateFlags': None, 'VkDescriptorSetLayoutBinding': None, 'vkCreateDescriptorSetLayout': None, 'VkStructureType': None}
mapDict['VkDescriptorType'] =  {'VkDescriptorSetLayoutBinding': None, 'VkDescriptorPoolSize': None, 'VkWriteDescriptorSet': None}
mapDict['VkDevice'] =  {'vkMergePipelineCaches': None, 'vkDestroyPipelineLayout': None, 'vkCreateBufferView': None, 'vkDestroyPipeline': None, 'vkDestroyImageView': None, 'vkGetImageMemoryRequirements': None, 'vkDestroySemaphore': None, 'vkDestroyQueryPool': None, 'vkCreateSampler': None, 'vkAllocateMemory': None, 'vkDestroyFramebuffer': None, 'vkDestroyBuffer': None, 'vkCreateShaderModule': None, 'vkFreeDescriptorSets': None, 'vkCreateRenderPass': None, 'vkDestroyPipelineCache': None, 'vkGetBufferMemoryRequirements': None, 'vkFlushMappedMemoryRanges': None, 'vkFreeCommandBuffers': None, 'vkDestroyFence': None, 'vkCreateFence': None, 'vkFreeMemory': None, 'vkCreatePipelineLayout': None, 'vkUpdateDescriptorSets': None, 'vkCreateComputePipelines': None, 'vkResetDescriptorPool': None, 'vkGetQueryPoolResults': None, 'vkCreateImageView': None, 'vkDestroyDevice': None, 'vkUnmapMemory': None, 'vkBindImageMemory': None, 'vkGetDeviceQueue': None, 'vkResetEvent': None, 'vkSetEvent': None, 'vkDestroyDescriptorPool': None, 'vkGetEventStatus': None, 'vkGetDeviceProcAddr': None, 'vkCreateGraphicsPipelines': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateDescriptorPool': None, 'vkGetImageSubresourceLayout': None, 'vkInvalidateMappedMemoryRanges': None, 'vkDeviceWaitIdle': None, 'vkWaitForFences': None, 'vkCreatePipelineCache': None, 'vkDestroyCommandPool': None, 'vkDestroyImage': None, 'vkCreateDevice': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateSharedSwapchainsKHR': None, 'vkCreateSemaphore': None, 'vkCreateBuffer': None, 'vkCreateCommandPool': None, 'vkDestroyBufferView': None, 'vkDestroyShaderModule': None, 'vkCreateImage': None, 'vkMapMemory': None, 'vkCreateFramebuffer': None, 'vkBindBufferMemory': None, 'vkResetCommandPool': None, 'vkAllocateDescriptorSets': None, 'vkCreateQueryPool': None, 'vkResetFences': None, 'vkAllocateCommandBuffers': None, 'vkGetDeviceMemoryCommitment': None, 'vkDestroySampler': None, 'vkGetRenderAreaGranularity': None, 'vkDestroyRenderPass': None, 'vkCreateEvent': None, 'vkGetFenceStatus': None, 'vkGetPipelineCacheData': None, 'vkDestroyEvent': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkDeviceCreateFlags': None, 'VkPhysicalDeviceFeatures': None, 'VkDeviceQueueCreateInfo': None, 'vkCreateDevice': None, 'VkStructureType': None}
mapDict['VkDeviceMemory'] =  {'vkBindImageMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkAllocateMemory': None, 'vkFreeMemory': None, 'VkSparseMemoryBind': None, 'vkMapMemory': None, 'VkMappedMemoryRange': None, 'vkBindBufferMemory': None, 'vkUnmapMemory': None, 'VkSparseImageMemoryBind': None}
...
mapDict['VkDeviceSize'] =  {'VkMemoryAllocateInfo': None, 'VkSparseImageMemoryRequirements': None, 'VkBufferCreateInfo': None, 'vkCmdDrawIndirect': None, 'VkSubresourceLayout': None, 'vkCmdDrawIndexedIndirect': None, 'VkBufferViewCreateInfo': None, 'VkBufferImageCopy': None, 'VkMemoryHeap': None, 'VkMappedMemoryRange': None, 'VkDescriptorBufferInfo': None, 'VkImageFormatProperties': None, 'vkCmdBindIndexBuffer': None, 'VkMemoryRequirements': None, 'vkMapMemory': None, 'VkSparseMemoryBind': None, 'VkSparseImageMemoryBind': None, 'vkBindBufferMemory': None, 'vkGetQueryPoolResults': None, 'vkCmdDispatchIndirect': None, 'vkCmdBindVertexBuffers': None, 'VkBufferMemoryBarrier': None, 'vkBindImageMemory': None, 'vkGetDeviceMemoryCommitment': None, 'VkBufferCopy': None, 'vkCmdUpdateBuffer': None, 'vkCmdFillBuffer': None, 'VkPhysicalDeviceLimits': None, 'vkCmdCopyQueryPoolResults': None}
...
mapDict['VkEvent'] =  {'vkResetEvent': None, 'vkSetEvent': None, 'vkCmdSetEvent': None, 'vkCmdResetEvent': None, 'vkCreateEvent': None, 'vkCmdWaitEvents': None, 'vkDestroyEvent': None, 'vkGetEventStatus': None}
...
mapDict['VkExtent2D'] =  {'vkGetRenderAreaGranularity': None, 'VkRect2D': None, 'VkSwapchainCreateInfoKHR': None}
mapDict['VkExtent3D'] =  {'VkQueueFamilyProperties': None, 'VkImageCopy': None, 'VkSparseImageMemoryBind': None, 'VkImageResolve': None, 'VkImageCreateInfo': None, 'VkSparseImageFormatProperties': None, 'VkImageFormatProperties': None, 'VkBufferImageCopy': None}
mapDict['VkFence'] =  {'vkDestroyFence': None, 'vkCreateFence': None, 'vkQueueSubmit': None, 'vkWaitForFences': None, 'vkQueueBindSparse': None, 'vkGetFenceStatus': None, 'vkResetFences': None}
...
mapDict['VkFormat'] =  {'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkAttachmentDescription': None, 'VkBufferViewCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkVertexInputAttributeDescription': None}
...
mapDict['VkFramebuffer'] =  {'VkRenderPassBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkDestroyFramebuffer': None, 'vkCreateFramebuffer': None}
mapDict['VkFramebufferCreateFlags'] =  {'VkFramebufferCreateInfo': None}
mapDict['VkFramebufferCreateInfo'] =  {'VkImageView': None, 'VkRenderPass': None, 'VkFramebufferCreateFlags': None, 'VkStructureType': None, 'vkCreateFramebuffer': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineCreateFlags': None, 'VkPipeline': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkStructureType': None, 'vkCreateGraphicsPipelines': None, 'VkRenderPass': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineLayout': None, 'VkPipelineShaderStageCreateInfo': None}
mapDict['VkImage'] =  {'vkCreateImage': None, 'vkCmdClearColorImage': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkGetImageSparseMemoryRequirements': None, 'VkImageMemoryBarrier': None, 'vkGetImageSubresourceLayout': None, 'vkCmdCopyImageToBuffer': None, 'VkImageViewCreateInfo': None, 'vkBindImageMemory': None, 'vkDestroyImage': None, 'vkGetImageMemoryRequirements': None, 'vkCmdBlitImage': None, 'vkCmdResolveImage': None, 'VkSparseImageMemoryBindInfo': None, 'vkCmdCopyImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkClearAttachment': None, 'VkImageSubresourceRange': None, 'VkImageSubresourceLayers': None, 'VkImageSubresource': None, 'VkImageAspectFlagBits': None, 'VkSparseImageFormatProperties': None}
...
mapDict['VkImageCreateInfo'] =  {'VkSampleCountFlagBits': None, 'VkSharingMode': None, 'VkImageType': None, 'VkStructureType': None, 'VkImageLayout': None, 'VkFormat': None, 'vkCreateImage': None, 'VkImageTiling': None, 'VkImageUsageFlags': None, 'VkImageCreateFlags': None, 'VkExtent3D': None}
...
mapDict['VkImageLayout'] =  {'VkImageMemoryBarrier': None, 'VkAttachmentDescription': None, 'vkCmdResolveImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdClearColorImage': None, 'VkAttachmentReference': None, 'vkCmdBlitImage': None, 'VkDescriptorImageInfo': None, 'VkImageCreateInfo': None, 'vkCmdCopyImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkImageMemoryBarrier'] =  {'VkImage': None, 'VkImageSubresourceRange': None, 'vkCmdWaitEvents': None, 'VkImageLayout': None, 'vkCmdPipelineBarrier': None, 'VkAccessFlags': None, 'VkStructureType': None}
mapDict['VkImageResolve'] =  {'VkOffset3D': None, 'VkImageSubresourceLayers': None, 'VkExtent3D': None, 'vkCmdResolveImage': None}
mapDict['VkImageSubresource'] =  {'VkImageAspectFlags': None, 'vkGetImageSubresourceLayout': None, 'VkSparseImageMemoryBind': None}
mapDict['VkImageSubresourceLayers'] =  {'VkImageAspectFlags': None, 'VkImageBlit': None, 'VkImageCopy': None, 'VkBufferImageCopy': None, 'VkImageResolve': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageAspectFlags': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdClearColorImage': None, 'VkImageViewCreateInfo': None, 'VkImageMemoryBarrier': None}
...
mapDict['VkImageUsageFlags'] =  {'VkImageUsageFlagBits': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkImageViewCreateInfo'] =  {'VkComponentMapping': None, 'VkImage': None, 'VkImageViewType': None, 'VkFormat': None, 'vkCreateImageView': None, 'VkImageViewCreateFlags': None, 'VkStructureType': None, 'VkImageSubresourceRange': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkEnumeratePhysicalDevices': None, 'vkGetInstanceProcAddr': None, 'vkCreateInstance': None, 'vkDestroyInstance': None}
mapDict['VkInstanceCreateFlags'] =  {'VkInstanceCreateInfo': None}
mapDict['VkInstanceCreateInfo'] =  {'VkApplicationInfo': None, 'VkInstanceCreateFlags': None, 'vkCreateInstance': None, 'VkStructureType': None}
...
mapDict['VkMappedMemoryRange'] =  {'vkInvalidateMappedMemoryRanges': None, 'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkStructureType': None, 'vkFlushMappedMemoryRanges': None}
...
mapDict['VkOffset3D'] =  {'VkImageBlit': None, 'VkImageResolve': None, 'VkImageCopy': None, 'VkSparseImageMemoryBind': None, 'VkBufferImageCopy': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkCreateDevice': None, 'vkGetPhysicalDeviceFeatures': None, 'vkEnumeratePhysicalDevices': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None}
...
mapDict['VkPipeline'] =  {'vkCmdBindPipeline': None, 'VkGraphicsPipelineCreateInfo': None, 'vkDestroyPipeline': None, 'VkComputePipelineCreateInfo': None, 'vkCreateComputePipelines': None, 'vkCreateGraphicsPipelines': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkMergePipelineCaches': None, 'vkCreateComputePipelines': None, 'vkDestroyPipelineCache': None, 'vkCreatePipelineCache': None, 'vkGetPipelineCacheData': None, 'vkCreateGraphicsPipelines': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBlendFactor': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkColorComponentFlags': None, 'VkBool32': None, 'VkBlendOp': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkLogicOp': None, 'VkBool32': None, 'VkStructureType': None, 'VkPipelineColorBlendStateCreateFlags': None, 'VkPipelineColorBlendAttachmentState': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None, 'VkCompareOp': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkStructureType': None, 'VkStencilOpState': None}
mapDict['VkPipelineDynamicStateCreateFlags'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateInfo'] =  {'VkDynamicState': None, 'VkPipelineDynamicStateCreateFlags': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkPipelineLayout'] =  {'vkCmdPushConstants': None, 'vkDestroyPipelineLayout': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCmdBindDescriptorSets': None, 'VkComputePipelineCreateInfo': None, 'vkCreatePipelineLayout': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkPushConstantRange': None, 'VkPipelineLayoutCreateFlags': None, 'vkCreatePipelineLayout': None, 'VkStructureType': None, 'VkDescriptorSetLayout': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkSampleCountFlagBits': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkSampleMask': None, 'VkStructureType': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPolygonMode': None, 'VkCullModeFlags': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkFrontFace': None, 'VkStructureType': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkSpecializationInfo': None, 'VkPipelineShaderStageCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkShaderStageFlagBits': None, 'VkComputePipelineCreateInfo': None, 'VkShaderModule': None, 'VkStructureType': None}
mapDict['VkPipelineStageFlagBits'] =  {'vkCmdWriteTimestamp': None, 'VkPipelineStageFlags': None}
mapDict['VkPipelineStageFlags'] =  {'vkCmdPipelineBarrier': None, 'VkPipelineStageFlagBits': None, 'vkCmdWaitEvents': None, 'vkCmdSetEvent': None, 'vkCmdResetEvent': None, 'VkSubmitInfo': None, 'VkSubpassDependency': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkVertexInputAttributeDescription': None, 'VkVertexInputBindingDescription': None, 'VkPipelineVertexInputStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkViewport': None, 'VkPipelineViewportStateCreateFlags': None, 'VkStructureType': None, 'VkRect2D': None}
...
mapDict['VkQueryPipelineStatisticFlags'] =  {'VkQueryPoolCreateInfo': None, 'VkQueryPipelineStatisticFlagBits': None, 'VkCommandBufferInheritanceInfo': None}
mapDict['VkQueryPool'] =  {'vkDestroyQueryPool': None, 'vkCreateQueryPool': None, 'vkCmdBeginQuery': None, 'vkCmdWriteTimestamp': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdResetQueryPool': None, 'vkGetQueryPoolResults': None, 'vkCmdEndQuery': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'vkCreateQueryPool': None, 'VkQueryPoolCreateFlags': None, 'VkQueryPipelineStatisticFlags': None, 'VkStructureType': None, 'VkQueryType': None}
...
mapDict['VkQueue'] =  {'vkGetDeviceQueue': None, 'vkQueueBindSparse': None, 'vkQueueSubmit': None, 'vkQueueWaitIdle': None}
...
mapDict['VkRect2D'] =  {'vkCmdSetScissor': None, 'VkOffset2D': None, 'VkDisplayPresentInfoKHR': None, 'VkRenderPassBeginInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkExtent2D': None, 'VkClearRect': None}
mapDict['VkRenderPass'] =  {'VkGraphicsPipelineCreateInfo': None, 'vkGetRenderAreaGranularity': None, 'vkDestroyRenderPass': None, 'vkCreateRenderPass': None, 'VkCommandBufferInheritanceInfo': None, 'VkRenderPassBeginInfo': None, 'VkFramebufferCreateInfo': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkRenderPass': None, 'VkFramebuffer': None, 'VkRect2D': None, 'vkCmdBeginRenderPass': None, 'VkClearValue': None, 'VkStructureType': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkRenderPassCreateFlags': None, 'VkAttachmentDescription': None, 'VkStructureType': None, 'vkCreateRenderPass': None, 'VkSubpassDescription': None, 'VkSubpassDependency': None}
mapDict['VkSampleCountFlagBits'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkAttachmentDescription': None, 'VkSampleCountFlags': None, 'VkPipelineMultisampleStateCreateInfo': None}
...
mapDict['VkSamplerCreateInfo'] =  {'VkSamplerAddressMode': None, 'VkCompareOp': None, 'VkFilter': None, 'VkSamplerCreateFlags': None, 'vkCreateSampler': None, 'VkBool32': None, 'VkSamplerMipmapMode': None, 'VkStructureType': None, 'VkBorderColor': None}
...
mapDict['VkShaderStageFlags'] =  {'VkPushConstantRange': None, 'VkDescriptorSetLayoutBinding': None, 'vkCmdPushConstants': None, 'VkShaderStageFlagBits': None}
mapDict['VkSharingMode'] =  {'VkImageCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkBufferCreateInfo': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'VkImageAspectFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageFormatFlags': None, 'VkExtent3D': None, 'VkSparseImageMemoryRequirements': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkOffset3D': None, 'VkSparseMemoryBindFlags': None, 'VkDeviceSize': None, 'VkExtent3D': None, 'VkImageSubresource': None, 'VkSparseImageMemoryBindInfo': None, 'VkDeviceMemory': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None, 'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkSparseBufferMemoryBindInfo': None}
...
mapDict['VkStencilFaceFlags'] =  {'vkCmdSetStencilReference': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdSetStencilWriteMask': None, 'VkStencilFaceFlagBits': None}
...
mapDict['VkStructureType'] =  {'VkImageMemoryBarrier': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkDisplayPresentInfoKHR': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkApplicationInfo': None, 'VkBufferViewCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkBufferCreateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkSubmitInfo': None, 'VkCommandBufferBeginInfo': None, 'VkSemaphoreCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkPipelineViewportStateCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkQueryPoolCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkMemoryBarrier': None, 'VkMemoryAllocateInfo': None, 'VkEventCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkFenceCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkMappedMemoryRange': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkDescriptorPoolCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkImageCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkBindSparseInfo': None}
mapDict['VkSubmitInfo'] =  {'VkSemaphore': None, 'VkCommandBuffer': None, 'vkQueueSubmit': None, 'VkStructureType': None, 'VkPipelineStageFlags': None}
mapDict['VkSubpassContents'] =  {'vkCmdBeginRenderPass': None, 'vkCmdNextSubpass': None}
mapDict['VkSubpassDependency'] =  {'VkAccessFlags': None, 'VkRenderPassCreateInfo': None, 'VkDependencyFlags': None, 'VkPipelineStageFlags': None}
...
mapDict['VkSwapchainCreateInfoKHR'] =  {'VkSharingMode': None, 'VkSwapchainKHR': None, 'VkSurfaceTransformFlagBitsKHR': None, 'VkImageUsageFlags': None, 'VkColorSpaceKHR': None, 'VkExtent2D': None, 'VkCompositeAlphaFlagBitsKHR': None, 'VkPresentModeKHR': None, 'VkSurfaceKHR': None, 'VkBool32': None, 'VkSwapchainCreateFlagsKHR': None, 'VkStructureType': None, 'vkCreateSharedSwapchainsKHR': None, 'VkFormat': None}
mapDict['VkSwapchainKHR'] =  {'vkCreateSharedSwapchainsKHR': None, 'VkSwapchainCreateInfoKHR': None}
...
mapDict['VkWriteDescriptorSet'] =  {'vkUpdateDescriptorSets': None, 'VkBufferView': None, 'VkDescriptorSet': None, 'VkDescriptorImageInfo': None, 'VkDescriptorType': None, 'VkDescriptorBufferInfo': None, 'VkStructureType': None}
...
mapDict['vkBindBufferMemory'] =  {'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkBuffer': None, 'VkDevice': None}
...
mapDict['vkCmdBlitImage'] =  {'VkFilter': None, 'VkImageBlit': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdClearAttachments'] =  {'VkClearAttachment': None, 'VkCommandBuffer': None, 'VkClearRect': None}
mapDict['vkCmdClearColorImage'] =  {'VkClearColorValue': None, 'VkImage': None, 'VkImageSubresourceRange': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImage': None, 'VkImageSubresourceRange': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkClearDepthStencilValue': None}
...
mapDict['vkCmdCopyImageToBuffer'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkBufferImageCopy': None, 'VkBuffer': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkCommandBuffer': None, 'VkPipelineStageFlags': None, 'VkDependencyFlags': None, 'VkBufferMemoryBarrier': None}
...
mapDict['vkCmdResolveImage'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImageResolve': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkCommandBuffer': None, 'VkPipelineStageFlags': None, 'VkEvent': None, 'VkBufferMemoryBarrier': None}
mapDict['vkCmdWriteTimestamp'] =  {'VkCommandBuffer': None, 'VkPipelineStageFlagBits': None, 'VkQueryPool': None}
mapDict['vkCreateBuffer'] =  {'VkAllocationCallbacks': None, 'VkBuffer': None, 'VkBufferCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateBufferView'] =  {'VkAllocationCallbacks': None, 'VkBufferViewCreateInfo': None, 'VkBufferView': None, 'VkDevice': None}
mapDict['vkCreateCommandPool'] =  {'VkCommandPoolCreateInfo': None, 'VkAllocationCallbacks': None, 'VkCommandPool': None, 'VkDevice': None}
mapDict['vkCreateComputePipelines'] =  {'VkAllocationCallbacks': None, 'VkComputePipelineCreateInfo': None, 'VkPipeline': None, 'VkPipelineCache': None, 'VkDevice': None}
mapDict['vkCreateDescriptorPool'] =  {'VkAllocationCallbacks': None, 'VkDescriptorPool': None, 'VkDescriptorPoolCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateDescriptorSetLayout'] =  {'VkAllocationCallbacks': None, 'VkDescriptorSetLayout': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateDevice'] =  {'VkPhysicalDevice': None, 'VkDeviceCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateEvent'] =  {'VkAllocationCallbacks': None, 'VkEventCreateInfo': None, 'VkEvent': None, 'VkDevice': None}
mapDict['vkCreateFence'] =  {'VkFenceCreateInfo': None, 'VkAllocationCallbacks': None, 'VkFence': None, 'VkDevice': None}
mapDict['vkCreateFramebuffer'] =  {'VkAllocationCallbacks': None, 'VkFramebuffer': None, 'VkFramebufferCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkPipelineCache': None, 'VkGraphicsPipelineCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateImage'] =  {'VkAllocationCallbacks': None, 'VkImageCreateInfo': None, 'VkImage': None, 'VkDevice': None}
mapDict['vkCreateImageView'] =  {'VkAllocationCallbacks': None, 'VkImageView': None, 'VkImageViewCreateInfo': None, 'VkDevice': None}
...
mapDict['vkCreatePipelineLayout'] =  {'VkPipelineLayoutCreateInfo': None, 'VkAllocationCallbacks': None, 'VkPipelineLayout': None, 'VkDevice': None}
mapDict['vkCreateQueryPool'] =  {'VkAllocationCallbacks': None, 'VkQueryPoolCreateInfo': None, 'VkQueryPool': None, 'VkDevice': None}
mapDict['vkCreateRenderPass'] =  {'VkAllocationCallbacks': None, 'VkRenderPass': None, 'VkRenderPassCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateSampler'] =  {'VkSamplerCreateInfo': None, 'VkAllocationCallbacks': None, 'VkSampler': None, 'VkDevice': None}
mapDict['vkCreateSemaphore'] =  {'VkSemaphoreCreateInfo': None, 'VkAllocationCallbacks': None, 'VkSemaphore': None, 'VkDevice': None}
mapDict['vkCreateShaderModule'] =  {'VkAllocationCallbacks': None, 'VkShaderModuleCreateInfo': None, 'VkShaderModule': None, 'VkDevice': None}
mapDict['vkCreateSharedSwapchainsKHR'] =  {'VkAllocationCallbacks': None, 'VkSwapchainKHR': None, 'VkSwapchainCreateInfoKHR': None, 'VkDevice': None}
...
mapDict['vkDestroyCommandPool'] =  {'VkAllocationCallbacks': None, 'VkCommandPool': None, 'VkDevice': None}
...
mapDict['vkDestroyImage'] =  {'VkAllocationCallbacks': None, 'VkImage': None, 'VkDevice': None}
...
mapDict['vkDestroyRenderPass'] =  {'VkAllocationCallbacks': None, 'VkRenderPass': None, 'VkDevice': None}
...
mapDict['vkGetDeviceMemoryCommitment'] =  {'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkDevice': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkSubresourceLayout': None, 'VkImageSubresource': None, 'VkImage': None, 'VkDevice': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageType': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkImageTiling': None, 'VkImageUsageFlags': None, 'VkImageCreateFlags': None, 'VkImageFormatProperties': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkSampleCountFlagBits': None, 'VkImageType': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkSparseImageFormatProperties': None, 'VkImageTiling': None, 'VkImageUsageFlags': None}
...
mapDict['vkMapMemory'] =  {'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkMemoryMapFlags': None, 'VkDevice': None}
...
mapDict['vkQueueSubmit'] =  {'VkFence': None, 'VkQueue': None, 'VkSubmitInfo': None}
mapDict['vkQueueWaitIdle'] =  {'VkQueue': None}
mapDict['vkResetCommandBuffer'] =  {'VkCommandBufferResetFlags': None, 'VkCommandBuffer': None}
mapDict['vkResetCommandPool'] =  {'VkCommandPoolResetFlags': None, 'VkCommandPool': None, 'VkDevice': None}
