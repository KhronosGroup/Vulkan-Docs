...
consts['VK_DEBUG_REPORT_ERROR_NONE_EXT'] =  'VkDebugReportErrorEXT'
consts['VK_DEBUG_REPORT_ERROR_CALLBACK_REF_EXT'] =  'VkDebugReportErrorEXT'
enums['VkDebugReportErrorEXT'] =  ['VK_DEBUG_REPORT_ERROR_NONE_EXT', 'VK_DEBUG_REPORT_ERROR_CALLBACK_REF_EXT']
consts['VK_EXT_DEBUG_REPORT_SPEC_VERSION'] =  None
consts['VK_EXT_DEBUG_REPORT_EXTENSION_NAME'] =  None
consts['VK_STRUCTURE_TYPE_DEBUG_REPORT_CREATE_INFO_EXT'] =  None
consts['VK_DEBUG_REPORT_INFORMATION_BIT_EXT'] =  'VkDebugReportFlagBitsEXT'
consts['VK_DEBUG_REPORT_WARNING_BIT_EXT'] =  'VkDebugReportFlagBitsEXT'
consts['VK_DEBUG_REPORT_PERFORMANCE_WARNING_BIT_EXT'] =  'VkDebugReportFlagBitsEXT'
consts['VK_DEBUG_REPORT_ERROR_BIT_EXT'] =  'VkDebugReportFlagBitsEXT'
consts['VK_DEBUG_REPORT_DEBUG_BIT_EXT'] =  'VkDebugReportFlagBitsEXT'
enums['VkDebugReportFlagBitsEXT'] =  ['VK_DEBUG_REPORT_INFORMATION_BIT_EXT', 'VK_DEBUG_REPORT_WARNING_BIT_EXT', 'VK_DEBUG_REPORT_PERFORMANCE_WARNING_BIT_EXT', 'VK_DEBUG_REPORT_ERROR_BIT_EXT', 'VK_DEBUG_REPORT_DEBUG_BIT_EXT']
flags['VkDebugReportFlagsEXT'] =  'VkDebugReportFlagBitsEXT'
funcpointers['PFN_vkDebugReportCallbackEXT'] =  None
structs['VkDebugReportCallbackCreateInfoEXT'] =  ['sType', 'pNext', 'flags', 'pfnCallback', 'pUserData']
structs['VkDebugReportCallbackEXT'] =  None
protos['vkCreateDebugReportCallbackEXT'] =  ['instance', 'pCreateInfo', 'pAllocator', 'pCallback']
protos['vkDestroyDebugReportCallbackEXT'] =  ['instance', 'callback', 'pAllocator']
protos['vkDebugReportMessageEXT'] =  ['instance', 'flags', 'objectType', 'object', 'location', 'messageCode', 'pLayerPrefix', 'pMessage']
