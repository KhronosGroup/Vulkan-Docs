...
mapDict['VkAccessFlags'] =  {'VkAccessFlagBits': None, 'VkMemoryBarrier': None, 'VkSubpassDependency': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None}
mapDict['VkAllocationCallbacks'] =  {'vkCreateInstance': None, 'vkCreateFence': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyDevice': None, 'vkDestroyPipelineLayout': None, 'vkDestroyDescriptorSetLayout': None, 'PFN_vkReallocationFunction': None, 'vkCreateImage': None, 'vkCreateXcbSurfaceKHR': None, 'vkCreateImageView': None, 'vkCreateBuffer': None, 'vkAllocateMemory': None, 'vkCreateDevice': None, 'vkDestroyBufferView': None, 'vkCreateCommandPool': None, 'vkCreateShaderModule': None, 'vkDestroySampler': None, 'vkCreateComputePipelines': None, 'vkCreateSampler': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyPipelineCache': None, 'vkDestroyEvent': None, 'PFN_vkInternalAllocationNotification': None, 'vkDestroyCommandPool': None, 'vkDestroyDescriptorPool': None, 'vkCreateFramebuffer': None, 'vkDestroyFence': None, 'vkDestroySemaphore': None, 'PFN_vkFreeFunction': None, 'PFN_vkInternalFreeNotification': None, 'vkDestroyPipeline': None, 'vkCreateRenderPass': None, 'PFN_vkAllocationFunction': None, 'vkCreateBufferView': None, 'vkCreateSemaphore': None, 'vkCreateQueryPool': None, 'vkDestroyImage': None, 'vkFreeMemory': None, 'vkCreatePipelineLayout': None, 'vkDestroyQueryPool': None, 'vkDestroyInstance': None, 'vkCreateDescriptorPool': None, 'vkDestroyBuffer': None, 'vkCreatePipelineCache': None, 'vkCreateEvent': None, 'vkDestroyShaderModule': None, 'vkDestroyRenderPass': None, 'vkDestroyImageView': None, 'vkDestroyFramebuffer': None}
mapDict['VkApplicationInfo'] =  {'VkInstanceCreateInfo': None, 'VkStructureType': None}
mapDict['VkAttachmentDescription'] =  {'VkAttachmentLoadOp': None, 'VkAttachmentStoreOp': None, 'VkRenderPassCreateInfo': None, 'VkFormat': None, 'VkSampleCountFlagBits': None, 'VkImageLayout': None, 'VkAttachmentDescriptionFlags': None}
...
mapDict['VkBindSparseInfo'] =  {'VkSemaphore': None, 'VkStructureType': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'vkQueueBindSparse': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPhysicalDeviceFeatures': None, 'VkCommandBufferInheritanceInfo': None, 'VkPhysicalDeviceLimits': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPhysicalDeviceSparseProperties': None, 'VkSamplerCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'vkWaitForFences': None, 'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdDrawIndirect': None, 'vkCmdUpdateBuffer': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdCopyQueryPoolResults': None, 'vkGetBufferMemoryRequirements': None, 'vkDestroyBuffer': None, 'vkCmdBindIndexBuffer': None, 'VkBufferViewCreateInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdDispatchIndirect': None, 'vkCmdBindVertexBuffers': None, 'VkBufferMemoryBarrier': None, 'vkCmdCopyBufferToImage': None, 'vkCmdFillBuffer': None, 'vkBindBufferMemory': None, 'vkCmdCopyBuffer': None, 'vkCmdCopyImageToBuffer': None, 'vkCreateBuffer': None, 'VkDescriptorBufferInfo': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkSharingMode': None, 'VkDeviceSize': None, 'vkCreateBuffer': None, 'VkBufferCreateFlags': None, 'VkStructureType': None, 'VkBufferUsageFlags': None}
mapDict['VkBufferImageCopy'] =  {'VkDeviceSize': None, 'VkExtent3D': None, 'VkOffset3D': None, 'VkImageSubresourceLayers': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkDeviceSize': None, 'vkCmdWaitEvents': None, 'VkBuffer': None, 'vkCmdPipelineBarrier': None, 'VkStructureType': None, 'VkAccessFlags': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkDeviceSize': None, 'VkFormat': None, 'VkBuffer': None, 'VkBufferViewCreateFlags': None, 'VkStructureType': None, 'vkCreateBufferView': None}
...
mapDict['VkClearValue'] =  {'VkRenderPassBeginInfo': None, 'VkClearDepthStencilValue': None, 'VkClearColorValue': None, 'VkClearAttachment': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdSetStencilWriteMask': None, 'vkCmdCopyImage': None, 'vkCmdBeginQuery': None, 'vkCmdCopyBuffer': None, 'vkCmdWriteTimestamp': None, 'vkCmdBeginRenderPass': None, 'vkCmdBlitImage': None, 'vkCmdResetQueryPool': None, 'vkCmdSetDepthBias': None, 'vkCmdPushConstants': None, 'vkCmdSetEvent': None, 'vkCmdUpdateBuffer': None, 'vkCmdPipelineBarrier': None, 'vkCmdExecuteCommands': None, 'vkCmdEndQuery': None, 'vkCmdBindVertexBuffers': None, 'vkCmdResolveImage': None, 'vkCmdCopyBufferToImage': None, 'vkEndCommandBuffer': None, 'vkFreeCommandBuffers': None, 'vkCmdFillBuffer': None, 'vkCmdSetLineWidth': None, 'vkCmdClearColorImage': None, 'vkCmdSetDepthBounds': None, 'vkCmdBindPipeline': None, 'vkCmdDrawIndirect': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdSetStencilReference': None, 'vkBeginCommandBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdDispatch': None, 'vkCmdSetViewport': None, 'vkCmdSetScissor': None, 'vkCmdEndRenderPass': None, 'vkCmdSetBlendConstants': None, 'vkCmdDispatchIndirect': None, 'vkCmdDraw': None, 'vkCmdResetEvent': None, 'vkResetCommandBuffer': None, 'vkCmdNextSubpass': None, 'vkCmdDrawIndexed': None, 'vkCmdClearAttachments': None, 'VkSubmitInfo': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdWaitEvents': None, 'vkAllocateCommandBuffers': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdBindDescriptorSets': None}
...
mapDict['VkCommandBufferBeginInfo'] =  {'vkBeginCommandBuffer': None, 'VkCommandBufferUsageFlags': None, 'VkCommandBufferInheritanceInfo': None, 'VkStructureType': None}
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkQueryPipelineStatisticFlags': None, 'VkRenderPass': None, 'VkFramebuffer': None, 'VkQueryControlFlags': None, 'VkBool32': None, 'VkCommandBufferBeginInfo': None, 'VkStructureType': None}
...
mapDict['VkCommandPool'] =  {'vkDestroyCommandPool': None, 'VkCommandBufferAllocateInfo': None, 'vkCreateCommandPool': None, 'vkResetCommandPool': None, 'vkFreeCommandBuffers': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkStructureType': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineCreateFlags': None, 'VkPipeline': None, 'vkCreateComputePipelines': None, 'VkPipelineLayout': None}
...
mapDict['VkDescriptorImageInfo'] =  {'VkImageView': None, 'VkWriteDescriptorSet': None, 'VkSampler': None, 'VkImageLayout': None}
mapDict['VkDescriptorPool'] =  {'vkFreeDescriptorSets': None, 'vkDestroyDescriptorPool': None, 'vkResetDescriptorPool': None, 'VkDescriptorSetAllocateInfo': None, 'vkCreateDescriptorPool': None}
...
mapDict['VkDescriptorPoolCreateInfo'] =  {'vkCreateDescriptorPool': None, 'VkDescriptorPoolCreateFlags': None, 'VkStructureType': None, 'VkDescriptorPoolSize': None}
...
mapDict['VkDescriptorSet'] =  {'vkCmdBindDescriptorSets': None, 'vkFreeDescriptorSets': None, 'VkCopyDescriptorSet': None, 'vkAllocateDescriptorSets': None, 'VkWriteDescriptorSet': None}
...
mapDict['VkDescriptorSetLayout'] =  {'VkPipelineLayoutCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyDescriptorSetLayout': None}
...
mapDict['VkDevice'] =  {'vkGetFenceStatus': None, 'vkResetDescriptorPool': None, 'vkCreateFence': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyDevice': None, 'vkCreateComputePipelines': None, 'vkGetPipelineCacheData': None, 'vkResetFences': None, 'vkDestroyDescriptorSetLayout': None, 'vkMergePipelineCaches': None, 'vkCreateImage': None, 'vkCreateImageView': None, 'vkCreateBuffer': None, 'vkWaitForFences': None, 'vkAllocateMemory': None, 'vkFreeMemory': None, 'vkCreateDevice': None, 'vkDestroyBufferView': None, 'vkGetDeviceProcAddr': None, 'vkCreateCommandPool': None, 'vkAllocateDescriptorSets': None, 'vkCreateShaderModule': None, 'vkUpdateDescriptorSets': None, 'vkDestroySampler': None, 'vkResetEvent': None, 'vkGetEventStatus': None, 'vkCreateSampler': None, 'vkBindImageMemory': None, 'vkFlushMappedMemoryRanges': None, 'vkDestroyPipelineCache': None, 'vkDestroyEvent': None, 'vkUnmapMemory': None, 'vkGetImageMemoryRequirements': None, 'vkDestroyCommandPool': None, 'vkDestroyQueryPool': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCreateFramebuffer': None, 'vkDestroyFence': None, 'vkDestroySemaphore': None, 'vkDestroyPipeline': None, 'vkCreateRenderPass': None, 'vkGetBufferMemoryRequirements': None, 'vkCreateBufferView': None, 'vkSetEvent': None, 'vkCreateSemaphore': None, 'vkCreateQueryPool': None, 'vkDestroyPipelineLayout': None, 'vkDestroyImage': None, 'vkCreateDescriptorSetLayout': None, 'vkBindBufferMemory': None, 'vkCreatePipelineLayout': None, 'vkGetImageSubresourceLayout': None, 'vkFreeCommandBuffers': None, 'vkGetQueryPoolResults': None, 'vkDestroyDescriptorPool': None, 'vkCreateDescriptorPool': None, 'vkInvalidateMappedMemoryRanges': None, 'vkGetRenderAreaGranularity': None, 'vkDestroyBuffer': None, 'vkMapMemory': None, 'vkCreatePipelineCache': None, 'vkResetCommandPool': None, 'vkCreateEvent': None, 'vkGetDeviceMemoryCommitment': None, 'vkDestroyShaderModule': None, 'vkDestroyRenderPass': None, 'vkDestroyImageView': None, 'vkGetDeviceQueue': None, 'vkAllocateCommandBuffers': None, 'vkDeviceWaitIdle': None, 'vkFreeDescriptorSets': None, 'vkDestroyFramebuffer': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkDeviceCreateFlags': None, 'VkPhysicalDeviceFeatures': None, 'vkCreateDevice': None, 'VkStructureType': None, 'VkDeviceQueueCreateInfo': None}
mapDict['VkDeviceMemory'] =  {'VkSparseImageMemoryBind': None, 'VkSparseMemoryBind': None, 'VkMappedMemoryRange': None, 'vkBindImageMemory': None, 'vkFreeMemory': None, 'vkMapMemory': None, 'vkAllocateMemory': None, 'vkBindBufferMemory': None, 'vkUnmapMemory': None, 'vkGetDeviceMemoryCommitment': None}
...
mapDict['VkDeviceSize'] =  {'vkCmdDrawIndirect': None, 'VkPhysicalDeviceLimits': None, 'VkSparseMemoryBind': None, 'VkMemoryRequirements': None, 'VkBufferCopy': None, 'vkCmdBindIndexBuffer': None, 'VkMemoryHeap': None, 'VkSparseImageMemoryBind': None, 'VkMappedMemoryRange': None, 'VkSparseImageMemoryRequirements': None, 'vkBindBufferMemory': None, 'VkBufferCreateInfo': None, 'vkCmdDispatchIndirect': None, 'vkGetQueryPoolResults': None, 'VkSubresourceLayout': None, 'vkCmdUpdateBuffer': None, 'VkBufferImageCopy': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdCopyQueryPoolResults': None, 'vkMapMemory': None, 'VkBufferViewCreateInfo': None, 'vkBindImageMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkCmdBindVertexBuffers': None, 'VkBufferMemoryBarrier': None, 'VkMemoryAllocateInfo': None, 'vkCmdFillBuffer': None, 'VkDescriptorBufferInfo': None, 'VkImageFormatProperties': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkSetEvent': None, 'vkDestroyEvent': None, 'vkCmdResetEvent': None, 'vkCmdWaitEvents': None, 'vkResetEvent': None, 'vkGetEventStatus': None, 'vkCreateEvent': None, 'vkCmdSetEvent': None}
...
mapDict['VkExtent3D'] =  {'VkQueueFamilyProperties': None, 'VkSparseImageMemoryBind': None, 'VkImageCreateInfo': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkSparseImageFormatProperties': None, 'VkBufferImageCopy': None, 'VkImageFormatProperties': None}
mapDict['VkFence'] =  {'vkDestroyFence': None, 'vkGetFenceStatus': None, 'vkCreateFence': None, 'vkQueueSubmit': None, 'vkWaitForFences': None, 'vkResetFences': None, 'vkQueueBindSparse': None}
...
mapDict['VkFormat'] =  {'VkImageViewCreateInfo': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkAttachmentDescription': None, 'VkVertexInputAttributeDescription': None, 'VkBufferViewCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None}
...
mapDict['VkFramebuffer'] =  {'VkRenderPassBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkCreateFramebuffer': None, 'vkDestroyFramebuffer': None}
mapDict['VkFramebufferCreateFlags'] =  {'VkFramebufferCreateInfo': None}
mapDict['VkFramebufferCreateInfo'] =  {'VkImageView': None, 'VkFramebufferCreateFlags': None, 'vkCreateFramebuffer': None, 'VkRenderPass': None, 'VkStructureType': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkRenderPass': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkPipeline': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineLayout': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineCreateFlags': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkStructureType': None}
mapDict['VkImage'] =  {'VkImageViewCreateInfo': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyImage': None, 'vkBindImageMemory': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdBlitImage': None, 'vkGetImageMemoryRequirements': None, 'vkCmdResolveImage': None, 'vkDestroyImage': None, 'vkCreateImage': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkImageMemoryBarrier': None, 'VkSparseImageMemoryBindInfo': None, 'vkGetImageSubresourceLayout': None, 'vkCmdClearColorImage': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkImageSubresource': None, 'VkImageSubresourceRange': None, 'VkSparseImageFormatProperties': None, 'VkImageSubresourceLayers': None, 'VkImageAspectFlagBits': None, 'VkClearAttachment': None}
mapDict['VkImageBlit'] =  {'vkCmdBlitImage': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None}
mapDict['VkImageCopy'] =  {'vkCmdCopyImage': None, 'VkImageSubresourceLayers': None, 'VkExtent3D': None, 'VkOffset3D': None}
...
mapDict['VkImageCreateInfo'] =  {'VkSharingMode': None, 'VkImageCreateFlags': None, 'VkImageLayout': None, 'vkCreateImage': None, 'VkStructureType': None, 'VkFormat': None, 'VkImageTiling': None, 'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkExtent3D': None, 'VkImageType': None}
...
mapDict['VkImageLayout'] =  {'VkAttachmentReference': None, 'vkCmdCopyImage': None, 'VkDescriptorImageInfo': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdBlitImage': None, 'vkCmdResolveImage': None, 'VkImageMemoryBarrier': None, 'VkAttachmentDescription': None, 'VkImageCreateInfo': None, 'vkCmdClearColorImage': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkImageMemoryBarrier'] =  {'VkImageSubresourceRange': None, 'VkImage': None, 'vkCmdWaitEvents': None, 'VkImageLayout': None, 'vkCmdPipelineBarrier': None, 'VkStructureType': None, 'VkAccessFlags': None}
...
mapDict['VkImageSubresourceLayers'] =  {'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageBlit': None, 'VkImageAspectFlags': None, 'VkImageCopy': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageMemoryBarrier': None, 'VkImageViewCreateInfo': None, 'VkImageAspectFlags': None, 'vkCmdClearColorImage': None, 'vkCmdClearDepthStencilImage': None}
...
mapDict['VkImageView'] =  {'VkFramebufferCreateInfo': None, 'vkCreateImageView': None, 'VkDescriptorImageInfo': None, 'vkDestroyImageView': None}
mapDict['VkImageViewCreateFlags'] =  {'VkImageViewCreateInfo': None}
mapDict['VkImageViewCreateInfo'] =  {'VkComponentMapping': None, 'VkImageSubresourceRange': None, 'VkImageViewCreateFlags': None, 'VkFormat': None, 'VkImageViewType': None, 'vkCreateImageView': None, 'VkStructureType': None, 'VkImage': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkEnumeratePhysicalDevices': None, 'vkCreateXcbSurfaceKHR': None, 'vkCreateInstance': None, 'vkGetInstanceProcAddr': None, 'vkDestroyInstance': None}
mapDict['VkInstanceCreateFlags'] =  {'VkInstanceCreateInfo': None}
mapDict['VkInstanceCreateInfo'] =  {'vkCreateInstance': None, 'VkApplicationInfo': None, 'VkStructureType': None, 'VkInstanceCreateFlags': None}
...
mapDict['VkOffset3D'] =  {'VkSparseImageMemoryBind': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageBlit': None, 'VkImageCopy': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceFeatures': None, 'vkGetPhysicalDeviceXcbPresentationSupportKHR': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkCreateDevice': None}
...
mapDict['VkPipeline'] =  {'vkCmdBindPipeline': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyPipeline': None, 'vkCreateComputePipelines': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'VkSubpassDescription': None, 'vkCmdBindDescriptorSets': None}
mapDict['VkPipelineCache'] =  {'vkCreateGraphicsPipelines': None, 'vkDestroyPipelineCache': None, 'vkCreateComputePipelines': None, 'vkCreatePipelineCache': None, 'vkGetPipelineCacheData': None, 'vkMergePipelineCaches': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBlendOp': None, 'VkBool32': None, 'VkBlendFactor': None, 'VkColorComponentFlags': None, 'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkPipelineColorBlendStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkBool32': None, 'VkLogicOp': None, 'VkStructureType': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkPipelineDepthStencilStateCreateFlags': None, 'VkCompareOp': None, 'VkStencilOpState': None, 'VkBool32': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateFlags'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateInfo'] =  {'VkDynamicState': None, 'VkPipelineDynamicStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None}
mapDict['VkPipelineInputAssemblyStateCreateFlags'] =  {'VkPipelineInputAssemblyStateCreateInfo': None}
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkBool32': None, 'VkPrimitiveTopology': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineInputAssemblyStateCreateFlags': None}
mapDict['VkPipelineLayout'] =  {'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCmdPushConstants': None, 'vkCreatePipelineLayout': None, 'vkDestroyPipelineLayout': None, 'vkCmdBindDescriptorSets': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkPushConstantRange': None, 'vkCreatePipelineLayout': None, 'VkPipelineLayoutCreateFlags': None, 'VkStructureType': None, 'VkDescriptorSetLayout': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkStructureType': None, 'VkSampleCountFlagBits': None, 'VkBool32': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkSampleMask': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkFrontFace': None, 'VkStructureType': None, 'VkCullModeFlags': None, 'VkBool32': None, 'VkPolygonMode': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkShaderStageFlagBits': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkShaderModule': None, 'VkPipelineShaderStageCreateFlags': None, 'VkSpecializationInfo': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'vkCmdResetEvent': None, 'vkCmdWaitEvents': None, 'VkSubmitInfo': None, 'vkCmdPipelineBarrier': None, 'VkSubpassDependency': None, 'VkPipelineStageFlagBits': None, 'vkCmdSetEvent': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkPipelineVertexInputStateCreateFlags': None, 'VkVertexInputAttributeDescription': None, 'VkVertexInputBindingDescription': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkRect2D': None, 'VkViewport': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineViewportStateCreateFlags': None}
...
mapDict['VkQueryPool'] =  {'vkCmdResetQueryPool': None, 'vkCreateQueryPool': None, 'vkCmdEndQuery': None, 'vkCmdBeginQuery': None, 'vkCmdCopyQueryPoolResults': None, 'vkDestroyQueryPool': None, 'vkCmdWriteTimestamp': None, 'vkGetQueryPoolResults': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkQueryType': None, 'vkCreateQueryPool': None, 'VkQueryPoolCreateFlags': None, 'VkStructureType': None, 'VkQueryPipelineStatisticFlags': None}
...
mapDict['VkRect2D'] =  {'VkRenderPassBeginInfo': None, 'vkCmdSetScissor': None, 'VkPipelineViewportStateCreateInfo': None, 'VkClearRect': None, 'VkOffset2D': None, 'VkExtent2D': None}
mapDict['VkRenderPass'] =  {'VkRenderPassBeginInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkCreateRenderPass': None, 'vkGetRenderAreaGranularity': None, 'vkDestroyRenderPass': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkRenderPass': None, 'VkFramebuffer': None, 'VkRect2D': None, 'VkClearValue': None, 'VkStructureType': None, 'vkCmdBeginRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkAttachmentDescription': None, 'VkSubpassDescription': None, 'VkRenderPassCreateFlags': None, 'vkCreateRenderPass': None, 'VkSubpassDependency': None, 'VkStructureType': None}
mapDict['VkSampleCountFlagBits'] =  {'VkImageCreateInfo': None, 'VkAttachmentDescription': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkSampleCountFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None}
...
mapDict['VkSamplerCreateInfo'] =  {'VkCompareOp': None, 'VkBool32': None, 'VkSamplerMipmapMode': None, 'VkSamplerAddressMode': None, 'VkBorderColor': None, 'VkSamplerCreateFlags': None, 'VkFilter': None, 'VkStructureType': None, 'vkCreateSampler': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageAspectFlags': None, 'VkSparseImageFormatFlags': None, 'VkExtent3D': None, 'VkSparseImageMemoryRequirements': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkSparseMemoryBindFlags': None, 'VkImageSubresource': None, 'VkDeviceSize': None, 'VkOffset3D': None, 'VkSparseImageMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkExtent3D': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkSparseImageOpaqueMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None}
...
mapDict['VkStructureType'] =  {'VkShaderModuleCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkMemoryBarrier': None, 'VkCommandPoolCreateInfo': None, 'VkMappedMemoryRange': None, 'VkFenceCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkQueryPoolCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkCommandBufferBeginInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkXcbSurfaceCreateInfoKHR': None, 'VkSemaphoreCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkApplicationInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkImageCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkEventCreateInfo': None, 'VkBufferCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkSubmitInfo': None, 'VkRenderPassBeginInfo': None, 'VkImageViewCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkBindSparseInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkRenderPassCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkCommandBufferAllocateInfo': None}
mapDict['VkSubmitInfo'] =  {'VkSemaphore': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None, 'vkQueueSubmit': None, 'VkStructureType': None}
...
mapDict['VkSubpassDescription'] =  {'VkPipelineBindPoint': None, 'VkRenderPassCreateInfo': None, 'VkSubpassDescriptionFlags': None, 'VkAttachmentReference': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkBufferView': None, 'VkDescriptorType': None, 'VkStructureType': None, 'VkDescriptorImageInfo': None, 'VkDescriptorSet': None, 'vkUpdateDescriptorSets': None, 'VkDescriptorBufferInfo': None}
...
mapDict['vkAllocateMemory'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkDeviceMemory': None, 'VkMemoryAllocateInfo': None}
...
mapDict['vkCmdBlitImage'] =  {'VkFilter': None, 'VkImageBlit': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImage': None}
mapDict['vkCmdClearAttachments'] =  {'VkCommandBuffer': None, 'VkClearRect': None, 'VkClearAttachment': None}
mapDict['vkCmdClearColorImage'] =  {'VkImageSubresourceRange': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImage': None, 'VkClearColorValue': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImageSubresourceRange': None, 'VkClearDepthStencilValue': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImage': None}
mapDict['vkCmdCopyBuffer'] =  {'VkBuffer': None, 'VkCommandBuffer': None, 'VkBufferCopy': None}
mapDict['vkCmdCopyBufferToImage'] =  {'VkBuffer': None, 'VkBufferImageCopy': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImage': None}
mapDict['vkCmdCopyImage'] =  {'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImage': None, 'VkImageCopy': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkBuffer': None, 'VkBufferImageCopy': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImage': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkBuffer': None, 'VkQueryPool': None, 'VkCommandBuffer': None, 'VkDeviceSize': None, 'VkQueryResultFlags': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkPipelineStageFlags': None, 'VkCommandBuffer': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkDependencyFlags': None}
...
mapDict['vkCmdResolveImage'] =  {'VkImageResolve': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImage': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkPipelineStageFlags': None, 'VkCommandBuffer': None, 'VkBufferMemoryBarrier': None, 'VkEvent': None, 'VkImageMemoryBarrier': None, 'VkMemoryBarrier': None}
mapDict['vkCmdWriteTimestamp'] =  {'VkQueryPool': None, 'VkCommandBuffer': None, 'VkPipelineStageFlagBits': None}
mapDict['vkCreateBuffer'] =  {'VkBuffer': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkBufferCreateInfo': None}
mapDict['vkCreateBufferView'] =  {'VkBufferView': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkBufferViewCreateInfo': None}
mapDict['vkCreateCommandPool'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkCommandPoolCreateInfo': None, 'VkCommandPool': None}
mapDict['vkCreateComputePipelines'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipelineCache': None, 'VkComputePipelineCreateInfo': None, 'VkPipeline': None}
mapDict['vkCreateDescriptorPool'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkDescriptorPoolCreateInfo': None, 'VkDescriptorPool': None}
mapDict['vkCreateDescriptorSetLayout'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkDescriptorSetLayout': None}
...
mapDict['vkCreateFramebuffer'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkFramebufferCreateInfo': None, 'VkFramebuffer': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipelineCache': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipeline': None}
mapDict['vkCreateImage'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkImageCreateInfo': None, 'VkImage': None}
mapDict['vkCreateImageView'] =  {'VkImageView': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkImageViewCreateInfo': None}
mapDict['vkCreateInstance'] =  {'VkAllocationCallbacks': None, 'VkInstance': None, 'VkInstanceCreateInfo': None}
mapDict['vkCreatePipelineCache'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipelineCache': None, 'VkPipelineCacheCreateInfo': None}
mapDict['vkCreatePipelineLayout'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipelineLayoutCreateInfo': None, 'VkPipelineLayout': None}
mapDict['vkCreateQueryPool'] =  {'VkQueryPoolCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkQueryPool': None}
mapDict['vkCreateRenderPass'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkRenderPass': None, 'VkRenderPassCreateInfo': None}
mapDict['vkCreateSampler'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkSamplerCreateInfo': None, 'VkSampler': None}
mapDict['vkCreateSemaphore'] =  {'VkSemaphoreCreateInfo': None, 'VkDevice': None, 'VkSemaphore': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateShaderModule'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkShaderModuleCreateInfo': None, 'VkShaderModule': None}
mapDict['vkCreateXcbSurfaceKHR'] =  {'VkXcbSurfaceCreateInfoKHR': None, 'VkAllocationCallbacks': None, 'VkInstance': None, 'VkSurfaceKHR': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkSubresourceLayout': None, 'VkDevice': None, 'VkImageSubresource': None, 'VkImage': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageTiling': None, 'VkFormat': None, 'VkImageCreateFlags': None, 'VkPhysicalDevice': None, 'VkImageFormatProperties': None, 'VkImageUsageFlags': None, 'VkImageType': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageTiling': None, 'VkFormat': None, 'VkSparseImageFormatProperties': None, 'VkPhysicalDevice': None, 'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkImageType': None}
...
mapDict['vkMapMemory'] =  {'VkDeviceSize': None, 'VkDevice': None, 'VkMemoryMapFlags': None, 'VkDeviceMemory': None}
