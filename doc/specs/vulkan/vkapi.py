...
mapDict['VkAccessFlags'] =  {'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkSubpassDependency': None, 'VkAccessFlagBits': None, 'VkBufferMemoryBarrier': None}
mapDict['VkAllocationCallbacks'] =  {'vkCreateDevice': None, 'vkCreateComputePipelines': None, 'vkDestroyImageView': None, 'vkCreateCommandPool': None, 'vkCreatePipelineCache': None, 'PFN_vkInternalAllocationNotification': None, 'vkDestroyCommandPool': None, 'vkCreateImage': None, 'vkCreateDescriptorSetLayout': None, 'vkFreeMemory': None, 'vkDestroyEvent': None, 'vkCreateGraphicsPipelines': None, 'vkCreateQueryPool': None, 'vkCreateShaderModule': None, 'vkDestroyPipelineCache': None, 'vkDestroyFramebuffer': None, 'vkDestroyRenderPass': None, 'vkDestroyBuffer': None, 'vkDestroyBufferView': None, 'vkDestroyPipelineLayout': None, 'vkCreateSampler': None, 'vkDestroyDescriptorPool': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateFramebuffer': None, 'PFN_vkReallocationFunction': None, 'vkDestroyImage': None, 'vkDestroyFence': None, 'vkCreateInstance': None, 'vkCreateBufferView': None, 'vkDestroySemaphore': None, 'vkCreateFence': None, 'PFN_vkAllocationFunction': None, 'vkDestroyPipeline': None, 'vkCreateImageView': None, 'vkAllocateMemory': None, 'vkDestroyQueryPool': None, 'PFN_vkFreeFunction': None, 'vkCreateBuffer': None, 'vkCreateEvent': None, 'vkDestroyInstance': None, 'vkDestroyDevice': None, 'vkCreateSemaphore': None, 'PFN_vkInternalFreeNotification': None, 'vkCreateRenderPass': None, 'vkCreateDescriptorPool': None, 'vkCreateMirSurfaceKHR': None, 'vkDestroySampler': None, 'vkDestroyShaderModule': None, 'vkCreatePipelineLayout': None}
mapDict['VkApplicationInfo'] =  {'VkStructureType': None, 'VkInstanceCreateInfo': None}
mapDict['VkAttachmentDescription'] =  {'VkRenderPassCreateInfo': None, 'VkFormat': None, 'VkImageLayout': None, 'VkSampleCountFlagBits': None, 'VkAttachmentStoreOp': None, 'VkAttachmentDescriptionFlags': None, 'VkAttachmentLoadOp': None}
...
mapDict['VkBindSparseInfo'] =  {'VkStructureType': None, 'vkQueueBindSparse': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSemaphore': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineRasterizationStateCreateInfo': None, 'VkPhysicalDeviceLimits': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'vkWaitForFences': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkSamplerCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdUpdateBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdCopyBufferToImage': None, 'vkCmdDrawIndirect': None, 'VkBufferViewCreateInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdCopyImageToBuffer': None, 'VkDescriptorBufferInfo': None, 'vkBindBufferMemory': None, 'vkGetBufferMemoryRequirements': None, 'vkCmdDispatchIndirect': None, 'vkCmdCopyBuffer': None, 'vkCmdFillBuffer': None, 'vkCmdCopyQueryPoolResults': None, 'vkCreateBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkDestroyBuffer': None, 'VkBufferMemoryBarrier': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkStructureType': None, 'VkBufferCreateFlags': None, 'VkSharingMode': None, 'VkDeviceSize': None, 'vkCreateBuffer': None, 'VkBufferUsageFlags': None}
mapDict['VkBufferImageCopy'] =  {'VkExtent3D': None, 'vkCmdCopyBufferToImage': None, 'VkDeviceSize': None, 'vkCmdCopyImageToBuffer': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None}
mapDict['VkBufferMemoryBarrier'] =  {'vkCmdWaitEvents': None, 'VkStructureType': None, 'VkAccessFlags': None, 'VkDeviceSize': None, 'vkCmdPipelineBarrier': None, 'VkBuffer': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkStructureType': None, 'VkFormat': None, 'VkBufferViewCreateFlags': None, 'VkDeviceSize': None, 'VkBuffer': None, 'vkCreateBufferView': None}
...
mapDict['VkClearValue'] =  {'VkClearDepthStencilValue': None, 'VkRenderPassBeginInfo': None, 'VkClearColorValue': None, 'VkClearAttachment': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdEndRenderPass': None, 'vkCmdSetBlendConstants': None, 'vkCmdCopyBufferToImage': None, 'vkCmdBindVertexBuffers': None, 'vkCmdClearColorImage': None, 'vkCmdDispatchIndirect': None, 'vkCmdDispatch': None, 'vkEndCommandBuffer': None, 'vkCmdUpdateBuffer': None, 'vkCmdDraw': None, 'VkSubmitInfo': None, 'vkCmdSetViewport': None, 'vkCmdSetEvent': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdEndQuery': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdFillBuffer': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdClearAttachments': None, 'vkAllocateCommandBuffers': None, 'vkCmdExecuteCommands': None, 'vkBeginCommandBuffer': None, 'vkCmdCopyImage': None, 'vkFreeCommandBuffers': None, 'vkCmdBeginRenderPass': None, 'vkResetCommandBuffer': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'vkCmdPushConstants': None, 'vkCmdCopyBuffer': None, 'vkCmdBindDescriptorSets': None, 'vkCmdResetQueryPool': None, 'vkCmdSetStencilReference': None, 'vkCmdSetScissor': None, 'vkCmdBlitImage': None, 'vkCmdResolveImage': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdSetDepthBounds': None, 'vkCmdDrawIndexed': None, 'vkCmdDrawIndirect': None, 'vkCmdBindPipeline': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBeginQuery': None, 'vkCmdSetDepthBias': None, 'vkCmdResetEvent': None, 'vkCmdSetLineWidth': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdBindIndexBuffer': None, 'vkCmdNextSubpass': None, 'vkCmdWriteTimestamp': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'VkStructureType': None, 'VkCommandBufferLevel': None, 'VkCommandPool': None, 'vkAllocateCommandBuffers': None}
mapDict['VkCommandBufferBeginInfo'] =  {'vkBeginCommandBuffer': None, 'VkStructureType': None, 'VkCommandBufferUsageFlags': None, 'VkCommandBufferInheritanceInfo': None}
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkRenderPass': None, 'VkStructureType': None, 'VkQueryControlFlags': None, 'VkQueryPipelineStatisticFlags': None, 'VkBool32': None, 'VkFramebuffer': None, 'VkCommandBufferBeginInfo': None}
...
mapDict['VkCommandPool'] =  {'vkFreeCommandBuffers': None, 'vkDestroyCommandPool': None, 'vkCreateCommandPool': None, 'VkCommandBufferAllocateInfo': None, 'vkResetCommandPool': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipelineLayout': None, 'VkStructureType': None, 'VkPipelineCreateFlags': None, 'VkPipelineShaderStageCreateInfo': None, 'vkCreateComputePipelines': None, 'VkPipeline': None}
...
mapDict['VkDescriptorPool'] =  {'VkDescriptorSetAllocateInfo': None, 'vkDestroyDescriptorPool': None, 'vkFreeDescriptorSets': None, 'vkResetDescriptorPool': None, 'vkCreateDescriptorPool': None}
...
mapDict['VkDescriptorPoolCreateInfo'] =  {'VkStructureType': None, 'vkCreateDescriptorPool': None, 'VkDescriptorPoolCreateFlags': None, 'VkDescriptorPoolSize': None}
...
mapDict['VkDescriptorSet'] =  {'VkCopyDescriptorSet': None, 'vkFreeDescriptorSets': None, 'vkAllocateDescriptorSets': None, 'vkCmdBindDescriptorSets': None, 'VkWriteDescriptorSet': None}
mapDict['VkDescriptorSetAllocateInfo'] =  {'VkStructureType': None, 'VkDescriptorSetLayout': None, 'vkAllocateDescriptorSets': None, 'VkDescriptorPool': None}
mapDict['VkDescriptorSetLayout'] =  {'VkDescriptorSetAllocateInfo': None, 'vkDestroyDescriptorSetLayout': None, 'VkPipelineLayoutCreateInfo': None, 'vkCreateDescriptorSetLayout': None}
mapDict['VkDescriptorSetLayoutBinding'] =  {'VkDescriptorSetLayoutCreateInfo': None, 'VkShaderStageFlags': None, 'VkDescriptorType': None, 'VkSampler': None}
...
mapDict['VkDevice'] =  {'vkGetDeviceQueue': None, 'vkWaitForFences': None, 'vkCreateDevice': None, 'vkResetCommandPool': None, 'vkCreateComputePipelines': None, 'vkDestroyImageView': None, 'vkMergePipelineCaches': None, 'vkResetEvent': None, 'vkDestroyFramebuffer': None, 'vkGetDeviceProcAddr': None, 'vkFlushMappedMemoryRanges': None, 'vkCreateCommandPool': None, 'vkGetDeviceMemoryCommitment': None, 'vkResetDescriptorPool': None, 'vkGetRenderAreaGranularity': None, 'vkCreatePipelineCache': None, 'vkDestroyRenderPass': None, 'vkGetImageSubresourceLayout': None, 'vkCreateImage': None, 'vkBindImageMemory': None, 'vkFreeMemory': None, 'vkSetEvent': None, 'vkDestroyEvent': None, 'vkDeviceWaitIdle': None, 'vkGetFenceStatus': None, 'vkCreateGraphicsPipelines': None, 'vkAllocateCommandBuffers': None, 'vkCreateQueryPool': None, 'vkCreateShaderModule': None, 'vkInvalidateMappedMemoryRanges': None, 'vkDestroyFence': None, 'vkAllocateDescriptorSets': None, 'vkGetPipelineCacheData': None, 'vkFreeDescriptorSets': None, 'vkDestroyBuffer': None, 'vkUnmapMemory': None, 'vkDestroyBufferView': None, 'vkDestroyPipelineLayout': None, 'vkCreateSampler': None, 'vkDestroyDescriptorPool': None, 'vkGetQueryPoolResults': None, 'vkDestroyDescriptorSetLayout': None, 'vkResetFences': None, 'vkCreateBufferView': None, 'vkBindBufferMemory': None, 'vkGetEventStatus': None, 'vkDestroyPipelineCache': None, 'vkDestroyCommandPool': None, 'vkMapMemory': None, 'vkCreateFence': None, 'vkDestroyPipeline': None, 'vkDestroyImage': None, 'vkCreatePipelineLayout': None, 'vkCreateImageView': None, 'vkGetImageSparseMemoryRequirements': None, 'vkAllocateMemory': None, 'vkGetBufferMemoryRequirements': None, 'vkDestroyQueryPool': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateBuffer': None, 'vkCreateFramebuffer': None, 'vkCreateEvent': None, 'vkDestroyDevice': None, 'vkCreateSemaphore': None, 'vkFreeCommandBuffers': None, 'vkGetImageMemoryRequirements': None, 'vkCreateRenderPass': None, 'vkCreateDescriptorPool': None, 'vkUpdateDescriptorSets': None, 'vkDestroySampler': None, 'vkDestroyShaderModule': None, 'vkDestroySemaphore': None}
...
mapDict['VkDeviceMemory'] =  {'vkAllocateMemory': None, 'VkSparseMemoryBind': None, 'vkMapMemory': None, 'vkBindImageMemory': None, 'vkFreeMemory': None, 'VkSparseImageMemoryBind': None, 'VkMappedMemoryRange': None, 'vkBindBufferMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkUnmapMemory': None}
...
mapDict['VkDeviceSize'] =  {'VkMemoryAllocateInfo': None, 'VkSparseMemoryBind': None, 'VkSubresourceLayout': None, 'vkGetQueryPoolResults': None, 'VkBufferImageCopy': None, 'VkDescriptorBufferInfo': None, 'vkBindBufferMemory': None, 'vkCmdDispatchIndirect': None, 'vkMapMemory': None, 'vkCmdBindVertexBuffers': None, 'VkSparseImageMemoryBind': None, 'VkBufferCreateInfo': None, 'VkMappedMemoryRange': None, 'vkCmdDrawIndexedIndirect': None, 'VkPhysicalDeviceLimits': None, 'vkBindImageMemory': None, 'vkCmdDrawIndirect': None, 'VkBufferViewCreateInfo': None, 'VkMemoryHeap': None, 'VkBufferCopy': None, 'vkGetDeviceMemoryCommitment': None, 'vkCmdUpdateBuffer': None, 'VkMemoryRequirements': None, 'vkCmdFillBuffer': None, 'VkImageFormatProperties': None, 'vkCmdCopyQueryPoolResults': None, 'VkBufferMemoryBarrier': None, 'vkCmdBindIndexBuffer': None, 'VkSparseImageMemoryRequirements': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkGetEventStatus': None, 'vkCmdWaitEvents': None, 'vkCmdResetEvent': None, 'vkCmdSetEvent': None, 'vkCreateEvent': None, 'vkSetEvent': None, 'vkDestroyEvent': None, 'vkResetEvent': None}
...
mapDict['VkExtent3D'] =  {'VkSparseImageMemoryBind': None, 'VkImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkSparseImageFormatProperties': None, 'VkQueueFamilyProperties': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkBufferImageCopy': None}
mapDict['VkFence'] =  {'vkDestroyFence': None, 'vkWaitForFences': None, 'vkQueueBindSparse': None, 'vkQueueSubmit': None, 'vkCreateFence': None, 'vkResetFences': None, 'vkGetFenceStatus': None}
...
mapDict['VkFormat'] =  {'VkImageViewCreateInfo': None, 'VkVertexInputAttributeDescription': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceFormatProperties': None, 'VkBufferViewCreateInfo': None, 'VkAttachmentDescription': None}
...
mapDict['VkFramebufferCreateInfo'] =  {'VkRenderPass': None, 'VkStructureType': None, 'VkImageView': None, 'VkFramebufferCreateFlags': None, 'vkCreateFramebuffer': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineCreateFlags': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipeline': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineLayout': None, 'VkRenderPass': None, 'VkStructureType': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None}
mapDict['VkImage'] =  {'VkImageViewCreateInfo': None, 'vkCmdClearColorImage': None, 'vkGetImageSubresourceLayout': None, 'vkCmdCopyBufferToImage': None, 'vkCreateImage': None, 'vkBindImageMemory': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdClearDepthStencilImage': None, 'vkDestroyImage': None, 'VkSparseImageMemoryBindInfo': None, 'vkGetImageMemoryRequirements': None, 'vkCmdCopyImage': None, 'VkImageMemoryBarrier': None, 'vkCmdResolveImage': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCmdBlitImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkImageSubresource': None, 'VkImageSubresourceRange': None, 'VkSparseImageFormatProperties': None, 'VkClearAttachment': None, 'VkImageAspectFlagBits': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageBlit'] =  {'VkImageSubresourceLayers': None, 'vkCmdBlitImage': None, 'VkOffset3D': None}
mapDict['VkImageCopy'] =  {'VkExtent3D': None, 'vkCmdCopyImage': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None}
...
mapDict['VkImageCreateInfo'] =  {'VkExtent3D': None, 'VkImageTiling': None, 'VkStructureType': None, 'VkFormat': None, 'VkSharingMode': None, 'VkSampleCountFlagBits': None, 'VkImageLayout': None, 'VkImageType': None, 'vkCreateImage': None, 'VkImageCreateFlags': None, 'VkImageUsageFlags': None}
...
mapDict['VkImageLayout'] =  {'VkDescriptorImageInfo': None, 'VkImageCreateInfo': None, 'vkCmdResolveImage': None, 'vkCmdClearDepthStencilImage': None, 'VkAttachmentDescription': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdClearColorImage': None, 'VkAttachmentReference': None, 'vkCmdBlitImage': None, 'vkCmdCopyImage': None, 'VkImageMemoryBarrier': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkImageMemoryBarrier'] =  {'VkImage': None, 'VkStructureType': None, 'VkAccessFlags': None, 'VkImageLayout': None, 'VkImageSubresourceRange': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkImageSubresourceLayers'] =  {'VkImageAspectFlags': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageBlit': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageViewCreateInfo': None, 'vkCmdClearColorImage': None, 'VkImageAspectFlags': None, 'vkCmdClearDepthStencilImage': None, 'VkImageMemoryBarrier': None}
...
mapDict['VkImageUsageFlags'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageUsageFlagBits': None}
...
mapDict['VkImageViewCreateInfo'] =  {'VkImage': None, 'VkStructureType': None, 'VkFormat': None, 'VkImageSubresourceRange': None, 'VkImageViewType': None, 'VkComponentMapping': None, 'VkImageViewCreateFlags': None, 'vkCreateImageView': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkCreateMirSurfaceKHR': None, 'vkEnumeratePhysicalDevices': None, 'vkGetInstanceProcAddr': None, 'vkDestroyInstance': None, 'vkCreateInstance': None}
...
mapDict['VkMappedMemoryRange'] =  {'VkStructureType': None, 'VkDeviceMemory': None, 'vkFlushMappedMemoryRanges': None, 'VkDeviceSize': None, 'vkInvalidateMappedMemoryRanges': None}
...
mapDict['VkMirSurfaceCreateInfoKHR'] =  {'vkCreateMirSurfaceKHR': None, 'VkStructureType': None, 'VkMirSurfaceCreateFlagsKHR': None}
mapDict['VkOffset2D'] =  {'VkRect2D': None}
mapDict['VkOffset3D'] =  {'VkSparseImageMemoryBind': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageBlit': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceFeatures': None, 'vkEnumeratePhysicalDevices': None, 'vkEnumerateDeviceLayerProperties': None, 'vkCreateDevice': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceMirPresentationSupportKHR': None}
...
mapDict['VkPipeline'] =  {'VkComputePipelineCreateInfo': None, 'vkCreateComputePipelines': None, 'vkDestroyPipeline': None, 'vkCmdBindPipeline': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCreateGraphicsPipelines': None}
mapDict['VkPipelineBindPoint'] =  {'VkSubpassDescription': None, 'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None}
mapDict['VkPipelineCache'] =  {'vkMergePipelineCaches': None, 'vkGetPipelineCacheData': None, 'vkCreateComputePipelines': None, 'vkDestroyPipelineCache': None, 'vkCreatePipelineCache': None, 'vkCreateGraphicsPipelines': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkPipelineColorBlendStateCreateInfo': None, 'VkBool32': None, 'VkColorComponentFlags': None, 'VkBlendFactor': None, 'VkBlendOp': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkStructureType': None, 'VkLogicOp': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPipelineColorBlendStateCreateFlags': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkPipelineDepthStencilStateCreateFlags': None, 'VkStructureType': None, 'VkStencilOpState': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkCompareOp': None}
mapDict['VkPipelineDynamicStateCreateFlags'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateInfo'] =  {'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineDynamicStateCreateFlags': None, 'VkDynamicState': None}
mapDict['VkPipelineInputAssemblyStateCreateFlags'] =  {'VkPipelineInputAssemblyStateCreateInfo': None}
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkStructureType': None, 'VkBool32': None, 'VkPipelineInputAssemblyStateCreateFlags': None, 'VkPrimitiveTopology': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineLayout'] =  {'vkDestroyPipelineLayout': None, 'VkComputePipelineCreateInfo': None, 'vkCmdBindDescriptorSets': None, 'vkCmdPushConstants': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCreatePipelineLayout': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkPipelineLayoutCreateFlags': None, 'VkStructureType': None, 'vkCreatePipelineLayout': None, 'VkDescriptorSetLayout': None, 'VkPushConstantRange': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkStructureType': None, 'VkSampleCountFlagBits': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkSampleMask': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkStructureType': None, 'VkFrontFace': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkBool32': None, 'VkCullModeFlags': None, 'VkPolygonMode': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkPipelineShaderStageCreateFlags': None, 'VkStructureType': None, 'VkShaderModule': None, 'VkComputePipelineCreateInfo': None, 'VkSpecializationInfo': None, 'VkShaderStageFlagBits': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'VkPipelineStageFlagBits': None, 'vkCmdWaitEvents': None, 'vkCmdResetEvent': None, 'vkCmdSetEvent': None, 'vkCmdPipelineBarrier': None, 'VkSubmitInfo': None, 'VkSubpassDependency': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkVertexInputBindingDescription': None, 'VkVertexInputAttributeDescription': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineVertexInputStateCreateFlags': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkRect2D': None, 'VkStructureType': None, 'VkViewport': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineViewportStateCreateFlags': None}
...
mapDict['VkQueryPool'] =  {'vkCmdBeginQuery': None, 'vkDestroyQueryPool': None, 'vkCreateQueryPool': None, 'vkCmdEndQuery': None, 'vkGetQueryPoolResults': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdResetQueryPool': None, 'vkCmdWriteTimestamp': None}
...
mapDict['VkQueueFamilyProperties'] =  {'VkExtent3D': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'VkQueueFlags': None}
mapDict['VkQueueFlagBits'] =  {'VkQueueFlags': None}
mapDict['VkQueueFlags'] =  {'VkQueueFamilyProperties': None, 'VkQueueFlagBits': None}
mapDict['VkRect2D'] =  {'vkCmdSetScissor': None, 'VkExtent2D': None, 'VkRenderPassBeginInfo': None, 'VkClearRect': None, 'VkOffset2D': None, 'VkPipelineViewportStateCreateInfo': None}
mapDict['VkRenderPass'] =  {'VkRenderPassBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkGetRenderAreaGranularity': None, 'VkFramebufferCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCreateRenderPass': None, 'vkDestroyRenderPass': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkRenderPass': None, 'VkStructureType': None, 'VkRect2D': None, 'VkClearValue': None, 'VkFramebuffer': None, 'vkCmdBeginRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkSubpassDescription': None, 'VkStructureType': None, 'VkSubpassDependency': None, 'VkRenderPassCreateFlags': None, 'VkAttachmentDescription': None, 'vkCreateRenderPass': None}
mapDict['VkSampleCountFlagBits'] =  {'VkSampleCountFlags': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkAttachmentDescription': None}
...
mapDict['VkSamplerCreateInfo'] =  {'VkSamplerCreateFlags': None, 'VkSamplerAddressMode': None, 'VkBorderColor': None, 'vkCreateSampler': None, 'VkFilter': None, 'VkBool32': None, 'VkStructureType': None, 'VkCompareOp': None, 'VkSamplerMipmapMode': None}
mapDict['VkSamplerMipmapMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSemaphore'] =  {'vkDestroySemaphore': None, 'VkBindSparseInfo': None, 'vkCreateSemaphore': None, 'VkSubmitInfo': None}
...
mapDict['VkShaderModule'] =  {'vkDestroyShaderModule': None, 'vkCreateShaderModule': None, 'VkPipelineShaderStageCreateInfo': None}
...
mapDict['VkShaderStageFlags'] =  {'VkPushConstantRange': None, 'VkShaderStageFlagBits': None, 'vkCmdPushConstants': None, 'VkDescriptorSetLayoutBinding': None}
...
mapDict['VkSparseImageMemoryBind'] =  {'VkExtent3D': None, 'VkSparseMemoryBindFlags': None, 'VkImageSubresource': None, 'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkSparseImageMemoryBindInfo': None, 'VkOffset3D': None}
mapDict['VkSparseImageMemoryBindInfo'] =  {'VkImage': None, 'VkBindSparseInfo': None, 'VkSparseImageMemoryBind': None}
mapDict['VkSparseImageMemoryRequirements'] =  {'vkGetImageSparseMemoryRequirements': None, 'VkDeviceSize': None, 'VkSparseImageFormatProperties': None}
mapDict['VkSparseImageOpaqueMemoryBindInfo'] =  {'VkImage': None, 'VkBindSparseInfo': None, 'VkSparseMemoryBind': None}
mapDict['VkSparseMemoryBind'] =  {'VkSparseMemoryBindFlags': None, 'VkSparseBufferMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkDeviceSize': None}
...
mapDict['VkStructureType'] =  {'VkCommandBufferBeginInfo': None, 'VkImageCreateInfo': None, 'VkApplicationInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkSamplerCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkEventCreateInfo': None, 'VkMirSurfaceCreateInfoKHR': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkMemoryBarrier': None, 'VkGraphicsPipelineCreateInfo': None, 'VkBindSparseInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkCopyDescriptorSet': None, 'VkMappedMemoryRange': None, 'VkWriteDescriptorSet': None, 'VkBufferCreateInfo': None, 'VkFenceCreateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkSubmitInfo': None, 'VkRenderPassCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkDeviceCreateInfo': None}
mapDict['VkSubmitInfo'] =  {'VkStructureType': None, 'vkQueueSubmit': None, 'VkSemaphore': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None}
...
mapDict['VkSurfaceKHR'] =  {'vkCreateMirSurfaceKHR': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkStructureType': None, 'VkDescriptorImageInfo': None, 'VkDescriptorType': None, 'VkBufferView': None, 'VkDescriptorSet': None, 'VkDescriptorBufferInfo': None, 'vkUpdateDescriptorSets': None}
...
mapDict['vkAllocateMemory'] =  {'VkDeviceMemory': None, 'VkAllocationCallbacks': None, 'VkMemoryAllocateInfo': None, 'VkDevice': None}
...
mapDict['vkCmdBindDescriptorSets'] =  {'VkPipelineLayout': None, 'VkDescriptorSet': None, 'VkCommandBuffer': None, 'VkPipelineBindPoint': None}
...
mapDict['vkCmdCopyBufferToImage'] =  {'VkImage': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkBufferImageCopy': None, 'VkImageLayout': None}
mapDict['vkCmdCopyImage'] =  {'VkImage': None, 'VkImageCopy': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkImage': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkBufferImageCopy': None, 'VkImageLayout': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkQueryResultFlags': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkDeviceSize': None, 'VkQueryPool': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkDependencyFlags': None, 'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdResolveImage'] =  {'VkImage': None, 'VkImageResolve': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkEvent': None, 'VkBufferMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None}
...
mapDict['vkCreateCommandPool'] =  {'VkCommandPool': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkCommandPoolCreateInfo': None}
mapDict['vkCreateComputePipelines'] =  {'VkComputePipelineCreateInfo': None, 'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkDevice': None, 'VkPipelineCache': None}
...
mapDict['vkCreateDevice'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPhysicalDevice': None, 'VkDeviceCreateInfo': None}
mapDict['vkCreateEvent'] =  {'VkEventCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkEvent': None}
mapDict['vkCreateFence'] =  {'VkAllocationCallbacks': None, 'VkFence': None, 'VkDevice': None, 'VkFenceCreateInfo': None}
mapDict['vkCreateFramebuffer'] =  {'VkFramebufferCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkFramebuffer': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkDevice': None, 'VkPipelineCache': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['vkCreateMirSurfaceKHR'] =  {'VkAllocationCallbacks': None, 'VkInstance': None, 'VkMirSurfaceCreateInfoKHR': None, 'VkSurfaceKHR': None}
...
mapDict['vkCreateRenderPass'] =  {'VkRenderPass': None, 'VkAllocationCallbacks': None, 'VkRenderPassCreateInfo': None, 'VkDevice': None}
...
mapDict['vkCreateShaderModule'] =  {'VkShaderModule': None, 'VkAllocationCallbacks': None, 'VkShaderModuleCreateInfo': None, 'VkDevice': None}
...
mapDict['vkDestroyFence'] =  {'VkAllocationCallbacks': None, 'VkFence': None, 'VkDevice': None}
...
mapDict['vkDestroySampler'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkSampler': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageTiling': None, 'VkImageUsageFlags': None, 'VkFormat': None, 'VkPhysicalDevice': None, 'VkImageFormatProperties': None, 'VkImageType': None, 'VkImageCreateFlags': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageUsageFlags': None, 'VkImageTiling': None, 'VkFormat': None, 'VkPhysicalDevice': None, 'VkSampleCountFlagBits': None, 'VkSparseImageFormatProperties': None, 'VkImageType': None}
