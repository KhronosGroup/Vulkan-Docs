...
mapDict['VkAccessFlags'] =  {'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkAccessFlagBits': None, 'VkMemoryBarrier': None, 'VkSubpassDependency': None}
mapDict['VkAllocationCallbacks'] =  {'vkCreateSharedSwapchainsKHR': None, 'vkCreateWaylandSurfaceKHR': None, 'vkCreateBuffer': None, 'vkCreateDevice': None, 'vkCreateSampler': None, 'vkCreateSwapchainKHR': None, 'vkCreateShaderModule': None, 'vkDestroyRenderPass': None, 'PFN_vkFreeFunction': None, 'PFN_vkReallocationFunction': None, 'vkDestroyBufferView': None, 'vkCreateEvent': None, 'vkCreateSemaphore': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateImage': None, 'vkCreateComputePipelines': None, 'vkCreateFence': None, 'vkDestroyDevice': None, 'vkCreateQueryPool': None, 'vkFreeMemory': None, 'vkDestroyPipeline': None, 'vkDestroySurfaceKHR': None, 'vkDestroySampler': None, 'vkDestroyShaderModule': None, 'vkDestroySemaphore': None, 'vkDestroyEvent': None, 'vkDestroyPipelineCache': None, 'vkDestroyFence': None, 'PFN_vkInternalFreeNotification': None, 'vkDestroyImageView': None, 'vkCreateImageView': None, 'vkDestroyBuffer': None, 'vkCreateDescriptorSetLayout': None, 'vkCreatePipelineLayout': None, 'vkCreateAndroidSurfaceKHR': None, 'vkDestroySwapchainKHR': None, 'vkDestroyQueryPool': None, 'vkCreateXlibSurfaceKHR': None, 'vkCreateCommandPool': None, 'vkCreateWin32SurfaceKHR': None, 'vkAllocateMemory': None, 'vkCreateDisplayModeKHR': None, 'vkDestroyDescriptorPool': None, 'vkCreateGraphicsPipelines': None, 'vkCreateMirSurfaceKHR': None, 'vkDestroyFramebuffer': None, 'vkDestroyInstance': None, 'vkCreateDescriptorPool': None, 'vkDestroyCommandPool': None, 'vkDestroyImage': None, 'vkCreateBufferView': None, 'vkCreateFramebuffer': None, 'vkCreatePipelineCache': None, 'vkCreateXcbSurfaceKHR': None, 'vkCreateInstance': None, 'PFN_vkInternalAllocationNotification': None, 'PFN_vkAllocationFunction': None, 'vkCreateDisplayPlaneSurfaceKHR': None, 'vkDestroyPipelineLayout': None, 'vkCreateRenderPass': None}
mapDict['VkAndroidSurfaceCreateFlagsKHR'] =  {'VkAndroidSurfaceCreateInfoKHR': None}
mapDict['VkAndroidSurfaceCreateInfoKHR'] =  {'vkCreateAndroidSurfaceKHR': None, 'VkStructureType': None, 'VkAndroidSurfaceCreateFlagsKHR': None}
mapDict['VkApplicationInfo'] =  {'VkInstanceCreateInfo': None, 'VkStructureType': None}
mapDict['VkAttachmentDescription'] =  {'VkSampleCountFlagBits': None, 'VkAttachmentDescriptionFlags': None, 'VkFormat': None, 'VkAttachmentStoreOp': None, 'VkAttachmentLoadOp': None, 'VkImageLayout': None, 'VkRenderPassCreateInfo': None}
...
mapDict['VkBindSparseInfo'] =  {'VkSparseBufferMemoryBindInfo': None, 'VkSemaphore': None, 'VkStructureType': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'vkQueueBindSparse': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineRasterizationStateCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkSwapchainCreateInfoKHR': None, 'VkDisplayPresentInfoKHR': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPhysicalDeviceLimits': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'vkWaitForFences': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPipelineMultisampleStateCreateInfo': None, 'vkGetPhysicalDeviceSurfaceSupportKHR': None, 'VkCommandBufferInheritanceInfo': None, 'VkDisplayPropertiesKHR': None, 'VkPipelineDepthStencilStateCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdCopyImageToBuffer': None, 'vkGetBufferMemoryRequirements': None, 'vkCreateBuffer': None, 'vkDestroyBuffer': None, 'vkCmdFillBuffer': None, 'vkCmdDrawIndirect': None, 'vkBindBufferMemory': None, 'vkCmdCopyBufferToImage': None, 'vkCmdBindIndexBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdDispatchIndirect': None, 'VkBufferViewCreateInfo': None, 'vkCmdUpdateBuffer': None, 'VkSparseBufferMemoryBindInfo': None, 'VkBufferMemoryBarrier': None, 'vkCmdCopyQueryPoolResults': None, 'VkDescriptorBufferInfo': None, 'vkCmdCopyBuffer': None, 'vkCmdDrawIndexedIndirect': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkBufferCreateFlags': None, 'VkDeviceSize': None, 'VkSharingMode': None, 'vkCreateBuffer': None, 'VkStructureType': None, 'VkBufferUsageFlags': None}
mapDict['VkBufferImageCopy'] =  {'VkDeviceSize': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None, 'vkCmdCopyBufferToImage': None, 'VkExtent3D': None, 'vkCmdCopyImageToBuffer': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkDeviceSize': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkStructureType': None, 'VkAccessFlags': None, 'VkBuffer': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkDeviceSize': None, 'VkBufferViewCreateFlags': None, 'VkFormat': None, 'VkStructureType': None, 'VkBuffer': None, 'vkCreateBufferView': None}
...
mapDict['VkClearValue'] =  {'VkRenderPassBeginInfo': None, 'VkClearDepthStencilValue': None, 'VkClearAttachment': None, 'VkClearColorValue': None}
...
mapDict['VkColorSpaceKHR'] =  {'VkSurfaceFormatKHR': None, 'VkSwapchainCreateInfoKHR': None}
mapDict['VkCommandBuffer'] =  {'vkCmdWaitEvents': None, 'vkCmdResetEvent': None, 'vkFreeCommandBuffers': None, 'vkCmdCopyBufferToImage': None, 'vkCmdSetViewport': None, 'vkCmdSetBlendConstants': None, 'vkCmdCopyImage': None, 'vkCmdBeginQuery': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyBuffer': None, 'vkBeginCommandBuffer': None, 'vkCmdResolveImage': None, 'vkCmdWriteTimestamp': None, 'vkCmdResetQueryPool': None, 'vkCmdDispatchIndirect': None, 'vkCmdSetScissor': None, 'vkCmdUpdateBuffer': None, 'vkCmdDispatch': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdBindPipeline': None, 'vkCmdSetDepthBounds': None, 'vkResetCommandBuffer': None, 'vkCmdDrawIndexed': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdSetLineWidth': None, 'vkEndCommandBuffer': None, 'vkCmdDraw': None, 'vkCmdBindIndexBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdPushConstants': None, 'vkCmdClearAttachments': None, 'vkCmdBindDescriptorSets': None, 'vkCmdEndRenderPass': None, 'vkCmdSetDepthBias': None, 'vkCmdSetStencilReference': None, 'vkCmdSetEvent': None, 'vkCmdNextSubpass': None, 'vkCmdEndQuery': None, 'vkCmdDrawIndirect': None, 'vkCmdClearColorImage': None, 'vkAllocateCommandBuffers': None, 'vkCmdFillBuffer': None, 'VkSubmitInfo': None, 'vkCmdPipelineBarrier': None, 'vkCmdExecuteCommands': None, 'vkCmdBlitImage': None, 'vkCmdBeginRenderPass': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdSetStencilWriteMask': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'VkCommandPool': None, 'VkCommandBufferLevel': None, 'VkStructureType': None, 'vkAllocateCommandBuffers': None}
...
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkStructureType': None, 'VkBool32': None, 'VkQueryControlFlags': None, 'VkCommandBufferBeginInfo': None, 'VkRenderPass': None, 'VkFramebuffer': None, 'VkQueryPipelineStatisticFlags': None}
...
mapDict['VkCommandPool'] =  {'VkCommandBufferAllocateInfo': None, 'vkDestroyCommandPool': None, 'vkCreateCommandPool': None, 'vkFreeCommandBuffers': None, 'vkResetCommandPool': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipeline': None, 'VkStructureType': None, 'VkPipelineShaderStageCreateInfo': None, 'vkCreateComputePipelines': None, 'VkPipelineCreateFlags': None, 'VkPipelineLayout': None}
...
mapDict['VkDescriptorImageInfo'] =  {'VkImageLayout': None, 'VkImageView': None, 'VkSampler': None, 'VkWriteDescriptorSet': None}
mapDict['VkDescriptorPool'] =  {'vkResetDescriptorPool': None, 'vkCreateDescriptorPool': None, 'VkDescriptorSetAllocateInfo': None, 'vkDestroyDescriptorPool': None, 'vkFreeDescriptorSets': None}
...
mapDict['VkDescriptorSet'] =  {'vkCmdBindDescriptorSets': None, 'VkCopyDescriptorSet': None, 'vkAllocateDescriptorSets': None, 'VkWriteDescriptorSet': None, 'vkFreeDescriptorSets': None}
...
mapDict['VkDescriptorSetLayoutBinding'] =  {'VkDescriptorSetLayoutCreateInfo': None, 'VkDescriptorType': None, 'VkShaderStageFlags': None, 'VkSampler': None}
mapDict['VkDescriptorSetLayoutCreateFlags'] =  {'VkDescriptorSetLayoutCreateInfo': None}
mapDict['VkDescriptorSetLayoutCreateInfo'] =  {'VkDescriptorSetLayoutCreateFlags': None, 'vkCreateDescriptorSetLayout': None, 'VkStructureType': None, 'VkDescriptorSetLayoutBinding': None}
mapDict['VkDescriptorType'] =  {'VkWriteDescriptorSet': None, 'VkDescriptorPoolSize': None, 'VkDescriptorSetLayoutBinding': None}
mapDict['VkDevice'] =  {'vkResetEvent': None, 'vkCreateSharedSwapchainsKHR': None, 'vkCreateBuffer': None, 'vkCreateDevice': None, 'vkCreateSampler': None, 'vkResetFences': None, 'vkFreeCommandBuffers': None, 'vkResetDescriptorPool': None, 'vkDestroyRenderPass': None, 'vkDestroyImageView': None, 'vkGetPipelineCacheData': None, 'vkCreateDescriptorPool': None, 'vkDestroyCommandPool': None, 'vkCreateImageView': None, 'vkDestroyBufferView': None, 'vkCreateEvent': None, 'vkCreateSwapchainKHR': None, 'vkAcquireNextImageKHR': None, 'vkGetQueryPoolResults': None, 'vkCreateSemaphore': None, 'vkFreeDescriptorSets': None, 'vkGetImageSubresourceLayout': None, 'vkUnmapMemory': None, 'vkCreateImage': None, 'vkAllocateDescriptorSets': None, 'vkCreatePipelineLayout': None, 'vkCreateFence': None, 'vkGetFenceStatus': None, 'vkCreateQueryPool': None, 'vkFreeMemory': None, 'vkDestroyPipeline': None, 'vkDestroyEvent': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroyShaderModule': None, 'vkDestroySemaphore': None, 'vkGetEventStatus': None, 'vkDestroyPipelineCache': None, 'vkAllocateCommandBuffers': None, 'vkDestroyFence': None, 'vkInvalidateMappedMemoryRanges': None, 'vkGetBufferMemoryRequirements': None, 'vkGetImageSparseMemoryRequirements': None, 'vkDestroyBuffer': None, 'vkCreateDescriptorSetLayout': None, 'vkBindBufferMemory': None, 'vkDestroyDescriptorPool': None, 'vkGetRenderAreaGranularity': None, 'vkAllocateMemory': None, 'vkBindImageMemory': None, 'vkFlushMappedMemoryRanges': None, 'vkDestroyQueryPool': None, 'vkDestroySampler': None, 'vkCreateCommandPool': None, 'vkGetImageMemoryRequirements': None, 'vkMergePipelineCaches': None, 'vkDestroySwapchainKHR': None, 'vkDestroyDevice': None, 'vkGetDeviceProcAddr': None, 'vkCreateGraphicsPipelines': None, 'vkMapMemory': None, 'vkDestroyFramebuffer': None, 'vkDeviceWaitIdle': None, 'vkUpdateDescriptorSets': None, 'vkCreateShaderModule': None, 'vkCreateFramebuffer': None, 'vkGetDeviceQueue': None, 'vkDestroyImage': None, 'vkCreateBufferView': None, 'vkGetDeviceMemoryCommitment': None, 'vkCreatePipelineCache': None, 'vkWaitForFences': None, 'vkCreateComputePipelines': None, 'vkSetEvent': None, 'vkGetSwapchainImagesKHR': None, 'vkResetCommandPool': None, 'vkDestroyPipelineLayout': None, 'vkCreateRenderPass': None}
...
mapDict['VkDeviceMemory'] =  {'vkUnmapMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkAllocateMemory': None, 'vkMapMemory': None, 'VkSparseImageMemoryBind': None, 'VkSparseMemoryBind': None, 'vkBindBufferMemory': None, 'vkFreeMemory': None, 'vkBindImageMemory': None, 'VkMappedMemoryRange': None}
...
mapDict['VkDeviceSize'] =  {'vkCmdDrawIndexedIndirect': None, 'vkCmdDispatchIndirect': None, 'vkCmdUpdateBuffer': None, 'vkBindBufferMemory': None, 'vkCmdBindIndexBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkBindImageMemory': None, 'VkMappedMemoryRange': None, 'VkBufferCreateInfo': None, 'VkImageFormatProperties': None, 'VkDescriptorBufferInfo': None, 'VkBufferImageCopy': None, 'VkPhysicalDeviceLimits': None, 'VkMemoryRequirements': None, 'VkSparseMemoryBind': None, 'vkMapMemory': None, 'VkBufferMemoryBarrier': None, 'vkCmdFillBuffer': None, 'vkCmdDrawIndirect': None, 'VkSparseImageMemoryRequirements': None, 'VkSparseImageMemoryBind': None, 'VkBufferViewCreateInfo': None, 'vkGetDeviceMemoryCommitment': None, 'VkBufferCopy': None, 'vkCmdCopyQueryPoolResults': None, 'VkMemoryHeap': None, 'VkMemoryAllocateInfo': None, 'vkGetQueryPoolResults': None, 'VkSubresourceLayout': None}
mapDict['VkDisplayKHR'] =  {'VkDisplayPropertiesKHR': None, 'vkCreateDisplayModeKHR': None, 'VkDisplayPlanePropertiesKHR': None, 'vkGetDisplayModePropertiesKHR': None, 'vkGetDisplayPlaneSupportedDisplaysKHR': None}
mapDict['VkDisplayModeCreateFlagsKHR'] =  {'VkDisplayModeCreateInfoKHR': None}
mapDict['VkDisplayModeCreateInfoKHR'] =  {'VkDisplayModeCreateFlagsKHR': None, 'vkCreateDisplayModeKHR': None, 'VkDisplayModeParametersKHR': None, 'VkStructureType': None}
mapDict['VkDisplayModeKHR'] =  {'vkGetDisplayPlaneCapabilitiesKHR': None, 'VkDisplayModePropertiesKHR': None, 'vkCreateDisplayModeKHR': None, 'VkDisplaySurfaceCreateInfoKHR': None}
mapDict['VkDisplayModeParametersKHR'] =  {'VkDisplayModePropertiesKHR': None, 'VkDisplayModeCreateInfoKHR': None, 'VkExtent2D': None}
mapDict['VkDisplayModePropertiesKHR'] =  {'vkGetDisplayModePropertiesKHR': None, 'VkDisplayModeParametersKHR': None, 'VkDisplayModeKHR': None}
mapDict['VkDisplayPlaneAlphaFlagBitsKHR'] =  {'VkDisplayPlaneAlphaFlagsKHR': None, 'VkDisplaySurfaceCreateInfoKHR': None}
mapDict['VkDisplayPlaneAlphaFlagsKHR'] =  {'VkDisplayPlaneCapabilitiesKHR': None, 'VkDisplayPlaneAlphaFlagBitsKHR': None}
mapDict['VkDisplayPlaneCapabilitiesKHR'] =  {'vkGetDisplayPlaneCapabilitiesKHR': None, 'VkOffset2D': None, 'VkDisplayPlaneAlphaFlagsKHR': None, 'VkExtent2D': None}
mapDict['VkDisplayPlanePropertiesKHR'] =  {'vkGetPhysicalDeviceDisplayPlanePropertiesKHR': None, 'VkDisplayKHR': None}
mapDict['VkDisplayPresentInfoKHR'] =  {'VkBool32': None, 'VkRect2D': None, 'VkStructureType': None}
mapDict['VkDisplayPropertiesKHR'] =  {'VkBool32': None, 'VkSurfaceTransformFlagsKHR': None, 'VkExtent2D': None, 'VkDisplayKHR': None, 'vkGetPhysicalDeviceDisplayPropertiesKHR': None}
mapDict['VkDisplaySurfaceCreateFlagsKHR'] =  {'VkDisplaySurfaceCreateInfoKHR': None}
mapDict['VkDisplaySurfaceCreateInfoKHR'] =  {'VkSurfaceTransformFlagBitsKHR': None, 'vkCreateDisplayPlaneSurfaceKHR': None, 'VkStructureType': None, 'VkDisplayModeKHR': None, 'VkDisplaySurfaceCreateFlagsKHR': None, 'VkDisplayPlaneAlphaFlagBitsKHR': None, 'VkExtent2D': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkResetEvent': None, 'vkCmdWaitEvents': None, 'vkCreateEvent': None, 'vkCmdResetEvent': None, 'vkDestroyEvent': None, 'vkSetEvent': None, 'vkGetEventStatus': None, 'vkCmdSetEvent': None}
mapDict['VkEventCreateFlags'] =  {'VkEventCreateInfo': None}
mapDict['VkEventCreateInfo'] =  {'VkEventCreateFlags': None, 'VkStructureType': None, 'vkCreateEvent': None}
mapDict['VkExtensionProperties'] =  {'vkEnumerateDeviceExtensionProperties': None, 'vkEnumerateInstanceExtensionProperties': None}
mapDict['VkExtent2D'] =  {'VkDisplayModeParametersKHR': None, 'VkSwapchainCreateInfoKHR': None, 'VkDisplayPropertiesKHR': None, 'VkDisplayPlaneCapabilitiesKHR': None, 'VkRect2D': None, 'vkGetRenderAreaGranularity': None, 'VkDisplaySurfaceCreateInfoKHR': None, 'VkSurfaceCapabilitiesKHR': None}
mapDict['VkExtent3D'] =  {'VkImageResolve': None, 'VkImageCopy': None, 'VkQueueFamilyProperties': None, 'VkSparseImageFormatProperties': None, 'VkSparseImageMemoryBind': None, 'VkBufferImageCopy': None, 'VkImageCreateInfo': None, 'VkImageFormatProperties': None}
mapDict['VkFence'] =  {'vkDestroyFence': None, 'vkWaitForFences': None, 'vkQueueSubmit': None, 'vkGetFenceStatus': None, 'vkCreateFence': None, 'vkResetFences': None, 'vkAcquireNextImageKHR': None, 'vkQueueBindSparse': None}
...
mapDict['VkFormat'] =  {'VkBufferViewCreateInfo': None, 'VkAttachmentDescription': None, 'vkGetPhysicalDeviceFormatProperties': None, 'VkVertexInputAttributeDescription': None, 'VkSwapchainCreateInfoKHR': None, 'VkSurfaceFormatKHR': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageViewCreateInfo': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkFramebufferCreateInfo'] =  {'vkCreateFramebuffer': None, 'VkFramebufferCreateFlags': None, 'VkImageView': None, 'VkStructureType': None, 'VkRenderPass': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineRasterizationStateCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkStructureType': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkRenderPass': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipeline': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineLayout': None, 'VkPipelineCreateFlags': None, 'VkPipelineDepthStencilStateCreateInfo': None}
mapDict['VkImage'] =  {'vkCmdCopyImageToBuffer': None, 'vkCreateImage': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCmdClearDepthStencilImage': None, 'VkImageMemoryBarrier': None, 'vkGetSwapchainImagesKHR': None, 'VkImageViewCreateInfo': None, 'vkCmdClearColorImage': None, 'vkGetImageMemoryRequirements': None, 'vkDestroyImage': None, 'vkCmdCopyBufferToImage': None, 'vkCmdResolveImage': None, 'vkBindImageMemory': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'vkCmdBlitImage': None, 'vkCmdCopyImage': None, 'vkGetImageSubresourceLayout': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkImageSubresourceLayers': None, 'VkImageAspectFlagBits': None, 'VkImageSubresourceRange': None, 'VkClearAttachment': None, 'VkImageSubresource': None, 'VkSparseImageFormatProperties': None}
...
mapDict['VkImageCreateInfo'] =  {'VkImageTiling': None, 'VkSampleCountFlagBits': None, 'VkSharingMode': None, 'VkFormat': None, 'VkStructureType': None, 'VkImageLayout': None, 'VkImageType': None, 'VkExtent3D': None, 'VkImageCreateFlags': None, 'vkCreateImage': None, 'VkImageUsageFlags': None}
mapDict['VkImageFormatProperties'] =  {'VkDeviceSize': None, 'VkExtent3D': None, 'VkSampleCountFlags': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
mapDict['VkImageLayout'] =  {'VkAttachmentDescription': None, 'VkDescriptorImageInfo': None, 'vkCmdCopyImageToBuffer': None, 'VkAttachmentReference': None, 'vkCmdClearColorImage': None, 'VkImageMemoryBarrier': None, 'vkCmdResolveImage': None, 'vkCmdCopyImage': None, 'vkCmdCopyBufferToImage': None, 'vkCmdBlitImage': None, 'VkImageCreateInfo': None, 'vkCmdClearDepthStencilImage': None}
mapDict['VkImageMemoryBarrier'] =  {'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkStructureType': None, 'VkAccessFlags': None, 'VkImage': None, 'VkImageLayout': None, 'VkImageSubresourceRange': None}
mapDict['VkImageResolve'] =  {'VkImageSubresourceLayers': None, 'VkExtent3D': None, 'VkOffset3D': None, 'vkCmdResolveImage': None}
mapDict['VkImageSubresource'] =  {'VkImageAspectFlags': None, 'VkSparseImageMemoryBind': None, 'vkGetImageSubresourceLayout': None}
...
mapDict['VkImageSubresourceRange'] =  {'vkCmdClearColorImage': None, 'VkImageViewCreateInfo': None, 'VkImageAspectFlags': None, 'vkCmdClearDepthStencilImage': None, 'VkImageMemoryBarrier': None}
...
mapDict['VkImageUsageFlags'] =  {'VkImageUsageFlagBits': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSwapchainCreateInfoKHR': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkSurfaceCapabilitiesKHR': None}
...
mapDict['VkImageViewCreateInfo'] =  {'vkCreateImageView': None, 'VkFormat': None, 'VkStructureType': None, 'VkImageViewType': None, 'VkImage': None, 'VkImageSubresourceRange': None, 'VkComponentMapping': None, 'VkImageViewCreateFlags': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkCreateWaylandSurfaceKHR': None, 'vkGetInstanceProcAddr': None, 'vkDestroyInstance': None, 'vkCreateXlibSurfaceKHR': None, 'vkDestroySurfaceKHR': None, 'vkCreateAndroidSurfaceKHR': None, 'vkCreateXcbSurfaceKHR': None, 'vkCreateWin32SurfaceKHR': None, 'vkCreateInstance': None, 'vkCreateMirSurfaceKHR': None, 'vkCreateDisplayPlaneSurfaceKHR': None, 'vkEnumeratePhysicalDevices': None}
mapDict['VkInstanceCreateFlags'] =  {'VkInstanceCreateInfo': None}
mapDict['VkInstanceCreateInfo'] =  {'VkInstanceCreateFlags': None, 'VkStructureType': None, 'VkApplicationInfo': None, 'vkCreateInstance': None}
...
mapDict['VkMappedMemoryRange'] =  {'VkDeviceSize': None, 'vkInvalidateMappedMemoryRanges': None, 'vkFlushMappedMemoryRanges': None, 'VkStructureType': None, 'VkDeviceMemory': None}
...
mapDict['VkMirSurfaceCreateInfoKHR'] =  {'vkCreateMirSurfaceKHR': None, 'VkMirSurfaceCreateFlagsKHR': None, 'VkStructureType': None}
mapDict['VkOffset2D'] =  {'VkDisplayPlaneCapabilitiesKHR': None, 'VkRect2D': None}
mapDict['VkOffset3D'] =  {'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageCopy': None, 'VkImageBlit': None, 'VkSparseImageMemoryBind': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceWaylandPresentationSupportKHR': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkCreateDevice': None, 'vkGetPhysicalDeviceSurfaceCapabilitiesKHR': None, 'vkGetPhysicalDeviceDisplayPropertiesKHR': None, 'vkGetDisplayPlaneCapabilitiesKHR': None, 'vkGetPhysicalDeviceXlibPresentationSupportKHR': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceSurfaceSupportKHR': None, 'vkCreateDisplayModeKHR': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetPhysicalDeviceDisplayPlanePropertiesKHR': None, 'vkGetPhysicalDeviceSurfacePresentModesKHR': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetDisplayModePropertiesKHR': None, 'vkGetDisplayPlaneSupportedDisplaysKHR': None, 'vkGetPhysicalDeviceSurfaceFormatsKHR': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceWin32PresentationSupportKHR': None, 'vkGetPhysicalDeviceMirPresentationSupportKHR': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceFeatures': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkGetPhysicalDeviceXcbPresentationSupportKHR': None}
...
mapDict['VkPhysicalDeviceProperties'] =  {'VkPhysicalDeviceType': None, 'vkGetPhysicalDeviceProperties': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPhysicalDeviceLimits': None}
...
mapDict['VkPipeline'] =  {'vkDestroyPipeline': None, 'vkCreateGraphicsPipelines': None, 'VkComputePipelineCreateInfo': None, 'vkCreateComputePipelines': None, 'vkCmdBindPipeline': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkCreateGraphicsPipelines': None, 'vkCreatePipelineCache': None, 'vkMergePipelineCaches': None, 'vkCreateComputePipelines': None, 'vkDestroyPipelineCache': None, 'vkGetPipelineCacheData': None}
mapDict['VkPipelineCacheCreateFlags'] =  {'VkPipelineCacheCreateInfo': None}
mapDict['VkPipelineCacheCreateInfo'] =  {'VkPipelineCacheCreateFlags': None, 'vkCreatePipelineCache': None, 'VkStructureType': None}
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBool32': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkBlendFactor': None, 'VkBlendOp': None, 'VkColorComponentFlags': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkPipelineColorBlendStateCreateFlags': None, 'VkPipelineColorBlendAttachmentState': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkLogicOp': None, 'VkStructureType': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkStencilOpState': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkStructureType': None, 'VkBool32': None, 'VkCompareOp': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateFlags'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateInfo'] =  {'VkDynamicState': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineDynamicStateCreateFlags': None}
mapDict['VkPipelineInputAssemblyStateCreateFlags'] =  {'VkPipelineInputAssemblyStateCreateInfo': None}
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkPipelineInputAssemblyStateCreateFlags': None, 'VkBool32': None, 'VkPrimitiveTopology': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineLayout'] =  {'vkDestroyPipelineLayout': None, 'vkCmdBindDescriptorSets': None, 'VkComputePipelineCreateInfo': None, 'vkCreatePipelineLayout': None, 'vkCmdPushConstants': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkPushConstantRange': None, 'VkDescriptorSetLayout': None, 'VkStructureType': None, 'VkPipelineLayoutCreateFlags': None, 'vkCreatePipelineLayout': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkSampleCountFlagBits': None, 'VkStructureType': None, 'VkBool32': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkSampleMask': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkPolygonMode': None, 'VkFrontFace': None, 'VkStructureType': None, 'VkCullModeFlags': None, 'VkBool32': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkStructureType': None, 'VkShaderStageFlagBits': None, 'VkPipelineShaderStageCreateFlags': None, 'VkSpecializationInfo': None, 'VkShaderModule': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'VkSubmitInfo': None, 'vkCmdPipelineBarrier': None, 'VkSubpassDependency': None, 'vkCmdResetEvent': None, 'VkPipelineStageFlagBits': None, 'vkCmdSetEvent': None, 'vkCmdWaitEvents': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkVertexInputBindingDescription': None, 'VkVertexInputAttributeDescription': None, 'VkStructureType': None, 'VkPipelineVertexInputStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkPipelineViewportStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkRect2D': None, 'VkStructureType': None, 'VkViewport': None}
mapDict['VkPolygonMode'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPresentInfoKHR'] =  {'VkResult': None, 'VkSwapchainKHR': None, 'VkStructureType': None, 'vkQueuePresentKHR': None, 'VkSemaphore': None}
mapDict['VkPresentModeKHR'] =  {'vkGetPhysicalDeviceSurfacePresentModesKHR': None, 'VkSwapchainCreateInfoKHR': None}
...
mapDict['VkQueryPool'] =  {'vkDestroyQueryPool': None, 'vkCmdBeginQuery': None, 'vkCmdEndQuery': None, 'vkCmdResetQueryPool': None, 'vkCreateQueryPool': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdWriteTimestamp': None, 'vkGetQueryPoolResults': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkQueryPipelineStatisticFlags': None, 'vkCreateQueryPool': None, 'VkStructureType': None, 'VkQueryType': None, 'VkQueryPoolCreateFlags': None}
...
mapDict['VkQueue'] =  {'vkQueueWaitIdle': None, 'vkQueuePresentKHR': None, 'vkGetDeviceQueue': None, 'vkQueueSubmit': None, 'vkQueueBindSparse': None}
...
mapDict['VkRect2D'] =  {'vkCmdSetScissor': None, 'VkOffset2D': None, 'VkClearRect': None, 'VkPipelineViewportStateCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkDisplayPresentInfoKHR': None, 'VkExtent2D': None}
mapDict['VkRenderPass'] =  {'VkFramebufferCreateInfo': None, 'VkRenderPassBeginInfo': None, 'vkCreateRenderPass': None, 'vkDestroyRenderPass': None, 'VkCommandBufferInheritanceInfo': None, 'vkGetRenderAreaGranularity': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkRenderPass': None, 'VkStructureType': None, 'vkCmdBeginRenderPass': None, 'VkRect2D': None, 'VkClearValue': None, 'VkFramebuffer': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkAttachmentDescription': None, 'VkStructureType': None, 'VkSubpassDependency': None, 'vkCreateRenderPass': None, 'VkRenderPassCreateFlags': None, 'VkSubpassDescription': None}
mapDict['VkResult'] =  {'VkPresentInfoKHR': None}
mapDict['VkSampleCountFlagBits'] =  {'VkAttachmentDescription': None, 'VkSampleCountFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkImageCreateInfo': None}
...
mapDict['VkSamplerCreateInfo'] =  {'VkBorderColor': None, 'vkCreateSampler': None, 'VkSamplerMipmapMode': None, 'VkSamplerCreateFlags': None, 'VkStructureType': None, 'VkFilter': None, 'VkBool32': None, 'VkSamplerAddressMode': None, 'VkCompareOp': None}
mapDict['VkSamplerMipmapMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSemaphore'] =  {'VkSubmitInfo': None, 'vkDestroySemaphore': None, 'VkBindSparseInfo': None, 'VkPresentInfoKHR': None, 'vkAcquireNextImageKHR': None, 'vkCreateSemaphore': None}
...
mapDict['VkShaderModule'] =  {'vkCreateShaderModule': None, 'VkPipelineShaderStageCreateInfo': None, 'vkDestroyShaderModule': None}
...
mapDict['VkShaderStageFlags'] =  {'VkPushConstantRange': None, 'vkCmdPushConstants': None, 'VkDescriptorSetLayoutBinding': None, 'VkShaderStageFlagBits': None}
mapDict['VkSharingMode'] =  {'VkBufferCreateInfo': None, 'VkImageCreateInfo': None, 'VkSwapchainCreateInfoKHR': None}
...
mapDict['VkSparseImageFormatFlags'] =  {'VkSparseImageFormatFlagBits': None, 'VkSparseImageFormatProperties': None}
mapDict['VkSparseImageFormatProperties'] =  {'VkExtent3D': None, 'VkSparseImageFormatFlags': None, 'VkImageAspectFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageMemoryRequirements': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkDeviceSize': None, 'VkOffset3D': None, 'VkDeviceMemory': None, 'VkSparseMemoryBindFlags': None, 'VkExtent3D': None, 'VkSparseImageMemoryBindInfo': None, 'VkImageSubresource': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkDeviceSize': None, 'VkSparseMemoryBindFlags': None, 'VkSparseBufferMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkSparseImageOpaqueMemoryBindInfo': None}
...
mapDict['VkStencilFaceFlags'] =  {'vkCmdSetStencilCompareMask': None, 'vkCmdSetStencilReference': None, 'VkStencilFaceFlagBits': None, 'vkCmdSetStencilWriteMask': None}
...
mapDict['VkStructureType'] =  {'VkSamplerCreateInfo': None, 'VkBindSparseInfo': None, 'VkCommandBufferBeginInfo': None, 'VkAndroidSurfaceCreateInfoKHR': None, 'VkApplicationInfo': None, 'VkMappedMemoryRange': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkImageCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkEventCreateInfo': None, 'VkBufferCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkWaylandSurfaceCreateInfoKHR': None, 'VkShaderModuleCreateInfo': None, 'VkXlibSurfaceCreateInfoKHR': None, 'VkCommandBufferInheritanceInfo': None, 'VkDisplaySurfaceCreateInfoKHR': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkDisplayPresentInfoKHR': None, 'VkRenderPassCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkCommandPoolCreateInfo': None, 'VkDisplayModeCreateInfoKHR': None, 'VkMirSurfaceCreateInfoKHR': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkWin32SurfaceCreateInfoKHR': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkFenceCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkInstanceCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkMemoryBarrier': None, 'VkXcbSurfaceCreateInfoKHR': None, 'VkBufferViewCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkSubmitInfo': None, 'VkBufferMemoryBarrier': None, 'VkCommandBufferAllocateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkPresentInfoKHR': None, 'VkMemoryAllocateInfo': None}
mapDict['VkSubmitInfo'] =  {'VkCommandBuffer': None, 'VkPipelineStageFlags': None, 'VkStructureType': None, 'vkQueueSubmit': None, 'VkSemaphore': None}
...
mapDict['VkSubpassDescription'] =  {'VkSubpassDescriptionFlags': None, 'VkRenderPassCreateInfo': None, 'VkPipelineBindPoint': None, 'VkAttachmentReference': None}
...
mapDict['VkSurfaceCapabilitiesKHR'] =  {'VkSurfaceTransformFlagBitsKHR': None, 'vkGetPhysicalDeviceSurfaceCapabilitiesKHR': None, 'VkSurfaceTransformFlagsKHR': None, 'VkExtent2D': None, 'VkCompositeAlphaFlagsKHR': None, 'VkImageUsageFlags': None}
mapDict['VkSurfaceFormatKHR'] =  {'VkColorSpaceKHR': None, 'VkFormat': None, 'vkGetPhysicalDeviceSurfaceFormatsKHR': None}
mapDict['VkSurfaceKHR'] =  {'vkCreateMirSurfaceKHR': None, 'vkCreateWaylandSurfaceKHR': None, 'vkGetPhysicalDeviceSurfacePresentModesKHR': None, 'VkSwapchainCreateInfoKHR': None, 'vkCreateXlibSurfaceKHR': None, 'vkDestroySurfaceKHR': None, 'vkCreateAndroidSurfaceKHR': None, 'vkCreateXcbSurfaceKHR': None, 'vkCreateWin32SurfaceKHR': None, 'vkGetPhysicalDeviceSurfaceCapabilitiesKHR': None, 'vkGetPhysicalDeviceSurfaceSupportKHR': None, 'vkGetPhysicalDeviceSurfaceFormatsKHR': None, 'vkCreateDisplayPlaneSurfaceKHR': None}
mapDict['VkSurfaceTransformFlagBitsKHR'] =  {'VkSurfaceTransformFlagsKHR': None, 'VkDisplaySurfaceCreateInfoKHR': None, 'VkSwapchainCreateInfoKHR': None, 'VkSurfaceCapabilitiesKHR': None}
...
mapDict['VkSwapchainCreateInfoKHR'] =  {'VkSurfaceTransformFlagBitsKHR': None, 'VkSharingMode': None, 'VkFormat': None, 'VkStructureType': None, 'VkPresentModeKHR': None, 'VkBool32': None, 'vkCreateSharedSwapchainsKHR': None, 'VkColorSpaceKHR': None, 'vkCreateSwapchainKHR': None, 'VkSwapchainKHR': None, 'VkSwapchainCreateFlagsKHR': None, 'VkSurfaceKHR': None, 'VkCompositeAlphaFlagBitsKHR': None, 'VkExtent2D': None, 'VkImageUsageFlags': None}
mapDict['VkSwapchainKHR'] =  {'VkSwapchainCreateInfoKHR': None, 'vkCreateSharedSwapchainsKHR': None, 'vkCreateSwapchainKHR': None, 'VkPresentInfoKHR': None, 'vkAcquireNextImageKHR': None, 'vkGetSwapchainImagesKHR': None, 'vkDestroySwapchainKHR': None}
...
mapDict['VkWaylandSurfaceCreateInfoKHR'] =  {'vkCreateWaylandSurfaceKHR': None, 'VkStructureType': None, 'VkWaylandSurfaceCreateFlagsKHR': None}
mapDict['VkWin32SurfaceCreateFlagsKHR'] =  {'VkWin32SurfaceCreateInfoKHR': None}
mapDict['VkWin32SurfaceCreateInfoKHR'] =  {'vkCreateWin32SurfaceKHR': None, 'VkStructureType': None, 'VkWin32SurfaceCreateFlagsKHR': None}
mapDict['VkWriteDescriptorSet'] =  {'VkDescriptorImageInfo': None, 'VkStructureType': None, 'VkDescriptorBufferInfo': None, 'vkUpdateDescriptorSets': None, 'VkDescriptorSet': None, 'VkDescriptorType': None, 'VkBufferView': None}
mapDict['VkXcbSurfaceCreateFlagsKHR'] =  {'VkXcbSurfaceCreateInfoKHR': None}
mapDict['VkXcbSurfaceCreateInfoKHR'] =  {'VkXcbSurfaceCreateFlagsKHR': None, 'VkStructureType': None, 'vkCreateXcbSurfaceKHR': None}
...
mapDict['vkAcquireNextImageKHR'] =  {'VkFence': None, 'VkSemaphore': None, 'VkDevice': None, 'VkSwapchainKHR': None}
mapDict['vkAllocateCommandBuffers'] =  {'VkCommandBufferAllocateInfo': None, 'VkDevice': None, 'VkCommandBuffer': None}
mapDict['vkAllocateDescriptorSets'] =  {'VkDescriptorSetAllocateInfo': None, 'VkDescriptorSet': None, 'VkDevice': None}
mapDict['vkAllocateMemory'] =  {'VkDeviceMemory': None, 'VkMemoryAllocateInfo': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkBeginCommandBuffer'] =  {'VkCommandBufferBeginInfo': None, 'VkCommandBuffer': None}
mapDict['vkBindBufferMemory'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkDevice': None, 'VkDeviceMemory': None}
mapDict['vkBindImageMemory'] =  {'VkImage': None, 'VkDeviceSize': None, 'VkDeviceMemory': None, 'VkDevice': None}
mapDict['vkCmdBeginQuery'] =  {'VkQueryControlFlags': None, 'VkCommandBuffer': None, 'VkQueryPool': None}
mapDict['vkCmdBeginRenderPass'] =  {'VkRenderPassBeginInfo': None, 'VkCommandBuffer': None, 'VkSubpassContents': None}
mapDict['vkCmdBindDescriptorSets'] =  {'VkDescriptorSet': None, 'VkPipelineBindPoint': None, 'VkCommandBuffer': None, 'VkPipelineLayout': None}
...
mapDict['vkCmdBlitImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkFilter': None, 'VkCommandBuffer': None, 'VkImageBlit': None}
mapDict['vkCmdClearAttachments'] =  {'VkClearAttachment': None, 'VkClearRect': None, 'VkCommandBuffer': None}
mapDict['vkCmdClearColorImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkImageSubresourceRange': None, 'VkCommandBuffer': None, 'VkClearColorValue': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkImageSubresourceRange': None, 'VkClearDepthStencilValue': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyBuffer'] =  {'VkBufferCopy': None, 'VkCommandBuffer': None, 'VkBuffer': None}
mapDict['vkCmdCopyBufferToImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkBuffer': None, 'VkBufferImageCopy': None}
mapDict['vkCmdCopyImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkImageCopy': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkBuffer': None, 'VkBufferImageCopy': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkDeviceSize': None, 'VkQueryResultFlags': None, 'VkCommandBuffer': None, 'VkBuffer': None, 'VkQueryPool': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkCommandBuffer': None, 'VkDependencyFlags': None, 'VkPipelineStageFlags': None, 'VkMemoryBarrier': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkImageMemoryBarrier': None, 'VkEvent': None, 'VkBufferMemoryBarrier': None, 'VkCommandBuffer': None, 'VkPipelineStageFlags': None, 'VkMemoryBarrier': None}
mapDict['vkCmdWriteTimestamp'] =  {'VkPipelineStageFlagBits': None, 'VkCommandBuffer': None, 'VkQueryPool': None}
mapDict['vkCreateAndroidSurfaceKHR'] =  {'VkInstance': None, 'VkSurfaceKHR': None, 'VkAndroidSurfaceCreateInfoKHR': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateBuffer'] =  {'VkBufferCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkBuffer': None}
mapDict['vkCreateBufferView'] =  {'VkBufferViewCreateInfo': None, 'VkBufferView': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateCommandPool'] =  {'VkCommandPool': None, 'VkCommandPoolCreateInfo': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateComputePipelines'] =  {'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkPipelineCache': None, 'VkDevice': None, 'VkComputePipelineCreateInfo': None}
...
mapDict['vkCreateDescriptorSetLayout'] =  {'VkDescriptorSetLayoutCreateInfo': None, 'VkDescriptorSetLayout': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateDevice'] =  {'VkDevice': None, 'VkDeviceCreateInfo': None, 'VkAllocationCallbacks': None, 'VkPhysicalDevice': None}
mapDict['vkCreateDisplayModeKHR'] =  {'VkDisplayModeCreateInfoKHR': None, 'VkDisplayModeKHR': None, 'VkDisplayKHR': None, 'VkPhysicalDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateDisplayPlaneSurfaceKHR'] =  {'VkInstance': None, 'VkSurfaceKHR': None, 'VkDisplaySurfaceCreateInfoKHR': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateEvent'] =  {'VkEvent': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkEventCreateInfo': None}
mapDict['vkCreateFence'] =  {'VkFenceCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkFence': None}
mapDict['vkCreateFramebuffer'] =  {'VkFramebufferCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkFramebuffer': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkPipelineCache': None, 'VkDevice': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['vkCreateImage'] =  {'VkImage': None, 'VkImageCreateInfo': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
...
mapDict['vkCreateMirSurfaceKHR'] =  {'VkMirSurfaceCreateInfoKHR': None, 'VkInstance': None, 'VkAllocationCallbacks': None, 'VkSurfaceKHR': None}
mapDict['vkCreatePipelineCache'] =  {'VkPipelineCache': None, 'VkPipelineCacheCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
...
mapDict['vkCreateQueryPool'] =  {'VkQueryPool': None, 'VkQueryPoolCreateInfo': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateRenderPass'] =  {'VkRenderPass': None, 'VkRenderPassCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateSampler'] =  {'VkSamplerCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkSampler': None}
mapDict['vkCreateSemaphore'] =  {'VkSemaphoreCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkSemaphore': None}
mapDict['vkCreateShaderModule'] =  {'VkShaderModule': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkShaderModuleCreateInfo': None}
mapDict['vkCreateSharedSwapchainsKHR'] =  {'VkSwapchainKHR': None, 'VkSwapchainCreateInfoKHR': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateSwapchainKHR'] =  {'VkSwapchainKHR': None, 'VkSwapchainCreateInfoKHR': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateWaylandSurfaceKHR'] =  {'VkWaylandSurfaceCreateInfoKHR': None, 'VkInstance': None, 'VkAllocationCallbacks': None, 'VkSurfaceKHR': None}
mapDict['vkCreateWin32SurfaceKHR'] =  {'VkInstance': None, 'VkSurfaceKHR': None, 'VkWin32SurfaceCreateInfoKHR': None, 'VkAllocationCallbacks': None}
...
mapDict['vkCreateXlibSurfaceKHR'] =  {'VkXlibSurfaceCreateInfoKHR': None, 'VkInstance': None, 'VkAllocationCallbacks': None, 'VkSurfaceKHR': None}
...
mapDict['vkDestroySurfaceKHR'] =  {'VkInstance': None, 'VkAllocationCallbacks': None, 'VkSurfaceKHR': None}
mapDict['vkDestroySwapchainKHR'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkSwapchainKHR': None}
...
mapDict['vkGetDisplayPlaneCapabilitiesKHR'] =  {'VkDisplayPlaneCapabilitiesKHR': None, 'VkDisplayModeKHR': None, 'VkPhysicalDevice': None}
...
mapDict['vkGetImageSparseMemoryRequirements'] =  {'VkImage': None, 'VkSparseImageMemoryRequirements': None, 'VkDevice': None}
mapDict['vkGetImageSubresourceLayout'] =  {'VkImage': None, 'VkImageSubresource': None, 'VkDevice': None, 'VkSubresourceLayout': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageTiling': None, 'VkFormat': None, 'VkImageFormatProperties': None, 'VkImageType': None, 'VkImageCreateFlags': None, 'VkPhysicalDevice': None, 'VkImageUsageFlags': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageTiling': None, 'VkSampleCountFlagBits': None, 'VkFormat': None, 'VkSparseImageFormatProperties': None, 'VkImageType': None, 'VkPhysicalDevice': None, 'VkImageUsageFlags': None}
mapDict['vkGetPhysicalDeviceSurfaceCapabilitiesKHR'] =  {'VkSurfaceCapabilitiesKHR': None, 'VkPhysicalDevice': None, 'VkSurfaceKHR': None}
mapDict['vkGetPhysicalDeviceSurfaceFormatsKHR'] =  {'VkSurfaceFormatKHR': None, 'VkPhysicalDevice': None, 'VkSurfaceKHR': None}
mapDict['vkGetPhysicalDeviceSurfacePresentModesKHR'] =  {'VkPresentModeKHR': None, 'VkPhysicalDevice': None, 'VkSurfaceKHR': None}
mapDict['vkGetPhysicalDeviceSurfaceSupportKHR'] =  {'VkBool32': None, 'VkPhysicalDevice': None, 'VkSurfaceKHR': None}
...
mapDict['vkGetQueryPoolResults'] =  {'VkDeviceSize': None, 'VkQueryResultFlags': None, 'VkDevice': None, 'VkQueryPool': None}
mapDict['vkGetRenderAreaGranularity'] =  {'VkRenderPass': None, 'VkExtent2D': None, 'VkDevice': None}
mapDict['vkGetSwapchainImagesKHR'] =  {'VkImage': None, 'VkDevice': None, 'VkSwapchainKHR': None}
...
mapDict['vkUpdateDescriptorSets'] =  {'VkCopyDescriptorSet': None, 'VkWriteDescriptorSet': None, 'VkDevice': None}
