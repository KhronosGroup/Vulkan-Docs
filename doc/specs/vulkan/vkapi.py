...
mapDict['VkAccessFlags'] =  {'VkSubpassDependency': None, 'VkAccessFlagBits': None, 'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None}
mapDict['VkAllocationCallbacks'] =  {'vkCreateComputePipelines': None, 'vkCreateBufferView': None, 'vkCreateDescriptorPool': None, 'vkCreateRenderPass': None, 'PFN_vkFreeFunction': None, 'vkDestroyDevice': None, 'vkDestroyDescriptorPool': None, 'vkCreateInstance': None, 'vkDestroySemaphore': None, 'PFN_vkInternalFreeNotification': None, 'vkCreateFence': None, 'vkDestroyFramebuffer': None, 'vkDestroyInstance': None, 'vkCreateQueryPool': None, 'vkCreateCommandPool': None, 'vkDestroyPipelineLayout': None, 'PFN_vkInternalAllocationNotification': None, 'vkDestroyBuffer': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroySampler': None, 'PFN_vkAllocationFunction': None, 'vkCreateImageView': None, 'vkDestroyBufferView': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyRenderPass': None, 'vkCreateBuffer': None, 'vkCreateEvent': None, 'PFN_vkReallocationFunction': None, 'vkAllocateMemory': None, 'vkCreateFramebuffer': None, 'vkDestroyCommandPool': None, 'vkDestroyPipeline': None, 'vkCreateImage': None, 'vkDestroyQueryPool': None, 'vkDestroyShaderModule': None, 'vkCreatePipelineLayout': None, 'vkCreateDevice': None, 'vkCreateSampler': None, 'vkCreateSharedSwapchainsKHR': None, 'vkDestroyPipelineCache': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreatePipelineCache': None, 'vkDestroyImageView': None, 'vkFreeMemory': None, 'vkDestroyFence': None, 'vkDestroyImage': None, 'vkDestroyEvent': None, 'vkCreateSemaphore': None, 'vkCreateShaderModule': None}
mapDict['VkApplicationInfo'] =  {'VkStructureType': None, 'VkInstanceCreateInfo': None}
mapDict['VkAttachmentDescription'] =  {'VkRenderPassCreateInfo': None, 'VkImageLayout': None, 'VkSampleCountFlagBits': None, 'VkAttachmentDescriptionFlags': None, 'VkFormat': None, 'VkAttachmentStoreOp': None, 'VkAttachmentLoadOp': None}
...
mapDict['VkBindSparseInfo'] =  {'VkStructureType': None, 'VkSparseImageMemoryBindInfo': None, 'VkSemaphore': None, 'vkQueueBindSparse': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSparseImageOpaqueMemoryBindInfo': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPhysicalDeviceLimits': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkDisplayPresentInfoKHR': None, 'VkPipelineColorBlendAttachmentState': None, 'VkSwapchainCreateInfoKHR': None, 'VkPhysicalDeviceSparseProperties': None, 'vkWaitForFences': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkSamplerCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdUpdateBuffer': None, 'vkCmdFillBuffer': None, 'vkCmdCopyImageToBuffer': None, 'vkBindBufferMemory': None, 'VkBufferMemoryBarrier': None, 'vkCmdDispatchIndirect': None, 'vkCmdDrawIndirect': None, 'VkDescriptorBufferInfo': None, 'vkCmdBindIndexBuffer': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdBindVertexBuffers': None, 'vkGetBufferMemoryRequirements': None, 'vkCreateBuffer': None, 'vkCmdCopyBuffer': None, 'VkSparseBufferMemoryBindInfo': None, 'vkDestroyBuffer': None, 'VkBufferViewCreateInfo': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkStructureType': None, 'VkDeviceSize': None, 'VkBufferUsageFlags': None, 'vkCreateBuffer': None, 'VkSharingMode': None, 'VkBufferCreateFlags': None}
mapDict['VkBufferImageCopy'] =  {'vkCmdCopyBufferToImage': None, 'VkDeviceSize': None, 'VkOffset3D': None, 'VkExtent3D': None, 'VkImageSubresourceLayers': None, 'vkCmdCopyImageToBuffer': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkStructureType': None, 'VkBuffer': None, 'VkAccessFlags': None, 'VkDeviceSize': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkStructureType': None, 'VkBuffer': None, 'vkCreateBufferView': None, 'VkFormat': None, 'VkDeviceSize': None, 'VkBufferViewCreateFlags': None}
...
mapDict['VkClearValue'] =  {'VkClearDepthStencilValue': None, 'VkClearAttachment': None, 'VkRenderPassBeginInfo': None, 'VkClearColorValue': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdClearAttachments': None, 'vkCmdUpdateBuffer': None, 'VkSubmitInfo': None, 'vkCmdNextSubpass': None, 'vkCmdEndRenderPass': None, 'vkCmdBindPipeline': None, 'vkCmdPushConstants': None, 'vkCmdBindIndexBuffer': None, 'vkCmdCopyBufferToImage': None, 'vkCmdSetViewport': None, 'vkCmdSetStencilReference': None, 'vkCmdCopyBuffer': None, 'vkBeginCommandBuffer': None, 'vkAllocateCommandBuffers': None, 'vkCmdFillBuffer': None, 'vkFreeCommandBuffers': None, 'vkCmdResetEvent': None, 'vkCmdEndQuery': None, 'vkCmdSetLineWidth': None, 'vkCmdSetScissor': None, 'vkCmdResetQueryPool': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdBeginRenderPass': None, 'vkCmdBeginQuery': None, 'vkCmdSetBlendConstants': None, 'vkCmdExecuteCommands': None, 'vkCmdBindDescriptorSets': None, 'vkCmdDrawIndexed': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdBlitImage': None, 'vkCmdWriteTimestamp': None, 'vkCmdSetDepthBias': None, 'vkCmdBindVertexBuffers': None, 'vkCmdClearColorImage': None, 'vkEndCommandBuffer': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdWaitEvents': None, 'vkCmdDraw': None, 'vkCmdCopyImage': None, 'vkResetCommandBuffer': None, 'vkCmdSetEvent': None, 'vkCmdDispatchIndirect': None, 'vkCmdSetDepthBounds': None, 'vkCmdDrawIndirect': None, 'vkCmdPipelineBarrier': None, 'vkCmdResolveImage': None, 'vkCmdDispatch': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'VkStructureType': None, 'VkCommandBufferLevel': None, 'vkAllocateCommandBuffers': None, 'VkCommandPool': None}
mapDict['VkCommandBufferBeginInfo'] =  {'VkStructureType': None, 'vkBeginCommandBuffer': None, 'VkCommandBufferInheritanceInfo': None, 'VkCommandBufferUsageFlags': None}
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkCommandBufferBeginInfo': None, 'VkStructureType': None, 'VkFramebuffer': None, 'VkQueryControlFlags': None, 'VkBool32': None, 'VkQueryPipelineStatisticFlags': None, 'VkRenderPass': None}
...
mapDict['VkCommandPool'] =  {'vkCreateCommandPool': None, 'vkDestroyCommandPool': None, 'vkFreeCommandBuffers': None, 'VkCommandBufferAllocateInfo': None, 'vkResetCommandPool': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'vkCreateComputePipelines': None, 'VkStructureType': None, 'VkPipelineLayout': None, 'VkPipeline': None, 'VkPipelineCreateFlags': None, 'VkPipelineShaderStageCreateInfo': None}
...
mapDict['VkDescriptorPool'] =  {'VkDescriptorSetAllocateInfo': None, 'vkDestroyDescriptorPool': None, 'vkResetDescriptorPool': None, 'vkCreateDescriptorPool': None, 'vkFreeDescriptorSets': None}
...
mapDict['VkDescriptorPoolCreateInfo'] =  {'VkDescriptorPoolCreateFlags': None, 'VkStructureType': None, 'vkCreateDescriptorPool': None, 'VkDescriptorPoolSize': None}
...
mapDict['VkDevice'] =  {'vkCreateComputePipelines': None, 'vkGetRenderAreaGranularity': None, 'vkMergePipelineCaches': None, 'vkCreateBufferView': None, 'vkCreateDescriptorPool': None, 'vkResetCommandPool': None, 'vkCreateRenderPass': None, 'vkGetDeviceMemoryCommitment': None, 'vkDestroyDevice': None, 'vkMapMemory': None, 'vkUpdateDescriptorSets': None, 'vkDestroyShaderModule': None, 'vkAllocateCommandBuffers': None, 'vkCreateQueryPool': None, 'vkDeviceWaitIdle': None, 'vkGetImageMemoryRequirements': None, 'vkCreateFence': None, 'vkFlushMappedMemoryRanges': None, 'vkResetDescriptorPool': None, 'vkDestroyFramebuffer': None, 'vkCreateSampler': None, 'vkBindImageMemory': None, 'vkAllocateDescriptorSets': None, 'vkCreateEvent': None, 'vkCreateDevice': None, 'vkCreateCommandPool': None, 'vkDestroyBuffer': None, 'vkSetEvent': None, 'vkGetPipelineCacheData': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroySampler': None, 'vkGetDeviceQueue': None, 'vkGetDeviceProcAddr': None, 'vkCreateImageView': None, 'vkDestroyBufferView': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyRenderPass': None, 'vkDestroyImage': None, 'vkBindBufferMemory': None, 'vkDestroyPipelineLayout': None, 'vkUnmapMemory': None, 'vkAllocateMemory': None, 'vkCreateFramebuffer': None, 'vkGetFenceStatus': None, 'vkDestroyCommandPool': None, 'vkDestroyPipeline': None, 'vkCreateImage': None, 'vkDestroyDescriptorSetLayout': None, 'vkGetBufferMemoryRequirements': None, 'vkInvalidateMappedMemoryRanges': None, 'vkDestroySemaphore': None, 'vkGetImageSubresourceLayout': None, 'vkCreatePipelineLayout': None, 'vkResetEvent': None, 'vkFreeCommandBuffers': None, 'vkResetFences': None, 'vkFreeDescriptorSets': None, 'vkDestroyDescriptorPool': None, 'vkCreatePipelineCache': None, 'vkWaitForFences': None, 'vkCreateSharedSwapchainsKHR': None, 'vkDestroyPipelineCache': None, 'vkGetImageSparseMemoryRequirements': None, 'vkGetQueryPoolResults': None, 'vkDestroyImageView': None, 'vkFreeMemory': None, 'vkDestroyFence': None, 'vkCreateBuffer': None, 'vkDestroyEvent': None, 'vkGetEventStatus': None, 'vkCreateSemaphore': None, 'vkCreateShaderModule': None, 'vkDestroyQueryPool': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkStructureType': None, 'VkPhysicalDeviceFeatures': None, 'vkCreateDevice': None, 'VkDeviceCreateFlags': None, 'VkDeviceQueueCreateInfo': None}
mapDict['VkDeviceMemory'] =  {'vkMapMemory': None, 'vkFreeMemory': None, 'VkSparseMemoryBind': None, 'vkBindImageMemory': None, 'vkBindBufferMemory': None, 'vkGetDeviceMemoryCommitment': None, 'VkMappedMemoryRange': None, 'vkUnmapMemory': None, 'vkAllocateMemory': None, 'VkSparseImageMemoryBind': None}
...
mapDict['VkDeviceSize'] =  {'VkPhysicalDeviceLimits': None, 'vkCmdFillBuffer': None, 'vkBindBufferMemory': None, 'VkMemoryAllocateInfo': None, 'vkGetDeviceMemoryCommitment': None, 'VkSparseImageMemoryRequirements': None, 'VkBufferCreateInfo': None, 'vkCmdUpdateBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkCmdDrawIndexedIndirect': None, 'vkMapMemory': None, 'VkMemoryRequirements': None, 'vkCmdBindVertexBuffers': None, 'VkSubresourceLayout': None, 'VkBufferImageCopy': None, 'VkSparseMemoryBind': None, 'vkBindImageMemory': None, 'vkCmdDispatchIndirect': None, 'VkBufferCopy': None, 'VkImageFormatProperties': None, 'vkCmdDrawIndirect': None, 'vkGetQueryPoolResults': None, 'vkCmdCopyQueryPoolResults': None, 'VkBufferMemoryBarrier': None, 'VkMemoryHeap': None, 'VkMappedMemoryRange': None, 'VkDescriptorBufferInfo': None, 'VkBufferViewCreateInfo': None, 'VkSparseImageMemoryBind': None}
mapDict['VkDisplayPresentInfoKHR'] =  {'VkBool32': None, 'VkStructureType': None, 'VkRect2D': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkResetEvent': None, 'vkCmdSetEvent': None, 'vkCmdResetEvent': None, 'vkCreateEvent': None, 'vkDestroyEvent': None, 'vkGetEventStatus': None, 'vkSetEvent': None, 'vkCmdWaitEvents': None}
...
mapDict['VkExtent3D'] =  {'VkSparseImageFormatProperties': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkQueueFamilyProperties': None, 'VkImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkBufferImageCopy': None, 'VkSparseImageMemoryBind': None}
mapDict['VkFence'] =  {'vkQueueSubmit': None, 'vkCreateFence': None, 'vkDestroyFence': None, 'vkQueueBindSparse': None, 'vkResetFences': None, 'vkWaitForFences': None, 'vkGetFenceStatus': None}
...
mapDict['VkFormat'] =  {'VkVertexInputAttributeDescription': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageViewCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkAttachmentDescription': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceFormatProperties': None, 'VkBufferViewCreateInfo': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkFramebufferCreateInfo'] =  {'VkStructureType': None, 'VkImageView': None, 'VkRenderPass': None, 'vkCreateFramebuffer': None, 'VkFramebufferCreateFlags': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkStructureType': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineCreateFlags': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkRenderPass': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineLayout': None, 'VkPipeline': None, 'VkPipelineShaderStageCreateInfo': None}
mapDict['VkImage'] =  {'vkGetImageMemoryRequirements': None, 'vkGetImageSparseMemoryRequirements': None, 'vkBindImageMemory': None, 'VkImageMemoryBarrier': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkGetImageSubresourceLayout': None, 'vkCmdBlitImage': None, 'vkCmdCopyBufferToImage': None, 'VkSparseImageMemoryBindInfo': None, 'vkCreateImage': None, 'VkImageViewCreateInfo': None, 'vkCmdClearColorImage': None, 'vkDestroyImage': None, 'vkCmdResolveImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkSparseImageFormatProperties': None, 'VkImageSubresourceRange': None, 'VkClearAttachment': None, 'VkImageSubresource': None, 'VkImageAspectFlagBits': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageBlit'] =  {'vkCmdBlitImage': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None}
mapDict['VkImageCopy'] =  {'VkExtent3D': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None, 'vkCmdCopyImage': None}
...
mapDict['VkImageCreateInfo'] =  {'VkStructureType': None, 'VkImageLayout': None, 'VkImageUsageFlags': None, 'VkImageTiling': None, 'VkSampleCountFlagBits': None, 'VkImageCreateFlags': None, 'VkSharingMode': None, 'VkExtent3D': None, 'VkFormat': None, 'VkImageType': None, 'vkCreateImage': None}
mapDict['VkImageFormatProperties'] =  {'VkSampleCountFlags': None, 'VkExtent3D': None, 'VkDeviceSize': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
mapDict['VkImageLayout'] =  {'vkCmdCopyImage': None, 'vkCmdCopyBufferToImage': None, 'VkDescriptorImageInfo': None, 'VkImageMemoryBarrier': None, 'vkCmdBlitImage': None, 'vkCmdResolveImage': None, 'VkAttachmentDescription': None, 'vkCmdClearColorImage': None, 'VkImageCreateInfo': None, 'VkAttachmentReference': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyImageToBuffer': None}
mapDict['VkImageMemoryBarrier'] =  {'VkStructureType': None, 'VkImage': None, 'VkImageLayout': None, 'VkImageSubresourceRange': None, 'VkAccessFlags': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None}
mapDict['VkImageResolve'] =  {'vkCmdResolveImage': None, 'VkExtent3D': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None}
mapDict['VkImageSubresource'] =  {'vkGetImageSubresourceLayout': None, 'VkImageAspectFlags': None, 'VkSparseImageMemoryBind': None}
mapDict['VkImageSubresourceLayers'] =  {'VkImageCopy': None, 'VkImageResolve': None, 'VkImageBlit': None, 'VkImageAspectFlags': None, 'VkBufferImageCopy': None}
mapDict['VkImageSubresourceRange'] =  {'vkCmdClearDepthStencilImage': None, 'VkImageViewCreateInfo': None, 'vkCmdClearColorImage': None, 'VkImageAspectFlags': None, 'VkImageMemoryBarrier': None}
...
mapDict['VkImageUsageFlags'] =  {'VkImageCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageUsageFlagBits': None, 'VkSwapchainCreateInfoKHR': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkImageViewCreateInfo'] =  {'VkImageViewCreateFlags': None, 'VkStructureType': None, 'VkImage': None, 'VkComponentMapping': None, 'VkImageViewType': None, 'VkFormat': None, 'vkCreateImageView': None, 'VkImageSubresourceRange': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkDestroyInstance': None, 'vkCreateInstance': None, 'vkEnumeratePhysicalDevices': None, 'vkGetInstanceProcAddr': None}
mapDict['VkInstanceCreateFlags'] =  {'VkInstanceCreateInfo': None}
mapDict['VkInstanceCreateInfo'] =  {'VkStructureType': None, 'VkApplicationInfo': None, 'vkCreateInstance': None, 'VkInstanceCreateFlags': None}
...
mapDict['VkMappedMemoryRange'] =  {'VkStructureType': None, 'VkDeviceSize': None, 'vkInvalidateMappedMemoryRanges': None, 'vkFlushMappedMemoryRanges': None, 'VkDeviceMemory': None}
mapDict['VkMemoryAllocateInfo'] =  {'VkStructureType': None, 'VkDeviceSize': None, 'vkAllocateMemory': None}
...
mapDict['VkOffset3D'] =  {'VkImageCopy': None, 'VkImageResolve': None, 'VkImageBlit': None, 'VkBufferImageCopy': None, 'VkSparseImageMemoryBind': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceFeatures': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkCreateDevice': None, 'vkEnumerateDeviceLayerProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkPipeline'] =  {'vkCreateComputePipelines': None, 'vkCreateGraphicsPipelines': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCmdBindPipeline': None, 'vkDestroyPipeline': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkCreateComputePipelines': None, 'vkCreateGraphicsPipelines': None, 'vkGetPipelineCacheData': None, 'vkCreatePipelineCache': None, 'vkDestroyPipelineCache': None, 'vkMergePipelineCaches': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBool32': None, 'VkColorComponentFlags': None, 'VkBlendFactor': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkBlendOp': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkStructureType': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None, 'VkCompareOp': None, 'VkStencilOpState': None}
...
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkBool32': None, 'VkStructureType': None, 'VkPipelineInputAssemblyStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPrimitiveTopology': None}
mapDict['VkPipelineLayout'] =  {'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'vkDestroyPipelineLayout': None, 'vkCmdPushConstants': None, 'vkCreatePipelineLayout': None, 'vkCmdBindDescriptorSets': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkStructureType': None, 'VkPipelineLayoutCreateFlags': None, 'vkCreatePipelineLayout': None, 'VkDescriptorSetLayout': None, 'VkPushConstantRange': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkSampleCountFlagBits': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkBool32': None, 'VkSampleMask': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkBool32': None, 'VkFrontFace': None, 'VkCullModeFlags': None, 'VkPolygonMode': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkStructureType': None, 'VkShaderStageFlagBits': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkShaderModule': None, 'VkPipelineShaderStageCreateFlags': None, 'VkSpecializationInfo': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'VkSubpassDependency': None, 'VkPipelineStageFlagBits': None, 'vkCmdSetEvent': None, 'VkSubmitInfo': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'vkCmdResetEvent': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkPipelineVertexInputStateCreateFlags': None, 'VkStructureType': None, 'VkVertexInputBindingDescription': None, 'VkVertexInputAttributeDescription': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkStructureType': None, 'VkRect2D': None, 'VkViewport': None, 'VkPipelineViewportStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkQueryPool'] =  {'vkGetQueryPoolResults': None, 'vkCmdCopyQueryPoolResults': None, 'vkDestroyQueryPool': None, 'vkCmdResetQueryPool': None, 'vkCmdEndQuery': None, 'vkCmdWriteTimestamp': None, 'vkCreateQueryPool': None, 'vkCmdBeginQuery': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkStructureType': None, 'VkQueryType': None, 'VkQueryPoolCreateFlags': None, 'vkCreateQueryPool': None, 'VkQueryPipelineStatisticFlags': None}
...
mapDict['VkQueue'] =  {'vkQueueSubmit': None, 'vkQueueWaitIdle': None, 'vkQueueBindSparse': None, 'vkGetDeviceQueue': None}
...
mapDict['VkRect2D'] =  {'VkOffset2D': None, 'VkRenderPassBeginInfo': None, 'VkClearRect': None, 'VkPipelineViewportStateCreateInfo': None, 'VkExtent2D': None, 'vkCmdSetScissor': None, 'VkDisplayPresentInfoKHR': None}
mapDict['VkRenderPass'] =  {'vkGetRenderAreaGranularity': None, 'VkCommandBufferInheritanceInfo': None, 'vkDestroyRenderPass': None, 'vkCreateRenderPass': None, 'VkGraphicsPipelineCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkRenderPassBeginInfo': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkStructureType': None, 'VkFramebuffer': None, 'VkRect2D': None, 'vkCmdBeginRenderPass': None, 'VkClearValue': None, 'VkRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkSubpassDependency': None, 'VkStructureType': None, 'vkCreateRenderPass': None, 'VkSubpassDescription': None, 'VkAttachmentDescription': None, 'VkRenderPassCreateFlags': None}
mapDict['VkSampleCountFlagBits'] =  {'VkSampleCountFlags': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkAttachmentDescription': None, 'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkSampleCountFlags'] =  {'VkPhysicalDeviceLimits': None, 'VkSampleCountFlagBits': None, 'VkImageFormatProperties': None}
mapDict['VkSampleMask'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkSampler'] =  {'vkCreateSampler': None, 'VkDescriptorSetLayoutBinding': None, 'vkDestroySampler': None, 'VkDescriptorImageInfo': None}
mapDict['VkSamplerAddressMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateFlags'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateInfo'] =  {'VkStructureType': None, 'VkSamplerCreateFlags': None, 'VkSamplerAddressMode': None, 'VkBorderColor': None, 'VkBool32': None, 'vkCreateSampler': None, 'VkSamplerMipmapMode': None, 'VkCompareOp': None, 'VkFilter': None}
...
mapDict['VkShaderStageFlags'] =  {'VkDescriptorSetLayoutBinding': None, 'VkPushConstantRange': None, 'VkShaderStageFlagBits': None, 'vkCmdPushConstants': None}
mapDict['VkSharingMode'] =  {'VkImageCreateInfo': None, 'VkBufferCreateInfo': None, 'VkSwapchainCreateInfoKHR': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'VkExtent3D': None, 'VkSparseImageMemoryRequirements': None, 'VkSparseImageFormatFlags': None, 'VkImageAspectFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkDeviceSize': None, 'VkImageSubresource': None, 'VkOffset3D': None, 'VkDeviceMemory': None, 'VkExtent3D': None, 'VkSparseImageMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkDeviceSize': None, 'VkSparseMemoryBindFlags': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'VkDeviceMemory': None}
...
mapDict['VkStencilFaceFlags'] =  {'VkStencilFaceFlagBits': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdSetStencilReference': None}
...
mapDict['VkStructureType'] =  {'VkPipelineColorBlendStateCreateInfo': None, 'VkDisplayPresentInfoKHR': None, 'VkSubmitInfo': None, 'VkEventCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkImageViewCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkFramebufferCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkCommandBufferBeginInfo': None, 'VkApplicationInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkMemoryBarrier': None, 'VkWriteDescriptorSet': None, 'VkComputePipelineCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkBindSparseInfo': None, 'VkBufferMemoryBarrier': None, 'VkPipelineLayoutCreateInfo': None, 'VkBufferCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkImageCreateInfo': None, 'VkFenceCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkMappedMemoryRange': None, 'VkDeviceQueueCreateInfo': None, 'VkCommandBufferAllocateInfo': None}
mapDict['VkSubmitInfo'] =  {'vkQueueSubmit': None, 'VkStructureType': None, 'VkPipelineStageFlags': None, 'VkSemaphore': None, 'VkCommandBuffer': None}
...
mapDict['VkSubpassDescription'] =  {'VkAttachmentReference': None, 'VkRenderPassCreateInfo': None, 'VkSubpassDescriptionFlags': None, 'VkPipelineBindPoint': None}
...
mapDict['VkSwapchainCreateInfoKHR'] =  {'VkStructureType': None, 'VkPresentModeKHR': None, 'VkFormat': None, 'VkSwapchainKHR': None, 'VkSurfaceKHR': None, 'VkExtent2D': None, 'VkImageUsageFlags': None, 'vkCreateSharedSwapchainsKHR': None, 'VkSurfaceTransformFlagBitsKHR': None, 'VkCompositeAlphaFlagBitsKHR': None, 'VkColorSpaceKHR': None, 'VkSharingMode': None, 'VkBool32': None, 'VkSwapchainCreateFlagsKHR': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkStructureType': None, 'VkDescriptorSet': None, 'VkDescriptorType': None, 'VkDescriptorImageInfo': None, 'VkBufferView': None, 'VkDescriptorBufferInfo': None, 'vkUpdateDescriptorSets': None}
...
mapDict['vkCmdBindDescriptorSets'] =  {'VkDescriptorSet': None, 'VkCommandBuffer': None, 'VkPipelineLayout': None, 'VkPipelineBindPoint': None}
mapDict['vkCmdBindIndexBuffer'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkIndexType': None, 'VkCommandBuffer': None}
mapDict['vkCmdBindPipeline'] =  {'VkPipeline': None, 'VkCommandBuffer': None, 'VkPipelineBindPoint': None}
mapDict['vkCmdBindVertexBuffers'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None}
mapDict['vkCmdBlitImage'] =  {'VkFilter': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkImageBlit': None}
mapDict['vkCmdClearAttachments'] =  {'VkClearAttachment': None, 'VkCommandBuffer': None, 'VkClearRect': None}
mapDict['vkCmdClearColorImage'] =  {'VkImageSubresourceRange': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkClearColorValue': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkClearDepthStencilValue': None, 'VkImageSubresourceRange': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdCopyBuffer'] =  {'VkBufferCopy': None, 'VkBuffer': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyBufferToImage'] =  {'VkBuffer': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkBufferImageCopy': None}
mapDict['vkCmdCopyImage'] =  {'VkImageCopy': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkBuffer': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkBufferImageCopy': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkQueryResultFlags': None, 'VkQueryPool': None}
mapDict['vkCmdDispatch'] =  {'VkCommandBuffer': None}
mapDict['vkCmdDispatchIndirect'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None}
mapDict['vkCmdDraw'] =  {'VkCommandBuffer': None}
mapDict['vkCmdDrawIndexed'] =  {'VkCommandBuffer': None}
mapDict['vkCmdDrawIndexedIndirect'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None}
mapDict['vkCmdDrawIndirect'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdFillBuffer'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None}
mapDict['vkCmdNextSubpass'] =  {'VkSubpassContents': None, 'VkCommandBuffer': None}
mapDict['vkCmdPipelineBarrier'] =  {'VkMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkDependencyFlags': None, 'VkCommandBuffer': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None}
mapDict['vkCmdPushConstants'] =  {'VkShaderStageFlags': None, 'VkCommandBuffer': None, 'VkPipelineLayout': None}
mapDict['vkCmdResetEvent'] =  {'VkEvent': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdSetEvent'] =  {'VkEvent': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdUpdateBuffer'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None}
mapDict['vkCmdWaitEvents'] =  {'VkEvent': None, 'VkPipelineStageFlags': None, 'VkMemoryBarrier': None, 'VkCommandBuffer': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None}
mapDict['vkCmdWriteTimestamp'] =  {'VkPipelineStageFlagBits': None, 'VkCommandBuffer': None, 'VkQueryPool': None}
mapDict['vkCreateBuffer'] =  {'VkBuffer': None, 'VkAllocationCallbacks': None, 'VkBufferCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateBufferView'] =  {'VkBufferView': None, 'VkAllocationCallbacks': None, 'VkBufferViewCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateCommandPool'] =  {'VkCommandPool': None, 'VkCommandPoolCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateComputePipelines'] =  {'VkAllocationCallbacks': None, 'VkPipelineCache': None, 'VkComputePipelineCreateInfo': None, 'VkPipeline': None, 'VkDevice': None}
...
mapDict['vkCreateEvent'] =  {'VkEvent': None, 'VkAllocationCallbacks': None, 'VkEventCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateFence'] =  {'VkFence': None, 'VkAllocationCallbacks': None, 'VkFenceCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateFramebuffer'] =  {'VkFramebuffer': None, 'VkFramebufferCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkPipeline': None, 'VkPipelineCache': None, 'VkAllocationCallbacks': None, 'VkGraphicsPipelineCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateImage'] =  {'VkImageCreateInfo': None, 'VkAllocationCallbacks': None, 'VkImage': None, 'VkDevice': None}
mapDict['vkCreateImageView'] =  {'VkAllocationCallbacks': None, 'VkImageViewCreateInfo': None, 'VkImageView': None, 'VkDevice': None}
mapDict['vkCreateInstance'] =  {'VkInstanceCreateInfo': None, 'VkInstance': None, 'VkAllocationCallbacks': None}
mapDict['vkCreatePipelineCache'] =  {'VkPipelineCache': None, 'VkAllocationCallbacks': None, 'VkPipelineCacheCreateInfo': None, 'VkDevice': None}
mapDict['vkCreatePipelineLayout'] =  {'VkAllocationCallbacks': None, 'VkPipelineLayoutCreateInfo': None, 'VkPipelineLayout': None, 'VkDevice': None}
...
mapDict['vkCreateSampler'] =  {'VkSampler': None, 'VkAllocationCallbacks': None, 'VkSamplerCreateInfo': None, 'VkDevice': None}
...
mapDict['vkGetBufferMemoryRequirements'] =  {'VkBuffer': None, 'VkMemoryRequirements': None, 'VkDevice': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageCreateFlags': None, 'VkImageUsageFlags': None, 'VkPhysicalDevice': None, 'VkImageTiling': None, 'VkImageFormatProperties': None, 'VkFormat': None, 'VkImageType': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageTiling': None, 'VkSparseImageFormatProperties': None, 'VkFormat': None, 'VkPhysicalDevice': None, 'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkImageType': None}
