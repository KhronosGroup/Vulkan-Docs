...
mapDict['VkAccessFlags'] =  {'VkMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkSubpassDependency': None, 'VkAccessFlagBits': None}
mapDict['VkAllocationCallbacks'] =  {'vkDestroyEvent': None, 'vkDestroyQueryPool': None, 'vkDestroyFence': None, 'PFN_vkFreeFunction': None, 'vkDestroyPipelineLayout': None, 'vkDestroySemaphore': None, 'vkCreateComputePipelines': None, 'vkDestroyImageView': None, 'PFN_vkAllocationFunction': None, 'vkAllocateMemory': None, 'vkCreateEvent': None, 'vkCreateCommandPool': None, 'vkDestroyDescriptorPool': None, 'vkDestroyPipelineCache': None, 'vkCreateBuffer': None, 'vkFreeMemory': None, 'vkDestroyPipeline': None, 'vkDestroyImage': None, 'vkCreateImage': None, 'vkDestroyDevice': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyCommandPool': None, 'vkCreateDescriptorPool': None, 'vkCreateBufferView': None, 'vkCreateInstance': None, 'vkCreateSemaphore': None, 'vkCreateShaderModule': None, 'vkCreateSampler': None, 'vkCreateQueryPool': None, 'PFN_vkInternalAllocationNotification': None, 'vkCreateWin32SurfaceKHR': None, 'vkCreateFence': None, 'PFN_vkInternalFreeNotification': None, 'vkDestroyShaderModule': None, 'vkDestroyFramebuffer': None, 'vkDestroyRenderPass': None, 'vkCreateRenderPass': None, 'vkCreateFramebuffer': None, 'vkDestroyBufferView': None, 'vkCreatePipelineLayout': None, 'vkCreateDevice': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroySampler': None, 'PFN_vkReallocationFunction': None, 'vkCreatePipelineCache': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateImageView': None, 'vkDestroyInstance': None, 'vkDestroyBuffer': None}
mapDict['VkApplicationInfo'] =  {'VkStructureType': None, 'VkInstanceCreateInfo': None}
mapDict['VkAttachmentDescription'] =  {'VkAttachmentStoreOp': None, 'VkFormat': None, 'VkAttachmentLoadOp': None, 'VkImageLayout': None, 'VkSampleCountFlagBits': None, 'VkRenderPassCreateInfo': None, 'VkAttachmentDescriptionFlags': None}
...
mapDict['VkBindSparseInfo'] =  {'VkSparseImageOpaqueMemoryBindInfo': None, 'VkStructureType': None, 'VkSparseImageMemoryBindInfo': None, 'VkSemaphore': None, 'vkQueueBindSparse': None, 'VkSparseBufferMemoryBindInfo': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkWaitForFences': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPhysicalDeviceLimits': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPhysicalDeviceSparseProperties': None, 'VkSamplerCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdDispatchIndirect': None, 'vkCmdFillBuffer': None, 'vkBindBufferMemory': None, 'vkCreateBuffer': None, 'vkCmdUpdateBuffer': None, 'vkCmdDrawIndirect': None, 'VkBufferViewCreateInfo': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyQueryPoolResults': None, 'VkDescriptorBufferInfo': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdBindVertexBuffers': None, 'vkCmdCopyBuffer': None, 'vkCmdBindIndexBuffer': None, 'VkBufferMemoryBarrier': None, 'vkGetBufferMemoryRequirements': None, 'vkCmdCopyBufferToImage': None, 'vkDestroyBuffer': None, 'VkSparseBufferMemoryBindInfo': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkStructureType': None, 'VkSharingMode': None, 'VkBufferUsageFlags': None, 'VkDeviceSize': None, 'vkCreateBuffer': None, 'VkBufferCreateFlags': None}
mapDict['VkBufferImageCopy'] =  {'VkDeviceSize': None, 'VkOffset3D': None, 'vkCmdCopyBufferToImage': None, 'VkImageSubresourceLayers': None, 'VkExtent3D': None, 'vkCmdCopyImageToBuffer': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkStructureType': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkDeviceSize': None, 'VkBuffer': None, 'VkAccessFlags': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkStructureType': None, 'VkDeviceSize': None, 'VkBuffer': None, 'VkBufferViewCreateFlags': None, 'VkFormat': None, 'vkCreateBufferView': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdDraw': None, 'vkCmdResetEvent': None, 'vkEndCommandBuffer': None, 'vkCmdDrawIndexed': None, 'vkCmdClearColorImage': None, 'vkCmdUpdateBuffer': None, 'vkCmdSetDepthBounds': None, 'vkCmdCopyImage': None, 'vkCmdSetScissor': None, 'vkCmdBindVertexBuffers': None, 'vkCmdWaitEvents': None, 'vkCmdPushConstants': None, 'vkCmdBeginQuery': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdSetDepthBias': None, 'vkCmdResolveImage': None, 'vkCmdEndQuery': None, 'vkCmdSetBlendConstants': None, 'vkCmdWriteTimestamp': None, 'vkCmdSetStencilCompareMask': None, 'vkFreeCommandBuffers': None, 'vkCmdSetStencilReference': None, 'vkResetCommandBuffer': None, 'vkCmdSetLineWidth': None, 'vkCmdBindDescriptorSets': None, 'vkCmdPipelineBarrier': None, 'vkCmdBindIndexBuffer': None, 'vkCmdBindPipeline': None, 'vkAllocateCommandBuffers': None, 'vkCmdClearAttachments': None, 'vkCmdDispatch': None, 'vkCmdSetEvent': None, 'vkBeginCommandBuffer': None, 'vkCmdResetQueryPool': None, 'vkCmdFillBuffer': None, 'vkCmdBeginRenderPass': None, 'vkCmdEndRenderPass': None, 'vkCmdCopyBufferToImage': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdExecuteCommands': None, 'vkCmdBlitImage': None, 'vkCmdDispatchIndirect': None, 'vkCmdNextSubpass': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdSetViewport': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyBuffer': None, 'VkSubmitInfo': None, 'vkCmdDrawIndirect': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'VkStructureType': None, 'VkCommandPool': None, 'vkAllocateCommandBuffers': None, 'VkCommandBufferLevel': None}
...
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkFramebuffer': None, 'VkStructureType': None, 'VkQueryPipelineStatisticFlags': None, 'VkQueryControlFlags': None, 'VkCommandBufferBeginInfo': None, 'VkBool32': None, 'VkRenderPass': None}
...
mapDict['VkCommandPool'] =  {'vkFreeCommandBuffers': None, 'vkDestroyCommandPool': None, 'VkCommandBufferAllocateInfo': None, 'vkCreateCommandPool': None, 'vkResetCommandPool': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipeline': None, 'VkPipelineShaderStageCreateInfo': None, 'VkStructureType': None, 'vkCreateComputePipelines': None, 'VkPipelineCreateFlags': None, 'VkPipelineLayout': None}
...
mapDict['VkDescriptorPool'] =  {'vkFreeDescriptorSets': None, 'vkDestroyDescriptorPool': None, 'vkCreateDescriptorPool': None, 'VkDescriptorSetAllocateInfo': None, 'vkResetDescriptorPool': None}
...
mapDict['VkDescriptorPoolCreateInfo'] =  {'VkDescriptorPoolSize': None, 'VkStructureType': None, 'vkCreateDescriptorPool': None, 'VkDescriptorPoolCreateFlags': None}
...
mapDict['VkDescriptorSet'] =  {'vkAllocateDescriptorSets': None, 'vkFreeDescriptorSets': None, 'vkCmdBindDescriptorSets': None, 'VkCopyDescriptorSet': None, 'VkWriteDescriptorSet': None}
mapDict['VkDescriptorSetAllocateInfo'] =  {'VkDescriptorSetLayout': None, 'VkStructureType': None, 'VkDescriptorPool': None, 'vkAllocateDescriptorSets': None}
...
mapDict['VkDescriptorSetLayoutCreateInfo'] =  {'vkCreateDescriptorSetLayout': None, 'VkStructureType': None, 'VkDescriptorSetLayoutBinding': None, 'VkDescriptorSetLayoutCreateFlags': None}
mapDict['VkDescriptorType'] =  {'VkDescriptorPoolSize': None, 'VkDescriptorSetLayoutBinding': None, 'VkWriteDescriptorSet': None}
mapDict['VkDevice'] =  {'vkDestroyEvent': None, 'vkBindBufferMemory': None, 'vkGetDeviceProcAddr': None, 'vkDestroyFence': None, 'vkUnmapMemory': None, 'vkWaitForFences': None, 'vkCreateFence': None, 'vkDestroySemaphore': None, 'vkCreateComputePipelines': None, 'vkGetDeviceQueue': None, 'vkDestroyQueryPool': None, 'vkDestroyImageView': None, 'vkCreateBuffer': None, 'vkAllocateMemory': None, 'vkCreateEvent': None, 'vkCreateCommandPool': None, 'vkDestroyDescriptorPool': None, 'vkGetEventStatus': None, 'vkGetQueryPoolResults': None, 'vkDestroyPipelineCache': None, 'vkCreateShaderModule': None, 'vkFreeMemory': None, 'vkDestroyPipeline': None, 'vkDestroyImage': None, 'vkDeviceWaitIdle': None, 'vkCreateImage': None, 'vkFreeCommandBuffers': None, 'vkDestroyDevice': None, 'vkCreateGraphicsPipelines': None, 'vkGetFenceStatus': None, 'vkDestroyCommandPool': None, 'vkCreateFramebuffer': None, 'vkGetImageMemoryRequirements': None, 'vkAllocateCommandBuffers': None, 'vkUpdateDescriptorSets': None, 'vkFlushMappedMemoryRanges': None, 'vkCreateDescriptorPool': None, 'vkCreateBufferView': None, 'vkMapMemory': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCreateSemaphore': None, 'vkSetEvent': None, 'vkCreateSampler': None, 'vkGetDeviceMemoryCommitment': None, 'vkInvalidateMappedMemoryRanges': None, 'vkGetImageSubresourceLayout': None, 'vkDestroyPipelineLayout': None, 'vkMergePipelineCaches': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroyShaderModule': None, 'vkDestroyFramebuffer': None, 'vkDestroyRenderPass': None, 'vkCreateRenderPass': None, 'vkCreateQueryPool': None, 'vkDestroyBufferView': None, 'vkGetPipelineCacheData': None, 'vkGetBufferMemoryRequirements': None, 'vkCreatePipelineLayout': None, 'vkCreateDevice': None, 'vkBindImageMemory': None, 'vkDestroySampler': None, 'vkResetDescriptorPool': None, 'vkFreeDescriptorSets': None, 'vkAllocateDescriptorSets': None, 'vkGetRenderAreaGranularity': None, 'vkResetCommandPool': None, 'vkCreatePipelineCache': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateImageView': None, 'vkResetEvent': None, 'vkDestroyBuffer': None, 'vkResetFences': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkStructureType': None, 'VkDeviceQueueCreateInfo': None, 'vkCreateDevice': None, 'VkPhysicalDeviceFeatures': None, 'VkDeviceCreateFlags': None}
mapDict['VkDeviceMemory'] =  {'vkMapMemory': None, 'vkBindBufferMemory': None, 'VkSparseImageMemoryBind': None, 'vkFreeMemory': None, 'VkSparseMemoryBind': None, 'vkUnmapMemory': None, 'vkBindImageMemory': None, 'vkAllocateMemory': None, 'vkGetDeviceMemoryCommitment': None, 'VkMappedMemoryRange': None}
...
mapDict['VkDeviceSize'] =  {'VkImageFormatProperties': None, 'vkMapMemory': None, 'vkBindBufferMemory': None, 'VkBufferCreateInfo': None, 'vkCmdUpdateBuffer': None, 'vkGetDeviceMemoryCommitment': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdBindVertexBuffers': None, 'VkPhysicalDeviceLimits': None, 'VkSubresourceLayout': None, 'VkSparseMemoryBind': None, 'VkBufferImageCopy': None, 'VkMappedMemoryRange': None, 'vkCmdFillBuffer': None, 'vkCmdDispatchIndirect': None, 'vkGetQueryPoolResults': None, 'VkMemoryRequirements': None, 'VkMemoryAllocateInfo': None, 'VkMemoryHeap': None, 'vkBindImageMemory': None, 'vkCmdCopyQueryPoolResults': None, 'VkDescriptorBufferInfo': None, 'VkSparseImageMemoryBind': None, 'VkSparseImageMemoryRequirements': None, 'vkCmdBindIndexBuffer': None, 'VkBufferCopy': None, 'VkBufferMemoryBarrier': None, 'vkCmdDrawIndirect': None, 'VkBufferViewCreateInfo': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkDestroyEvent': None, 'vkGetEventStatus': None, 'vkCmdWaitEvents': None, 'vkCmdSetEvent': None, 'vkSetEvent': None, 'vkCmdResetEvent': None, 'vkCreateEvent': None, 'vkResetEvent': None}
...
mapDict['VkExtent3D'] =  {'VkImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkQueueFamilyProperties': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkSparseImageMemoryBind': None, 'VkSparseImageFormatProperties': None}
mapDict['VkFence'] =  {'vkQueueSubmit': None, 'vkWaitForFences': None, 'vkDestroyFence': None, 'vkGetFenceStatus': None, 'vkQueueBindSparse': None, 'vkCreateFence': None, 'vkResetFences': None}
...
mapDict['VkFormat'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'VkVertexInputAttributeDescription': None, 'VkImageCreateInfo': None, 'VkBufferViewCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageViewCreateInfo': None, 'VkAttachmentDescription': None, 'vkGetPhysicalDeviceFormatProperties': None}
...
mapDict['VkFramebuffer'] =  {'vkDestroyFramebuffer': None, 'VkCommandBufferInheritanceInfo': None, 'vkCreateFramebuffer': None, 'VkRenderPassBeginInfo': None}
mapDict['VkFramebufferCreateFlags'] =  {'VkFramebufferCreateInfo': None}
mapDict['VkFramebufferCreateInfo'] =  {'VkFramebufferCreateFlags': None, 'VkStructureType': None, 'VkImageView': None, 'VkRenderPass': None, 'vkCreateFramebuffer': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineDynamicStateCreateInfo': None, 'VkStructureType': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipeline': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineCreateFlags': None, 'VkRenderPass': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineLayout': None}
mapDict['VkImage'] =  {'vkDestroyImage': None, 'vkGetImageSparseMemoryRequirements': None, 'VkSparseImageMemoryBindInfo': None, 'vkCmdClearColorImage': None, 'vkCmdCopyBufferToImage': None, 'vkCmdClearDepthStencilImage': None, 'VkImageMemoryBarrier': None, 'vkCreateImage': None, 'vkCmdCopyImage': None, 'vkGetImageSubresourceLayout': None, 'vkCmdCopyImageToBuffer': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkGetImageMemoryRequirements': None, 'vkCmdResolveImage': None, 'VkImageViewCreateInfo': None, 'vkBindImageMemory': None, 'vkCmdBlitImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkImageSubresource': None, 'VkImageSubresourceLayers': None, 'VkImageAspectFlagBits': None, 'VkClearAttachment': None, 'VkSparseImageFormatProperties': None, 'VkImageSubresourceRange': None}
mapDict['VkImageBlit'] =  {'VkOffset3D': None, 'vkCmdBlitImage': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageCopy'] =  {'VkExtent3D': None, 'VkOffset3D': None, 'vkCmdCopyImage': None, 'VkImageSubresourceLayers': None}
...
mapDict['VkImageCreateInfo'] =  {'VkStructureType': None, 'VkImageType': None, 'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkSharingMode': None, 'VkImageLayout': None, 'VkExtent3D': None, 'VkFormat': None, 'VkImageCreateFlags': None, 'VkImageTiling': None, 'vkCreateImage': None}
...
mapDict['VkImageLayout'] =  {'VkAttachmentReference': None, 'vkCmdClearColorImage': None, 'vkCmdClearDepthStencilImage': None, 'VkImageMemoryBarrier': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyImage': None, 'VkDescriptorImageInfo': None, 'VkImageCreateInfo': None, 'vkCmdResolveImage': None, 'vkCmdCopyBufferToImage': None, 'vkCmdBlitImage': None, 'VkAttachmentDescription': None}
mapDict['VkImageMemoryBarrier'] =  {'VkStructureType': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkImageLayout': None, 'VkAccessFlags': None, 'VkImage': None, 'VkImageSubresourceRange': None}
mapDict['VkImageResolve'] =  {'VkExtent3D': None, 'VkOffset3D': None, 'vkCmdResolveImage': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageSubresource'] =  {'VkImageAspectFlags': None, 'vkGetImageSubresourceLayout': None, 'VkSparseImageMemoryBind': None}
mapDict['VkImageSubresourceLayers'] =  {'VkImageCopy': None, 'VkImageBlit': None, 'VkImageAspectFlags': None, 'VkBufferImageCopy': None, 'VkImageResolve': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageViewCreateInfo': None, 'VkImageAspectFlags': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdClearColorImage': None, 'VkImageMemoryBarrier': None}
...
mapDict['VkImageUsageFlags'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageUsageFlagBits': None, 'VkImageCreateInfo': None}
mapDict['VkImageView'] =  {'vkCreateImageView': None, 'VkDescriptorImageInfo': None, 'VkFramebufferCreateInfo': None, 'vkDestroyImageView': None}
mapDict['VkImageViewCreateFlags'] =  {'VkImageViewCreateInfo': None}
mapDict['VkImageViewCreateInfo'] =  {'VkStructureType': None, 'VkComponentMapping': None, 'VkImageViewCreateFlags': None, 'VkImage': None, 'vkCreateImageView': None, 'VkFormat': None, 'VkImageViewType': None, 'VkImageSubresourceRange': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkEnumeratePhysicalDevices': None, 'vkCreateInstance': None, 'vkDestroyInstance': None, 'vkCreateWin32SurfaceKHR': None, 'vkGetInstanceProcAddr': None}
...
mapDict['VkMappedMemoryRange'] =  {'vkInvalidateMappedMemoryRanges': None, 'VkStructureType': None, 'vkFlushMappedMemoryRanges': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
mapDict['VkMemoryAllocateInfo'] =  {'VkStructureType': None, 'vkAllocateMemory': None, 'VkDeviceSize': None}
mapDict['VkMemoryBarrier'] =  {'VkStructureType': None, 'VkAccessFlags': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'vkCreateDevice': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetPhysicalDeviceFeatures': None, 'vkGetPhysicalDeviceWin32PresentationSupportKHR': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None}
mapDict['VkPhysicalDeviceFeatures'] =  {'VkBool32': None, 'VkDeviceCreateInfo': None, 'vkGetPhysicalDeviceFeatures': None}
mapDict['VkPhysicalDeviceLimits'] =  {'VkPhysicalDeviceProperties': None, 'VkBool32': None, 'VkSampleCountFlags': None, 'VkDeviceSize': None}
...
mapDict['VkPipeline'] =  {'VkGraphicsPipelineCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyPipeline': None, 'VkComputePipelineCreateInfo': None, 'vkCmdBindPipeline': None, 'vkCreateComputePipelines': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkMergePipelineCaches': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyPipelineCache': None, 'vkGetPipelineCacheData': None, 'vkCreatePipelineCache': None, 'vkCreateComputePipelines': None}
...
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkPipelineColorBlendStateCreateFlags': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None, 'VkPipelineColorBlendAttachmentState': None, 'VkLogicOp': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkCompareOp': None, 'VkBool32': None, 'VkStencilOpState': None}
...
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineInputAssemblyStateCreateFlags': None, 'VkBool32': None, 'VkPrimitiveTopology': None}
mapDict['VkPipelineLayout'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'vkCmdBindDescriptorSets': None, 'vkCmdPushConstants': None, 'vkCreatePipelineLayout': None, 'vkDestroyPipelineLayout': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkDescriptorSetLayout': None, 'VkStructureType': None, 'vkCreatePipelineLayout': None, 'VkPushConstantRange': None, 'VkPipelineLayoutCreateFlags': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkBool32': None, 'VkSampleCountFlagBits': None, 'VkSampleMask': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkCullModeFlags': None, 'VkPolygonMode': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkFrontFace': None, 'VkBool32': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkShaderStageFlagBits': None, 'VkComputePipelineCreateInfo': None, 'VkPipelineShaderStageCreateFlags': None, 'VkSpecializationInfo': None, 'VkShaderModule': None}
mapDict['VkPipelineStageFlagBits'] =  {'vkCmdWriteTimestamp': None, 'VkPipelineStageFlags': None}
mapDict['VkPipelineStageFlags'] =  {'VkSubmitInfo': None, 'vkCmdResetEvent': None, 'vkCmdWaitEvents': None, 'VkSubpassDependency': None, 'vkCmdSetEvent': None, 'vkCmdPipelineBarrier': None, 'VkPipelineStageFlagBits': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineVertexInputStateCreateFlags': None, 'VkVertexInputBindingDescription': None, 'VkVertexInputAttributeDescription': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkViewport': None, 'VkPipelineViewportStateCreateFlags': None, 'VkRect2D': None}
...
mapDict['VkQueryPool'] =  {'vkGetQueryPoolResults': None, 'vkDestroyQueryPool': None, 'vkCmdEndQuery': None, 'vkCmdWriteTimestamp': None, 'vkCmdBeginQuery': None, 'vkCreateQueryPool': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdResetQueryPool': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkStructureType': None, 'VkQueryType': None, 'vkCreateQueryPool': None, 'VkQueryPipelineStatisticFlags': None, 'VkQueryPoolCreateFlags': None}
...
mapDict['VkQueue'] =  {'vkGetDeviceQueue': None, 'vkQueueBindSparse': None, 'vkQueueWaitIdle': None, 'vkQueueSubmit': None}
...
mapDict['VkRect2D'] =  {'VkRenderPassBeginInfo': None, 'VkExtent2D': None, 'VkOffset2D': None, 'VkPipelineViewportStateCreateInfo': None, 'VkClearRect': None, 'vkCmdSetScissor': None}
mapDict['VkRenderPass'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkFramebufferCreateInfo': None, 'vkCreateRenderPass': None, 'vkDestroyRenderPass': None, 'VkRenderPassBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkGetRenderAreaGranularity': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkFramebuffer': None, 'VkStructureType': None, 'VkRect2D': None, 'VkClearValue': None, 'vkCmdBeginRenderPass': None, 'VkRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkStructureType': None, 'VkSubpassDependency': None, 'VkAttachmentDescription': None, 'vkCreateRenderPass': None, 'VkRenderPassCreateFlags': None, 'VkSubpassDescription': None}
...
mapDict['VkSamplerCreateInfo'] =  {'VkStructureType': None, 'VkSamplerAddressMode': None, 'VkCompareOp': None, 'VkSamplerMipmapMode': None, 'VkBorderColor': None, 'VkBool32': None, 'VkSamplerCreateFlags': None, 'VkFilter': None, 'vkCreateSampler': None}
...
mapDict['VkShaderStageFlags'] =  {'vkCmdPushConstants': None, 'VkShaderStageFlagBits': None, 'VkDescriptorSetLayoutBinding': None, 'VkPushConstantRange': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'VkSparseImageMemoryRequirements': None, 'VkExtent3D': None, 'VkImageAspectFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageFormatFlags': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkImageSubresource': None, 'VkSparseMemoryBindFlags': None, 'VkSparseImageMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkExtent3D': None, 'VkOffset3D': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None, 'VkSparseBufferMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
...
mapDict['VkStructureType'] =  {'VkInstanceCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkEventCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkImageCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkBindSparseInfo': None, 'VkMappedMemoryRange': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkSamplerCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkBufferCreateInfo': None, 'VkMemoryBarrier': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkCommandBufferBeginInfo': None, 'VkFenceCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkWin32SurfaceCreateInfoKHR': None, 'VkBufferViewCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkSubmitInfo': None, 'VkWriteDescriptorSet': None, 'VkApplicationInfo': None}
mapDict['VkSubmitInfo'] =  {'VkStructureType': None, 'VkPipelineStageFlags': None, 'vkQueueSubmit': None, 'VkCommandBuffer': None, 'VkSemaphore': None}
mapDict['VkSubpassContents'] =  {'vkCmdBeginRenderPass': None, 'vkCmdNextSubpass': None}
mapDict['VkSubpassDependency'] =  {'VkRenderPassCreateInfo': None, 'VkPipelineStageFlags': None, 'VkAccessFlags': None, 'VkDependencyFlags': None}
mapDict['VkSubpassDescription'] =  {'VkSubpassDescriptionFlags': None, 'VkPipelineBindPoint': None, 'VkAttachmentReference': None, 'VkRenderPassCreateInfo': None}
...
mapDict['VkWin32SurfaceCreateInfoKHR'] =  {'VkStructureType': None, 'VkWin32SurfaceCreateFlagsKHR': None, 'vkCreateWin32SurfaceKHR': None}
mapDict['VkWriteDescriptorSet'] =  {'VkStructureType': None, 'VkDescriptorImageInfo': None, 'VkDescriptorSet': None, 'VkBufferView': None, 'VkDescriptorType': None, 'VkDescriptorBufferInfo': None, 'vkUpdateDescriptorSets': None}
...
mapDict['vkBindBufferMemory'] =  {'VkDevice': None, 'VkDeviceSize': None, 'VkDeviceMemory': None, 'VkBuffer': None}
...
mapDict['vkCmdBlitImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImageBlit': None, 'VkFilter': None}
mapDict['vkCmdClearAttachments'] =  {'VkCommandBuffer': None, 'VkClearRect': None, 'VkClearAttachment': None}
mapDict['vkCmdClearColorImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImageSubresourceRange': None, 'VkClearColorValue': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkClearDepthStencilValue': None, 'VkImageSubresourceRange': None}
...
mapDict['vkCmdCopyImageToBuffer'] =  {'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkBufferImageCopy': None, 'VkBuffer': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkBuffer': None, 'VkCommandBuffer': None, 'VkQueryResultFlags': None, 'VkQueryPool': None, 'VkDeviceSize': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkCommandBuffer': None, 'VkImageMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkDependencyFlags': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkEvent': None, 'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkCommandBuffer': None, 'VkImageMemoryBarrier': None, 'VkPipelineStageFlags': None}
mapDict['vkCmdWriteTimestamp'] =  {'VkQueryPool': None, 'VkCommandBuffer': None, 'VkPipelineStageFlagBits': None}
mapDict['vkCreateBuffer'] =  {'VkDevice': None, 'VkBuffer': None, 'VkAllocationCallbacks': None, 'VkBufferCreateInfo': None}
mapDict['vkCreateBufferView'] =  {'VkDevice': None, 'VkBufferViewCreateInfo': None, 'VkBufferView': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateCommandPool'] =  {'VkCommandPoolCreateInfo': None, 'VkDevice': None, 'VkCommandPool': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateComputePipelines'] =  {'VkPipeline': None, 'VkDevice': None, 'VkPipelineCache': None, 'VkAllocationCallbacks': None, 'VkComputePipelineCreateInfo': None}
...
mapDict['vkCreateDevice'] =  {'VkPhysicalDevice': None, 'VkAllocationCallbacks': None, 'VkDeviceCreateInfo': None, 'VkDevice': None}
...
mapDict['vkCreateGraphicsPipelines'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkDevice': None, 'VkPipelineCache': None, 'VkPipeline': None, 'VkAllocationCallbacks': None}
...
mapDict['vkCreateSemaphore'] =  {'VkDevice': None, 'VkSemaphore': None, 'VkAllocationCallbacks': None, 'VkSemaphoreCreateInfo': None}
mapDict['vkCreateShaderModule'] =  {'VkDevice': None, 'VkShaderModule': None, 'VkShaderModuleCreateInfo': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateWin32SurfaceKHR'] =  {'VkWin32SurfaceCreateInfoKHR': None, 'VkAllocationCallbacks': None, 'VkInstance': None, 'VkSurfaceKHR': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkPhysicalDevice': None, 'VkImageFormatProperties': None, 'VkImageType': None, 'VkImageTiling': None, 'VkImageUsageFlags': None, 'VkFormat': None, 'VkImageCreateFlags': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkPhysicalDevice': None, 'VkImageType': None, 'VkFormat': None, 'VkImageUsageFlags': None, 'VkSampleCountFlagBits': None, 'VkImageTiling': None, 'VkSparseImageFormatProperties': None}
...
mapDict['vkGetQueryPoolResults'] =  {'VkDevice': None, 'VkQueryResultFlags': None, 'VkQueryPool': None, 'VkDeviceSize': None}
...
mapDict['vkMapMemory'] =  {'VkDevice': None, 'VkMemoryMapFlags': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
