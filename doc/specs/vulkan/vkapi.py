...
mapDict['VkAccessFlags'] =  {'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkSubpassDependency': None, 'VkAccessFlagBits': None}
mapDict['VkAllocationCallbacks'] =  {'PFN_vkAllocationFunction': None, 'vkDestroySampler': None, 'vkCreateDescriptorPool': None, 'vkDestroyImage': None, 'vkCreateRenderPass': None, 'vkDestroyBuffer': None, 'vkCreateFramebuffer': None, 'vkDestroyImageView': None, 'vkCreateShaderModule': None, 'vkDestroyPipeline': None, 'vkDestroyFence': None, 'PFN_vkReallocationFunction': None, 'vkDestroyBufferView': None, 'vkCreateQueryPool': None, 'vkDestroyEvent': None, 'PFN_vkInternalFreeNotification': None, 'vkDestroyRenderPass': None, 'vkCreatePipelineLayout': None, 'vkCreatePipelineCache': None, 'vkAllocateMemory': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroyPipelineLayout': None, 'vkCreateDisplayModeKHR': None, 'vkCreateInstance': None, 'PFN_vkFreeFunction': None, 'vkCreateSemaphore': None, 'vkDestroyCommandPool': None, 'vkDestroyDescriptorPool': None, 'vkDestroyShaderModule': None, 'PFN_vkInternalAllocationNotification': None, 'vkCreateCommandPool': None, 'vkCreateImageView': None, 'vkCreateSampler': None, 'vkDestroyInstance': None, 'vkDestroyDevice': None, 'vkCreateImage': None, 'vkCreateBuffer': None, 'vkDestroyPipelineCache': None, 'vkCreateFence': None, 'vkCreateDisplayPlaneSurfaceKHR': None, 'vkCreateDevice': None, 'vkDestroyFramebuffer': None, 'vkDestroySemaphore': None, 'vkFreeMemory': None, 'vkDestroyQueryPool': None, 'vkCreateComputePipelines': None, 'vkCreateEvent': None, 'vkCreateBufferView': None, 'vkCreateGraphicsPipelines': None, 'vkCreateDescriptorSetLayout': None}
mapDict['VkApplicationInfo'] =  {'VkInstanceCreateInfo': None, 'VkStructureType': None}
mapDict['VkAttachmentDescription'] =  {'VkRenderPassCreateInfo': None, 'VkAttachmentLoadOp': None, 'VkSampleCountFlagBits': None, 'VkAttachmentDescriptionFlags': None, 'VkFormat': None, 'VkImageLayout': None, 'VkAttachmentStoreOp': None}
...
mapDict['VkBindSparseInfo'] =  {'VkSparseBufferMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'vkQueueBindSparse': None, 'VkSemaphore': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkStructureType': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPhysicalDeviceFeatures': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPhysicalDeviceLimits': None, 'VkSamplerCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'vkWaitForFences': None, 'VkDisplayPropertiesKHR': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdCopyBufferToImage': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdCopyQueryPoolResults': None, 'VkDescriptorBufferInfo': None, 'vkCmdFillBuffer': None, 'vkCmdUpdateBuffer': None, 'vkBindBufferMemory': None, 'vkDestroyBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdDrawIndirect': None, 'VkBufferMemoryBarrier': None, 'vkCmdCopyBuffer': None, 'VkBufferViewCreateInfo': None, 'vkGetBufferMemoryRequirements': None, 'vkCreateBuffer': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdDispatchIndirect': None, 'vkCmdBindIndexBuffer': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkSharingMode': None, 'VkStructureType': None, 'VkBufferUsageFlags': None, 'vkCreateBuffer': None, 'VkDeviceSize': None, 'VkBufferCreateFlags': None}
mapDict['VkBufferImageCopy'] =  {'vkCmdCopyBufferToImage': None, 'VkExtent3D': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None, 'vkCmdCopyImageToBuffer': None, 'VkDeviceSize': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkAccessFlags': None, 'VkStructureType': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkDeviceSize': None, 'VkBuffer': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkStructureType': None, 'VkFormat': None, 'VkBufferViewCreateFlags': None, 'vkCreateBufferView': None, 'VkDeviceSize': None, 'VkBuffer': None}
mapDict['VkClearAttachment'] =  {'vkCmdClearAttachments': None, 'VkClearValue': None, 'VkImageAspectFlags': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdUpdateBuffer': None, 'vkCmdEndRenderPass': None, 'vkCmdExecuteCommands': None, 'vkCmdSetLineWidth': None, 'vkCmdWaitEvents': None, 'vkCmdBlitImage': None, 'vkCmdDrawIndirect': None, 'vkCmdBindDescriptorSets': None, 'vkCmdResolveImage': None, 'vkCmdDrawIndexed': None, 'vkCmdPipelineBarrier': None, 'vkCmdSetScissor': None, 'vkCmdBeginQuery': None, 'vkCmdSetBlendConstants': None, 'vkCmdResetQueryPool': None, 'vkResetCommandBuffer': None, 'vkEndCommandBuffer': None, 'vkCmdWriteTimestamp': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdDraw': None, 'vkCmdEndQuery': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyQueryPoolResults': None, 'vkFreeCommandBuffers': None, 'vkCmdPushConstants': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdFillBuffer': None, 'vkCmdSetStencilReference': None, 'vkCmdCopyBuffer': None, 'vkCmdSetViewport': None, 'vkCmdClearColorImage': None, 'vkCmdSetEvent': None, 'vkCmdCopyImage': None, 'vkBeginCommandBuffer': None, 'vkCmdSetDepthBias': None, 'vkCmdBindPipeline': None, 'vkCmdBindIndexBuffer': None, 'vkCmdCopyBufferToImage': None, 'vkCmdClearDepthStencilImage': None, 'vkAllocateCommandBuffers': None, 'vkCmdSetDepthBounds': None, 'vkCmdClearAttachments': None, 'vkCmdDispatch': None, 'vkCmdBindVertexBuffers': None, 'vkCmdDrawIndexedIndirect': None, 'VkSubmitInfo': None, 'vkCmdNextSubpass': None, 'vkCmdBeginRenderPass': None, 'vkCmdDispatchIndirect': None, 'vkCmdResetEvent': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'VkCommandBufferLevel': None, 'vkAllocateCommandBuffers': None, 'VkStructureType': None, 'VkCommandPool': None}
...
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkCommandBufferBeginInfo': None, 'VkQueryControlFlags': None, 'VkStructureType': None, 'VkRenderPass': None, 'VkFramebuffer': None, 'VkQueryPipelineStatisticFlags': None, 'VkBool32': None}
...
mapDict['VkCommandPool'] =  {'VkCommandBufferAllocateInfo': None, 'vkFreeCommandBuffers': None, 'vkDestroyCommandPool': None, 'vkCreateCommandPool': None, 'vkResetCommandPool': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipelineShaderStageCreateInfo': None, 'VkStructureType': None, 'VkPipelineCreateFlags': None, 'vkCreateComputePipelines': None, 'VkPipelineLayout': None, 'VkPipeline': None}
...
mapDict['VkDescriptorImageInfo'] =  {'VkImageLayout': None, 'VkSampler': None, 'VkWriteDescriptorSet': None, 'VkImageView': None}
mapDict['VkDescriptorPool'] =  {'vkCreateDescriptorPool': None, 'vkFreeDescriptorSets': None, 'VkDescriptorSetAllocateInfo': None, 'vkDestroyDescriptorPool': None, 'vkResetDescriptorPool': None}
...
mapDict['VkDescriptorSet'] =  {'vkCmdBindDescriptorSets': None, 'VkCopyDescriptorSet': None, 'vkFreeDescriptorSets': None, 'VkWriteDescriptorSet': None, 'vkAllocateDescriptorSets': None}
...
mapDict['VkDescriptorSetLayoutBinding'] =  {'VkShaderStageFlags': None, 'VkSampler': None, 'VkDescriptorType': None, 'VkDescriptorSetLayoutCreateInfo': None}
mapDict['VkDescriptorSetLayoutCreateFlags'] =  {'VkDescriptorSetLayoutCreateInfo': None}
mapDict['VkDescriptorSetLayoutCreateInfo'] =  {'VkDescriptorSetLayoutCreateFlags': None, 'VkDescriptorSetLayoutBinding': None, 'VkStructureType': None, 'vkCreateDescriptorSetLayout': None}
mapDict['VkDescriptorType'] =  {'VkWriteDescriptorSet': None, 'VkDescriptorSetLayoutBinding': None, 'VkDescriptorPoolSize': None}
mapDict['VkDevice'] =  {'vkMapMemory': None, 'vkCreateDescriptorPool': None, 'vkDestroySampler': None, 'vkCreateDevice': None, 'vkCreateCommandPool': None, 'vkDestroyImage': None, 'vkMergePipelineCaches': None, 'vkBindBufferMemory': None, 'vkGetDeviceQueue': None, 'vkCreateImageView': None, 'vkFreeDescriptorSets': None, 'vkDestroyImageView': None, 'vkGetFenceStatus': None, 'vkCreateShaderModule': None, 'vkUpdateDescriptorSets': None, 'vkDestroyRenderPass': None, 'vkGetDeviceProcAddr': None, 'vkDestroyPipeline': None, 'vkDestroyFence': None, 'vkCreateEvent': None, 'vkDestroyBufferView': None, 'vkCreateQueryPool': None, 'vkDestroyEvent': None, 'vkSetEvent': None, 'vkWaitForFences': None, 'vkGetPipelineCacheData': None, 'vkGetImageSubresourceLayout': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCreatePipelineCache': None, 'vkGetImageMemoryRequirements': None, 'vkAllocateMemory': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateBuffer': None, 'vkCreatePipelineLayout': None, 'vkDestroyCommandPool': None, 'vkGetDeviceMemoryCommitment': None, 'vkResetCommandPool': None, 'vkBindImageMemory': None, 'vkFlushMappedMemoryRanges': None, 'vkInvalidateMappedMemoryRanges': None, 'vkAllocateDescriptorSets': None, 'vkResetEvent': None, 'vkCreateSemaphore': None, 'vkCreateRenderPass': None, 'vkCreateFramebuffer': None, 'vkDestroyDescriptorPool': None, 'vkDestroyShaderModule': None, 'vkDestroyBuffer': None, 'vkCreateComputePipelines': None, 'vkResetDescriptorPool': None, 'vkCreateDescriptorSetLayout': None, 'vkAllocateCommandBuffers': None, 'vkCreateSampler': None, 'vkDestroyDevice': None, 'vkUnmapMemory': None, 'vkCreateImage': None, 'vkDestroyPipelineLayout': None, 'vkGetRenderAreaGranularity': None, 'vkGetEventStatus': None, 'vkDestroyPipelineCache': None, 'vkCreateFence': None, 'vkDeviceWaitIdle': None, 'vkDestroyFramebuffer': None, 'vkCreateGraphicsPipelines': None, 'vkDestroySemaphore': None, 'vkFreeMemory': None, 'vkDestroyQueryPool': None, 'vkGetBufferMemoryRequirements': None, 'vkGetQueryPoolResults': None, 'vkFreeCommandBuffers': None, 'vkResetFences': None, 'vkCreateBufferView': None}
...
mapDict['VkDeviceMemory'] =  {'vkMapMemory': None, 'vkUnmapMemory': None, 'VkSparseMemoryBind': None, 'VkSparseImageMemoryBind': None, 'vkFreeMemory': None, 'vkAllocateMemory': None, 'vkBindImageMemory': None, 'VkMappedMemoryRange': None, 'vkBindBufferMemory': None, 'vkGetDeviceMemoryCommitment': None}
...
mapDict['VkDeviceSize'] =  {'vkMapMemory': None, 'VkImageFormatProperties': None, 'VkMemoryAllocateInfo': None, 'VkDescriptorBufferInfo': None, 'vkBindImageMemory': None, 'vkBindBufferMemory': None, 'VkSubresourceLayout': None, 'VkBufferImageCopy': None, 'VkSparseImageMemoryRequirements': None, 'VkBufferMemoryBarrier': None, 'vkCmdDrawIndirect': None, 'VkMappedMemoryRange': None, 'VkBufferCopy': None, 'VkBufferCreateInfo': None, 'vkCmdBindIndexBuffer': None, 'vkCmdFillBuffer': None, 'VkMemoryRequirements': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdUpdateBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdDrawIndexedIndirect': None, 'VkPhysicalDeviceLimits': None, 'VkSparseMemoryBind': None, 'VkMemoryHeap': None, 'VkBufferViewCreateInfo': None, 'vkGetQueryPoolResults': None, 'vkCmdDispatchIndirect': None, 'vkGetDeviceMemoryCommitment': None, 'VkSparseImageMemoryBind': None}
mapDict['VkDisplayKHR'] =  {'VkDisplayPlanePropertiesKHR': None, 'vkGetDisplayModePropertiesKHR': None, 'vkGetDisplayPlaneSupportedDisplaysKHR': None, 'VkDisplayPropertiesKHR': None, 'vkCreateDisplayModeKHR': None}
...
mapDict['VkDisplayModeKHR'] =  {'VkDisplaySurfaceCreateInfoKHR': None, 'vkGetDisplayPlaneCapabilitiesKHR': None, 'VkDisplayModePropertiesKHR': None, 'vkCreateDisplayModeKHR': None}
...
mapDict['VkDisplayPlaneCapabilitiesKHR'] =  {'VkOffset2D': None, 'vkGetDisplayPlaneCapabilitiesKHR': None, 'VkDisplayPlaneAlphaFlagsKHR': None, 'VkExtent2D': None}
mapDict['VkDisplayPlanePropertiesKHR'] =  {'VkDisplayKHR': None, 'vkGetPhysicalDeviceDisplayPlanePropertiesKHR': None}
mapDict['VkDisplayPropertiesKHR'] =  {'VkDisplayKHR': None, 'vkGetPhysicalDeviceDisplayPropertiesKHR': None, 'VkSurfaceTransformFlagsKHR': None, 'VkExtent2D': None, 'VkBool32': None}
mapDict['VkDisplaySurfaceCreateFlagsKHR'] =  {'VkDisplaySurfaceCreateInfoKHR': None}
mapDict['VkDisplaySurfaceCreateInfoKHR'] =  {'VkDisplaySurfaceCreateFlagsKHR': None, 'VkStructureType': None, 'VkDisplayModeKHR': None, 'vkCreateDisplayPlaneSurfaceKHR': None, 'VkSurfaceTransformFlagBitsKHR': None, 'VkDisplayPlaneAlphaFlagBitsKHR': None, 'VkExtent2D': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkGetEventStatus': None, 'vkCmdWaitEvents': None, 'vkResetEvent': None, 'vkCmdSetEvent': None, 'vkCreateEvent': None, 'vkDestroyEvent': None, 'vkSetEvent': None, 'vkCmdResetEvent': None}
...
mapDict['VkExtent2D'] =  {'VkDisplaySurfaceCreateInfoKHR': None, 'VkDisplayPlaneCapabilitiesKHR': None, 'VkRect2D': None, 'VkDisplayModeParametersKHR': None, 'vkGetRenderAreaGranularity': None, 'VkDisplayPropertiesKHR': None}
mapDict['VkExtent3D'] =  {'VkImageFormatProperties': None, 'VkQueueFamilyProperties': None, 'VkImageResolve': None, 'VkSparseImageMemoryBind': None, 'VkSparseImageFormatProperties': None, 'VkImageCopy': None, 'VkImageCreateInfo': None, 'VkBufferImageCopy': None}
mapDict['VkFence'] =  {'vkDestroyFence': None, 'vkCreateFence': None, 'vkWaitForFences': None, 'vkQueueSubmit': None, 'vkResetFences': None, 'vkGetFenceStatus': None, 'vkQueueBindSparse': None}
...
mapDict['VkFormat'] =  {'VkImageViewCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkBufferViewCreateInfo': None, 'VkVertexInputAttributeDescription': None, 'VkAttachmentDescription': None, 'vkGetPhysicalDeviceFormatProperties': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineShaderStageCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkStructureType': None, 'VkPipelineCreateFlags': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkRenderPass': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipeline': None, 'VkPipelineLayout': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None}
mapDict['VkImage'] =  {'vkBindImageMemory': None, 'vkCmdCopyBufferToImage': None, 'vkCreateImage': None, 'VkImageMemoryBarrier': None, 'vkCmdClearDepthStencilImage': None, 'vkDestroyImage': None, 'vkCmdResolveImage': None, 'VkImageViewCreateInfo': None, 'vkGetImageSubresourceLayout': None, 'vkCmdClearColorImage': None, 'vkGetImageSparseMemoryRequirements': None, 'VkSparseImageMemoryBindInfo': None, 'vkCmdBlitImage': None, 'vkCmdCopyImage': None, 'vkCmdCopyImageToBuffer': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkGetImageMemoryRequirements': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkClearAttachment': None, 'VkImageAspectFlagBits': None, 'VkImageSubresourceLayers': None, 'VkSparseImageFormatProperties': None, 'VkImageSubresourceRange': None, 'VkImageSubresource': None}
...
mapDict['VkImageCreateInfo'] =  {'VkSharingMode': None, 'vkCreateImage': None, 'VkSampleCountFlagBits': None, 'VkImageTiling': None, 'VkStructureType': None, 'VkExtent3D': None, 'VkImageLayout': None, 'VkImageCreateFlags': None, 'VkImageType': None, 'VkImageUsageFlags': None, 'VkFormat': None}
mapDict['VkImageFormatProperties'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'VkSampleCountFlags': None, 'VkDeviceSize': None, 'VkExtent3D': None}
mapDict['VkImageLayout'] =  {'vkCmdCopyBufferToImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdResolveImage': None, 'VkImageMemoryBarrier': None, 'VkAttachmentReference': None, 'VkDescriptorImageInfo': None, 'VkImageCreateInfo': None, 'vkCmdClearColorImage': None, 'vkCmdBlitImage': None, 'vkCmdCopyImage': None, 'vkCmdCopyImageToBuffer': None, 'VkAttachmentDescription': None}
mapDict['VkImageMemoryBarrier'] =  {'VkAccessFlags': None, 'VkStructureType': None, 'vkCmdWaitEvents': None, 'VkImageLayout': None, 'VkImage': None, 'VkImageSubresourceRange': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkImageSubresourceLayers'] =  {'VkImageBlit': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageAspectFlags': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageViewCreateInfo': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdClearColorImage': None, 'VkImageMemoryBarrier': None, 'VkImageAspectFlags': None}
...
mapDict['VkImageUsageFlags'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageUsageFlagBits': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkImageViewCreateInfo'] =  {'VkComponentMapping': None, 'VkStructureType': None, 'VkFormat': None, 'VkImage': None, 'VkImageViewCreateFlags': None, 'VkImageSubresourceRange': None, 'VkImageViewType': None, 'vkCreateImageView': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkEnumeratePhysicalDevices': None, 'vkCreateInstance': None, 'vkDestroyInstance': None, 'vkGetInstanceProcAddr': None, 'vkCreateDisplayPlaneSurfaceKHR': None}
...
mapDict['VkMappedMemoryRange'] =  {'VkDeviceSize': None, 'vkFlushMappedMemoryRanges': None, 'vkInvalidateMappedMemoryRanges': None, 'VkStructureType': None, 'VkDeviceMemory': None}
mapDict['VkMemoryAllocateInfo'] =  {'vkAllocateMemory': None, 'VkStructureType': None, 'VkDeviceSize': None}
mapDict['VkMemoryBarrier'] =  {'VkAccessFlags': None, 'VkStructureType': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkEnumerateDeviceLayerProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetDisplayPlaneSupportedDisplaysKHR': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkGetPhysicalDeviceDisplayPropertiesKHR': None, 'vkGetDisplayModePropertiesKHR': None, 'vkCreateDevice': None, 'vkGetDisplayPlaneCapabilitiesKHR': None, 'vkCreateDisplayModeKHR': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceFeatures': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkGetPhysicalDeviceDisplayPlanePropertiesKHR': None}
mapDict['VkPhysicalDeviceFeatures'] =  {'VkDeviceCreateInfo': None, 'vkGetPhysicalDeviceFeatures': None, 'VkBool32': None}
mapDict['VkPhysicalDeviceLimits'] =  {'VkSampleCountFlags': None, 'VkDeviceSize': None, 'VkPhysicalDeviceProperties': None, 'VkBool32': None}
...
mapDict['VkPipeline'] =  {'vkCmdBindPipeline': None, 'vkCreateComputePipelines': None, 'VkGraphicsPipelineCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyPipeline': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None, 'vkCmdBindPipeline': None}
mapDict['VkPipelineCache'] =  {'vkGetPipelineCacheData': None, 'vkCreatePipelineCache': None, 'vkDestroyPipelineCache': None, 'vkCreateComputePipelines': None, 'vkMergePipelineCaches': None, 'vkCreateGraphicsPipelines': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkPipelineColorBlendStateCreateInfo': None, 'VkBlendOp': None, 'VkColorComponentFlags': None, 'VkBlendFactor': None, 'VkBool32': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkPipelineColorBlendStateCreateFlags': None, 'VkPipelineColorBlendAttachmentState': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkLogicOp': None, 'VkBool32': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkCompareOp': None, 'VkStructureType': None, 'VkStencilOpState': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkBool32': None}
mapDict['VkPipelineDynamicStateCreateFlags'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateInfo'] =  {'VkDynamicState': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineDynamicStateCreateFlags': None, 'VkStructureType': None}
mapDict['VkPipelineInputAssemblyStateCreateFlags'] =  {'VkPipelineInputAssemblyStateCreateInfo': None}
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkPrimitiveTopology': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineInputAssemblyStateCreateFlags': None}
mapDict['VkPipelineLayout'] =  {'vkCmdPushConstants': None, 'vkCmdBindDescriptorSets': None, 'vkCreatePipelineLayout': None, 'VkGraphicsPipelineCreateInfo': None, 'vkDestroyPipelineLayout': None, 'VkComputePipelineCreateInfo': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkPipelineLayoutCreateFlags': None, 'vkCreatePipelineLayout': None, 'VkPushConstantRange': None, 'VkStructureType': None, 'VkDescriptorSetLayout': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkSampleMask': None, 'VkSampleCountFlagBits': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkBool32': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkCullModeFlags': None, 'VkStructureType': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkPolygonMode': None, 'VkFrontFace': None, 'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkSpecializationInfo': None, 'VkStructureType': None, 'VkShaderModule': None, 'VkPipelineShaderStageCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkShaderStageFlagBits': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'VkSubmitInfo': None, 'VkPipelineStageFlagBits': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None, 'VkSubpassDependency': None, 'vkCmdSetEvent': None, 'vkCmdResetEvent': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkVertexInputAttributeDescription': None, 'VkPipelineVertexInputStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkVertexInputBindingDescription': None, 'VkStructureType': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkPipelineViewportStateCreateFlags': None, 'VkViewport': None, 'VkRect2D': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None}
...
mapDict['VkQueryPool'] =  {'vkCmdWriteTimestamp': None, 'vkDestroyQueryPool': None, 'vkCmdBeginQuery': None, 'vkCreateQueryPool': None, 'vkGetQueryPoolResults': None, 'vkCmdEndQuery': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdResetQueryPool': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkQueryPoolCreateFlags': None, 'vkCreateQueryPool': None, 'VkStructureType': None, 'VkQueryType': None, 'VkQueryPipelineStatisticFlags': None}
...
mapDict['VkRect2D'] =  {'VkOffset2D': None, 'vkCmdSetScissor': None, 'VkPipelineViewportStateCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkClearRect': None, 'VkExtent2D': None}
mapDict['VkRenderPass'] =  {'VkCommandBufferInheritanceInfo': None, 'VkFramebufferCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkRenderPassBeginInfo': None, 'vkCreateRenderPass': None, 'vkGetRenderAreaGranularity': None, 'vkDestroyRenderPass': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkRect2D': None, 'VkStructureType': None, 'VkRenderPass': None, 'VkFramebuffer': None, 'VkClearValue': None, 'vkCmdBeginRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkSubpassDescription': None, 'VkStructureType': None, 'VkAttachmentDescription': None, 'vkCreateRenderPass': None, 'VkSubpassDependency': None, 'VkRenderPassCreateFlags': None}
mapDict['VkSampleCountFlagBits'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSampleCountFlags': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkImageCreateInfo': None, 'VkAttachmentDescription': None}
...
mapDict['VkSampler'] =  {'vkCreateSampler': None, 'vkDestroySampler': None, 'VkDescriptorSetLayoutBinding': None, 'VkDescriptorImageInfo': None}
mapDict['VkSamplerAddressMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateFlags'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateInfo'] =  {'VkCompareOp': None, 'VkFilter': None, 'VkBorderColor': None, 'VkStructureType': None, 'VkSamplerAddressMode': None, 'vkCreateSampler': None, 'VkSamplerMipmapMode': None, 'VkSamplerCreateFlags': None, 'VkBool32': None}
mapDict['VkSamplerMipmapMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSemaphore'] =  {'vkCreateSemaphore': None, 'VkSubmitInfo': None, 'vkDestroySemaphore': None, 'VkBindSparseInfo': None}
mapDict['VkSemaphoreCreateFlags'] =  {'VkSemaphoreCreateInfo': None}
mapDict['VkSemaphoreCreateInfo'] =  {'vkCreateSemaphore': None, 'VkSemaphoreCreateFlags': None, 'VkStructureType': None}
...
mapDict['VkShaderStageFlags'] =  {'vkCmdPushConstants': None, 'VkDescriptorSetLayoutBinding': None, 'VkShaderStageFlagBits': None, 'VkPushConstantRange': None}
mapDict['VkSharingMode'] =  {'VkImageCreateInfo': None, 'VkBufferCreateInfo': None}
...
mapDict['VkSparseImageMemoryBind'] =  {'VkImageSubresource': None, 'VkSparseImageMemoryBindInfo': None, 'VkExtent3D': None, 'VkSparseMemoryBindFlags': None, 'VkOffset3D': None, 'VkDeviceSize': None, 'VkDeviceMemory': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkSparseBufferMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkDeviceSize': None, 'VkDeviceMemory': None}
...
mapDict['VkStencilFaceFlags'] =  {'vkCmdSetStencilReference': None, 'VkStencilFaceFlagBits': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdSetStencilWriteMask': None}
...
mapDict['VkStructureType'] =  {'VkPipelineShaderStageCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkMemoryBarrier': None, 'VkCommandBufferBeginInfo': None, 'VkRenderPassBeginInfo': None, 'VkBufferCreateInfo': None, 'VkApplicationInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkFenceCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkDisplaySurfaceCreateInfoKHR': None, 'VkShaderModuleCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkDisplayModeCreateInfoKHR': None, 'VkCommandBufferInheritanceInfo': None, 'VkCopyDescriptorSet': None, 'VkImageMemoryBarrier': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkMappedMemoryRange': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkBindSparseInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkEventCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkSubmitInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkWriteDescriptorSet': None, 'VkImageCreateInfo': None}
mapDict['VkSubmitInfo'] =  {'vkQueueSubmit': None, 'VkCommandBuffer': None, 'VkSemaphore': None, 'VkStructureType': None, 'VkPipelineStageFlags': None}
...
mapDict['VkSubpassDescription'] =  {'VkPipelineBindPoint': None, 'VkRenderPassCreateInfo': None, 'VkAttachmentReference': None, 'VkSubpassDescriptionFlags': None}
...
mapDict['VkSurfaceTransformFlagBitsKHR'] =  {'VkDisplaySurfaceCreateInfoKHR': None, 'VkSurfaceTransformFlagsKHR': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkStructureType': None, 'VkDescriptorBufferInfo': None, 'VkDescriptorSet': None, 'vkUpdateDescriptorSets': None, 'VkDescriptorImageInfo': None, 'VkDescriptorType': None, 'VkBufferView': None}
...
mapDict['vkAllocateMemory'] =  {'VkAllocationCallbacks': None, 'VkMemoryAllocateInfo': None, 'VkDeviceMemory': None, 'VkDevice': None}
...
mapDict['vkCmdBlitImage'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkFilter': None, 'VkImageBlit': None, 'VkImageLayout': None}
mapDict['vkCmdClearAttachments'] =  {'VkClearAttachment': None, 'VkCommandBuffer': None, 'VkClearRect': None}
mapDict['vkCmdClearColorImage'] =  {'VkClearColorValue': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageSubresourceRange': None, 'VkImageLayout': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkClearDepthStencilValue': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageSubresourceRange': None, 'VkImageLayout': None}
mapDict['vkCmdCopyBuffer'] =  {'VkCommandBuffer': None, 'VkBuffer': None, 'VkBufferCopy': None}
mapDict['vkCmdCopyBufferToImage'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkBuffer': None, 'VkBufferImageCopy': None, 'VkImageLayout': None}
mapDict['vkCmdCopyImage'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkImageCopy': None, 'VkImageLayout': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkBuffer': None, 'VkBufferImageCopy': None, 'VkImageLayout': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkQueryResultFlags': None, 'VkCommandBuffer': None, 'VkQueryPool': None, 'VkBuffer': None, 'VkDeviceSize': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkBufferMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkDependencyFlags': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkMemoryBarrier': None, 'VkEvent': None, 'VkCommandBuffer': None}
mapDict['vkCmdWriteTimestamp'] =  {'VkCommandBuffer': None, 'VkQueryPool': None, 'VkPipelineStageFlagBits': None}
mapDict['vkCreateBuffer'] =  {'VkAllocationCallbacks': None, 'VkBufferCreateInfo': None, 'VkDevice': None, 'VkBuffer': None}
...
mapDict['vkCreateComputePipelines'] =  {'VkComputePipelineCreateInfo': None, 'VkAllocationCallbacks': None, 'VkPipelineCache': None, 'VkPipeline': None, 'VkDevice': None}
...
mapDict['vkCreateDescriptorSetLayout'] =  {'VkAllocationCallbacks': None, 'VkDescriptorSetLayout': None, 'VkDevice': None, 'VkDescriptorSetLayoutCreateInfo': None}
mapDict['vkCreateDevice'] =  {'VkAllocationCallbacks': None, 'VkPhysicalDevice': None, 'VkDeviceCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateDisplayModeKHR'] =  {'VkDisplayModeCreateInfoKHR': None, 'VkDisplayKHR': None, 'VkPhysicalDevice': None, 'VkAllocationCallbacks': None, 'VkDisplayModeKHR': None}
mapDict['vkCreateDisplayPlaneSurfaceKHR'] =  {'VkDisplaySurfaceCreateInfoKHR': None, 'VkInstance': None, 'VkAllocationCallbacks': None, 'VkSurfaceKHR': None}
mapDict['vkCreateEvent'] =  {'VkEvent': None, 'VkEventCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateFence'] =  {'VkFence': None, 'VkAllocationCallbacks': None, 'VkFenceCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateFramebuffer'] =  {'VkAllocationCallbacks': None, 'VkFramebuffer': None, 'VkDevice': None, 'VkFramebufferCreateInfo': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkPipelineCache': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipeline': None}
mapDict['vkCreateImage'] =  {'VkImage': None, 'VkAllocationCallbacks': None, 'VkImageCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateImageView'] =  {'VkImageViewCreateInfo': None, 'VkAllocationCallbacks': None, 'VkImageView': None, 'VkDevice': None}
...
mapDict['vkCreateQueryPool'] =  {'VkAllocationCallbacks': None, 'VkQueryPool': None, 'VkQueryPoolCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateRenderPass'] =  {'VkAllocationCallbacks': None, 'VkRenderPassCreateInfo': None, 'VkRenderPass': None, 'VkDevice': None}
mapDict['vkCreateSampler'] =  {'VkAllocationCallbacks': None, 'VkSamplerCreateInfo': None, 'VkDevice': None, 'VkSampler': None}
mapDict['vkCreateSemaphore'] =  {'VkAllocationCallbacks': None, 'VkSemaphore': None, 'VkSemaphoreCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateShaderModule'] =  {'VkAllocationCallbacks': None, 'VkShaderModuleCreateInfo': None, 'VkShaderModule': None, 'VkDevice': None}
...
mapDict['vkDestroyDescriptorPool'] =  {'VkAllocationCallbacks': None, 'VkDescriptorPool': None, 'VkDevice': None}
mapDict['vkDestroyDescriptorSetLayout'] =  {'VkAllocationCallbacks': None, 'VkDescriptorSetLayout': None, 'VkDevice': None}
...
mapDict['vkDestroyImageView'] =  {'VkAllocationCallbacks': None, 'VkImageView': None, 'VkDevice': None}
mapDict['vkDestroyInstance'] =  {'VkInstance': None, 'VkAllocationCallbacks': None}
mapDict['vkDestroyPipeline'] =  {'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkDevice': None}
...
mapDict['vkFreeDescriptorSets'] =  {'VkDescriptorSet': None, 'VkDescriptorPool': None, 'VkDevice': None}
...
mapDict['vkGetDisplayModePropertiesKHR'] =  {'VkDisplayKHR': None, 'VkPhysicalDevice': None, 'VkDisplayModePropertiesKHR': None}
mapDict['vkGetDisplayPlaneCapabilitiesKHR'] =  {'VkDisplayPlaneCapabilitiesKHR': None, 'VkPhysicalDevice': None, 'VkDisplayModeKHR': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkImage': None, 'VkImageSubresource': None, 'VkSubresourceLayout': None, 'VkDevice': None}
...
mapDict['vkGetPhysicalDeviceFormatProperties'] =  {'VkFormatProperties': None, 'VkPhysicalDevice': None, 'VkFormat': None}
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageFormatProperties': None, 'VkPhysicalDevice': None, 'VkImageTiling': None, 'VkFormat': None, 'VkImageUsageFlags': None, 'VkImageCreateFlags': None, 'VkImageType': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkSampleCountFlagBits': None, 'VkImageTiling': None, 'VkFormat': None, 'VkImageUsageFlags': None, 'VkPhysicalDevice': None, 'VkSparseImageFormatProperties': None, 'VkImageType': None}
mapDict['vkGetPipelineCacheData'] =  {'VkPipelineCache': None, 'VkDevice': None}
mapDict['vkGetQueryPoolResults'] =  {'VkQueryResultFlags': None, 'VkQueryPool': None, 'VkDeviceSize': None, 'VkDevice': None}
...
mapDict['vkQueueBindSparse'] =  {'VkFence': None, 'VkBindSparseInfo': None, 'VkQueue': None}
mapDict['vkQueueSubmit'] =  {'VkSubmitInfo': None, 'VkFence': None, 'VkQueue': None}
