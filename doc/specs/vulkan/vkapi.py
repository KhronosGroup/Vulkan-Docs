...
mapDict['VkAllocationCallbacks'] =  {'vkDestroyInstance': None, 'PFN_vkInternalAllocationNotification': None, 'vkDestroyBuffer': None, 'vkCreateFence': None, 'vkFreeMemory': None, 'vkDestroyImageView': None, 'vkCreateQueryPool': None, 'vkCreateMirSurfaceKHR': None, 'vkDestroyRenderPass': None, 'vkDestroyDescriptorPool': None, 'PFN_vkFreeFunction': None, 'vkDestroyQueryPool': None, 'vkDestroySemaphore': None, 'vkCreateSemaphore': None, 'vkCreatePipelineLayout': None, 'vkDestroyShaderModule': None, 'PFN_vkInternalFreeNotification': None, 'vkDestroyFramebuffer': None, 'vkDestroyBufferView': None, 'vkCreateInstance': None, 'vkCreateBufferView': None, 'vkDestroySampler': None, 'vkDestroyPipeline': None, 'vkCreateSampler': None, 'vkDestroyFence': None, 'vkDestroyEvent': None, 'vkCreateFramebuffer': None, 'vkDestroyPipelineCache': None, 'vkCreateImage': None, 'vkCreateDescriptorPool': None, 'vkAllocateMemory': None, 'vkDestroyPipelineLayout': None, 'vkCreateGraphicsPipelines': None, 'vkCreatePipelineCache': None, 'PFN_vkAllocationFunction': None, 'vkCreateRenderPass': None, 'vkDestroyCommandPool': None, 'vkCreateEvent': None, 'vkDestroyDevice': None, 'vkCreateBuffer': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateComputePipelines': None, 'vkCreateCommandPool': None, 'vkDestroyImage': None, 'vkCreateImageView': None, 'PFN_vkReallocationFunction': None, 'vkCreateShaderModule': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateDevice': None}
mapDict['VkApplicationInfo'] =  {'VkStructureType': None, 'VkInstanceCreateInfo': None}
mapDict['VkAttachmentDescription'] =  {'VkImageLayout': None, 'VkFormat': None, 'VkAttachmentDescriptionFlags': None, 'VkAttachmentLoadOp': None, 'VkRenderPassCreateInfo': None, 'VkSampleCountFlagBits': None, 'VkAttachmentStoreOp': None}
...
mapDict['VkBindSparseInfo'] =  {'VkStructureType': None, 'VkSemaphore': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'vkQueueBindSparse': None, 'VkSparseImageMemoryBindInfo': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineInputAssemblyStateCreateInfo': None, 'vkWaitForFences': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkCommandBufferInheritanceInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPhysicalDeviceLimits': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdFillBuffer': None, 'vkCmdBindIndexBuffer': None, 'VkBufferMemoryBarrier': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdCopyBuffer': None, 'vkDestroyBuffer': None, 'VkBufferViewCreateInfo': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdDrawIndirect': None, 'vkCmdDrawIndexedIndirect': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdDispatchIndirect': None, 'vkCreateBuffer': None, 'vkGetBufferMemoryRequirements': None, 'vkBindBufferMemory': None, 'vkCmdUpdateBuffer': None, 'VkDescriptorBufferInfo': None, 'vkCmdBindVertexBuffers': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkStructureType': None, 'VkBufferUsageFlags': None, 'VkBufferCreateFlags': None, 'VkSharingMode': None, 'VkDeviceSize': None, 'vkCreateBuffer': None}
mapDict['VkBufferImageCopy'] =  {'VkImageSubresourceLayers': None, 'vkCmdCopyBufferToImage': None, 'VkOffset3D': None, 'VkDeviceSize': None, 'vkCmdCopyImageToBuffer': None, 'VkExtent3D': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkStructureType': None, 'vkCmdWaitEvents': None, 'VkAccessFlags': None, 'vkCmdPipelineBarrier': None, 'VkDeviceSize': None, 'VkBuffer': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkStructureType': None, 'VkBuffer': None, 'VkFormat': None, 'vkCreateBufferView': None, 'VkDeviceSize': None, 'VkBufferViewCreateFlags': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdDrawIndexed': None, 'vkCmdCopyBuffer': None, 'vkCmdDispatchIndirect': None, 'vkCmdDrawIndirect': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdClearColorImage': None, 'vkCmdEndQuery': None, 'vkEndCommandBuffer': None, 'vkCmdNextSubpass': None, 'vkCmdClearAttachments': None, 'vkCmdSetBlendConstants': None, 'vkCmdFillBuffer': None, 'vkCmdSetDepthBounds': None, 'vkCmdSetStencilReference': None, 'vkCmdBeginQuery': None, 'vkResetCommandBuffer': None, 'vkCmdCopyImage': None, 'vkCmdSetDepthBias': None, 'vkFreeCommandBuffers': None, 'vkCmdSetScissor': None, 'vkCmdResolveImage': None, 'vkCmdWriteTimestamp': None, 'vkCmdBindDescriptorSets': None, 'vkCmdCopyBufferToImage': None, 'vkCmdEndRenderPass': None, 'vkCmdBindPipeline': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdSetEvent': None, 'vkCmdBlitImage': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdSetViewport': None, 'vkCmdPushConstants': None, 'vkCmdDraw': None, 'VkSubmitInfo': None, 'vkCmdExecuteCommands': None, 'vkCmdWaitEvents': None, 'vkCmdBindIndexBuffer': None, 'vkCmdBeginRenderPass': None, 'vkCmdUpdateBuffer': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdResetQueryPool': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdDispatch': None, 'vkCmdResetEvent': None, 'vkCmdPipelineBarrier': None, 'vkCmdBindVertexBuffers': None, 'vkAllocateCommandBuffers': None, 'vkCmdSetLineWidth': None, 'vkBeginCommandBuffer': None, 'vkCmdClearDepthStencilImage': None}
...
mapDict['VkCommandBufferBeginInfo'] =  {'VkStructureType': None, 'VkCommandBufferInheritanceInfo': None, 'vkBeginCommandBuffer': None, 'VkCommandBufferUsageFlags': None}
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkStructureType': None, 'VkRenderPass': None, 'VkBool32': None, 'VkCommandBufferBeginInfo': None, 'VkQueryPipelineStatisticFlags': None, 'VkFramebuffer': None, 'VkQueryControlFlags': None}
...
mapDict['VkCommandPool'] =  {'vkCreateCommandPool': None, 'vkResetCommandPool': None, 'vkDestroyCommandPool': None, 'VkCommandBufferAllocateInfo': None, 'vkFreeCommandBuffers': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkStructureType': None, 'VkPipelineShaderStageCreateInfo': None, 'vkCreateComputePipelines': None, 'VkPipeline': None, 'VkPipelineLayout': None, 'VkPipelineCreateFlags': None}
mapDict['VkCopyDescriptorSet'] =  {'VkStructureType': None, 'vkUpdateDescriptorSets': None, 'VkDescriptorSet': None}
...
mapDict['VkDescriptorPool'] =  {'vkDestroyDescriptorPool': None, 'VkDescriptorSetAllocateInfo': None, 'vkFreeDescriptorSets': None, 'vkResetDescriptorPool': None, 'vkCreateDescriptorPool': None}
...
mapDict['VkDescriptorSet'] =  {'VkWriteDescriptorSet': None, 'VkCopyDescriptorSet': None, 'vkFreeDescriptorSets': None, 'vkAllocateDescriptorSets': None, 'vkCmdBindDescriptorSets': None}
...
mapDict['VkDevice'] =  {'vkCreatePipelineLayout': None, 'vkDestroyDescriptorPool': None, 'vkGetDeviceQueue': None, 'vkDestroyRenderPass': None, 'vkGetImageSubresourceLayout': None, 'vkCreateFence': None, 'vkFreeMemory': None, 'vkDestroyImageView': None, 'vkCreateQueryPool': None, 'vkDestroyPipelineLayout': None, 'vkFlushMappedMemoryRanges': None, 'vkBindImageMemory': None, 'vkSetEvent': None, 'vkAllocateCommandBuffers': None, 'vkUnmapMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkWaitForFences': None, 'vkDestroySemaphore': None, 'vkCreateSemaphore': None, 'vkDeviceWaitIdle': None, 'vkDestroyEvent': None, 'vkDestroyShaderModule': None, 'vkDestroyFramebuffer': None, 'vkDestroyBufferView': None, 'vkMapMemory': None, 'vkGetQueryPoolResults': None, 'vkDestroyBuffer': None, 'vkFreeCommandBuffers': None, 'vkCreateBufferView': None, 'vkCreateRenderPass': None, 'vkAllocateDescriptorSets': None, 'vkResetEvent': None, 'vkDestroySampler': None, 'vkDestroyPipeline': None, 'vkCreateSampler': None, 'vkGetFenceStatus': None, 'vkGetRenderAreaGranularity': None, 'vkCreateFramebuffer': None, 'vkDestroyPipelineCache': None, 'vkResetFences': None, 'vkGetImageSparseMemoryRequirements': None, 'vkMergePipelineCaches': None, 'vkCreateImage': None, 'vkCreateDescriptorSetLayout': None, 'vkAllocateMemory': None, 'vkDestroyQueryPool': None, 'vkCreateGraphicsPipelines': None, 'vkDestroyDescriptorSetLayout': None, 'vkResetDescriptorPool': None, 'vkCreatePipelineCache': None, 'vkGetImageMemoryRequirements': None, 'vkGetBufferMemoryRequirements': None, 'vkBindBufferMemory': None, 'vkDestroyCommandPool': None, 'vkCreateEvent': None, 'vkUpdateDescriptorSets': None, 'vkDestroyDevice': None, 'vkCreateBuffer': None, 'vkDestroyFence': None, 'vkCreateComputePipelines': None, 'vkGetPipelineCacheData': None, 'vkCreateCommandPool': None, 'vkDestroyImage': None, 'vkGetEventStatus': None, 'vkCreateDescriptorPool': None, 'vkCreateImageView': None, 'vkCreateShaderModule': None, 'vkInvalidateMappedMemoryRanges': None, 'vkFreeDescriptorSets': None, 'vkResetCommandPool': None, 'vkCreateDevice': None, 'vkGetDeviceProcAddr': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkStructureType': None, 'vkCreateDevice': None, 'VkDeviceCreateFlags': None, 'VkPhysicalDeviceFeatures': None, 'VkDeviceQueueCreateInfo': None}
mapDict['VkDeviceMemory'] =  {'vkGetDeviceMemoryCommitment': None, 'vkBindBufferMemory': None, 'vkBindImageMemory': None, 'VkSparseMemoryBind': None, 'vkAllocateMemory': None, 'VkSparseImageMemoryBind': None, 'vkFreeMemory': None, 'VkMappedMemoryRange': None, 'vkUnmapMemory': None, 'vkMapMemory': None}
...
mapDict['VkDeviceSize'] =  {'VkBufferImageCopy': None, 'vkBindImageMemory': None, 'VkImageFormatProperties': None, 'vkCmdDispatchIndirect': None, 'VkBufferViewCreateInfo': None, 'vkCmdDrawIndirect': None, 'vkCmdDrawIndexedIndirect': None, 'VkSparseImageMemoryRequirements': None, 'VkMemoryHeap': None, 'VkBufferCopy': None, 'VkMemoryRequirements': None, 'VkMemoryAllocateInfo': None, 'vkBindBufferMemory': None, 'vkGetDeviceMemoryCommitment': None, 'VkBufferCreateInfo': None, 'vkCmdFillBuffer': None, 'vkCmdBindIndexBuffer': None, 'VkSparseMemoryBind': None, 'VkSubresourceLayout': None, 'VkBufferMemoryBarrier': None, 'vkCmdCopyQueryPoolResults': None, 'vkMapMemory': None, 'vkGetQueryPoolResults': None, 'VkSparseImageMemoryBind': None, 'VkPhysicalDeviceLimits': None, 'VkMappedMemoryRange': None, 'vkCmdUpdateBuffer': None, 'VkDescriptorBufferInfo': None, 'vkCmdBindVertexBuffers': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkCmdWaitEvents': None, 'vkCmdSetEvent': None, 'vkCreateEvent': None, 'vkResetEvent': None, 'vkCmdResetEvent': None, 'vkSetEvent': None, 'vkDestroyEvent': None, 'vkGetEventStatus': None}
...
mapDict['VkExtent3D'] =  {'VkImageCopy': None, 'VkBufferImageCopy': None, 'VkImageCreateInfo': None, 'VkSparseImageMemoryBind': None, 'VkSparseImageFormatProperties': None, 'VkQueueFamilyProperties': None, 'VkImageResolve': None, 'VkImageFormatProperties': None}
mapDict['VkFence'] =  {'vkWaitForFences': None, 'vkGetFenceStatus': None, 'vkResetFences': None, 'vkQueueBindSparse': None, 'vkDestroyFence': None, 'vkCreateFence': None, 'vkQueueSubmit': None}
...
mapDict['VkFormat'] =  {'VkVertexInputAttributeDescription': None, 'VkAttachmentDescription': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageViewCreateInfo': None, 'VkImageCreateInfo': None, 'VkBufferViewCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceFormatProperties': None}
...
mapDict['VkFramebufferCreateInfo'] =  {'VkStructureType': None, 'VkRenderPass': None, 'vkCreateFramebuffer': None, 'VkFramebufferCreateFlags': None, 'VkImageView': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkRenderPass': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkStructureType': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipeline': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineLayout': None, 'VkPipelineCreateFlags': None}
mapDict['VkImage'] =  {'vkCmdResolveImage': None, 'vkCmdCopyBufferToImage': None, 'vkGetImageSubresourceLayout': None, 'vkDestroyImage': None, 'vkCreateImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdClearColorImage': None, 'vkCmdCopyImage': None, 'vkGetImageSparseMemoryRequirements': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkCmdBlitImage': None, 'VkSparseImageMemoryBindInfo': None, 'vkBindImageMemory': None, 'VkImageViewCreateInfo': None, 'vkGetImageMemoryRequirements': None, 'VkImageMemoryBarrier': None, 'vkCmdClearDepthStencilImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkImageAspectFlagBits': None, 'VkImageSubresourceLayers': None, 'VkSparseImageFormatProperties': None, 'VkImageSubresource': None, 'VkClearAttachment': None, 'VkImageSubresourceRange': None}
mapDict['VkImageBlit'] =  {'VkOffset3D': None, 'vkCmdBlitImage': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageCopy'] =  {'VkOffset3D': None, 'VkImageSubresourceLayers': None, 'vkCmdCopyImage': None, 'VkExtent3D': None}
...
mapDict['VkImageCreateInfo'] =  {'VkStructureType': None, 'VkImageType': None, 'VkFormat': None, 'VkImageLayout': None, 'VkSharingMode': None, 'VkImageUsageFlags': None, 'vkCreateImage': None, 'VkImageTiling': None, 'VkExtent3D': None, 'VkSampleCountFlagBits': None, 'VkImageCreateFlags': None}
mapDict['VkImageFormatProperties'] =  {'VkDeviceSize': None, 'VkSampleCountFlags': None, 'VkExtent3D': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
mapDict['VkImageLayout'] =  {'vkCmdResolveImage': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdClearColorImage': None, 'VkDescriptorImageInfo': None, 'VkAttachmentDescription': None, 'vkCmdBlitImage': None, 'VkAttachmentReference': None, 'VkImageCreateInfo': None, 'vkCmdCopyImage': None, 'VkImageMemoryBarrier': None, 'vkCmdClearDepthStencilImage': None}
mapDict['VkImageMemoryBarrier'] =  {'VkStructureType': None, 'vkCmdWaitEvents': None, 'VkAccessFlags': None, 'vkCmdPipelineBarrier': None, 'VkImageLayout': None, 'VkImage': None, 'VkImageSubresourceRange': None}
...
mapDict['VkImageSubresourceLayers'] =  {'VkImageAspectFlags': None, 'VkImageCopy': None, 'VkBufferImageCopy': None, 'VkImageResolve': None, 'VkImageBlit': None}
...
mapDict['VkImageView'] =  {'vkDestroyImageView': None, 'vkCreateImageView': None, 'VkDescriptorImageInfo': None, 'VkFramebufferCreateInfo': None}
mapDict['VkImageViewCreateFlags'] =  {'VkImageViewCreateInfo': None}
mapDict['VkImageViewCreateInfo'] =  {'VkStructureType': None, 'VkImageViewType': None, 'VkFormat': None, 'VkImageViewCreateFlags': None, 'VkComponentMapping': None, 'VkImage': None, 'vkCreateImageView': None, 'VkImageSubresourceRange': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkDestroyInstance': None, 'vkGetInstanceProcAddr': None, 'vkEnumeratePhysicalDevices': None, 'vkCreateMirSurfaceKHR': None, 'vkCreateInstance': None}
...
mapDict['VkMemoryBarrier'] =  {'VkStructureType': None, 'vkCmdWaitEvents': None, 'VkAccessFlags': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkMirSurfaceCreateInfoKHR'] =  {'VkStructureType': None, 'vkCreateMirSurfaceKHR': None, 'VkMirSurfaceCreateFlagsKHR': None}
mapDict['VkOffset2D'] =  {'VkRect2D': None}
mapDict['VkOffset3D'] =  {'VkImageCopy': None, 'VkImageBlit': None, 'VkBufferImageCopy': None, 'VkImageResolve': None, 'VkSparseImageMemoryBind': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkCreateDevice': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetPhysicalDeviceMirPresentationSupportKHR': None, 'vkGetPhysicalDeviceFeatures': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkGetPhysicalDeviceProperties': None}
...
mapDict['VkPipeline'] =  {'VkComputePipelineCreateInfo': None, 'vkCmdBindPipeline': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCreateComputePipelines': None, 'vkDestroyPipeline': None, 'vkCreateGraphicsPipelines': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindDescriptorSets': None, 'vkCmdBindPipeline': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkGetPipelineCacheData': None, 'vkCreatePipelineCache': None, 'vkCreateComputePipelines': None, 'vkDestroyPipelineCache': None, 'vkMergePipelineCaches': None, 'vkCreateGraphicsPipelines': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBool32': None, 'VkBlendOp': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkBlendFactor': None, 'VkColorComponentFlags': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkStructureType': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPipelineColorBlendStateCreateFlags': None, 'VkLogicOp': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkStructureType': None, 'VkBool32': None, 'VkCompareOp': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkStencilOpState': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkStructureType': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineInputAssemblyStateCreateFlags': None, 'VkPrimitiveTopology': None}
mapDict['VkPipelineLayout'] =  {'vkCmdBindDescriptorSets': None, 'VkComputePipelineCreateInfo': None, 'vkDestroyPipelineLayout': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCreatePipelineLayout': None, 'vkCmdPushConstants': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkStructureType': None, 'vkCreatePipelineLayout': None, 'VkDescriptorSetLayout': None, 'VkPipelineLayoutCreateFlags': None, 'VkPushConstantRange': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkStructureType': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkSampleMask': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkSampleCountFlagBits': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkStructureType': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkPolygonMode': None, 'VkCullModeFlags': None, 'VkFrontFace': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkStructureType': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkShaderStageFlagBits': None, 'VkSpecializationInfo': None, 'VkPipelineShaderStageCreateFlags': None, 'VkShaderModule': None}
mapDict['VkPipelineStageFlagBits'] =  {'vkCmdWriteTimestamp': None, 'VkPipelineStageFlags': None}
mapDict['VkPipelineStageFlags'] =  {'vkCmdWaitEvents': None, 'vkCmdSetEvent': None, 'vkCmdPipelineBarrier': None, 'vkCmdResetEvent': None, 'VkPipelineStageFlagBits': None, 'VkSubmitInfo': None, 'VkSubpassDependency': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkStructureType': None, 'VkVertexInputBindingDescription': None, 'VkPipelineVertexInputStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkVertexInputAttributeDescription': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkStructureType': None, 'VkPipelineViewportStateCreateFlags': None, 'VkRect2D': None, 'VkGraphicsPipelineCreateInfo': None, 'VkViewport': None}
...
mapDict['VkQueryPool'] =  {'vkGetQueryPoolResults': None, 'vkCmdEndQuery': None, 'vkDestroyQueryPool': None, 'vkCmdBeginQuery': None, 'vkCmdWriteTimestamp': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdResetQueryPool': None, 'vkCreateQueryPool': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkStructureType': None, 'VkQueryType': None, 'VkQueryPipelineStatisticFlags': None, 'VkQueryPoolCreateFlags': None, 'vkCreateQueryPool': None}
...
mapDict['VkQueue'] =  {'vkQueueBindSparse': None, 'vkQueueWaitIdle': None, 'vkGetDeviceQueue': None, 'vkQueueSubmit': None}
...
mapDict['VkRect2D'] =  {'VkPipelineViewportStateCreateInfo': None, 'VkExtent2D': None, 'VkClearRect': None, 'VkOffset2D': None, 'VkRenderPassBeginInfo': None, 'vkCmdSetScissor': None}
mapDict['VkRenderPass'] =  {'VkGraphicsPipelineCreateInfo': None, 'vkDestroyRenderPass': None, 'vkGetRenderAreaGranularity': None, 'VkFramebufferCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkCreateRenderPass': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkStructureType': None, 'VkRenderPass': None, 'VkRect2D': None, 'vkCmdBeginRenderPass': None, 'VkClearValue': None, 'VkFramebuffer': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkStructureType': None, 'VkAttachmentDescription': None, 'VkRenderPassCreateFlags': None, 'vkCreateRenderPass': None, 'VkSubpassDescription': None, 'VkSubpassDependency': None}
mapDict['VkSampleCountFlagBits'] =  {'VkAttachmentDescription': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSampleCountFlags': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkImageCreateInfo': None}
...
mapDict['VkSamplerCreateInfo'] =  {'VkStructureType': None, 'VkSamplerAddressMode': None, 'VkBorderColor': None, 'VkBool32': None, 'VkSamplerMipmapMode': None, 'VkCompareOp': None, 'VkFilter': None, 'VkSamplerCreateFlags': None, 'vkCreateSampler': None}
mapDict['VkSamplerMipmapMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSemaphore'] =  {'VkBindSparseInfo': None, 'vkCreateSemaphore': None, 'VkSubmitInfo': None, 'vkDestroySemaphore': None}
...
mapDict['VkShaderStageFlags'] =  {'VkDescriptorSetLayoutBinding': None, 'VkPushConstantRange': None, 'vkCmdPushConstants': None, 'VkShaderStageFlagBits': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'VkImageAspectFlags': None, 'VkSparseImageMemoryRequirements': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageFormatFlags': None, 'VkExtent3D': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkSparseMemoryBindFlags': None, 'VkOffset3D': None, 'VkImageSubresource': None, 'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkSparseImageMemoryBindInfo': None, 'VkExtent3D': None}
...
mapDict['VkStructureType'] =  {'VkPipelineShaderStageCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkBindSparseInfo': None, 'VkMemoryAllocateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkBufferCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkMemoryBarrier': None, 'VkRenderPassCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkCommandBufferBeginInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkImageCreateInfo': None, 'VkMappedMemoryRange': None, 'VkInstanceCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkApplicationInfo': None, 'VkFenceCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkWriteDescriptorSet': None, 'VkShaderModuleCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkSubmitInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkEventCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkSamplerCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkMirSurfaceCreateInfoKHR': None}
mapDict['VkSubmitInfo'] =  {'VkStructureType': None, 'VkSemaphore': None, 'VkCommandBuffer': None, 'vkQueueSubmit': None, 'VkPipelineStageFlags': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkStructureType': None, 'VkDescriptorType': None, 'VkDescriptorImageInfo': None, 'VkDescriptorSet': None, 'VkBufferView': None, 'VkDescriptorBufferInfo': None, 'vkUpdateDescriptorSets': None}
...
mapDict['vkBindBufferMemory'] =  {'VkDevice': None, 'VkBuffer': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
...
mapDict['vkCmdBindDescriptorSets'] =  {'VkPipelineLayout': None, 'VkCommandBuffer': None, 'VkPipelineBindPoint': None, 'VkDescriptorSet': None}
mapDict['vkCmdBindIndexBuffer'] =  {'VkDeviceSize': None, 'VkCommandBuffer': None, 'VkBuffer': None, 'VkIndexType': None}
...
mapDict['vkCmdBlitImage'] =  {'VkImageBlit': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkFilter': None, 'VkImageLayout': None}
mapDict['vkCmdClearAttachments'] =  {'VkCommandBuffer': None, 'VkClearAttachment': None, 'VkClearRect': None}
mapDict['vkCmdClearColorImage'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkClearColorValue': None, 'VkImageLayout': None, 'VkImageSubresourceRange': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImageSubresourceRange': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None, 'VkClearDepthStencilValue': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkCommandBuffer': None, 'VkDependencyFlags': None, 'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkPipelineStageFlags': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkEvent': None, 'VkCommandBuffer': None, 'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkPipelineStageFlags': None}
...
mapDict['vkCreateCommandPool'] =  {'VkDevice': None, 'VkCommandPool': None, 'VkCommandPoolCreateInfo': None, 'VkAllocationCallbacks': None}
...
mapDict['vkCreateFence'] =  {'VkFenceCreateInfo': None, 'VkDevice': None, 'VkFence': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateFramebuffer'] =  {'VkFramebufferCreateInfo': None, 'VkDevice': None, 'VkFramebuffer': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkPipelineCache': None, 'VkDevice': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipeline': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateImage'] =  {'VkDevice': None, 'VkAllocationCallbacks': None, 'VkImage': None, 'VkImageCreateInfo': None}
mapDict['vkCreateImageView'] =  {'VkImageView': None, 'VkDevice': None, 'VkImageViewCreateInfo': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateInstance'] =  {'VkInstance': None, 'VkInstanceCreateInfo': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateMirSurfaceKHR'] =  {'VkSurfaceKHR': None, 'VkInstance': None, 'VkAllocationCallbacks': None, 'VkMirSurfaceCreateInfoKHR': None}
...
mapDict['vkCreateShaderModule'] =  {'VkShaderModuleCreateInfo': None, 'VkDevice': None, 'VkShaderModule': None, 'VkAllocationCallbacks': None}
...
mapDict['vkGetDeviceMemoryCommitment'] =  {'VkDevice': None, 'VkDeviceSize': None, 'VkDeviceMemory': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkImageSubresource': None, 'VkDevice': None, 'VkImage': None, 'VkSubresourceLayout': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageFormatProperties': None, 'VkImageType': None, 'VkImageUsageFlags': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkImageTiling': None, 'VkImageCreateFlags': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageType': None, 'VkImageUsageFlags': None, 'VkSparseImageFormatProperties': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkImageTiling': None, 'VkSampleCountFlagBits': None}
...
mapDict['vkMapMemory'] =  {'VkMemoryMapFlags': None, 'VkDevice': None, 'VkDeviceSize': None, 'VkDeviceMemory': None}
