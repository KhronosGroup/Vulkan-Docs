...
mapDict['VkAccessFlags'] =  {'VkImageMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkAccessFlagBits': None, 'VkBufferMemoryBarrier': None, 'VkSubpassDependency': None}
mapDict['VkAllocationCallbacks'] =  {'vkCreateFramebuffer': None, 'vkDestroyEvent': None, 'vkDestroySemaphore': None, 'vkCreateImageView': None, 'vkCreateQueryPool': None, 'vkDestroyRenderPass': None, 'vkCreateInstance': None, 'vkDestroyCommandPool': None, 'vkCreateBuffer': None, 'vkCreateGraphicsPipelines': None, 'vkCreatePipelineLayout': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyQueryPool': None, 'vkCreateCommandPool': None, 'PFN_vkInternalFreeNotification': None, 'PFN_vkAllocationFunction': None, 'PFN_vkInternalAllocationNotification': None, 'vkCreateEvent': None, 'vkCreateRenderPass': None, 'vkDestroyPipelineLayout': None, 'vkDestroyPipeline': None, 'vkFreeMemory': None, 'vkCreateDevice': None, 'vkDestroyInstance': None, 'vkDestroyBufferView': None, 'vkCreateShaderModule': None, 'vkDestroyImage': None, 'vkCreateFence': None, 'vkCreateXlibSurfaceKHR': None, 'vkDestroyDescriptorPool': None, 'vkCreatePipelineCache': None, 'vkCreateComputePipelines': None, 'vkDestroyPipelineCache': None, 'vkCreateSampler': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateSemaphore': None, 'PFN_vkFreeFunction': None, 'vkCreateDescriptorPool': None, 'vkDestroyDevice': None, 'vkCreateBufferView': None, 'vkDestroyShaderModule': None, 'vkDestroySampler': None, 'vkDestroyImageView': None, 'PFN_vkReallocationFunction': None, 'vkDestroyFence': None, 'vkAllocateMemory': None, 'vkCreateImage': None, 'vkDestroyBuffer': None, 'vkDestroyFramebuffer': None}
mapDict['VkApplicationInfo'] =  {'VkStructureType': None, 'VkInstanceCreateInfo': None}
mapDict['VkAttachmentDescription'] =  {'VkAttachmentStoreOp': None, 'VkAttachmentLoadOp': None, 'VkSampleCountFlagBits': None, 'VkImageLayout': None, 'VkRenderPassCreateInfo': None, 'VkFormat': None, 'VkAttachmentDescriptionFlags': None}
...
mapDict['VkBindSparseInfo'] =  {'VkSemaphore': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkStructureType': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'vkQueueBindSparse': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'vkWaitForFences': None, 'VkSamplerCreateInfo': None, 'VkPhysicalDeviceLimits': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPhysicalDeviceFeatures': None, 'VkPipelineDepthStencilStateCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkBindBufferMemory': None, 'vkCmdDrawIndexedIndirect': None, 'VkBufferViewCreateInfo': None, 'vkCmdCopyBufferToImage': None, 'vkCmdDrawIndirect': None, 'vkGetBufferMemoryRequirements': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkDestroyBuffer': None, 'vkCmdUpdateBuffer': None, 'VkDescriptorBufferInfo': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdDispatchIndirect': None, 'vkCmdFillBuffer': None, 'vkCmdCopyBuffer': None, 'VkBufferMemoryBarrier': None, 'vkCreateBuffer': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkDeviceSize': None, 'VkBufferCreateFlags': None, 'VkSharingMode': None, 'VkBufferUsageFlags': None, 'vkCreateBuffer': None, 'VkStructureType': None}
mapDict['VkBufferImageCopy'] =  {'VkDeviceSize': None, 'vkCmdCopyImageToBuffer': None, 'VkExtent3D': None, 'vkCmdCopyBufferToImage': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkBuffer': None, 'VkDeviceSize': None, 'VkStructureType': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None, 'VkAccessFlags': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkBufferViewCreateFlags': None, 'VkBuffer': None, 'VkFormat': None, 'VkStructureType': None, 'VkDeviceSize': None, 'vkCreateBufferView': None}
...
mapDict['VkClearValue'] =  {'VkClearAttachment': None, 'VkClearColorValue': None, 'VkClearDepthStencilValue': None, 'VkRenderPassBeginInfo': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdNextSubpass': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkCmdClearAttachments': None, 'vkAllocateCommandBuffers': None, 'vkCmdResolveImage': None, 'vkCmdDrawIndexed': None, 'VkSubmitInfo': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdBeginRenderPass': None, 'vkCmdCopyBufferToImage': None, 'vkCmdDispatch': None, 'vkCmdResetEvent': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdPipelineBarrier': None, 'vkCmdBindVertexBuffers': None, 'vkCmdWaitEvents': None, 'vkCmdEndQuery': None, 'vkCmdWriteTimestamp': None, 'vkCmdDraw': None, 'vkCmdSetBlendConstants': None, 'vkCmdCopyBuffer': None, 'vkFreeCommandBuffers': None, 'vkCmdResetQueryPool': None, 'vkResetCommandBuffer': None, 'vkCmdSetDepthBounds': None, 'vkCmdDrawIndirect': None, 'vkCmdSetEvent': None, 'vkCmdBindDescriptorSets': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdBlitImage': None, 'vkCmdSetViewport': None, 'vkCmdEndRenderPass': None, 'vkCmdFillBuffer': None, 'vkCmdSetLineWidth': None, 'vkBeginCommandBuffer': None, 'vkCmdCopyImage': None, 'vkCmdSetDepthBias': None, 'vkCmdClearColorImage': None, 'vkCmdSetScissor': None, 'vkCmdUpdateBuffer': None, 'vkCmdDispatchIndirect': None, 'vkCmdCopyQueryPoolResults': None, 'vkEndCommandBuffer': None, 'vkCmdBeginQuery': None, 'vkCmdSetStencilReference': None, 'vkCmdExecuteCommands': None, 'vkCmdBindPipeline': None, 'vkCmdPushConstants': None, 'vkCmdClearDepthStencilImage': None}
...
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkRenderPass': None, 'VkQueryPipelineStatisticFlags': None, 'VkFramebuffer': None, 'VkStructureType': None, 'VkCommandBufferBeginInfo': None, 'VkBool32': None, 'VkQueryControlFlags': None}
...
mapDict['VkCommandPool'] =  {'vkResetCommandPool': None, 'VkCommandBufferAllocateInfo': None, 'vkCreateCommandPool': None, 'vkDestroyCommandPool': None, 'vkFreeCommandBuffers': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipelineLayout': None, 'VkStructureType': None, 'VkPipeline': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineCreateFlags': None, 'vkCreateComputePipelines': None}
...
mapDict['VkDescriptorImageInfo'] =  {'VkWriteDescriptorSet': None, 'VkSampler': None, 'VkImageLayout': None, 'VkImageView': None}
mapDict['VkDescriptorPool'] =  {'vkCreateDescriptorPool': None, 'vkDestroyDescriptorPool': None, 'vkResetDescriptorPool': None, 'vkFreeDescriptorSets': None, 'VkDescriptorSetAllocateInfo': None}
...
mapDict['VkDescriptorSet'] =  {'VkCopyDescriptorSet': None, 'VkWriteDescriptorSet': None, 'vkCmdBindDescriptorSets': None, 'vkFreeDescriptorSets': None, 'vkAllocateDescriptorSets': None}
mapDict['VkDescriptorSetAllocateInfo'] =  {'vkAllocateDescriptorSets': None, 'VkDescriptorSetLayout': None, 'VkStructureType': None, 'VkDescriptorPool': None}
...
mapDict['VkDescriptorSetLayoutBinding'] =  {'VkDescriptorSetLayoutCreateInfo': None, 'VkSampler': None, 'VkShaderStageFlags': None, 'VkDescriptorType': None}
...
mapDict['VkDevice'] =  {'vkCreateFramebuffer': None, 'vkGetImageSparseMemoryRequirements': None, 'vkDestroyEvent': None, 'vkAllocateCommandBuffers': None, 'vkGetDeviceQueue': None, 'vkInvalidateMappedMemoryRanges': None, 'vkBindImageMemory': None, 'vkUpdateDescriptorSets': None, 'vkDestroyDescriptorSetLayout': None, 'vkBindBufferMemory': None, 'vkResetFences': None, 'vkGetDeviceProcAddr': None, 'vkFlushMappedMemoryRanges': None, 'vkSetEvent': None, 'vkDestroyCommandPool': None, 'vkCreateBuffer': None, 'vkCreateGraphicsPipelines': None, 'vkGetRenderAreaGranularity': None, 'vkCreatePipelineLayout': None, 'vkCreateSampler': None, 'vkDestroyQueryPool': None, 'vkDestroyBuffer': None, 'vkGetEventStatus': None, 'vkUnmapMemory': None, 'vkDestroySampler': None, 'vkCreateEvent': None, 'vkCreateRenderPass': None, 'vkDestroyPipelineLayout': None, 'vkResetEvent': None, 'vkDestroyPipeline': None, 'vkMergePipelineCaches': None, 'vkGetQueryPoolResults': None, 'vkCreateCommandPool': None, 'vkCreateDevice': None, 'vkMapMemory': None, 'vkDestroySemaphore': None, 'vkGetImageMemoryRequirements': None, 'vkGetPipelineCacheData': None, 'vkDestroyBufferView': None, 'vkResetDescriptorPool': None, 'vkCreateComputePipelines': None, 'vkDestroyFence': None, 'vkGetFenceStatus': None, 'vkCreateFence': None, 'vkDestroyImage': None, 'vkWaitForFences': None, 'vkDestroyDescriptorPool': None, 'vkCreatePipelineCache': None, 'vkCreateShaderModule': None, 'vkDestroyPipelineCache': None, 'vkCreateDescriptorSetLayout': None, 'vkAllocateDescriptorSets': None, 'vkFreeDescriptorSets': None, 'vkDestroyFramebuffer': None, 'vkCreateImageView': None, 'vkCreateSemaphore': None, 'vkGetBufferMemoryRequirements': None, 'vkCreateDescriptorPool': None, 'vkCreateImage': None, 'vkCreateBufferView': None, 'vkFreeCommandBuffers': None, 'vkDestroyShaderModule': None, 'vkGetImageSubresourceLayout': None, 'vkDestroyImageView': None, 'vkFreeMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkCreateQueryPool': None, 'vkAllocateMemory': None, 'vkDeviceWaitIdle': None, 'vkDestroyRenderPass': None, 'vkResetCommandPool': None, 'vkDestroyDevice': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'vkCreateDevice': None, 'VkDeviceCreateFlags': None, 'VkDeviceQueueCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkStructureType': None}
mapDict['VkDeviceMemory'] =  {'vkUnmapMemory': None, 'vkMapMemory': None, 'vkBindImageMemory': None, 'VkSparseImageMemoryBind': None, 'vkFreeMemory': None, 'vkGetDeviceMemoryCommitment': None, 'VkSparseMemoryBind': None, 'vkAllocateMemory': None, 'vkBindBufferMemory': None, 'VkMappedMemoryRange': None}
...
mapDict['VkDeviceSize'] =  {'vkMapMemory': None, 'VkBufferCreateInfo': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdDrawIndirect': None, 'VkMemoryRequirements': None, 'vkCmdBindIndexBuffer': None, 'VkBufferCopy': None, 'VkDescriptorBufferInfo': None, 'VkBufferViewCreateInfo': None, 'vkBindImageMemory': None, 'VkMemoryHeap': None, 'VkImageFormatProperties': None, 'vkCmdFillBuffer': None, 'VkMappedMemoryRange': None, 'VkPhysicalDeviceLimits': None, 'vkBindBufferMemory': None, 'VkSparseMemoryBind': None, 'VkSparseImageMemoryRequirements': None, 'VkMemoryAllocateInfo': None, 'vkCmdDispatchIndirect': None, 'vkCmdBindVertexBuffers': None, 'VkBufferMemoryBarrier': None, 'vkCmdUpdateBuffer': None, 'vkCmdCopyQueryPoolResults': None, 'VkSubresourceLayout': None, 'vkGetDeviceMemoryCommitment': None, 'VkSparseImageMemoryBind': None, 'vkGetQueryPoolResults': None, 'VkBufferImageCopy': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkCmdWaitEvents': None, 'vkCreateEvent': None, 'vkCmdSetEvent': None, 'vkDestroyEvent': None, 'vkResetEvent': None, 'vkSetEvent': None, 'vkCmdResetEvent': None, 'vkGetEventStatus': None}
...
mapDict['VkExtent3D'] =  {'VkSparseImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkImageFormatProperties': None, 'VkSparseImageMemoryBind': None, 'VkQueueFamilyProperties': None, 'VkImageCopy': None, 'VkBufferImageCopy': None, 'VkImageResolve': None}
mapDict['VkFence'] =  {'vkWaitForFences': None, 'vkQueueSubmit': None, 'vkQueueBindSparse': None, 'vkDestroyFence': None, 'vkResetFences': None, 'vkGetFenceStatus': None, 'vkCreateFence': None}
...
mapDict['VkFormat'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'VkBufferViewCreateInfo': None, 'VkImageViewCreateInfo': None, 'vkGetPhysicalDeviceFormatProperties': None, 'VkAttachmentDescription': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkVertexInputAttributeDescription': None}
...
mapDict['VkFramebufferCreateInfo'] =  {'VkFramebufferCreateFlags': None, 'vkCreateFramebuffer': None, 'VkStructureType': None, 'VkImageView': None, 'VkRenderPass': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineLayout': None, 'VkPipelineViewportStateCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkStructureType': None, 'VkPipeline': None, 'VkPipelineCreateFlags': None, 'VkRenderPass': None, 'VkPipelineDepthStencilStateCreateInfo': None}
mapDict['VkImage'] =  {'vkCmdCopyImageToBuffer': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCmdCopyBufferToImage': None, 'vkGetImageMemoryRequirements': None, 'vkCreateImage': None, 'vkGetImageSubresourceLayout': None, 'vkCmdBlitImage': None, 'vkDestroyImage': None, 'vkCmdResolveImage': None, 'vkCmdClearColorImage': None, 'VkImageMemoryBarrier': None, 'vkBindImageMemory': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'VkImageViewCreateInfo': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkSparseImageFormatProperties': None, 'VkImageAspectFlagBits': None, 'VkClearAttachment': None, 'VkImageSubresource': None, 'VkImageSubresourceRange': None, 'VkImageSubresourceLayers': None}
...
mapDict['VkImageCreateInfo'] =  {'VkSharingMode': None, 'VkImageType': None, 'VkFormat': None, 'VkStructureType': None, 'VkImageLayout': None, 'VkImageUsageFlags': None, 'VkSampleCountFlagBits': None, 'VkImageCreateFlags': None, 'vkCreateImage': None, 'VkExtent3D': None, 'VkImageTiling': None}
...
mapDict['VkImageLayout'] =  {'vkCmdCopyImageToBuffer': None, 'VkAttachmentDescription': None, 'vkCmdCopyBufferToImage': None, 'vkCmdBlitImage': None, 'vkCmdResolveImage': None, 'vkCmdClearColorImage': None, 'VkImageMemoryBarrier': None, 'VkImageCreateInfo': None, 'VkAttachmentReference': None, 'vkCmdClearDepthStencilImage': None, 'VkDescriptorImageInfo': None, 'vkCmdCopyImage': None}
mapDict['VkImageMemoryBarrier'] =  {'vkCmdWaitEvents': None, 'VkStructureType': None, 'vkCmdPipelineBarrier': None, 'VkImage': None, 'VkImageSubresourceRange': None, 'VkAccessFlags': None, 'VkImageLayout': None}
mapDict['VkImageResolve'] =  {'VkExtent3D': None, 'VkImageSubresourceLayers': None, 'vkCmdResolveImage': None, 'VkOffset3D': None}
mapDict['VkImageSubresource'] =  {'VkImageAspectFlags': None, 'vkGetImageSubresourceLayout': None, 'VkSparseImageMemoryBind': None}
mapDict['VkImageSubresourceLayers'] =  {'VkImageAspectFlags': None, 'VkImageBlit': None, 'VkBufferImageCopy': None, 'VkImageCopy': None, 'VkImageResolve': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageAspectFlags': None, 'vkCmdClearColorImage': None, 'VkImageViewCreateInfo': None, 'vkCmdClearDepthStencilImage': None, 'VkImageMemoryBarrier': None}
...
mapDict['VkImageUsageFlags'] =  {'VkImageUsageFlagBits': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None}
...
mapDict['VkImageViewCreateInfo'] =  {'vkCreateImageView': None, 'VkImageSubresourceRange': None, 'VkFormat': None, 'VkStructureType': None, 'VkComponentMapping': None, 'VkImage': None, 'VkImageViewCreateFlags': None, 'VkImageViewType': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkCreateInstance': None, 'vkEnumeratePhysicalDevices': None, 'vkDestroyInstance': None, 'vkGetInstanceProcAddr': None, 'vkCreateXlibSurfaceKHR': None}
mapDict['VkInstanceCreateFlags'] =  {'VkInstanceCreateInfo': None}
mapDict['VkInstanceCreateInfo'] =  {'vkCreateInstance': None, 'VkInstanceCreateFlags': None, 'VkStructureType': None, 'VkApplicationInfo': None}
...
mapDict['VkMappedMemoryRange'] =  {'VkDeviceSize': None, 'VkDeviceMemory': None, 'vkFlushMappedMemoryRanges': None, 'VkStructureType': None, 'vkInvalidateMappedMemoryRanges': None}
mapDict['VkMemoryAllocateInfo'] =  {'VkDeviceSize': None, 'vkAllocateMemory': None, 'VkStructureType': None}
mapDict['VkMemoryBarrier'] =  {'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None, 'VkStructureType': None, 'VkAccessFlags': None}
...
mapDict['VkOffset3D'] =  {'VkImageBlit': None, 'VkImageCopy': None, 'VkBufferImageCopy': None, 'VkSparseImageMemoryBind': None, 'VkImageResolve': None}
mapDict['VkPhysicalDevice'] =  {'vkCreateDevice': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceXlibPresentationSupportKHR': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceFeatures': None}
...
mapDict['VkPhysicalDeviceProperties'] =  {'VkPhysicalDeviceType': None, 'vkGetPhysicalDeviceProperties': None, 'VkPhysicalDeviceLimits': None, 'VkPhysicalDeviceSparseProperties': None}
...
mapDict['VkPipeline'] =  {'vkCreateGraphicsPipelines': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCmdBindPipeline': None, 'VkComputePipelineCreateInfo': None, 'vkCreateComputePipelines': None, 'vkDestroyPipeline': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkCreateGraphicsPipelines': None, 'vkCreatePipelineCache': None, 'vkGetPipelineCacheData': None, 'vkDestroyPipelineCache': None, 'vkMergePipelineCaches': None, 'vkCreateComputePipelines': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBlendFactor': None, 'VkColorComponentFlags': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkBlendOp': None, 'VkBool32': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkPipelineColorBlendStateCreateFlags': None, 'VkLogicOp': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkBool32': None, 'VkStructureType': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkStructureType': None, 'VkCompareOp': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkStencilOpState': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPrimitiveTopology': None, 'VkPipelineInputAssemblyStateCreateFlags': None}
mapDict['VkPipelineLayout'] =  {'vkCreatePipelineLayout': None, 'VkGraphicsPipelineCreateInfo': None, 'vkDestroyPipelineLayout': None, 'vkCmdPushConstants': None, 'VkComputePipelineCreateInfo': None, 'vkCmdBindDescriptorSets': None}
...
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkPipelineRasterizationStateCreateFlags': None, 'VkStructureType': None, 'VkFrontFace': None, 'VkCullModeFlags': None, 'VkPolygonMode': None, 'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkPipelineShaderStageCreateFlags': None, 'VkSpecializationInfo': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkShaderModule': None, 'VkShaderStageFlagBits': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'vkCmdWaitEvents': None, 'VkSubmitInfo': None, 'vkCmdSetEvent': None, 'vkCmdPipelineBarrier': None, 'VkSubpassDependency': None, 'VkPipelineStageFlagBits': None, 'vkCmdResetEvent': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkVertexInputBindingDescription': None, 'VkPipelineVertexInputStateCreateFlags': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkVertexInputAttributeDescription': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkViewport': None, 'VkRect2D': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineViewportStateCreateFlags': None}
...
mapDict['VkQueryPool'] =  {'vkCmdBeginQuery': None, 'vkCmdResetQueryPool': None, 'vkCmdCopyQueryPoolResults': None, 'vkDestroyQueryPool': None, 'vkCreateQueryPool': None, 'vkGetQueryPoolResults': None, 'vkCmdEndQuery': None, 'vkCmdWriteTimestamp': None}
...
mapDict['VkRect2D'] =  {'VkExtent2D': None, 'VkPipelineViewportStateCreateInfo': None, 'VkOffset2D': None, 'vkCmdSetScissor': None, 'VkClearRect': None, 'VkRenderPassBeginInfo': None}
mapDict['VkRenderPass'] =  {'vkGetRenderAreaGranularity': None, 'VkGraphicsPipelineCreateInfo': None, 'VkFramebufferCreateInfo': None, 'vkDestroyRenderPass': None, 'VkRenderPassBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkCreateRenderPass': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkFramebuffer': None, 'VkRect2D': None, 'VkStructureType': None, 'vkCmdBeginRenderPass': None, 'VkClearValue': None, 'VkRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'vkCreateRenderPass': None, 'VkAttachmentDescription': None, 'VkSubpassDescription': None, 'VkStructureType': None, 'VkRenderPassCreateFlags': None, 'VkSubpassDependency': None}
mapDict['VkSampleCountFlagBits'] =  {'VkImageCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSampleCountFlags': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkAttachmentDescription': None}
...
mapDict['VkSampler'] =  {'VkDescriptorImageInfo': None, 'vkDestroySampler': None, 'vkCreateSampler': None, 'VkDescriptorSetLayoutBinding': None}
mapDict['VkSamplerAddressMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateFlags'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateInfo'] =  {'VkFilter': None, 'VkSamplerCreateFlags': None, 'VkStructureType': None, 'VkCompareOp': None, 'VkBorderColor': None, 'VkSamplerAddressMode': None, 'VkSamplerMipmapMode': None, 'VkBool32': None, 'vkCreateSampler': None}
mapDict['VkSamplerMipmapMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSemaphore'] =  {'vkCreateSemaphore': None, 'vkDestroySemaphore': None, 'VkBindSparseInfo': None, 'VkSubmitInfo': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'VkImageAspectFlags': None, 'VkSparseImageFormatFlags': None, 'VkExtent3D': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageMemoryRequirements': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkDeviceSize': None, 'VkDeviceMemory': None, 'VkSparseImageMemoryBindInfo': None, 'VkImageSubresource': None, 'VkExtent3D': None, 'VkSparseMemoryBindFlags': None, 'VkOffset3D': None}
mapDict['VkSparseImageMemoryBindInfo'] =  {'VkBindSparseInfo': None, 'VkImage': None, 'VkSparseImageMemoryBind': None}
mapDict['VkSparseImageMemoryRequirements'] =  {'VkDeviceSize': None, 'VkSparseImageFormatProperties': None, 'vkGetImageSparseMemoryRequirements': None}
mapDict['VkSparseImageOpaqueMemoryBindInfo'] =  {'VkSparseMemoryBind': None, 'VkImage': None, 'VkBindSparseInfo': None}
mapDict['VkSparseMemoryBind'] =  {'VkDeviceSize': None, 'VkDeviceMemory': None, 'VkSparseMemoryBindFlags': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseBufferMemoryBindInfo': None}
...
mapDict['VkStructureType'] =  {'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkBufferCreateInfo': None, 'VkSubmitInfo': None, 'VkFenceCreateInfo': None, 'VkImageCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkBindSparseInfo': None, 'VkDeviceCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkEventCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkXlibSurfaceCreateInfoKHR': None, 'VkMappedMemoryRange': None, 'VkSemaphoreCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkCommandBufferBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkApplicationInfo': None, 'VkMemoryBarrier': None, 'VkPipelineCacheCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkImageMemoryBarrier': None, 'VkComputePipelineCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkBufferMemoryBarrier': None, 'VkCopyDescriptorSet': None}
mapDict['VkSubmitInfo'] =  {'VkSemaphore': None, 'vkQueueSubmit': None, 'VkCommandBuffer': None, 'VkPipelineStageFlags': None, 'VkStructureType': None}
mapDict['VkSubpassContents'] =  {'vkCmdNextSubpass': None, 'vkCmdBeginRenderPass': None}
mapDict['VkSubpassDependency'] =  {'VkRenderPassCreateInfo': None, 'VkDependencyFlags': None, 'VkPipelineStageFlags': None, 'VkAccessFlags': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkStructureType': None, 'VkDescriptorType': None, 'VkDescriptorImageInfo': None, 'VkDescriptorSet': None, 'VkDescriptorBufferInfo': None, 'VkBufferView': None, 'vkUpdateDescriptorSets': None}
mapDict['VkXlibSurfaceCreateFlagsKHR'] =  {'VkXlibSurfaceCreateInfoKHR': None}
mapDict['VkXlibSurfaceCreateInfoKHR'] =  {'VkXlibSurfaceCreateFlagsKHR': None, 'VkStructureType': None, 'vkCreateXlibSurfaceKHR': None}
...
mapDict['vkCmdBeginQuery'] =  {'VkQueryPool': None, 'VkCommandBuffer': None, 'VkQueryControlFlags': None}
...
mapDict['vkCmdBindIndexBuffer'] =  {'VkBuffer': None, 'VkDeviceSize': None, 'VkCommandBuffer': None, 'VkIndexType': None}
...
mapDict['vkCmdBlitImage'] =  {'VkImageBlit': None, 'VkFilter': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdClearAttachments'] =  {'VkClearRect': None, 'VkClearAttachment': None, 'VkCommandBuffer': None}
mapDict['vkCmdClearColorImage'] =  {'VkImage': None, 'VkCommandBuffer': None, 'VkImageSubresourceRange': None, 'VkImageLayout': None, 'VkClearColorValue': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImageSubresourceRange': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkClearDepthStencilValue': None, 'VkImageLayout': None}
...
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkBuffer': None, 'VkDeviceSize': None, 'VkQueryPool': None, 'VkCommandBuffer': None, 'VkQueryResultFlags': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkImageMemoryBarrier': None, 'VkCommandBuffer': None, 'VkMemoryBarrier': None, 'VkDependencyFlags': None, 'VkPipelineStageFlags': None, 'VkBufferMemoryBarrier': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkImageMemoryBarrier': None, 'VkCommandBuffer': None, 'VkEvent': None, 'VkMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkBufferMemoryBarrier': None}
...
mapDict['vkCreateBufferView'] =  {'VkBufferViewCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkBufferView': None}
mapDict['vkCreateCommandPool'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkCommandPool': None, 'VkCommandPoolCreateInfo': None}
mapDict['vkCreateComputePipelines'] =  {'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkComputePipelineCreateInfo': None, 'VkDevice': None, 'VkPipelineCache': None}
mapDict['vkCreateDescriptorPool'] =  {'VkAllocationCallbacks': None, 'VkDescriptorPoolCreateInfo': None, 'VkDevice': None, 'VkDescriptorPool': None}
mapDict['vkCreateDescriptorSetLayout'] =  {'VkDescriptorSetLayoutCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkDescriptorSetLayout': None}
mapDict['vkCreateDevice'] =  {'VkDevice': None, 'VkDeviceCreateInfo': None, 'VkAllocationCallbacks': None, 'VkPhysicalDevice': None}
mapDict['vkCreateEvent'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkEvent': None, 'VkEventCreateInfo': None}
mapDict['vkCreateFence'] =  {'VkFenceCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkFence': None}
mapDict['vkCreateFramebuffer'] =  {'VkFramebuffer': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkFramebufferCreateInfo': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkPipeline': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineCache': None}
mapDict['vkCreateImage'] =  {'VkImageCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkImage': None}
mapDict['vkCreateImageView'] =  {'VkAllocationCallbacks': None, 'VkImageViewCreateInfo': None, 'VkDevice': None, 'VkImageView': None}
mapDict['vkCreateInstance'] =  {'VkAllocationCallbacks': None, 'VkInstanceCreateInfo': None, 'VkInstance': None}
mapDict['vkCreatePipelineCache'] =  {'VkPipelineCacheCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipelineCache': None}
mapDict['vkCreatePipelineLayout'] =  {'VkPipelineLayout': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipelineLayoutCreateInfo': None}
mapDict['vkCreateQueryPool'] =  {'VkQueryPoolCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkQueryPool': None}
mapDict['vkCreateRenderPass'] =  {'VkRenderPassCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkRenderPass': None}
mapDict['vkCreateSampler'] =  {'VkSamplerCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkSampler': None}
mapDict['vkCreateSemaphore'] =  {'VkSemaphore': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkSemaphoreCreateInfo': None}
mapDict['vkCreateShaderModule'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkShaderModule': None, 'VkShaderModuleCreateInfo': None}
mapDict['vkCreateXlibSurfaceKHR'] =  {'VkXlibSurfaceCreateInfoKHR': None, 'VkAllocationCallbacks': None, 'VkSurfaceKHR': None, 'VkInstance': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageType': None, 'VkFormat': None, 'VkImageUsageFlags': None, 'VkImageFormatProperties': None, 'VkImageCreateFlags': None, 'VkPhysicalDevice': None, 'VkImageTiling': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkSparseImageFormatProperties': None, 'VkImageType': None, 'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkFormat': None, 'VkPhysicalDevice': None, 'VkImageTiling': None}
...
mapDict['vkGetQueryPoolResults'] =  {'VkDeviceSize': None, 'VkQueryPool': None, 'VkQueryResultFlags': None, 'VkDevice': None}
