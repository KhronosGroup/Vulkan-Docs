...
mapDict['VkAccessFlags'] =  {'VkSubpassDependency': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkAccessFlagBits': None}
mapDict['VkAllocationCallbacks'] =  {'vkDestroyFramebuffer': None, 'vkCreateBuffer': None, 'vkCreateWaylandSurfaceKHR': None, 'vkCreateSampler': None, 'vkCreateGraphicsPipelines': None, 'vkCreateFramebuffer': None, 'vkCreateQueryPool': None, 'vkDestroyBuffer': None, 'vkCreateCommandPool': None, 'vkDestroyBufferView': None, 'vkCreatePipelineCache': None, 'vkDestroyShaderModule': None, 'vkCreateSemaphore': None, 'vkDestroyPipeline': None, 'vkCreateRenderPass': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroyDevice': None, 'PFN_vkInternalFreeNotification': None, 'vkDestroyImageView': None, 'vkDestroyFence': None, 'vkDestroyPipelineLayout': None, 'vkCreateEvent': None, 'vkDestroySemaphore': None, 'PFN_vkAllocationFunction': None, 'vkCreateShaderModule': None, 'vkCreateDescriptorPool': None, 'vkCreateInstance': None, 'vkCreateBufferView': None, 'PFN_vkInternalAllocationNotification': None, 'vkDestroyCommandPool': None, 'vkCreatePipelineLayout': None, 'vkDestroyRenderPass': None, 'PFN_vkFreeFunction': None, 'vkCreateImageView': None, 'vkDestroyPipelineCache': None, 'vkDestroyEvent': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateFence': None, 'PFN_vkReallocationFunction': None, 'vkAllocateMemory': None, 'vkDestroyImage': None, 'vkCreateImage': None, 'vkDestroySampler': None, 'vkDestroyDescriptorPool': None, 'vkCreateDevice': None, 'vkCreateComputePipelines': None, 'vkDestroyInstance': None, 'vkDestroyQueryPool': None, 'vkFreeMemory': None}
mapDict['VkApplicationInfo'] =  {'VkInstanceCreateInfo': None, 'VkStructureType': None}
mapDict['VkAttachmentDescription'] =  {'VkFormat': None, 'VkRenderPassCreateInfo': None, 'VkSampleCountFlagBits': None, 'VkAttachmentLoadOp': None, 'VkAttachmentStoreOp': None, 'VkAttachmentDescriptionFlags': None, 'VkImageLayout': None}
...
mapDict['VkBindSparseInfo'] =  {'VkSemaphore': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'vkQueueBindSparse': None, 'VkStructureType': None, 'VkSparseBufferMemoryBindInfo': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPhysicalDeviceFeatures': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPhysicalDeviceLimits': None, 'VkPhysicalDeviceSparseProperties': None, 'VkCommandBufferInheritanceInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkSamplerCreateInfo': None, 'vkWaitForFences': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkDestroyBuffer': None, 'vkCmdFillBuffer': None, 'vkCreateBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdUpdateBuffer': None, 'VkBufferViewCreateInfo': None, 'VkDescriptorBufferInfo': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyBuffer': None, 'vkCmdDrawIndirect': None, 'vkBindBufferMemory': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkGetBufferMemoryRequirements': None, 'VkBufferMemoryBarrier': None, 'vkCmdDispatchIndirect': None, 'vkCmdDrawIndexedIndirect': None, 'VkSparseBufferMemoryBindInfo': None}
...
mapDict['VkBufferCreateInfo'] =  {'vkCreateBuffer': None, 'VkSharingMode': None, 'VkBufferUsageFlags': None, 'VkStructureType': None, 'VkBufferCreateFlags': None, 'VkDeviceSize': None}
mapDict['VkBufferImageCopy'] =  {'VkOffset3D': None, 'VkImageSubresourceLayers': None, 'VkDeviceSize': None, 'VkExtent3D': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyImageToBuffer': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkAccessFlags': None, 'VkBuffer': None, 'vkCmdWaitEvents': None, 'VkStructureType': None, 'VkDeviceSize': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkFormat': None, 'VkBuffer': None, 'VkBufferViewCreateFlags': None, 'VkDeviceSize': None, 'vkCreateBufferView': None, 'VkStructureType': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdEndQuery': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyImage': None, 'vkEndCommandBuffer': None, 'vkCmdNextSubpass': None, 'vkCmdPushConstants': None, 'VkSubmitInfo': None, 'vkCmdDispatch': None, 'vkCmdWriteTimestamp': None, 'vkCmdCopyBuffer': None, 'vkCmdSetEvent': None, 'vkCmdBindVertexBuffers': None, 'vkCmdBindDescriptorSets': None, 'vkCmdSetViewport': None, 'vkCmdSetDepthBias': None, 'vkCmdExecuteCommands': None, 'vkCmdResetQueryPool': None, 'vkCmdSetDepthBounds': None, 'vkCmdDispatchIndirect': None, 'vkResetCommandBuffer': None, 'vkCmdFillBuffer': None, 'vkCmdSetLineWidth': None, 'vkAllocateCommandBuffers': None, 'vkCmdUpdateBuffer': None, 'vkBeginCommandBuffer': None, 'vkCmdBeginRenderPass': None, 'vkCmdDrawIndirect': None, 'vkCmdDrawIndexed': None, 'vkCmdSetStencilCompareMask': None, 'vkFreeCommandBuffers': None, 'vkCmdDraw': None, 'vkCmdSetBlendConstants': None, 'vkCmdEndRenderPass': None, 'vkCmdBlitImage': None, 'vkCmdPipelineBarrier': None, 'vkCmdBeginQuery': None, 'vkCmdResolveImage': None, 'vkCmdClearColorImage': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdBindPipeline': None, 'vkCmdClearAttachments': None, 'vkCmdSetStencilReference': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkCmdWaitEvents': None, 'vkCmdSetScissor': None, 'vkCmdCopyBufferToImage': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdResetEvent': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'VkCommandBufferLevel': None, 'VkStructureType': None, 'VkCommandPool': None, 'vkAllocateCommandBuffers': None}
mapDict['VkCommandBufferBeginInfo'] =  {'VkCommandBufferInheritanceInfo': None, 'VkStructureType': None, 'vkBeginCommandBuffer': None, 'VkCommandBufferUsageFlags': None}
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkFramebuffer': None, 'VkBool32': None, 'VkQueryPipelineStatisticFlags': None, 'VkQueryControlFlags': None, 'VkStructureType': None, 'VkCommandBufferBeginInfo': None, 'VkRenderPass': None}
...
mapDict['VkCommandPool'] =  {'vkCreateCommandPool': None, 'vkResetCommandPool': None, 'vkFreeCommandBuffers': None, 'vkDestroyCommandPool': None, 'VkCommandBufferAllocateInfo': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'vkCreateComputePipelines': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipeline': None, 'VkPipelineLayout': None, 'VkStructureType': None, 'VkPipelineCreateFlags': None}
...
mapDict['VkDescriptorPool'] =  {'VkDescriptorSetAllocateInfo': None, 'vkResetDescriptorPool': None, 'vkFreeDescriptorSets': None, 'vkCreateDescriptorPool': None, 'vkDestroyDescriptorPool': None}
...
mapDict['VkDescriptorSet'] =  {'VkWriteDescriptorSet': None, 'vkCmdBindDescriptorSets': None, 'VkCopyDescriptorSet': None, 'vkAllocateDescriptorSets': None, 'vkFreeDescriptorSets': None}
mapDict['VkDescriptorSetAllocateInfo'] =  {'VkStructureType': None, 'VkDescriptorPool': None, 'vkAllocateDescriptorSets': None, 'VkDescriptorSetLayout': None}
mapDict['VkDescriptorSetLayout'] =  {'VkDescriptorSetAllocateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateDescriptorSetLayout': None}
mapDict['VkDescriptorSetLayoutBinding'] =  {'VkShaderStageFlags': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkDescriptorType': None, 'VkSampler': None}
mapDict['VkDescriptorSetLayoutCreateFlags'] =  {'VkDescriptorSetLayoutCreateInfo': None}
mapDict['VkDescriptorSetLayoutCreateInfo'] =  {'VkStructureType': None, 'VkDescriptorSetLayoutBinding': None, 'VkDescriptorSetLayoutCreateFlags': None, 'vkCreateDescriptorSetLayout': None}
mapDict['VkDescriptorType'] =  {'VkWriteDescriptorSet': None, 'VkDescriptorSetLayoutBinding': None, 'VkDescriptorPoolSize': None}
mapDict['VkDevice'] =  {'vkGetImageMemoryRequirements': None, 'vkCreateBuffer': None, 'vkResetDescriptorPool': None, 'vkGetDeviceQueue': None, 'vkAllocateCommandBuffers': None, 'vkCreateSampler': None, 'vkCreateGraphicsPipelines': None, 'vkGetQueryPoolResults': None, 'vkDestroySemaphore': None, 'vkGetBufferMemoryRequirements': None, 'vkGetDeviceMemoryCommitment': None, 'vkCreateFramebuffer': None, 'vkFreeDescriptorSets': None, 'vkDeviceWaitIdle': None, 'vkWaitForFences': None, 'vkDestroyBuffer': None, 'vkCreateCommandPool': None, 'vkDestroyBufferView': None, 'vkCreatePipelineCache': None, 'vkDestroyShaderModule': None, 'vkCreateSemaphore': None, 'vkDestroyPipeline': None, 'vkCreateRenderPass': None, 'vkUpdateDescriptorSets': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroyDevice': None, 'vkAllocateDescriptorSets': None, 'vkDestroyImageView': None, 'vkBindBufferMemory': None, 'vkMapMemory': None, 'vkMergePipelineCaches': None, 'vkCreateDescriptorPool': None, 'vkCreateQueryPool': None, 'vkDestroyPipelineLayout': None, 'vkCreateEvent': None, 'vkBindImageMemory': None, 'vkGetEventStatus': None, 'vkCreateShaderModule': None, 'vkResetFences': None, 'vkCreateBufferView': None, 'vkGetFenceStatus': None, 'vkGetDeviceProcAddr': None, 'vkInvalidateMappedMemoryRanges': None, 'vkResetCommandPool': None, 'vkDestroyFramebuffer': None, 'vkDestroyCommandPool': None, 'vkCreatePipelineLayout': None, 'vkGetImageSparseMemoryRequirements': None, 'vkDestroyRenderPass': None, 'vkUnmapMemory': None, 'vkSetEvent': None, 'vkCreateImageView': None, 'vkDestroyFence': None, 'vkDestroyEvent': None, 'vkCreateDescriptorSetLayout': None, 'vkCreateFence': None, 'vkAllocateMemory': None, 'vkDestroyImage': None, 'vkCreateImage': None, 'vkDestroyPipelineCache': None, 'vkDestroyQueryPool': None, 'vkDestroyDescriptorPool': None, 'vkCreateDevice': None, 'vkCreateComputePipelines': None, 'vkGetPipelineCacheData': None, 'vkGetRenderAreaGranularity': None, 'vkGetImageSubresourceLayout': None, 'vkResetEvent': None, 'vkFlushMappedMemoryRanges': None, 'vkDestroySampler': None, 'vkFreeMemory': None, 'vkFreeCommandBuffers': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkDeviceQueueCreateInfo': None, 'VkStructureType': None, 'vkCreateDevice': None, 'VkDeviceCreateFlags': None, 'VkPhysicalDeviceFeatures': None}
mapDict['VkDeviceMemory'] =  {'vkBindImageMemory': None, 'vkBindBufferMemory': None, 'vkAllocateMemory': None, 'vkMapMemory': None, 'VkMappedMemoryRange': None, 'vkGetDeviceMemoryCommitment': None, 'vkUnmapMemory': None, 'VkSparseImageMemoryBind': None, 'vkFreeMemory': None, 'VkSparseMemoryBind': None}
...
mapDict['VkDeviceSize'] =  {'vkBindImageMemory': None, 'VkBufferCreateInfo': None, 'vkCmdBindIndexBuffer': None, 'VkBufferCopy': None, 'vkCmdFillBuffer': None, 'vkCmdUpdateBuffer': None, 'VkDescriptorBufferInfo': None, 'VkPhysicalDeviceLimits': None, 'VkImageFormatProperties': None, 'vkCmdDrawIndirect': None, 'VkBufferViewCreateInfo': None, 'vkGetQueryPoolResults': None, 'VkSparseMemoryBind': None, 'VkMemoryRequirements': None, 'vkGetDeviceMemoryCommitment': None, 'VkSubresourceLayout': None, 'VkBufferMemoryBarrier': None, 'vkCmdBindVertexBuffers': None, 'VkSparseImageMemoryRequirements': None, 'VkMappedMemoryRange': None, 'vkCmdCopyQueryPoolResults': None, 'VkMemoryHeap': None, 'vkCmdDispatchIndirect': None, 'VkBufferImageCopy': None, 'vkBindBufferMemory': None, 'vkMapMemory': None, 'VkMemoryAllocateInfo': None, 'vkCmdDrawIndexedIndirect': None, 'VkSparseImageMemoryBind': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkGetEventStatus': None, 'vkSetEvent': None, 'vkCmdSetEvent': None, 'vkCreateEvent': None, 'vkCmdWaitEvents': None, 'vkCmdResetEvent': None, 'vkResetEvent': None, 'vkDestroyEvent': None}
...
mapDict['VkExtent3D'] =  {'VkImageFormatProperties': None, 'VkBufferImageCopy': None, 'VkSparseImageFormatProperties': None, 'VkImageCopy': None, 'VkQueueFamilyProperties': None, 'VkImageCreateInfo': None, 'VkImageResolve': None, 'VkSparseImageMemoryBind': None}
mapDict['VkFence'] =  {'vkGetFenceStatus': None, 'vkCreateFence': None, 'vkResetFences': None, 'vkQueueSubmit': None, 'vkQueueBindSparse': None, 'vkDestroyFence': None, 'vkWaitForFences': None}
...
mapDict['VkFormat'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'VkBufferViewCreateInfo': None, 'VkAttachmentDescription': None, 'VkVertexInputAttributeDescription': None, 'VkImageViewCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceFormatProperties': None}
...
mapDict['VkFramebufferCreateInfo'] =  {'vkCreateFramebuffer': None, 'VkStructureType': None, 'VkImageView': None, 'VkFramebufferCreateFlags': None, 'VkRenderPass': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineViewportStateCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkRenderPass': None, 'VkPipelineShaderStageCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineLayout': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkStructureType': None, 'VkPipelineCreateFlags': None, 'VkPipeline': None, 'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkImage'] =  {'vkBindImageMemory': None, 'vkGetImageMemoryRequirements': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkCmdBlitImage': None, 'VkSparseImageMemoryBindInfo': None, 'vkDestroyImage': None, 'vkCreateImage': None, 'vkCmdClearColorImage': None, 'vkCmdCopyImage': None, 'VkImageMemoryBarrier': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdResolveImage': None, 'vkCmdCopyImageToBuffer': None, 'VkImageViewCreateInfo': None, 'vkGetImageSparseMemoryRequirements': None, 'vkGetImageSubresourceLayout': None, 'vkCmdCopyBufferToImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkClearAttachment': None, 'VkSparseImageFormatProperties': None, 'VkImageSubresource': None, 'VkImageSubresourceLayers': None, 'VkImageSubresourceRange': None, 'VkImageAspectFlagBits': None}
mapDict['VkImageBlit'] =  {'vkCmdBlitImage': None, 'VkOffset3D': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageCopy'] =  {'vkCmdCopyImage': None, 'VkExtent3D': None, 'VkOffset3D': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageCreateFlagBits'] =  {'VkImageCreateFlags': None}
mapDict['VkImageCreateFlags'] =  {'VkImageCreateInfo': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageCreateFlagBits': None}
mapDict['VkImageCreateInfo'] =  {'VkImageTiling': None, 'vkCreateImage': None, 'VkFormat': None, 'VkImageType': None, 'VkSampleCountFlagBits': None, 'VkSharingMode': None, 'VkImageCreateFlags': None, 'VkStructureType': None, 'VkExtent3D': None, 'VkImageLayout': None, 'VkImageUsageFlags': None}
mapDict['VkImageFormatProperties'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'VkDeviceSize': None, 'VkExtent3D': None, 'VkSampleCountFlags': None}
mapDict['VkImageLayout'] =  {'vkCmdBlitImage': None, 'VkImageMemoryBarrier': None, 'vkCmdResolveImage': None, 'vkCmdClearColorImage': None, 'vkCmdCopyImage': None, 'VkDescriptorImageInfo': None, 'vkCmdClearDepthStencilImage': None, 'VkAttachmentDescription': None, 'vkCmdCopyImageToBuffer': None, 'VkImageCreateInfo': None, 'vkCmdCopyBufferToImage': None, 'VkAttachmentReference': None}
mapDict['VkImageMemoryBarrier'] =  {'VkAccessFlags': None, 'VkImage': None, 'VkImageSubresourceRange': None, 'VkStructureType': None, 'vkCmdWaitEvents': None, 'VkImageLayout': None, 'vkCmdPipelineBarrier': None}
mapDict['VkImageResolve'] =  {'vkCmdResolveImage': None, 'VkExtent3D': None, 'VkOffset3D': None, 'VkImageSubresourceLayers': None}
mapDict['VkImageSubresource'] =  {'vkGetImageSubresourceLayout': None, 'VkSparseImageMemoryBind': None, 'VkImageAspectFlags': None}
mapDict['VkImageSubresourceLayers'] =  {'VkImageCopy': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageAspectFlags': None, 'VkImageBlit': None}
mapDict['VkImageSubresourceRange'] =  {'vkCmdClearDepthStencilImage': None, 'VkImageViewCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkImageAspectFlags': None, 'vkCmdClearColorImage': None}
...
mapDict['VkImageUsageFlags'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageUsageFlagBits': None}
...
mapDict['VkImageViewCreateInfo'] =  {'VkImage': None, 'VkFormat': None, 'VkImageViewCreateFlags': None, 'VkImageSubresourceRange': None, 'VkImageViewType': None, 'VkStructureType': None, 'VkComponentMapping': None, 'vkCreateImageView': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkCreateInstance': None, 'vkCreateWaylandSurfaceKHR': None, 'vkEnumeratePhysicalDevices': None, 'vkDestroyInstance': None, 'vkGetInstanceProcAddr': None}
...
mapDict['VkMemoryBarrier'] =  {'VkAccessFlags': None, 'VkStructureType': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None}
...
mapDict['VkOffset3D'] =  {'VkImageCopy': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkSparseImageMemoryBind': None, 'VkImageBlit': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceWaylandPresentationSupportKHR': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkEnumerateDeviceLayerProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkCreateDevice': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkGetPhysicalDeviceFeatures': None, 'vkGetPhysicalDeviceMemoryProperties': None}
mapDict['VkPhysicalDeviceFeatures'] =  {'vkGetPhysicalDeviceFeatures': None, 'VkBool32': None, 'VkDeviceCreateInfo': None}
mapDict['VkPhysicalDeviceLimits'] =  {'VkBool32': None, 'VkDeviceSize': None, 'VkSampleCountFlags': None, 'VkPhysicalDeviceProperties': None}
mapDict['VkPhysicalDeviceMemoryProperties'] =  {'VkMemoryHeap': None, 'VkMemoryType': None, 'vkGetPhysicalDeviceMemoryProperties': None}
mapDict['VkPhysicalDeviceProperties'] =  {'vkGetPhysicalDeviceProperties': None, 'VkPhysicalDeviceType': None, 'VkPhysicalDeviceLimits': None, 'VkPhysicalDeviceSparseProperties': None}
...
mapDict['VkPipeline'] =  {'vkCreateComputePipelines': None, 'vkCreateGraphicsPipelines': None, 'VkComputePipelineCreateInfo': None, 'vkCmdBindPipeline': None, 'vkDestroyPipeline': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkCreateComputePipelines': None, 'vkCreateGraphicsPipelines': None, 'vkGetPipelineCacheData': None, 'vkCreatePipelineCache': None, 'vkMergePipelineCaches': None, 'vkDestroyPipelineCache': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBlendFactor': None, 'VkBool32': None, 'VkBlendOp': None, 'VkColorComponentFlags': None, 'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkBool32': None, 'VkPipelineColorBlendAttachmentState': None, 'VkLogicOp': None, 'VkPipelineColorBlendStateCreateFlags': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkBool32': None, 'VkCompareOp': None, 'VkStencilOpState': None, 'VkStructureType': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkPipelineInputAssemblyStateCreateFlags': None, 'VkPrimitiveTopology': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None}
mapDict['VkPipelineLayout'] =  {'VkComputePipelineCreateInfo': None, 'vkCreatePipelineLayout': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCmdBindDescriptorSets': None, 'vkDestroyPipelineLayout': None, 'vkCmdPushConstants': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkStructureType': None, 'VkDescriptorSetLayout': None, 'VkPipelineLayoutCreateFlags': None, 'vkCreatePipelineLayout': None, 'VkPushConstantRange': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkBool32': None, 'VkSampleMask': None, 'VkSampleCountFlagBits': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineMultisampleStateCreateFlags': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkBool32': None, 'VkCullModeFlags': None, 'VkPolygonMode': None, 'VkStructureType': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkFrontFace': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkShaderStageFlagBits': None, 'VkPipelineShaderStageCreateFlags': None, 'VkSpecializationInfo': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkShaderModule': None}
mapDict['VkPipelineStageFlagBits'] =  {'vkCmdWriteTimestamp': None, 'VkPipelineStageFlags': None}
mapDict['VkPipelineStageFlags'] =  {'VkSubpassDependency': None, 'VkPipelineStageFlagBits': None, 'vkCmdSetEvent': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None, 'VkSubmitInfo': None, 'vkCmdResetEvent': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkVertexInputAttributeDescription': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkVertexInputBindingDescription': None, 'VkPipelineVertexInputStateCreateFlags': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkRect2D': None, 'VkStructureType': None, 'VkPipelineViewportStateCreateFlags': None, 'VkViewport': None, 'VkGraphicsPipelineCreateInfo': None}
...
mapDict['VkQueryPool'] =  {'vkCmdWriteTimestamp': None, 'vkCmdResetQueryPool': None, 'vkGetQueryPoolResults': None, 'vkCmdBeginQuery': None, 'vkCmdEndQuery': None, 'vkDestroyQueryPool': None, 'vkCmdCopyQueryPoolResults': None, 'vkCreateQueryPool': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkQueryPipelineStatisticFlags': None, 'VkStructureType': None, 'VkQueryType': None, 'VkQueryPoolCreateFlags': None, 'vkCreateQueryPool': None}
mapDict['VkQueryResultFlagBits'] =  {'VkQueryResultFlags': None}
mapDict['VkQueryResultFlags'] =  {'vkCmdCopyQueryPoolResults': None, 'VkQueryResultFlagBits': None, 'vkGetQueryPoolResults': None}
mapDict['VkQueryType'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueue'] =  {'vkQueueBindSparse': None, 'vkGetDeviceQueue': None, 'vkQueueSubmit': None, 'vkQueueWaitIdle': None}
...
mapDict['VkRect2D'] =  {'VkPipelineViewportStateCreateInfo': None, 'VkRenderPassBeginInfo': None, 'vkCmdSetScissor': None, 'VkOffset2D': None, 'VkExtent2D': None, 'VkClearRect': None}
mapDict['VkRenderPass'] =  {'VkFramebufferCreateInfo': None, 'vkDestroyRenderPass': None, 'VkRenderPassBeginInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkCreateRenderPass': None, 'VkGraphicsPipelineCreateInfo': None, 'vkGetRenderAreaGranularity': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkFramebuffer': None, 'VkRect2D': None, 'VkClearValue': None, 'VkStructureType': None, 'vkCmdBeginRenderPass': None, 'VkRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkSubpassDependency': None, 'VkAttachmentDescription': None, 'VkSubpassDescription': None, 'VkRenderPassCreateFlags': None, 'VkStructureType': None, 'vkCreateRenderPass': None}
...
mapDict['VkSampler'] =  {'VkDescriptorImageInfo': None, 'vkDestroySampler': None, 'VkDescriptorSetLayoutBinding': None, 'vkCreateSampler': None}
mapDict['VkSamplerAddressMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateFlags'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateInfo'] =  {'VkBool32': None, 'VkSamplerAddressMode': None, 'VkSamplerMipmapMode': None, 'VkCompareOp': None, 'VkBorderColor': None, 'VkStructureType': None, 'VkSamplerCreateFlags': None, 'VkFilter': None, 'vkCreateSampler': None}
...
mapDict['VkShaderModuleCreateInfo'] =  {'VkStructureType': None, 'vkCreateShaderModule': None, 'VkShaderModuleCreateFlags': None}
...
mapDict['VkSparseBufferMemoryBindInfo'] =  {'VkBuffer': None, 'VkSparseMemoryBind': None, 'VkBindSparseInfo': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkExtent3D': None, 'VkSparseImageFormatFlags': None, 'VkSparseImageMemoryRequirements': None, 'VkImageAspectFlags': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkImageSubresource': None, 'VkOffset3D': None, 'VkSparseImageMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None, 'VkDeviceSize': None, 'VkExtent3D': None, 'VkDeviceMemory': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkSparseMemoryBindFlags': None, 'VkDeviceSize': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkSparseBufferMemoryBindInfo': None}
...
mapDict['VkStencilFaceFlags'] =  {'vkCmdSetStencilCompareMask': None, 'vkCmdSetStencilReference': None, 'vkCmdSetStencilWriteMask': None, 'VkStencilFaceFlagBits': None}
...
mapDict['VkStructureType'] =  {'VkWaylandSurfaceCreateInfoKHR': None, 'VkBufferCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkBufferViewCreateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkRenderPassBeginInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkSubmitInfo': None, 'VkFenceCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkPipelineShaderStageCreateInfo': None, 'VkEventCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkApplicationInfo': None, 'VkCommandBufferBeginInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkMemoryBarrier': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkImageViewCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkSamplerCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkMappedMemoryRange': None, 'VkImageCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkBindSparseInfo': None, 'VkDescriptorPoolCreateInfo': None}
mapDict['VkSubmitInfo'] =  {'vkQueueSubmit': None, 'VkPipelineStageFlags': None, 'VkStructureType': None, 'VkSemaphore': None, 'VkCommandBuffer': None}
mapDict['VkSubpassContents'] =  {'vkCmdNextSubpass': None, 'vkCmdBeginRenderPass': None}
mapDict['VkSubpassDependency'] =  {'VkPipelineStageFlags': None, 'VkDependencyFlags': None, 'VkRenderPassCreateInfo': None, 'VkAccessFlags': None}
...
mapDict['VkWaylandSurfaceCreateInfoKHR'] =  {'VkStructureType': None, 'vkCreateWaylandSurfaceKHR': None, 'VkWaylandSurfaceCreateFlagsKHR': None}
mapDict['VkWriteDescriptorSet'] =  {'VkDescriptorSet': None, 'VkDescriptorType': None, 'vkUpdateDescriptorSets': None, 'VkStructureType': None, 'VkBufferView': None, 'VkDescriptorBufferInfo': None, 'VkDescriptorImageInfo': None}
...
mapDict['vkAllocateMemory'] =  {'VkDevice': None, 'VkAllocationCallbacks': None, 'VkDeviceMemory': None, 'VkMemoryAllocateInfo': None}
...
mapDict['vkBindImageMemory'] =  {'VkImage': None, 'VkDevice': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
...
mapDict['vkCmdBindDescriptorSets'] =  {'VkDescriptorSet': None, 'VkPipelineBindPoint': None, 'VkPipelineLayout': None, 'VkCommandBuffer': None}
mapDict['vkCmdBindIndexBuffer'] =  {'VkIndexType': None, 'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdClearColorImage'] =  {'VkImageSubresourceRange': None, 'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkClearColorValue': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImageSubresourceRange': None, 'VkImage': None, 'VkImageLayout': None, 'VkClearDepthStencilValue': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyBuffer'] =  {'VkBuffer': None, 'VkBufferCopy': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyBufferToImage'] =  {'VkImage': None, 'VkBufferImageCopy': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdCopyImage'] =  {'VkImage': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImageCopy': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkImage': None, 'VkImageLayout': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkBufferImageCopy': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkDeviceSize': None, 'VkQueryResultFlags': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkQueryPool': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkPipelineStageFlags': None, 'VkMemoryBarrier': None, 'VkDependencyFlags': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkEvent': None, 'VkPipelineStageFlags': None, 'VkMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkCommandBuffer': None}
...
mapDict['vkCreateComputePipelines'] =  {'VkPipelineCache': None, 'VkDevice': None, 'VkAllocationCallbacks': None, 'VkPipeline': None, 'VkComputePipelineCreateInfo': None}
mapDict['vkCreateDescriptorPool'] =  {'VkDescriptorPool': None, 'VkDevice': None, 'VkAllocationCallbacks': None, 'VkDescriptorPoolCreateInfo': None}
mapDict['vkCreateDescriptorSetLayout'] =  {'VkDevice': None, 'VkAllocationCallbacks': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkDescriptorSetLayout': None}
...
mapDict['vkCreateFence'] =  {'VkDevice': None, 'VkFenceCreateInfo': None, 'VkFence': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateFramebuffer'] =  {'VkFramebufferCreateInfo': None, 'VkFramebuffer': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkPipelineCache': None, 'VkDevice': None, 'VkAllocationCallbacks': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipeline': None}
mapDict['vkCreateImage'] =  {'VkImageCreateInfo': None, 'VkDevice': None, 'VkAllocationCallbacks': None, 'VkImage': None}
...
mapDict['vkCreatePipelineLayout'] =  {'VkDevice': None, 'VkPipelineLayoutCreateInfo': None, 'VkPipelineLayout': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateQueryPool'] =  {'VkDevice': None, 'VkQueryPoolCreateInfo': None, 'VkQueryPool': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateRenderPass'] =  {'VkDevice': None, 'VkRenderPassCreateInfo': None, 'VkRenderPass': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateSampler'] =  {'VkDevice': None, 'VkAllocationCallbacks': None, 'VkSamplerCreateInfo': None, 'VkSampler': None}
...
mapDict['vkCreateWaylandSurfaceKHR'] =  {'VkSurfaceKHR': None, 'VkInstance': None, 'VkAllocationCallbacks': None, 'VkWaylandSurfaceCreateInfoKHR': None}
...
mapDict['vkDestroyPipeline'] =  {'VkDevice': None, 'VkPipeline': None, 'VkAllocationCallbacks': None}
...
mapDict['vkGetBufferMemoryRequirements'] =  {'VkDevice': None, 'VkBuffer': None, 'VkMemoryRequirements': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkSubresourceLayout': None, 'VkImage': None, 'VkDevice': None, 'VkImageSubresource': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageTiling': None, 'VkImageCreateFlags': None, 'VkFormat': None, 'VkImageUsageFlags': None, 'VkPhysicalDevice': None, 'VkImageFormatProperties': None, 'VkImageType': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageTiling': None, 'VkFormat': None, 'VkImageUsageFlags': None, 'VkSampleCountFlagBits': None, 'VkPhysicalDevice': None, 'VkImageType': None, 'VkSparseImageFormatProperties': None}
...
mapDict['vkMapMemory'] =  {'VkMemoryMapFlags': None, 'VkDevice': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
