...
mapDict['VkAccessFlags'] =  {'VkMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkSubpassDependency': None, 'VkImageMemoryBarrier': None, 'VkAccessFlagBits': None}
mapDict['VkAllocationCallbacks'] =  {'vkDestroyFence': None, 'vkCreateImageView': None, 'vkCreateDescriptorPool': None, 'vkDestroySemaphore': None, 'vkCreatePipelineCache': None, 'vkCreateImage': None, 'vkDestroyDescriptorPool': None, 'vkCreateFence': None, 'vkDestroyInstance': None, 'vkCreatePipelineLayout': None, 'vkDestroyQueryPool': None, 'vkDestroyBufferView': None, 'vkDestroyCommandPool': None, 'vkCreateSampler': None, 'vkCreateInstance': None, 'vkDestroyRenderPass': None, 'vkCreateRenderPass': None, 'vkCreateGraphicsPipelines': None, 'PFN_vkInternalAllocationNotification': None, 'vkCreateShaderModule': None, 'vkDestroyPipelineLayout': None, 'vkDestroyImageView': None, 'vkCreateFramebuffer': None, 'PFN_vkInternalFreeNotification': None, 'vkCreateSharedSwapchainsKHR': None, 'vkDestroyImage': None, 'PFN_vkFreeFunction': None, 'vkDestroyEvent': None, 'vkCreateEvent': None, 'vkDestroyBuffer': None, 'vkDestroyPipeline': None, 'vkFreeMemory': None, 'vkCreateBufferView': None, 'vkCreateComputePipelines': None, 'vkDestroyShaderModule': None, 'vkDestroySampler': None, 'vkDestroyDevice': None, 'vkCreateBuffer': None, 'vkCreateSemaphore': None, 'vkDestroyPipelineCache': None, 'vkDestroyFramebuffer': None, 'vkCreateDevice': None, 'PFN_vkReallocationFunction': None, 'vkAllocateMemory': None, 'PFN_vkAllocationFunction': None, 'vkCreateQueryPool': None, 'vkCreateCommandPool': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyDescriptorSetLayout': None}
mapDict['VkApplicationInfo'] =  {'VkStructureType': None, 'VkInstanceCreateInfo': None}
mapDict['VkAttachmentDescription'] =  {'VkAttachmentDescriptionFlags': None, 'VkAttachmentStoreOp': None, 'VkSampleCountFlagBits': None, 'VkImageLayout': None, 'VkRenderPassCreateInfo': None, 'VkFormat': None, 'VkAttachmentLoadOp': None}
...
mapDict['VkBindSparseInfo'] =  {'vkQueueBindSparse': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'VkSemaphore': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkStructureType': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkSamplerCreateInfo': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPhysicalDeviceLimits': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'vkWaitForFences': None, 'VkDisplayPresentInfoKHR': None, 'VkSwapchainCreateInfoKHR': None, 'VkPhysicalDeviceFeatures': None, 'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdCopyQueryPoolResults': None, 'vkCreateBuffer': None, 'vkCmdFillBuffer': None, 'vkCmdUpdateBuffer': None, 'vkCmdDrawIndirect': None, 'VkBufferMemoryBarrier': None, 'VkBufferViewCreateInfo': None, 'vkCmdBindIndexBuffer': None, 'vkDestroyBuffer': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdBindVertexBuffers': None, 'vkCmdDispatchIndirect': None, 'vkCmdCopyBuffer': None, 'vkCmdDrawIndexedIndirect': None, 'vkGetBufferMemoryRequirements': None, 'vkBindBufferMemory': None, 'vkCmdCopyBufferToImage': None, 'VkDescriptorBufferInfo': None, 'vkCmdCopyImageToBuffer': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkDeviceSize': None, 'VkSharingMode': None, 'vkCreateBuffer': None, 'VkBufferCreateFlags': None, 'VkBufferUsageFlags': None, 'VkStructureType': None}
mapDict['VkBufferImageCopy'] =  {'VkImageSubresourceLayers': None, 'VkDeviceSize': None, 'VkOffset3D': None, 'VkExtent3D': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyImageToBuffer': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkAccessFlags': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkStructureType': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkFormat': None, 'VkBufferViewCreateFlags': None, 'VkStructureType': None, 'vkCreateBufferView': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdSetStencilReference': None, 'vkCmdResetEvent': None, 'vkCmdWriteTimestamp': None, 'vkResetCommandBuffer': None, 'vkCmdFillBuffer': None, 'vkCmdPushConstants': None, 'VkSubmitInfo': None, 'vkCmdCopyImage': None, 'vkCmdNextSubpass': None, 'vkFreeCommandBuffers': None, 'vkCmdSetScissor': None, 'vkBeginCommandBuffer': None, 'vkCmdWaitEvents': None, 'vkCmdSetLineWidth': None, 'vkCmdDraw': None, 'vkCmdExecuteCommands': None, 'vkEndCommandBuffer': None, 'vkCmdDrawIndexed': None, 'vkCmdEndQuery': None, 'vkCmdCopyBufferToImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdBeginQuery': None, 'vkCmdEndRenderPass': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdSetEvent': None, 'vkCmdSetBlendConstants': None, 'vkCmdBindIndexBuffer': None, 'vkCmdUpdateBuffer': None, 'vkCmdResolveImage': None, 'vkCmdBindVertexBuffers': None, 'vkCmdDispatchIndirect': None, 'vkCmdClearAttachments': None, 'vkCmdBeginRenderPass': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdDispatch': None, 'vkCmdResetQueryPool': None, 'vkCmdClearColorImage': None, 'vkCmdBlitImage': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdDrawIndirect': None, 'vkCmdSetDepthBounds': None, 'vkCmdPipelineBarrier': None, 'vkCmdSetDepthBias': None, 'vkCmdBindPipeline': None, 'vkCmdCopyBuffer': None, 'vkCmdSetViewport': None, 'vkCmdBindDescriptorSets': None, 'vkAllocateCommandBuffers': None}
mapDict['VkCommandBufferAllocateInfo'] =  {'VkCommandPool': None, 'VkStructureType': None, 'vkAllocateCommandBuffers': None, 'VkCommandBufferLevel': None}
...
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkQueryControlFlags': None, 'VkCommandBufferBeginInfo': None, 'VkQueryPipelineStatisticFlags': None, 'VkFramebuffer': None, 'VkStructureType': None, 'VkBool32': None, 'VkRenderPass': None}
...
mapDict['VkCommandPool'] =  {'vkFreeCommandBuffers': None, 'vkCreateCommandPool': None, 'vkDestroyCommandPool': None, 'vkResetCommandPool': None, 'VkCommandBufferAllocateInfo': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipelineCreateFlags': None, 'vkCreateComputePipelines': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipeline': None, 'VkPipelineLayout': None, 'VkStructureType': None}
...
mapDict['VkDescriptorPool'] =  {'VkDescriptorSetAllocateInfo': None, 'vkDestroyDescriptorPool': None, 'vkCreateDescriptorPool': None, 'vkResetDescriptorPool': None, 'vkFreeDescriptorSets': None}
...
mapDict['VkDescriptorSet'] =  {'vkCmdBindDescriptorSets': None, 'VkWriteDescriptorSet': None, 'vkAllocateDescriptorSets': None, 'vkFreeDescriptorSets': None, 'VkCopyDescriptorSet': None}
...
mapDict['VkDescriptorSetLayout'] =  {'VkDescriptorSetAllocateInfo': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyDescriptorSetLayout': None, 'VkPipelineLayoutCreateInfo': None}
...
mapDict['VkDescriptorSetLayoutCreateInfo'] =  {'vkCreateDescriptorSetLayout': None, 'VkDescriptorSetLayoutBinding': None, 'VkDescriptorSetLayoutCreateFlags': None, 'VkStructureType': None}
mapDict['VkDescriptorType'] =  {'VkDescriptorSetLayoutBinding': None, 'VkWriteDescriptorSet': None, 'VkDescriptorPoolSize': None}
mapDict['VkDevice'] =  {'vkDestroyFence': None, 'vkCreateImageView': None, 'vkResetFences': None, 'vkDestroySemaphore': None, 'vkMapMemory': None, 'vkGetQueryPoolResults': None, 'vkCreateImage': None, 'vkDestroyDescriptorPool': None, 'vkDestroyQueryPool': None, 'vkCreateDescriptorPool': None, 'vkResetDescriptorPool': None, 'vkCreateFence': None, 'vkCreatePipelineLayout': None, 'vkFlushMappedMemoryRanges': None, 'vkFreeCommandBuffers': None, 'vkDestroyBufferView': None, 'vkGetImageSubresourceLayout': None, 'vkCreateSampler': None, 'vkBindImageMemory': None, 'vkDestroyRenderPass': None, 'vkGetPipelineCacheData': None, 'vkCreateRenderPass': None, 'vkDestroyCommandPool': None, 'vkAllocateDescriptorSets': None, 'vkCreateEvent': None, 'vkCreateGraphicsPipelines': None, 'vkSetEvent': None, 'vkGetEventStatus': None, 'vkGetFenceStatus': None, 'vkCreateShaderModule': None, 'vkDestroyPipelineLayout': None, 'vkDestroyImageView': None, 'vkDeviceWaitIdle': None, 'vkWaitForFences': None, 'vkDestroyPipeline': None, 'vkInvalidateMappedMemoryRanges': None, 'vkBindBufferMemory': None, 'vkResetCommandPool': None, 'vkCreateSharedSwapchainsKHR': None, 'vkDestroyImage': None, 'vkDestroyEvent': None, 'vkGetDeviceQueue': None, 'vkGetDeviceMemoryCommitment': None, 'vkMergePipelineCaches': None, 'vkFreeMemory': None, 'vkGetImageSparseMemoryRequirements': None, 'vkUpdateDescriptorSets': None, 'vkCreateBufferView': None, 'vkFreeDescriptorSets': None, 'vkGetBufferMemoryRequirements': None, 'vkCreateComputePipelines': None, 'vkDestroyShaderModule': None, 'vkDestroySampler': None, 'vkGetImageMemoryRequirements': None, 'vkDestroyDevice': None, 'vkDestroyBuffer': None, 'vkCreateSemaphore': None, 'vkDestroyPipelineCache': None, 'vkUnmapMemory': None, 'vkGetRenderAreaGranularity': None, 'vkDestroyFramebuffer': None, 'vkCreateDevice': None, 'vkGetDeviceProcAddr': None, 'vkCreateDescriptorSetLayout': None, 'vkCreatePipelineCache': None, 'vkAllocateMemory': None, 'vkCreateBuffer': None, 'vkCreateFramebuffer': None, 'vkCreateQueryPool': None, 'vkCreateCommandPool': None, 'vkResetEvent': None, 'vkAllocateCommandBuffers': None, 'vkDestroyDescriptorSetLayout': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkDeviceQueueCreateInfo': None, 'vkCreateDevice': None, 'VkPhysicalDeviceFeatures': None, 'VkStructureType': None, 'VkDeviceCreateFlags': None}
mapDict['VkDeviceMemory'] =  {'vkAllocateMemory': None, 'VkSparseMemoryBind': None, 'vkUnmapMemory': None, 'vkBindImageMemory': None, 'vkMapMemory': None, 'vkBindBufferMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkFreeMemory': None, 'VkSparseImageMemoryBind': None, 'VkMappedMemoryRange': None}
...
mapDict['VkDeviceSize'] =  {'vkCmdCopyQueryPoolResults': None, 'vkBindImageMemory': None, 'VkBufferCopy': None, 'VkMemoryRequirements': None, 'VkPhysicalDeviceLimits': None, 'vkGetQueryPoolResults': None, 'vkCmdFillBuffer': None, 'VkSparseImageMemoryBind': None, 'vkCmdBindIndexBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdDispatchIndirect': None, 'VkBufferImageCopy': None, 'VkDescriptorBufferInfo': None, 'vkCmdUpdateBuffer': None, 'vkGetDeviceMemoryCommitment': None, 'VkBufferMemoryBarrier': None, 'VkImageFormatProperties': None, 'VkSubresourceLayout': None, 'VkMemoryHeap': None, 'vkMapMemory': None, 'VkBufferViewCreateInfo': None, 'VkSparseMemoryBind': None, 'VkSparseImageMemoryRequirements': None, 'VkMappedMemoryRange': None, 'vkCmdDrawIndexedIndirect': None, 'vkBindBufferMemory': None, 'VkBufferCreateInfo': None, 'VkMemoryAllocateInfo': None, 'vkCmdDrawIndirect': None}
...
mapDict['VkEvent'] =  {'vkDestroyEvent': None, 'vkCmdWaitEvents': None, 'vkCmdResetEvent': None, 'vkCreateEvent': None, 'vkCmdSetEvent': None, 'vkGetEventStatus': None, 'vkResetEvent': None, 'vkSetEvent': None}
...
mapDict['VkExtent3D'] =  {'VkImageFormatProperties': None, 'VkImageCreateInfo': None, 'VkQueueFamilyProperties': None, 'VkImageCopy': None, 'VkImageResolve': None, 'VkSparseImageMemoryBind': None, 'VkSparseImageFormatProperties': None, 'VkBufferImageCopy': None}
mapDict['VkFence'] =  {'vkQueueBindSparse': None, 'vkDestroyFence': None, 'vkGetFenceStatus': None, 'vkQueueSubmit': None, 'vkResetFences': None, 'vkCreateFence': None, 'vkWaitForFences': None}
...
mapDict['VkFormat'] =  {'VkAttachmentDescription': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageViewCreateInfo': None, 'VkImageCreateInfo': None, 'VkVertexInputAttributeDescription': None, 'VkBufferViewCreateInfo': None, 'VkSwapchainCreateInfoKHR': None}
...
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipeline': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineCreateFlags': None, 'VkPipelineLayout': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkStructureType': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkRenderPass': None}
mapDict['VkImage'] =  {'vkDestroyImage': None, 'vkCmdClearColorImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBlitImage': None, 'VkImageMemoryBarrier': None, 'VkImageViewCreateInfo': None, 'vkCreateImage': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCmdCopyImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdResolveImage': None, 'VkSparseImageMemoryBindInfo': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkCmdCopyBufferToImage': None, 'vkGetImageSubresourceLayout': None, 'vkGetImageMemoryRequirements': None, 'vkBindImageMemory': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkImageSubresourceLayers': None, 'VkImageSubresourceRange': None, 'VkImageAspectFlagBits': None, 'VkClearAttachment': None, 'VkSparseImageFormatProperties': None, 'VkImageSubresource': None}
...
mapDict['VkImageCreateInfo'] =  {'VkExtent3D': None, 'VkImageTiling': None, 'VkImageUsageFlags': None, 'VkSharingMode': None, 'VkImageLayout': None, 'vkCreateImage': None, 'VkImageType': None, 'VkFormat': None, 'VkImageCreateFlags': None, 'VkStructureType': None, 'VkSampleCountFlagBits': None}
mapDict['VkImageFormatProperties'] =  {'VkExtent3D': None, 'VkSampleCountFlags': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkDeviceSize': None}
mapDict['VkImageLayout'] =  {'VkImageMemoryBarrier': None, 'vkCmdClearColorImage': None, 'vkCmdBlitImage': None, 'vkCmdCopyImage': None, 'VkAttachmentDescription': None, 'VkDescriptorImageInfo': None, 'VkImageCreateInfo': None, 'vkCmdResolveImage': None, 'VkAttachmentReference': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdClearDepthStencilImage': None}
mapDict['VkImageMemoryBarrier'] =  {'VkAccessFlags': None, 'VkImageSubresourceRange': None, 'VkImageLayout': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkStructureType': None, 'VkImage': None}
...
mapDict['VkImageSubresourceLayers'] =  {'VkImageResolve': None, 'VkImageCopy': None, 'VkImageBlit': None, 'VkBufferImageCopy': None, 'VkImageAspectFlags': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageMemoryBarrier': None, 'vkCmdClearColorImage': None, 'vkCmdClearDepthStencilImage': None, 'VkImageViewCreateInfo': None, 'VkImageAspectFlags': None}
...
mapDict['VkImageUsageFlags'] =  {'VkImageUsageFlagBits': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkSwapchainCreateInfoKHR': None, 'VkImageCreateInfo': None}
mapDict['VkImageView'] =  {'vkCreateImageView': None, 'vkDestroyImageView': None, 'VkDescriptorImageInfo': None, 'VkFramebufferCreateInfo': None}
mapDict['VkImageViewCreateFlags'] =  {'VkImageViewCreateInfo': None}
mapDict['VkImageViewCreateInfo'] =  {'vkCreateImageView': None, 'VkComponentMapping': None, 'VkImageSubresourceRange': None, 'VkImageViewType': None, 'VkImageViewCreateFlags': None, 'VkFormat': None, 'VkStructureType': None, 'VkImage': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkDestroyInstance': None, 'vkGetInstanceProcAddr': None, 'vkEnumeratePhysicalDevices': None, 'vkCreateInstance': None}
mapDict['VkInstanceCreateFlags'] =  {'VkInstanceCreateInfo': None}
mapDict['VkInstanceCreateInfo'] =  {'VkApplicationInfo': None, 'VkInstanceCreateFlags': None, 'VkStructureType': None, 'vkCreateInstance': None}
...
mapDict['VkMappedMemoryRange'] =  {'VkDeviceSize': None, 'vkInvalidateMappedMemoryRanges': None, 'VkDeviceMemory': None, 'VkStructureType': None, 'vkFlushMappedMemoryRanges': None}
mapDict['VkMemoryAllocateInfo'] =  {'VkDeviceSize': None, 'VkStructureType': None, 'vkAllocateMemory': None}
mapDict['VkMemoryBarrier'] =  {'vkCmdWaitEvents': None, 'VkAccessFlags': None, 'vkCmdPipelineBarrier': None, 'VkStructureType': None}
...
mapDict['VkMemoryRequirements'] =  {'VkDeviceSize': None, 'vkGetImageMemoryRequirements': None, 'vkGetBufferMemoryRequirements': None}
mapDict['VkMemoryType'] =  {'VkPhysicalDeviceMemoryProperties': None, 'VkMemoryPropertyFlags': None}
mapDict['VkOffset2D'] =  {'VkRect2D': None}
mapDict['VkOffset3D'] =  {'VkImageResolve': None, 'VkImageCopy': None, 'VkImageBlit': None, 'VkSparseImageMemoryBind': None, 'VkBufferImageCopy': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkEnumerateDeviceLayerProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkCreateDevice': None, 'vkGetPhysicalDeviceFeatures': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceProperties': None}
mapDict['VkPhysicalDeviceFeatures'] =  {'VkDeviceCreateInfo': None, 'VkBool32': None, 'vkGetPhysicalDeviceFeatures': None}
mapDict['VkPhysicalDeviceLimits'] =  {'VkDeviceSize': None, 'VkPhysicalDeviceProperties': None, 'VkBool32': None, 'VkSampleCountFlags': None}
...
mapDict['VkPipeline'] =  {'vkCmdBindPipeline': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'vkCreateComputePipelines': None, 'vkDestroyPipeline': None, 'VkComputePipelineCreateInfo': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'vkCmdBindDescriptorSets': None, 'VkSubpassDescription': None}
mapDict['VkPipelineCache'] =  {'vkGetPipelineCacheData': None, 'vkCreatePipelineCache': None, 'vkCreateGraphicsPipelines': None, 'vkCreateComputePipelines': None, 'vkMergePipelineCaches': None, 'vkDestroyPipelineCache': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBlendOp': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkColorComponentFlags': None, 'VkBool32': None, 'VkBlendFactor': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkLogicOp': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineColorBlendStateCreateFlags': None, 'VkPipelineColorBlendAttachmentState': None, 'VkStructureType': None, 'VkBool32': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkCompareOp': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkStructureType': None, 'VkBool32': None, 'VkStencilOpState': None}
...
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkPipelineInputAssemblyStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkBool32': None, 'VkPrimitiveTopology': None}
mapDict['VkPipelineLayout'] =  {'vkDestroyPipelineLayout': None, 'vkCreatePipelineLayout': None, 'VkGraphicsPipelineCreateInfo': None, 'vkCmdBindDescriptorSets': None, 'VkComputePipelineCreateInfo': None, 'vkCmdPushConstants': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkPushConstantRange': None, 'VkDescriptorSetLayout': None, 'vkCreatePipelineLayout': None, 'VkStructureType': None, 'VkPipelineLayoutCreateFlags': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkPipelineMultisampleStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkSampleCountFlagBits': None, 'VkSampleMask': None, 'VkBool32': None, 'VkStructureType': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkPipelineRasterizationStateCreateFlags': None, 'VkFrontFace': None, 'VkCullModeFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPolygonMode': None, 'VkStructureType': None, 'VkBool32': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkShaderModule': None, 'VkShaderStageFlagBits': None, 'VkGraphicsPipelineCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkPipelineShaderStageCreateFlags': None, 'VkSpecializationInfo': None, 'VkStructureType': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'VkSubmitInfo': None, 'VkSubpassDependency': None, 'vkCmdResetEvent': None, 'vkCmdSetEvent': None, 'VkPipelineStageFlagBits': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkPipelineVertexInputStateCreateFlags': None, 'VkVertexInputAttributeDescription': None, 'VkVertexInputBindingDescription': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkRect2D': None, 'VkGraphicsPipelineCreateInfo': None, 'VkStructureType': None, 'VkPipelineViewportStateCreateFlags': None, 'VkViewport': None}
...
mapDict['VkQueryPool'] =  {'vkCmdResetQueryPool': None, 'vkCmdBeginQuery': None, 'vkCmdCopyQueryPoolResults': None, 'vkCreateQueryPool': None, 'vkCmdEndQuery': None, 'vkGetQueryPoolResults': None, 'vkDestroyQueryPool': None, 'vkCmdWriteTimestamp': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkQueryPoolCreateFlags': None, 'VkQueryPipelineStatisticFlags': None, 'VkStructureType': None, 'vkCreateQueryPool': None, 'VkQueryType': None}
...
mapDict['VkRect2D'] =  {'vkCmdSetScissor': None, 'VkOffset2D': None, 'VkExtent2D': None, 'VkDisplayPresentInfoKHR': None, 'VkPipelineViewportStateCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkClearRect': None}
mapDict['VkRenderPass'] =  {'VkGraphicsPipelineCreateInfo': None, 'vkDestroyRenderPass': None, 'vkGetRenderAreaGranularity': None, 'VkFramebufferCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'vkCreateRenderPass': None, 'VkRenderPassBeginInfo': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkClearValue': None, 'VkRect2D': None, 'VkFramebuffer': None, 'vkCmdBeginRenderPass': None, 'VkStructureType': None, 'VkRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkAttachmentDescription': None, 'VkSubpassDependency': None, 'VkSubpassDescription': None, 'VkRenderPassCreateFlags': None, 'vkCreateRenderPass': None, 'VkStructureType': None}
mapDict['VkSampleCountFlagBits'] =  {'VkPipelineMultisampleStateCreateInfo': None, 'VkSampleCountFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkAttachmentDescription': None, 'VkImageCreateInfo': None}
...
mapDict['VkSampler'] =  {'vkDestroySampler': None, 'VkDescriptorImageInfo': None, 'vkCreateSampler': None, 'VkDescriptorSetLayoutBinding': None}
mapDict['VkSamplerAddressMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateFlags'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateInfo'] =  {'VkFilter': None, 'VkSamplerCreateFlags': None, 'vkCreateSampler': None, 'VkBorderColor': None, 'VkSamplerAddressMode': None, 'VkSamplerMipmapMode': None, 'VkStructureType': None, 'VkBool32': None, 'VkCompareOp': None}
mapDict['VkSamplerMipmapMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSemaphore'] =  {'VkSubmitInfo': None, 'vkCreateSemaphore': None, 'vkDestroySemaphore': None, 'VkBindSparseInfo': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'VkExtent3D': None, 'VkSparseImageFormatFlags': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageMemoryRequirements': None, 'VkImageAspectFlags': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkExtent3D': None, 'VkOffset3D': None, 'VkSparseImageMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkDeviceSize': None, 'VkSparseMemoryBindFlags': None, 'VkImageSubresource': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkDeviceSize': None, 'VkDeviceMemory': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None}
...
mapDict['VkStructureType'] =  {'VkApplicationInfo': None, 'VkImageMemoryBarrier': None, 'VkBufferViewCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkBindSparseInfo': None, 'VkSubmitInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkCommandPoolCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkDisplayPresentInfoKHR': None, 'VkMappedMemoryRange': None, 'VkInstanceCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkBufferCreateInfo': None, 'VkSemaphoreCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkFenceCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkCommandBufferBeginInfo': None, 'VkEventCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkMemoryBarrier': None, 'VkCommandBufferAllocateInfo': None, 'VkBufferMemoryBarrier': None, 'VkComputePipelineCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkImageCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkRenderPassBeginInfo': None, 'VkMemoryAllocateInfo': None}
mapDict['VkSubmitInfo'] =  {'VkSemaphore': None, 'vkQueueSubmit': None, 'VkStructureType': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None}
mapDict['VkSubpassContents'] =  {'vkCmdBeginRenderPass': None, 'vkCmdNextSubpass': None}
mapDict['VkSubpassDependency'] =  {'VkAccessFlags': None, 'VkRenderPassCreateInfo': None, 'VkPipelineStageFlags': None, 'VkDependencyFlags': None}
...
mapDict['VkSwapchainCreateInfoKHR'] =  {'VkImageUsageFlags': None, 'VkSharingMode': None, 'VkExtent2D': None, 'VkColorSpaceKHR': None, 'VkPresentModeKHR': None, 'VkBool32': None, 'VkSwapchainKHR': None, 'VkSurfaceTransformFlagBitsKHR': None, 'VkSwapchainCreateFlagsKHR': None, 'VkFormat': None, 'VkSurfaceKHR': None, 'VkStructureType': None, 'VkCompositeAlphaFlagBitsKHR': None, 'vkCreateSharedSwapchainsKHR': None}
mapDict['VkSwapchainKHR'] =  {'VkSwapchainCreateInfoKHR': None, 'vkCreateSharedSwapchainsKHR': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkDescriptorImageInfo': None, 'VkDescriptorSet': None, 'VkDescriptorType': None, 'VkDescriptorBufferInfo': None, 'vkUpdateDescriptorSets': None, 'VkStructureType': None, 'VkBufferView': None}
mapDict['vkAllocateCommandBuffers'] =  {'VkCommandBufferAllocateInfo': None, 'VkDevice': None, 'VkCommandBuffer': None}
mapDict['vkAllocateDescriptorSets'] =  {'VkDescriptorSetAllocateInfo': None, 'VkDevice': None, 'VkDescriptorSet': None}
mapDict['vkAllocateMemory'] =  {'VkAllocationCallbacks': None, 'VkDeviceMemory': None, 'VkDevice': None, 'VkMemoryAllocateInfo': None}
...
mapDict['vkBindImageMemory'] =  {'VkDeviceMemory': None, 'VkDevice': None, 'VkDeviceSize': None, 'VkImage': None}
...
mapDict['vkCmdBindIndexBuffer'] =  {'VkDeviceSize': None, 'VkBuffer': None, 'VkCommandBuffer': None, 'VkIndexType': None}
...
mapDict['vkCmdBlitImage'] =  {'VkFilter': None, 'VkImageBlit': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImage': None}
mapDict['vkCmdClearAttachments'] =  {'VkClearAttachment': None, 'VkClearRect': None, 'VkCommandBuffer': None}
mapDict['vkCmdClearColorImage'] =  {'VkClearColorValue': None, 'VkImageSubresourceRange': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImage': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkClearDepthStencilValue': None, 'VkImageSubresourceRange': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImage': None}
mapDict['vkCmdCopyBuffer'] =  {'VkBuffer': None, 'VkBufferCopy': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyBufferToImage'] =  {'VkBuffer': None, 'VkBufferImageCopy': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImage': None}
mapDict['vkCmdCopyImage'] =  {'VkImageCopy': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImage': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkBuffer': None, 'VkBufferImageCopy': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImage': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkQueryResultFlags': None, 'VkDeviceSize': None, 'VkBuffer': None, 'VkQueryPool': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkImageMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkCommandBuffer': None, 'VkDependencyFlags': None}
mapDict['vkCmdPushConstants'] =  {'VkShaderStageFlags': None, 'VkPipelineLayout': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdResolveImage'] =  {'VkImageResolve': None, 'VkImageLayout': None, 'VkCommandBuffer': None, 'VkImage': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkImageMemoryBarrier': None, 'VkEvent': None, 'VkPipelineStageFlags': None, 'VkBufferMemoryBarrier': None, 'VkMemoryBarrier': None, 'VkCommandBuffer': None}
...
mapDict['vkCreateBufferView'] =  {'VkAllocationCallbacks': None, 'VkBufferViewCreateInfo': None, 'VkDevice': None, 'VkBufferView': None}
mapDict['vkCreateCommandPool'] =  {'VkAllocationCallbacks': None, 'VkCommandPool': None, 'VkDevice': None, 'VkCommandPoolCreateInfo': None}
...
mapDict['vkCreateDescriptorPool'] =  {'VkAllocationCallbacks': None, 'VkDescriptorPool': None, 'VkDevice': None, 'VkDescriptorPoolCreateInfo': None}
mapDict['vkCreateDescriptorSetLayout'] =  {'VkAllocationCallbacks': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkDescriptorSetLayout': None, 'VkDevice': None}
mapDict['vkCreateDevice'] =  {'VkPhysicalDevice': None, 'VkDevice': None, 'VkAllocationCallbacks': None, 'VkDeviceCreateInfo': None}
mapDict['vkCreateEvent'] =  {'VkAllocationCallbacks': None, 'VkEventCreateInfo': None, 'VkDevice': None, 'VkEvent': None}
...
mapDict['vkCreateGraphicsPipelines'] =  {'VkPipelineCache': None, 'VkPipeline': None, 'VkDevice': None, 'VkGraphicsPipelineCreateInfo': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateImage'] =  {'VkAllocationCallbacks': None, 'VkImageCreateInfo': None, 'VkDevice': None, 'VkImage': None}
mapDict['vkCreateImageView'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkImageView': None, 'VkImageViewCreateInfo': None}
mapDict['vkCreateInstance'] =  {'VkInstance': None, 'VkAllocationCallbacks': None, 'VkInstanceCreateInfo': None}
mapDict['vkCreatePipelineCache'] =  {'VkAllocationCallbacks': None, 'VkPipelineCache': None, 'VkDevice': None, 'VkPipelineCacheCreateInfo': None}
mapDict['vkCreatePipelineLayout'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPipelineLayout': None, 'VkPipelineLayoutCreateInfo': None}
mapDict['vkCreateQueryPool'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkQueryPool': None, 'VkQueryPoolCreateInfo': None}
mapDict['vkCreateRenderPass'] =  {'VkAllocationCallbacks': None, 'VkRenderPass': None, 'VkDevice': None, 'VkRenderPassCreateInfo': None}
mapDict['vkCreateSampler'] =  {'VkSamplerCreateInfo': None, 'VkSampler': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateSemaphore'] =  {'VkAllocationCallbacks': None, 'VkSemaphore': None, 'VkSemaphoreCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateShaderModule'] =  {'VkAllocationCallbacks': None, 'VkShaderModule': None, 'VkDevice': None, 'VkShaderModuleCreateInfo': None}
mapDict['vkCreateSharedSwapchainsKHR'] =  {'VkSwapchainCreateInfoKHR': None, 'VkSwapchainKHR': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkImageSubresource': None, 'VkDevice': None, 'VkSubresourceLayout': None, 'VkImage': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageTiling': None, 'VkImageType': None, 'VkImageFormatProperties': None, 'VkImageUsageFlags': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkImageCreateFlags': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageTiling': None, 'VkImageType': None, 'VkImageUsageFlags': None, 'VkSparseImageFormatProperties': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkSampleCountFlagBits': None}
