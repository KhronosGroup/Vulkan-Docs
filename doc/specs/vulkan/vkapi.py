...
mapDict['VkAccessFlags'] =  {'VkMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkAccessFlagBits': None, 'VkImageMemoryBarrier': None, 'VkSubpassDependency': None}
mapDict['VkAllocationCallbacks'] =  {'vkDestroyRenderPass': None, 'vkDestroyInstance': None, 'vkCreateImageView': None, 'vkAllocateMemory': None, 'vkCreateBuffer': None, 'vkCreateComputePipelines': None, 'PFN_vkReallocationFunction': None, 'vkDestroyQueryPool': None, 'vkCreateDevice': None, 'vkCreateEvent': None, 'vkCreateSemaphore': None, 'vkCreateInstance': None, 'vkDestroyFramebuffer': None, 'vkCreateDescriptorPool': None, 'vkCreateBufferView': None, 'vkFreeMemory': None, 'vkDestroyImageView': None, 'vkCreateGraphicsPipelines': None, 'vkCreateXlibSurfaceKHR': None, 'vkDestroyEvent': None, 'vkDestroyBuffer': None, 'PFN_vkInternalAllocationNotification': None, 'vkDestroyFence': None, 'vkDestroySampler': None, 'vkCreateFence': None, 'vkCreateSampler': None, 'vkDestroyImage': None, 'vkCreatePipelineLayout': None, 'vkCreateCommandPool': None, 'vkDestroyCommandPool': None, 'vkCreateQueryPool': None, 'vkDestroyPipelineCache': None, 'PFN_vkFreeFunction': None, 'PFN_vkInternalFreeNotification': None, 'vkCreateShaderModule': None, 'PFN_vkAllocationFunction': None, 'vkDestroyShaderModule': None, 'vkDestroyPipelineLayout': None, 'vkDestroySemaphore': None, 'vkDestroyBufferView': None, 'vkCreateImage': None, 'vkDestroyPipeline': None, 'vkCreateFramebuffer': None, 'vkDestroyDevice': None, 'vkCreatePipelineCache': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateRenderPass': None, 'vkDestroyDescriptorPool': None}
mapDict['VkApplicationInfo'] =  {'VkInstanceCreateInfo': None, 'VkStructureType': None}
mapDict['VkAttachmentDescription'] =  {'VkAttachmentStoreOp': None, 'VkSampleCountFlagBits': None, 'VkAttachmentDescriptionFlags': None, 'VkImageLayout': None, 'VkRenderPassCreateInfo': None, 'VkAttachmentLoadOp': None, 'VkFormat': None}
...
mapDict['VkBindSparseInfo'] =  {'VkSparseBufferMemoryBindInfo': None, 'vkQueueBindSparse': None, 'VkSemaphore': None, 'VkStructureType': None, 'VkSparseImageMemoryBindInfo': None, 'VkSparseImageOpaqueMemoryBindInfo': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineColorBlendStateCreateInfo': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPhysicalDeviceLimits': None, 'VkPipelineMultisampleStateCreateInfo': None, 'vkWaitForFences': None, 'VkCommandBufferInheritanceInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkPhysicalDeviceFeatures': None, 'VkSamplerCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'VkBufferMemoryBarrier': None, 'vkCmdUpdateBuffer': None, 'vkBindBufferMemory': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdFillBuffer': None, 'vkCreateBuffer': None, 'vkCmdCopyBufferToImage': None, 'vkCmdDrawIndexedIndirect': None, 'vkDestroyBuffer': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdDrawIndirect': None, 'vkCmdBindVertexBuffers': None, 'vkCmdCopyQueryPoolResults': None, 'vkGetBufferMemoryRequirements': None, 'vkCmdDispatchIndirect': None, 'VkBufferViewCreateInfo': None, 'vkCmdCopyBuffer': None, 'vkCmdBindIndexBuffer': None, 'VkDescriptorBufferInfo': None}
...
mapDict['VkBufferCreateInfo'] =  {'VkStructureType': None, 'VkSharingMode': None, 'vkCreateBuffer': None, 'VkBufferUsageFlags': None, 'VkBufferCreateFlags': None, 'VkDeviceSize': None}
mapDict['VkBufferImageCopy'] =  {'vkCmdCopyImageToBuffer': None, 'VkExtent3D': None, 'VkImageSubresourceLayers': None, 'VkDeviceSize': None, 'vkCmdCopyBufferToImage': None, 'VkOffset3D': None}
mapDict['VkBufferMemoryBarrier'] =  {'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkAccessFlags': None, 'VkBuffer': None, 'VkStructureType': None, 'VkDeviceSize': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkFormat': None, 'vkCreateBufferView': None, 'VkBufferViewCreateFlags': None, 'VkStructureType': None, 'VkBuffer': None, 'VkDeviceSize': None}
...
mapDict['VkCommandBuffer'] =  {'vkEndCommandBuffer': None, 'vkCmdCopyBufferToImage': None, 'vkFreeCommandBuffers': None, 'vkCmdBindDescriptorSets': None, 'vkCmdPipelineBarrier': None, 'vkCmdBeginRenderPass': None, 'vkCmdResolveImage': None, 'vkCmdBindIndexBuffer': None, 'vkCmdEndRenderPass': None, 'vkCmdSetStencilReference': None, 'vkCmdNextSubpass': None, 'vkCmdSetStencilCompareMask': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdBeginQuery': None, 'vkCmdEndQuery': None, 'vkCmdCopyBuffer': None, 'VkSubmitInfo': None, 'vkCmdSetScissor': None, 'vkCmdClearColorImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdDrawIndexed': None, 'vkCmdSetLineWidth': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdCopyImage': None, 'vkCmdSetViewport': None, 'vkAllocateCommandBuffers': None, 'vkCmdSetBlendConstants': None, 'vkCmdSetDepthBounds': None, 'vkCmdDrawIndirect': None, 'vkCmdBindPipeline': None, 'vkCmdResetEvent': None, 'vkCmdExecuteCommands': None, 'vkCmdFillBuffer': None, 'vkCmdResetQueryPool': None, 'vkCmdSetEvent': None, 'vkCmdUpdateBuffer': None, 'vkCmdBindVertexBuffers': None, 'vkCmdClearAttachments': None, 'vkCmdSetDepthBias': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdDispatch': None, 'vkCmdPushConstants': None, 'vkCmdDraw': None, 'vkBeginCommandBuffer': None, 'vkCmdWaitEvents': None, 'vkCmdWriteTimestamp': None, 'vkResetCommandBuffer': None, 'vkCmdDispatchIndirect': None, 'vkCmdBlitImage': None}
...
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkFramebuffer': None, 'VkQueryPipelineStatisticFlags': None, 'VkCommandBufferBeginInfo': None, 'VkBool32': None, 'VkStructureType': None, 'VkRenderPass': None, 'VkQueryControlFlags': None}
...
mapDict['VkCommandPool'] =  {'vkFreeCommandBuffers': None, 'VkCommandBufferAllocateInfo': None, 'vkDestroyCommandPool': None, 'vkResetCommandPool': None, 'vkCreateCommandPool': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipelineLayout': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineCreateFlags': None, 'VkStructureType': None, 'VkPipeline': None, 'vkCreateComputePipelines': None}
...
mapDict['VkDescriptorPool'] =  {'VkDescriptorSetAllocateInfo': None, 'vkFreeDescriptorSets': None, 'vkDestroyDescriptorPool': None, 'vkResetDescriptorPool': None, 'vkCreateDescriptorPool': None}
...
mapDict['VkDescriptorPoolCreateInfo'] =  {'VkStructureType': None, 'VkDescriptorPoolSize': None, 'VkDescriptorPoolCreateFlags': None, 'vkCreateDescriptorPool': None}
...
mapDict['VkDescriptorSet'] =  {'vkFreeDescriptorSets': None, 'VkWriteDescriptorSet': None, 'VkCopyDescriptorSet': None, 'vkCmdBindDescriptorSets': None, 'vkAllocateDescriptorSets': None}
...
mapDict['VkDescriptorSetLayout'] =  {'VkDescriptorSetAllocateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyDescriptorSetLayout': None}
...
mapDict['VkDescriptorSetLayoutCreateInfo'] =  {'VkDescriptorSetLayoutCreateFlags': None, 'VkStructureType': None, 'vkCreateDescriptorSetLayout': None, 'VkDescriptorSetLayoutBinding': None}
mapDict['VkDescriptorType'] =  {'VkWriteDescriptorSet': None, 'VkDescriptorSetLayoutBinding': None, 'VkDescriptorPoolSize': None}
mapDict['VkDevice'] =  {'vkDestroyRenderPass': None, 'vkCreateImageView': None, 'vkAllocateMemory': None, 'vkCreateBuffer': None, 'vkGetImageMemoryRequirements': None, 'vkInvalidateMappedMemoryRanges': None, 'vkCreateComputePipelines': None, 'vkCreateQueryPool': None, 'vkFreeCommandBuffers': None, 'vkAllocateCommandBuffers': None, 'vkSetEvent': None, 'vkCreateDevice': None, 'vkCreateEvent': None, 'vkCreateSemaphore': None, 'vkMergePipelineCaches': None, 'vkDestroyFramebuffer': None, 'vkGetDeviceMemoryCommitment': None, 'vkDestroyDescriptorPool': None, 'vkUpdateDescriptorSets': None, 'vkWaitForFences': None, 'vkDestroySemaphore': None, 'vkGetFenceStatus': None, 'vkCreateBufferView': None, 'vkFlushMappedMemoryRanges': None, 'vkDestroyImageView': None, 'vkCreateGraphicsPipelines': None, 'vkResetFences': None, 'vkFreeDescriptorSets': None, 'vkUnmapMemory': None, 'vkDestroyImage': None, 'vkResetCommandPool': None, 'vkDestroyFence': None, 'vkGetPipelineCacheData': None, 'vkDestroySampler': None, 'vkCreateFence': None, 'vkCreateSampler': None, 'vkGetDeviceQueue': None, 'vkCreateDescriptorPool': None, 'vkMapMemory': None, 'vkDestroyEvent': None, 'vkGetDeviceProcAddr': None, 'vkAllocateDescriptorSets': None, 'vkCreatePipelineLayout': None, 'vkCreateCommandPool': None, 'vkDestroyCommandPool': None, 'vkGetEventStatus': None, 'vkDestroyBuffer': None, 'vkGetImageSparseMemoryRequirements': None, 'vkGetQueryPoolResults': None, 'vkDestroyPipelineCache': None, 'vkGetBufferMemoryRequirements': None, 'vkBindImageMemory': None, 'vkCreateShaderModule': None, 'vkDestroyShaderModule': None, 'vkDeviceWaitIdle': None, 'vkBindBufferMemory': None, 'vkDestroyPipelineLayout': None, 'vkResetDescriptorPool': None, 'vkDestroyBufferView': None, 'vkGetImageSubresourceLayout': None, 'vkCreateImage': None, 'vkDestroyPipeline': None, 'vkDestroyQueryPool': None, 'vkCreateFramebuffer': None, 'vkGetRenderAreaGranularity': None, 'vkDestroyDevice': None, 'vkCreatePipelineCache': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyDescriptorSetLayout': None, 'vkCreateRenderPass': None, 'vkResetEvent': None, 'vkFreeMemory': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkDeviceCreateFlags': None, 'VkDeviceQueueCreateInfo': None, 'VkStructureType': None, 'VkPhysicalDeviceFeatures': None, 'vkCreateDevice': None}
mapDict['VkDeviceMemory'] =  {'VkSparseImageMemoryBind': None, 'vkBindBufferMemory': None, 'vkMapMemory': None, 'vkAllocateMemory': None, 'vkBindImageMemory': None, 'vkFreeMemory': None, 'VkSparseMemoryBind': None, 'vkGetDeviceMemoryCommitment': None, 'vkUnmapMemory': None, 'VkMappedMemoryRange': None}
...
mapDict['VkDeviceSize'] =  {'VkSparseImageMemoryBind': None, 'VkSparseImageMemoryRequirements': None, 'vkGetDeviceMemoryCommitment': None, 'VkBufferCopy': None, 'VkPhysicalDeviceLimits': None, 'VkSubresourceLayout': None, 'vkCmdDrawIndexedIndirect': None, 'vkGetQueryPoolResults': None, 'vkCmdBindVertexBuffers': None, 'vkBindImageMemory': None, 'VkBufferViewCreateInfo': None, 'vkMapMemory': None, 'VkMappedMemoryRange': None, 'vkCmdDrawIndirect': None, 'VkImageFormatProperties': None, 'VkBufferCreateInfo': None, 'VkBufferMemoryBarrier': None, 'vkCmdUpdateBuffer': None, 'vkBindBufferMemory': None, 'VkBufferImageCopy': None, 'vkCmdFillBuffer': None, 'vkCmdDispatchIndirect': None, 'VkMemoryAllocateInfo': None, 'VkSparseMemoryBind': None, 'vkCmdBindIndexBuffer': None, 'vkCmdCopyQueryPoolResults': None, 'VkMemoryHeap': None, 'VkMemoryRequirements': None, 'VkDescriptorBufferInfo': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkCmdSetEvent': None, 'vkSetEvent': None, 'vkCreateEvent': None, 'vkDestroyEvent': None, 'vkCmdWaitEvents': None, 'vkResetEvent': None, 'vkGetEventStatus': None, 'vkCmdResetEvent': None}
...
mapDict['VkExtent3D'] =  {'VkSparseImageMemoryBind': None, 'VkSparseImageFormatProperties': None, 'VkImageResolve': None, 'VkBufferImageCopy': None, 'VkImageCopy': None, 'VkImageCreateInfo': None, 'VkQueueFamilyProperties': None, 'VkImageFormatProperties': None}
mapDict['VkFence'] =  {'vkQueueBindSparse': None, 'vkGetFenceStatus': None, 'vkQueueSubmit': None, 'vkDestroyFence': None, 'vkWaitForFences': None, 'vkCreateFence': None, 'vkResetFences': None}
...
mapDict['VkFormat'] =  {'VkImageCreateInfo': None, 'vkGetPhysicalDeviceFormatProperties': None, 'VkImageViewCreateInfo': None, 'VkVertexInputAttributeDescription': None, 'VkBufferViewCreateInfo': None, 'VkAttachmentDescription': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None}
...
mapDict['VkFramebuffer'] =  {'VkCommandBufferInheritanceInfo': None, 'VkRenderPassBeginInfo': None, 'vkDestroyFramebuffer': None, 'vkCreateFramebuffer': None}
mapDict['VkFramebufferCreateFlags'] =  {'VkFramebufferCreateInfo': None}
mapDict['VkFramebufferCreateInfo'] =  {'VkImageView': None, 'VkStructureType': None, 'VkRenderPass': None, 'vkCreateFramebuffer': None, 'VkFramebufferCreateFlags': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineColorBlendStateCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineCreateFlags': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipeline': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkStructureType': None, 'VkRenderPass': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineLayout': None, 'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkImage'] =  {'vkCmdClearColorImage': None, 'vkCmdClearDepthStencilImage': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkCmdCopyImage': None, 'vkGetImageSubresourceLayout': None, 'vkCreateImage': None, 'vkCmdCopyBufferToImage': None, 'VkImageViewCreateInfo': None, 'vkCmdCopyImageToBuffer': None, 'vkGetImageSparseMemoryRequirements': None, 'VkSparseImageMemoryBindInfo': None, 'VkImageMemoryBarrier': None, 'vkDestroyImage': None, 'vkBindImageMemory': None, 'vkCmdResolveImage': None, 'vkGetImageMemoryRequirements': None, 'vkCmdBlitImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkSparseImageFormatProperties': None, 'VkImageSubresourceLayers': None, 'VkImageSubresource': None, 'VkClearAttachment': None, 'VkImageSubresourceRange': None, 'VkImageAspectFlagBits': None}
...
mapDict['VkImageCreateInfo'] =  {'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkImageCreateFlags': None, 'VkExtent3D': None, 'VkFormat': None, 'VkImageTiling': None, 'vkCreateImage': None, 'VkImageType': None, 'VkImageLayout': None, 'VkStructureType': None, 'VkSharingMode': None}
mapDict['VkImageFormatProperties'] =  {'vkGetPhysicalDeviceImageFormatProperties': None, 'VkExtent3D': None, 'VkSampleCountFlags': None, 'VkDeviceSize': None}
mapDict['VkImageLayout'] =  {'vkCmdClearColorImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdCopyImage': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyImageToBuffer': None, 'VkImageMemoryBarrier': None, 'VkImageCreateInfo': None, 'VkDescriptorImageInfo': None, 'VkAttachmentDescription': None, 'vkCmdResolveImage': None, 'VkAttachmentReference': None, 'vkCmdBlitImage': None}
mapDict['VkImageMemoryBarrier'] =  {'VkImage': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkAccessFlags': None, 'VkImageSubresourceRange': None, 'VkStructureType': None, 'VkImageLayout': None}
mapDict['VkImageResolve'] =  {'vkCmdResolveImage': None, 'VkExtent3D': None, 'VkImageSubresourceLayers': None, 'VkOffset3D': None}
mapDict['VkImageSubresource'] =  {'VkSparseImageMemoryBind': None, 'vkGetImageSubresourceLayout': None, 'VkImageAspectFlags': None}
mapDict['VkImageSubresourceLayers'] =  {'VkImageBlit': None, 'VkImageResolve': None, 'VkImageCopy': None, 'VkBufferImageCopy': None, 'VkImageAspectFlags': None}
mapDict['VkImageSubresourceRange'] =  {'vkCmdClearColorImage': None, 'vkCmdClearDepthStencilImage': None, 'VkImageMemoryBarrier': None, 'VkImageViewCreateInfo': None, 'VkImageAspectFlags': None}
...
mapDict['VkImageViewCreateInfo'] =  {'VkComponentMapping': None, 'VkImage': None, 'VkFormat': None, 'VkImageViewCreateFlags': None, 'VkImageSubresourceRange': None, 'VkStructureType': None, 'VkImageViewType': None, 'vkCreateImageView': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkGetInstanceProcAddr': None, 'vkCreateXlibSurfaceKHR': None, 'vkDestroyInstance': None, 'vkEnumeratePhysicalDevices': None, 'vkCreateInstance': None}
mapDict['VkInstanceCreateFlags'] =  {'VkInstanceCreateInfo': None}
mapDict['VkInstanceCreateInfo'] =  {'VkInstanceCreateFlags': None, 'VkStructureType': None, 'vkCreateInstance': None, 'VkApplicationInfo': None}
...
mapDict['VkMappedMemoryRange'] =  {'vkFlushMappedMemoryRanges': None, 'VkStructureType': None, 'vkInvalidateMappedMemoryRanges': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
...
mapDict['VkOffset3D'] =  {'VkSparseImageMemoryBind': None, 'VkImageBlit': None, 'VkImageResolve': None, 'VkImageCopy': None, 'VkBufferImageCopy': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceXlibPresentationSupportKHR': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkCreateDevice': None, 'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceFeatures': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetPhysicalDeviceProperties': None}
mapDict['VkPhysicalDeviceFeatures'] =  {'VkBool32': None, 'VkDeviceCreateInfo': None, 'vkGetPhysicalDeviceFeatures': None}
mapDict['VkPhysicalDeviceLimits'] =  {'VkBool32': None, 'VkPhysicalDeviceProperties': None, 'VkSampleCountFlags': None, 'VkDeviceSize': None}
mapDict['VkPhysicalDeviceMemoryProperties'] =  {'vkGetPhysicalDeviceMemoryProperties': None, 'VkMemoryType': None, 'VkMemoryHeap': None}
mapDict['VkPhysicalDeviceProperties'] =  {'VkPhysicalDeviceSparseProperties': None, 'VkPhysicalDeviceType': None, 'vkGetPhysicalDeviceProperties': None, 'VkPhysicalDeviceLimits': None}
...
mapDict['VkPipeline'] =  {'vkCmdBindPipeline': None, 'VkGraphicsPipelineCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'vkDestroyPipeline': None, 'vkCreateGraphicsPipelines': None, 'vkCreateComputePipelines': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'VkSubpassDescription': None, 'vkCmdBindDescriptorSets': None}
mapDict['VkPipelineCache'] =  {'vkCreatePipelineCache': None, 'vkDestroyPipelineCache': None, 'vkMergePipelineCaches': None, 'vkGetPipelineCacheData': None, 'vkCreateGraphicsPipelines': None, 'vkCreateComputePipelines': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBlendFactor': None, 'VkBool32': None, 'VkBlendOp': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkColorComponentFlags': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkPipelineColorBlendStateCreateFlags': None, 'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None, 'VkStructureType': None, 'VkPipelineColorBlendAttachmentState': None, 'VkLogicOp': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkCompareOp': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkStencilOpState': None, 'VkBool32': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateFlags'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkPipelineDynamicStateCreateInfo'] =  {'VkDynamicState': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineDynamicStateCreateFlags': None}
mapDict['VkPipelineInputAssemblyStateCreateFlags'] =  {'VkPipelineInputAssemblyStateCreateInfo': None}
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkBool32': None, 'VkStructureType': None, 'VkPrimitiveTopology': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineInputAssemblyStateCreateFlags': None}
mapDict['VkPipelineLayout'] =  {'vkCmdBindDescriptorSets': None, 'vkCreatePipelineLayout': None, 'VkGraphicsPipelineCreateInfo': None, 'vkDestroyPipelineLayout': None, 'VkComputePipelineCreateInfo': None, 'vkCmdPushConstants': None}
...
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkSampleCountFlagBits': None, 'VkPipelineMultisampleStateCreateFlags': None, 'VkSampleMask': None, 'VkBool32': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkCullModeFlags': None, 'VkPipelineRasterizationStateCreateFlags': None, 'VkFrontFace': None, 'VkPolygonMode': None, 'VkBool32': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkShaderModule': None, 'VkComputePipelineCreateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineShaderStageCreateFlags': None, 'VkStructureType': None, 'VkSpecializationInfo': None, 'VkShaderStageFlagBits': None}
mapDict['VkPipelineStageFlagBits'] =  {'VkPipelineStageFlags': None, 'vkCmdWriteTimestamp': None}
mapDict['VkPipelineStageFlags'] =  {'vkCmdSetEvent': None, 'vkCmdResetEvent': None, 'vkCmdWaitEvents': None, 'VkPipelineStageFlagBits': None, 'VkSubmitInfo': None, 'vkCmdPipelineBarrier': None, 'VkSubpassDependency': None}
mapDict['VkPipelineTessellationStateCreateFlags'] =  {'VkPipelineTessellationStateCreateInfo': None}
mapDict['VkPipelineTessellationStateCreateInfo'] =  {'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineTessellationStateCreateFlags': None}
mapDict['VkPipelineVertexInputStateCreateFlags'] =  {'VkPipelineVertexInputStateCreateInfo': None}
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkPipelineVertexInputStateCreateFlags': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkVertexInputBindingDescription': None, 'VkVertexInputAttributeDescription': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkPipelineViewportStateCreateFlags': None, 'VkViewport': None, 'VkStructureType': None, 'VkGraphicsPipelineCreateInfo': None, 'VkRect2D': None}
...
mapDict['VkQueryPool'] =  {'vkDestroyQueryPool': None, 'vkCmdBeginQuery': None, 'vkCmdEndQuery': None, 'vkCmdWriteTimestamp': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdResetQueryPool': None, 'vkGetQueryPoolResults': None, 'vkCreateQueryPool': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'VkQueryPoolCreateFlags': None, 'vkCreateQueryPool': None, 'VkStructureType': None, 'VkQueryPipelineStatisticFlags': None, 'VkQueryType': None}
...
mapDict['VkRect2D'] =  {'VkExtent2D': None, 'VkPipelineViewportStateCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkOffset2D': None, 'VkClearRect': None, 'vkCmdSetScissor': None}
mapDict['VkRenderPass'] =  {'VkFramebufferCreateInfo': None, 'vkDestroyRenderPass': None, 'VkRenderPassBeginInfo': None, 'vkGetRenderAreaGranularity': None, 'vkCreateRenderPass': None, 'VkCommandBufferInheritanceInfo': None, 'VkGraphicsPipelineCreateInfo': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkFramebuffer': None, 'VkClearValue': None, 'vkCmdBeginRenderPass': None, 'VkRect2D': None, 'VkStructureType': None, 'VkRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkRenderPassCreateFlags': None, 'vkCreateRenderPass': None, 'VkAttachmentDescription': None, 'VkStructureType': None, 'VkSubpassDescription': None, 'VkSubpassDependency': None}
...
mapDict['VkSampler'] =  {'VkDescriptorImageInfo': None, 'VkDescriptorSetLayoutBinding': None, 'vkDestroySampler': None, 'vkCreateSampler': None}
mapDict['VkSamplerAddressMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateFlags'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSamplerCreateInfo'] =  {'VkBorderColor': None, 'VkCompareOp': None, 'VkFilter': None, 'VkSamplerAddressMode': None, 'VkBool32': None, 'VkStructureType': None, 'vkCreateSampler': None, 'VkSamplerCreateFlags': None, 'VkSamplerMipmapMode': None}
...
mapDict['VkShaderStageFlags'] =  {'VkPushConstantRange': None, 'VkDescriptorSetLayoutBinding': None, 'VkShaderStageFlagBits': None, 'vkCmdPushConstants': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageMemoryRequirements': None, 'VkExtent3D': None, 'VkSparseImageFormatFlags': None, 'VkImageAspectFlags': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkSparseMemoryBindFlags': None, 'VkExtent3D': None, 'VkImageSubresource': None, 'VkOffset3D': None, 'VkSparseImageMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkSparseBufferMemoryBindInfo': None, 'VkSparseMemoryBindFlags': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkDeviceMemory': None, 'VkDeviceSize': None}
...
mapDict['VkStencilFaceFlags'] =  {'VkStencilFaceFlagBits': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdSetStencilReference': None, 'vkCmdSetStencilCompareMask': None}
...
mapDict['VkStructureType'] =  {'VkDeviceQueueCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkInstanceCreateInfo': None, 'VkComputePipelineCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkEventCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkBufferCreateInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkFramebufferCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkBindSparseInfo': None, 'VkMemoryBarrier': None, 'VkPipelineLayoutCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkRenderPassCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkXlibSurfaceCreateInfoKHR': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkShaderModuleCreateInfo': None, 'VkMemoryAllocateInfo': None, 'VkImageMemoryBarrier': None, 'VkFenceCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkCommandBufferBeginInfo': None, 'VkSamplerCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkImageCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkQueryPoolCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkMappedMemoryRange': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkCopyDescriptorSet': None, 'VkCommandBufferInheritanceInfo': None, 'VkApplicationInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkSubmitInfo': None, 'VkSemaphoreCreateInfo': None}
...
mapDict['VkSubpassDependency'] =  {'VkAccessFlags': None, 'VkPipelineStageFlags': None, 'VkRenderPassCreateInfo': None, 'VkDependencyFlags': None}
...
mapDict['VkSurfaceKHR'] =  {'vkCreateXlibSurfaceKHR': None}
...
mapDict['VkWriteDescriptorSet'] =  {'vkUpdateDescriptorSets': None, 'VkBufferView': None, 'VkDescriptorType': None, 'VkDescriptorImageInfo': None, 'VkStructureType': None, 'VkDescriptorBufferInfo': None, 'VkDescriptorSet': None}
mapDict['VkXlibSurfaceCreateFlagsKHR'] =  {'VkXlibSurfaceCreateInfoKHR': None}
mapDict['VkXlibSurfaceCreateInfoKHR'] =  {'vkCreateXlibSurfaceKHR': None, 'VkStructureType': None, 'VkXlibSurfaceCreateFlagsKHR': None}
...
mapDict['vkCmdBeginQuery'] =  {'VkCommandBuffer': None, 'VkQueryPool': None, 'VkQueryControlFlags': None}
mapDict['vkCmdBeginRenderPass'] =  {'VkCommandBuffer': None, 'VkRenderPassBeginInfo': None, 'VkSubpassContents': None}
mapDict['vkCmdBindDescriptorSets'] =  {'VkCommandBuffer': None, 'VkDescriptorSet': None, 'VkPipelineBindPoint': None, 'VkPipelineLayout': None}
...
mapDict['vkCmdBlitImage'] =  {'VkCommandBuffer': None, 'VkImage': None, 'VkFilter': None, 'VkImageBlit': None, 'VkImageLayout': None}
mapDict['vkCmdClearAttachments'] =  {'VkCommandBuffer': None, 'VkClearAttachment': None, 'VkClearRect': None}
mapDict['vkCmdClearColorImage'] =  {'VkClearColorValue': None, 'VkCommandBuffer': None, 'VkImage': None, 'VkImageLayout': None, 'VkImageSubresourceRange': None}
...
mapDict['vkCmdCopyBufferToImage'] =  {'VkBufferImageCopy': None, 'VkCommandBuffer': None, 'VkBuffer': None, 'VkImageLayout': None, 'VkImage': None}
mapDict['vkCmdCopyImage'] =  {'VkCommandBuffer': None, 'VkImage': None, 'VkImageCopy': None, 'VkImageLayout': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkBufferImageCopy': None, 'VkCommandBuffer': None, 'VkImage': None, 'VkBuffer': None, 'VkImageLayout': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkCommandBuffer': None, 'VkBuffer': None, 'VkQueryResultFlags': None, 'VkQueryPool': None, 'VkDeviceSize': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkDependencyFlags': None, 'VkCommandBuffer': None, 'VkImageMemoryBarrier': None}
...
mapDict['vkCmdResolveImage'] =  {'VkCommandBuffer': None, 'VkImage': None, 'VkImageResolve': None, 'VkImageLayout': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkEvent': None, 'VkCommandBuffer': None, 'VkImageMemoryBarrier': None}
...
mapDict['vkCreateComputePipelines'] =  {'VkPipeline': None, 'VkPipelineCache': None, 'VkComputePipelineCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateDescriptorPool'] =  {'VkDescriptorPool': None, 'VkDescriptorPoolCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
...
mapDict['vkCreateFence'] =  {'VkAllocationCallbacks': None, 'VkFence': None, 'VkFenceCreateInfo': None, 'VkDevice': None}
mapDict['vkCreateFramebuffer'] =  {'VkFramebufferCreateInfo': None, 'VkFramebuffer': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateGraphicsPipelines'] =  {'VkPipeline': None, 'VkPipelineCache': None, 'VkGraphicsPipelineCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateImage'] =  {'VkImage': None, 'VkImageCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateImageView'] =  {'VkImageView': None, 'VkAllocationCallbacks': None, 'VkImageViewCreateInfo': None, 'VkDevice': None}
...
mapDict['vkCreateQueryPool'] =  {'VkQueryPool': None, 'VkQueryPoolCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateRenderPass'] =  {'VkRenderPassCreateInfo': None, 'VkRenderPass': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateSampler'] =  {'VkSampler': None, 'VkSamplerCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
...
mapDict['vkCreateXlibSurfaceKHR'] =  {'VkInstance': None, 'VkXlibSurfaceCreateInfoKHR': None, 'VkSurfaceKHR': None, 'VkAllocationCallbacks': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkImage': None, 'VkSubresourceLayout': None, 'VkImageSubresource': None, 'VkDevice': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageUsageFlags': None, 'VkImageCreateFlags': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkImageTiling': None, 'VkImageType': None, 'VkImageFormatProperties': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkPhysicalDevice': None, 'VkFormat': None, 'VkImageTiling': None, 'VkSparseImageFormatProperties': None, 'VkImageType': None}
