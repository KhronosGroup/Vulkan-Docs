...
mapDict['VkAccessFlags'] =  {'VkMemoryBarrier': None, 'VkAccessFlagBits': None, 'VkSubpassDependency': None, 'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None}
mapDict['VkAllocationCallbacks'] =  {'vkCreateSemaphore': None, 'vkDestroyPipelineLayout': None, 'vkCreateInstance': None, 'vkCreateShaderModule': None, 'vkCreatePipelineCache': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroyBufferView': None, 'vkDestroyPipeline': None, 'vkCreateRenderPass': None, 'vkDestroySampler': None, 'vkCreateComputePipelines': None, 'PFN_vkReallocationFunction': None, 'vkCreateDescriptorPool': None, 'vkDestroyBuffer': None, 'vkDestroyImage': None, 'vkDestroySwapchainKHR': None, 'vkDestroyQueryPool': None, 'vkCreateFence': None, 'vkDestroyDevice': None, 'vkCreateImageView': None, 'vkCreateDevice': None, 'vkDestroyFramebuffer': None, 'vkCreateBuffer': None, 'vkCreateCommandPool': None, 'vkCreateSampler': None, 'vkCreateEvent': None, 'vkDestroyShaderModule': None, 'vkDestroyImageView': None, 'vkFreeMemory': None, 'vkDestroyCommandPool': None, 'vkDestroyRenderPass': None, 'vkCreateBufferView': None, 'vkCreateSwapchainKHR': None, 'PFN_vkFreeFunction': None, 'PFN_vkInternalAllocationNotification': None, 'vkCreatePipelineLayout': None, 'vkCreateImage': None, 'vkDestroyFence': None, 'vkCreateDescriptorSetLayout': None, 'vkDestroyInstance': None, 'vkCreateQueryPool': None, 'vkCreateFramebuffer': None, 'vkAllocateMemory': None, 'PFN_vkAllocationFunction': None, 'vkDestroyPipelineCache': None, 'vkDestroyEvent': None, 'vkDestroySemaphore': None, 'vkDestroyDescriptorPool': None, 'vkCreateGraphicsPipelines': None, 'PFN_vkInternalFreeNotification': None}
mapDict['VkApplicationInfo'] =  {'VkInstanceCreateInfo': None, 'VkStructureType': None}
mapDict['VkAttachmentDescription'] =  {'VkSampleCountFlagBits': None, 'VkImageLayout': None, 'VkRenderPassCreateInfo': None, 'VkAttachmentLoadOp': None, 'VkFormat': None, 'VkAttachmentStoreOp': None, 'VkAttachmentDescriptionFlags': None}
...
mapDict['VkBindSparseInfo'] =  {'VkStructureType': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseImageMemoryBindInfo': None, 'vkQueueBindSparse': None, 'VkSparseBufferMemoryBindInfo': None, 'VkSemaphore': None}
mapDict['VkBlendFactor'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBlendOp'] =  {'VkPipelineColorBlendAttachmentState': None}
mapDict['VkBool32'] =  {'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'vkWaitForFences': None, 'VkCommandBufferInheritanceInfo': None, 'VkPhysicalDeviceLimits': None, 'VkSamplerCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPhysicalDeviceSparseProperties': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkBorderColor'] =  {'VkSamplerCreateInfo': None}
mapDict['VkBuffer'] =  {'vkCmdCopyImageToBuffer': None, 'VkDescriptorBufferInfo': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdFillBuffer': None, 'vkCmdDrawIndirect': None, 'VkBufferViewCreateInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdDispatchIndirect': None, 'vkCmdBindVertexBuffers': None, 'vkCmdCopyBufferToImage': None, 'vkCreateBuffer': None, 'VkBufferMemoryBarrier': None, 'vkBindBufferMemory': None, 'vkCmdCopyBuffer': None, 'vkCmdBindIndexBuffer': None, 'vkCmdUpdateBuffer': None, 'vkGetBufferMemoryRequirements': None, 'vkDestroyBuffer': None}
...
mapDict['VkBufferCreateInfo'] =  {'vkCreateBuffer': None, 'VkStructureType': None, 'VkSharingMode': None, 'VkBufferCreateFlags': None, 'VkDeviceSize': None, 'VkBufferUsageFlags': None}
mapDict['VkBufferImageCopy'] =  {'vkCmdCopyImageToBuffer': None, 'vkCmdCopyBufferToImage': None, 'VkExtent3D': None, 'VkOffset3D': None, 'VkImageSubresourceLayers': None, 'VkDeviceSize': None}
mapDict['VkBufferMemoryBarrier'] =  {'VkBuffer': None, 'VkStructureType': None, 'VkAccessFlags': None, 'vkCmdPipelineBarrier': None, 'vkCmdWaitEvents': None, 'VkDeviceSize': None}
...
mapDict['VkBufferViewCreateInfo'] =  {'VkFormat': None, 'VkStructureType': None, 'VkBuffer': None, 'vkCreateBufferView': None, 'VkDeviceSize': None, 'VkBufferViewCreateFlags': None}
...
mapDict['VkCommandBuffer'] =  {'vkCmdSetStencilCompareMask': None, 'vkCmdResetEvent': None, 'vkBeginCommandBuffer': None, 'vkCmdBeginQuery': None, 'vkCmdPipelineBarrier': None, 'vkCmdClearColorImage': None, 'vkCmdDispatchIndirect': None, 'vkCmdNextSubpass': None, 'vkCmdExecuteCommands': None, 'vkCmdEndQuery': None, 'vkEndCommandBuffer': None, 'vkCmdResolveImage': None, 'vkCmdSetBlendConstants': None, 'vkFreeCommandBuffers': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdSetEvent': None, 'vkCmdBindVertexBuffers': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdDrawIndexed': None, 'vkResetCommandBuffer': None, 'VkSubmitInfo': None, 'vkCmdSetScissor': None, 'vkCmdSetLineWidth': None, 'vkCmdSetStencilReference': None, 'vkCmdCopyBuffer': None, 'vkCmdBlitImage': None, 'vkCmdDispatch': None, 'vkCmdSetViewport': None, 'vkCmdBindDescriptorSets': None, 'vkCmdWriteTimestamp': None, 'vkCmdPushConstants': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdBindPipeline': None, 'vkCmdBeginRenderPass': None, 'vkCmdBindIndexBuffer': None, 'vkCmdUpdateBuffer': None, 'vkCmdClearAttachments': None, 'vkAllocateCommandBuffers': None, 'vkCmdDraw': None, 'vkCmdDrawIndirect': None, 'vkCmdSetDepthBias': None, 'vkCmdResetQueryPool': None, 'vkCmdWaitEvents': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdFillBuffer': None, 'vkCmdCopyBufferToImage': None, 'vkCmdCopyImage': None, 'vkCmdSetDepthBounds': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdEndRenderPass': None}
...
mapDict['VkCommandBufferInheritanceInfo'] =  {'VkQueryPipelineStatisticFlags': None, 'VkFramebuffer': None, 'VkStructureType': None, 'VkQueryControlFlags': None, 'VkRenderPass': None, 'VkBool32': None, 'VkCommandBufferBeginInfo': None}
...
mapDict['VkCommandPool'] =  {'VkCommandBufferAllocateInfo': None, 'vkFreeCommandBuffers': None, 'vkResetCommandPool': None, 'vkCreateCommandPool': None, 'vkDestroyCommandPool': None}
...
mapDict['VkComputePipelineCreateInfo'] =  {'VkPipelineLayout': None, 'VkPipelineShaderStageCreateInfo': None, 'VkStructureType': None, 'VkPipelineCreateFlags': None, 'vkCreateComputePipelines': None, 'VkPipeline': None}
...
mapDict['VkDescriptorImageInfo'] =  {'VkSampler': None, 'VkWriteDescriptorSet': None, 'VkImageLayout': None, 'VkImageView': None}
mapDict['VkDescriptorPool'] =  {'vkDestroyDescriptorPool': None, 'vkFreeDescriptorSets': None, 'VkDescriptorSetAllocateInfo': None, 'vkCreateDescriptorPool': None, 'vkResetDescriptorPool': None}
...
mapDict['VkDescriptorSet'] =  {'vkAllocateDescriptorSets': None, 'VkCopyDescriptorSet': None, 'VkWriteDescriptorSet': None, 'vkCmdBindDescriptorSets': None, 'vkFreeDescriptorSets': None}
mapDict['VkDescriptorSetAllocateInfo'] =  {'VkDescriptorPool': None, 'vkAllocateDescriptorSets': None, 'VkDescriptorSetLayout': None, 'VkStructureType': None}
mapDict['VkDescriptorSetLayout'] =  {'VkDescriptorSetAllocateInfo': None, 'vkCreateDescriptorSetLayout': None, 'VkPipelineLayoutCreateInfo': None, 'vkDestroyDescriptorSetLayout': None}
mapDict['VkDescriptorSetLayoutBinding'] =  {'VkSampler': None, 'VkDescriptorType': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkShaderStageFlags': None}
...
mapDict['VkDevice'] =  {'vkGetImageSparseMemoryRequirements': None, 'vkDestroyPipelineLayout': None, 'vkGetDeviceQueue': None, 'vkCreateSemaphore': None, 'vkCreatePipelineCache': None, 'vkDestroyDescriptorSetLayout': None, 'vkDestroyBufferView': None, 'vkFreeDescriptorSets': None, 'vkDestroyPipeline': None, 'vkUnmapMemory': None, 'vkAcquireNextImageKHR': None, 'vkDestroySampler': None, 'vkCreateComputePipelines': None, 'vkCreateDescriptorPool': None, 'vkDestroyBuffer': None, 'vkFreeCommandBuffers': None, 'vkGetQueryPoolResults': None, 'vkDestroyImage': None, 'vkMapMemory': None, 'vkCreateRenderPass': None, 'vkDestroyQueryPool': None, 'vkWaitForFences': None, 'vkCreateImage': None, 'vkCreateShaderModule': None, 'vkDestroyDevice': None, 'vkCreateImageView': None, 'vkCreateDevice': None, 'vkDestroyFramebuffer': None, 'vkCreateBuffer': None, 'vkCreateCommandPool': None, 'vkResetCommandPool': None, 'vkCreateSampler': None, 'vkCreateEvent': None, 'vkDestroyShaderModule': None, 'vkDeviceWaitIdle': None, 'vkDestroyImageView': None, 'vkBindImageMemory': None, 'vkUpdateDescriptorSets': None, 'vkMergePipelineCaches': None, 'vkDestroySwapchainKHR': None, 'vkResetEvent': None, 'vkGetFenceStatus': None, 'vkGetDeviceProcAddr': None, 'vkResetDescriptorPool': None, 'vkDestroyCommandPool': None, 'vkFlushMappedMemoryRanges': None, 'vkCreateBufferView': None, 'vkDestroyRenderPass': None, 'vkGetImageSubresourceLayout': None, 'vkGetDeviceMemoryCommitment': None, 'vkAllocateCommandBuffers': None, 'vkSetEvent': None, 'vkCreatePipelineLayout': None, 'vkGetImageMemoryRequirements': None, 'vkResetFences': None, 'vkCreateSwapchainKHR': None, 'vkFreeMemory': None, 'vkDestroyFence': None, 'vkCreateQueryPool': None, 'vkCreateFramebuffer': None, 'vkGetRenderAreaGranularity': None, 'vkAllocateMemory': None, 'vkGetEventStatus': None, 'vkGetPipelineCacheData': None, 'vkCreateDescriptorSetLayout': None, 'vkAllocateDescriptorSets': None, 'vkDestroyPipelineCache': None, 'vkGetSwapchainImagesKHR': None, 'vkDestroyEvent': None, 'vkDestroySemaphore': None, 'vkCreateFence': None, 'vkBindBufferMemory': None, 'vkInvalidateMappedMemoryRanges': None, 'vkCreateGraphicsPipelines': None, 'vkGetBufferMemoryRequirements': None, 'vkDestroyDescriptorPool': None}
mapDict['VkDeviceCreateFlags'] =  {'VkDeviceCreateInfo': None}
mapDict['VkDeviceCreateInfo'] =  {'VkDeviceCreateFlags': None, 'VkDeviceQueueCreateInfo': None, 'VkPhysicalDeviceFeatures': None, 'VkStructureType': None, 'vkCreateDevice': None}
mapDict['VkDeviceMemory'] =  {'vkBindImageMemory': None, 'vkFreeMemory': None, 'VkSparseImageMemoryBind': None, 'vkUnmapMemory': None, 'vkGetDeviceMemoryCommitment': None, 'vkMapMemory': None, 'vkBindBufferMemory': None, 'vkAllocateMemory': None, 'VkSparseMemoryBind': None, 'VkMappedMemoryRange': None}
...
mapDict['VkDeviceSize'] =  {'VkMemoryAllocateInfo': None, 'vkBindImageMemory': None, 'VkSparseImageMemoryBind': None, 'vkMapMemory': None, 'vkCmdCopyQueryPoolResults': None, 'VkBufferViewCreateInfo': None, 'VkImageFormatProperties': None, 'VkDescriptorBufferInfo': None, 'vkGetDeviceMemoryCommitment': None, 'VkSparseMemoryBind': None, 'VkBufferMemoryBarrier': None, 'VkSparseImageMemoryRequirements': None, 'vkCmdDrawIndexedIndirect': None, 'vkCmdBindIndexBuffer': None, 'vkCmdDispatchIndirect': None, 'vkGetQueryPoolResults': None, 'VkSubresourceLayout': None, 'VkBufferCopy': None, 'vkCmdDrawIndirect': None, 'VkBufferCreateInfo': None, 'VkPhysicalDeviceLimits': None, 'VkMappedMemoryRange': None, 'VkMemoryHeap': None, 'vkCmdFillBuffer': None, 'vkCmdBindVertexBuffers': None, 'VkBufferImageCopy': None, 'VkMemoryRequirements': None, 'vkBindBufferMemory': None, 'vkCmdUpdateBuffer': None}
mapDict['VkDynamicState'] =  {'VkPipelineDynamicStateCreateInfo': None}
mapDict['VkEvent'] =  {'vkResetEvent': None, 'vkCmdSetEvent': None, 'vkSetEvent': None, 'vkCmdResetEvent': None, 'vkGetEventStatus': None, 'vkCmdWaitEvents': None, 'vkDestroyEvent': None, 'vkCreateEvent': None}
...
mapDict['VkExtent3D'] =  {'VkBufferImageCopy': None, 'VkQueueFamilyProperties': None, 'VkSparseImageMemoryBind': None, 'VkImageResolve': None, 'VkSparseImageFormatProperties': None, 'VkImageFormatProperties': None, 'VkImageCopy': None, 'VkImageCreateInfo': None}
mapDict['VkFence'] =  {'vkQueueSubmit': None, 'vkAcquireNextImageKHR': None, 'vkDestroyFence': None, 'vkGetFenceStatus': None, 'vkWaitForFences': None, 'vkCreateFence': None, 'vkQueueBindSparse': None, 'vkResetFences': None}
...
mapDict['VkFormat'] =  {'vkGetPhysicalDeviceFormatProperties': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkAttachmentDescription': None, 'VkImageViewCreateInfo': None, 'VkVertexInputAttributeDescription': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkBufferViewCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkImageCreateInfo': None}
...
mapDict['VkFramebuffer'] =  {'VkCommandBufferInheritanceInfo': None, 'vkDestroyFramebuffer': None, 'VkRenderPassBeginInfo': None, 'vkCreateFramebuffer': None}
mapDict['VkFramebufferCreateFlags'] =  {'VkFramebufferCreateInfo': None}
mapDict['VkFramebufferCreateInfo'] =  {'VkFramebufferCreateFlags': None, 'VkRenderPass': None, 'vkCreateFramebuffer': None, 'VkStructureType': None, 'VkImageView': None}
mapDict['VkFrontFace'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkGraphicsPipelineCreateInfo'] =  {'VkPipelineTessellationStateCreateInfo': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'vkCreateGraphicsPipelines': None, 'VkPipelineViewportStateCreateInfo': None, 'VkRenderPass': None, 'VkPipelineLayout': None, 'VkPipelineCreateFlags': None, 'VkPipeline': None, 'VkStructureType': None, 'VkPipelineShaderStageCreateInfo': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkImage'] =  {'vkBindImageMemory': None, 'vkGetImageSparseMemoryRequirements': None, 'vkCmdClearColorImage': None, 'vkDestroyImage': None, 'VkImageMemoryBarrier': None, 'VkSparseImageMemoryBindInfo': None, 'vkGetSwapchainImagesKHR': None, 'VkImageViewCreateInfo': None, 'vkCreateImage': None, 'vkCmdCopyImageToBuffer': None, 'vkGetImageSubresourceLayout': None, 'vkCmdCopyBufferToImage': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'vkCmdCopyImage': None, 'vkGetImageMemoryRequirements': None, 'vkCmdResolveImage': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdBlitImage': None}
mapDict['VkImageAspectFlagBits'] =  {'VkImageAspectFlags': None}
mapDict['VkImageAspectFlags'] =  {'VkClearAttachment': None, 'VkImageSubresourceLayers': None, 'VkImageSubresource': None, 'VkSparseImageFormatProperties': None, 'VkImageAspectFlagBits': None, 'VkImageSubresourceRange': None}
mapDict['VkImageBlit'] =  {'VkImageSubresourceLayers': None, 'vkCmdBlitImage': None, 'VkOffset3D': None}
mapDict['VkImageCopy'] =  {'VkImageSubresourceLayers': None, 'vkCmdCopyImage': None, 'VkExtent3D': None, 'VkOffset3D': None}
...
mapDict['VkImageCreateInfo'] =  {'VkImageType': None, 'VkImageTiling': None, 'VkExtent3D': None, 'VkStructureType': None, 'VkSampleCountFlagBits': None, 'VkImageUsageFlags': None, 'VkSharingMode': None, 'VkFormat': None, 'VkImageLayout': None, 'VkImageCreateFlags': None, 'vkCreateImage': None}
mapDict['VkImageFormatProperties'] =  {'VkSampleCountFlags': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkExtent3D': None, 'VkDeviceSize': None}
mapDict['VkImageLayout'] =  {'VkAttachmentReference': None, 'VkDescriptorImageInfo': None, 'VkAttachmentDescription': None, 'vkCmdClearColorImage': None, 'vkCmdCopyImageToBuffer': None, 'vkCmdCopyBufferToImage': None, 'VkImageMemoryBarrier': None, 'vkCmdCopyImage': None, 'vkCmdBlitImage': None, 'vkCmdResolveImage': None, 'vkCmdClearDepthStencilImage': None, 'VkImageCreateInfo': None}
mapDict['VkImageMemoryBarrier'] =  {'VkStructureType': None, 'VkAccessFlags': None, 'vkCmdWaitEvents': None, 'vkCmdPipelineBarrier': None, 'VkImageSubresourceRange': None, 'VkImageLayout': None, 'VkImage': None}
mapDict['VkImageResolve'] =  {'VkImageSubresourceLayers': None, 'vkCmdResolveImage': None, 'VkExtent3D': None, 'VkOffset3D': None}
mapDict['VkImageSubresource'] =  {'VkSparseImageMemoryBind': None, 'VkImageAspectFlags': None, 'vkGetImageSubresourceLayout': None}
mapDict['VkImageSubresourceLayers'] =  {'VkBufferImageCopy': None, 'VkImageBlit': None, 'VkImageAspectFlags': None, 'VkImageCopy': None, 'VkImageResolve': None}
mapDict['VkImageSubresourceRange'] =  {'VkImageViewCreateInfo': None, 'VkImageMemoryBarrier': None, 'VkImageAspectFlags': None, 'vkCmdClearDepthStencilImage': None, 'vkCmdClearColorImage': None}
...
mapDict['VkImageUsageFlags'] =  {'VkSwapchainCreateInfoKHR': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'VkImageCreateInfo': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageUsageFlagBits': None}
mapDict['VkImageView'] =  {'VkFramebufferCreateInfo': None, 'VkDescriptorImageInfo': None, 'vkDestroyImageView': None, 'vkCreateImageView': None}
mapDict['VkImageViewCreateFlags'] =  {'VkImageViewCreateInfo': None}
mapDict['VkImageViewCreateInfo'] =  {'VkImageSubresourceRange': None, 'VkComponentMapping': None, 'VkImageViewType': None, 'VkStructureType': None, 'VkFormat': None, 'VkImageViewCreateFlags': None, 'vkCreateImageView': None, 'VkImage': None}
mapDict['VkImageViewType'] =  {'VkImageViewCreateInfo': None}
mapDict['VkIndexType'] =  {'vkCmdBindIndexBuffer': None}
mapDict['VkInstance'] =  {'vkEnumeratePhysicalDevices': None, 'vkDestroyInstance': None, 'vkCreateInstance': None, 'vkGetInstanceProcAddr': None}
...
mapDict['VkMappedMemoryRange'] =  {'vkInvalidateMappedMemoryRanges': None, 'vkFlushMappedMemoryRanges': None, 'VkDeviceSize': None, 'VkStructureType': None, 'VkDeviceMemory': None}
mapDict['VkMemoryAllocateInfo'] =  {'vkAllocateMemory': None, 'VkDeviceSize': None, 'VkStructureType': None}
mapDict['VkMemoryBarrier'] =  {'VkAccessFlags': None, 'vkCmdWaitEvents': None, 'VkStructureType': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkOffset3D'] =  {'VkBufferImageCopy': None, 'VkSparseImageMemoryBind': None, 'VkImageBlit': None, 'VkImageCopy': None, 'VkImageResolve': None}
mapDict['VkPhysicalDevice'] =  {'vkGetPhysicalDeviceQueueFamilyProperties': None, 'vkEnumerateDeviceExtensionProperties': None, 'vkCreateDevice': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'vkGetPhysicalDeviceFeatures': None, 'vkEnumerateDeviceLayerProperties': None, 'vkGetPhysicalDeviceImageFormatProperties': None, 'vkEnumeratePhysicalDevices': None, 'vkGetPhysicalDeviceProperties': None, 'vkGetPhysicalDeviceMemoryProperties': None, 'vkGetPhysicalDeviceFormatProperties': None}
mapDict['VkPhysicalDeviceFeatures'] =  {'vkGetPhysicalDeviceFeatures': None, 'VkBool32': None, 'VkDeviceCreateInfo': None}
mapDict['VkPhysicalDeviceLimits'] =  {'VkSampleCountFlags': None, 'VkBool32': None, 'VkPhysicalDeviceProperties': None, 'VkDeviceSize': None}
...
mapDict['VkPipeline'] =  {'VkGraphicsPipelineCreateInfo': None, 'vkCmdBindPipeline': None, 'vkDestroyPipeline': None, 'vkCreateComputePipelines': None, 'vkCreateGraphicsPipelines': None, 'VkComputePipelineCreateInfo': None}
mapDict['VkPipelineBindPoint'] =  {'vkCmdBindPipeline': None, 'VkSubpassDescription': None, 'vkCmdBindDescriptorSets': None}
mapDict['VkPipelineCache'] =  {'vkDestroyPipelineCache': None, 'vkMergePipelineCaches': None, 'vkCreateComputePipelines': None, 'vkCreatePipelineCache': None, 'vkGetPipelineCacheData': None, 'vkCreateGraphicsPipelines': None}
...
mapDict['VkPipelineColorBlendAttachmentState'] =  {'VkBlendFactor': None, 'VkColorComponentFlags': None, 'VkBool32': None, 'VkBlendOp': None, 'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateFlags'] =  {'VkPipelineColorBlendStateCreateInfo': None}
mapDict['VkPipelineColorBlendStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkPipelineColorBlendAttachmentState': None, 'VkLogicOp': None, 'VkStructureType': None, 'VkBool32': None, 'VkPipelineColorBlendStateCreateFlags': None}
...
mapDict['VkPipelineDepthStencilStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkPipelineDepthStencilStateCreateFlags': None, 'VkCompareOp': None, 'VkStructureType': None, 'VkBool32': None, 'VkStencilOpState': None}
...
mapDict['VkPipelineInputAssemblyStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkBool32': None, 'VkPrimitiveTopology': None, 'VkStructureType': None, 'VkPipelineInputAssemblyStateCreateFlags': None}
mapDict['VkPipelineLayout'] =  {'VkGraphicsPipelineCreateInfo': None, 'vkCmdBindDescriptorSets': None, 'vkDestroyPipelineLayout': None, 'vkCreatePipelineLayout': None, 'VkComputePipelineCreateInfo': None, 'vkCmdPushConstants': None}
mapDict['VkPipelineLayoutCreateFlags'] =  {'VkPipelineLayoutCreateInfo': None}
mapDict['VkPipelineLayoutCreateInfo'] =  {'VkPipelineLayoutCreateFlags': None, 'vkCreatePipelineLayout': None, 'VkDescriptorSetLayout': None, 'VkStructureType': None, 'VkPushConstantRange': None}
mapDict['VkPipelineMultisampleStateCreateFlags'] =  {'VkPipelineMultisampleStateCreateInfo': None}
mapDict['VkPipelineMultisampleStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkSampleCountFlagBits': None, 'VkStructureType': None, 'VkBool32': None, 'VkSampleMask': None, 'VkPipelineMultisampleStateCreateFlags': None}
mapDict['VkPipelineRasterizationStateCreateFlags'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPipelineRasterizationStateCreateInfo'] =  {'VkPipelineRasterizationStateCreateFlags': None, 'VkCullModeFlags': None, 'VkStructureType': None, 'VkFrontFace': None, 'VkBool32': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPolygonMode': None}
mapDict['VkPipelineShaderStageCreateFlags'] =  {'VkPipelineShaderStageCreateInfo': None}
mapDict['VkPipelineShaderStageCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkShaderModule': None, 'VkStructureType': None, 'VkShaderStageFlagBits': None, 'VkSpecializationInfo': None, 'VkPipelineShaderStageCreateFlags': None, 'VkComputePipelineCreateInfo': None}
mapDict['VkPipelineStageFlagBits'] =  {'vkCmdWriteTimestamp': None, 'VkPipelineStageFlags': None}
mapDict['VkPipelineStageFlags'] =  {'VkSubmitInfo': None, 'vkCmdSetEvent': None, 'vkCmdResetEvent': None, 'vkCmdWaitEvents': None, 'VkSubpassDependency': None, 'VkPipelineStageFlagBits': None, 'vkCmdPipelineBarrier': None}
...
mapDict['VkPipelineVertexInputStateCreateInfo'] =  {'VkVertexInputAttributeDescription': None, 'VkGraphicsPipelineCreateInfo': None, 'VkVertexInputBindingDescription': None, 'VkStructureType': None, 'VkPipelineVertexInputStateCreateFlags': None}
mapDict['VkPipelineViewportStateCreateFlags'] =  {'VkPipelineViewportStateCreateInfo': None}
mapDict['VkPipelineViewportStateCreateInfo'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkRect2D': None, 'VkPipelineViewportStateCreateFlags': None, 'VkViewport': None, 'VkStructureType': None}
mapDict['VkPolygonMode'] =  {'VkPipelineRasterizationStateCreateInfo': None}
mapDict['VkPresentInfoKHR'] =  {'VkSwapchainKHR': None, 'VkResult': None, 'vkQueuePresentKHR': None, 'VkStructureType': None, 'VkSemaphore': None}
...
mapDict['VkQueryPool'] =  {'vkCmdWriteTimestamp': None, 'vkCmdEndQuery': None, 'vkCreateQueryPool': None, 'vkDestroyQueryPool': None, 'vkCmdCopyQueryPoolResults': None, 'vkCmdBeginQuery': None, 'vkGetQueryPoolResults': None, 'vkCmdResetQueryPool': None}
mapDict['VkQueryPoolCreateFlags'] =  {'VkQueryPoolCreateInfo': None}
mapDict['VkQueryPoolCreateInfo'] =  {'vkCreateQueryPool': None, 'VkQueryPipelineStatisticFlags': None, 'VkQueryPoolCreateFlags': None, 'VkStructureType': None, 'VkQueryType': None}
...
mapDict['VkQueue'] =  {'vkQueueBindSparse': None, 'vkQueueSubmit': None, 'vkQueueWaitIdle': None, 'vkQueuePresentKHR': None, 'vkGetDeviceQueue': None}
...
mapDict['VkRect2D'] =  {'VkOffset2D': None, 'VkClearRect': None, 'vkCmdSetScissor': None, 'VkExtent2D': None, 'VkPipelineViewportStateCreateInfo': None, 'VkRenderPassBeginInfo': None}
mapDict['VkRenderPass'] =  {'VkGraphicsPipelineCreateInfo': None, 'vkGetRenderAreaGranularity': None, 'vkCreateRenderPass': None, 'VkFramebufferCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkRenderPassBeginInfo': None, 'vkDestroyRenderPass': None}
mapDict['VkRenderPassBeginInfo'] =  {'VkClearValue': None, 'VkFramebuffer': None, 'VkStructureType': None, 'VkRenderPass': None, 'VkRect2D': None, 'vkCmdBeginRenderPass': None}
mapDict['VkRenderPassCreateFlags'] =  {'VkRenderPassCreateInfo': None}
mapDict['VkRenderPassCreateInfo'] =  {'VkSubpassDependency': None, 'VkStructureType': None, 'VkSubpassDescription': None, 'VkRenderPassCreateFlags': None, 'vkCreateRenderPass': None, 'VkAttachmentDescription': None}
mapDict['VkResult'] =  {'VkPresentInfoKHR': None}
mapDict['VkSampleCountFlagBits'] =  {'VkSampleCountFlags': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkAttachmentDescription': None, 'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkImageCreateInfo': None}
...
mapDict['VkSamplerCreateInfo'] =  {'VkSamplerAddressMode': None, 'VkBool32': None, 'VkCompareOp': None, 'VkBorderColor': None, 'VkStructureType': None, 'VkSamplerMipmapMode': None, 'vkCreateSampler': None, 'VkSamplerCreateFlags': None, 'VkFilter': None}
mapDict['VkSamplerMipmapMode'] =  {'VkSamplerCreateInfo': None}
mapDict['VkSemaphore'] =  {'vkCreateSemaphore': None, 'VkSubmitInfo': None, 'vkDestroySemaphore': None, 'vkAcquireNextImageKHR': None, 'VkPresentInfoKHR': None, 'VkBindSparseInfo': None}
...
mapDict['VkShaderStageFlags'] =  {'VkDescriptorSetLayoutBinding': None, 'vkCmdPushConstants': None, 'VkShaderStageFlagBits': None, 'VkPushConstantRange': None}
...
mapDict['VkSparseImageFormatProperties'] =  {'vkGetPhysicalDeviceSparseImageFormatProperties': None, 'VkSparseImageMemoryRequirements': None, 'VkImageAspectFlags': None, 'VkExtent3D': None, 'VkSparseImageFormatFlags': None}
mapDict['VkSparseImageMemoryBind'] =  {'VkSparseMemoryBindFlags': None, 'VkExtent3D': None, 'VkSparseImageMemoryBindInfo': None, 'VkImageSubresource': None, 'VkOffset3D': None, 'VkDeviceSize': None, 'VkDeviceMemory': None}
...
mapDict['VkSparseMemoryBind'] =  {'VkSparseMemoryBindFlags': None, 'VkSparseImageOpaqueMemoryBindInfo': None, 'VkSparseBufferMemoryBindInfo': None, 'VkDeviceSize': None, 'VkDeviceMemory': None}
...
mapDict['VkStencilFaceFlags'] =  {'vkCmdSetStencilReference': None, 'vkCmdSetStencilWriteMask': None, 'vkCmdSetStencilCompareMask': None, 'VkStencilFaceFlagBits': None}
...
mapDict['VkStructureType'] =  {'VkShaderModuleCreateInfo': None, 'VkCommandBufferBeginInfo': None, 'VkEventCreateInfo': None, 'VkBufferViewCreateInfo': None, 'VkPipelineCacheCreateInfo': None, 'VkBufferMemoryBarrier': None, 'VkPipelineInputAssemblyStateCreateInfo': None, 'VkRenderPassBeginInfo': None, 'VkComputePipelineCreateInfo': None, 'VkDescriptorPoolCreateInfo': None, 'VkCommandBufferAllocateInfo': None, 'VkInstanceCreateInfo': None, 'VkDeviceQueueCreateInfo': None, 'VkWriteDescriptorSet': None, 'VkSemaphoreCreateInfo': None, 'VkBufferCreateInfo': None, 'VkMappedMemoryRange': None, 'VkCopyDescriptorSet': None, 'VkSubmitInfo': None, 'VkQueryPoolCreateInfo': None, 'VkPipelineShaderStageCreateInfo': None, 'VkImageViewCreateInfo': None, 'VkPipelineColorBlendStateCreateInfo': None, 'VkSwapchainCreateInfoKHR': None, 'VkMemoryAllocateInfo': None, 'VkGraphicsPipelineCreateInfo': None, 'VkPipelineVertexInputStateCreateInfo': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkRenderPassCreateInfo': None, 'VkPipelineViewportStateCreateInfo': None, 'VkMemoryBarrier': None, 'VkFenceCreateInfo': None, 'VkPipelineLayoutCreateInfo': None, 'VkBindSparseInfo': None, 'VkDescriptorSetAllocateInfo': None, 'VkImageMemoryBarrier': None, 'VkPipelineMultisampleStateCreateInfo': None, 'VkPipelineTessellationStateCreateInfo': None, 'VkCommandPoolCreateInfo': None, 'VkPipelineDynamicStateCreateInfo': None, 'VkDeviceCreateInfo': None, 'VkSamplerCreateInfo': None, 'VkPipelineRasterizationStateCreateInfo': None, 'VkFramebufferCreateInfo': None, 'VkCommandBufferInheritanceInfo': None, 'VkApplicationInfo': None, 'VkPipelineDepthStencilStateCreateInfo': None, 'VkPresentInfoKHR': None, 'VkImageCreateInfo': None}
mapDict['VkSubmitInfo'] =  {'VkCommandBuffer': None, 'vkQueueSubmit': None, 'VkPipelineStageFlags': None, 'VkStructureType': None, 'VkSemaphore': None}
mapDict['VkSubpassContents'] =  {'vkCmdBeginRenderPass': None, 'vkCmdNextSubpass': None}
mapDict['VkSubpassDependency'] =  {'VkRenderPassCreateInfo': None, 'VkDependencyFlags': None, 'VkAccessFlags': None, 'VkPipelineStageFlags': None}
...
mapDict['VkSwapchainCreateInfoKHR'] =  {'VkBool32': None, 'VkPresentModeKHR': None, 'VkSwapchainKHR': None, 'VkFormat': None, 'vkCreateSwapchainKHR': None, 'VkSurfaceKHR': None, 'VkStructureType': None, 'VkExtent2D': None, 'VkImageUsageFlags': None, 'VkSharingMode': None, 'VkCompositeAlphaFlagBitsKHR': None, 'VkColorSpaceKHR': None, 'VkSwapchainCreateFlagsKHR': None, 'VkSurfaceTransformFlagBitsKHR': None}
mapDict['VkSwapchainKHR'] =  {'vkCreateSwapchainKHR': None, 'vkGetSwapchainImagesKHR': None, 'vkDestroySwapchainKHR': None, 'vkAcquireNextImageKHR': None, 'VkPresentInfoKHR': None, 'VkSwapchainCreateInfoKHR': None}
...
mapDict['VkWriteDescriptorSet'] =  {'VkDescriptorSet': None, 'vkUpdateDescriptorSets': None, 'VkDescriptorBufferInfo': None, 'VkStructureType': None, 'VkDescriptorImageInfo': None, 'VkDescriptorType': None, 'VkBufferView': None}
...
mapDict['vkAllocateMemory'] =  {'VkMemoryAllocateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkDeviceMemory': None}
mapDict['vkBeginCommandBuffer'] =  {'VkCommandBufferBeginInfo': None, 'VkCommandBuffer': None}
mapDict['vkBindBufferMemory'] =  {'VkBuffer': None, 'VkDeviceSize': None, 'VkDevice': None, 'VkDeviceMemory': None}
mapDict['vkBindImageMemory'] =  {'VkDeviceSize': None, 'VkImage': None, 'VkDevice': None, 'VkDeviceMemory': None}
...
mapDict['vkCmdBindDescriptorSets'] =  {'VkPipelineLayout': None, 'VkPipelineBindPoint': None, 'VkCommandBuffer': None, 'VkDescriptorSet': None}
...
mapDict['vkCmdBlitImage'] =  {'VkImageLayout': None, 'VkImageBlit': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkFilter': None}
mapDict['vkCmdClearAttachments'] =  {'VkClearRect': None, 'VkClearAttachment': None, 'VkCommandBuffer': None}
mapDict['vkCmdClearColorImage'] =  {'VkClearColorValue': None, 'VkImageLayout': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageSubresourceRange': None}
mapDict['vkCmdClearDepthStencilImage'] =  {'VkImageLayout': None, 'VkClearDepthStencilValue': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageSubresourceRange': None}
mapDict['vkCmdCopyBuffer'] =  {'VkBufferCopy': None, 'VkBuffer': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyBufferToImage'] =  {'VkBufferImageCopy': None, 'VkImageLayout': None, 'VkBuffer': None, 'VkImage': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyImage'] =  {'VkImageLayout': None, 'VkImage': None, 'VkCommandBuffer': None, 'VkImageCopy': None}
mapDict['vkCmdCopyImageToBuffer'] =  {'VkBufferImageCopy': None, 'VkImageLayout': None, 'VkBuffer': None, 'VkImage': None, 'VkCommandBuffer': None}
mapDict['vkCmdCopyQueryPoolResults'] =  {'VkBuffer': None, 'VkQueryResultFlags': None, 'VkQueryPool': None, 'VkCommandBuffer': None, 'VkDeviceSize': None}
...
mapDict['vkCmdPipelineBarrier'] =  {'VkMemoryBarrier': None, 'VkImageMemoryBarrier': None, 'VkBufferMemoryBarrier': None, 'VkDependencyFlags': None, 'VkPipelineStageFlags': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdResolveImage'] =  {'VkImageLayout': None, 'VkImageResolve': None, 'VkImage': None, 'VkCommandBuffer': None}
...
mapDict['vkCmdWaitEvents'] =  {'VkMemoryBarrier': None, 'VkCommandBuffer': None, 'VkBufferMemoryBarrier': None, 'VkPipelineStageFlags': None, 'VkEvent': None, 'VkImageMemoryBarrier': None}
mapDict['vkCmdWriteTimestamp'] =  {'VkPipelineStageFlagBits': None, 'VkQueryPool': None, 'VkCommandBuffer': None}
mapDict['vkCreateBuffer'] =  {'VkBuffer': None, 'VkBufferCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
mapDict['vkCreateBufferView'] =  {'VkBufferView': None, 'VkBufferViewCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
...
mapDict['vkCreateDescriptorSetLayout'] =  {'VkDescriptorSetLayout': None, 'VkDescriptorSetLayoutCreateInfo': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateDevice'] =  {'VkDeviceCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkPhysicalDevice': None}
...
mapDict['vkCreateGraphicsPipelines'] =  {'VkGraphicsPipelineCreateInfo': None, 'VkPipeline': None, 'VkPipelineCache': None, 'VkDevice': None, 'VkAllocationCallbacks': None}
mapDict['vkCreateImage'] =  {'VkImage': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkImageCreateInfo': None}
mapDict['vkCreateImageView'] =  {'VkImageViewCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None, 'VkImageView': None}
...
mapDict['vkCreatePipelineLayout'] =  {'VkPipelineLayout': None, 'VkPipelineLayoutCreateInfo': None, 'VkAllocationCallbacks': None, 'VkDevice': None}
...
mapDict['vkFreeMemory'] =  {'VkAllocationCallbacks': None, 'VkDevice': None, 'VkDeviceMemory': None}
...
mapDict['vkGetImageSubresourceLayout'] =  {'VkImageSubresource': None, 'VkImage': None, 'VkDevice': None, 'VkSubresourceLayout': None}
...
mapDict['vkGetPhysicalDeviceImageFormatProperties'] =  {'VkImageType': None, 'VkImageTiling': None, 'VkPhysicalDevice': None, 'VkImageUsageFlags': None, 'VkFormat': None, 'VkImageFormatProperties': None, 'VkImageCreateFlags': None}
...
mapDict['vkGetPhysicalDeviceSparseImageFormatProperties'] =  {'VkImageType': None, 'VkImageTiling': None, 'VkPhysicalDevice': None, 'VkImageUsageFlags': None, 'VkSparseImageFormatProperties': None, 'VkFormat': None, 'VkSampleCountFlagBits': None}
...
mapDict['vkMapMemory'] =  {'VkMemoryMapFlags': None, 'VkDeviceSize': None, 'VkDevice': None, 'VkDeviceMemory': None}
