...
The following line should generate a warning or error from the spec-macros
extension when building with 'makeSpec -spec core html', since the enum is
valid but is not in the core specification:
...
include::{chapters}/descriptors.adoc[]

ifdef::VK_EXT_descriptor_heap[]
include::{chapters}/descriptorheaps.adoc[]
endif::VK_EXT_descriptor_heap[]

include::{chapters}/descriptorsets.adoc[]

ifdef::VK_EXT_descriptor_buffer[]
include::{chapters}/descriptorbuffers.adoc[]
...
include::{chapters}/gpa_interface.adoc[]
...
include::{chapters}/VK_KHR_opacity_micromap/micromaps.adoc[]
