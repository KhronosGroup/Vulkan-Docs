...
from vuAST import VuAST, VuFormatter, VuSourceStyler, createAliasMap, createSymbolAvailabilityMap
...
def test_stripped_not(registry):
    ...
    verify(registry, 'VkRenderPassCreateInfo2', ['VK_VERSION_1_0'], ['VK_QCOM_render_pass_transform'], vu, {}, expect);
    verify(registry, 'VkRenderPassCreateInfo2', ['VK_VERSION_1_0'], [], vu, {}, 'require(False)');
    ...
    verify(registry, 'VkRenderPassCreateInfo2', ['VK_VERSION_1_0', 'VK_VERSION_1_1', 'VK_VERSION_1_2'],
           ['VK_QCOM_render_pass_transform'], vu, {}, expect);
    verify(registry, 'VkRenderPassCreateInfo2', ['VK_VERSION_1_0', 'VK_VERSION_1_1', 'VK_VERSION_1_2'], [], vu, {}, 'require(False)');
