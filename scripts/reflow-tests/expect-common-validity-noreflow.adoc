...
// Common to VkCmdCopyBufferToImage* commands
  ...
  * [[VUID-{refpage}-srcBuffer-10001]]
    pname:srcBuffer must: have been created with the ename:VK_BUFFER_USAGE_TRANSFER_SRC_BIT usage flag set
ifdef::VK_VERSION_1_1,VK_KHR_maintenance1[]
  ...
  * [[VUID-{refpage}-dstImage-00177]] pname:dstImage must: have been created with the ename:VK_IMAGE_USAGE_TRANSFER_DST_BIT usage flag set
