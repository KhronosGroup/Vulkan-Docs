        ...
        if explicitexternsyncparams is not None:
            for param in explicitexternsyncparams:
                ...
                for attrib in externsyncattribs:
                    is_queue = param_type == 'VkQueue'
                    if attrib.conditionally_extern_sync and not is_queue:
                        ...
                        #
                        # Exceptionally, for VkQueue the language is uniform enough to be autogenerated.
                        continue
