...
def test_output(registry):
    ...
    input = '\n'.join(['if info.has_pnext(VkSwapchainPresentFenceInfoEXT):',
                       ...
                       '  if fence != VK_NULL_HANDLE:',
                       '   require(fence.valid())'])
    output = '\n'.join(['[vu]#[vu-keyword]##if## info.[vu-builtin]##<<vu-builtin-has_pnext,has_pnext>>##&lpar;slink:VkSwapchainPresentFenceInfoEXT&rpar;: +',
                        '&nbsp;&nbsp;[vu-keyword]##for## fence [vu-operator]##in## info.[vu-builtin]##<<vu-builtin-pnext,pnext>>##&lpar;slink:VkSwapchainPresentFenceInfoEXT&rpar;.pFences: +',
                        '&nbsp;&nbsp;&nbsp;&nbsp;[vu-keyword]##if## fence [vu-operator]##!=## dlink:VK_NULL_HANDLE: +',
                        '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;[vu-builtin]##<<vu-builtin-require,require>>##&lpar;fence.[vu-builtin]##<<vu-builtin-valid,valid>>##&lpar;&rpar;&rpar;#']);
    verify(formatter, input, output)
...
def test_output_with_comment(registry):
    ...
    output = '\n'.join(['[vu]#[vu-comment]##&#x23; Multiple comment## +',
                        ...
                        '[vu-keyword]##if## info.[vu-builtin]##<<vu-builtin-has_pnext,has_pnext>>##&lpar;slink:VkSwapchainPresentFenceInfoEXT&rpar;: +',
...
def test_output_with_feature(registry):
    ...
    input = '\n'.join(['if (is_feature_enabled(robustBufferAccess) or',
                       ...
                       '  require(fence.valid())'])
    output = '\n'.join(['[vu]#[vu-keyword]##if## &lpar;[vu-builtin]##<<vu-builtin-is_feature_enabled,is_feature_enabled>>##&lpar;<<features-robustBufferAccess,robustBufferAccess>>&rpar; [vu-operator]##or## +',
                        '&nbsp;&nbsp;&nbsp;&nbsp;[vu-builtin]##<<vu-builtin-is_feature_enabled,is_feature_enabled>>##&lpar;<<features-storageBuffer16BitAccess,storageBuffer16BitAccess>>&rpar; [vu-operator]##or## +',
                        '&nbsp;&nbsp;&nbsp;&nbsp;[vu-builtin]##<<vu-builtin-is_feature_enabled,is_feature_enabled>>##&lpar;<<features-primitiveFragmentShadingRateMeshShader,primitiveFragmentShadingRateMeshShader>>&rpar;&rpar;: +',
                        '&nbsp;&nbsp;[vu-builtin]##<<vu-builtin-require,require>>##&lpar;fence.[vu-builtin]##<<vu-builtin-valid,valid>>##&lpar;&rpar;&rpar;#'])
    verify(formatter, input, output)
