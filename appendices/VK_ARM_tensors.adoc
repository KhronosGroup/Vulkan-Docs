...
*Interactions and External Dependencies*::
  ...
  - This extension interacts with `apiext:VK_KHR_unified_image_layouts`
  - This extension interacts with `apiext:VK_KHR_shader_bfloat16`
  - This extension interacts with `apiext:VK_EXT_shader_float8`
*IP Status*::
    No known IP claims.
*Contributors*::
  - Kévin Petit, Arm Ltd.
