...
| <<debugging,Debugging>> a| include::{chapters}/debugging.adoc[tag=scaddition]
|====
...
| <<descriptors,Resource Descriptors>> a| include::{chapters}/descriptorsets.adoc[tag=scdeviation]
| <<sparsememory,Sparse Resources>> a| include::{chapters}/sparsemem.adoc[tag=scdeviation]
| <<wsi,WSI Swapchain>> a| include::{chapters}/VK_KHR_surface/wsi.adoc[tag=scdeviation]
...
| <<descriptors,Resource Descriptors>> a| include::{chapters}/descriptorsets.adoc[tag=scremoved]
...
| <<wsi,WSI Swapchain>> a| include::{chapters}/VK_KHR_surface/wsi.adoc[tag=scremoved_swapchain]
|====
