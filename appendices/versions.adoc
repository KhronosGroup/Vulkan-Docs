...
As <<features-protectedMemory, pname:protectedMemory>> is optional in core
Vulkan, <<features-pipelineProtectedAccess, pname:pipelineProtectedAccess>>
is only required when <<features-protectedMemory, pname:protectedMemory>> is
supported.
