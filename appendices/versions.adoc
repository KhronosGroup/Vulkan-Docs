...
corresponding to the sname:VkPhysicalDevice4444FormatsFeaturesEXT structure.
...
There are no members in the slink:VkPhysicalDeviceVulkan13Features structure
corresponding to the sname:VkPhysicalDeviceExtendedDynamicStateFeaturesEXT
structure.
...
There are no members in the slink:VkPhysicalDeviceVulkan13Features structure
corresponding to the sname:VkPhysicalDeviceExtendedDynamicState2FeaturesEXT
structure.
...
1.3.
There are no members in the slink:VkPhysicalDeviceVulkan13Features structure
corresponding to the sname:VkPhysicalDeviceTexelBufferAlignmentFeaturesEXT
structure.
...
There are no members in the slink:VkPhysicalDeviceVulkan13Features structure
corresponding to the sname:VkPhysicalDeviceYcbcr2Plane444FormatsFeaturesEXT
structure.
