...
--
Vulkan Base Version 1.0 is a subset of the initial release of the Vulkan 1.0 API.
...
// This is the spec-specific form of the section
Vulkan Base Version 1.0 is a subset the initial release of the Vulkan 1.0 API.
...
--
Vulkan Compute Version 1.0 is a subset of the initial release of the Vulkan 1.0 API.
...
--
Vulkan Graphics Version 1.0 is a subset of the initial release of the Vulkan 1.0 API.
