...
[open,refpage='VkCuModuleTexturingModeCreateInfoNVX',desc='Stub description of VkCuModuleTexturingModeCreateInfoNVX',type='structs']
--
There is currently no specification language written for this type.
This section acts only as placeholder and to avoid dead links in the
specification and reference pages.

include::{generated}/api/structs/VkCuModuleTexturingModeCreateInfoNVX.adoc[]

include::{generated}/validity/structs/VkCuModuleTexturingModeCreateInfoNVX.adoc[]
--
...
=== Version History
  ...
  ** Add slink:VkCuModuleTexturingModeCreateInfoNVX
