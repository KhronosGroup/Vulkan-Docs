...
ifdef::VK_KHR_shader_untyped_pointers[]
    ...
    must: not be used with an code:OpTypeRuntimeArray that is the last
    member of a code:Block-decorated code:OpTypeStruct in the code:Uniform
    storage {StorageClass}
...
ifdef::VK_KHR_ray_tracing_pipeline[]
  ...
  * [[VUID-{refpage}-OpTraceRayKHR-11855]]
...
ifdef::VK_NV_ray_tracing_motion_blur[]
  ...
  * [[VUID-{refpage}-flags-11876]]
    ...
    pname:flags
  * [[VUID-{refpage}-OpHitObjectTraceRayMotionEXT-11877]]
    For code:OpHitObjectTraceRayMotionEXT and
    code:OpHitObjectTraceMotionReorderExecuteEXT instructions, the pipeline
    must: have been created with
    ename:VK_PIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV set
endif::VK_NV_ray_tracing_motion_blur[]
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11878]]
...
ifdef::VK_NV_ray_tracing_motion_blur[]
    ...
    floating-point values
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11879]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    floating-point values
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11880]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    operand
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11881]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    code:RayDirection, code:RayTmin, and code:RayTmax operands must: not
    contain NaNs
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11882]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
  ...
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11883]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    code:SkipAABBsKHR
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11884]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    code:CullFrontFacingTrianglesKHR
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11885]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
  ...
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11886]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    ename:VK_PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR set
  * [[VUID-{refpage}-OpHitObjectTraceRayEXT-11887]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
...
ifdef::VK_EXT_ray_tracing_invocation_reorder[]
  * [[VUID-{refpage}-maxShaderBindingTableRecordIndex-11888]]
