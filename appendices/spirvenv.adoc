...
ifdef::VK_EXT_shader_split_barrier[]
  ...
  * [[VUID-StandaloneSpirv-UniformConstant-06677]]
    ...
    code:Binding, or code:BuiltIn with code:SamplerHeapEXT or
  ...
  * [[VUID-StandaloneSpirv-Result-11339]]
    ...
    code:ResourceHeapEXT
  * [[VUID-StandaloneSpirv-Result-11346]]
    The code:Result code:Type operand of code:OpBufferPointerEXT must: have
    a code:Type operand that is <<interfaces-resources-layout, explicitly
    laid out>>
