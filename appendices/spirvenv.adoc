...
ifdef::VK_EXT_shader_tile_image[]
  * [[VUID-{refpage}-shaderTileImageColorReadAccess-08728]]
    If the <<features-shaderTileImageColorReadAccess,
    pname:shaderTileImageColorReadAccess>> feature is not enabled,
    code:OpColorAttachmentReadEXT operation must: not be used
  * [[VUID-{refpage}-shaderTileImageDepthReadAccess-08729]]
    If the <<features-shaderTileImageDepthReadAccess,
    pname:shaderTileImageDepthReadAccess>> feature is not enabled,
    code:OpDepthAttachmentReadEXT operation must: not be used
  * [[VUID-{refpage}-shaderTileImageStencilReadAccess-08730]]
    If the <<features-shaderTileImageStencilReadAccess,
    pname:shaderTileImageStencilReadAccess>> feature is not enabled,
