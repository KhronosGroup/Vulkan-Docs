...
// Add any needed conditional logic to the runtime section if needed.
  ...
  * [[VUID-{refpage}-ExecutionModel-07320]]
    If the code:ExecutionModel is *TessellationControl*, and the
    code:MemoryModel is *GLSL450*, the *Scope* for memory must: not be
    *Workgroup*
  * [[VUID-{refpage}-None-07321]]
    If the *Scope* for memory is *Workgroup*, then it must: only be used in
    the task, mesh, tessellation control, or compute execution models
  ...
  * [[VUID-{refpage}-SubgroupVoteKHR-07951]]
    ...
    code:SubgroupBallotKHR capabilities are declared, *Scope* for memory
  ...
  * [[VUID-{refpage}-None-04643]]
    ...
    *ShaderRecordBufferKHR*, *PhysicalStorageBuffer*, or *TileImageEXT*
  ...
  * [[VUID-{refpage}-None-08720]]
    If the *Storage Class* is *TileImageEXT*, then it must: only be used in
  ...
  * [[VUID-{refpage}-OpTypeRuntimeArray-04680]]
    ...
    code:PhysicalStorageBuffer storage classes; code:BufferBlock-decorated
    code:OpTypeStruct in code:Uniform storage class; the outermost dimension
    of an arrayed variable in the code:StorageBuffer, code:Uniform, or
    code:UniformConstant storage classes
  ...
  * [[VUID-{refpage}-Base-07650]]
    ...
    class of *Workgroup*, *StorageBuffer*, or *PhysicalStorageBuffer*
  * [[VUID-{refpage}-Base-07651]]
    If the code:Base operand of code:OpPtrAccessChain has a *Workgroup*
    storage class, then the code:VariablePointers capability must: be
    declared
  * [[VUID-{refpage}-Base-07652]]
    If the code:Base operand of code:OpPtrAccessChain has a *StorageBuffer*
    storage class, then the code:VariablePointers or
  ...
  * [[VUID-{refpage}-OpEntryPoint-06674]]
    ...
    code:OpVariable in the code:PushConstant storage class
  ...
  * [[VUID-{refpage}-Uniform-06676]]
    Any variable in the code:Uniform storage class must: be decorated as
  ...
  * [[VUID-{refpage}-TileImageEXT-08723]]
    ...
    code:TileImageEXT storage class and the code:Location decoration
...
ifdef::VK_VERSION_1_2,VK_KHR_vulkan_memory_model[]
  * [[VUID-{refpage}-vulkanMemoryModel-06265]]
    ...
    pname:vulkanMemoryModelDeviceScope>> is not enabled, *Device* memory
...
ifdef::VK_KHR_shader_atomic_int64[]
  * [[VUID-{refpage}-None-06278]]
    ...
    a _Pointer_ with a *Storage Class* of *StorageBuffer* or *Uniform*
...
ifndef::VK_EXT_shader_atomic_float2[]
  * [[VUID-{refpage}-None-06280]]
    ...
    atomic operations to be supported on a _Pointer_ with a *Storage Class*
    of *StorageBuffer*
...
ifdef::VK_EXT_shader_image_atomic_int64[]
  * [[VUID-{refpage}-None-06288]]
    ...
    must: be enabled for 64-bit integer atomic operations to be supported on
    a _Pointer_ with a *Storage Class* of *Image*
...
ifdef::VK_VERSION_1_2,VK_KHR_shader_float_controls[]
  ...
  * [[VUID-{refpage}-denormBehaviorIndependence-06290]]
    ...
    must: use the same denormals execution mode for all floating-point types
...
ifdef::VK_KHR_8bit_storage[]
  ...
  * [[VUID-{refpage}-uniformAndStorageBuffer8BitAccess-06329]]
    ...
    objects in the *Uniform* storage class with the *Block* decoration must:
    not have an 8-bit integer member
...
ifdef::VK_KHR_16bit_storage[]
  ...
  * [[VUID-{refpage}-uniformAndStorageBuffer16BitAccess-06332]]
    ...
    objects in the *Uniform* storage class with the *Block* decoration must:
    not have 16-bit integer or 16-bit floating-point members
...
[eq]#ULP = 1 / 2^<<limits-subPixelInterpolationOffsetBits,
...
ifdef::VK_VERSION_1_3,VK_KHR_maintenance4[]
  ...
  * [[VUID-{refpage}-Workgroup-06530]]
    ...
    storage class in the code:GLCompute {ExecutionModel} must: be less than
...
ifdef::VK_VERSION_1_3,VK_KHR_zero_initialize_workgroup_memory[]
  * [[VUID-{refpage}-shaderZeroInitializeWorkgroupMemory-06372]]
    ...
    code:OpVariable with *Workgroup* as its *Storage Class* must: not have
...
ifdef::VK_AMD_shader_early_and_late_fragment_tests[]
  ...
  * [[VUID-{refpage}-shaderEarlyAndLateFragmentTests-06771]]
    If <<features-shaderEarlyAndLateFragmentTests,
    pname:shaderEarlyAndLateFragmentTests>> is not enabled, the
    code:StencilRefGreaterBackEXT code:Execution code:Mode must: not be used
...
ifdef::VK_QCOM_image_processing[]
  ...
  * [[VUID-{refpage}-OpImageWeightedSampleQCOM-06980]]
    If an code:OpImageWeightedSampleQCOM operation is used, then the
    code:Weight code:Image parameter must: be of storage class
  ...
  * [[VUID-{refpage}-OpImageBlockMatchSSDQCOM-06986]]
    ...
    operation is used, then code:target code:sampled code:image and
    code:reference code:sampled code:image parameters must: have been
    created with sampler object with code:unnormalizeCordinates
...
In shaders that use the code:SignedZeroInfNanPreserve execution mode the
