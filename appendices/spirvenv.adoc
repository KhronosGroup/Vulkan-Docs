...
// Add any needed conditional logic to the runtime section if needed.
  ...
  * [[VUID-{refpage}-ExecutionModel-07320]]
    If the code:ExecutionModel is code:TessellationControl, and the
  ...
  * [[VUID-{refpage}-Location-04917]]
    If a <<interfaces-iointerfaces-user,user-defined variables>> points to a
    code:Block decorated code:OpTypeStruct, then the code:OpVariable must:
    have a code:Location decoration
  * [[VUID-{refpage}-Location-04918]]
    If a <<interfaces-iointerfaces-user,user-defined variable>> has a
    code:Location decoration, and the variable points to a
  ...
  * [[VUID-{refpage}-Location-04919]]
    ...
    have a code:Location decoration, and the variable points to a code:Block
    decorated code:OpTypeStruct, then each member of the struct must: have a
