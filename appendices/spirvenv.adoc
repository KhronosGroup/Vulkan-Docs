...
ifndef::VK_VERSION_1_1[]
  * [[VUID-{refpage}-SubgroupVoteKHR-06997]]
    If the code:SubgroupVoteKHR or code:SubgroupBallotKHR capability is not
  ...
  * [[VUID-{refpage}-MeshEXT-07728]]
    ...
    and the code:OutputPoints {ExecutionMode}, a code:PointSize decorated
...
ifdef::VK_QCOM_image_processing[]
  ...
  * [[VUID-{refpage}-OpImageBlockMatchSSDQCOM-06988]]
    ...
    <<limits-blockmatch-maxblocksize, maxBlockMatchRegion>>.
  * [[VUID-{refpage}-OpImageBoxFilterQCOM-06989]]
    ...
    to <<limits-boxfilter-maxblocksize, maxBoxFilterBlockSize>>.code:height.
