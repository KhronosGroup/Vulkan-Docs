...
ifdef::VK_EXT_shader_uniform_buffer_unsized_array[]
  ...
  * [[VUID-{refpage}-OpArrayLength-11805]]
    code:OpArrayLength
...
ifdef::VK_KHR_shader_fma[]
  * [[VUID-{refpage}-shaderFmaFloat16-10977]]
    ...
    16-bit float
  * [[VUID-{refpage}-shaderFmaFloat32-10978]]
    <<features-shaderFmaFloat32, pname:shaderFmaFloat32>> must: be enabled
    for code:OpFmaKHR to be supported with a result type that includes a
    32-bit float
  * [[VUID-{refpage}-shaderFmaFloat64-10979]]
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
  ...
  * [[VUID-{refpage}-maintenance5-10934]]
    If the <<features-maintenance5, pname:maintenance5>> feature is enabled
...
ifdef::VK_EXT_shader_uniform_buffer_unsized_array[]
  * [[VUID-{refpage}-shaderUniformBufferUnsizedArray-11806]]
...
ifdef::VK_EXT_shader_64bit_indexing[]
  ...
  * [[VUID-{refpage}-OpArrayLength-11807]]
    code:OpArrayLength
ifdef::VK_KHR_shader_untyped_pointers[]
    and code:OpUntypedArrayLengthKHR
endif::VK_KHR_shader_untyped_pointers[]
...
ifdef::VK_NV_cooperative_vector[]
  * [[VUID-{refpage}-OpCooperativeVectorMatrixMulAddNV-11808]]
...
ifdef::VK_EXT_shader_64bit_indexing[]
  ...
  * [[VUID-{refpage}-OpCooperativeVectorLoadNV-11809]]
