...
// Add any needed conditional logic to the runtime section if needed.
  ...
  * [[VUID-StandaloneSpirv-None-04636]]
    ...
    code:Subgroup
  * [[VUID-StandaloneSpirv-Scope-12243]]
  ...
  * [[VUID-StandaloneSpirv-MemorySemantics-13551]]
    ...
    barrier instructions (code:OpControlBarrier,
ifdef::VK_EXT_shader_split_barrier[]
    code:OpControlBarrierArriveEXT, code:OpControlBarrierWaitEXT,
endif::VK_EXT_shader_split_barrier[]
    or code:OpMemoryBarrier)
  ...
  * [[VUID-StandaloneSpirv-OpImageTexelPointer-04658]]
    ...
    code:R32ui
  * [[VUID-StandaloneSpirv-OpUntypedImageTexelPointerEXT-11416]]
    If an code:OpUntypedImageTexelPointerEXT instruction is used in an
    atomic operation, the image type operand must: have an image format of
    code:R64i, code:R64ui, code:R32f, code:R32i, or code:R32ui
  ...
  * [[VUID-StandaloneSpirv-OpImageGather-04664]]
    The "`Component`" operand of code:OpImageGather,
ifdef::VK_QCOM_image_processing3[code:OpImageGatherQCOM,]
    and code:OpImageSparseGather must: be the <id> of a constant instruction
  ...
  * [[VUID-StandaloneSpirv-None-04667]]
    If the code:DescriptorHeapEXT capability is not declared, structure
    types must: not contain opaque types
  * [[VUID-StandaloneSpirv-DescriptorHeapEXT-11482]]
    If the code:DescriptorHeapEXT capability is declared, structure types
  ...
  * [[VUID-StandaloneSpirv-Component-04921]]
    If the code:Component decoration is used on a variable that has a vector
    type with a code:Component code:Type with a code:Width that is less than
    or equal to 32, the sum of its code:Component code:Count and the
    code:Component decoration value must: be less than or equal to 4
  * [[VUID-StandaloneSpirv-Component-04922]]
    If the code:Component decoration is used on a variable that has a vector
    type with a code:Component code:Type with a code:Width that is equal to
    64, the sum of two times its code:Component code:Count and the
    code:Component decoration value must: be less than or equal to 4
  ...
  * [[VUID-StandaloneSpirv-TessLevelInner-10880]]
  ...
  ** the last member of a code:Block-decorated code:OpTypeStruct in the
     code:Uniform storage {StorageClass}
  ...
  * [[VUID-StandaloneSpirv-OpArrayLength-11805]]
    code:OpArrayLength and code:OpUntypedArrayLengthKHR must: not be used
    with an code:OpTypeRuntimeArray that is the last member of a
    code:Block-decorated code:OpTypeStruct in the code:Uniform storage
    {StorageClass}
  ...
  * [[VUID-StandaloneSpirv-Function-12294]]
    A type _T_ that is a vector sized with a specialization constant must:
    neither be, nor be contained in, the type _T2_ of a variable _V_, unless
    either: a) _T_ is equal to _T2_, b) _V_ is declared in the
    code:Function, or code:Private {StorageClass}, c) _V_ is a non-Block
    variable in the code:Workgroup {StorageClass}, or d) _V_ is an interface
...
ifdef::VK_EXT_shader_split_barrier[]
  * [[VUID-StandaloneSpirv-SplitBarrierEXT-13552]]
    The code:SplitBarrierEXT capability must: not be enabled in any stage
    other than compute
  * [[VUID-StandaloneSpirv-OpControlBarrierArriveEXT-13553]]
    The execution Scope for code:OpControlBarrierArriveEXT and
    code:OpControlBarrierWaitEXT must: be code:Workgroup or code:Subgroup
  * [[VUID-StandaloneSpirv-MemorySemantics-13556]]
    The code:MemorySemantics for code:OpControlBarrierArriveEXT must: not
    have any non-relaxed memory order set other than code:Release
  * [[VUID-StandaloneSpirv-MemorySemantics-13557]]
    The code:MemorySemantics for code:OpControlBarrierWaitEXT must: not have
    any non-relaxed memory order set other than code:Acquire
endif::VK_EXT_shader_split_barrier[]
  ...
  * [[VUID-{refpage}-Offset-12509]]
    Variables or block members in the input interface decorated with
    code:Offset must: also be decorated with code:PerTaskNV
  * [[VUID-StandaloneSpirv-Offset-04716]]
    ...
    code:XfbStride, inherit code:XfbBuffer and code:XfbStride decorations
    from a block containing them, or be decorated with code:PerTaskNV
  ...
  * [[VUID-StandaloneSpirv-OpUntypedVariableKHR-11167]]
    Any code:OpUntypedVariableKHR with a {StorageClass} other than
    code:UniformConstant must: have a code:Data code:Type operand specified
  * [[VUID-StandaloneSpirv-OpUntypedVariableKHR-11347]]
    Any code:OpUntypedVariableKHR in the code:UniformConstant storage class
    without a code:Data code:Type must: be decorated with
    code:SamplerHeapEXT or code:ResourceHeapEXT
  ...
  * [[VUID-StandaloneSpirv-OpVariable-06673]]
    ...
    unless the code:PushConstantBanksNV capability is declared
  * [[VUID-StandaloneSpirv-OpEntryPoint-06674]]
    Each code:OpEntryPoint must: statically use at most one variable in the
    code:PushConstant {StorageClass} unless the code:PushConstantBanksNV
  ...
  * [[VUID-StandaloneSpirv-UniformConstant-06677]]
    ...
    code:Uniform {StorageClass} must: be decorated with either
    code:DescriptorSet and code:Binding, or code:BuiltIn with
    code:SamplerHeapEXT or code:ResourceHeapEXT
  ...
  * [[VUID-StandaloneSpirv-StorageTexelBufferArrayDynamicIndexing-10133]]
    ...
    must: be determined by <<glossary-constant-integral-expression, constant
    integral expressions>>
  * [[VUID-StandaloneSpirv-MaximallyReconvergesKHR-09565]]
    The code:MaximallyReconvergesKHR {ExecutionMode} must: not be applied to
    an entry point if an _invocation repack instruction_ is statically used
  ...
  * [[VUID-StandaloneSpirv-Result-11336]]
    If the code:Result code:Type operand of code:OpLoad is
    code:OpTypeSampler, code:Pointer must: be derived from a variable
    decorated with code:Binding and code:DescriptorSet, or decorated with
    code:BuiltIn and code:SamplerHeapEXT
  * [[VUID-StandaloneSpirv-Result-11337]]
    If the code:Result code:Type operand of code:OpLoad is code:OpTypeImage,
    code:Pointer must: be derived from a variable decorated with
    code:Binding and code:DescriptorSet, or decorated with code:BuiltIn and
    code:ResourceHeapEXT
  * [[VUID-StandaloneSpirv-Result-11339]]
    If the code:Result code:Type operand of code:OpLoad is
    code:OpTypeAccelerationStructureKHR, and code:Pointer is not in the
    code:Private or code:Function {StorageClass}, code:Pointer must: be
    derived from a variable decorated with code:Binding and
    code:DescriptorSet, or decorated with code:BuiltIn and
    code:ResourceHeapEXT
  * [[VUID-StandaloneSpirv-OpTypeUntypedPointerKHR-11417]]
    The {StorageClass} of code:OpTypeUntypedPointerKHR must: be code:Image,
    code:UniformConstant,code:Workgroup, code:StorageBuffer, code:Uniform,
    code:PushConstant, or code:PhysicalStorageBuffer
  * [[VUID-StandaloneSpirv-None-12295]]
    If the code:LongVectorEXT capability is not declared, the code:Component
    code:Count of any vector type must: be less than or equal to `4` and
    greater than `1`
  * [[VUID-StandaloneSpirv-Type-12297]]
    Any pointer type whose code:Type parameter is a vector type with more
  ...
  * [[VUID-{refpage}-OpConvertFToU-12465]]
    Floating-point objects consumed or produced by code:OpConvertFToU,
    code:OpConvertFToS, code:OpConvertSToF, or code:OpConvertUToF must: not
    have a code:Float6E2M3EXT, code:Float6E3M2EXT, code:Float4E2M1EXT,
    code:Float8UnsignedE8M0EXT, or code:MXInt8EXT encoding
  * [[VUID-{refpage}-OpFConvert-12466]]
    Floating-point objects produced by code:OpFConvert must: not have a
    code:Float6E2M3EXT, code:Float6E3M2EXT, code:Float4E2M1EXT,
    code:Float8UnsignedE8M0EXT, or code:MXInt8EXT encoding
  * [[VUID-{refpage}-OpFConvert-12467]]
    If the object consumed by code:OpFConvert has a code:Float6E2M3EXT,
    code:Float6E3M2EXT, code:Float4E2M1EXT, code:Float8UnsignedE8M0EXT, or
    code:MXInt8EXT encoding, then the code:Result code:Type must: have an
    <<ieee-754,IEEE 754>>, code:Float8E4M3EXT, code:Float8E5M2EXT, or
    code:BFloat16KHR encoding
  * [[VUID-{refpage}-Result-12468]]
    The code:Result code:Type operand of code:OpBitcastExtractEXT must: be
    code:OpTypeFloat with a code:Float6E2M3EXT, code:Float6E3M2EXT, or
    code:Float4E2M1EXT encoding
  * [[VUID-{refpage}-Base-12469]]
    The code:Base operand of code:OpBitcastExtractEXT must: be a scalar or
    vector integer type
****
--
...
.Valid Usage
****
ifdef::VK_COMPUTE_VERSION_1_2,VK_KHR_vulkan_memory_model[]
...
endif::VK_COMPUTE_VERSION_1_2,VK_KHR_vulkan_memory_model[]
...
ifndef::VK_GRAPHICS_VERSION_1_4,VK_KHR_dynamic_rendering_local_read[Any]
...
ifdef::VK_COMPUTE_VERSION_1_1[]
  ...
  * [[VUID-RuntimeSpirv-maxClipDistances-00708]]
    If sname:VkPhysicalDeviceLimits::pname:maxClipDistances is not zero,
    then any entry point interface variable declared with the
    code:ClipDistance code:BuiltIn decoration, must: not have an array size
    greater than sname:VkPhysicalDeviceLimits::pname:maxClipDistances
  * [[VUID-RuntimeSpirv-maxCullDistances-00709]]
    If sname:VkPhysicalDeviceLimits::pname:maxCullDistances is not zero,
    then any entry point interface variable declared with the
    code:CullDistance code:BuiltIn decoration, must: not have an array size
    greater than sname:VkPhysicalDeviceLimits::pname:maxCullDistances
  * [[VUID-RuntimeSpirv-maxCombinedClipAndCullDistances-00710]]
    If sname:VkPhysicalDeviceLimits::pname:maxCombinedClipAndCullDistances
    is not zero, then any entry point interface variable declared with the
    code:ClipDistance code:BuiltIn and code:CullDistance code:BuiltIn
  ...
  * [[VUID-RuntimeSpirv-maxClipDistances-08448]]
    If sname:VkPhysicalDeviceLimits::pname:maxClipDistances is zero, then
    entry point interface variables declared with the code:ClipDistance
    code:BuiltIn decoration must: not be statically accessed
  * [[VUID-RuntimeSpirv-maxCullDistances-08449]]
    If sname:VkPhysicalDeviceLimits::pname:maxCullDistances is zero, then
    entry point interface variables declared with the code:CullDistance
    code:BuiltIn decoration must: not be statically accessed
...
ifdef::VK_EXT_descriptor_heap[]
    the code:DescriptorHeapEXT capability is not declared,
...
ifdef::VK_EXT_descriptor_heap[]
    ...
    image operand) must: be decorated with code:NonUniform
endif::VK_COMPUTE_VERSION_1_1[]
...
ifdef::VK_KHR_shader_fma[]
  * [[VUID-RuntimeSpirv-shaderFmaFloat16-10977]]
    <<features-shaderFmaFloat16, pname:shaderFmaFloat16>> must: be enabled
    for code:OpFmaKHR to be supported with a result type that includes a
    16-bit float
  * [[VUID-RuntimeSpirv-shaderFmaFloat32-10978]]
    <<features-shaderFmaFloat32, pname:shaderFmaFloat32>> must: be enabled
    for code:OpFmaKHR to be supported with a result type that includes a
    32-bit float
  * [[VUID-RuntimeSpirv-shaderFmaFloat64-10979]]
    <<features-shaderFmaFloat64, pname:shaderFmaFloat64>> must: be enabled
    for code:OpFmaKHR to be supported with a result type that includes a
    64-bit float
...
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_buffer_device_address,VK_KHR_buffer_device_address[]
  ...
  * [[VUID-RuntimeSpirv-PhysicalStorageBuffer64-11819]]
    ...
    code:PhysicalStorageBuffer {StorageClass} must: reference a buffer
    created with the ename:VK_BUFFER_USAGE_SHADER_DEVICE_ADDRESS_BIT usage
    flag set
...
ifdef::VK_EXT_cooperative_matrix_maintenance1[]
    if the <<features-cooperativeMatrixProperties2EXT,
    slink:VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT::pname:cooperativeMatrixProperties2>>
    feature is not enabled,
endif::VK_EXT_cooperative_matrix_maintenance1[]
    the type must: match one of the supported
    slink:VkCooperativeMatrixPropertiesKHR structures as defined in
    <<shaders-cooperative-matrix-properties-khr-type-matching,
    VkCooperativeMatrixPropertiesKHR Type Matching>>
...
ifdef::VK_EXT_cooperative_matrix_maintenance1[]
    ...
    slink:VkCooperativeMatrixPropertiesKHR structure as defined in
    <<shaders-cooperative-matrix-properties-khr-muladd-matching,
    VkCooperativeMatrixPropertiesKHR Multiply-Add Matching>>
ifdef::VK_QCOM_cooperative_matrix_conversion[]
  * [[VUID-{refpage}-NSize-12352]]
    For code:OpExtractSubArrayQCOM, the length of the code:Source code:Array
    operand must: match the
    slink:VkCooperativeMatrixPropertiesKHR::pname:NSize of one of the
    matrices in any of the supported slink:VkCooperativeMatrixPropertiesKHR
  * [[VUID-{refpage}-KSize-12353]]
    For code:OpExtractSubArrayQCOM, the length of the code:Result code:Type
    operand must: match the
    slink:VkCooperativeMatrixPropertiesKHR::pname:KSize of one of the
    matrices in any of the supported slink:VkCooperativeMatrixPropertiesKHR
  * [[VUID-{refpage}-OpExtractSubArrayQCOM-12354]]
    For code:OpExtractSubArrayQCOM, the code:Start code:Index operand must:
    be a multiple of the length of the code:Result code:Type operand
...
ifndef::VK_NV_cooperative_matrix2[The]
    scope of all code:OpTypeCooperativeMatrixKHR must: not be
    elink:VkScopeKHR::ename:VK_SCOPE_WORKGROUP_KHR
ifdef::VK_EXT_cooperative_matrix_maintenance1[]
  * [[VUID-{refpage}-cooperativeMatrixProperties2-13382]]
    For code:OpTypeCooperativeMatrixKHR, if the
    <<features-cooperativeMatrixProperties2EXT,
    slink:VkPhysicalDeviceCooperativeMatrixMaintenance1FeaturesEXT::pname:cooperativeMatrixProperties2>>
    feature is enabled
ifdef::VK_NV_cooperative_matrix2[]
    and the <<features-cooperativeMatrixFlexibleDimensions,
    pname:cooperativeMatrixFlexibleDimensions>> feature is not enabled
endif::VK_NV_cooperative_matrix2[]
    then the type must: either match one of the supported
    slink:VkCooperativeMatrixPropertiesKHR structures as defined in
    <<shaders-cooperative-matrix-properties-khr-type-matching,
    VkCooperativeMatrixPropertiesKHR Type Matching>>, or match one of the
    supported slink:VkCooperativeMatrixProperties2EXT structures as defined
    in <<shaders-cooperative-matrix-properties2-type-matching,
    VkCooperativeMatrixProperties2EXT Type Matching>>
  * [[VUID-{refpage}-cooperativeMatrixProperties2-13383]]
...
ifdef::VK_NV_cooperative_matrix2[]
    ...
    slink:VkCooperativeMatrixPropertiesKHR structures as defined in
    <<shaders-cooperative-matrix-properties-khr-muladd-matching,
    VkCooperativeMatrixPropertiesKHR Multiply-Add Matching>>, or match one
    of the supported slink:VkCooperativeMatrixProperties2EXT structures as
    defined in <<shaders-cooperative-matrix-properties2-muladd-matching,
    VkCooperativeMatrixProperties2EXT Multiply-Add Matching>>
endif::VK_EXT_cooperative_matrix_maintenance1[]
ifdef::VK_NV_cooperative_matrix2[]
  * [[VUID-RuntimeSpirv-cooperativeMatrixFlexibleDimensions-10165]]
    For code:OpTypeCooperativeMatrixKHR, if the
    <<features-cooperativeMatrixFlexibleDimensions,
    pname:cooperativeMatrixFlexibleDimensions>> feature is enabled, the type
    must: match one of the following:
  ** A supported slink:VkCooperativeMatrixPropertiesKHR structure as defined
     in <<shaders-cooperative-matrix-properties-khr-type-matching,
     VkCooperativeMatrixPropertiesKHR Type Matching>>
ifdef::VK_EXT_cooperative_matrix_maintenance1[]
  ** If the <<features-cooperativeMatrixProperties2EXT,
     pname:cooperativeMatrixProperties2>> feature is enabled, a supported
     slink:VkCooperativeMatrixProperties2EXT structure as defined in
     <<shaders-cooperative-matrix-properties2-type-matching,
     VkCooperativeMatrixProperties2EXT Type Matching>>
endif::VK_EXT_cooperative_matrix_maintenance1[]
  ** A supported slink:VkCooperativeMatrixFlexibleDimensionsPropertiesNV
     structure as defined in
     <<shaders-cooperative-matrix-flexible-dimensions-properties-type-matching,
     VkCooperativeMatrixFlexibleDimensionsPropertiesNV Type Matching>>
  ...
  ** A supported slink:VkCooperativeMatrixPropertiesKHR structure as defined
     in <<shaders-cooperative-matrix-properties-khr-muladd-matching,
     VkCooperativeMatrixPropertiesKHR Multiply-Add Matching>>
ifdef::VK_EXT_cooperative_matrix_maintenance1[]
  ** If the <<features-cooperativeMatrixProperties2EXT,
     pname:cooperativeMatrixProperties2>> feature is enabled, a supported
     slink:VkCooperativeMatrixProperties2EXT structure as defined in
     <<shaders-cooperative-matrix-properties2-muladd-matching,
     VkCooperativeMatrixProperties2EXT Multiply-Add Matching>>
endif::VK_EXT_cooperative_matrix_maintenance1[]
  ** A supported slink:VkCooperativeMatrixFlexibleDimensionsPropertiesNV
     structure as defined in
     VkCooperativeMatrixFlexibleDimensionsPropertiesNV
     <<shaders-cooperative-matrix-flexible-dimensions-properties-muladd-matching,
     Multiply-Add Matching>>
  * [[VUID-RuntimeSpirv-cooperativeMatrixFlexibleDimensionsMaxDimension-10167]]
    If the <<features-cooperativeMatrixFlexibleDimensions,
    pname:cooperativeMatrixFlexibleDimensions>> feature is enabled, all
    code:OpTypeCooperativeMatrixKHR dimensions must: be less than or equal
    to
...
ifdef::VK_NV_cooperative_matrix_decode_vector[]
  * [[VUID-{refpage}-OpCooperativeMatrixLoadTensorNV-12429]]
    For each code:OpCooperativeMatrixLoadTensorNV instruction that includes
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_EXT_subgroup_size_control[]
  ...
  * [[VUID-{refpage}-OpCooperativeMatrix-12379]]
    If any code:OpCooperativeMatrix* instructions accesses a descriptor, it
...
ifdef::VK_EXT_mesh_shader[]
  ...
  * [[VUID-{refpage}-MeshEXT-12333]]
    For mesh shaders using the code:MeshEXT {ExecutionModel} the index into
    the array of any variable decorated with the code:PerPrimitiveEXT
  ...
  * [[VUID-{refpage}-MeshEXT-12380]]
    If the code:MeshEXT {ExecutionModel} dynamically accesses a variable
    with the code:TaskPayloadWorkgroupEXT {StorageClass}, there must be a
    matching code:TaskPayloadWorkgroupEXT {StorageClass} variable in the
    code:TaskEXT {ExecutionModel} passed as an argument to
...
ifdef::VK_ARM_tensors[storage tensor,]
    and storage buffer variables in the fragment stage must: be decorated
    with the code:NonWritable decoration
...
ifdef::VK_ARM_tensors[storage tensor,]
    ...
    stages must: be decorated with the code:NonWritable decoration
ifdef::VKSC_VERSION_1_0[]
...
ifdef::VK_KHR_opacity_micromap[]
  * [[VUID-{refpage}-RayTracingOpacityMicromapKHR-11542]]
    If the code:RayTracingOpacityMicromapKHR capability is not enabled, any
    code:Rayflags operand provided to an instruction must: not contain
    code:ForceOpacityMicromap2StateKHR
ifdef::VK_EXT_opacity_micromap+VK_ARM_pipeline_opacity_micromap[]
  * [[VUID-{refpage}-micromap-11630]]
    If the code:OpacityMicromapIdKHR execution mode is specified with its
    specialization constant operand equal to ename:VK_TRUE, the pipeline
    must: not have been created with
    ename:VK_PIPELINE_CREATE_2_DISALLOW_OPACITY_MICROMAP_BIT_ARM
endif::VK_EXT_opacity_micromap+VK_ARM_pipeline_opacity_micromap[]
...
ifdef::VK_NV_ray_tracing_motion_blur[]
  * [[VUID-RuntimeSpirv-flags-11875]]
    For code:OpHitObjectTraceRayMotionEXT and
    code:OpHitObjectTraceMotionReorderExecuteEXT instructions, if
    code:Acceleration code:Structure was built with
    ename:VK_BUILD_ACCELERATION_STRUCTURE_MOTION_BIT_NV in pname:flags, the
    pipeline must: have been created with
    ename:VK_PIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV set
  * [[VUID-RuntimeSpirv-flags-11876]]
    For code:OpHitObjectTraceRayMotionEXT and
    code:OpHitObjectTraceMotionReorderExecuteEXT instructions,
    code:Acceleration code:Structure must: be an acceleration structure
    built as a <<acceleration-structure-top-level, top-level acceleration
    structure>> with ename:VK_BUILD_ACCELERATION_STRUCTURE_MOTION_BIT_NV in
    pname:flags
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayMotionEXT-11877]]
    For code:OpHitObjectTraceRayMotionEXT and
    code:OpHitObjectTraceMotionReorderExecuteEXT instructions, the pipeline
    must: have been created with
    ename:VK_PIPELINE_CREATE_RAY_TRACING_ALLOW_MOTION_BIT_NV set
endif::VK_NV_ray_tracing_motion_blur[]
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11878]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
endif::VK_NV_ray_tracing_motion_blur[]
    and code:OpHitObjectTraceReorderExecuteEXT instructions, all components
    of the code:RayOrigin and code:RayDirection operands must: be finite
    floating-point values
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11879]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
endif::VK_NV_ray_tracing_motion_blur[]
    and code:OpHitObjectTraceReorderExecuteEXT instructions, the
    code:RayTmin and code:RayTmax operands must: be non-negative
    floating-point values
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11880]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    and code:OpHitObjectTraceReorderExecuteEXT instructions, the
    code:RayTmin operand must: be less than or equal to the code:RayTmax
    operand
...
ifdef::VK_NV_ray_tracing_motion_blur[]
    ...
    and code:OpHitObjectTraceReorderExecuteEXT instructions, code:RayOrigin,
    code:RayDirection, code:RayTmin, and code:RayTmax operands must: not
    contain NaNs
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11882]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
endif::VK_NV_ray_tracing_motion_blur[]
    and code:OpHitObjectTraceReorderExecuteEXT instructions the code:time
    operand must: be between 0.0 and 1.0
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11883]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    and code:OpHitObjectTraceReorderExecuteEXT instructions, the
    code:Rayflags operand must: not contain both code:SkipTrianglesKHR and
    code:SkipAABBsKHR
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11884]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    and code:OpHitObjectTraceReorderExecuteEXT instructions, the
    code:Rayflags operand must: not contain more than one of
    code:SkipTrianglesKHR, code:CullBackFacingTrianglesKHR, and
    code:CullFrontFacingTrianglesKHR
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11885]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    and code:OpHitObjectTraceReorderExecuteEXT instructions, the
    code:Rayflags operand must: not contain more than one of code:OpaqueKHR,
    code:NoOpaqueKHR, code:CullOpaqueKHR, and code:CullNoOpaqueKHR
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11886]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
endif::VK_NV_ray_tracing_motion_blur[]
    and code:OpHitObjectTraceReorderExecuteEXT instructions, if the
    code:Rayflags operand contains code:SkipTrianglesKHR, the pipeline must:
    not have been created with
    ename:VK_PIPELINE_CREATE_RAY_TRACING_SKIP_AABBS_BIT_KHR set
  * [[VUID-RuntimeSpirv-OpHitObjectTraceRayEXT-11887]]
    For code:OpHitObjectTraceRayEXT,
ifdef::VK_NV_ray_tracing_motion_blur[]
    code:OpHitObjectTraceRayMotionEXT,
    code:OpHitObjectTraceMotionReorderExecuteEXT
    ...
    and code:OpHitObjectTraceReorderExecuteEXT instructions, if the
    code:Rayflags operand contains code:SkipAABBsKHR, the pipeline must: not
    have been created with
    ename:VK_PIPELINE_CREATE_RAY_TRACING_SKIP_TRIANGLES_BIT_KHR set
...
ifndef::VK_COMPUTE_VERSION_1_3,VK_KHR_maintenance4[]
  ...
  * [[VUID-RuntimeSpirv-OpTypeVector-06816]]
    Any vector type output interface variables must: not have a higher
    code:Component code:Count than a matching vector type input interface
    variable
...
ifdef::VK_COMPUTE_VERSION_1_3,VK_KHR_maintenance4[]
  ...
  * [[VUID-RuntimeSpirv-maintenance4-06817]]
    ...
    higher code:Component code:Count than a matching vector type input
    interface variable
endif::VK_COMPUTE_VERSION_1_3,VK_KHR_maintenance4[]
...
ifndef::VK_COMPUTE_VERSION_1_3,VK_KHR_zero_initialize_workgroup_memory[]
...
ifdef::VK_QCOM_image_processing3[or code:OpImageGatherQCOM]
    instructions
ifdef::VK_KHR_shader_untyped_pointers[]
  ...
  ** If 16-bit storage is enabled for the storage classes of both the
     code:Target and code:Source operands the code:Size operand may instead
     be a multiple of 2
  ...
  * [[VUID-RuntimeSpirv-OpImage-06376]]
    If an code:OpImage*Gather
ifdef::VK_QCOM_image_processing3[or code:OpImageGatherQCOM]
    operation has an image operand of code:Offset, code:ConstOffset, or
    code:ConstOffsets the offset value must: be greater than or equal to
    <<limits-minTexelGatherOffset, pname:minTexelGatherOffset>>
  * [[VUID-RuntimeSpirv-OpImage-06377]]
    If an code:OpImage*Gather
ifdef::VK_QCOM_image_processing3[or code:OpImageGatherQCOM]
    operation has an image operand of code:Offset, code:ConstOffset, or
    code:ConstOffsets the offset value must: be less than or equal to
    <<limits-maxTexelGatherOffset, pname:maxTexelGatherOffset>>
...
ifdef::VK_QCOM_render_pass_shader_resolve,VK_EXT_custom_resolve[]
  * [[VUID-RuntimeSpirv-SampleRateShading-06378]]
    ...
    ename:VK_SUBPASS_DESCRIPTION_FRAGMENT_REGION_BIT_EXT, then the SPIR-V
...
ifdef::VK_AMD_shader_early_and_late_fragment_tests[]
  * [[VUID-RuntimeSpirv-shaderEarlyAndLateFragmentTests-06767]]
    ...
    code:EarlyAndLateFragmentTestsAMD {ExecutionMode} must: not be used
  * [[VUID-RuntimeSpirv-shaderEarlyAndLateFragmentTests-06768]]
    If the <<features-shaderEarlyAndLateFragmentTests,
    pname:shaderEarlyAndLateFragmentTests>> feature is not enabled, the
    code:StencilRefUnchangedFrontAMD {ExecutionMode} must: not be used
  * [[VUID-RuntimeSpirv-shaderEarlyAndLateFragmentTests-06769]]
    If the <<features-shaderEarlyAndLateFragmentTests,
    pname:shaderEarlyAndLateFragmentTests>> feature is not enabled, the
    code:StencilRefUnchangedBackAMD {ExecutionMode} must: not be used
  * [[VUID-RuntimeSpirv-shaderEarlyAndLateFragmentTests-06770]]
    If the <<features-shaderEarlyAndLateFragmentTests,
    pname:shaderEarlyAndLateFragmentTests>> feature is not enabled, the
    code:StencilRefGreaterFrontAMD {ExecutionMode} must: not be used
  * [[VUID-RuntimeSpirv-shaderEarlyAndLateFragmentTests-06771]]
    If the <<features-shaderEarlyAndLateFragmentTests,
    pname:shaderEarlyAndLateFragmentTests>> feature is not enabled, the
    code:StencilRefGreaterBackAMD {ExecutionMode} must: not be used
  * [[VUID-RuntimeSpirv-shaderEarlyAndLateFragmentTests-06772]]
    If the <<features-shaderEarlyAndLateFragmentTests,
    pname:shaderEarlyAndLateFragmentTests>> feature is not enabled, the
    code:StencilRefLessFrontAMD {ExecutionMode} must: not be used
  * [[VUID-RuntimeSpirv-shaderEarlyAndLateFragmentTests-06773]]
    If the <<features-shaderEarlyAndLateFragmentTests,
    pname:shaderEarlyAndLateFragmentTests>> feature is not enabled, the
    code:StencilRefLessBackAMD {ExecutionMode} must: not be used
endif::VK_AMD_shader_early_and_late_fragment_tests[]
ifdef::VK_QCOM_image_processing[]
  * [[VUID-RuntimeSpirv-OpImageSampleWeightedQCOM-06979]]
    If an code:OpImageSampleWeightedQCOM operation is used, then the
  ...
  * [[VUID-RuntimeSpirv-OpImageSampleWeightedQCOM-06980]]
    If an code:OpImageSampleWeightedQCOM operation is used, then the
  ...
  * [[VUID-RuntimeSpirv-OpImageSampleWeightedQCOM-06981]]
    If an code:OpImageSampleWeightedQCOM operation is used, then the
...
ifdef::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
  ...
  * [[VUID-RuntimeSpirv-maintenance5-10934]]
    If the <<features-maintenance5, pname:maintenance5>> feature is enabled
    and a code:PointSize decorated variable is written to for any output
    vertex in the code:Geometry {ExecutionModel}, all execution paths for
    all output vertices must: write to a code:PointSize decorated variable
endif::VK_GRAPHICS_VERSION_1_4,VK_KHR_maintenance5[]
...
ifdef::VK_QCOM_image_processing2[]
  ...
  * [[VUID-RuntimeSpirv-pNext-09226]]
    ...
    code:target code:sampled code:image must: have been created using a
...
ifdef::VK_EXT_shader_split_barrier[]
  * [[VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13558]]
    If a code:OpControlBarrierArriveEXT or code:OpControlBarrierWaitEXT
    instruction is executed with an execution scope equal to code:Workgroup,
    its execution must: be inside _uniform control flow_ within the
    invocation group
  * [[VUID-RuntimeSpirv-OpControlBarrierWaitEXT-13559]]
    If a code:OpControlBarrierWaitEXT instruction is executed, a
    code:OpControlBarrierArriveEXT instruction with the same execution scope
    must: have been executed previously
  * [[VUID-RuntimeSpirv-OpControlBarrierWaitEXT-13560]]
    If a code:OpControlBarrierWaitEXT instruction is executed, another
    code:OpControlBarrierWaitEXT instruction with the same execution scope
    must: not have been previously executed prior to the last executed
    code:OpControlBarrierArriveEXT instruction with the same execution scope
  * [[VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13561]]
    If a code:OpControlBarrierArriveEXT instruction is executed, another
    code:OpControlBarrierArriveEXT instruction with the same execution scope
    must: not have been previously executed unless a
    code:OpControlBarrierWaitEXT instruction with the same execution scope
    has been executed after it
  * [[VUID-RuntimeSpirv-OpControlBarrierArriveEXT-13562]]
    If the module uses code:OpControlBarrierArriveEXT or
    code:OpControlBarrierWaitEXT, the sum of size in bytes for variables and
    <<workgroup-padding, padding>> in the code:Workgroup {StorageClass} in
    the code:GLCompute {ExecutionModel} must: be less than or equal to
    <<limits-maxComputeSharedMemorySize, pname:maxComputeSharedMemorySize>>
    minus
    <<limits-splitBarrierReservedSharedMemory,pname:splitBarrierReservedSharedMemory>>
endif::VK_EXT_shader_split_barrier[]
ifdef::VK_QCOM_shader_multiple_wait_queues[]
  * [[VUID-{refpage}-maxShaderWaitQueues-12426]]
    The literal operand of the code:MultipleWaitQueuesQCOM Loop Control
    must: be less than or equal to
    slink:VkPhysicalDeviceShaderMultipleWaitQueuesPropertiesQCOM::pname:maxShaderWaitQueues
...
ifdef::VK_QCOM_tile_shading[]
  ...
  * [[VUID-RuntimeSpirv-OpImage-10706]]
    ...
    must: not be consumed by code:OpImageTexelPointer
ifdef::VK_KHR_shader_untyped_pointers+VK_EXT_descriptor_heap[]
    or code:OpUntypedImageTexelPointerEXT
endif::VK_KHR_shader_untyped_pointers+VK_EXT_descriptor_heap[]
    unless the <<features-tileShadingFragmentStage,tileShadingAtomicOps>>
    feature is enabled
...
ifdef::VK_QCOM_image_processing,VK_QCOM_image_processing2[]
  ...
  * [[VUID-RuntimeSpirv-Coordinate-10713]]
    ...
    code:OpImageSparseRead, code:OpImageWrite,
ifdef::VK_KHR_shader_untyped_pointers+VK_EXT_descriptor_heap[]
    code:OpUntypedImageTexelPointerEXT
endif::VK_KHR_shader_untyped_pointers+VK_EXT_descriptor_heap[]
    or code:OpImageTexelPointer instruction that consumes an
    code:OpTypeImage with an image code:Storage code:Class
    code:TileAttachmentQCOM must: not result in any texels accessed outside
    the boundaries of the current tile, computed as described in
    <<renderpass-tile-shading-offset-validation,Tile Attachments>>
...
ifdef::VK_COMPUTE_VERSION_1_1,VK_KHR_sampler_ycbcr_conversion[]
  * [[VUID-RuntimeSpirv-OpTypeSampler-12203]]
    If a variable with type code:OpTypeSampler is declared in the
    <<interfaces-resources, Shader Resource Interface>>, it must: not be
    backed by a <<samplers,sampler>> that requires
    <<samplers-YCbCr-conversion,sampler {YCbCr} conversion>>
  * [[VUID-RuntimeSpirv-OpTypeImage-12204]]
    If a variable with type code:OpTypeImage is declared in the
    <<interfaces-resources, Shader Resource Interface>>, it must: not be
    backed by an <<resources-image-views,image view>> that requires
    <<samplers-YCbCr-conversion,sampler {YCbCr} conversion>>
  * [[VUID-RuntimeSpirv-None-12205]]
    If an <<resources-image-views,image view>> or <<samplers,sampler>> that
    requires <<samplers-YCbCr-conversion,sampler {YCbCr} conversion>> is
    accessed in a shader, it must: be determined by
    <<glossary-constant-integral-expression, constant integral expressions>>
  * [[VUID-RuntimeSpirv-OpTypeSampledImage-12206]]
    If an code:OpTypeSampledImage variable backed by an
    <<resources-image-views,image view>> and <<samplers,sampler>> that
    require <<samplers-YCbCr-conversion,sampler {YCbCr} conversion>> is
    statically used in a shader, it must: only be used with
    code:OpImageSample*, code:OpImageSparseSample*, or code:OpImage
    instructions
  * [[VUID-RuntimeSpirv-OpTypeImage-12207]]
    If a code:OpTypeImage variable backed by an <<resources-image-views,
    image view>> that requires <<samplers-YCbCr-conversion,sampler {YCbCr}
    conversion>> is statically used in a shader, it must: only be used with
    code:OpImageQueryLevels or code:OpImageQuerySizeLod instructions
  * [[VUID-RuntimeSpirv-ConstOffset-10718]]
    If an code:OpTypeSampledImage variable backed by an
    <<resources-image-views,image view>> and <<samplers,sampler>> that
    require <<samplers-YCbCr-conversion,sampler {YCbCr} conversion>> is
    statically used in a shader with a sampling instruction, it must: not
    use the code:ConstOffset or code:Offset operands
ifdef::VK_EXT_descriptor_buffer,VK_EXT_descriptor_heap[]
  * [[VUID-RuntimeSpirv-OpTypeSampledImage-12208]]
    If an code:OpTypeSampledImage variable backed by an
    <<resources-image-views,image view>> and <<samplers,sampler>> that
    require <<samplers-YCbCr-conversion,sampler {YCbCr} conversion>> is
    statically used in a shader, the image view and sampler must: have been
    created with an _identically defined_ slink:VkSamplerYcbcrConversion set
    via slink:VkSamplerYcbcrConversionInfo
...
ifdef::VK_EXT_shader_uniform_buffer_unsized_array[]
  * [[VUID-RuntimeSpirv-shaderUniformBufferUnsizedArray-11806]]
    If the <<features-shaderUniformBufferUnsizedArray,
    pname:shaderUniformBufferUnsizedArray>> feature is not enabled,
    code:OpTypeRuntimeArray must: not be used for the last member of a
    code:Block-decorated code:OpTypeStruct in the code:Uniform storage
    {StorageClass}
...
ifdef::VK_ARM_data_graph[]
  ...
  ** its pname:arrayElement member must: be zero
  ** its pname:pNext chain must: include a slink:VkTensorDescriptionARM
     structure
  *** whose pname:dimensionCount is equal to the code:Rank of the
...
ifdef::VK_EXT_ray_tracing_invocation_reorder[]
  * [[VUID-RuntimeSpirv-maxShaderBindingTableRecordIndex-11888]]
    ...
    code:OpHitObjectSetShaderBindingTableRecordIndexEXT must: be less than
    or equal to
    slink:VkPhysicalDeviceRayTracingInvocationReorderPropertiesEXT::pname:maxShaderBindingTableRecordIndex
endif::VK_EXT_ray_tracing_invocation_reorder[]
...
ifdef::VK_EXT_shader_64bit_indexing[]
    ...
    ename:VK_PIPELINE_CREATE_2_64_BIT_INDEXING_BIT_EXT or
    ename:VK_SHADER_CREATE_64_BIT_INDEXING_BIT_EXT flags and the entry point
    does not set the code:Shader64BitIndexingEXT execution mode
endif::VK_EXT_shader_64bit_indexing[]
  * [[VUID-RuntimeSpirv-OpArrayLength-11807]]
    code:OpArrayLength
ifdef::VK_KHR_shader_untyped_pointers[]
    and code:OpUntypedArrayLengthKHR
endif::VK_KHR_shader_untyped_pointers[]
...
ifdef::VK_EXT_shader_64bit_indexing[]
    ...
    does not set the code:Shader64BitIndexingEXT execution mode
ifdef::VK_EXT_descriptor_heap[]
  * [[VUID-RuntimeSpirv-OpConstantSizeOfEXT-11475]]
    The result type of code:OpConstantSizeOfEXT must: not be a 64-bit
...
ifdef::VK_NV_cooperative_vector[]
  * [[VUID-RuntimeSpirv-OpCooperativeVectorMatrixMulAddNV-11808]]
    code:OpCooperativeVectorMatrixMulAddNV and
    code:OpCooperativeVectorMatrixMulNV code:MatrixOffset and
    code:BiasOffset parameters must: be 32-bit integer types
ifdef::VK_EXT_shader_64bit_indexing[]
    if the pipeline or shader was not compiled with the
    ename:VK_PIPELINE_CREATE_2_64_BIT_INDEXING_BIT_EXT or
    ename:VK_SHADER_CREATE_64_BIT_INDEXING_BIT_EXT flags and the entry point
  ...
  * [[VUID-RuntimeSpirv-OpCooperativeVectorLoadNV-11809]]
    code:OpCooperativeVectorLoadNV, code:OpCooperativeVectorStoreNV,
    code:OpCooperativeVectorOuterProductAccumulateNV, and
    code:OpCooperativeVectorReduceSumAccumulateNV code:Offset parameters
...
ifdef::VK_EXT_shader_long_vector[]
  * [[VUID-RuntimeSpirv-longVector-12296]]
    If the <<features-longVector,pname:longVector>> feature is enabled, the
    code:Component code:Count of any vector type must: be less than or equal
    to <<limits-maxVectorComponents,pname:maxVectorComponents>>
endif::VK_EXT_shader_long_vector[]
ifdef::VK_EXT_descriptor_heap[]
  * [[VUID-RuntimeSpirv-samplerDescriptorAlignment-11348]]
    If the code:Result code:Type operand of code:OpLoad is
    code:OpTypeSampler, and code:Pointer is derived from a variable
    decorated with code:SamplerHeapEXT, it must: be at an offset from the
    base that is a multiple of <<limits-samplerDescriptorAlignment,
    pname:samplerDescriptorAlignment>>
  * [[VUID-RuntimeSpirv-imageDescriptorAlignment-11349]]
    If the code:Result code:Type operand of code:OpLoad is code:OpTypeImage,
    and code:Pointer is derived from a variable decorated with
    code:ResourceHeapEXT, it must: be at an offset from the base that is a
    multiple of <<limits-imageDescriptorAlignment,
    pname:imageDescriptorAlignment>>
  * [[VUID-RuntimeSpirv-imageDescriptorAlignment-11383]]
    If the code:Image operand of code:OpImageTexelPointer
ifdef::VK_KHR_shader_untyped_pointers[]
    or code:OpUntypedImageTexelPointerEXT
endif::VK_KHR_shader_untyped_pointers[]
    is derived from a variable decorated with code:ResourceHeapEXT, it must:
...
ifdef::VK_KHR_acceleration_structure,VK_NV_ray_tracing[]
  * [[VUID-RuntimeSpirv-Result-11350]]
    If the code:Result code:Type operand of code:OpLoad is
    code:OpTypeAccelerationStructureKHR and code:Pointer is derived from a
    variable decorated with code:ResourceHeapEXT, it must: be at an offset
    from the base that is a multiple of <<limits-bufferDescriptorAlignment,
  ...
  * [[VUID-RuntimeSpirv-bufferDescriptorAlignment-11384]]
    The code:Buffer operand of code:OpBufferPointerEXT must: be at an offset
    from the base of the code:ResourceHeapEXT that is a multiple of
    <<limits-bufferDescriptorAlignment, pname:bufferDescriptorAlignment>>
ifdef::VK_ARM_tensors[]
  * [[VUID-RuntimeSpirv-tensorDescriptorAlignment-11481]]
    If the code:Result code:Type operand of code:OpLoad is
    code:OpTypeTensorARM and code:Pointer is derived from a variable
    decorated with code:ResourceHeapEXT, it must: be at an offset from the
    base that is a multiple of <<limits-tensorDescriptorAlignment,
    pname:tensorDescriptorAlignment>>
endif::VK_ARM_tensors[]
  * [[VUID-RuntimeSpirv-samplerDescriptorAlignment-11476]]
    If a code:OpTypeSampler member of a struct is decorated with code:Offset
    or code:OffsetIdEXT, the code:Byte code:Offset value must be a multiple
    of
    <<limits-samplerDescriptorAlignment,pname:samplerDescriptorAlignment>>
  * [[VUID-RuntimeSpirv-imageDescriptorAlignment-11477]]
    If a code:OpTypeImage member of a struct is decorated with code:Offset
    or code:OffsetIdEXT, the code:Byte code:Offset value must be a multiple
    of <<limits-imageDescriptorAlignment,pname:imageDescriptorAlignment>>
  * [[VUID-RuntimeSpirv-bufferDescriptorAlignment-11478]]
    If a code:OpTypeBufferEXT member of a struct is decorated with
    code:Offset or code:OffsetIdEXT, the code:Byte code:Offset value must be
    a multiple of
    <<limits-bufferDescriptorAlignment,pname:bufferDescriptorAlignment>>
ifdef::VK_KHR_acceleration_structure,VK_NV_ray_tracing[]
  * [[VUID-RuntimeSpirv-bufferDescriptorAlignment-11479]]
    If a code:OpTypeAccelerationStructureKHR member of a struct is decorated
    with code:Offset or code:OffsetIdEXT, the code:Byte code:Offset value
    must be a multiple of <<limits-bufferDescriptorAlignment,
    pname:bufferDescriptorAlignment>>
endif::VK_KHR_acceleration_structure,VK_NV_ray_tracing[]
ifdef::VK_ARM_tensors[]
  * [[VUID-RuntimeSpirv-tensorDescriptorAlignment-11480]]
    If a code:OpTypeTensorARM member of a struct is decorated with
    code:Offset or code:OffsetIdEXT, the code:Byte code:Offset value must be
    a multiple of <<limits-tensorDescriptorAlignment,
    pname:tensorDescriptorAlignment>>
endif::VK_ARM_tensors[]
  * [[VUID-RuntimeSpirv-DescriptorSet-11385]]
    If an instruction accesses memory through any resource with a
    code:DescriptorSet and code:Binding that are <<descriptorheaps-bindings,
    mapped>> using ename:VK_DESCRIPTOR_MAPPING_SOURCE_PUSH_DATA_EXT,
...
ifdef::VK_KHR_ray_tracing_pipeline,VK_NV_ray_tracing[]
    ...
    ename:VK_DESCRIPTOR_MAPPING_SOURCE_RESOURCE_HEAP_DATA_EXT, the resource
    through which that memory is accessed must: be determined by
    <<glossary-constant-integral-expression, constant integral expressions>>
  * [[VUID-RuntimeSpirv-source-11387]]
    All possible values of a variable pointer to a resource that are not
    code:OpConstantNull must: either all be pointers to resources with
    code:DescriptorSet and code:Binding decorations with the same
    <<descriptorheaps-bindings, mapping types>> as specified by
    slink:VkDescriptorSetAndBindingMappingEXT::pname:source, or all be
    pointers to resources without code:DescriptorSet and code:Binding
    decorations
  * [[VUID-RuntimeSpirv-DescriptorSet-11388]]
    All possible values of a variable pointer to a resource must: not be
    resources with a code:DescriptorSet and code:Binding that are
    <<descriptorheaps-bindings, mapped>> using
...
ifdef::VK_KHR_ray_tracing_pipeline,VK_NV_ray_tracing[]
  ...
  * [[VUID-RuntimeSpirv-Result-11340]]
    If the code:Result code:Type operand of code:OpLoad is
    code:OpTypeSampler, and code:Pointer is derived from a variable
    decorated with code:SamplerHeapEXT, it must: correspond to loading a
    descriptor matching one of the descriptor types listed in
    <<interfaces-resources-heap-type-correspondence, Heap Resource Type
    Correspondence>> for code:OpTypeSampler
  * [[VUID-RuntimeSpirv-Result-11341]]
    If the code:Result code:Type operand of code:OpLoad is code:OpTypeImage,
    and code:Pointer is derived from a variable decorated with
    code:ResourceHeapEXT, it must: correspond to loading a descriptor
    matching one of the descriptor types listed in
    <<interfaces-resources-heap-type-correspondence, Heap Resource Type
    Correspondence>> for code:OpTypeImage
  * [[VUID-RuntimeSpirv-Result-11342]]
    The code:Buffer operand of code:OpBufferPointerEXT must: correspond to
    accessing a descriptor matching one of the descriptor types listed in
    <<interfaces-resources-heap-type-correspondence, Heap Resource Type
    Correspondence>> for code:OpTypePointer
  * [[VUID-RuntimeSpirv-Result-11343]]
    If the code:Result code:Type operand of code:OpLoad is code:OpTypeImage,
    and code:Pointer is derived from a variable decorated with
    code:ResourceHeapEXT, the code:Image code:Format and code:Sampled
    code:Type of that code:OpTypeImage must: correspond to a descriptor with
    a elink:VkFormat that matches as described by <<spirvenv-image-formats,
    Compatibility Between SPIR-V Image Formats and Vulkan Formats>> and
    <<spirvenv-format-type-matching, Image Format and Type Matching Between
    SPIR-V Image Formats and Vulkan Formats>>
  * [[VUID-RuntimeSpirv-Result-11345]]
    If the code:Result code:Type operand of code:OpLoad is code:OpTypeImage,
    and code:Pointer is derived from a variable decorated with
    code:ResourceHeapEXT, the operands of that code:OpTypeImage must:
    correspond to a descriptor with operands that match as described by
    <<interfaces-resources-heap-image-operand-correspondence,Heap Image
    Operand Correspondence>> and
    <<interfaces-resources-heap-image-dim-correspondence,Heap Image View
    Type Dimensionality>>
...
ifdef::VK_KHR_shader_untyped_pointers[]
    ...
    types listed in <<interfaces-resources-heap-type-correspondence, Heap
    Resource Type Correspondence>> for the code:OpTypeImage pointed to
  * [[VUID-RuntimeSpirv-Image-11380]]
    If the code:Image operand of code:OpImageTexelPointer
ifdef::VK_KHR_shader_untyped_pointers[]
    or code:OpUntypedImageTexelPointerEXT
endif::VK_KHR_shader_untyped_pointers[]
    is derived from a variable decorated with code:ResourceHeapEXT, the
    code:Image code:Format and code:Sampled code:Type of the
    code:OpTypeImage pointed to must: correspond to a descriptor with a
    elink:VkFormat that matches as described by <<spirvenv-image-formats,
    Compatibility Between SPIR-V Image Formats and Vulkan Formats>> and
    <<spirvenv-format-type-matching, Image Format and Type Matching>>
...
ifdef::VK_KHR_shader_untyped_pointers[]
    ...
    is derived from a variable decorated with code:ResourceHeapEXT, the
    operands of that code:OpTypeImage must: correspond to a descriptor with
    operands that match as described by
    <<interfaces-resources-heap-image-operand-correspondence,Heap Image
    Operand Correspondence>> and
    <<interfaces-resources-heap-image-dim-correspondence,Heap Image View
    Type Dimensionality>>
  * [[VUID-{refpage}-maxPushDataSize-12455]]
    The size of the code:PushConstant {StorageClass} block must: be less
    than or equal to <<limits-maxPushDataSize,pname:maxPushDataSize>>
endif::VK_EXT_descriptor_heap[]
****
--
...
ifndef::VK_COMPUTE_VERSION_1_4,VK_KHR_shader_float_controls2[]
...
ifndef::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float_controls[]
...
ifdef::VK_EXT_shader_float8[]
  ...
  ** If the entry point is declared with the code:DenormPreserve
     {ExecutionMode} then for the affected instructions the denormalized
  ...
  ** The following core SPIR-V instructions must: respect the
     ...
     code:OpFSub, code:OpFMul,
ifdef::VK_KHR_shader_fma[code:OpFmaKHR,]
     code:OpFDiv, code:OpFRem, code:OpFMod, code:OpVectorTimesScalar,
     code:OpMatrixTimesScalar, code:OpVectorTimesMatrix,
     code:OpMatrixTimesVector, code:OpMatrixTimesMatrix,
     code:OpOuterProduct, code:OpDot, code:OpGroupNonUniformFMin,
     code:OpGroupNonUniformFMax,
...
[NOTE]
====
The interpretation of objects with a code:OpTypeFloat type with
code:MXInt8EXT encoding that have the bit pattern 0x80 is undefined:.
====
...
[eq]#a# despite the code:NoContraction decoration, since the replacement is
...
ifdef::VK_KHR_shader_bfloat16,VK_EXT_shader_float8,VK_EXT_shader_ocp_microscaling_types[]
...
ifdef::VK_EXT_shader_ocp_microscaling_types[]
  ...
  * code:Float6E3M2EXT
  * code:Float4E2M1EXT
  * code:Float8UnsignedE8M0EXT
  * code:MXInt8EXT
endif::VK_EXT_shader_ocp_microscaling_types[]
endif::VK_KHR_shader_bfloat16,VK_EXT_shader_float8,VK_EXT_shader_ocp_microscaling_types[]
...
ifndef::VK_COMPUTE_VERSION_1_2,VK_KHR_shader_float16_int8[]
...
a
ifdef::VK_COMPUTE_VERSION_1_2,VK_EXT_buffer_device_address,VK_KHR_buffer_device_address[physical storage buffer or]
...
ifdef::VK_EXT_shader_64bit_indexing[]
[[spirvenv-64bindexing]]
=== 64-Bit Indexing

The application can: enable 64-bit indexing either by setting the flags
ename:VK_PIPELINE_CREATE_2_64_BIT_INDEXING_BIT_EXT or
ename:VK_SHADER_CREATE_64_BIT_INDEXING_BIT_EXT or by setting the
code:Execution code:Mode code:Shader64BitIndexingEXT on the entry point,
...
code:ArrayStride for a runtime-sized array when evaluating an access chain
in code:StorageBuffer or code:PhysicalStorageBuffer will have 64 bits of
range.
Similarly, the `Element` times code:ArrayStride calculation for
code:OpPtrAccessChain
ifdef::VK_KHR_shader_untyped_pointers[]
and code:OpUntypedPtrAccessChainKHR
endif::VK_KHR_shader_untyped_pointers[]
...
If 64-bit indexing is enabled, code:OpArrayLength
ifdef::VK_KHR_shader_untyped_pointers[]
and code:OpUntypedArrayLengthKHR
endif::VK_KHR_shader_untyped_pointers[]
...
ifdef::VK_NV_cooperative_matrix[code:OpCooperativeMatrixLoadNV, code:OpCooperativeMatrixStoreNV,]
ifdef::VK_KHR_cooperative_matrix[code:OpCooperativeMatrixLoadKHR, and code:OpCooperativeMatrixStoreKHR]
...
tensorCoordToLinear used by code:OpCooperativeMatrixLoadTensorNV and
code:OpCooperativeMatrixStoreTensorNV in the code:SPV_NV_cooperative_matrix2
...
code:OpCooperativeVectorLoadNV, code:OpCooperativeVectorStoreNV,
code:OpCooperativeVectorMatrixMulNV, code:OpCooperativeVectorMatrixMulAddNV,
code:OpCooperativeVectorOuterProductAccumulateNV, and
code:OpCooperativeVectorReduceSumAccumulateNV can: be 64-bit integers.
endif::VK_NV_cooperative_vector[]
...
resource's format or vice versa via <<images-texel-decode>> for reads and
<<images-texel-encode>> for writes.
...
[[spirvenv-spir-v-and-vulkan-imageview-dimension-compatibility-table]]
...
[[spirvenv-spir-v-and-vulkan-image-format-compatibility-table]]
...
[[spirvenv-spir-v-tensor-element-type-and-vulkan-format-compatibility-table]]
...
ifdef::VK_EXT_shader_float8[]
|`OpTypeFloat 8 Float8E4M3EXT` |ename:VK_FORMAT_R8_SFLOAT_FPENCODING_FLOAT8E4M3_ARM
|`OpTypeFloat 8 Float8E5M2EXT` |ename:VK_FORMAT_R8_SFLOAT_FPENCODING_FLOAT8E5M2_ARM
endif::VK_EXT_shader_float8[]
|`OpTypeFloat 16`              |ename:VK_FORMAT_R16_SFLOAT
ifdef::VK_KHR_shader_bfloat16[]
|`OpTypeFloat 16 BFloat16KHR`  |ename:VK_FORMAT_R16_SFLOAT_FPENCODING_BFLOAT16_ARM
endif::VK_KHR_shader_bfloat16[]
|`OpTypeFloat 32`              |ename:VK_FORMAT_R32_SFLOAT
|`OpTypeFloat 64`              |ename:VK_FORMAT_R64_SFLOAT
|`OpTypeInt 8 0`               |ename:VK_FORMAT_R8_UINT, ename:VK_FORMAT_R8_SINT
|`OpTypeInt 8 1`               |ename:VK_FORMAT_R8_SINT
|`OpTypeInt 16 0`              |ename:VK_FORMAT_R16_UINT, ename:VK_FORMAT_R16_SINT
|`OpTypeInt 16 1`              |ename:VK_FORMAT_R16_SINT
|`OpTypeInt 32 0`              |ename:VK_FORMAT_R32_UINT, ename:VK_FORMAT_R32_SINT
|`OpTypeInt 32 1`              |ename:VK_FORMAT_R32_SINT
|`OpTypeInt 64 0`              |ename:VK_FORMAT_R64_UINT, ename:VK_FORMAT_R64_SINT
