...
ifdef::VK_EXT_shader_64bit_indexing[]
  ...
  * [[VUID-RuntimeSpirv-None-12295]]
    {empty}
ifdef::VK_EXT_shader_long_vector[]
    If the <<features-longVector,pname:longVector>> feature is not enabled,
endif::VK_EXT_shader_long_vector[]
    the code:Component code:Count of any vector type must: be less than or
