...
ifdef::VK_EXT_cooperative_matrix_maintenance1[]
  * [[VUID-{refpage}-cooperativeMatrixProperties2-13382]]
    ...
    supported slink:VkCooperativeMatrixPropertiesKHR as described above, or
    one of the supported slink:VkCooperativeMatrixProperties2EXT returned by
    a query with slink:VkPhysicalDeviceCooperativeMatrixInfo2EXT specifying
  ...
  ** for code:MatrixA, the number of rows must: be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:MGranularity and the
     number of columns must: be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:KGranularity and the
     type must: match slink:VkCooperativeMatrixProperties2EXT::pname:AType
  ** for code:MatrixB, the number of rows must: be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:KGranularity and the
     number of columns must: be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:NGranularity and the
     type must: match slink:VkCooperativeMatrixProperties2EXT::pname:BType
  ** for code:MatrixAccumulator, the number of rows must: be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:MGranularity and the
     number of columns must: be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:NGranularity and the
     type must: match slink:VkCooperativeMatrixProperties2EXT::pname:CType
     or slink:VkCooperativeMatrixProperties2EXT::pname:ResultType
  ** if the scope is ename:VK_SCOPE_WORKGROUP_KHR, the number of invocations
     in the local workgroup must: match
     slink:VkPhysicalDeviceCooperativeMatrixInfo2EXT::pname:invocations
...
ifdef::VK_EXT_shader_object[]
     or ename:VK_SHADER_CREATE_ALLOW_VARYING_SUBGROUP_SIZE_BIT_EXT
endif::VK_EXT_shader_object[]
     set, or if the SPIR-V module is version 1.6 or later and no structure
     specifying a required subgroup size was chained,
     slink:VkPhysicalDeviceCooperativeMatrixInfo2EXT::pname:subgroupSize
     must: be `0`
...
ifdef::VK_NV_cooperative_matrix2[]
     if the <<features-cooperativeMatrixFlexibleDimensions,
     pname:cooperativeMatrixFlexibleDimensions>> feature is not enabled, the
endif::VK_NV_cooperative_matrix2[]
ifndef::VK_NV_cooperative_matrix2[The]
  ...
  * [[VUID-{refpage}-cooperativeMatrixProperties2-13383]]
    ...
    supported slink:VkCooperativeMatrixProperties2EXT returned by a query
    with slink:VkPhysicalDeviceCooperativeMatrixInfo2EXT specifying the
  ...
  ** The type of code:A must: have code:Rows be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:MGranularity,
     code:Columns be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:KGranularity, code:Use
     be code:MatrixAKHR, and code:ComponentType match
     slink:VkCooperativeMatrixProperties2EXT::pname:AType
  ** The type of code:B must: have code:Rows be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:KGranularity,
     code:Columns be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:NGranularity, code:Use
     be code:MatrixBKHR, and code:ComponentType match
     slink:VkCooperativeMatrixProperties2EXT::pname:BType
  ** The type of code:C must: have code:Rows be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:MGranularity,
     code:Columns be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:NGranularity, code:Use
     be code:MatrixAccumulatorKHR, and code:ComponentType match
     slink:VkCooperativeMatrixProperties2EXT::pname:CType
  ** The type of code:Result must: have code:Rows be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:MGranularity,
     code:Columns be a multiple of
     slink:VkCooperativeMatrixProperties2EXT::pname:NGranularity, code:Use
     be code:MatrixAccumulatorKHR, and code:ComponentType match
     slink:VkCooperativeMatrixProperties2EXT::pname:ResultType
  ** If and only if slink:VkCooperativeMatrixProperties2EXT::pname:AType is
     a signed integer type, code:MatrixASignedComponents must: be used
  ** If and only if slink:VkCooperativeMatrixProperties2EXT::pname:BType is
     a signed integer type, code:MatrixBSignedComponents must: be used
  ** If and only if slink:VkCooperativeMatrixProperties2EXT::pname:CType is
     a signed integer type, code:MatrixCSignedComponents must: be used
  ** If and only if
     slink:VkCooperativeMatrixProperties2EXT::pname:ResultType is a signed
     integer type, code:MatrixResultSignedComponents must: be used
  ** If and only if
     slink:VkPhysicalDeviceCooperativeMatrixInfo2EXT::pname:flags contains
     ename:VK_COOPERATIVE_MATRIX_SATURATING_ACCUMULATION_BIT_EXT,
     code:SaturatingAccumulationKHR must: be used
  ** The scope of all cooperative matrix operands must: match
     slink:VkPhysicalDeviceCooperativeMatrixInfo2EXT::pname:scope
  ** If the scope is ename:VK_SCOPE_WORKGROUP_KHR, the number of invocations
     in the local workgroup must: match
     slink:VkPhysicalDeviceCooperativeMatrixInfo2EXT::pname:invocations
ifdef::VK_VERSION_1_3,VK_EXT_subgroup_size_control[]
