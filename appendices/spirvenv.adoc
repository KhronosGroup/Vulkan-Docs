...
// Add any needed conditional logic to the runtime section if needed.
  ...
  * [[VUID-{refpage}-OpControlBarrier-10609]]
    If the semantics for code:OpControlBarrier includes at least one
    {StorageClass}, then it must: include one of code:Acquire, code:Release,
    code:AcquireRelease, or code:SequentiallyConsistent memory semantics
...
ifdef::VK_QCOM_tile_shading[]
  ...
  * [[VUID-{refpage}-StorageTexelBufferArrayDynamicIndexing-10133]]
    ...
    must: be determined by <<glossary-constant-integral-expression, constant
    integral expressions>> code:PhysicalStorageBuffer.
ifdef::VK_QCOM_tile_shading[]
...
ifdef::VK_QCOM_tile_shading[]
  ...
  * [[VUID-{refpage}-x-10702]]
    ...
    to
    slink:VkPhysicalDeviceTileShadingPropertiesQCOM::pname:maxTileShadingRate::pname:x
  * [[VUID-{refpage}-y-10703]]
    In compute shaders that enables SPIR-V capability code:TileShadingQCOM,
    the pname:y size in code:TileShadingRateQCOM must: be less than or equal
    to
    slink:VkPhysicalDeviceTileShadingPropertiesQCOM::pname:maxTileShadingRate::pname:y
  * [[VUID-{refpage}-z-10704]]
    In compute shaders that enables SPIR-V capability code:TileShadingQCOM,
    the pname:z size in code:TileShadingRateQCOM must: be less than or equal
    to slink:VkTilePropertiesQCOM::pname:tileSize::pname:z
