...
include::{generated}/meta/{refprefix}VK_KHR_pipeline_library_group_handles.adoc[]
...
`apiext:VK_EXT_pipeline_library_group_handles` extension.
...
include::{generated}/interfaces/VK_KHR_pipeline_library_group_handles.adoc[]
