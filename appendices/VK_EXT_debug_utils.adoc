...
ifdef::VK_EXT_debug_marker,VK_EXT_debug_report[]
...
endif::VK_EXT_debug_marker,VK_EXT_debug_report[]
...
the etext:VkDebugReportObjectTypeEXT enumeration will no longer be updated
