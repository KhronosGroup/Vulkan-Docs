...
include::{generated}/meta/{refprefix}VK_EXT_rasterization_order_attachment_access.txt[]
...
include::{generated}/interfaces/VK_EXT_rasterization_order_attachment_access.txt[]
